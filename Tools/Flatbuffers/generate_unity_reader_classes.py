...
class_to_generate = {
    ...
    "JNNFCGGHCAF" : {"FB_class":"IGLOKFOAKDB"},
    "NJOFJDHEGIK" : {"FB_class":"LDLCKBMOFJC"},
    "MIAGFHOGPPN" : {"FB_class":"HACLELJLADO"},
    "LBMIEHAHNFD" : {"FB_class":"IBBBNNBOBLD"},
    "IMLKIIBJABA" : {"FB_class":"MLCJDNPCFHI"},
    "KMPKAHGGCHK" : {"FB_class":"GPDPAKFCMMO"},
    "PCFOIOGMHHL" : {"FB_class":"NLMKDBJHCCM"},
    "FGALMCADGMO" : {"FB_class":"FKNGHMMLIJF"},
    "NHADPDNKGIE" : {"FB_class":"PCIEJLEICFK"},
    "FLHKDAGGLNK" : {"FB_class":"HPKOMBFEADM"},
    "MDOBMPOHGJO" : {"FB_class":"GAPIOFFIFKN"},
    "MGOOKLACCAB" : {"FB_class":"BECPINGJFLI"},
    ...
    "ALFKCDIOOHC" : {"FB_class":"JHNNMJEDOLG"},
    "MEIHPKLEAKP" : {"FB_class":"NCJELDIPMGO"},
    "JONOKOHFAJO" : {"FB_class":"GLBBAECGHNN"},
    "MKLLOAPBIGJ" : {"FB_class":"AMMFBOPDMFI"},
    "EHIHLFGHOEF" : {"FB_class":"CBOPKMNJJIA"},
    "BOLCKDHHNDB" : {"FB_class":"ONCFNGIBLHO"},
    "CEGLELHPKBO" : {"FB_class":"AIAIHLIBPLM"},
    "OOFJBDCPKBJ" : {"FB_class":"DOLNHKKDNCC"},
    "CHIHOOMFLNA" : {"FB_class":"AGKBCKADDKJ"},
    "BELBAJBINBO" : {"FB_class":"AIAGNLHOHPF"},
    "PMHJIJGDJMO" : {"FB_class":"CFFBOCDCDCJ"},
    "BLOHGJIKLAK" : {"FB_class":"HKILNANKLLB"},
    "DNKLFEPGGNC" : {"FB_class":"ACCMHHCLELG"},
    "IGDFIPKLHBA" : {"FB_class":"JAFMFLPLHEB"},
    "LEGLJNFOBGN" : {"FB_class":"CHFNKBBHDGM"},
    "MFNEHMPBDKK" : {"FB_class":"KIPJDHHEGND"},
    "PCKMEHLNOFO" : {"FB_class":"BNMAJCFEFOK"},
    ...
    "LLENNGEBHNC" : {"FB_class":"EAHMHMEDAOG"},
    "MEPHNDCDFFJ" : {"FB_class":"PLONLLOGMEJ"},
    "DGLENODDACE" : {"FB_class":"BGECCLJCLID"},
    "EMEEODMLEHD" : {"FB_class":"JAAOECLAKNC"},
    "BOFIIKIJEPA" : {"FB_class":"PCIPKGNLLBO"},
    ...
    "OPHFFGFJIBJ" : {"FB_class":"OIMNNAPBCGG"},
    "FOKPKJFHNLO" : {"FB_class":"NMCBIDLKHED"},
    "NPAJGBIFLHB" : {"FB_class":"NBIKKFDBOFF"},
    "MAGFOKIIPPD" : {"FB_class":"FDGDGGHOJBP"},
    "HMNJADGBKFA" : {"FB_class":"KBPJMHKBEAJ"},
    "KBFIJHDHOGA" : {"FB_class":"LDCIDAKFJPH"},
    "CEGMAIDIKLC" : {"FB_class":"EDNGOONFHEO"},
    "ANCFFLNKINL" : {"FB_class":"KCMFPGDPCIG"},
    "EDHLNJNFNDN" : {"FB_class":"MMLADLKNMEL"},
    "PMPDPNDJBLB" : {"FB_class":"MCCEAMFIECM"},
    "HGHOHICGBEP" : {"FB_class":"HJOPMDDAIDF"},
}
