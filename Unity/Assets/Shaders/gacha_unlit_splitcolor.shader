Shader "MCRS/Gacha/Unlit_SplitColor" {
	Properties {
...
*/
			fixed4 frag(v2f i) : SV_Target
			{
				...
				u_xlat0.xy = i.texcoord0.xy * _MaskTex_ST.xy + _MaskTex_ST.zw;
				u_xlat10_0.x = tex2D(_MaskTex, u_xlat0.xy).x;
				u_xlat0.x = u_xlat10_0.x * i.color0.w;
...
/*
					...
					void main()
					{
					    ...
					    u_xlat10_0.x = texture2D(_MaskTex, u_xlat0.xy).x;
