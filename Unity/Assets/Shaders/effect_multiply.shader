...
*/
			...
			{
				float4 u_xlat10_0, u_xlat0, SV_Target0, u_xlat16_1;
				float u_xlat6;
				u_xlat10_0 = tex2D(_MainTex, i.texcoord0.xy);
				u_xlat0 = u_xlat10_0 * _Color;
				u_xlat0 = u_xlat0 * i.color0;
				u_xlat6 = u_xlat0.w * _Power;
				u_xlat16_1.xyz = u_xlat0.xyz * float3(_Power, _Power, _Power) + float3(-1.0, -1.0, -1.0);
				u_xlat16_1.xyz = float3(u_xlat6, u_xlat6, u_xlat6) * u_xlat16_1.xyz + float3(1.0, 1.0, 1.0);
...
/*
					...
					void main()
					{
					    ...
					    u_xlat6 = u_xlat0.w * _Power;
					    u_xlat16_1.xyz = u_xlat0.xyz * vec3(_Power) + vec3(-1.0, -1.0, -1.0);
					    u_xlat16_1.xyz = vec3(u_xlat6) * u_xlat16_1.xyz + vec3(1.0, 1.0, 1.0);
					    SV_Target0.xyz = u_xlat16_1.xyz;
					    SV_Target0.w = 1.0;
					    return;
					}
