Shader "MCRS/RhythmUI/RhythmUIPilotCutin" {
	Properties {
		_MainTex ("Base (RGB)", 2D) = "white" {}
		_MaskTex ("Mask (A)", 2D) = "white" {}
		_BgTex ("Bg (RGBA)", 2D) = "white" {}
	...
	SubShader {
		...
		Pass {
			...
			v2f vert(appdata v)
			{
				...
				o.color0 = float4(v.color0.x, v.color0.y, v.color0.z, v.color0.w * _Alpha);
				return o; 
			}
/*			GpuProgramID 18021
			Program "vp" {
...
*/
			...
			{
				float4 SV_Target0, u_xlat10_3, u_xlat10_1, u_xlat16_2;
				float u_xlat10_0;
				u_xlat10_0 = tex2D(_MaskTex, i.texcoord0.xy).x;
				u_xlat10_3.xyz = tex2D(_MainTex, i.texcoord0.xy).xyz;
				u_xlat10_1.xyz = tex2D(_BgTex, i.texcoord0.xy).xyz;
				u_xlat16_2.xyz = u_xlat10_3.xyz + (-u_xlat10_1.xyz);
				u_xlat16_2.xyz = float3(u_xlat10_0, u_xlat10_0, u_xlat10_0) * u_xlat16_2.xyz + u_xlat10_1.xyz;
				SV_Target0.xyz = u_xlat16_2.xyz * i.color0.xyz + _AddColor.xyz;
...
/*
					...
					void main()
					{
					    ...
					    u_xlat10_1.xyz = texture2D(_BgTex, vs_TEXCOORD0.xy).xyz;
					    u_xlat16_2.xyz = u_xlat10_3.xyz + (-u_xlat10_1.xyz);
					    u_xlat16_2.xyz = vec3(u_xlat10_0) * u_xlat16_2.xyz + u_xlat10_1.xyz;
					    SV_Target0.xyz = u_xlat16_2.xyz * vs_COLOR0.xyz + _AddColor.xyz;
