...
*/
			...
			{
				float4 u_xlat10_0, u_xlat0, u_xlat1, SV_Target0;
				u_xlat10_0.xyz = tex2D(_MainTex, i.texcoord0.xy).xyz;
				SV_Target0.xyz = u_xlat10_0.xyz * i.color0.xyz;
...
/*
					...
					void main()
					{
					    ...
					    SV_Target0.xyz = u_xlat10_0.xyz * vs_COLOR1.xyz;
					    u_xlat10_0.x = texture2D(_AlphaTex, vs_TEXCOORD0.xy).x;
					    SV_Target0.w = u_xlat10_0.x * vs_COLOR1.w;
					    return;
					}
