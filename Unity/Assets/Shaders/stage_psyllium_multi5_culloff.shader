Shader "MCRS/Stage/PsylliumMulti5_CullOff" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			sampler2D _PsylliumMaskTex2;
			float4 _PsylliumMaskTex2_ST;
			float4 _Color1;
			float4 _Color2;
			float4 _Color3;
			float4 _Color4;
...
*/
			fixed4 frag(v2f i) : SV_Target
			{
				...
				u_xlat10_1.xy = tex2D(_PsylliumMaskTex2, i.texcoord0.xy).xy;
				u_xlat0.xyz = _Color4.xyz * u_xlat10_1.xxx + u_xlat0.xyz;
				u_xlat0.xyz = _Color5.xyz * u_xlat10_1.yyy + u_xlat0.xyz;
...
/*
					...
					uniform lowp sampler2D _PsylliumMaskTex2;
					varying highp vec2 vs_TEXCOORD0;
					varying highp vec4 vs_COLOR1;
					...
					void main()
					{
					    ...
					    u_xlat0.xyw = _Color1.xyz * u_xlat10_0.xxx + u_xlat1.xyz;
					    u_xlat0.xyz = _Color3.xyz * u_xlat10_0.zzz + u_xlat0.xyw;
					    u_xlat10_1.xy = texture2D(_PsylliumMaskTex2, vs_TEXCOORD0.xy).xy;
					    u_xlat0.xyz = _Color4.xyz * u_xlat10_1.xxx + u_xlat0.xyz;
					    u_xlat0.xyz = _Color5.xyz * u_xlat10_1.yyy + u_xlat0.xyz;
