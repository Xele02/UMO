...
*/
			...
			{
				float4 u_xlat10_0, u_xlat0, u_xlat1, SV_Target0, u_xlat2;
				bool u_xlatb0;
				u_xlat10_0.x = tex2D(_AlphaTex, i.texcoord0.xy).x;
				u_xlat1 = i.color0.w * _Color.w;
				u_xlat2 = u_xlat1 * u_xlat10_0.x + (-_Cutoff);
				u_xlat0.x = u_xlat10_0.x * u_xlat1;
