...
{   
    ...
    public IEnumerator PlayVideo(MemoryStream s)
    {
        ...
        /*while(!pb.IsReady())
            yield return null;
        MediaTrack[] tracks = pb.GetTracksInfo();
        for(int i = 0; i < tracks.Length; i++)
        {
            UnityEngine.Debug.Log("Tracks : "+tracks[i].Data.Video.Width);
        }*/
        pb.PlayPause();
        yield break;
    }
    ...
    void Awake()
    {
        CriUsmStream videoStream = new CriUsmStream("/home/xele/Projects/UtaMacrossOffline/Data/android/mov/gm/dv/game_dv_0119_mv_q2!s64ede4a6z!.usm");
...
//         using(FileStream fs = File.Open("/home/xele/.config/unity3d/UtaMacross/UtaMacross/data/android/snd/bgm/cs_w_0001.acb", FileMode.Open, FileAccess.Read, FileShare.Read))
//         {
