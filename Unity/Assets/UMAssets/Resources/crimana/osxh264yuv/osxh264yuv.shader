		...
		Pass {
			...
			Program "vp" {
				SubProgram "gles hw_tier00 " {
					...
					uniform lowp sampler2D _TextureRGB;
					varying mediump vec2 vs_TEXCOORD0;
					...
					void main()
					{
					    ...
					    u_xlat10_1 = texture2D(_TextureRGB, vs_TEXCOORD0.xy);
				...
				SubProgram "gles hw_tier00 " {
					...
					void main()
					{
					    u_xlat10_0 = texture2D(_TextureRGB, vs_TEXCOORD0.xy);
				...
				SubProgram "gles hw_tier00 " {
					...
					void main()
					{
					    u_xlat10_0.x = texture2D(_TextureA, vs_TEXCOORD0.xy).x;
					    u_xlat16_1 = (-_Transparency) + 1.0;
					    SV_Target0.w = u_xlat10_0.x * u_xlat16_1;
					    u_xlat10_0.xyz = texture2D(_TextureRGB, vs_TEXCOORD0.xy).xyz;
				...
				SubProgram "gles hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat10_0.x = texture2D(_TextureA, vs_TEXCOORD0.xy).x;
					    u_xlat16_1.x = (-_Transparency) + 1.0;
					    SV_Target0.w = u_xlat10_0.x * u_xlat16_1.x;
					    return;
					}
				...
				SubProgram "gles hw_tier00 " {
					...
					{
					    u_xlat10_0.x = texture2D(_TextureA, vs_TEXCOORD0.xy).x;
					    u_xlat0 = u_xlat10_0.x * vs_COLOR0.w;
					    u_xlat16_1 = (-_Transparency) + 1.0;
