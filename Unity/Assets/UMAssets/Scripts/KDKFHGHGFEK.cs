...
public class KDKFHGHGFEK
{
	...
	public void KHEKNNFCAOI(int PPFNGGCBJKC, EKLNMHFCAOI.FKGCBLHOOCL_Category NPADACLCNAN)
	{
		...
		switch(NPADACLCNAN)
		{
			...
			case EKLNMHFCAOI.FKGCBLHOOCL_Category.ICIMCGOJEMD_StampItemSerif:
			{
				...
				DOIGLOBENMG_StampName = NCPPAHHCCAO.GHHOBKGGADG(PPFNGGCBJKC);
				break;
			}
			...
			case EKLNMHFCAOI.FKGCBLHOOCL_Category.KKGHNKKGLCO_DecoItemPosterSceneAft:
			{
				if(PPFNGGCBJKC < 1)
					return;
				if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table.Count < PPFNGGCBJKC)
					return;
				MMPBPOIFDAF_Scene.PMKOFEIONEG sIte = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.PNLOINMCCKH_Scene.OPIBAPEGCLA[PPFNGGCBJKC - 1];
				FJFCNGNGIBN = 3;
				MLIBEPGADJH_Scene.KKLDOOJBJMN dbItem = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[PPFNGGCBJKC - 1];
			...
			case EKLNMHFCAOI.FKGCBLHOOCL_Category.HEMGMACMGAB_DecoItemVFFigure:
			{
				if(PPFNGGCBJKC < 1)
					return;
				if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.PEOALFEGNDH_Valkyrie.CDENCMNHNGA_table.Count < PPFNGGCBJKC)
					return;
				JPIANKEOOMB_Valkyrie.KJPIDJOMODA_ValkyrieInfo dbItem = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.PEOALFEGNDH_Valkyrie.CDENCMNHNGA_table[PPFNGGCBJKC - 1];
				...
				OIGEIIGKMNH_Valkyrie.HLNPGNNPCGO_ValkyrieInfo sIt = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.JJFFBDLIOCF_Valkyrie.CNGNBKNBKGI_ValkList[PPFNGGCBJKC - 1];
			...
			case EKLNMHFCAOI.FKGCBLHOOCL_Category.NNBMEEPOBIO_DecoItemCostumeTorso:
			{
				if(PPFNGGCBJKC < 1)
					return;
				if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.MFPNGNMFEAL_Costume.CDENCMNHNGA_table.Count < PPFNGGCBJKC)
					return;
				LCLCCHLDNHJ_Costume.ILODJKFJJDO_CostumeInfo dbItem = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.MFPNGNMFEAL_Costume.CDENCMNHNGA_table[PPFNGGCBJKC - 1];
				...
				EBFLJMOCLNA_Costume.ILFJDCICIKN sIt = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.BEKHNNCGIEL_Costume.FABAGMLEKIB_CostumeList[PPFNGGCBJKC - 1];
		...
		KGBAOKCMALD = itemId;
		FBFLDFMFFOH_Rarity = EKLNMHFCAOI.FABCKNDLPDH_GetItemRarity(NPADACLCNAN, PPFNGGCBJKC);
		BFINGCJHOHI_Count = EKLNMHFCAOI.ALHCGDMEMID_GetNumItems(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, NPADACLCNAN, PPFNGGCBJKC, null);
	...
	{
		return CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.OMMNKDEODJP_DecoItem.NBKAMFFIOOG_Sp[EKLNMHFCAOI.DEACAHNLMNI_getItemId(KIJAPOFAGPN) - 1].ANAJIAENLNB_Level;
	}
	...
	public static int IOKFJAIDMLD_GetNumItemsReady(int KIJAPOFAGPN, int DMBFOMLCGBG, long JHNMKKNEENE)
	{
		...
		NDBFKHKMMCE_DecoItem.FIDBAFHNGCF db = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.EPAHOAKPAJJ_DecoItem.GMONECJCJFK_Sp[itemId - 1];
		return Mathf.Min((int)((s.EMHCHMHMFHJ_ChargeTimeOffset + (JHNMKKNEENE - s.FOONCJDLLIK_ChargeTime)) / GGEGLPOMJCK_TimeByUnit(KIJAPOFAGPN, DMBFOMLCGBG)), l[db.GBJFNGCDKPM_Type - 1].NANNGLGOFKH_MaxNumber);
	}
	...
	public static long GGEGLPOMJCK_TimeByUnit(int KIJAPOFAGPN, int _CIEOBFIIPLD_Level)
	{
		int itemId = EKLNMHFCAOI.DEACAHNLMNI_getItemId(KIJAPOFAGPN);
		NDBFKHKMMCE_DecoItem.FIDBAFHNGCF db = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.EPAHOAKPAJJ_DecoItem.GMONECJCJFK_Sp[itemId - 1];
		...
		return (l[db.GBJFNGCDKPM_Type - 1].KPBJHHHMOJE_TimeToChargeMin * 60) / l[db.GBJFNGCDKPM_Type - 1].NANNGLGOFKH_MaxNumber;
	}
