...
public class KDKFHGHGFEK
{
	...
	public void KHEKNNFCAOI_Init(int _PPFNGGCBJKC_id, EKLNMHFCAOI.FKGCBLHOOCL_Category NPADACLCNAN)
	{
		...
		switch(NPADACLCNAN)
		{
			...
			case EKLNMHFCAOI.FKGCBLHOOCL_Category.HEMGMACMGAB_DecoItemVFFigure:
			{
				...
				FJFCNGNGIBN = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.EPAHOAKPAJJ_DecoItem.LPJLEHAJADA_GetIntParam("attr_vffigure", 12);
				FLJPIHEEKOJ = 1;
				...
				EDEEMPJPFCP = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.EPAHOAKPAJJ_DecoItem.LPJLEHAJADA_GetIntParam("offset_x_vffigure", 0);
				HDHNEILDILJ = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.EPAHOAKPAJJ_DecoItem.LPJLEHAJADA_GetIntParam("offset_y_vffigure", 0);
			...
			case EKLNMHFCAOI.FKGCBLHOOCL_Category.NNBMEEPOBIO_DecoItemCostumeTorso:
			{
				...
				FJFCNGNGIBN = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.EPAHOAKPAJJ_DecoItem.LPJLEHAJADA_GetIntParam("attr_costume_torso", 12);
				FLJPIHEEKOJ = 1;
				...
				GJMHALIIPME_Type = GBJFNGCDKPM_typ;
				EDEEMPJPFCP = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.EPAHOAKPAJJ_DecoItem.LPJLEHAJADA_GetIntParam("offset_x_costume_torso", 0);
				HDHNEILDILJ = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.EPAHOAKPAJJ_DecoItem.LPJLEHAJADA_GetIntParam("offset_y_costume_torso", 0);
		...
		KGBAOKCMALD = itemId;
		FBFLDFMFFOH_rar = EKLNMHFCAOI.FABCKNDLPDH_GetItemRarity(NPADACLCNAN, _PPFNGGCBJKC_id);
		BFINGCJHOHI_cnt = EKLNMHFCAOI.ALHCGDMEMID_GetNumItems(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, NPADACLCNAN, _PPFNGGCBJKC_id, null);
	...
	public static int IOKFJAIDMLD_GetNumItemsReady(int _KIJAPOFAGPN_ItemId, int DMBFOMLCGBG, long _JHNMKKNEENE_Time)
	{
		...
		NDBFKHKMMCE_DecoItem.FIDBAFHNGCF db = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.EPAHOAKPAJJ_DecoItem.GMONECJCJFK_Sp[itemId - 1];
		return Mathf.Min((int)((s.EMHCHMHMFHJ_ChargeTimeOffset + (_JHNMKKNEENE_Time - s.FOONCJDLLIK_ChargeTime)) / GGEGLPOMJCK_TimeByUnit(_KIJAPOFAGPN_ItemId, DMBFOMLCGBG)), l[db.GBJFNGCDKPM_typ - 1].NANNGLGOFKH_value);
	}
	...
	public static long CFNHNIMKPCI_GetChargeTimeOffset(BCGFHLIEKLJ_DecoItem.GNGFGEIAGJL BBFIGEOBOMB, long _JHNMKKNEENE_Time)
	{
		...
		List<NEGELNMPEPH_DecoSpSetting.DAGLEHBMBLF> l = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.BGKKOOGPEFD_DecoSpSetting.ILCGCPIGAFP[BBFIGEOBOMB.ANAJIAENLNB_lv - 1];
		...
		{
			long t2 = t - GGEGLPOMJCK_TimeByUnit(BBFIGEOBOMB.PPFNGGCBJKC_id, BBFIGEOBOMB.ANAJIAENLNB_lv) * IOKFJAIDMLD_GetNumItemsReady(BBFIGEOBOMB.PPFNGGCBJKC_id, BBFIGEOBOMB.ANAJIAENLNB_lv, _JHNMKKNEENE_Time);
			if(t2 != 0)
				res = t2;
		}
		return res;
	...
	public static long GGEGLPOMJCK_TimeByUnit(int _KIJAPOFAGPN_ItemId, int _CIEOBFIIPLD_Level)
	{
		...
		return (l[db.GBJFNGCDKPM_typ - 1].KPBJHHHMOJE_TimeToChargeMin * 60) / l[db.GBJFNGCDKPM_typ - 1].NANNGLGOFKH_value;
	}
