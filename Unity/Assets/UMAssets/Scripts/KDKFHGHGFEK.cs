...
public class KDKFHGHGFEK
{
	...
	public int GBJFNGCDKPM_Attribute { get; private set; } // 0x30 GHLFADHILNN CEJJMKODOGK HOHCEBMMACI
	...
	public void KHEKNNFCAOI(int PPFNGGCBJKC, EKLNMHFCAOI.FKGCBLHOOCL_Category NPADACLCNAN)
	{
		...
		switch(NPADACLCNAN)
		{
			...
			case EKLNMHFCAOI.FKGCBLHOOCL_Category.OKPAJOALDCG_DecoItemObj:
			{
				...
				CPKMLLNADLJ_Serie = (SeriesAttr.Type)dbItem.CPKMLLNADLJ;
				FLJPIHEEKOJ = dbItem.EKLIPGELKCL;
				GBJFNGCDKPM_Attribute = dbItem.GBJFNGCDKPM_SpType;
			...
			case EKLNMHFCAOI.FKGCBLHOOCL_Category.MCKHJLHKMJD_DecoItemChara:
			{
				...
				GBJFNGCDKPM_Attribute = dbItem.GBJFNGCDKPM;
			...
			case EKLNMHFCAOI.FKGCBLHOOCL_Category.ICIMCGOJEMD_StampItemSerif:
			{
				...
				CPKMLLNADLJ_Serie = (SeriesAttr.Type)dbItem.CPKMLLNADLJ;
				FLJPIHEEKOJ = dbItem.EKLIPGELKCL;
				GBJFNGCDKPM_Attribute = dbItem.GBJFNGCDKPM_FrameId;
				FPCGPGJOKNH_CharaId = dbItem.JBFLEDKDFCO;
			...
			case EKLNMHFCAOI.FKGCBLHOOCL_Category.HEMGMACMGAB_DecoItemVFFigure:
			{
				...
				FLJPIHEEKOJ = 1;
				GBJFNGCDKPM_Attribute = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.EPAHOAKPAJJ_DecoItem.LPJLEHAJADA("typ_vffigure", 3);
				GJMHALIIPME_Type = GBJFNGCDKPM_Attribute;
			...
			case EKLNMHFCAOI.FKGCBLHOOCL_Category.NNBMEEPOBIO_DecoItemCostumeTorso:
			{
				...
				FLJPIHEEKOJ = 1;
				GBJFNGCDKPM_Attribute = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.EPAHOAKPAJJ_DecoItem.LPJLEHAJADA("typ_costume_torso", 3);
				GJMHALIIPME_Type = GBJFNGCDKPM_Attribute;
				...
				EBFLJMOCLNA_Costume.ILFJDCICIKN sIt = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.BEKHNNCGIEL_Costume.FABAGMLEKIB_List[PPFNGGCBJKC - 1];
		...
		BFINGCJHOHI = EKLNMHFCAOI.ALHCGDMEMID_GetNumItems(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, NPADACLCNAN, PPFNGGCBJKC, null);
	...
	public void ODDIHGPONFL(KDKFHGHGFEK GPBJHKLFCEP)
	{
		...
		GBJFNGCDKPM_Attribute = GPBJHKLFCEP.GBJFNGCDKPM_Attribute;
	...
	public static bool EOACAIMCBCG_UpdateCostumeCache()
	{
		...
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null && CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
		{
			...
			for(int i = 0; i < CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.BEKHNNCGIEL_Costume.FABAGMLEKIB_List.Count; i++)
			{
					...
					for(int i = 0; i < JKNMNFKPEAA_CostumeList.Count; i++)
					{
						if(JKNMNFKPEAA_CostumeList[i].BFINGCJHOHI_Cnt > 0)
						{
							...
							if(data.PPFNGGCBJKC_Id > 0)
							{
								...
								data.EILKGEADKGH = data.PPFNGGCBJKC_Id * 10 + dbCos.AHHJLDLAPAN_DivaId * 100000;
                                l2.Add(data);
							}
						}
					}
