...
public class AGLHPOOPOCG
{
	...
	private void BJKCAKJHMPC_GetTopRank(string _DEPGBBJMFED_CategoryId, int HHNFHJCAPJO, MOCLMLOPBLK KLMFJJCNBIP, DJBHIFLHJLK IDAEHNGOKAE, DJBHIFLHJLK JGKOLBLPMPG)
	{
