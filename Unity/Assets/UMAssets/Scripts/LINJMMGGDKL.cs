...
public class LINJMMGGDKL_SecureInt2
{
	...
	public FENCAJJBLBH.EIAPDOGALDK_SecureGroup _KGICDMIJGDF_Group = /*4*/FENCAJJBLBH.EIAPDOGALDK_SecureGroup.PNLBHBFOECC_4_SecureValue; // 0x18
	...
	} } //  JADLONAJDAK_bgs 0x1805374  JFNEHIGOBHH_bgs 0x1805384
	...
	public FENCAJJBLBH KPOCKNCJBPN_CheckSecure()
	{
		if(NMNHBJIAPGG_CheckFalsification == null)
		{
			...
			{
				NMNHBJIAPGG_CheckFalsification = new FENCAJJBLBH(_KGICDMIJGDF_Group, 0, 0, "NetSecureValue2");
			}
		}
