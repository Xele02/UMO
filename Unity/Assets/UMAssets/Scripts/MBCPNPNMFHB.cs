...
public class MBCPNPNMFHB
{
	...
	public void MDGPGGLHIPB(MHOILBOJFHL.KCAEDEHGAFO INDDJNMPONH, IMCBBOAFION HIDFAIBOHCC_OnSuccess, IMCBBOAFION AOCANKOMKFG_OnFail)
	{
		MHOILBOJFHL.KCAEDEHGAFO OIPCCBHIKIA = INDDJNMPONH;
		LKFOCCGOINN l = BAGOKKHNLDB(INDDJNMPONH);
		if(l != null)
		{
			...
			{
				//0xA2E200
				LKFOCCGOINN res = NHECPMNKEFK as LKFOCCGOINN;
	...
	private LKFOCCGOINN BAGOKKHNLDB(MHOILBOJFHL.KCAEDEHGAFO INDDJNMPONH)
	{
		switch(INDDJNMPONH)
		{
			case MHOILBOJFHL.KCAEDEHGAFO.CCFMGBNHMNN:
