...
public class OKLFOAPMJAA
{
	...
	public class BABPHOEGLPC
	{
		...
		internal IEnumerator MBPIBLCIOMJ_Coroutine_Update(int KPNKPGLPDHI, IMCBBOAFION _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK MOBEEPPKFLG)
		{
			//0x14A4160
			LPEPBLHCGKP.HGBINHBILCP();
			yield return Co.R(DGGKAEPHMAJ_Coroutine_Next(KPNKPGLPDHI, GNIINAKDJPA, LDACLKFJEHH, _BHFHGFKBOHH_OnSuccess, MOBEEPPKFLG, true));
		}

		//[IteratorStateMachineAttribute] // RVA: 0x6C2EB8 Offset: 0x6C2EB8 VA: 0x6C2EB8
		//// RVA: 0x14A1BAC Offset: 0x14A1BAC VA: 0x14A1BAC
		internal IEnumerator DGGKAEPHMAJ_Coroutine_Next(int KPNKPGLPDHI, int MKLHCKJEKKC, int PLBOJBHAPLO, IMCBBOAFION _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK MOBEEPPKFLG, bool HOLDBIDPJFJ)
		{
		...
		internal IEnumerator NPJFFIBIAAJ_Coroutine_ForceLoad(int KPNKPGLPDHI, int PLBOJBHAPLO, IMCBBOAFION _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK MOBEEPPKFLG)
		{
			//0x14A2CFC
			LPEPBLHCGKP.HGBINHBILCP();
			LKMKNEGCCHF.Clear();
	...
	public void JLEFHIOELGH(int KPNKPGLPDHI, IMCBBOAFION _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK MOBEEPPKFLG, bool BELNGJDDEIB/* = true*/)
	{
		if(!BELNGJDDEIB)
		{
	...
	public void HDHACKFJKGM(int KPNKPGLPDHI, IMCBBOAFION _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK MOBEEPPKFLG)
	{
		N.a.StartCoroutineWatched(JNBFDCGMECE.DGGKAEPHMAJ_Coroutine_Next(KPNKPGLPDHI, JNBFDCGMECE.GNIINAKDJPA, JNBFDCGMECE.LDACLKFJEHH, _BHFHGFKBOHH_OnSuccess, MOBEEPPKFLG, false));
	}
	...
	public void NPIBJOGODKG(int KPNKPGLPDHI, ANPBHCNJIDI.NNPGLGHDBKN _HCAHCFGPJIF_Desc, IMCBBOAFION _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK MOBEEPPKFLG, DJBHIFLHJLK NKGHADCBGJO)
	{
		NINFIBPLBFO.IDAPJFGJHND();
		FKPJGFFFCDG = true;
		JNBFDCGMECE.LPEPBLHCGKP.NPIBJOGODKG(KPNKPGLPDHI, _HCAHCFGPJIF_Desc, () =>
		{
			//0x14A25A4
			FKPJGFFFCDG = false;
	...
	public void HCMMMCFFGCA_UpdateThreadComment(ANPBHCNJIDI.NNPGLGHDBKN _HCAHCFGPJIF_Desc, IMCBBOAFION _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK MOBEEPPKFLG)
	{
	...
	//public void NCLDLJLAEBK(ANPBHCNJIDI.NNPGLGHDBKN _HCAHCFGPJIF_Desc, IMCBBOAFION _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK MOBEEPPKFLG) { }

	//// RVA: 0x14A2170 Offset: 0x14A2170 VA: 0x14A2170
	public void DADODHBGLKP(int KPNKPGLPDHI, int PLBOJBHAPLO, Action<List<ANPBHCNJIDI.NNPGLGHDBKN>> _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK MOBEEPPKFLG)
	{
		...
		{
			//0x14A2824
			_BHFHGFKBOHH_OnSuccess(LHAFADCJBME.LPEPBLHCGKP.HDMKAIKOMCB);
		}, MOBEEPPKFLG));
	}
}
