...
public class OKLFOAPMJAA
{
	...
	public class BABPHOEGLPC
	{
		...
		private void OBKGEDCKHHE_Init(string LFGDLECGDCL, int MKLHCKJEKKC, int PLBOJBHAPLO, int _EMGJJFKONHK_ExpireDays, bool LAGDKBMDHLD, IGJCFFIGKIJ CHKHBIMFOHO)
		{
			...
			DCPBHPPFJOH = AHAENNIFOAF.IAOPMEAIHLH.HJNNKCMLGFL_M1_None;
			LJMIFOIACKO = 0;
		}
	...
	{
		if(JNBFDCGMECE.LKMKNEGCCHF.Count > 0 && JNBFDCGMECE.DCPBHPPFJOH != AHAENNIFOAF.IAOPMEAIHLH.HJNNKCMLGFL_M1_None)
		{
	...
	public void HDHACKFJKGM(int _KPNKPGLPDHI_Op, IMCBBOAFION _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK _MOBEEPPKFLG_OnFail)
	{
