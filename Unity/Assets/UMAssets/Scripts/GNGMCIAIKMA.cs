...
public class GNGMCIAIKMA
{
		...
		if(saveBingo != null)
		{
			if(saveBingo.BJOHOIAKKFM_Bst != 0)
			{
				if(INDDJNMPONH > 0 && INDDJNMPONH <= DKFJADMCNPI.NLKCMNHOBAI.GJPEANBALKF/*15*/)
				{
					switch(INDDJNMPONH)
					{
						case DKFJADMCNPI.NLKCMNHOBAI.CLJMJHDGPOC/*1*/:
						...
						case DKFJADMCNPI.NLKCMNHOBAI.NGDJIJOIPIB/*9*/:
							...
							return;
						case DKFJADMCNPI.NLKCMNHOBAI.EHEDFAMGLDP/*10*/:
						...
						case DKFJADMCNPI.NLKCMNHOBAI.CLJHDIKFECG/*12*/:
							...
							return;
						case DKFJADMCNPI.NLKCMNHOBAI.OBNEIGIFMFD/*13*/:
							GJENEJOANEL(saveBingo, DKFJADMCNPI.NLKCMNHOBAI.OBNEIGIFMFD/*13*/, PPFNGGCBJKC, HMFFHLPNMPH);
							return;
						case DKFJADMCNPI.NLKCMNHOBAI.DOEHLCLBCNN/*14*/:
	...
	private void GJENEJOANEL(NFMHCLHEMHB_Bingo.CCGKCGJKADC NHLBKJCPLBL, DKFJADMCNPI.NLKCMNHOBAI INDDJNMPONH, int PPFNGGCBJKC, int HMFFHLPNMPH)
	{
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			...
			for(int i = 0; i < l.Count; i++)
			{
				if(INDDJNMPONH == DKFJADMCNPI.NLKCMNHOBAI.OBNEIGIFMFD/*13*/)
				{
