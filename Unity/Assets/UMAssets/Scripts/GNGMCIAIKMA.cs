...
public class GNGMCIAIKMA
{
	public class DFABPMMMIIB
	{
		...
		public int PPFNGGCBJKC_id { get { return EHOIENNDEDH_IdCrypted ^ FBGGEFFJJHB_xor; } set { EHOIENNDEDH_IdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x1E532B4 DEMEPMAEJOO_get_id 0x1E5334C HIGKAIDMOKN_set_id
		public int NMMPEIIDBJL { get { return JLCIMGKBDKD ^ FBGGEFFJJHB_xor; } set { JLCIMGKBDKD = value ^ FBGGEFFJJHB_xor; } } //0x1E533E8 FFOPNIECCMB_bgs 0x1E53480 ECPBEDDJHAL_bgs
		public long PDBPFJJCADD_open_at { get { return PCLNFCNIECH_OpenAtCrypted ^ BBEGLBMOBOF_xorl; } set { PCLNFCNIECH_OpenAtCrypted = value ^ BBEGLBMOBOF_xorl; } } //0x1E5351C FOACOMBHPAC_get_open_at 0x1E535B8 NBACOBCOJCA_set_open_at
		public long FDBNFFNFOND_close_at { get { return HHPIJHADAOB_CloseAtCrypted ^ BBEGLBMOBOF_xorl; } set { HHPIJHADAOB_CloseAtCrypted = value ^ BBEGLBMOBOF_xorl; } } //0x1E5365C BPJOGHJCLDJ_get_close_at 0x1E536F8 NLJKMCHOCBK_set_close_at
		public string OCDMGOGMHGE_KeyPrefix { get { return EBGIDCIIGDO_KeyPrefix.DNJEJEANJGL_Value; } set { EBGIDCIIGDO_KeyPrefix.DNJEJEANJGL_Value = value; } } //0x1E5379C HBAAAKFHDBB_get_KeyPrefix 0x1E537C8 NHJLJOIPOFK_set_KeyPrefix
		...
		public bool KHEKNNFCAOI_Init(int _APFDNBGMMMM_BingoId)
		{
			...
			{
				JKICPBIIHNE_Bingo.HNOGDJFJGPM bingo = HHCJCDFCLOB_Instance.FJLIDJJAGOM_GetBingoDb().JJAICEAEGKF[HHCJCDFCLOB_Instance.NIGPFNIIDII(_APFDNBGMMMM_BingoId)];
				...
				OCDMGOGMHGE_KeyPrefix = bingo.OCDMGOGMHGE_KeyPrefix;
				LNHNECFGEPO.Clear();
				for(int i = 0; i < d.PFEGHILDOGF.Count; i++)
				{
					if(HHCJCDFCLOB_Instance.DKMLDEDKPBA_IsEnabled(d.PFEGHILDOGF[i].PLALNIIBLOF_en))
					{
						...
						for(int j = 0; j < 8; j++)
						{
							...
							data2.DNJEJEANJGL_Value = d.PFEGHILDOGF[i].FKNBLDPIPMC_GetItemCode(j);
				...
				{
					if (HHCJCDFCLOB_Instance.DKMLDEDKPBA_IsEnabled(d.CFHKEJHDGBG[i].PLALNIIBLOF_en))
					{
	...
	public class GGJOIEMJPEF
	{
		...
		public int PPFNGGCBJKC_id { get { return EHOIENNDEDH_IdCrypted ^ FBGGEFFJJHB_xor; } set { EHOIENNDEDH_IdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x1E54794 DEMEPMAEJOO_get_id 0x1E5482C HIGKAIDMOKN_set_id
		public bool EOALGPLPGKB { get { return FGMOPPIODAE == 29; } set { FGMOPPIODAE = (sbyte)(value ? 29 : 63); } } // 0x1E548C8 AINFOGCAHAP_bgs 0x1E548DC ONIAGBIHOKN_bgs
		...
		public bool KHEKNNFCAOI_Init(JKICPBIIHNE_Bingo.CCOCDFGGDBB _NDFIEMPPMLF_master, int IKOLGECGPNM)
		{
			if(HHCJCDFCLOB_Instance != null)
			{
				if(HHCJCDFCLOB_Instance.DKMLDEDKPBA_IsEnabled(_NDFIEMPPMLF_master.PLALNIIBLOF_en))
				{
					...
					for(int i = 0; i < 8; i++)
					{
						...
						data.PPFNGGCBJKC_id = _NDFIEMPPMLF_master.FKNBLDPIPMC_GetItemCode(i);
						data.BFINGCJHOHI_cnt = _NDFIEMPPMLF_master.KAINPNMMAEK_GetItemCount(i);
						data.MPKBLMCNHOM_MissionIsSpecial = _NDFIEMPPMLF_master.BLLCPCGGHJM(i) > 0;
	...
	public class JLHGLHJDAGN
	{
		...
		public int PPFNGGCBJKC_id { get { return EHOIENNDEDH_IdCrypted ^ FBGGEFFJJHB_xor; } set { EHOIENNDEDH_IdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x1E54F04 DEMEPMAEJOO_get_id 0x1E54F9C HIGKAIDMOKN_set_id
		public string FEMMDNIELFC_Desc { get { return FHBDAJIDLNN.DNJEJEANJGL_Value; } set { FHBDAJIDLNN.DNJEJEANJGL_Value = value; } } //0x1E55038 JDHDMBHNKJD_get_Desc 0x1E55064 FNAJEJLLJOE_set_Desc
		public string JEPGJJJBFLN_ConditionText { get { return IDCENBCAPBP.DNJEJEANJGL_Value; } set { IDCENBCAPBP.DNJEJEANJGL_Value = value; } } //0x1E55098 AKHEBLBJGBP_get_ConditionText 0x1E550C4 EEJDMJMLKMG_set_ConditionText
		public int GOKJLBDJOLA_df { get { return EHLGHDIACCG_MusicDifficultyCrypted ^ FBGGEFFJJHB_xor; } set { EHLGHDIACCG_MusicDifficultyCrypted = value ^ FBGGEFFJJHB_xor; } } //0x1E550F8 CCEEILBGBOM_get_df 0x1E55190 MKNIFMGHJHC_set_df
		public int MAPNDFCJFLJ_ConditionType { get { return FILBJBFDMMN_Crypted ^ FBGGEFFJJHB_xor; } set { FILBJBFDMMN_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x1E5522C IPFCNEIHNLJ_get_ConditionType 0x1E552C4 CLNEANLIOFN_set_ConditionType
		public int JBFLEDKDFCO_cid { get { return KGKIDDDKOGL_cidCrypted ^ FBGGEFFJJHB_xor; } set { KGKIDDDKOGL_cidCrypted = value ^ FBGGEFFJJHB_xor; } } //0x1E55360 LIJMKJLDHGP_get_cid 0x1E553F8 NFNCLFPPADP_set_cid
		public int GLCLFMGPMAN_ItemId { get { return AHGCGHAAHOO_ItemIdCrypted ^ FBGGEFFJJHB_xor; } set { AHGCGHAAHOO_ItemIdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x1E55494 LNJAENEGDEL_get_ItemId 0x1E5552C JHIDBGCHOKL_set_ItemId
		public int GJABBJOJPEE { get { return GNMMBOFGBCO_Crypted ^ FBGGEFFJJHB_xor; } set { GNMMBOFGBCO_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x1E555C8 PDMHLKEJELM_bgs 0x1E55660 PHGIOONNIOF_bgs
	...
	public class JCIFAFBDALP
	{
		...
		public int PPFNGGCBJKC_id { get { return EHOIENNDEDH_IdCrypted ^ FBGGEFFJJHB_xor; } set { EHOIENNDEDH_IdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x1E54DBC DEMEPMAEJOO_get_id 0x1E5495C HIGKAIDMOKN_set_id
		public int BFINGCJHOHI_cnt { get { return IFEHKNJONPL_CountCrypted ^ FBGGEFFJJHB_xor; } set { IFEHKNJONPL_CountCrypted = value ^ FBGGEFFJJHB_xor; } } //0x1E54D24 LFMCLIDAPHB_get_cnt 0x1E549F8 EDAEPDGGFJJ_set_cnt
		public bool MPKBLMCNHOM_MissionIsSpecial { get { return AJGFHCKFCHN_Crypted == 29; } set { AJGFHCKFCHN_Crypted = (sbyte)(value ? 29 : 63); } } //0x1E54E54 BOFCPLOLHCJ_bgs 0x1E54A94 FDPPEPOHFNA_bgs
	...
	public class KDGHBAGLKEP
	{
		...
		public int PPFNGGCBJKC_id { get { return EHOIENNDEDH_IdCrypted ^ FBGGEFFJJHB_xor; } set { EHOIENNDEDH_IdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x1E558A0 DEMEPMAEJOO_get_id 0x1E540B4 HIGKAIDMOKN_set_id
		public int FDBOPFEOENF_diva { get { return LLEMDLLGIAH_divaCrypted ^ FBGGEFFJJHB_xor; } set { LLEMDLLGIAH_divaCrypted = value ^ FBGGEFFJJHB_xor; } } //0x1E55938 MJPHCAIKKJG_get_diva 0x1E54150 GHECGDMEBFF_set_diva
		public int CPKMLLNADLJ_Serie { get { return IPAKEGGICML_SerieCrypted ^ FBGGEFFJJHB_xor; } set { IPAKEGGICML_SerieCrypted = value ^ FBGGEFFJJHB_xor; } } //0x1E559D0 BJPJMGHCDNO_get_Serie 0x1E541EC BPKIOJBKNBP_set_Serie
	...
	public const sbyte HKKJGAJPNIL_True = 29;
	public const sbyte FKHFJOKHNAK_False = 63;
	...
	public static GNGMCIAIKMA HHCJCDFCLOB_Instance { get; private set; } // 0x10 GNGMCIAIKMA_bgs OKPMHKNCNAL_bgs
	public int PMPKHBAJAFA_BingoId { get { return ILGOKEAIBBA ^ FBGGEFFJJHB_xor; } set { ILGOKEAIBBA = value ^ FBGGEFFJJHB_xor; } } // OAKEIKFELFC_bgs 0xAB8FE4  MBHILIEPJOO_bgs 0xAB9050
	public int MALACFEDHDE_CurrentCount { get { return NPNDCNDCDPC ^ FBGGEFFJJHB_xor; } set { NPNDCNDCDPC = value ^ FBGGEFFJJHB_xor; } } //  KIMKKEOMPDL_bgs 0xAB90C0 PGILHFKNKEN_bgs 0xAB912C
	private int HHKAGEAMHOE { get { return PFJENHEKCAO ^ FBGGEFFJJHB_xor; } set { PFJENHEKCAO = value ^ FBGGEFFJJHB_xor; } } // DGNHFHGNDOF_bgs 0xAB919C  HDADMLNHJMN_bgs 0xAB9208
	private int EEOPPDBICBN_TutoId { get { return ELNEJEEKOEI_TutoIdCrypted ^ FBGGEFFJJHB_xor; } set { ELNEJEEKOEI_TutoIdCrypted = value ^ FBGGEFFJJHB_xor; } } // GDODEJOPENB_bgs 0xAB9278 JIJIGMCJHBC_bgs 0xAB92E4
	private int CEGHDFHLFPO { get { return IDKOMEFBCBD ^ FBGGEFFJJHB_xor; } set { IDKOMEFBCBD = value ^ FBGGEFFJJHB_xor; } } // CDJABHMPLKM_bgs 0xAB9354  EIHJCGDLLPF_bgs 0xAB93C0
	...
	{
		return GBCPDBJEDHL(NKGJPJPHLIF_SakashoManager.HHCJCDFCLOB_Instance.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime());
	}
	...
	public long DBEDJLOAILN(int _APFDNBGMMMM_BingoId)
	{
		...
		if(saveBingo.AHCFGOGCJKI_St.PPFNGGCBJKC_id > 0)
		{
			...
			if(a2 > 0)
			{
				DateTime date = Utility.GetLocalDateTime(NKGJPJPHLIF_SakashoManager.HHCJCDFCLOB_Instance.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime() + a2 * 86400);
	...
	{
		return OHCAABOMEOF.LDGFHMMAFOC(OHCAABOMEOF.KGOGMKMBCPP_EventType.DIDJLIPNCKO_12_Bingo/*12*/, _PPFNGGCBJKC_id);
	}
	...
	public JKICPBIIHNE_Bingo FJLIDJJAGOM_GetBingoDb()
	{
		...
		{
			return IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FPOIPGFFAPE_Bingo;
		}
		return null;
	}
	...
	public NFMHCLHEMHB_Bingo PDMHKENDJHI_GetSaveBingoBlock()
	{
		...
		{
			return CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.PEGNNEFHDOP_Bingo;
		}
		return null;
	}
	...
	public NFMHCLHEMHB_Bingo.CCGKCGJKADC MENDFPNPAAO_GetSaveBingo(int _PPFNGGCBJKC_id)
	{
		...
		if(saveBingo != null)
		{
			...
			if(res == null)
			{
				NFMHCLHEMHB_Bingo.CCGKCGJKADC n = saveBingo.EACEMMDIPFD_GetFirstUnititialized();
				if(n != null)
				{
	...
	public NFMHCLHEMHB_Bingo.CCGKCGJKADC MENDFPNPAAO_GetSaveBingo(BBHNACPENDM_ServerSaveData _AHEFHIMGIBI_PlayerData, int _PPFNGGCBJKC_id)
	{
		if(_AHEFHIMGIBI_PlayerData.PEGNNEFHDOP_Bingo != null)
		{
			...
			if(bingo == null)
			{
				bingo = _AHEFHIMGIBI_PlayerData.PEGNNEFHDOP_Bingo.EACEMMDIPFD_GetFirstUnititialized();
				if(bingo != null)
				{
	...
	// public bool OIEBCNPOMIB_UpdateDayChange(int _APFDNBGMMMM_BingoId, int _AMCCOGJACPK_CardId, int _EIHOBHDKCDB_RewardId) { }
	...
	public List<JKICPBIIHNE_Bingo.IEGCPLCLOHF> AOIADBHHJAJ_GetValidBingoCells(int _APFDNBGMMMM_BingoId, int _AMCCOGJACPK_CardId, int _CPKMLLNADLJ_Serie, int _AHHJLDLAPAN_DivaId)
	{
		...
		for(int i = 0; i < bingo.DPGMFEGFCJN[0].MFMGDFACBON.Count; i++)
		{
			...
			{
				if(data.PBEEPMLJGJC_Cid == _AMCCOGJACPK_CardId)
				{
					if(data.NDFOAINJPIN_pos < 10)
					{
						...
						res[data.NDFOAINJPIN_pos - 1].PBEEPMLJGJC_Cid = data.PBEEPMLJGJC_Cid;
						...
						res[data.NDFOAINJPIN_pos - 1].JEPGJJJBFLN_ConditionText = data.JEPGJJJBFLN_ConditionText;
	...
	public void GJENEJOANEL(int _APFDNBGMMMM_BingoId, DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType _INDDJNMPONH_type, int _PPFNGGCBJKC_id, int _HMFFHLPNMPH_count, JGEOBNENMAH_NetGameManager.HAJIFNABIFF _OMNOFMEBLAD_clearSetup)
	{
		NFMHCLHEMHB_Bingo.CCGKCGJKADC saveBingo = MENDFPNPAAO_GetSaveBingo(_APFDNBGMMMM_BingoId);
		if(saveBingo != null)
		{
			...
			{
				if(_INDDJNMPONH_type > 0 && _INDDJNMPONH_type <= DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType.GJPEANBALKF_15_EventPlay/*15*/)
				{
					switch(_INDDJNMPONH_type)
					{
						case DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType.CLJMJHDGPOC_1_Shop/*1*/:
							saveBingo.AHCFGOGCJKI_St.JJKBBFEJFGO_Cnt.AGNDGJOPIDL_AddShop(_HMFFHLPNMPH_count);
							return;
						case DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType.IBGNFEOLKDP_2_Login/*2*/:
							saveBingo.AHCFGOGCJKI_St.JJKBBFEJFGO_Cnt.JLKOBAAEDAM_AddLogin(_HMFFHLPNMPH_count);
							return;
						case DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType.KENMCJCIGIB_3_VaklOp/*3*/:
							...
							return;
						case DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType.LFLMBPJJEEG_4_DivaOp/*4*/:
							saveBingo.AHCFGOGCJKI_St.JJKBBFEJFGO_Cnt.NKOPNPPGPCD_AddDOpcValue(_PPFNGGCBJKC_id + -1, _HMFFHLPNMPH_count);
							return;
						case DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType.BCMLFJPLKAM_5_DivaOpOccur/*5*/:
							...
							return;
						case DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType.EGFEFGJLKLA_6_DivaOpPowerup/*6*/:
							...
							return;
						case DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType.HOOJOFACOEK_7_SetCostume/*7*/:
							...
							return;
						case DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType.DAOKJMHHKGP_8_Gift/*8*/:
							...
							return;
						case DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType.NGDJIJOIPIB_9_GetScene/*9*/:
							saveBingo.AHCFGOGCJKI_St.JJKBBFEJFGO_Cnt.CNEMNJOLIBE_AddScene(_HMFFHLPNMPH_count);
							return;
						case DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType.EHEDFAMGLDP_10_Medal/*10*/:
							saveBingo.AHCFGOGCJKI_St.JJKBBFEJFGO_Cnt.EJDEINMOHOP_AddMedal(_HMFFHLPNMPH_count);
							return;
						case DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType.KJAFDMGNBPO_11_DailyMission/*11*/:
							saveBingo.AHCFGOGCJKI_St.JJKBBFEJFGO_Cnt.OAEMBFCMCHL_DailyMission(_HMFFHLPNMPH_count);
							return;
						case DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType.CLJHDIKFECG_12_Mission/*12*/:
							saveBingo.AHCFGOGCJKI_St.JJKBBFEJFGO_Cnt.HFOCJMOOMBB_EventMission(_HMFFHLPNMPH_count);
							return;
						case DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType.OBNEIGIFMFD_13_MedalShopConsume/*13*/:
							GJENEJOANEL(saveBingo, DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType.OBNEIGIFMFD_13_MedalShopConsume/*13*/, _PPFNGGCBJKC_id, _HMFFHLPNMPH_count);
							return;
						case DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType.DOEHLCLBCNN_14_Gacha/*14*/:
							saveBingo.AHCFGOGCJKI_St.JJKBBFEJFGO_Cnt.BFAJMALBALG_AddGacha(_HMFFHLPNMPH_count);
							return;
						case DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType.GJPEANBALKF_15_EventPlay/*15*/:
							if(_OMNOFMEBLAD_clearSetup != null && !_OMNOFMEBLAD_clearSetup.OBOPMHBPCFE_MvMode && _OMNOFMEBLAD_clearSetup.OEILJHENAHN_PlayEventType > 0)
	...
	public void GJENEJOANEL(BBHNACPENDM_ServerSaveData _AHEFHIMGIBI_PlayerData, int _APFDNBGMMMM_BingoId, DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType _INDDJNMPONH_type, int _PPFNGGCBJKC_id, int _HMFFHLPNMPH_count)
	{
		...
		if(bingo != null)
		{
			...
			{
				if(_INDDJNMPONH_type != DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType.NGDJIJOIPIB_9_GetScene/*9*/)
					return;
	...
	private void GJENEJOANEL(NFMHCLHEMHB_Bingo.CCGKCGJKADC NHLBKJCPLBL, DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType _INDDJNMPONH_type, int _PPFNGGCBJKC_id, int _HMFFHLPNMPH_count)
	{
		if(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database != null)
		{
			BJPLLEBHAGO_DivaInfo divaInfo = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MGFMPKLLGHE_Diva.GCINIJEMHFK_Get(NHLBKJCPLBL.AHCFGOGCJKI_St.AHHJLDLAPAN_DivaId);
			...
			for(int i = 0; i < l.Count; i++)
			{
				if(_INDDJNMPONH_type == DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType.OBNEIGIFMFD_13_MedalShopConsume/*13*/)
				{
	...
	public void GJENEJOANEL(DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType _INDDJNMPONH_type, int _OIPCCBHIKIA_index, int _HMFFHLPNMPH_count, JGEOBNENMAH_NetGameManager.HAJIFNABIFF _OMNOFMEBLAD_clearSetup)
	{
		List<int> l = CNADOFDDNLO_GetActiveBingos();
		for(int i = 0; i < l.Count; i++)
		{
			GJENEJOANEL(l[i], _INDDJNMPONH_type, _OIPCCBHIKIA_index, _HMFFHLPNMPH_count, _OMNOFMEBLAD_clearSetup);
		}
	}

	// // RVA: 0xABEB0C Offset: 0xABEB0C VA: 0xABEB0C
	public void GJENEJOANEL(BBHNACPENDM_ServerSaveData _AHEFHIMGIBI_PlayerData, DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType _INDDJNMPONH_type, int _OIPCCBHIKIA_index, int _HMFFHLPNMPH_count)
	{
		List<int> l = CNADOFDDNLO_GetActiveBingos();
		for(int i = 0; i < l.Count; i++)
		{
	...
	public int GOIAHBFBKPF(int _APFDNBGMMMM_BingoId, JGEOBNENMAH_NetGameManager.HAJIFNABIFF _OMNOFMEBLAD_clearSetup, JKICPBIIHNE_Bingo.IEGCPLCLOHF _KOGBMDOONFA_Info, OKGLGHCBCJP_Database _LKMHPJKIFDN_md, BBHNACPENDM_ServerSaveData _LDEGEHAEALK_ServerData, int _HMFFHLPNMPH_count)
	{
		...
		if(type < 34)
		{
			if(type == 23)
			{
				...
				if (_OMNOFMEBLAD_clearSetup.KNIFCANOHOC_score > _HMFFHLPNMPH_count)
					return _OMNOFMEBLAD_clearSetup.KNIFCANOHOC_score;
				return _HMFFHLPNMPH_count;
			}
			if(type == 31)
			{
		...
		switch(type)
		{
			...
			case 65:
				if(CHOFDPDFPDC_ConfigValue < 1)
				{
					...
					if(b > 0)
					{
						c = _LDEGEHAEALK_ServerData.BEKHNNCGIEL_Costume.EEOADCECNOM_GetCostume(2).FJODMPGPDDD_Unlocked ? 1 : 0;
					}
					return (b - c) - l.Count;
				}
				else
				{
					...
					for(int i = 0; i < l.Count; i++)
					{
						...
						if(c.JPIDIENBGKH_CostumeId != 2)
						{
							...
							{
								res += _LDEGEHAEALK_ServerData.BEKHNNCGIEL_Costume.EEOADCECNOM_GetCostume(c.JPIDIENBGKH_CostumeId).FJODMPGPDDD_Unlocked ? 1 : 0;
							}
						}
					}
					return res;
			...
			case 70:
				if(CHOFDPDFPDC_ConfigValue < 1)
				{
					...
					{
						if(_LDEGEHAEALK_ServerData.BEKHNNCGIEL_Costume.FABAGMLEKIB_CostumeList[i].FJODMPGPDDD_Unlocked)
						{
	...
	public bool FGHOILFCCKC(JGEOBNENMAH_NetGameManager.HAJIFNABIFF _OMNOFMEBLAD_clearSetup, JKICPBIIHNE_Bingo.IEGCPLCLOHF _KOGBMDOONFA_Info, OKGLGHCBCJP_Database _LKMHPJKIFDN_md, BBHNACPENDM_ServerSaveData _LDEGEHAEALK_ServerData, long _JHNMKKNEENE_Time)
	{
		...
		if(_OMNOFMEBLAD_clearSetup != null)
		{
			fminfo = _LKMHPJKIFDN_md.IBPAFKKEKNK_Music.NOBCLJIAMLC_GetFreeMusicData(_OMNOFMEBLAD_clearSetup.GHBPLHBNMBK_FreeMusicId);
		...
		if(a < 32)
		{
			switch (a)
			{
				...
				case 9:
					if (fminfo == null || _OMNOFMEBLAD_clearSetup == null)
						return false;
				...
				case 10:
					if (_OMNOFMEBLAD_clearSetup != null)
					{
						return _KOGBMDOONFA_Info.GOKJLBDJOLA_df == _OMNOFMEBLAD_clearSetup.AKNELONELJK_difficulty;
					}
					break;
				case 12:
					if (_OMNOFMEBLAD_clearSetup != null)
				...
				case 13:
					if (_OMNOFMEBLAD_clearSetup != null)
					{
						return fminfo.EMJCHPDJHEI(_OMNOFMEBLAD_clearSetup.LFGNLKKFOCD_IsLine6, _OMNOFMEBLAD_clearSetup.AKNELONELJK_difficulty).DLPBHJALHCK_GetScoreRank(_OMNOFMEBLAD_clearSetup.KNIFCANOHOC_score) == 4;
					}
					break;
				case 21:
					if (_OMNOFMEBLAD_clearSetup != null)
					{
						return _OMNOFMEBLAD_clearSetup.KNCBNGCDMII_HadValkyrieMode;
					}
					break;
				case 22:
					if (_OMNOFMEBLAD_clearSetup != null)
		...
		switch(a)
		{
			...
			case 60:
				if (_OMNOFMEBLAD_clearSetup != null)
					return _OMNOFMEBLAD_clearSetup.GHBPLHBNMBK_FreeMusicId == val;
				break;
			case 63:
				if(_OMNOFMEBLAD_clearSetup != null)
				{
					for(int i = 0; i < _OMNOFMEBLAD_clearSetup.CPNOKMINILL_SkillDataList.Count; i++)
					{
						if (_OMNOFMEBLAD_clearSetup.CPNOKMINILL_SkillDataList[i].isActive && (int)_OMNOFMEBLAD_clearSetup.CPNOKMINILL_SkillDataList[i].skillType == val)
							return true;
					}
				}
				break;
			...
			case 72:
				if(_OMNOFMEBLAD_clearSetup != null)
				{
					List<IBJAKJJICBC> list = IBJAKJJICBC.FKDIMODKKJD_GetList(5, _OMNOFMEBLAD_clearSetup.NFFDIGEJHGL_ServerTime, true, false, false, false);
					for(int i = 0; i < list.Count; i++)
					{
						if(list[i].LHONOILACFL_IsWeeklyEvent)
						{
							if (_OMNOFMEBLAD_clearSetup.GHBPLHBNMBK_FreeMusicId == list[i].GHBPLHBNMBK_FreeMusicId)
								return true;
						}
					}
				}
	...
	public bool HEFIKPAHCIA_UpdateMission(JGEOBNENMAH_NetGameManager.HAJIFNABIFF _OMNOFMEBLAD_clearSetup, long JHNMKKNEENE_Time/* = -1*/)
    {
		List<int> l = CNADOFDDNLO_GetActiveBingos();
		if(JHNMKKNEENE_Time < 0)
		{
			JHNMKKNEENE_Time = NKGJPJPHLIF_SakashoManager.HHCJCDFCLOB_Instance.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime();
		}
		bool res = false;
		for(int i = 0; i < l.Count; i++)
		{
			res |= HEFIKPAHCIA_UpdateMission(l[i], _OMNOFMEBLAD_clearSetup, JHNMKKNEENE_Time);
		}
		return res;
    }

	// // RVA: 0xAC1228 Offset: 0xAC1228 VA: 0xAC1228
	public bool HEFIKPAHCIA_UpdateMission(int _APFDNBGMMMM_BingoId, JGEOBNENMAH_NetGameManager.HAJIFNABIFF _OMNOFMEBLAD_clearSetup, long _JHNMKKNEENE_Time/* = -1*/)
	{
		if(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database != null && CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData != null)
		{
            ...
            if (bingo.BJOHOIAKKFM_Bst != 0)
			{
				...
				if(_OMNOFMEBLAD_clearSetup != null)
				{
					KEODKEGFDLD_FreeMusicInfo fminfo = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.IBPAFKKEKNK_Music.NOBCLJIAMLC_GetFreeMusicData(_OMNOFMEBLAD_clearSetup.GHBPLHBNMBK_FreeMusicId);
					minfo = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.IBPAFKKEKNK_Music.IAJLOELFHKC_GetMusicInfo(fminfo.DLAEJOBELBH_MusicId);
					ADDHLABEFKH a = fminfo.EMJCHPDJHEI(_OMNOFMEBLAD_clearSetup.LFGNLKKFOCD_IsLine6, _OMNOFMEBLAD_clearSetup.AKNELONELJK_difficulty);
					scoreRank = a.DLPBHJALHCK_GetScoreRank(_OMNOFMEBLAD_clearSetup.KNIFCANOHOC_score);
					rankCombo = a.CCFAAPPKILD_GetRankCombo(_OMNOFMEBLAD_clearSetup.NLKEBAOBJCM_combo);
				}
				int diva = bingo.AHCFGOGCJKI_St.AHHJLDLAPAN_DivaId;
                BJPLLEBHAGO_DivaInfo divaInfo = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MGFMPKLLGHE_Diva.GCINIJEMHFK_Get(diva);
				int attr = 0;
				if(divaInfo != null)
				{
				...
				for(int i = 0; i < l.Count; i++)
				{
					...
					else
					{
						if(l[i].CPKMLLNADLJ_Serie < 1 || (l[i].CPKMLLNADLJ_Serie == minfo.AIHCEGFANAM_SerieAttr))
						{
							...
							{
								if(_OMNOFMEBLAD_clearSetup.AKNELONELJK_difficulty < (l[i].GOKJLBDJOLA_df - 1))
									continue;
							}
					...
					if(b)
					{
						...
						if(FGHOILFCCKC(_OMNOFMEBLAD_clearSetup, l[i], IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database, CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData, 0))
						{
							int a = GOIAHBFBKPF(_APFDNBGMMMM_BingoId, _OMNOFMEBLAD_clearSetup, l[i], IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database, CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData, bingo.AHCFGOGCJKI_St.HDMADAHNLDN_Missions[l[i].NDFOAINJPIN_pos - 1].HMFFHLPNMPH_count);
	...
	public List<JJPEIELNEJB.JLHHGLANHGE> HNBJHJENFGL(JJPEIELNEJB.OMMBBPKFLNH _KOGBMDOONFA_Info, List<int> FFLGNFIAFFE)
	{
		...
		for(int i = 0; i < FFLGNFIAFFE.Count; i++)
		{
			...
			data.MJBKGOJBPAD_item_type = EKLNMHFCAOI_ItemManager.BKHFLDMOGBD_GetItemCategory(data.GLCLFMGPMAN_ItemId);
			data.OCNINMIMHGC_item_value = EKLNMHFCAOI_ItemManager.DEACAHNLMNI_getItemId(data.GLCLFMGPMAN_ItemId);
			data.HAAJGNCFNJM_item_name = EKLNMHFCAOI_ItemManager.INCKKODFJAP_GetItemName(data.GLCLFMGPMAN_ItemId);
			...
			res.Add(data);
			CPIICACGNBH_AddItem(CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.JANMJPOKLFL_InventoryUtil, CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData, data.GLCLFMGPMAN_ItemId, data.LJKMKCOAICL_ItemCount, _KOGBMDOONFA_Info.APFDNBGMMMM_BingoId);
			saveBingo.AHCFGOGCJKI_St.HDMADAHNLDN_Missions[FFLGNFIAFFE[i]].CMCKNKKCNDK_status = 3;
			ILCCJNDFFOB.HHCJCDFCLOB_Instance.JHAPELNFEOM(_KOGBMDOONFA_Info.APFDNBGMMMM_BingoId, _KOGBMDOONFA_Info.BECEJMHDBBP[FFLGNFIAFFE[i]].PPFNGGCBJKC_id, _KOGBMDOONFA_Info.BECEJMHDBBP[FFLGNFIAFFE[i]].JEPGJJJBFLN_ConditionText);
		}
		return res;
    }

	// // RVA: 0xAC21E4 Offset: 0xAC21E4 VA: 0xAC21E4
	public void CPIICACGNBH_AddItem(JKNGJFOBADP _JANMJPOKLFL_InventoryUtil, BBHNACPENDM_ServerSaveData _LDEGEHAEALK_ServerData, int _KIJAPOFAGPN_ItemId, int _HMFFHLPNMPH_count, int _APFDNBGMMMM_BingoId)
	{
		StringBuilder str = new StringBuilder();
		str.Append(_APFDNBGMMMM_BingoId);
		str.Append(':');
		_JANMJPOKLFL_InventoryUtil.FEGDNPIEKJC(OAGBCBBHMPF.COIIJOEKBDH_InventoryAddType.DIDJLIPNCKO_29_Bingo, str.ToString());
	...
	public bool NJJLNPOCKFO(int _APFDNBGMMMM_BingoId)
	{
		...
		else
		{
			...
			if(d != null)
			{
				d.MIKCFEHGNJB_dt = NKGJPJPHLIF_SakashoManager.HHCJCDFCLOB_Instance.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime();
				return true;
			}
		}
		return false;
	...
	// public int OBOGIOGEBPK(FKMOKDCJFEN.ADCPCCNCOMD_Status _CMCKNKKCNDK_status) { }
