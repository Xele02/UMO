...
public class GJOOGLGLFID
{
	...
	public void KHEKNNFCAOI()
    {
        ...
        if(ev != null)
        {
            ...
            BJJGECFMNIP_Rank = JGEOBNENMAH.HHCJCDFCLOB.NEFFKLNAAJI[0];
            EKOEECDHABK_ExRanking = JGEOBNENMAH.HHCJCDFCLOB.NEFFKLNAAJI[1];
            BEOKMNIPFBA_MedalId = JGEOBNENMAH.HHCJCDFCLOB.BEOKMNIPFBA;
            ODOOKDGCKMF_MedalNum = FCLGIPFPIPH_DashBonus * JGEOBNENMAH.HHCJCDFCLOB.ODOOKDGCKMF;
            BGJDHCEOIDB_BattleClass = ev.CKCPAMDDNPF.EIMCIBOANHE;
