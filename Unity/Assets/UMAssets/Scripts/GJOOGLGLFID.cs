...
public class GJOOGLGLFID
{
	...
	public int AHOKAPCGJMA_TotalPoint { get { return HJOJJCKDPPJ_Crypted ^ FBGGEFFJJHB; } set { HJOJJCKDPPJ_Crypted = value ^ FBGGEFFJJHB; } } //0xAAE13C GKLPFHEELGM 0xAAE150 EJPEPBGDDJM
