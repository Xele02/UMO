...
public class IOGKADECKOP
{
	...
	// private int FHACAEAHPIA; // 0x30
		...
		if(!FBBAOFKBGBA)
		{
			...
			{
				FHBJNLFHGPB(40);
				NLJKCDHIPEG.AHEFHIMGIBI_Save.JHFIPCIHJNL_Base.FNLNIKFNHAM = true;
				string str1 = NLJKCDHIPEG.AHEFHIMGIBI_Save.JHFIPCIHJNL_Base.OPFGFINHFCE;
				Debug.LogError("TODO CHECK");
				if(str1 == "") // StringLiteral_9806 UTF8?
				{
					NLJKCDHIPEG.AHEFHIMGIBI_Save.JHFIPCIHJNL_Base.AFPONJEJKCO = 0;
				}
				NLJKCDHIPEG.AHEFHIMGIBI_Save.JHFIPCIHJNL_Base.KFKDMBPNLJK = true;
				NLJKCDHIPEG.FMFKHDPKLOC.JHFIPCIHJNL_Base.KFKDMBPNLJK = true;
			...
			//LAB_00a0d064:
			FHBJNLFHGPB(60);
			if(NLJKCDHIPEG.AHEFHIMGIBI_Save.DAEJHMCMFJD_Offer.KNIKMMKNOFA == 3)
			{
				// goto LAB_00a0d0e8;
			}
			else
