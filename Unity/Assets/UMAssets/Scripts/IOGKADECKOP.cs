...
public class IOGKADECKOP
{
	...
	// private int FHACAEAHPIA; // 0x30
		...
		if(!FBBAOFKBGBA)
		{
			...
			{
				FHBJNLFHGPB(40);
				NLJKCDHIPEG.AHEFHIMGIBI_ServerSave.JHFIPCIHJNL_Base.FNLNIKFNHAM = true;
				string str1 = NLJKCDHIPEG.AHEFHIMGIBI_ServerSave.JHFIPCIHJNL_Base.OPFGFINHFCE;
				Debug.LogError("TODO CHECK");
				if(str1 == "") // StringLiteral_9806 UTF8?
				{
					NLJKCDHIPEG.AHEFHIMGIBI_ServerSave.JHFIPCIHJNL_Base.AFPONJEJKCO = 0;
				}
