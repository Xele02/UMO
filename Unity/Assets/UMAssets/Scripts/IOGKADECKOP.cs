	...
	// private int FHACAEAHPIA; // 0x30
		...
		if(!FBBAOFKBGBA_IsError)
		{
			...
			if(!OJFKNEOJEHH_IsError)
			{
				...
				IKDICBBFBMI_EventBase o = JEPBIIJDGEF_EventInfo.HHCJCDFCLOB.OEGDCBLNNFF(/*7*/OHCAABOMEOF.KGOGMKMBCPP_EventType.ENPJADLIFAB_EventSp, /*9*/KGCNCBOKCBA.GNENJEHKMHD.BCKENOKGLIJ_9);
				if(o != null)
