...
public class IMMAOANGPNK
{
	...
	private void AMAFAKNIHFO()
	{
		...
		KDLPEDBKMID.HHCJCDFCLOB.OIKLOJMPBGA(NKEBMCIMJND_Database.GDEKCOOBLMA_System.OHJFBLFELNK[AFEHLCGHAEE.JJHDDBLNOHA/*delay_install_autowait*/].DNJEJEANJGL_Value);
	}
