...
public class KKLGENJKEBN
{
	...
	public void HEOKADCEAGL_GetRanks(string LJNAKDMILMC, IMCBBOAFION KLMFJJCNBIP, DJBHIFLHJLK IDAEHNGOKAE, DJBHIFLHJLK BFKEGJMPELF, DJBHIFLHJLK OPJANCPEKAB)
	{
		LPPCNCMEDFA = 0;
		IPNEJCOFBIB = 0;
		...
		req.BHFHGFKBOHH_OnSuccess = (CACGCMBKHDI_Request NHECPMNKEFK) =>
		{
			...
			{
				IPNEJCOFBIB = r.NFEAMMJIMPG.EJDEDOJFOOK[0].KNIFCANOHOC;
				LPPCNCMEDFA = r.NFEAMMJIMPG.EJDEDOJFOOK[0].FJOLNJLLJEJ;
				KLMFJJCNBIP();
			}
		};
	}
