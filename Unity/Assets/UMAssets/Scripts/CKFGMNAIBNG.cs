...
public class CKFGMNAIBNG
{
	...
	public int ENMAEBJGEKL_SkillId { get { return HCFNIMFOOPF_SkillIdCrypted ^ FBGGEFFJJHB_xor; } set { HCFNIMFOOPF_SkillIdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x107DE8C FHIMMFAEDIP_bgs 0x107DE9C CPEAMPGOMCB_bgs
	public int DEOBDFOPLHG_SkillLevel { get { return NNAPJKPBBKI_Crypted ^ FBGGEFFJJHB_xor; } set { NNAPJKPBBKI_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x107DEAC LHFCGJBCDEE_bgs 0x107DEBC OAGOCCBEFPD_bgs
	public int DAJGPBLEEOB_ModelId { get { return FBGGEFFJJHB_xor ^ HNJNKCPDKAL_CryptedModelId; } set { HNJNKCPDKAL_CryptedModelId = FBGGEFFJJHB_xor ^ value; } } //0x107DECC LHPKEPPBKPF_bgs 0x107DEDC OIOEEEDODJA_bgs
	public int AHHJLDLAPAN_DivaId { get { return CGIGOFKGCII_CryptedDivaId ^ FBGGEFFJJHB_xor; } set { CGIGOFKGCII_CryptedDivaId = FBGGEFFJJHB_xor ^ value; } } //0x107DEEC IPKDLMIDMHH_bgs 0x107DEFC IENNENMKEFO_bgs
	public int JPIDIENBGKH_CostumeId { get { return HFJLOKDMJHI_CostumeIdCrypted ^ FBGGEFFJJHB_xor; } set { HFJLOKDMJHI_CostumeIdCrypted = FBGGEFFJJHB_xor ^ value; } } //0x107DF0C PHLLMIGCPCB_bgs 0x107DF1C BLBNMENMCIF_bgs
	public int GKIKAABHAAD_Level { get { return LMMCLBNCBIO_CryptedLevel ^ FBGGEFFJJHB_xor; } set { LMMCLBNCBIO_CryptedLevel = FBGGEFFJJHB_xor ^ value; } } //0x107DF2C JNDLKKLLAMO_bgs 0x107DF3C PBOBJNPNBHG_bgs
	public int EGLDFPILJLG_SkillBuffEffect { get { return NPCEOIJLNGB_Crypted ^ FBGGEFFJJHB_xor; } set { NPCEOIJLNGB_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x107DF4C JACADMEJOAH_bgs 0x107DF5C MMDBFGAFINM_bgs
	// public bool LFLNFHKOIIM { get; }

	// // RVA: 0x107DF6C Offset: 0x107DF6C VA: 0x107DF6C
	public short LLJPMOIPBAG_GetColorForLevel(int _BMBBDIAEOMP_i)
	{
	...
	public CKFGMNAIBNG()
    {
        ...
        ECNEBGLPECK = LPDNKHAIOLH.CEIBAFOCNCA_Int() & 0x7fff;
	...
	public void KHEKNNFCAOI_Init(int AHHJLDLAPAN_DivaId, int JPIDIENBGKH_CostumeId, int _GKIKAABHAAD_Level, bool OJEBNBLHPNP/* = false*/)
    {
        LCLCCHLDNHJ_Costume.ILODJKFJJDO_CostumeInfo cosInfo = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MFPNGNMFEAL_Costume.LBDOLHGDIEB_Find(AHHJLDLAPAN_DivaId, JPIDIENBGKH_CostumeId);
		if(CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData != null)
		{
            ...
            EBFLJMOCLNA_Costume.ILFJDCICIKN dbCostumeId = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.BEKHNNCGIEL_Costume.EEOADCECNOM_GetCostume(cosInfo.JPIDIENBGKH_CostumeId);
			FJODMPGPDDD_Unlocked = dbCostumeId.FJODMPGPDDD_Unlocked;
			this.GKIKAABHAAD_Level = _GKIKAABHAAD_Level;
			DEOBDFOPLHG_SkillLevel = cosInfo.DOGKAEAHIMI_GetUnlockedSkillLevel(_GKIKAABHAAD_Level);
    ...
    {
		KHEKNNFCAOI_Init(AHHJLDLAPAN_DivaId, _JPIDIENBGKH_CostumeId, _AHEFHIMGIBI_PlayerData.BEKHNNCGIEL_Costume.EEOADCECNOM_GetCostume(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MFPNGNMFEAL_Costume.LBDOLHGDIEB_Find(AHHJLDLAPAN_DivaId, _JPIDIENBGKH_CostumeId).JPIDIENBGKH_CostumeId).ANAJIAENLNB_lv, OJEBNBLHPNP);
		CEHICAFELBI(_AHEFHIMGIBI_PlayerData);
	}

	// // RVA: 0x107E604 Offset: 0x107E604 VA: 0x107E604
	private static void OHGOPFEOJOG_GetSkillInfo(LCLCCHLDNHJ_Costume.ILODJKFJJDO_CostumeInfo _NDFIEMPPMLF_master, MessageBank GDMBMJBMNME, StringBuilder _JEHFDJPOEFF_str, int HDHANIEDJPA, int _DEOBDFOPLHG_SkillLevel, ref string _OPFGFINHFCE_name, ref string _HCAHCFGPJIF_Desc)
	{
		...
		{
			HBDCPGLAPHH h = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.BIOEJKBCIKD_CenterSkillCostume[HDHANIEDJPA - 1];
			int a = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.EBKAAEDMIBI_CostumeEffectInfo[h.HEKHODDJHAO_P1 - 1].KCOHMHFBDKF_Value1[_DEOBDFOPLHG_SkillLevel - 1];
			if(a > 0)
			{
				StringBuilder str = new StringBuilder(32);
				_JEHFDJPOEFF_str.SetFormat("cs_nm_{0:D4}", _NDFIEMPPMLF_master.HGHFFJKGNCO_SkillId);
				str.SetFormat(GDMBMJBMNME.GetMessageByLabel(_JEHFDJPOEFF_str.ToString()), a);
				_OPFGFINHFCE_name = str.ToString();

				_JEHFDJPOEFF_str.SetFormat("cs_dsc_{0:D4}", _NDFIEMPPMLF_master.HGHFFJKGNCO_SkillId);
				str.SetFormat(GDMBMJBMNME.GetMessageByLabel(_JEHFDJPOEFF_str.ToString()), a);
	...
	public void CEHICAFELBI(BBHNACPENDM_ServerSaveData _AHEFHIMGIBI_PlayerData)
	{
		if(JPIDIENBGKH_CostumeId > 0)
		{
			...
			{
				EJODLFBKFDK_IsNewColor[i] = saveCostume.EJODLFBKFDK_IsNewColor(LLJPMOIPBAG_GetColorForLevel(i));
			}
		}
	}
	...
	public void PDADHMIODCA(BBHNACPENDM_ServerSaveData _AHEFHIMGIBI_PlayerData, int _HEHKNMCDBJJ_ColorId, bool _JKDJCFEBDHC_Enabled)
	{
		...
		for(int i = 0; i < EOGIFMAPOPA_ColsAvaiableFlags_Crypted.Length; i++)
		{
			if(_HEHKNMCDBJJ_ColorId == LLJPMOIPBAG_GetColorForLevel(i))
			{
				idx = i;
				break;
			}
	...
	{
		PDADHMIODCA(CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData, _HEHKNMCDBJJ_ColorId, _JKDJCFEBDHC_Enabled);
	}
	...
	public static List<CKFGMNAIBNG> NEOMKKIEMJJ(BBHNACPENDM_ServerSaveData _KPMOBPNENCD_serverData, bool OJEBNBLHPNP/* = false*/, bool NHMPDLNPBJD/* = false*/)
	{
		...
		{
			LCLCCHLDNHJ_Costume.ILODJKFJJDO_CostumeInfo dbCos = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MFPNGNMFEAL_Costume.CDENCMNHNGA_table[i];
			...
			if (!OJEBNBLHPNP)
			{
				if (dbCos.PPEGAKEIEGM_Enabled == 2)
				{
					...
					{
						if(saveCos.FJODMPGPDDD_Unlocked)
						{
							//LAB_0107f50c
							CKFGMNAIBNG data = new CKFGMNAIBNG();
							data.KHEKNNFCAOI_Init(dbCos.AHHJLDLAPAN_DivaId, dbCos.JPIDIENBGKH_CostumeId, _KPMOBPNENCD_serverData, OJEBNBLHPNP);
	...
	public static string EJOJNFDHDHN_GetName(int _AHHJLDLAPAN_DivaId, int _JPIDIENBGKH_CostumeId)
	{
		return MessageManager.Instance.GetMessage("master", "cos_" + IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MFPNGNMFEAL_Costume.LBDOLHGDIEB_Find(_AHHJLDLAPAN_DivaId, _JPIDIENBGKH_CostumeId).JPIDIENBGKH_CostumeId.ToString("D4"));
	}
	...
	public static int LLJPMOIPBAG_GetColorForLevel(int _AHHJLDLAPAN_DivaId, int _JPIDIENBGKH_CostumeId, int _ANAJIAENLNB_lv)
	{
		return IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MFPNGNMFEAL_Costume.LBDOLHGDIEB_Find(_AHHJLDLAPAN_DivaId, _JPIDIENBGKH_CostumeId).LLJPMOIPBAG_GetColorForLevel(_ANAJIAENLNB_lv);
	}
	...
	{
		return IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MFPNGNMFEAL_Costume.LBDOLHGDIEB_Find(_AHHJLDLAPAN_DivaId, _JPIDIENBGKH_CostumeId).MHIKGGMOPOJ(_HEHKNMCDBJJ_ColorId);
	}
}
