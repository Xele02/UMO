...
public class MKCJNKIEADB
{
	...
	public virtual void KHEKNNFCAOI(EDOHBJAPLPF_JsonData IDLHJIOMJBK)
	{
		...
		EGBOHDFBAPB_CloseAt = JsonUtil.GetLong(IDLHJIOMJBK, AFEHLCGHAEE_Strings.EGBOHDFBAPB_CloseAt);
	...
	public bool ILOKENBBBAE(long _BEBJKJKBOGH_Date)
	{
		if(KBFOIECIADN_OpenAt == 0 || _BEBJKJKBOGH_Date >= KBFOIECIADN_OpenAt)
		{
			if(EGBOHDFBAPB_CloseAt == 0 || _BEBJKJKBOGH_Date < EGBOHDFBAPB_CloseAt)
			{
				return _BEBJKJKBOGH_Date >= MMPCPKODGKI_ResetAt;
			}
		}
		return false;
	}
