...
public class IDLAIOHLFDI_GetLoginBonuses : CACGCMBKHDI_Request
{
	...
	{
		public List<MKCJNKIEADB> CEBOHGGJBMN_LoginBonuses = new List<MKCJNKIEADB>(); // 0x8
		...
		{
			EDOHBJAPLPF_JsonData b = _IDLHJIOMJBK_Data[AFEHLCGHAEE_Strings.CEBOHGGJBMN_LoginBonuses];
			CEBOHGGJBMN_LoginBonuses = new List<MKCJNKIEADB>(b.HNBFOAJIIAL_Count);
