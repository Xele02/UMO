...
public class HDPDEAJGJEO_PaymentGetPurchasingStatus : CACGCMBKHDI_Request
{
	...
	{
		public bool OIJLNFJALJP; // 0x8
		public List<FDECBLBCNIC> HIAIAJJPCDE; // 0xC
	...
	{
		TodoLogger.Log(0, "HDPDEAJGJEO_PaymentGetPurchasingStatus.DHLDNIEELHO");
	}

	// RVA: 0x1742DD8 Offset: 0x1742DD8 VA: 0x1742DD8 Slot: 13
	public override void MGFNKDPHFGI(MonoBehaviour DANMJLOBLIE)
	{
		TodoLogger.Log(0, "HDPDEAJGJEO_PaymentGetPurchasingStatus.MGFNKDPHFGI");
	}
}
