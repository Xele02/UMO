...
public class HNFBMAFPDLB_GetRegularRankingRanksAroundTarget : CACGCMBKHDI_Request
{
	...
	{
		EBGACDGNCAA_CallContext = SakashoRegularRanking.GetRegularRankingRanksAroundTarget(DEPGBBJMFED_CategoryId, HHNFHJCAPJO, NHPCKCOPKAM, PJFKNNNDMIA, MLPEHNBNOGD, DCKLDDCAJAP, MEOCKCJBDAD);
	}
