...
public class PGCGJPPBOOA
{
	...
	public int HEIPELEDAIK; // 0xC
	public string OPFGFINHFCE; // 0x10
	public string OCGFKMHNEOF; // 0x14
	public string KLMPFGOCBHC; // 0x18
	public long KBFOIECIADN; // 0x20
	public long HEOKKHAGEIE; // 0x28
	public long ENMGMCHECGE; // 0x30
	public long GKOAEJDMLED; // 0x38
	public long EGBOHDFBAPB; // 0x40
	public long OFJFGMDBFPK; // 0x48
	public int DNBPICNPJNE; // 0x50
	public int ADKJLADBKKK; // 0x54
	public bool KDIDMAMLBLO; // 0x58
	public bool DNDNFAAOOBA; // 0x59
	public bool KBJAHKHGHAN; // 0x5A
	public bool GFENIDOHDFP; // 0x5B
...
public class KNHMEGDFNBP_GetRankings : CACGCMBKHDI_Request
{
	...
	// RVA: 0x112278C Offset: 0x112278C VA: 0x112278C Slot: 7
