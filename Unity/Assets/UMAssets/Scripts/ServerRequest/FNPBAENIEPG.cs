...
public class FNPBAENIEPG_PurchaseAndSave : CACGCMBKHDI_Request
{
	...
	public void DOMFHDPMCCO(BBHNACPENDM_ServerSaveData.EMHDCKMFCGE IDLHJIOMJBK, int _AFKAGFOFAHM_ProductId, int BPNPBJALGHM, int APHNELOFGAK)
	{
		AHEFHIMGIBI_PlayerData = IDLHJIOMJBK.PBNINEMAOPB();
		CHDDDCCHJJH = !IDLHJIOMJBK.BLOCFLFHCFJ_Keep;
	...
	{
		EBGACDGNCAA_CallContext = SakashoPayment.PurchaseAndSave(AFKAGFOFAHM_ProductId, BPNPBJALGHM, APHNELOFGAK, HHIHCJKLJFF.ToArray(), AHEFHIMGIBI_PlayerData, CHDDDCCHJJH, DCKLDDCAJAP, MEOCKCJBDAD);
	}
