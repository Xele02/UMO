...
public class FIDDMIAEFEA_GetRankingRecordsByKeys : CACGCMBKHDI_Request
{
	...
	public List<string> JIMKNDJMCID; // 0x7C
	public FIDDMIAEFEA_GetRankingRecordsByKeys.HHAPIDPPJJK NFEAMMJIMPG; // 0x80

	// public override bool OIDCBBGLPHL { get; }

	// // RVA: 0x14E8960 Offset: 0x14E8960 VA: 0x14E8960 Slot: 7
