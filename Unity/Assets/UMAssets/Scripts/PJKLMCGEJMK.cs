...
public class PJKLMCGEJMK
{
    ...
    {
    	UnityEngine.Debug.LogError("Enter NBCKHIAINIM_Coroutine_Execute");
        ...
        while(true)
        {
            ...
            if(enterIf)
            {
                ...
                SakashoAPICallContext GPBPFELFMFL = ADKIDBJCAJA.EBGACDGNCAA;
                //LAB_00934228
                ...
                {
                    ADKIDBJCAJA.CJMFJOMECKI = error.getErrorId();
                ...
                // L 573
                if(ADKIDBJCAJA.CJMFJOMECKI == /*1*/SakashoErrorId.INTERNAL_SERVER_ERROR)
                {
                    NELKBIEGFIF(ADKIDBJCAJA);
                }
                if(ADKIDBJCAJA.CJMFJOMECKI == /*170*/SakashoErrorId.APPLICATION_UNDER_MAINTENANCE)
                {
                    LMBLIFCNKCJ = true;
                }
                if(EHLBPCGHLCL(ADKIDBJCAJA, ADKIDBJCAJA.CJMFJOMECKI, true))
                {
                ...
                {
                    if(ADKIDBJCAJA.NBFDEFGFLPJ(ADKIDBJCAJA.CJMFJOMECKI))
                    {
                        break;
                    }
                }
                bool APGOAMNGFFF = false;
                yield return N.a.StartCoroutine(MELKAFEGNMD(ADKIDBJCAJA, ADKIDBJCAJA.CJMFJOMECKI, errorResponse, errorJSon, () => {
                    //0x933250
                    APGOAMNGFFF = true;
                }));
                // L 663
        ...
        if(!KADMOOOMMJF)
        {
            ...
            if(a == null)
            {
    	        UnityEngine.Debug.LogError("Exit NBCKHIAINIM_Coroutine_Execute");
                yield break;
            }
        }
        else
        ...
        a(ADKIDBJCAJA);
    	UnityEngine.Debug.LogError("Exit "+(KADMOOOMMJF?" Error":"")+" NBCKHIAINIM_Coroutine_Execute");
    }
    ...
    {
    	UnityEngine.Debug.LogError("Enter MELKAFEGNMD");
        UnityEngine.Debug.LogError("TODO");
    	UnityEngine.Debug.LogError("Exit MELKAFEGNMD");
        yield break;
    }
    ...
    {
    	UnityEngine.Debug.LogError("Enter AOMMJNJGFEL");
        UnityEngine.Debug.LogError("TODO");
    	UnityEngine.Debug.LogError("Exit AOMMJNJGFEL");
        yield break;
    }
    ...
    {
    	UnityEngine.Debug.LogError("Enter GGOECCJJPFN");
        UnityEngine.Debug.LogError("TODO");
    	UnityEngine.Debug.LogError("Exit GGOECCJJPFN");
        yield break;
    }
