...
public struct AEGLGBOGDHH
{
	...
	public void DIJOPLHIMBO(JGEOBNENMAH.NEDILFPPCJF BGDCOKFCCBO, StatusData HFEMKGEOHJL, StatusData PDIPANKOKOL, int IFCPCIHJANL, int LCIPPBOFPOB)
	{
		...
		BGDCOKFCCBO.MINAGJOIGOP = IFCPCIHJANL;
		...
		BGDCOKFCCBO.IBFPGFJDLEI = LCIPPBOFPOB;
		BGDCOKFCCBO.APPEPDLOPAA = CLCIOEHGFNI.CMCKNKKCNDK.soul;
		BGDCOKFCCBO.LHBINHCMEDA = CLCIOEHGFNI.CMCKNKKCNDK.vocal;
		BGDCOKFCCBO.BPNAAEDJGPC = CLCIOEHGFNI.CMCKNKKCNDK.charm;
	}
