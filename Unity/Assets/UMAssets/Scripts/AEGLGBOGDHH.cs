...
public struct AEGLGBOGDHH
{
	...
	public void DIJOPLHIMBO(JGEOBNENMAH.NEDILFPPCJF BGDCOKFCCBO, StatusData HFEMKGEOHJL, StatusData _PDIPANKOKOL_FriendStat, int IFCPCIHJANL, int LCIPPBOFPOB)
	{
		...
		BGDCOKFCCBO.HBKBKHACHHI_ParaSoul = HFEMKGEOHJL.soul + d.soul;
		BGDCOKFCCBO.GMECIBOJCFF_ParaVoice = HFEMKGEOHJL.vocal + d.vocal;
		BGDCOKFCCBO.MIMLMJGGNJH_para_charm = HFEMKGEOHJL.charm + d.charm;
		BGDCOKFCCBO.IPEKDLNEOFI_ParaLife = HFEMKGEOHJL.life + d.life;
		BGDCOKFCCBO.BFHPKJEKJNN_ParaSupport = HFEMKGEOHJL.support + d.support;
		BGDCOKFCCBO.DDBEJNGJIPF_Fold = HFEMKGEOHJL.fold + d.fold;
		BGDCOKFCCBO.CBOCBLLOMHE_ParaTotal = HFEMKGEOHJL.Total + d.Total;
