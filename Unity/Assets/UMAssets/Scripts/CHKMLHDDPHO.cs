...
public class CHKMLHDDPHO
{
	...
	// public void JCHLONCMPAJ(BCGFHLIEKLJ_DecoItem.GNGFGEIAGJL KOGBMDOONFA) { }

	// // RVA: 0x12C80B8 Offset: 0x12C80B8 VA: 0x12C80B8
	// public void KFFPODKBAOD(BCGFHLIEKLJ_DecoItem.GNGFGEIAGJL KOGBMDOONFA, IMCBBOAFION MHFGKMFMKON, DJBHIFLHJLK BJCLMGKNHIF, CHKMLHDDPHO.HKGCIPJGEFG FMKECCHDHBL) { }
	...
	// public KDKFHGHGFEK ODOGCNNGPCN(BCGFHLIEKLJ_DecoItem.GNGFGEIAGJL KOGBMDOONFA) { }

	// // RVA: 0x12C958C Offset: 0x12C958C VA: 0x12C958C
	// public int PAKNKLJEMBI(BCGFHLIEKLJ_DecoItem.GNGFGEIAGJL KOGBMDOONFA) { }

	// // RVA: 0x12C95C4 Offset: 0x12C95C4 VA: 0x12C95C4
	// public int PAKNKLJEMBI(BCGFHLIEKLJ_DecoItem.GNGFGEIAGJL KOGBMDOONFA, KDKFHGHGFEK IJHHPOKOBJF) { }

	// // RVA: 0x12C8068 Offset: 0x12C8068 VA: 0x12C8068
	// public bool KEPMKHNFJCN(BCGFHLIEKLJ_DecoItem.GNGFGEIAGJL KOGBMDOONFA) { }

	// // RVA: 0x12C9680 Offset: 0x12C9680 VA: 0x12C9680
	// public bool KEPMKHNFJCN(BCGFHLIEKLJ_DecoItem.GNGFGEIAGJL KOGBMDOONFA, KDKFHGHGFEK IJHHPOKOBJF) { }

	// // RVA: 0x12C9624 Offset: 0x12C9624 VA: 0x12C9624
	// public int OKMELNIIMMO(BCGFHLIEKLJ_DecoItem.GNGFGEIAGJL KOGBMDOONFA) { }

	// // RVA: 0x12C80F0 Offset: 0x12C80F0 VA: 0x12C80F0
	// private bool BGJCNDOBHCL(BCGFHLIEKLJ_DecoItem.GNGFGEIAGJL KOGBMDOONFA, CHKMLHDDPHO.HKGCIPJGEFG FMKECCHDHBL) { }

	// // RVA: 0x12C8408 Offset: 0x12C8408 VA: 0x12C8408
	// private void HJMKBCFJOOH(IMCBBOAFION _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK MOBEEPPKFLG) { }
