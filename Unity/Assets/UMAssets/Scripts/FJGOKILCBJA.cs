						...
						else
						{
							...
							if(JDGLDMPOCKH_ConsumeItemCat != EKLNMHFCAOI.FKGCBLHOOCL_Category.IBBDMIFICCN_BonusVC)
							{
								...
								CIOECGOMILE.HHCJCDFCLOB.AIKJMHBDABF_SavePlayerData(() =>
								{
									...
									{
										GNGMCIAIKMA.HHCJCDFCLOB.GJENEJOANEL(DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType.CLJMJHDGPOC_1_Shop, 0, _JLENMGOCHDG_Count, null);
										if(BMAKHHKJNEG == EKLNMHFCAOI.FKGCBLHOOCL_Category.ADCAAALBAIF_Medal)
										{
											if(DFMCFJNBNJI_ConsumeItemId > 0)
											{
												...
												{
													GNGMCIAIKMA.HHCJCDFCLOB.GJENEJOANEL(DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType.OBNEIGIFMFD_13_MedalShopConsume, BGHCIAOANCF_BuyItemId, _JLENMGOCHDG_Count, null);
												}
											}
										}
							...
							if(GLHFDCKOJDN != null)
							{
								...
								if(!GIGHIFOIMNA)
								{
									...
									CIOECGOMILE.HHCJCDFCLOB.AIKJMHBDABF_SavePlayerData(() =>
									{
										...
										ILCCJNDFFOB.HHCJCDFCLOB.DBNECDJCNOI_ShopBuy(OPKDAIMPJBH_ShopId, CDMILJLEPHK.NEMKDKDIIDK_ShopName, MABBBOEAPAA_p.EFNMDPKEJIM_LineupId, AFKAGFOFAHM_ProductId, JPJMHLNOIAJ_ItemCostFullId, IFDHJKDDLIM_ConsumItemCount, PEKOLGMLJAL_AfterConsumeItemCount, BGHCIAOANCF_BuyItemId, GJNAOBBAPOF_BuyItemCount, FFBPGKHIKGD_AfterBuyItemCount, _JLENMGOCHDG_Count, JLENMGOCHDG_Count, MABBBOEAPAA_p.JLENMGOCHDG_Count, EAPILIMHDNP_BuyLimitDate, NFBLLKHBMEK_SakashoProductId, DJPBDDBNMLN_SakashoProductName);
										_BHFHGFKBOHH_OnSuccess();
									}, () =>
									{
										//0x1183A20
