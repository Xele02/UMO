...
public class IBJAKJJICBC : EEDKAACNBBG_MusicData
{
	...
	public class ANJLFFPBAEF_DifficultyInfo
	{
		...
		public int NLBLLLLBHOP_Crypted = FBGGEFFJJHB_xor; // 0x8
		public int NBOLDNMPJFG_Crypted = FBGGEFFJJHB_xor; // 0xC
		...
		public int CMCKNKKCNDK_Status { get { return NLBLLLLBHOP_Crypted ^ FBGGEFFJJHB_xor; } set { NLBLLLLBHOP_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x12203C0 CNKGOPKANGF 0x1215B00 CHJGGLFGALP
		public int KNIFCANOHOC_Score { get { return NBOLDNMPJFG_Crypted ^ FBGGEFFJJHB_xor; } set { NBOLDNMPJFG_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x1214AC0 EOJEPLIPOMJ 0x1215AB0 AEEMBPAEAAI
		...
		public int CIEOBFIIPLD_Level { get { return HHMLMKAEJBJ_Score.ANAJIAENLNB_Level; } } //0x1220424 OGKGFGMKPKB
	...
	public int LOFKFOCAJGB_Crypted = FBGGEFFJJHB_xor; // 0xA0
	...
	public int OEILJHENAHN_PlayEventType { get { return MJLNDHPNFHE_PlayEventCrypted ^ FBGGEFFJJHB_xor; } set { MJLNDHPNFHE_PlayEventCrypted = value ^ FBGGEFFJJHB_xor; } } //0x12132F8 MGJDCGJMEKP 0x121330C IMJDLLMCMAH // MJLNDHPNFHE
	...
	public bool MNDFBBMNJGN_NoEnergy { get { return LOFKFOCAJGB_Crypted != FBGGEFFJJHB_xor; } } //0x12141B8 KLMOKPHBBOC  LOFKFOCAJGB
	public int JKIADEKHGLC_TicketId { get { return LOFKFOCAJGB_Crypted ^ FBGGEFFJJHB_xor; } set { LOFKFOCAJGB_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x12141D4 OMELGCEEHKD 0x12141E8 EJEGDHIDAHL  LOFKFOCAJGB
	...
	public int LMPNAPIGAEA(WeekdayEventAttr.Type INDDJNMPONH)
	{
		...
		{
			int a = 1;
			int a2 = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.NKDGLGCAPEI_GrowItem.CDENCMNHNGA_table[EKLNMHFCAOI.DEACAHNLMNI_getItemId(ICHJBDPJNMA_GetWeeklyItem(INDDJNMPONH, 2)) - 1].INDDJNMPONH;
			if (a2 >= 2 && a2 < 6)
	...
	{
		bool res = false;
		if((int)_AKNELONELJK_Difficulty < MGJKEJHEBPO_DiffInfos.Count)
		{
			int score = MGJKEJHEBPO_DiffInfos[(int)_AKNELONELJK_Difficulty].KNIFCANOHOC_Score;
	...
	public void KHEKNNFCAOI(int _GHBPLHBNMBK_FreeMusicId, bool HCIKDFECJGE/* = false*/, int NLKONOBBDJK/* = 0*/, int IOFOHHOJCBE/* = 0*/, long JHNMKKNEENE/* = 0*/, bool PJLNJJIBFBN/* = false*/, bool LICNKMNIKBF/* = false*/, bool _GIKLNODJKFK_IsLine6/* = false*/)
	{
		...
		for (int i = 0; i < count; i++)
		{
			...
			if(!_GIKLNODJKFK_IsLine6)
			{
				...
				info.HPBPDHPIBGN_EnemyData.KHEKNNFCAOI(musicInfo.LHICAKGHIGF_EnemyIdByDiff[i], musicInfo.LJPKLMJPLAC_DIn[i]);
			...
			if(info.HHMLMKAEJBJ_Score != null)
			{
				...
				info.BPLOEAHOPFI_Stamina = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.HNMMJINNHII_Game.HHEEPBJNAKA_GetEnergy(info.HHMLMKAEJBJ_Score.ANAJIAENLNB_Level, _GIKLNODJKFK_IsLine6);
	...
	private void FAEBEJENNHD(IKDICBBFBMI_EventBase LIKDEHHKFEH)
	{
		...
		if(LIKDEHHKFEH != null)
		{
			AFCMIOIGAJN_EventInfo.KINJOEIAHFK_OpenTime = LIKDEHHKFEH.GLIMIGNNGGB_RankingStart;
			AFCMIOIGAJN_EventInfo.PCCFAKEOBIC_CloseTime = LIKDEHHKFEH.DPJCPDKALGI_RankingEnd;
	...
	private void OKLGJBKAJGH(IKDICBBFBMI_EventBase LIKDEHHKFEH, int OOCBPMNHLPM)
	{
		...
		if(LIKDEHHKFEH != null)
		{
			NOKBLCDMLPP_MinigameEventInfo.KINJOEIAHFK_OpenTime = LIKDEHHKFEH.GLIMIGNNGGB_RankingStart;
			NOKBLCDMLPP_MinigameEventInfo.PCCFAKEOBIC_CloseTime = LIKDEHHKFEH.DPJCPDKALGI_RankingEnd;
	...
	public void PMKBMGNAJIL(HLEBAINCOME_EventScore LIKDEHHKFEH, bool _GIKLNODJKFK_IsLine6)
	{
		...
		for(int diffIdx = 0; diffIdx < cnt; diffIdx++)
		{
			...
			if(!_GIKLNODJKFK_IsLine6)
			{
				...
				diff.HPBPDHPIBGN_EnemyData.KHEKNNFCAOI(m.LHICAKGHIGF_EnemyIdByDiff[diffIdx], m.LJPKLMJPLAC_DIn[diffIdx]);
			...
			diff.BPLOEAHOPFI_Stamina = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.HNMMJINNHII_Game.HHEEPBJNAKA_GetEnergy(diff.HHMLMKAEJBJ_Score.ANAJIAENLNB_Level, _GIKLNODJKFK_IsLine6);
	...
	private void NIIMCBEJHDE(AMLGMLNGMFB_EventAprilFool LIKDEHHKFEH, int MNKCJGIGPJP, bool _GIKLNODJKFK_IsLine6)
	{
		...
		for(int i = 0; i < c; i++)
		{
			...
			if(!_GIKLNODJKFK_IsLine6)
			{
				...
				data.HPBPDHPIBGN_EnemyData.KHEKNNFCAOI(m.LHICAKGHIGF_EnemyIdByDiff[i], m.LJPKLMJPLAC_DIn[i]);
			...
			data.BPLOEAHOPFI_Stamina = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.HNMMJINNHII_Game.HHEEPBJNAKA_GetEnergy(data.HHMLMKAEJBJ_Score.ANAJIAENLNB_Level, _GIKLNODJKFK_IsLine6);
	...
	private void JBOHCKEIHKI(int _GHBPLHBNMBK_FreeMusicId, long JIHKOPIENAC, bool PJLNJJIBFBN, int PGIIDPEGGPI)
	{
		GHBPLHBNMBK_FreeMusicId = _GHBPLHBNMBK_FreeMusicId;
		KEODKEGFDLD_FreeMusicInfo m = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.IBPAFKKEKNK_Music.GEAANLPDJBP_FreeMusicData[GHBPLHBNMBK_FreeMusicId - 1];
		base.KHEKNNFCAOI(m.DLAEJOBELBH_MusicId);
	...
	private void NPEKPHAFMGE_SetupEnemies(int _CPBFAMJEODF_CSkill, int MGHPJNNDCIG)
	{
		for(int i = 0; i < MGJKEJHEBPO_DiffInfos.Count; i++)
		{
			MGJKEJHEBPO_DiffInfos[i].HPBPDHPIBGN_EnemyData.NPEKPHAFMGE_OverrideSkill(_CPBFAMJEODF_CSkill, MGHPJNNDCIG);
		}
	}
	...
	public static List<IBJAKJJICBC> FKDIMODKKJD(int _DEPGBBJMFED_CategoryId, long JHNMKKNEENE_Date, bool OJEBNBLHPNP/* = true*/, bool EHBPHDPHPKF/* = false*/, bool JNBMBDFKEOI/* = false*/, bool JCOJKAHFADL/* = false*/)
    {
		...
		else
		{
			...
			if (eventScore != null)
			{
				...
				{
					if(!JCOJKAHFADL || ib.GBNOALJPOBM_IsLine6)
					{
						res.Add(ib);
					}
				}
					...
					for (int j = 0; j < l.Count; j++)
					{
						...
						if (data.GHBPLHBNMBK_FreeMusicId > 0)
						{
							...
							else
							{
								...
								if (!JCOJKAHFADL || data.GBNOALJPOBM_IsLine6)
								{
									res.Add(data);
								}
							}
		...
		for (int i = 0; i < numSongs; i++)
		{
			...
			if (musicInfo.PPEGAKEIEGM_Enabled == 2)
			{
				if (musicInfo.GBNOALJPOBM_IsLine6 || !JCOJKAHFADL)
				{
					...
					if (_DEPGBBJMFED_CategoryId == 5)
					{
						...
						{
							CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.LCKMBHDMPIP_RecordMusic.FAMANJGJANN_FreeMusicInfo[i].FKBPJCDBDAG_SetWeekEventServerDate(JHNMKKNEENE_Date);
							//Setup vars
							//L311
							b = true;
	...
	private static List<IKDICBBFBMI_EventBase> DJPFFHLCCNL(OHCAABOMEOF.KGOGMKMBCPP_EventType INDDJNMPONH, long JHNMKKNEENE, KGCNCBOKCBA.GNENJEHKMHD_EventStatus BELFNAHNMDL/* = KGCNCBOKCBA.GNENJEHKMHD_EventStatus.BCKENOKGLIJ_9_ResultRewardreceived*/)
	{
	...
	public static List<IBJAKJJICBC> ENHMHDALFDB(long JHNMKKNEENE, bool EHBPHDPHPKF/* = False*/, bool JCOJKAHFADL/* = False*/)
	{
		...
		if(ev != null)
		{
			if(ev.HIDHLFCBIDE_EventType == OHCAABOMEOF.KGOGMKMBCPP_EventType.AOPKACCDKPA_EventCollection && ev.NGOFCFJHOMI_Status < KGCNCBOKCBA.GNENJEHKMHD_EventStatus.EMAMLLFAOJI_Counting_6)
			{
				...
				{
					ib = new IBJAKJJICBC();
					ib.KHEKNNFCAOI(lm[i], false, 0, 0, JHNMKKNEENE, ev.PJLNJJIBFBN, true, JCOJKAHFADL);
					if(!JCOJKAHFADL || ib.GBNOALJPOBM_IsLine6)
					{
						...
						{
							for(int j = 0; j < ib.MGJKEJHEBPO_DiffInfos.Count; j++)
							{
								ib.MGJKEJHEBPO_DiffInfos[j].PPDPGKHKCNB = ev.EAMODCHMCEL_GetTicketCost(j, JCOJKAHFADL);
							}
							ib.JKIADEKHGLC_TicketId = ev.JKIADEKHGLC_TicketItemId;
						}
        ...
        if (ev != null && ev.HIDHLFCBIDE_EventType == OHCAABOMEOF.KGOGMKMBCPP_EventType.PFKOKHODEGL_EventBattle)
		{
			...
			for(int i = 0; i < c; i++)
			{
				if(isExRival || eventBattle.PIPHAKNMIBL_Rivals[i].BHCIFFILAKJ_Strength < 3)
				{
					...
					ib.OGHOPBAKEFE_IsEventSpecial = true;
					if(ib.GBNOALJPOBM_IsLine6 || !JCOJKAHFADL)
					{
						res.Add(ib);
					}
				}
	...
	public static List<IBJAKJJICBC> LIENJMIJMIE(long JHNMKKNEENE, bool _GBNOALJPOBM_IsLine6/* = false*/)
    {
	...
	public static List<IBJAKJJICBC> FMHFMIMDOCM(int _DEPGBBJMFED_CategoryId, long JHNMKKNEENE, bool JCOJKAHFADL /*= False*/)
	{
		return MJAJPHIKGBF(_DEPGBBJMFED_CategoryId, JHNMKKNEENE, JCOJKAHFADL, JEPBIIJDGEF_EventInfo.HHCJCDFCLOB.MKBJOOAILBB_GetEventByStatus(KGCNCBOKCBA.GNENJEHKMHD_EventStatus.EMAMLLFAOJI_Counting_6, false), OHCAABOMEOF.KGOGMKMBCPP_EventType.NKDOEBONGNI_EventMission);
	}

	// // RVA: 0x121DF50 Offset: 0x121DF50 VA: 0x121DF50
	public static List<IBJAKJJICBC> DHFHJBMKEHN(int _DEPGBBJMFED_CategoryId, long JHNMKKNEENE, bool JCOJKAHFADL/* = False*/)
	{
		return MJAJPHIKGBF(_DEPGBBJMFED_CategoryId, JHNMKKNEENE, JCOJKAHFADL, JEPBIIJDGEF_EventInfo.HHCJCDFCLOB.OEGDCBLNNFF(OHCAABOMEOF.KGOGMKMBCPP_EventType.CADKONMJEDA_EventRaid, KGCNCBOKCBA.GNENJEHKMHD_EventStatus.EMAMLLFAOJI_Counting_6), OHCAABOMEOF.KGOGMKMBCPP_EventType.CADKONMJEDA_EventRaid);
	}

	// // RVA: 0x121E028 Offset: 0x121E028 VA: 0x121E028
	public static List<IBJAKJJICBC> ONHHIHBHKPK(int _DEPGBBJMFED_CategoryId, long JHNMKKNEENE, bool JCOJKAHFADL/* = False*/)
	{
		List<IBJAKJJICBC> res = MJAJPHIKGBF(_DEPGBBJMFED_CategoryId, JHNMKKNEENE, JCOJKAHFADL, JEPBIIJDGEF_EventInfo.HHCJCDFCLOB.OEGDCBLNNFF(OHCAABOMEOF.KGOGMKMBCPP_EventType.BNECMLPHAGJ_EventGoDiva, KGCNCBOKCBA.GNENJEHKMHD_EventStatus.EMAMLLFAOJI_Counting_6), OHCAABOMEOF.KGOGMKMBCPP_EventType.BNECMLPHAGJ_EventGoDiva);
	...
	private static List<IBJAKJJICBC> MJAJPHIKGBF(int _DEPGBBJMFED_CategoryId, long JHNMKKNEENE, bool JCOJKAHFADL, IKDICBBFBMI_EventBase FBFNJMKPBBA, OHCAABOMEOF.KGOGMKMBCPP_EventType HIDHLFCBIDE)
	{
		int cnt = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.IBPAFKKEKNK_Music.GEAANLPDJBP_FreeMusicData.Count;
		int cnt2 = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.LCKMBHDMPIP_RecordMusic.FAMANJGJANN_FreeMusicInfo.Count;
		if(cnt2 < cnt)
			cnt = cnt2;
		List<IBJAKJJICBC> res = new List<IBJAKJJICBC>();
		if(FBFNJMKPBBA != null && _DEPGBBJMFED_CategoryId == 5 && FBFNJMKPBBA.HIDHLFCBIDE_EventType == HIDHLFCBIDE)
		{
				...
				else if(_DEPGBBJMFED_CategoryId == 5)
				{
					if(evWeekDay != null)
					{
						if(evWeekDay.FLPDCNBLOKL_IsSongForWeekDay((int)dow, song.GHBPLHBNMBK_FreeMusicId))
						{
							...
							//LAB_0121db68
							IBJAKJJICBC ib = new IBJAKJJICBC();
							ib.KHEKNNFCAOI(song.GHBPLHBNMBK_FreeMusicId, true, (int)dow, evWeekDay.ELEPHBOKIGK_Limit + evWeekDay.AEHCKNNGAKF_BonusMaxCount, JHNMKKNEENE, IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.GDEKCOOBLMA_System.FPGDAPAILAK_ExtremeUnlock == 2, false, JCOJKAHFADL);
							ib.MNNHHJBBICA_GameEventType = (int)HIDHLFCBIDE;
	...
	public static List<IBJAKJJICBC> GCCBCAKFJMF(int _DEPGBBJMFED_CategoryId, long JHNMKKNEENE, int OAFJONPIFGM, bool JCOJKAHFADL/* = False*/)
	{
		List<IBJAKJJICBC> res = new List<IBJAKJJICBC>();
		if(_DEPGBBJMFED_CategoryId == 5)
		{
			...
			if(ev.HIDHLFCBIDE_EventType < OHCAABOMEOF.KGOGMKMBCPP_EventType.KEILBOLBDHN_EventScore)
			{
				if(ev.HIDHLFCBIDE_EventType == OHCAABOMEOF.KGOGMKMBCPP_EventType.AOPKACCDKPA_EventCollection)
				{
					...
					{
						IBJAKJJICBC ib = new IBJAKJJICBC();
						ib.KHEKNNFCAOI(l[i], false, 0, 0, JHNMKKNEENE, ev.PJLNJJIBFBN, true, false);
						ib.MNNHHJBBICA_GameEventType = 1;
						ib.MFJKNCACBDG_OpenEventType = 1;
						ib.OEILJHENAHN_PlayEventType = 1;
						ib.BJANNALFGGA_HasRanking = false;
						...
						if(ev.MNDFBBMNJGN_IsUsingTicket)
						{
							for(int j = 0; j < ib.MGJKEJHEBPO_DiffInfos.Count; i++)
							{
								ib.MGJKEJHEBPO_DiffInfos[i].PPDPGKHKCNB = ev.EAMODCHMCEL_GetTicketCost(i, JCOJKAHFADL);
							}
							ib.JKIADEKHGLC_TicketId = ev.JKIADEKHGLC_TicketItemId;
						}
						res.Add(ib);
				...
				ev.HIDHLFCBIDE_EventType == OHCAABOMEOF.KGOGMKMBCPP_EventType.NKDOEBONGNI_EventMission)
			{
				...
				{
					IBJAKJJICBC ib = new IBJAKJJICBC();
					ib.KHEKNNFCAOI(ls[i], false, 0, 0, JHNMKKNEENE, ev.PJLNJJIBFBN, true, false);
					...
					ib.EKANGPODCEP_EventId = OAFJONPIFGM;
					res.Add(ib);
				}
			}
        }
	...
	public static IBJAKJJICBC MLMMPFACEKI_FindMusicInLists(int _GHBPLHBNMBK_FreeMusicId, List<IBJAKJJICBC> OEAJOJMOGMH, List<IBJAKJJICBC> FCCKCFEEOMN, List<IBJAKJJICBC> LCKJDADHOEB, List<IBJAKJJICBC> BAOEHOFNOOG, List<IBJAKJJICBC> EGLEKOHJBNA, List<IBJAKJJICBC> GEEODBLIDDB, ref int EIPGHNKPAOH, ref int OIPCCBHIKIA)
	{
		EIPGHNKPAOH = 0;
		OIPCCBHIKIA = 0;
