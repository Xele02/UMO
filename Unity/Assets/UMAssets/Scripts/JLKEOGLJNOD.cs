...
public class JLKEOGLJNOD
{
	...
	public void PJOOMNIEGPP(List<FFHPBEPOMAK> NBIGLBMHEDC, BBHNACPENDM AHEFHIMGIBI)
	{
		UnityEngine.Debug.LogError("TODO JLKEOGLJNOD PJOOMNIEGPP");
		NGHKJOEDLIP = AHEFHIMGIBI.MLAFAACKKBG.GCINIJEMHFK(0);
	}
