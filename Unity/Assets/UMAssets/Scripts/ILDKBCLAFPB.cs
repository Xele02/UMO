...
public class ILDKBCLAFPB
{
    ...
    public class MPHNGGECENI
    {
        ...
        public int BGLLCLEDHKK; // 0x8
        public int HOMPENLIHCK; // 0xC
        public int CNCIMBGLKOB; // 0x10
        public int LMDACNNJDOE; // 0x14
        public int ICGAOAFIHFD; // 0x18
        public int FCKEDCKCEFC; // 0x1C
        public int IBEINHHMHAC; // 0x20
        public int CJFAJNMADBA; // 0x24
        public int NFMEIILKACN; // 0x28
        public int NAGJLEIPAAC; // 0x2C
        public int DADIPGPHLDD; // 0x30
        public int DDHCLNFPNGK; // 0x34
        ...
        public int FPJHOLMLDGC; // 0x68
        public int CDGKHMEOEMP; // 0x6C
        public int OLALFDCEHKJ; // 0x70
        public int FPFAMFOPJDJ; // 0x74
        public int DCHMOFLEFMI; // 0x78
        public int MBOEPFLNDOD; // 0x7C
        public int MGOOLKHAPAF; // 0x80
        public int AIKDLBAANLG; // 0x84
        public int KOKDGGOFPPI; // 0x88
        public int LIPAPGABJOA; // 0x8C
        public int JDJBFBPBLDC; // 0x90
        public int FJKNAHGFAPP; // 0x94
        public int LHJHOFNIJJF; // 0x98
        public bool ODOEJMPJHME; // 0x9C
        public int LBIKGDHCICB; // 0xA0
        public int JJDENMHGOIH; // 0xA4
        public int KDNKCOAJGCM; // 0xA8
        public int BBIOMNCILMC; // 0xAC
        public bool GDLAPBKCBFP; // 0xB0
        public int BAGJHPGGCCI; // 0xB4
        public bool EDDMJEMOAGM; // 0xB8
        public bool CJKKALFPMLA; // 0xB9
        public bool KPFAFLBICLA; // 0xBA
        public bool MJHEPGIEDDL; // 0xBB
        public int HLABNEIEJPM; // 0xBC
        public int HJPDHDHMOPF; // 0xC0
        public bool BIEOIPOLFLN; // 0xC4
    ...
    {
        // public FOLMONPGGPP HKGPAMEKGKG; // 0x8
        // public DNLECGEBDOI IAHLNPMFJMH; // 0xC
        public MPHNGGECENI CNLJNGLMMHB; // 0x10
        public BEJIKEOAJHN MHHPDGJLJGE; // 0x14
        // public APLMBKKCNKC MCNEIJAOLNO; // 0x18
        // public IJDOCJCLAIL PPCGEFGJJIC; // 0x1C
        // public JDBOPCADICO BOJCCICAHJK; // 0x20
        // public EHNBPANMAKA OFMECFHNCHA; // 0x24
        // public FNDHMLLDACE NDOKECOAPML; // 0x28
        // public HEJDCGGIADL LDNJHLLKEIG; // 0x2C
        // public NKHHJGFNAKI LPBFPCGDOGC; // 0x30
        // public DBAJCPLEMDP PFOMECFACLL; // 0x34
        // public DJJGOGFPCEA GBCEALJIKFN; // 0x38
        // public JCFNHPMBPLJ EGNEDJLCMAI; // 0x3C
        // public CMKCDNCHNKH MOBOMOEHGAO; // 0x40
        // public ABEMIFANBMF DKFCBKNPPOO; // 0x44
        // public ICEOHGGIBBE NNKKOLHBGEL; // 0x48
        // public EIHCEKNKHJB IOAFPGDJCDH; // 0x4C
        // public FIDNFICGLEE KPHPNFBBLPA; // 0x50
        // public AKKDKBOBKGH ICFDECCGKIL; // 0x54
        ...
        // // RVA: 0x2019E18 Offset: 0x2019E18 VA: 0x2019E18
        // public void .ctor() { }
    }
	...
	// Fields
	// private static Action<ILDKBCLAFPB.IPHAEFKCNMN>[] BKDGANJBPPG; // 0x0
	// private CipherRijndael MIDAHPPDINB; // 0x8
	private const string AGLECLBEGCE = "SaveData";
	private const string EDAOODPKLLI = "save.bin";
	// private ILDKBCLAFPB.IPHAEFKCNMN GLANNFOPMDO; // 0xC
	// private ILDKBCLAFPB.IPHAEFKCNMN CGFIFBHIBCF; // 0x10
	...
	public ILDKBCLAFPB.EJFLCPHPMCA PCODDPDFLHK()
    {
        UnityEngine.Debug.LogError("TODO");
