...
public class ILDKBCLAFPB
{
	...
	public class APLMBKKCNKC_Select
	{
		...
		public class PLHMBFFLEPB_MissionEvent
		{
			...
			public void NGNECOFAMKP_SetCategoryId(FreeCategoryId.Type DEPGBBJMFED)
			{
				OMKLPMBJLIO_CategoryId = (int)DEPGBBJMFED;
			}

			//// RVA: 0x2024F58 Offset: 0x2024F58 VA: 0x2024F58
			public void ACGKEJKPFIA_SetMusicIdForCategory(FreeCategoryId.Type DEPGBBJMFED, int GHBPLHBNMBK)
			{
				LGMDOEIPLAK_FreeMusicIds[(int)DEPGBBJMFED - 1] = GHBPLHBNMBK;
			}

			//// RVA: 0x2024FE4 Offset: 0x2024FE4 VA: 0x2024FE4
			public void FKJBADIPKHK_GetMusicIdForCategory(FreeCategoryId.Type DEPGBBJMFED, out int GHBPLHBNMBK)
			{
	...
	public class GCLIKCLDDKG_PlayerData
	{
		...
		public void INBCGKAFHDO(BBHNACPENDM_ServerSaveData _AHEFHIMGIBI_PlayerData)
		{
			...
			{
				_AHEFHIMGIBI_PlayerData.MLAFAACKKBG_Unit.GCINIJEMHFK(0).FDBOPFEOENF_MainDivas[0].DIPKCALNIII_Id = DGCJCAHIAPP_DivaData.PPFNGGCBJKC_Id;
				_AHEFHIMGIBI_PlayerData.MLAFAACKKBG_Unit.GCINIJEMHFK(0).FDBOPFEOENF_MainDivas[0].EBDNICPAFLB_SSlot[0] = DGCJCAHIAPP_DivaData.AFBMEMCHJCL_MainScene.DNJEJEANJGL_Value;
				_AHEFHIMGIBI_PlayerData.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[DGCJCAHIAPP_DivaData.PPFNGGCBJKC_Id - 1].CPGFPEDMDEH_Have = 1;
				_AHEFHIMGIBI_PlayerData.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[DGCJCAHIAPP_DivaData.PPFNGGCBJKC_Id - 1].BEEAIAAJOHD_CostumeId = 0;
				_AHEFHIMGIBI_PlayerData.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[DGCJCAHIAPP_DivaData.PPFNGGCBJKC_Id - 1].AFNIOJHODAG_CostumeColorId = 0;
				_AHEFHIMGIBI_PlayerData.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[DGCJCAHIAPP_DivaData.PPFNGGCBJKC_Id - 1].PIGLAEFPNEK_MSlot = DGCJCAHIAPP_DivaData.AFBMEMCHJCL_MainScene.DNJEJEANJGL_Value;
				_AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.NIKCFOALFJC_DivaFirst = DGCJCAHIAPP_DivaData.PPFNGGCBJKC_Id;
			}
			...
			for(int i = 0; i < KKAOCDKGJHJ_DropItems.Count; i++)
			{
				...
				{
					_AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.KBMDMEEMGLK_GrowItem[itemId - 1].BFINGCJHOHI_Cnt += KKAOCDKGJHJ_DropItems[i].HMFFHLPNMPH_Count;
				}
		...
		public void MNGKOHKKAHI(BBHNACPENDM_ServerSaveData _AHEFHIMGIBI_PlayerData)
		{
			for(int i = 0; i < _AHEFHIMGIBI_PlayerData.PNLOINMCCKH_Scene.OPIBAPEGCLA.Count; i++)
			{
				...
				{
					PNLOINMCCKH_SceneData.EDEDFDDIOKO(_AHEFHIMGIBI_PlayerData.PNLOINMCCKH_Scene.OPIBAPEGCLA[i]);
					break;
				}
			}
			...
			for(int i = 0; i < _AHEFHIMGIBI_PlayerData.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList.Count; i++)
			{
				...
				{
					DGCJCAHIAPP_DivaData.PPFNGGCBJKC_Id = _AHEFHIMGIBI_PlayerData.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[i].DIPKCALNIII_DivaId;
					DGCJCAHIAPP_DivaData.AFBMEMCHJCL_MainScene.DNJEJEANJGL_Value = _AHEFHIMGIBI_PlayerData.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[i].PIGLAEFPNEK_MSlot;
					break;
				}
			}
		}
	...
	public class IJDOCJCLAIL_SortProprty
	{
		...
		public class MMALELPFEBH_UserList
		{
			...
			//public void .ctor(int LHPDCGNKPHD, int NPEEPPCPEPE, int _ACCHOFLOOEC_RarityFilter, int BOFFOHHLLFG, int BBIIHLNBHDE, int LKPCKPJGJKN, int EILKGEADKGH) { }
		...
		public class KLIBOIEIMBA_EventMission
		{
			...
			public int KHAJGNDEPMG_FilterMusicLevelMin { get { return OOJKCGDIPIH_FilterMusicLevelMin_Crypted ^ FBGGEFFJJHB; } set { OOJKCGDIPIH_FilterMusicLevelMin_Crypted = value ^ FBGGEFFJJHB; } } //0x2031C58 MLGBACGCCEA 0x2031C68 OHHKCBNKFHD
			public int IKFKKJLBBBN_FilterMusicLevelMax { get { return CPBHIHNOIHB_FilterMusicLevelMax_Crypted ^ FBGGEFFJJHB; } set { CPBHIHNOIHB_FilterMusicLevelMax_Crypted = value ^ FBGGEFFJJHB; } } //0x2031C78 FCGLOBJNLLH 0x2031C88 CPIMGEMMJJE
	...
	public class ABEMIFANBMF_Offer
	{
		...
		public void AHOBDLOOLHD(int _AHHJLDLAPAN_DivaId, int ANAJIAENLNB)
		{
			if(_AHHJLDLAPAN_DivaId > 0 && _AHHJLDLAPAN_DivaId - 1 < 10)
			{
				IDCCFDHKJNP_LastVOP_DivaLv[_AHHJLDLAPAN_DivaId - 1] = ANAJIAENLNB;
		...
		{
			GHKKEFGDIBC_LastVFP_Unlock = _ADPPAIPFHML_Num;
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				if (GHKKEFGDIBC_LastVFP_Unlock == CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.GHKKEFGDIBC_LastVfpUnlock)
					return;
				if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.GHKKEFGDIBC_LastVfpUnlock <= GHKKEFGDIBC_LastVFP_Unlock)
				{
					CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.GHKKEFGDIBC_LastVfpUnlock = GHKKEFGDIBC_LastVFP_Unlock;
					return;
				}
				GHKKEFGDIBC_LastVFP_Unlock = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.GHKKEFGDIBC_LastVfpUnlock;
			}
		}
		...
		public void AHAECLAKMIB_UpdateDailyLv(int ANAJIAENLNB)
		{
			...
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				if (CHFMCFNEFEO_LastVOP_DailyLv == CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.CHFMCFNEFEO_LastVopDailyLv)
					return;
				if (CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.CHFMCFNEFEO_LastVopDailyLv <= CHFMCFNEFEO_LastVOP_DailyLv)
				{
					CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.CHFMCFNEFEO_LastVopDailyLv = CHFMCFNEFEO_LastVOP_DailyLv;
					return;
				}
				CHFMCFNEFEO_LastVOP_DailyLv = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.CHFMCFNEFEO_LastVopDailyLv;
			}
		}
