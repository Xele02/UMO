...
public class ILDKBCLAFPB
{
	...
	public class APLMBKKCNKC_Select
	{
		...
		public class JPAIABGDMCK_RaidLobbyEvent
		{
			...
			{
				return LFGLBIAODLE.KNMEGCIAIAO_NewsletterUpdateAt == CJDJGHIIBHP.KNMEGCIAIAO_NewsletterUpdateAt &&
		...
		public class OAMMINGBAPE_Skip
		{
			...
			{
				return LFGLBIAODLE.MDDGHHALFKF_Skip == CJDJGHIIBHP.MDDGHHALFKF_Skip &&
		...
		public class MEMAEGKMBJM_UnitMenu
		{
			...
			{
				return LFGLBIAODLE.BLABFAMKLIN_UnitInfoDispType == CJDJGHIIBHP.BLABFAMKLIN_UnitInfoDispType;
			}
		...
		public class KOOHLCAIIGJ_StepUpQuest
		{
			...
			{
				return LFGLBIAODLE.IAPNOPFIPAG_IsShowNextInfo == CJDJGHIIBHP.IAPNOPFIPAG_IsShowNextInfo;
			}
	...
	public class IJDOCJCLAIL_SortProprty
	{
		public class CLBMCCEEDGE_VerticalMusicSelect
		{
			...
			{
				return ILEKEPJBFDP.EOCPIGDIFNB_MusicAttrFilterBits == GEPALDIIDPC.EOCPIGDIFNB_MusicAttrFilterBits &&
		...
		public class MMALELPFEBH_UserList
		{
			...
			{
				return ILEKEPJBFDP.LHPDCGNKPHD_sortItem == GEPALDIIDPC.LHPDCGNKPHD_sortItem &&
		...
		public class LPNOICEBNEL_MusicSelect
		{
			...
			{
				return ILEKEPJBFDP.EOCPIGDIFNB_FilterMusicAttr == GEPALDIIDPC.EOCPIGDIFNB_FilterMusicAttr &&
		...
		public class FPMABHADHBB_EventGoDiva
		{
			...
			public static bool CHDGLBBFEKH(FPMABHADHBB_EventGoDiva ILEKEPJBFDP, FPMABHADHBB_EventGoDiva GEPALDIIDPC)
			{
				return ILEKEPJBFDP.EOCPIGDIFNB_FilterMusicAttr == GEPALDIIDPC.EOCPIGDIFNB_FilterMusicAttr &&
					...
					ILEKEPJBFDP.JGOJDHFAHHE_FilterScoreRank == GEPALDIIDPC.JGOJDHFAHHE_FilterScoreRank &&
					ILEKEPJBFDP.PGMJCBIHNHK_FilterReward == GEPALDIIDPC.PGMJCBIHNHK_FilterReward &&
					(ILEKEPJBFDP.FBGGEFFJJHB ^ ILEKEPJBFDP.OOJKCGDIPIH_FilterMusicLevelMin) == (GEPALDIIDPC.OOJKCGDIPIH_FilterMusicLevelMin ^ GEPALDIIDPC.FBGGEFFJJHB) &&
					(ILEKEPJBFDP.FBGGEFFJJHB ^ ILEKEPJBFDP.CPBHIHNOIHB_FilterMusicLevelMax) == (GEPALDIIDPC.CPBHIHNOIHB_FilterMusicLevelMax ^ GEPALDIIDPC.FBGGEFFJJHB) &&
		...
		public class MCINLGMJPDM_SelectHomeBG
		{
			...
			{
				return ILEKEPJBFDP.EILKGEADKGH_Order == GEPALDIIDPC.EILKGEADKGH_Order &&
		...
		{
			return ILEKEPJBFDP.LNFFKCDNCPN_sceneSelectSortItem == GEPALDIIDPC.LNFFKCDNCPN_sceneSelectSortItem &&
    ...
    public class JDBOPCADICO_Notification
    {
		...
		{
			return ILEKEPJBFDP.KNOLBNCEHFB_StaminaReceive == GEPALDIIDPC.KNOLBNCEHFB_StaminaReceive &&
	...
	public class EHNBPANMAKA_Popup
	{
		...
		{
			return System.Linq.Enumerable.SequenceEqual<long>(LFGLBIAODLE.KBMJNKENLAC_PopupNt, CJDJGHIIBHP.KBMJNKENLAC_PopupNt);
		}
	...
	public class FNDHMLLDACE_Login
	{
		...
		{
			return BKLCILHFCGB_Flags.CHDGLBBFEKH_IsEqual(LFGLBIAODLE.LDCMANMNAHC_HomeTalkFlags, CJDJGHIIBHP.LDCMANMNAHC_HomeTalkFlags) &&
	...
	public class HEJDCGGIADL_StatusPopup
	{
		...
		{
			return LFGLBIAODLE.EPJPNFIMODP_DivaStatusPage == CJDJGHIIBHP.EPJPNFIMODP_DivaStatusPage &&
	...
	public class NKHHJGFNAKI_Anketo
	{
		...
		{
			return BKLCILHFCGB_Flags.CHDGLBBFEKH_IsEqual(LFGLBIAODLE.FHEJNGDFMAI_AnswerFlags, CJDJGHIIBHP.FHEJNGDFMAI_AnswerFlags);
		}
	...
	public class DBAJCPLEMDP_Shop
	{
		...
		{
			return System.Linq.Enumerable.SequenceEqual<long>(LFGLBIAODLE.MHKCPJDNJKI, CJDJGHIIBHP.MHKCPJDNJKI);
		}
	...
	public class JCFNHPMBPLJ_UnitDance
	{
		...
		{
			return LFGLBIAODLE.KBAMKMDJMJC_DisableWarning != CJDJGHIIBHP.KBAMKMDJMJC_DisableWarning;
		}
	...
	public class CMKCDNCHNKH_CostumeUpgrade
	{
		...
		{
			return ILEKEPJBFDP.AEKKEKBMOCF_DivaFilterBit == GEPALDIIDPC.AEKKEKBMOCF_DivaFilterBit &&
	...
	public class ICEOHGGIBBE_ChatCommon
	{
		...
		{
			return ILEKEPJBFDP.OCFJGGFPIBK_ChatIconState == GEPALDIIDPC.OCFJGGFPIBK_ChatIconState;
		}
	...
	public class EIHCEKNKHJB_ValkyrieTuneUp
	{
		...
		{
			return LFGLBIAODLE.IHAHBHEDIAK_SelectVfId == CJDJGHIIBHP.IHAHBHEDIAK_SelectVfId;
		}
	...
	public class FIDNFICGLEE_LimitedItemWarning
	{
		...
		{
			return LFGLBIAODLE.DIKBJMJBOIL_RateUpDate == CJDJGHIIBHP.DIKBJMJBOIL_RateUpDate &&
	...
	public class AKKDKBOBKGH_AprilFool
	{
		...
		{
			return OEAIOIHGMIH.CHDGLBBFEKH(LFGLBIAODLE.MNKOCOODFKH_MiniGameShooting, CJDJGHIIBHP.MNKOCOODFKH_MiniGameShooting);
		}
...
public class FLGABCAPFEC<T> // TypeDefIndex: 7782
{
	...
	{
		return LFGLBIAODLE.DOBDFAGOIJK_List.Equals(CJDJGHIIBHP.DOBDFAGOIJK_List);
	}
	///* GenericInstMethod :
	//|
