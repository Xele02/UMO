...
public class EEDBNJAEKBI
{
	...
	{
		KIICLPJJBNL_EpiItem.NKGPGMOHAFM epi = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.NEGGMILDEEF_EpiItem.CDENCMNHNGA_table[MHFBCINOJEE - 1];
		EGOLBAPFHHD_Common.AMCANGCIBEG saveEpi = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.GJODJNIHKKF_EpiItem[MHFBCINOJEE - 1];
