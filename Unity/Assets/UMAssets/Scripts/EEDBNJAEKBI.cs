...
public class EEDBNJAEKBI
{
	...
	{
		KIICLPJJBNL_EpiItem.NKGPGMOHAFM epi = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.NEGGMILDEEF_EpiItem.CDENCMNHNGA_table[_MHFBCINOJEE_Num - 1];
		EGOLBAPFHHD_Common.AMCANGCIBEG saveEpi = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.GJODJNIHKKF_epi_item[_MHFBCINOJEE_Num - 1];
		...
		INFIBMLIHLO_ItemId = EKLNMHFCAOI_ItemManager.GJEEGMCBGGM_GetItemFullId(EKLNMHFCAOI_ItemManager.FKGCBLHOOCL_Category.MEDAKGBKIMO_EpisodeItem, _MHFBCINOJEE_Num);
	}

	//// RVA: 0x1C48554 Offset: 0x1C48554 VA: 0x1C48554
	public static List<EEDBNJAEKBI> FKDIMODKKJD_GetList()
	{
		List<KIICLPJJBNL_EpiItem.NKGPGMOHAFM> epiList = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.NEGGMILDEEF_EpiItem.CDENCMNHNGA_table;
