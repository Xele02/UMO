...
public class NABANOOIECF
{
	...
	public int PPFNGGCBJKC_id { get { return EHOIENNDEDH_IdCrypted ^ FBGGEFFJJHB_xor; } set { EHOIENNDEDH_IdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x17BEE78 DEMEPMAEJOO_get_id 0x17BEE8C HIGKAIDMOKN_set_id
