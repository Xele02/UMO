...
public class HLMJIADBPIJ
{
	...
	public static bool IBHJAMDGGMC(NJLGICBHIOC.EOFJDIACFEC INDDJNMPONH, long DPIBHFNDJII, long EKPBOLNFGJB, BBHNACPENDM_ServerSaveData _AHEFHIMGIBI_PlayerData, OKGLGHCBCJP_Database NKEBMCIMJND, long JHNMKKNEENE)
    {
        switch(INDDJNMPONH)
		{
			...
			case NJLGICBHIOC.EOFJDIACFEC.NDGMFGMHCJM/*2*/:
				{
					if (_AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common == null)
						return false;
					return _AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.KIECDDFNCAN_Level >= DPIBHFNDJII;
				}
			case NJLGICBHIOC.EOFJDIACFEC.NEKIMLIDECE/*3*/:
				{
					if (_AHEFHIMGIBI_PlayerData.OEKEIGFAIGN_Counter == null)
						return false;
					return _AHEFHIMGIBI_PlayerData.OEKEIGFAIGN_Counter.BDLNMOIOMHK_Total.MILCBLJDADN_MusicClear >= DPIBHFNDJII;
				}
			case NJLGICBHIOC.EOFJDIACFEC.NMPIGOJAENA/*4*/:
				{
					if (_AHEFHIMGIBI_PlayerData.OEKEIGFAIGN_Counter == null)
						return false;
					return _AHEFHIMGIBI_PlayerData.OEKEIGFAIGN_Counter.BDLNMOIOMHK_Total.LHOCOEOKFNO_SerieClear[DPIBHFNDJII - 1] >= EKPBOLNFGJB;
				}
			case NJLGICBHIOC.EOFJDIACFEC.MCNJJOFADCD/*5*/:
				{
					if (_AHEFHIMGIBI_PlayerData.OEKEIGFAIGN_Counter == null)
						return false;
					return _AHEFHIMGIBI_PlayerData.OEKEIGFAIGN_Counter.BDLNMOIOMHK_Total.PHPPOGOEOAF_DiffClear[4] >= DPIBHFNDJII;
				}
			case NJLGICBHIOC.EOFJDIACFEC.OKFIBPHHCNO/*7*/:
				{
					if (_AHEFHIMGIBI_PlayerData.OEKEIGFAIGN_Counter == null)
						return false;
					return _AHEFHIMGIBI_PlayerData.OEKEIGFAIGN_Counter.BDLNMOIOMHK_Total.FILFPNDEINH_Fcb >= DPIBHFNDJII;
				}
			case NJLGICBHIOC.EOFJDIACFEC.BADNCCCDDPO/*8*/:
				{
					if (_AHEFHIMGIBI_PlayerData.DGCJCAHIAPP_Diva == null)
						return false;
					return _AHEFHIMGIBI_PlayerData.DGCJCAHIAPP_Diva.LGKFMLIOPKL_GetDivaInfo((int)DPIBHFNDJII).OKMELNIIMMO_GetDivaLevel() >= EKPBOLNFGJB;
				}
			case NJLGICBHIOC.EOFJDIACFEC.MLPPDEEBBDM/*9*/:
				{
					...
					if(DPIBHFNDJII - 1 < NKEBMCIMJND.MOLEPBNJAGE_Episode.BBAJKJPKOHD_EpisodeList.Count)
					{
						if (NKEBMCIMJND.MOLEPBNJAGE_Episode.BBAJKJPKOHD_EpisodeList[(int)DPIBHFNDJII - 1].PPEGAKEIEGM != 2)
							return false;
						return _AHEFHIMGIBI_PlayerData.NGHJPEIKLJL_Episode.BBAJKJPKOHD_EpisodeList[(int)DPIBHFNDJII - 1].EBIIIAELNAA_Step + 1 <= NKEBMCIMJND.MOLEPBNJAGE_Episode.BBAJKJPKOHD_EpisodeList[(int)DPIBHFNDJII - 1].FGOGPCMHPIN_Count;
					}
					return false;
				}
			...
			case NJLGICBHIOC.EOFJDIACFEC.ILCMGKPAEOI/*11*/:
				{
					if (_AHEFHIMGIBI_PlayerData.OEKEIGFAIGN_Counter == null)
						return false;
					return _AHEFHIMGIBI_PlayerData.OEKEIGFAIGN_Counter.BDLNMOIOMHK_Total.HOHBKPPOLLA_Uc >= DPIBHFNDJII;
				}
			...
			case NJLGICBHIOC.EOFJDIACFEC.BILICHMCHIP/*15*/:
				return _AHEFHIMGIBI_PlayerData.FLHMJHBOBEA_Sns.HAJEJPFGILG[(int)DPIBHFNDJII - 1].PMKJFKJFDOC_Itm != 0;
			case NJLGICBHIOC.EOFJDIACFEC.PMMOLBAAHEM/*16*/:
				if (DPIBHFNDJII < 0)
					return false;
				return EKPBOLNFGJB <= _AHEFHIMGIBI_PlayerData.OEKEIGFAIGN_Counter.BDLNMOIOMHK_Total.GKOAPFJFKEJ_VOpC[DPIBHFNDJII]; // ?
			case NJLGICBHIOC.EOFJDIACFEC.OHAGNHFOEKO/*17*/:
				if (DPIBHFNDJII < 1)
					return false;
				return EKPBOLNFGJB <= _AHEFHIMGIBI_PlayerData.OEKEIGFAIGN_Counter.BDLNMOIOMHK_Total.LOOAKNLDONN_DOpC[DPIBHFNDJII - 1]; // ?
			case NJLGICBHIOC.EOFJDIACFEC.LJHIFLMDGKE/*18*/:
				{
					JDDGGJCGOPA_RecordMusic.EHFMCGGNPIJ_MusicInfo mi = _AHEFHIMGIBI_PlayerData.LCKMBHDMPIP_RecordMusic.FAMANJGJANN_FreeMusicInfo[(int)DPIBHFNDJII - 1];
					int r = 0;
			...
			case NJLGICBHIOC.EOFJDIACFEC.OMPHECLBFEH/*19*/:
				{
					...
					if (!NKEBMCIMJND.IBPAFKKEKNK_Music.IAAMKEJKPPL(m, _AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.KIECDDFNCAN_Level))
						return false;
					return _AHEFHIMGIBI_PlayerData.LCKMBHDMPIP_RecordMusic.FAMANJGJANN_FreeMusicInfo[(int)DPIBHFNDJII - 1].DMANHOPOBMP_IsShowUnlock;
				}
