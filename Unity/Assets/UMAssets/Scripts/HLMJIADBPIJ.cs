			...
			case NJLGICBHIOC.EOFJDIACFEC.NEKIMLIDECE/*3*/:
				{
					if (AHEFHIMGIBI.OEKEIGFAIGN_Counter == null)
						return false;
					return AHEFHIMGIBI.OEKEIGFAIGN_Counter.BDLNMOIOMHK_Total.MILCBLJDADN_MClr >= DPIBHFNDJII;
				}
			case NJLGICBHIOC.EOFJDIACFEC.NMPIGOJAENA/*4*/:
				{
					if (AHEFHIMGIBI.OEKEIGFAIGN_Counter == null)
						return false;
					return AHEFHIMGIBI.OEKEIGFAIGN_Counter.BDLNMOIOMHK_Total.LHOCOEOKFNO_SClr[DPIBHFNDJII - 1] >= EKPBOLNFGJB;
				}
			case NJLGICBHIOC.EOFJDIACFEC.MCNJJOFADCD/*5*/:
				{
					if (AHEFHIMGIBI.OEKEIGFAIGN_Counter == null)
						return false;
					return AHEFHIMGIBI.OEKEIGFAIGN_Counter.BDLNMOIOMHK_Total.PHPPOGOEOAF_DClr[4] >= DPIBHFNDJII;
				}
