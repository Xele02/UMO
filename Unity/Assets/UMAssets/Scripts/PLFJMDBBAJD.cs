...
public class PLFJMDBBAJD
{
	...
	public void KHEKNNFCAOI()
    {
		...
		{
            PKNOKJNLPOE_EventRaid.MJFMOPMOFDJ p = ev.KACFOENGHIK();
            PKNOKJNLPOE_EventRaid.KJJDLBFDGDM p2 = ev.KLDMMPJKHEO();
            CIEOBFIIPLD = p.ANAJIAENLNB;
            FJOLNJLLJEJ_BossRank = p.FJOLNJLLJEJ_Rank;
            MPKBLMCNHOM_MissionIsSpecial = p.IKICLMGFFPB_MissionIsSpecial;
	...
	public void KHEKNNFCAOI(PKNOKJNLPOE_EventRaid.MJFMOPMOFDJ GJFJLEOGFLD, Action KBCBGIGOLHP)
	{
		...
		if(ev != null)
		{
			...
			{
				//0xFE98E4
				CIEOBFIIPLD = GJFJLEOGFLD.ANAJIAENLNB;
				FJOLNJLLJEJ_BossRank = GJFJLEOGFLD.FJOLNJLLJEJ_Rank;
				MPKBLMCNHOM_MissionIsSpecial = GJFJLEOGFLD.IKICLMGFFPB_MissionIsSpecial;
				...
				{
					NEAPOLIIELG_MvpRewards = ev.KLDMMPJKHEO().NEAPOLIIELG_MvpRewards;
					JAGJOLBDBDK_FirstRewards = ev.KLDMMPJKHEO().JAGJOLBDBDK_FirstRewards;
					FGNHJFLBMIE_DefeatRewards = ev.KLDMMPJKHEO().FGNHJFLBMIE_DefeatRewards;
					KBCBGIGOLHP();
				}
			}, () =>
			{
