...
public class PLFJMDBBAJD
{
	...
	public List<PKNOKJNLPOE_EventRaid.KJJDLBFDGDM.EGMFNKCKOLB> NEAPOLIIELG_MvpRewards { get { return PAHGKOAIPFL; } set { PAHGKOAIPFL = value; } } //0xFE92BC JBCIDFIBJMB_bgs 0xFE92C4 PJGAMCFPENJ_bgs
	public List<PKNOKJNLPOE_EventRaid.KJJDLBFDGDM.EGMFNKCKOLB> JAGJOLBDBDK_FirstRewards { get { return BLPPOBLGLAJ; } set { BLPPOBLGLAJ = value; } } //0xFE92CC MEPHLOMFANC_bgs 0xFE92D4 OKKIILBBLPM_bgs
	public List<PKNOKJNLPOE_EventRaid.KJJDLBFDGDM.EGMFNKCKOLB> FGNHJFLBMIE_DefeatRewards { get { return NAJFDCBBCHD; } set { NAJFDCBBCHD = value; } } //0xFE92DC NPCCNIIELEL_bgs 0xFE92E4 AGPAFGCHEBM_bgs
