		...
		else
		{
			...
			if(JJJNKGBCFMI_Step < FGOGPCMHPIN_Count)
			{
				...
				if(st != null && rw != null)
				{
					...
					JBFLCHFEIGL.OJELCGDDAOM_MissingPoint = JBFLCHFEIGL.DNBFMLBNAEE_TotalPoint - ABLHIAEDJAI_CurrentValue;
		...
		if(KELFCMEOPPM_EpId > 0)
		{
			...
			if(JJJNKGBCFMI_Step < FGOGPCMHPIN_Count)
			{
				...
				if(step != null && reward != null)
				{
					...
					data.OJELCGDDAOM_MissingPoint = data.DNBFMLBNAEE_TotalPoint - ABLHIAEDJAI_CurrentValue;
