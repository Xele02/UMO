...
public class LGMEPLIJLNB
{
	...
	public static List<LGMEPLIJLNB> FKDIMODKKJD_GetList(int _KELFCMEOPPM_EpisodeId)
	{
        ...
        HMGPODKEFBA_EpisodeInfo NDFIEMPPMLF_master = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MOLEPBNJAGE_Episode.BBAJKJPKOHD_EpisodeList[_KELFCMEOPPM_EpisodeId - 1];
        OCLHKHAMDHF_Episode.JEHNEEBBDBO_EpisodeInfo saveEp = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.NGHJPEIKLJL_Episode.BBAJKJPKOHD_EpisodeList[_KELFCMEOPPM_EpisodeId - 1];
		FMLIFJBPFNA_Step f = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MOLEPBNJAGE_Episode.KODIKHBMBBJ_Steps.Find((FMLIFJBPFNA_Step _GHPLINIACBB_x) => {
			//0x17F58C0
		...
		for(int i = 0; i < NDFIEMPPMLF_master.FGOGPCMHPIN_Count; i++)
		{
			...
			JNIKPOIKFAC_Reward r = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MOLEPBNJAGE_Episode.LFAAEPAAEMB_Rewards.Find((JNIKPOIKFAC_Reward _GHPLINIACBB_x) => {
				//0x17F590C
	...
	public static LGMEPLIJLNB BMFKMFNPGPC(int _KELFCMEOPPM_EpisodeId, bool MPCFDBHLOGM)
	{
		...
		{
			HMGPODKEFBA_EpisodeInfo NDFIEMPPMLF_master = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MOLEPBNJAGE_Episode.BBAJKJPKOHD_EpisodeList[_KELFCMEOPPM_EpisodeId - 1];
			OCLHKHAMDHF_Episode.JEHNEEBBDBO_EpisodeInfo saveInfo = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.NGHJPEIKLJL_Episode.BBAJKJPKOHD_EpisodeList[_KELFCMEOPPM_EpisodeId - 1];
			...
			for(int i = 0; i < NDFIEMPPMLF_master.FGOGPCMHPIN_Count; i++)
			{
				...
				JNIKPOIKFAC_Reward reward = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MOLEPBNJAGE_Episode.LFAAEPAAEMB_Rewards.Find((JNIKPOIKFAC_Reward _GHPLINIACBB_x) =>
				{
					//0x17F5990
...
public class PIGBBNDPPJC
{
	...
	{
		CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.NGHJPEIKLJL_Episode.BBAJKJPKOHD_EpisodeList[KELFCMEOPPM_EpisodeId - 1].LHMOAJAIJCO_is_new = false;
	}
	...
	public void KHEKNNFCAOI_Init(int _KELFCMEOPPM_EpisodeId)
	{
		...
		{
			HMGPODKEFBA_EpisodeInfo NDFIEMPPMLF_master = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MOLEPBNJAGE_Episode.BBAJKJPKOHD_EpisodeList[_KELFCMEOPPM_EpisodeId - 1];
			OCLHKHAMDHF_Episode.JEHNEEBBDBO_EpisodeInfo serverEpInfo = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.NGHJPEIKLJL_Episode.BBAJKJPKOHD_EpisodeList[_KELFCMEOPPM_EpisodeId - 1];
			...
			if(JJJNKGBCFMI_CurrentStep < FGOGPCMHPIN_Count)
			{
				...
				FMLIFJBPFNA_Step st = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MOLEPBNJAGE_Episode.KODIKHBMBBJ_Steps.Find((FMLIFJBPFNA_Step _GHPLINIACBB_x) =>
				{
					//0x16D369C
					return NDFIEMPPMLF_master.IOFHEGJPHKG_StepId == _GHPLINIACBB_x.IOFHEGJPHKG_StepId;
				});
				JNIKPOIKFAC_Reward rw = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MOLEPBNJAGE_Episode.LFAAEPAAEMB_Rewards.Find((JNIKPOIKFAC_Reward _GHPLINIACBB_x) =>
				{
					//0x16D3734
			...
			int cosItemId = EKLNMHFCAOI_ItemManager.GJEEGMCBGGM_GetItemFullId(EKLNMHFCAOI_ItemManager.FKGCBLHOOCL_Category.KBHGPMNGALJ_5_Costume, 0);
			int valkItemId = EKLNMHFCAOI_ItemManager.GJEEGMCBGGM_GetItemFullId(EKLNMHFCAOI_ItemManager.FKGCBLHOOCL_Category.PFIOMNHDHCO_6_Valkyrie, 0);
			int homeBgItemId = EKLNMHFCAOI_ItemManager.GJEEGMCBGGM_GetItemFullId(EKLNMHFCAOI_ItemManager.FKGCBLHOOCL_Category.HGDPIAFBCGA_HomeBg, 0);
	...
	public void FBANBDCOEJL_Update()
	{
		...
		{
			HMGPODKEFBA_EpisodeInfo epInfo = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MOLEPBNJAGE_Episode.BBAJKJPKOHD_EpisodeList[KELFCMEOPPM_EpisodeId - 1];
			OCLHKHAMDHF_Episode.JEHNEEBBDBO_EpisodeInfo saveEpInfo = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.NGHJPEIKLJL_Episode.BBAJKJPKOHD_EpisodeList[KELFCMEOPPM_EpisodeId - 1];
			...
			FMLIFJBPFNA_Step step2 = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MOLEPBNJAGE_Episode.KODIKHBMBBJ_Steps.Find((FMLIFJBPFNA_Step _GHPLINIACBB_x) =>
			{
				//0x16D37F0
				return _GHPLINIACBB_x.IOFHEGJPHKG_StepId == epInfo.IOFHEGJPHKG_StepId;
			});
	...
	public static List<PIGBBNDPPJC> FKDIMODKKJD_GetList(bool DHFLBNAHGDF/* = false*/)
	{
		...
		for(int i = 0; i < IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MOLEPBNJAGE_Episode.BBAJKJPKOHD_EpisodeList.Count; i++)
		{
			HMGPODKEFBA_EpisodeInfo dbEp = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MOLEPBNJAGE_Episode.BBAJKJPKOHD_EpisodeList[i];
			OCLHKHAMDHF_Episode.JEHNEEBBDBO_EpisodeInfo saveEp = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.NGHJPEIKLJL_Episode.BBAJKJPKOHD_EpisodeList[i];
	...
	{
		OCLHKHAMDHF_Episode.JEHNEEBBDBO_EpisodeInfo info = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.NGHJPEIKLJL_Episode.BBAJKJPKOHD_EpisodeList[KELFCMEOPPM_EpisodeId - 1];
		if(info.HPLMMKHBKIG_Id == KELFCMEOPPM_EpisodeId)
		{
			KIICLPJJBNL_EpiItem.NKGPGMOHAFM info2 = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.NEGGMILDEEF_EpiItem.CDENCMNHNGA_table[BNGHLLCONJM - 1];
			EGOLBAPFHHD_Common.AMCANGCIBEG info3 = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.GJODJNIHKKF_epi_item[BNGHLLCONJM - 1];
	...
	public int PFMLAOPEAMJ(int BNGHLLCONJM, int _HMFFHLPNMPH_count, IMCBBOAFION _BHFHGFKBOHH_OnSuccess)
	{
		...
		if (res > 0)
		{
			...
			if(f == null)
			{
				...
				OCLHKHAMDHF_Episode.JEHNEEBBDBO_EpisodeInfo ep = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.NGHJPEIKLJL_Episode.BBAJKJPKOHD_EpisodeList[KELFCMEOPPM_EpisodeId - 1];
				KIICLPJJBNL_EpiItem.NKGPGMOHAFM info2 = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.NEGGMILDEEF_EpiItem.CDENCMNHNGA_table[BNGHLLCONJM - 1];
				EGOLBAPFHHD_Common.AMCANGCIBEG info3 = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.GJODJNIHKKF_epi_item[BNGHLLCONJM - 1];
				...
				ep.MOACIBEKLEN(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MOLEPBNJAGE_Episode, _HMFFHLPNMPH_count * info2.JBGEEPFKIGG_val, false);
				int a2 = ep.OGDBKJKIGAJ_CurrentPoint;
				ILCCJNDFFOB.HHCJCDFCLOB_Instance.BBDKHAMANCB_Episode(KELFCMEOPPM_EpisodeId, a, a2, ep.EBIIIAELNAA_Step, JpStringLiterals.StringLiteral_13085, EKLNMHFCAOI_ItemManager.GJEEGMCBGGM_GetItemFullId(EKLNMHFCAOI_ItemManager.FKGCBLHOOCL_Category.MEDAKGBKIMO_EpisodeItem, BNGHLLCONJM), _HMFFHLPNMPH_count);
			}
	...
	{
		return GMDHJBGLBEI(_KELFCMEOPPM_EpisodeId, CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData);
	}
	...
	private bool FIBLGPNEKEM(int _KELFCMEOPPM_EpisodeId)
	{
		...
		{
			MMPBPOIFDAF_Scene.PMKOFEIONEG serverScene = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.PNLOINMCCKH_Scene.OPIBAPEGCLA_Scenes[i];
			if (serverScene.IHIAFIHAAPO_Unlocked)
			{
				MLIBEPGADJH_Scene.KKLDOOJBJMN dbScene = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[serverScene.PPFNGGCBJKC_id - 1];
