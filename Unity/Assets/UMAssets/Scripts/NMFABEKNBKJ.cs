...
public class NMFABEKNBKJ
{
	...
	private IEnumerator LAGOJPPLDOH_Corotuine_BootInitilaize_FCM(IMCBBOAFION PONEMLJPAOE, IMCBBOAFION CNJANCCFBIL)
	{
		...
		//0x1CADBC8
		TodoLogger.Log(5, "LAGOJPPLDOH_Corotuine_BootInitilaize_FCM");
	...
	// private void MABFNKCMEDL(string PPFNGGCBJKC, string OPFGFINHFCE, int PDJFAPLAPAG = 3) { }
