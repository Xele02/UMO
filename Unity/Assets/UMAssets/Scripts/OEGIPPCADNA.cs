...
public class OEGIPPCADNA
{
	...
	//public void MJFKJHJJLMN(int LHJCOPMMIGO, bool FBBNPFFEJBN = False, IMCBBOAFION KLMFJJCNBIP, DJBHIFLHJLK IDAEHNGOKAE, DJBHIFLHJLK JGKOLBLPMPG) { }

	//// RVA: 0x1B3D1B0 Offset: 0x1B3D1B0 VA: 0x1B3D1B0
	//public void FGMOMBKGCNF(int DPDCIICKJEJ = 0, IMCBBOAFION KLMFJJCNBIP, DJBHIFLHJLK NIMPEHIECJH, DJBHIFLHJLK JGKOLBLPMPG) { }
