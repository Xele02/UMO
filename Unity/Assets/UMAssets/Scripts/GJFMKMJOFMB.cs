...
public class GJFMKMJOFMB
{
	...
	public void KHEKNNFCAOI(bool JHOJAGMJABJ, bool IEABEILIGPO/* = false*/)
	{
		if(IEABEILIGPO)
		{
			...
			{
				if(NHPDPKHMFEP.HHCJCDFCLOB.LKNKNKAALJO[i].JJBGOIMEIPF_ItemFullId == BBDNDNHJEKJ)
				{
					CFNFKIIOOHC += NHPDPKHMFEP.HHCJCDFCLOB.LKNKNKAALJO[i].MBJIFDBEDAC_ItemCount;
				}
				else
				{
					BBDNDNHJEKJ = NHPDPKHMFEP.HHCJCDFCLOB.LKNKNKAALJO[i].JJBGOIMEIPF_ItemFullId;
					CFNFKIIOOHC = NHPDPKHMFEP.HHCJCDFCLOB.LKNKNKAALJO[i].MBJIFDBEDAC_ItemCount;
					ENHGKPMEICN = true;
				}
			}
