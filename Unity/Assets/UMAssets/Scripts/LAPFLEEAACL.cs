...
public class LAPFLEEAACL
{
	...
	// private List<KBPDNHOKEKD> MHKCPJDNJKI; // 0xC
	// public JKNGJFOBADP JANMJPOKLFL = new JKNGJFOBADP(); // 0x10
	public int PPECNOCKNMC; // 0x14
	private HHJHIFJIKAC.IJFKAIHFJLF AIBKGHFBFCC = /*2*/HHJHIFJIKAC.IJFKAIHFJLF.JEPMLKCJCPK; // 0x18

	// // RVA: 0xD945C4 Offset: 0xD945C4 VA: 0xD945C4
	public LAPFLEEAACL(HHJHIFJIKAC.IJFKAIHFJLF INDDJNMPONH)
    {
