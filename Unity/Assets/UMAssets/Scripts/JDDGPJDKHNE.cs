...
public class JDDGPJDKHNE
{
	...
	// private KIJECNFNNDB LAFGAPBDKML = new KIJECNFNNDB(); // 0xC
	...
	// public void LGCNNIKLFFN(int KAPMOPMDHJE, EDOHBJAPLPF JIBNPJCIALH) { }
	...
	public void IJBGPAENLJA()
    {
		...
		BBMBNCPEAHC.KHEKNNFCAOI(MKKOKHPMCHB());
		UnityEngine.Debug.Log("load secureSaveFile");
		LAHBCJNDGCH = new NPAFCENJADP();
		LAHBCJNDGCH.KHEKNNFCAOI(AOJAEBGJMGJ());
	...
	// public void OJIDPFKENDG(EDOHBJAPLPF HKICMNAACDA) { }

	// // RVA: 0x1C31D24 Offset: 0x1C31D24 VA: 0x1C31D24
	// public void CLHLFPDNFNM(int KAPMOPMDHJE, EDOHBJAPLPF JIBNPJCIALH, bool FOIGCFNFPOB) { }

	// // RVA: 0x1C32048 Offset: 0x1C32048 VA: 0x1C32048
	// public void KIPIMGCGLJG(int KAPMOPMDHJE, EDOHBJAPLPF JIBNPJCIALH, bool FOIGCFNFPOB) { }
				...
				if(BBMBNCPEAHC.MGJKEJHEBPO.Count != 0)
				{
					if(NKGJPJPHLIF.HHCJCDFCLOB.CGMMHFHHLID)
					{
						if(!DGKBPJBILIK)
						{
							...
							if(PIBMLNOFHHG < 30)
								return;
							UnityEngine.Debug.LogError("Check test");
