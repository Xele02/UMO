	...
	public void HEOKADCEAGL(int LHJCOPMMIGO, bool PFFJNEFNAMI, IMCBBOAFION KLMFJJCNBIP, DJBHIFLHJLK IDAEHNGOKAE, DJBHIFLHJLK JGKOLBLPMPG)
	{
		...
		else
		{
			...
			if(!ONJBNDCMMNL[LHJCOPMMIGO].BEKAMBBOLBO)
			{
				...
				{
					//0xD93350
					ONJBNDCMMNL[LHJCOPMMIGO].FJOLNJLLJEJ = (int)KKLGENJKEBN.HHCJCDFCLOB.LPPCNCMEDFA_Rank;
					ONJBNDCMMNL[LHJCOPMMIGO].DNBFMLBNAEE = (int)KKLGENJKEBN.HHCJCDFCLOB.IPNEJCOFBIB_ScoreTrunc;
				...
				{
					//0xD934C0
					ONJBNDCMMNL[LHJCOPMMIGO].FJOLNJLLJEJ = 0;
					ONJBNDCMMNL[LHJCOPMMIGO].DNBFMLBNAEE = 0;
