...
public class LAMCONGFONF
{
	...
	public void FAMFKPBPIAA_GetRankingPlayerList(int LHJCOPMMIGO, bool PFFJNEFNAMI, int CJHEHIMLGGL, IMCBBOAFION _KLMFJJCNBIP_OnSuccess, DJBHIFLHJLK _IDAEHNGOKAE_OnRankingError, DJBHIFLHJLK _JGKOLBLPMPG_OnFail)
	{
		DPPIBCENJJJ = false;
