...
public class NGJOPPIGCPM_ResultData
{
	...
	public DFJMELLLNLH JLBJIIBGCOE; // 0x6C
	...
	public int DACPGGLFLJG { get { return FJBDKCEJGLN ^ FBGGEFFJJHB; } set { FJBDKCEJGLN = value ^ FBGGEFFJJHB; } } //0x1AF688C NELPFJENPDN 0x1AF68A0 IDHCAMDEBJE
	public int GCAPLLEIAAI { get { return ABCKCDLNFNH ^ FBGGEFFJJHB; } set { ABCKCDLNFNH = value ^ FBGGEFFJJHB; } } //0x1AF68B4 BKGFGIGDJHB 0x1AF68C8 DELDFNOMADE
	 public int GPMILOPNBPA { get { return HKIPKLKCPLO ^ FBGGEFFJJHB; } set { HKIPKLKCPLO = value ^ FBGGEFFJJHB; } } //0x1AF68DC AFMDAPPNMBO 0x1AF68F0 AIEBJIPABLO
	 public int PBGLMBMEKAA { get { return LFGIMJKNBKD ^ FBGGEFFJJHB; } set { LFGIMJKNBKD = value ^ FBGGEFFJJHB; } } //0x1AF6904 JEPPJKNMPGN 0x1AF6918 ABGNJBDMNBG
	 ...
	 public int IOPCBBNHJIP { get { return DHJAFJKALCA_ForcedMusicId < 1 ? DLAEJOBELBH_MusicId : DHJAFJKALCA_ForcedMusicId; } private set { DHJAFJKALCA_ForcedMusicId = value; } } //0x1AF6CB0 PJKILEHFBHA 0x1AF6CD4 BOBNBADBNGG
	...
	public void KHEKNNFCAOI(int GHBPLHBNMBK_FreeMusicId, Difficulty.Type NOAKHKMLPFK_diff, bool JIBFGLODGHN_EnableLiveSkip, bool GIKLNODJKFK_IsLine6 = false, int MNNHHJBBICA_GameEventType = 0)
    {
		...
		OEELDFNNLKK_SaveRecordMusic2 = CIOECGOMILE.HHCJCDFCLOB.MNJHBCIIHED.LCKMBHDMPIP_RecordMusic;
		JDDGGJCGOPA_RecordMusic.EHFMCGGNPIJ_MusicInfo mInfo1 = LCKMBHDMPIP_SaveRecordMusic.FAMANJGJANN_MusicInfo[GHBPLHBNMBK_FreeMusicId - 1];
		JDDGGJCGOPA_RecordMusic.EHFMCGGNPIJ_MusicInfo mInfo2 = OEELDFNNLKK_SaveRecordMusic2.FAMANJGJANN_MusicInfo[GHBPLHBNMBK_FreeMusicId - 1];
		...
		PBGLMBMEKAA = mInfo1.PDNJGJNGPNJ;
		GCAPLLEIAAI = mInfo1.ODEHJGPDFCL;
		GPMILOPNBPA = mInfo1.ECLDABOLHLM;
		...
		PENICOGGNLF_RankScore = HMONFKMAFDD.EMJCHPDJHEI(GIKLNODJKFK_IsLine6, (int)NOAKHKMLPFK_diff).DLPBHJALHCK_GetScoreRank(GCAPLLEIAAI);
		ILNBLNECEKB_RankCombo = HMONFKMAFDD.EMJCHPDJHEI(GIKLNODJKFK_IsLine6, (int)NOAKHKMLPFK_diff).CCFAAPPKILD_GetRankCombo(PBGLMBMEKAA);
		DACPGGLFLJG = 0;
		if (!JIBFGLODGHN_EnableLiveSkip)
		{
			DACPGGLFLJG = mInfo1.ABFNAEKEGOB;
		}
