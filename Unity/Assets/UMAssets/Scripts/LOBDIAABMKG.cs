...
public class LOBDIAABMKG
{
	...
	// public bool KHEKNNFCAOI(List<KBPDNHOKEKD> BBKDLIPKADG, int MGBDCFIKBPM, GCAHJLOGMCI.KNMMOMEHDON INDDJNMPONH, bool IAHLNPMFJMH, int APHNELOFGAK) { }

	// // RVA: 0x10C7660 Offset: 0x10C7660 VA: 0x10C7660
	// public int GHINEFPPDMH() { }

	// // RVA: 0x10C7820 Offset: 0x10C7820 VA: 0x10C7820
	// public bool KHEKNNFCAOI(KOPCFBCDBPC CCBEKGNDDBE, JBHCLFDBPKP BKGFCEIFMNF, int MGBDCFIKBPM, GCAHJLOGMCI.KNMMOMEHDON INDDJNMPONH, int APHNELOFGAK) { }
