...
public class EKLNMHFCAOI
{
	...
	public static int LKBIIPBKNGJ_GetItemFileStatus(int KIJAPOFAGPN)
	{
		...
		switch(itemCat)
		{
			...
			case FKGCBLHOOCL_Category.KBHGPMNGALJ_Costume:
				if(itemId > 0)
				{
					if(itemId <= IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.MFPNGNMFEAL_Costume.CDENCMNHNGA_table.Count)
					{
						if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.MFPNGNMFEAL_Costume.CDENCMNHNGA_table[itemId - 1].PPEGAKEIEGM_Enabled == 2)
						{
							return 1;
						}
						return 2;
			...
			case FKGCBLHOOCL_Category.PFIOMNHDHCO_Valkyrie:
				if(itemId > 0)
				{
					if(itemId <= IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.PEOALFEGNDH_Valkyrie.CDENCMNHNGA_table.Count)
					{
						if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.PEOALFEGNDH_Valkyrie.CDENCMNHNGA_table[itemId - 1].PPEGAKEIEGM_Enabled == 2)
						{
							return 1;
						}
						return 2;
	...
	public static string INCKKODFJAP_GetItemName(FKGCBLHOOCL_Category INDDJNMPONH, int JBGEEPFKIGG, bool useJp = false)
	{
		...
		if (INDDJNMPONH == FKGCBLHOOCL_Category.OCMIGPEOFEG_GachaLimit)
		{
			...
			{
				//0x1303AD8
				return _GHPLINIACBB_x.FEFDGBPFKBJ_GId % 10000 == JBGEEPFKIGG;
			});
			if (g != null)
				id = g.PPFNGGCBJKC_Id;
		}
		...
		if(INDDJNMPONH < FKGCBLHOOCL_Category.FMIIHMHKJDI_SpItem)
		{
			if(INDDJNMPONH == FKGCBLHOOCL_Category.KNHFAHFCCBK_SnsItem)
			{
				return string.Format(MessageManager.Instance.GetMessage("menu", "sns_item_description"), 
					MessageManager.Instance.GetBank(AFEHLCGHAEE_Strings.NDFIEMPPMLF_master).GetMessageByLabel(string.Format("rn_{0:D4}", IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.OMGFKMANMAB_Sns.CDENCMNHNGA_table[JBGEEPFKIGG - 1].MALFHCHNEFN_RoomId)),
	...
	public static int APDHLDGBENB(int KIJAPOFAGPN)
	{
		...
		{
			return a + (IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[KIJAPOFAGPN % 10000 - 1].FBJDHLGODPP_Sngl ? 1 : 0);
		}
		return a;
	}
	...
	public static int FABCKNDLPDH_GetItemRarity(FKGCBLHOOCL_Category INDDJNMPONH, int PPFNGGCBJKC)
	{
		switch(INDDJNMPONH)
		{
			case FKGCBLHOOCL_Category.ACGHELNGNGK_UnionCredit:
				{
					if(PPFNGGCBJKC != 0)
						PPFNGGCBJKC--;
					return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.NMJEDFNPIPL_UcItem.CDENCMNHNGA_table[PPFNGGCBJKC].EKLIPGELKCL_Rarity;
				}
			case FKGCBLHOOCL_Category.MHKFDBLMOGF_Scene:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.HLCHKCJLEGK_GrowItem:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.NKDGLGCAPEI_GrowItem.CDENCMNHNGA_table[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.MEDAKGBKIMO_EpisodeItem:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.NEGGMILDEEF_EpiItem.CDENCMNHNGA_table[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.MNCJMDDAFJB_EmblemItem:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.LBNBNAFGMDE_Emblem.CDENCMNHNGA_table[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.EMOLGEDEEJP_EventItem:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.DHOFNBMPBAG_EventItem.CDENCMNHNGA_table[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.GIMBFBNKPNO_CompoItem:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.ALFKMKICDPP_Compo.CDENCMNHNGA_table[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.DMMIIBCMCFG_EnergyItem:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.KOPOGNLKAEN_EnergyItem.CDENCMNHNGA_table[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.IGIFMNJADEC_MvTicket:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.NEGKEEAFKHP_MvTicket.CDENCMNHNGA_table[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.ADCAAALBAIF_Medal:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.ICICKEBMEFA_Medal.CDENCMNHNGA_table[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.DLBHNNOHLMM_PresentItem:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.LPFEHNJEJFB_PresentItem.CDENCMNHNGA_table[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.FMIIHMHKJDI_SpItem:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.OOEPHOEFBNL_SpItem.CDENCMNHNGA_table[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.NEIIGCODGBA_CostumeItem:
			...
			case FKGCBLHOOCL_Category.CIOGEKJNMBB_RareUpItem:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.KKIMFMKOHFH_RareUpItem.CDENCMNHNGA_table[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.DLOPEFGOAPD_LimitedItem:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.IHPFCIJKFIC_LimitedItem.CDENCMNHNGA_table[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.GPMKJNDHDCP_DecoItemBg:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.EPAHOAKPAJJ_DecoItem.GJLHEJPHEDA_ItemsBg[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.OKPAJOALDCG_DecoItemObj:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.EPAHOAKPAJJ_DecoItem.GHOLIPLDMPJ_ItemsObj[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.MCKHJLHKMJD_DecoItemChara:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.EPAHOAKPAJJ_DecoItem.KHCACDIKJLG_ItemsChara[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.ICIMCGOJEMD_StampItemSerif:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.GAPONCJOKAC_DecoStamp.DMKMNGELNAE_Serif[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.BMMBLLOKNPF_DecoItemSp:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.EPAHOAKPAJJ_DecoItem.GMONECJCJFK_Sp[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.MABCLBNIOFA_ValkyrieItem:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.FBGKBGNIHGC_ValItem.CDENCMNHNGA_table[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.OOMMOOIIPJE_DecoItemPoster:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.EPAHOAKPAJJ_DecoItem.COLIEKINOPB_ItemsPoster[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.AEFGOANHNMG_DecoItemPosterSceneBef:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.KKGHNKKGLCO_DecoItemPosterSceneAft:
				int a = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
				if(a > 3 && a < 6)
					a++;
				return a;
			case FKGCBLHOOCL_Category.CFLFPPDMFAE_RaidItem:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.ONOJBMDKBLE_EventRaidItem.CDENCMNHNGA_table[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.GGEFMAAOMFH_StampItemChara:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.GAPONCJOKAC_DecoStamp.FHBIIONKIDI_Stamps[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.ICJOEDJECAP_DecoSetItem:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.MJALLIOHKEJ_DecoSetItem.CDENCMNHNGA_table[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
			case FKGCBLHOOCL_Category.CKCPFLDGILD_LimitedCompoItem:
				return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.MBAGKLJDKMH_LimitedCompoItem.OCMMLAOEPIG[PPFNGGCBJKC - 1].EKLIPGELKCL_Rarity;
		}
		return 1;
	}
	...
	public static int ALHCGDMEMID_GetNumItems(OKGLGHCBCJP_Database LKMHPJKIFDN, BBHNACPENDM_ServerSaveData LDEGEHAEALK, FKGCBLHOOCL_Category INDDJNMPONH, int NANNGLGOFKH, IKDICBBFBMI_EventBase JMFICAICKBC)
	{
		switch(INDDJNMPONH)
		{
			...
			case FKGCBLHOOCL_Category.MHKFDBLMOGF_Scene:
				...
				{
					return LDEGEHAEALK.PNLOINMCCKH_Scene.OPIBAPEGCLA[NANNGLGOFKH - 1].JPIPENJGGDD_Mlt + (LKMHPJKIFDN.ECNHDEHADGL_Scene.CDENCMNHNGA_table[NANNGLGOFKH - 1].FBJDHLGODPP_Sngl ? 0 : 1);
				}
				break;
			case FKGCBLHOOCL_Category.KBHGPMNGALJ_Costume:
				return LDEGEHAEALK.BEKHNNCGIEL_Costume.FABAGMLEKIB_CostumeList[NANNGLGOFKH - 1].CGKAEMGLHNK_Possessed() ? 1 : 0;
			case FKGCBLHOOCL_Category.PFIOMNHDHCO_Valkyrie:
				return LDEGEHAEALK.JJFFBDLIOCF_Valkyrie.CNGNBKNBKGI_ValkList[NANNGLGOFKH - 1].FJODMPGPDDD_Unlocked ? 1 : 0;
			case FKGCBLHOOCL_Category.HLCHKCJLEGK_GrowItem:
				return LDEGEHAEALK.KCCLEHLLOFG_Common.KBMDMEEMGLK_GrowItem[NANNGLGOFKH - 1].BFINGCJHOHI_Count;
			case FKGCBLHOOCL_Category.MEDAKGBKIMO_EpisodeItem:
				return LDEGEHAEALK.KCCLEHLLOFG_Common.GJODJNIHKKF_EpiItem[NANNGLGOFKH - 1].BFINGCJHOHI_Count;
			case FKGCBLHOOCL_Category.MNCJMDDAFJB_EmblemItem:
				if(LDEGEHAEALK.OFAJDLJBMEM_Emblem.MDKOHOCONKE[NANNGLGOFKH - 1].BEBJKJKBOGH_Date != 0)
				{
					return LDEGEHAEALK.OFAJDLJBMEM_Emblem.MDKOHOCONKE[NANNGLGOFKH - 1].FHCAFLCLGAA_EmCnt;
				}
				break;
			case FKGCBLHOOCL_Category.CLMIJKACELE_EventTicket:
			...
			case FKGCBLHOOCL_Category.DMMIIBCMCFG_EnergyItem:
				return LDEGEHAEALK.KCCLEHLLOFG_Common.KFEBOFKAHAJ_EngItem[NANNGLGOFKH - 1].BFINGCJHOHI_Count;
			case FKGCBLHOOCL_Category.IGIFMNJADEC_MvTicket:
				return LDEGEHAEALK.KCCLEHLLOFG_Common.GKKDNOFMJJN_NumTicket;
			case FKGCBLHOOCL_Category.ADCAAALBAIF_Medal:
				return LDEGEHAEALK.KCCLEHLLOFG_Common.MHKJEBNOPIM_Medal[NANNGLGOFKH - 1].BFINGCJHOHI_Count;
			case FKGCBLHOOCL_Category.IBBDMIFICCN_BonusVC:
				return CIOECGOMILE.HHCJCDFCLOB.NOJDLFKKMDD_GetCurrencyTotal(NANNGLGOFKH);
			case FKGCBLHOOCL_Category.LLFAAOHPMIC_EventGachaTicket:
				if(LDEGEHAEALK.MMAIJOCPJHP_EventBoxGacha != null)
				{
					JNGINLMOJKH_EventGachaTicket.JDNAAGCHCOH tkt = LKMHPJKIFDN.NKOKFIMNCJM_EventGachaTicket.CDENCMNHNGA_table[NANNGLGOFKH - 1];
					return LDEGEHAEALK.MMAIJOCPJHP_EventBoxGacha.FBCJICEPLED[tkt.EJPKFBHNDGI_EvNo - 1].BGCOKABBHNC_GachaTicketCnt;
				}
				break;
			case FKGCBLHOOCL_Category.DLBHNNOHLMM_PresentItem:
				return LDEGEHAEALK.KCCLEHLLOFG_Common.DHJFHILPKLB_IntimacyPresent[NANNGLGOFKH - 1].BFINGCJHOHI_Count;
			case FKGCBLHOOCL_Category.FMIIHMHKJDI_SpItem:
				if(NANNGLGOFKH == 13)
				{
				...
				return LDEGEHAEALK.KCCLEHLLOFG_Common.BBFIGEOBOMB_SpItem[NANNGLGOFKH - 1].BFINGCJHOHI_Count;
			case FKGCBLHOOCL_Category.NEIIGCODGBA_CostumeItem:
				return LDEGEHAEALK.KCCLEHLLOFG_Common.EFBKCNNFIPJ(NANNGLGOFKH).BFINGCJHOHI_Count;
			case FKGCBLHOOCL_Category.CIOGEKJNMBB_RareUpItem:
				{
					long time = NKGJPJPHLIF.HHCJCDFCLOB.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime();
			...
			case FKGCBLHOOCL_Category.GPMKJNDHDCP_DecoItemBg:
				return LDEGEHAEALK.OMMNKDEODJP_DecoItem.DJHBDDGEKGO_Bgs[NANNGLGOFKH - 1].BFINGCJHOHI_Count;
			case FKGCBLHOOCL_Category.OKPAJOALDCG_DecoItemObj:
				return LDEGEHAEALK.OMMNKDEODJP_DecoItem.KPMFLNOELIN_Objs[NANNGLGOFKH - 1].BFINGCJHOHI_Count;
			case FKGCBLHOOCL_Category.MCKHJLHKMJD_DecoItemChara:
				return LDEGEHAEALK.OMMNKDEODJP_DecoItem.PEBDEIKBCCM_Chars[NANNGLGOFKH - 1].BFINGCJHOHI_Count;
			case FKGCBLHOOCL_Category.ICIMCGOJEMD_StampItemSerif:
				return LDEGEHAEALK.FJPOELGFPBP_DecoStamp.DMKMNGELNAE_Serif[NANNGLGOFKH - 1].BFINGCJHOHI_Count;
			case FKGCBLHOOCL_Category.BMMBLLOKNPF_DecoItemSp:
				return LDEGEHAEALK.OMMNKDEODJP_DecoItem.NBKAMFFIOOG_Sp[NANNGLGOFKH - 1].BFINGCJHOHI_Count;
			case FKGCBLHOOCL_Category.MABCLBNIOFA_ValkyrieItem:
				return LDEGEHAEALK.KCCLEHLLOFG_Common.MJAIFKFOPPI_ValItem[NANNGLGOFKH - 1].BFINGCJHOHI_Count;
			case FKGCBLHOOCL_Category.OOMMOOIIPJE_DecoItemPoster:
				return LDEGEHAEALK.OMMNKDEODJP_DecoItem.PFNNIMBMKDL_Posters[NANNGLGOFKH - 1].BFINGCJHOHI_Count;
			case FKGCBLHOOCL_Category.AEFGOANHNMG_DecoItemPosterSceneBef:
			...
			case FKGCBLHOOCL_Category.CFLFPPDMFAE_RaidItem:
				...
				break;
			case FKGCBLHOOCL_Category.GGEFMAAOMFH_StampItemChara:
				return LDEGEHAEALK.FJPOELGFPBP_DecoStamp.FHBIIONKIDI_Stamps[NANNGLGOFKH - 1].BFINGCJHOHI_Count;
			case FKGCBLHOOCL_Category.ICJOEDJECAP_DecoSetItem:
				return LDEGEHAEALK.OMMNKDEODJP_DecoItem.NOAEDPJGBJK_Sets[NANNGLGOFKH - 1].BFINGCJHOHI_Count;
			case FKGCBLHOOCL_Category.HEMGMACMGAB_DecoItemVFFigure:
		...
		switch (INDDJNMPONH)
		{
			...
			case FKGCBLHOOCL_Category.MHKFDBLMOGF_Scene:
				...
				else
				{
					if (LDEGEHAEALK.PNLOINMCCKH_Scene.OPIBAPEGCLA[NANNGLGOFKH - 1].BEBJKJKBOGH_Date == 0)
					{
						LDEGEHAEALK.PNLOINMCCKH_Scene.OPIBAPEGCLA[NANNGLGOFKH - 1].BEBJKJKBOGH_Date = NKGJPJPHLIF.HHCJCDFCLOB.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime();
					}

					MLIBEPGADJH_Scene.KKLDOOJBJMN dbScene = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[NANNGLGOFKH - 1];
					...
					if(dbScene.KELFCMEOPPM_Ep != 0 && dbScene.PPEGAKEIEGM_En == 2)
					{
						...
						{
							LDEGEHAEALK.NGHJPEIKLJL_Episode.BBAJKJPKOHD_EpisodeList[dbScene.KELFCMEOPPM_Ep - 1].BEBJKJKBOGH_Date = NKGJPJPHLIF.HHCJCDFCLOB.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime();
			...
			case FKGCBLHOOCL_Category.KBHGPMNGALJ_Costume:
				if(NANNGLGOFKH == 0)
				{
					LDEGEHAEALK.BEKHNNCGIEL_Costume.FABAGMLEKIB_CostumeList[NANNGLGOFKH - 1].BEBJKJKBOGH_Date = 0;
				}
				else
				{
					LDEGEHAEALK.BEKHNNCGIEL_Costume.FABAGMLEKIB_CostumeList[NANNGLGOFKH - 1].BEBJKJKBOGH_Date = NKGJPJPHLIF.HHCJCDFCLOB.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime();
				}
				break;
			case FKGCBLHOOCL_Category.PFIOMNHDHCO_Valkyrie:
				if (NANNGLGOFKH == 0)
					...
					LDEGEHAEALK.JJFFBDLIOCF_Valkyrie.CNGNBKNBKGI_ValkList[NANNGLGOFKH - 1].BEBJKJKBOGH_Date = NKGJPJPHLIF.HHCJCDFCLOB.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime();
				break;
			case FKGCBLHOOCL_Category.HLCHKCJLEGK_GrowItem:
				LDEGEHAEALK.KCCLEHLLOFG_Common.KBMDMEEMGLK_GrowItem[NANNGLGOFKH - 1].BFINGCJHOHI_Count = HMFFHLPNMPH;
				break;
			case FKGCBLHOOCL_Category.MEDAKGBKIMO_EpisodeItem:
				LDEGEHAEALK.KCCLEHLLOFG_Common.GJODJNIHKKF_EpiItem[NANNGLGOFKH - 1].BFINGCJHOHI_Count = HMFFHLPNMPH;
				break;
			case FKGCBLHOOCL_Category.MNCJMDDAFJB_EmblemItem:
				if (NANNGLGOFKH == 1)
				...
				if (HMFFHLPNMPH == 0)
				{
					LDEGEHAEALK.OFAJDLJBMEM_Emblem.MDKOHOCONKE[NANNGLGOFKH - 1].FHCAFLCLGAA_EmCnt = 0;
				}
				else
				{
					if(LDEGEHAEALK.OFAJDLJBMEM_Emblem.MDKOHOCONKE[NANNGLGOFKH - 1].BEBJKJKBOGH_Date == 0)
					{
						LDEGEHAEALK.OFAJDLJBMEM_Emblem.MDKOHOCONKE[NANNGLGOFKH - 1].BEBJKJKBOGH_Date = NKGJPJPHLIF.HHCJCDFCLOB.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime();
					}
					LDEGEHAEALK.OFAJDLJBMEM_Emblem.MDKOHOCONKE[NANNGLGOFKH - 1].FHCAFLCLGAA_EmCnt = HMFFHLPNMPH - 1;
				}
				break;
			case FKGCBLHOOCL_Category.CLMIJKACELE_EventTicket:
			...
			case FKGCBLHOOCL_Category.DMMIIBCMCFG_EnergyItem:
				if(HMFFHLPNMPH == 0)
				{
					LDEGEHAEALK.KCCLEHLLOFG_Common.KFEBOFKAHAJ_EngItem[NANNGLGOFKH - 1].BFINGCJHOHI_Count = 0;
					LDEGEHAEALK.KCCLEHLLOFG_Common.KFEBOFKAHAJ_EngItem[NANNGLGOFKH - 1].BEBJKJKBOGH_Date = 0;
				}
				else
				{
					LDEGEHAEALK.KCCLEHLLOFG_Common.KFEBOFKAHAJ_EngItem[NANNGLGOFKH - 1].BFINGCJHOHI_Count = HMFFHLPNMPH;
					LDEGEHAEALK.KCCLEHLLOFG_Common.KFEBOFKAHAJ_EngItem[NANNGLGOFKH - 1].BEBJKJKBOGH_Date = NKGJPJPHLIF.HHCJCDFCLOB.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime();
				}
				break;
			case FKGCBLHOOCL_Category.IGIFMNJADEC_MvTicket:
			...
			case FKGCBLHOOCL_Category.ADCAAALBAIF_Medal:
				if (HMFFHLPNMPH == 0)
				{
					LDEGEHAEALK.KCCLEHLLOFG_Common.MHKJEBNOPIM_Medal[NANNGLGOFKH - 1].BFINGCJHOHI_Count = 0;
					LDEGEHAEALK.KCCLEHLLOFG_Common.MHKJEBNOPIM_Medal[NANNGLGOFKH - 1].BEBJKJKBOGH_Date = 0;
				}
				else
				{
					LDEGEHAEALK.KCCLEHLLOFG_Common.MHKJEBNOPIM_Medal[NANNGLGOFKH - 1].BFINGCJHOHI_Count = HMFFHLPNMPH;
					LDEGEHAEALK.KCCLEHLLOFG_Common.MHKJEBNOPIM_Medal[NANNGLGOFKH - 1].BEBJKJKBOGH_Date = NKGJPJPHLIF.HHCJCDFCLOB.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime(); ;
				}
				break;
			//case FKGCBLHOOCL_Category.IBBDMIFICCN_BonusVC:
			...
			case FKGCBLHOOCL_Category.LLFAAOHPMIC_EventGachaTicket:
				...
				break;
			case FKGCBLHOOCL_Category.DLBHNNOHLMM_PresentItem:
				LDEGEHAEALK.KCCLEHLLOFG_Common.DHJFHILPKLB_IntimacyPresent[NANNGLGOFKH - 1].BFINGCJHOHI_Count = HMFFHLPNMPH;
				break;
			case FKGCBLHOOCL_Category.FMIIHMHKJDI_SpItem:
				if (NANNGLGOFKH == 13)
				{
				...
				{
					LDEGEHAEALK.KCCLEHLLOFG_Common.BBFIGEOBOMB_SpItem[NANNGLGOFKH - 1].BFINGCJHOHI_Count = HMFFHLPNMPH;
				}
				break;
			case FKGCBLHOOCL_Category.NEIIGCODGBA_CostumeItem:
				LDEGEHAEALK.KCCLEHLLOFG_Common.EFBKCNNFIPJ(NANNGLGOFKH).BFINGCJHOHI_Count = HMFFHLPNMPH;
				break;
			case FKGCBLHOOCL_Category.CIOGEKJNMBB_RareUpItem:
				{
					long time = NKGJPJPHLIF.HHCJCDFCLOB.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime();
			...
			case FKGCBLHOOCL_Category.BMMBLLOKNPF_DecoItemSp:
				...
				break;
			case FKGCBLHOOCL_Category.MABCLBNIOFA_ValkyrieItem:
				LDEGEHAEALK.KCCLEHLLOFG_Common.MJAIFKFOPPI_ValItem[NANNGLGOFKH - 1].BFINGCJHOHI_Count = HMFFHLPNMPH;
				break;
			case FKGCBLHOOCL_Category.OOMMOOIIPJE_DecoItemPoster:
	...
	// public static void BAABHKHJBBH(OKGLGHCBCJP LKMHPJKIFDN, BBHNACPENDM_ServerSaveData LDEGEHAEALK, EKLNMHFCAOI.FKGCBLHOOCL INDDJNMPONH, int NANNGLGOFKH, IKDICBBFBMI JMFICAICKBC) { }
	...
	public static int AFEONHCADEL_GetMaxAllowed(OKGLGHCBCJP_Database LKMHPJKIFDN, BBHNACPENDM_ServerSaveData LDEGEHAEALK, EKLNMHFCAOI.FKGCBLHOOCL_Category INDDJNMPONH, int NANNGLGOFKH, IKDICBBFBMI_EventBase JMFICAICKBC)
	{
		...
		switch(INDDJNMPONH)
		{
			...
			case FKGCBLHOOCL_Category.MHKFDBLMOGF_Scene:
				{
					MLIBEPGADJH_Scene.KKLDOOJBJMN dbScene = LKMHPJKIFDN.ECNHDEHADGL_Scene.CDENCMNHNGA_table[NANNGLGOFKH - 1];
			...
			case FKGCBLHOOCL_Category.CLMIJKACELE_EventTicket:
				...
				break;
			case FKGCBLHOOCL_Category.DMMIIBCMCFG_EnergyItem:
				return LKMHPJKIFDN.KOPOGNLKAEN_EnergyItem.CDENCMNHNGA_table[NANNGLGOFKH - 1].DOOGFEGEKLG_Max;
			case FKGCBLHOOCL_Category.LLFAAOHPMIC_EventGachaTicket:
				return LKMHPJKIFDN.NKOKFIMNCJM_EventGachaTicket.CDENCMNHNGA_table[NANNGLGOFKH - 1].DOOGFEGEKLG_Max;
			case FKGCBLHOOCL_Category.FMIIHMHKJDI_SpItem:
				if(NANNGLGOFKH != 13)
				{
					return LKMHPJKIFDN.OOEPHOEFBNL_SpItem.CDENCMNHNGA_table[NANNGLGOFKH - 1].DOOGFEGEKLG_Max;
				}
				else
				{
			...
			case FKGCBLHOOCL_Category.CIOGEKJNMBB_RareUpItem:
				...
				break;
			case FKGCBLHOOCL_Category.DLOPEFGOAPD_LimitedItem:
				return LKMHPJKIFDN.IHPFCIJKFIC_LimitedItem.CDENCMNHNGA_table[NANNGLGOFKH - 1].DOOGFEGEKLG_Max;
			case FKGCBLHOOCL_Category.PJCJEOECLBK_MonthlyPassItem:
				a = 31;
				break;
			case FKGCBLHOOCL_Category.OKPAJOALDCG_DecoItemObj:
			...
			case FKGCBLHOOCL_Category.CFLFPPDMFAE_RaidItem:
				return LKMHPJKIFDN.ONOJBMDKBLE_EventRaidItem.CDENCMNHNGA_table[NANNGLGOFKH - 1].DOOGFEGEKLG_Max;
			case FKGCBLHOOCL_Category.ICJOEDJECAP_DecoSetItem:
				return LKMHPJKIFDN.MJALLIOHKEJ_DecoSetItem.CDENCMNHNGA_table[NANNGLGOFKH - 1].KEJMJPHFFOJ_Max;
			case FKGCBLHOOCL_Category.CKCPFLDGILD_LimitedCompoItem:
