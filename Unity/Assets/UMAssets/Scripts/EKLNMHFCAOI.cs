...
public class EKLNMHFCAOI
{
	...
	public static int DLNFNHMPGLI(OKGLGHCBCJP_Database LKMHPJKIFDN, BBHNACPENDM_ServerSaveData LDEGEHAEALK, FKGCBLHOOCL_Category INDDJNMPONH, int NANNGLGOFKH, IKDICBBFBMI_EventBase JMFICAICKBC)
	{
		return Mathf.Clamp(ALHCGDMEMID_GetNumItems(LKMHPJKIFDN, LDEGEHAEALK, INDDJNMPONH, NANNGLGOFKH, JMFICAICKBC), 0, EEIFENNHAHF(LKMHPJKIFDN, LDEGEHAEALK, INDDJNMPONH, NANNGLGOFKH, JMFICAICKBC));
	}
	...
	public static int EEIFENNHAHF(OKGLGHCBCJP_Database LKMHPJKIFDN, BBHNACPENDM_ServerSaveData LDEGEHAEALK, EKLNMHFCAOI.FKGCBLHOOCL_Category INDDJNMPONH, int NANNGLGOFKH, IKDICBBFBMI_EventBase JMFICAICKBC)
	{
