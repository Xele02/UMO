...
public class HJNNLPIGHLM_EventCollection : IKDICBBFBMI_EventBase // TypeDefIndex: 8979
{
	...
	protected override bool JIHMLILFOPG(long JHNMKKNEENE)
	{
		...
		if(db != null)
		{
			TodoLogger.Log(0, "HJNNLPIGHLM_EventCollection.JIHMLILFOPG");
		}
		return false;
	}
	...
	{
		TodoLogger.Log(0, "HJNNLPIGHLM_EventCollection.IMCMNOPNGHO");
		return false;
	}
	...
	public override List<string> IJCPBPFEGDM(long JHNMKKNEENE)
	{
		if(!MNNNLDFNNCD(JHNMKKNEENE))
			return null;
		TodoLogger.Log(0, "HJNNLPIGHLM_EventCollection.IJCPBPFEGDM");
		return null;
	}
