...
public class GONMPHKGKHI_RewardView
{
	...
	//public bool LBHPMGDNPHK(GONMPHKGKHI.CECMLGBLHHG INDDJNMPONH) { }
	...
	public bool JDKOAKDLHMG(CECMLGBLHHG INDDJNMPONH, ref List<LCMJJMNMIKG_RewardInfo> PJFOENCFNEK, ref List<LCMJJMNMIKG_RewardInfo> MPCJGPEBCCD, ref List<int> BBAJKJPKOHD)
	{
		...
		if(INDDJNMPONH == CECMLGBLHHG.INJNLJHGGKB/*4*/)
		{
		...
		switch(INDDJNMPONH)
		{
			case CECMLGBLHHG.AGLFBCCGHJM/*2*/:
			...
			case CECMLGBLHHG.BKHAAGAAIHJ/*7*/:
				...
				break;
			case CECMLGBLHHG.JCGKGFLCKCP/*8*/:
