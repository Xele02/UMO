...
public class PIGBKEIAMPE_FriendManager
{
	...
	private void IMLMNFGDFPE(CACGCMBKHDI_Request _ADKIDBJCAJA_action, CACGCMBKHDI_Request.HDHIKGLMOGF MOBEEPPKFLG, CACGCMBKHDI_Request.HDHIKGLMOGF AOCANKOMKFG)
	{
		...
		if(AOCANKOMKFG != null)
		{
			AOCANKOMKFG(_ADKIDBJCAJA_action);
		}
	}
	...
	public void IJGADKKPAGJ(IMCBBOAFION BHFHGFKBOHH, CACGCMBKHDI_Request.HDHIKGLMOGF MOBEEPPKFLG, CACGCMBKHDI_Request.HDHIKGLMOGF AOCANKOMKFG)
	{
		...
		COJNCNGHIJC.BHFHGFKBOHH_OnSuccess = (CACGCMBKHDI_Request KFBCOGJKEJP) =>
		{
			...
			else
			{
				...
				{
					//0x925F4C
					CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.FFJHJGFKMJB_FriendCheckTime = CPHFEPHDJIB.FJDBNGEPKHL.KMEFBNBFJHI_GetServerTime();
					BFDEHIANFOG.Clear();
					for(int i = 0; i < IODPMHILFDI.Count; i++)
					{
						BFDEHIANFOG.Add(IODPMHILFDI[i]);
	...
	// public void EICNBEKECJG(List<IBIGBMDANNM> _AHEFHIMGIBI_PlayerData, IMCBBOAFION BHFHGFKBOHH, CACGCMBKHDI.HDHIKGLMOGF MOBEEPPKFLG, CACGCMBKHDI.HDHIKGLMOGF AOCANKOMKFG) { }
	...
	// public static SakashoPlayerCriteria NKNOLNNPGAC(BBHNACPENDM _AHEFHIMGIBI_PlayerData) { }

	// // RVA: 0x16D9C04 Offset: 0x16D9C04 VA: 0x16D9C04
	// public static SakashoPlayerCriteria NKNOLNNPGAC(BBHNACPENDM _AHEFHIMGIBI_PlayerData, int PPFNGGCBJKC) { }
