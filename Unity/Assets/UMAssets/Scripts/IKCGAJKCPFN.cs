...
public class IKCGAJKCPFN
{
	...
	public void LHPDDGIJKNB_Reset(int PPFNGGCBJKC, int KNEFBLHBDBG)
	{
		BEBJKJKBOGH_date = 0;
	...
	//public void AGHKODFKOJI(BHBONAHFKHD JBBHNIACMFJ, string JIKKNHIAEKG, string MJBACHKCIHA, int _OIPCCBHIKIA_index, IKCGAJKCPFN _OHMCIEMIKCE_t, bool EFOEPDLNLJG) { }
