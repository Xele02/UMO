...
public class JKNNIKNKMNJ
{
	...
	public long DLPEEDCCNMJ_CntSaveTime { get
		...
		} } //0x1472734 IPMOLPGCIIB_bgs 0x1472488 POJLMKDPBHI_bgs
	public int NEPIPMPAFIE_CntVal { get
		...
		set
		{
			...
			HICKJFPDBEG = PINPIHODOKP ^ FBGGEFFJJHB_xor;
		} } //0x1472770 DNNADJLKBPC_bgs 0x14724A8 BJOJAFDBOBL_bgs
	...
	} //0x1472798 HHBCMCGODFP_bgs 0x14724E4 NPANKNNLDOB_bgs
	public long FLJGHBLEDDB_UpdateInterval { get
		...
		set
		{
			...
			if (value == 0)
				OPDBPKLCEFO = 1;
			JCGIEJGOEIM = OPDBPKLCEFO ^ FBGGEFFJJHB_xor;
		} } //0x14727C0 DEOLPKEGHFP_bgs 0x1472520 OCIMIINBMAD_bgs
	public long FJDBNGEPKHL_Time { get { 
		...
		} //0x14727FC FIIMIGEKDCM_bgs 0x1472568 JFIOOGMDBJD_bgs
	...
	public JKNNIKNKMNJ()
    {
        ...
        DDPGLABEIEM = 0;
        FBGGEFFJJHB_xor = (int)time ^ 0x71020923;
        EHCBKLCHFHE = FBGGEFFJJHB_xor;
        PINPIHODOKP = GPBGFJONHPB_GetMaxIntimacy();
        HICKJFPDBEG = PINPIHODOKP ^ FBGGEFFJJHB_xor;
        OPDBPKLCEFO = 60;
        MKMBHBOGFHM = 0;
        BPADHGOCPIH = GPBGFJONHPB_GetMaxIntimacy();
        EMGIAPOEKLL = BPADHGOCPIH ^ FBGGEFFJJHB_xor;
        JCGIEJGOEIM = FBGGEFFJJHB_xor ^ 0x3c;
        HFMOEKIBNKA = FBGGEFFJJHB_xor;
    }
	...
	public int DCLKMNGMIKC_GetCurrentValue(bool LIFPCFFJEOA/* = false*/)
	{
		if(!LIFPCFFJEOA)
		{
	...
	// public bool MAPPOEFALIP(int BBCCIJGFKHD, bool MDNODGAFHJN = True, bool _DDGFCOPPBBN_test = True) { }
