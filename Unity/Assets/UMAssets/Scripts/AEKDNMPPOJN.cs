				...
				if(!PLOEDFHCGFA.JMHIDPKHELB)
				{
					...
					else
					{
						if(EKLNMHFCAOI.BKHFLDMOGBD_GetItemCategory(PLOEDFHCGFA.MJNOAMAFNHA_CostItemId) == EKLNMHFCAOI.FKGCBLHOOCL_Category.HLCHKCJLEGK_GrowItem)
						{
							...
							{
								//0x15BE164
								ILCCJNDFFOB.HHCJCDFCLOB.EEOLHMGNJGO(_BCCHOBPJJKE_SceneId, MABBBOEAPAA_p.EKLIPGELKCL_Rarity, MJBODMOLOBC_luck, PLOEDFHCGFA.MJNOAMAFNHA_CostItemId, PLOEDFHCGFA.IJEOIMGILCK, PLOEDFHCGFA.GNKGDDMMJPF, ICPDDMIBEIL_Bf, IBDJFHFIIHN_s.DMNIMMGGJJJ_Leaf);
