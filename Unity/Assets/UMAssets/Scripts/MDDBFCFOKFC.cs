...
public class MDDBFCFOKFC
{
	public class IFHIAPIJGMI
	{
		...
		public long NPDKEIIMCDI_LastShowtime { get { return OPHCDLEFFIP ^ BHEHGCHGBDG; } set { OPHCDLEFFIP = value ^ BHEHGCHGBDG; } } //0x130F528 NEGDLLGOPKH_bgs 0x130F4E8 FEAJLAKILIO_bgs
		public bool CINLIMIKCAL_EnableBgEffect { get { return DIFBAMPAOJI == GCAHAAADBEH; } set { DIFBAMPAOJI = value ? GCAHAAADBEH : GKIDNIKODDK; } } //0x130F548 AMJHFHHKBIM_bgs 0x130F50C PCCOLLEDFMJ_bgs
		public bool HEKJKLJDHNN_EnablePosterAnim { get { return AMEELEFFAEC == GCAHAAADBEH; } set { AMEELEFFAEC = value ? GCAHAAADBEH : GKIDNIKODDK; } } //0x130F564 JGCAHFJDAKI_bgs 0x130F580 CDBCKJDGPNF_bgs
