...
public class OJEGDIBEBHP
{
	...
	public void KHEKNNFCAOI_Init(int _PPFNGGCBJKC_id)
	{
		if(_PPFNGGCBJKC_id > 0)
		{
			...
			PNJICDLDCAE = db.JBGEEPFKIGG_Value;
			...
			GLHBKPNFLOP_Count = save.BFINGCJHOHI_Count;
	...
	public static List<OJEGDIBEBHP> FKDIMODKKJD()
	{
		...
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				...
				{
					//0x148CF24
					int r = HKICMNAACDA.JONPKLHMOBL_Category.CompareTo(BNKHBCBJBKI.JONPKLHMOBL_Category);
					if(r == 0)
					{
						r = HKICMNAACDA.PNJICDLDCAE.CompareTo(BNKHBCBJBKI.PNJICDLDCAE);
						if(r == 0)
							r = HKICMNAACDA.KIJAPOFAGPN_ItemId.CompareTo(BNKHBCBJBKI.KIJAPOFAGPN_ItemId);
					}
					return r;
				});
			}
