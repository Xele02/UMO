...
public class BKKMNPEEILG
{
	...
	public void KHEKNNFCAOI_Init(HAEDCCLHEMN_NetEventBattleController _MOHDLLIJELH_cont, int ODHFJJCJHDD)
	{
	...
	public void GOCAPCKLAPI(HAEDCCLHEMN_NetEventBattleController _MOHDLLIJELH_cont, int _GHBPLHBNMBK_FreeMusicId)
	{
		...
		AMCGONHBGGF d = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.MLAFAACKKBG_Unit.FJDDNKGHPHN_GetDefault().FDBOPFEOENF_diva[0];
		...
		{
			AFBMEMCHJCL_MainScene = new GCIJNCFDNON_SceneInfo();
			MMPBPOIFDAF_Scene.PMKOFEIONEG saveScene = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.PNLOINMCCKH_Scene.OPIBAPEGCLA_Scenes[d.EBDNICPAFLB_s_slot[0] - 1];
			MLIBEPGADJH_Scene.KKLDOOJBJMN dbScene = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[d.EBDNICPAFLB_s_slot[0] - 1];
			AFBMEMCHJCL_MainScene.KHEKNNFCAOI_Init(d.EBDNICPAFLB_s_slot[0], null, null, saveScene.JPIPENJGGDD_NumBoard, 0, dbScene.AGOEDLNOHND(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, saveScene.EMOJHJGHJLN_Sb, saveScene.JPIPENJGGDD_NumBoard, IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.GENHLFPKOEE(dbScene.EKLIPGELKCL_Rarity, dbScene.MCCIFLKCNKO_Feed)), false, 0, saveScene.DMNIMMGGJJJ_Leaf);
			AFBMEMCHJCL_MainScene.CIEOBFIIPLD_Level = saveScene.ANAJIAENLNB_lv;
		}
		FDBOPFEOENF_diva = new FFHPBEPOMAK_DivaInfo();
		FDBOPFEOENF_diva.KHEKNNFCAOI_Init(d.DIPKCALNIII_diva_id, CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.DGCJCAHIAPP_Diva.LGKFMLIOPKL_GetDivaInfo(d.DIPKCALNIII_diva_id).HEBKEJBDCBH_diva_lv, d.BEEAIAAJOHD_CostumeId, d.AFNIOJHODAG_CostumeColorId, AFBMEMCHJCL_MainScene, null, false);
		OPFGFINHFCE_name = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.JHFIPCIHJNL_Base.OPFGFINHFCE_name;
		if(v < 0)
		{
	...
	public void HNLMOCGGIGH()
	{
		...
		{
			AFBMEMCHJCL_MainScene = new GCIJNCFDNON_SceneInfo();
			AFBMEMCHJCL_MainScene.KHEKNNFCAOI_Init(diva.EBDNICPAFLB_s_slot[0], null, null, CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.PNLOINMCCKH_Scene.OPIBAPEGCLA_Scenes[diva.EBDNICPAFLB_s_slot[0] - 1].JPIPENJGGDD_NumBoard, 0, 0, false, 0, 0);
			AFBMEMCHJCL_MainScene.CIEOBFIIPLD_Level = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.PNLOINMCCKH_Scene.OPIBAPEGCLA_Scenes[diva.EBDNICPAFLB_s_slot[0] - 1].ANAJIAENLNB_lv;
		}
		FDBOPFEOENF_diva = new FFHPBEPOMAK_DivaInfo();
		FDBOPFEOENF_diva.KHEKNNFCAOI_Init(diva.DIPKCALNIII_diva_id, CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.DGCJCAHIAPP_Diva.LGKFMLIOPKL_GetDivaInfo(diva.DIPKCALNIII_diva_id).HEBKEJBDCBH_diva_lv, diva.BEEAIAAJOHD_CostumeId, diva.AFNIOJHODAG_CostumeColorId, AFBMEMCHJCL_MainScene, null, false);
		OPFGFINHFCE_name = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.JHFIPCIHJNL_Base.OPFGFINHFCE_name;
		BEBJKJKBOGH_date = NKGJPJPHLIF_SakashoManager.HHCJCDFCLOB_Instance.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime();
