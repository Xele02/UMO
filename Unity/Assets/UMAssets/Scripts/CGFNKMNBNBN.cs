...
public class CGFNKMNBNBN
{
	...
	{
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.PFEKKPABPKL_HomeBg.CDENCMNHNGA.Count > PPFNGGCBJKC - 1)
		{
			CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.POCPLFJCHDD_HomeBg[PPFNGGCBJKC - 1].BEBJKJKBOGH_Date = BEBJKJKBOGH_Time;
		}
	}

	// // RVA: 0x12BACA8 Offset: 0x12BACA8 VA: 0x12BACA8
	public static void DPMCLJMIBDK(BBHNACPENDM_ServerSaveData _AHEFHIMGIBI_PlayerData, int PPFNGGCBJKC, long BEBJKJKBOGH)
	{
		if(PPFNGGCBJKC - 1 < IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.PFEKKPABPKL_HomeBg.CDENCMNHNGA.Count)
		{
			_AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.POCPLFJCHDD_HomeBg[PPFNGGCBJKC - 1].BEBJKJKBOGH_Date = BEBJKJKBOGH;
		}
	}
	...
	public static bool DGCIHGPOMCI_CheckHomeBgExpire(long JHNMKKNEENE)
	{
		if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.MDKELFPNCDB_HomeSceneEvolveId == 0)
		{
			...
			if(g != null)
			{
				...
				{
					CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.GPHPNEGGGBG_HomeSceneId = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.MGFMPKLLGHE_Diva.CDENCMNHNGA_Divas[GameManager.Instance.GetHomeDiva().AHHJLDLAPAN_DivaId - 1].CMBCBNEODPD_HomeBgId;
					return true;
				}
			}
		}
