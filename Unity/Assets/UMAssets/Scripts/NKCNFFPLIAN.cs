...
{
	private NNJFKLBPBNK_SecureString MLCELGHBCLK_KeyCrypted = new NNJFKLBPBNK_SecureString(); // 0x8
    ...
    {
        MLCELGHBCLK_KeyCrypted.DNJEJEANJGL_Value = ((string)OBHAFLMHAKG[AFEHLCGHAEE_Strings.LJNAKDMILMC_key]);
        ...
        CKDHEFMLDIG_GameId.DNJEJEANJGL_Value = ((int)OBHAFLMHAKG[AFEHLCGHAEE_Strings.DMJGDDEACMD_game_id]);
    }
