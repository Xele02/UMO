...
public class NKCNFFPLIAN
{
    ...
    {
        MLCELGHBCLK.DNJEJEANJGL_Value = ((string)OBHAFLMHAKG[AFEHLCGHAEE_Strings.LJNAKDMILMC_key]);
        PJHFOFGOPDA.DNJEJEANJGL_Value = ((int)OBHAFLMHAKG[AFEHLCGHAEE_Strings.CNDDKMJAIBG_mode]);
        FINCFIGKHPA.DNJEJEANJGL_Value = ((string)OBHAFLMHAKG[AFEHLCGHAEE_Strings.OPFGFINHFCE_name]);
        CKDHEFMLDIG.DNJEJEANJGL_Value = ((int)OBHAFLMHAKG[AFEHLCGHAEE_Strings.DMJGDDEACMD_game_id]);
    }
