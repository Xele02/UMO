...
public class IFBCGCCJBHI
{
	...
	public string FPLEADMHLKN { get; private set; } // 0x28 LAOBMPGBJBI KFJLNKOMGJB ENMDNIKAKEI
	...
	// public string KOENBEGADHP { get; private set; } // 0x2C GDKGMEDOGJL FJOICJOJJEB JJNFELKEKHO
	...
	public int AAODIMMEFBI { get; private set; } // 0x30 GPADNICDEGE IHMBMOACINF OJLEJOKHKFP
	public int JHKAEJBNGKE { get; private set; } // 0x38 IJMECHNGGLC IIDDKFAKIDO KHMAEPICIAN
	// public HighScoreRatingRank.Type ILELGGCCGMJ { get; private set; } // 0x3C NNBOAJNHMOA LADENPJCBJM JNAAPMEFGMG
	...
	public void FBANBDCOEJL()
    {
        if(KCCLEHLLOFG == null)
        {
            if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI.KCCLEHLLOFG != null)
            {
                KCCLEHLLOFG = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI.KCCLEHLLOFG;
            }
        }
        IGHDEGMBPKI();
        FOCDOMKICKL();
