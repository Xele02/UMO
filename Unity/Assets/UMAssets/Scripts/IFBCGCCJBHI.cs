...
public class IFBCGCCJBHI
{
	...
	public int GBIKGLELKEO_MedalValue { get
		{
			...
			return CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.MHKJEBNOPIM_Medal[id - 1].BFINGCJHOHI_Count;
		}
	...
	public void KHEKNNFCAOI()
	{
		...
		KCCLEHLLOFG_SaveCommon = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common;
