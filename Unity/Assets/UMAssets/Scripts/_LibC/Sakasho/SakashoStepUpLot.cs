...
namespace ExternLib
{
	public static partial class LibSakasho
	{
		public static int SakashoStepUpLotPurchase(int callbackId, string json)
		{
			...
			res[AFEHLCGHAEE_Strings.LKHAAGIJEPG_player_status][AFEHLCGHAEE_Strings.DBNAGGGJDAB_CurrentStepIndex] = 0;
			...
			res[AFEHLCGHAEE_Strings.LKHAAGIJEPG_player_status][AFEHLCGHAEE_Strings.ENJCKADOFBD_NextPurchaseHash] = "";
		...
		public static int SakashoStepUpLotGetStepUpLotRecords(int callbackId, string json)
		{
			// Hack directly send response

			EDOHBJAPLPF_JsonData res = GetBaseMessage();
			res["step_up_lots"] = new EDOHBJAPLPF_JsonData();
			res["step_up_lots"].LAJDIPCJCPO_SetJsonType(JFBMDLGBPEN_JsonType.BDHGEFMCJDF_Array);
			SendMessage(callbackId, res);
			// end hack
