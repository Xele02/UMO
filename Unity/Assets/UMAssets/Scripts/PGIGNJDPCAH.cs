...
public class PGIGNJDPCAH
{
	...
	private static IEnumerator OOILBGOKHDC_Co_ReGetSeverTime(bool _FBBNPFFEJBN_Force, IMCBBOAFION _GIMKOLPGIAO_OnSuccess, IMCBBOAFION MBIKIBHLAGE)
	{
	...
	public static bool MNANNMDBHMP(IMCBBOAFION _GIMKOLPGIAO_OnSuccess, IMCBBOAFION MBIKIBHLAGE_OnError)
	{
		if(!LANLFCFBOHI)
		{
			...
			switch(EALOBDHOCHP_Stat)
			{
				...
				case IMOIPBMGIPN.PJPJEHEFMMJ:
					JHHBAFKMBDL.HHCJCDFCLOB.PNIJEKOHEII(() =>
					{
						...
						N.a.StartCoroutineWatched(OOILBGOKHDC_Co_ReGetSeverTime(EALOBDHOCHP_Stat == IMOIPBMGIPN.CKOMFNPGHOM, _GIMKOLPGIAO_OnSuccess, MBIKIBHLAGE_OnError));
					});
					LANLFCFBOHI = true;
					return true;
			}
