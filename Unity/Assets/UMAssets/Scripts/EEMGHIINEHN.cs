...
public class EEMGHIINEHN
{
	...
	public void CLFGOPNDGNL_SetScene(GCIJNCFDNON_SceneInfo IFGEJDMMAHE, int IGNIIEBMFIN, int IMJIADPJJMM)
	{
		if (CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_ServerSave != null)
		{
			...
			CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_ServerSave.IGNHLKEMJND_AssistPlate.LDIINNKMLLO[IGNIIEBMFIN].JOHLGBDOLNO_DataList[IMJIADPJJMM].DOMFHDPMCCO(IFGEJDMMAHE.BCCHOBPJJKE_SceneId, IFGEJDMMAHE.KBOLNIBLIND_Mb, IFGEJDMMAHE.ODKMKEHJOCK_Sb, IFGEJDMMAHE.MJBODMOLOBC_Luck, IFGEJDMMAHE.JPIPENJGGDD_NumBoard, IFGEJDMMAHE.MKHFCGPJPFI_LimitOverCount);
		}
	}
