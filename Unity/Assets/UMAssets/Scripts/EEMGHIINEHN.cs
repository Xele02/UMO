...
public class EEMGHIINEHN
{
	...
	private void AODCGBBHKDJ(BBHNACPENDM_ServerSaveData LDEGEHAEALK, int IGNIIEBMFIN/* = 0*/)
	{
		...
		for(int i = 0; i < saveAssistPlate.JOHLGBDOLNO_DataList.Length; i++)
		{
			if(saveAssistPlate.JOHLGBDOLNO_DataList[i].PPFNGGCBJKC_Id > 0)
			{
				...
				data.JOHLGBDOLNO_AssistScenes[i].KHEKNNFCAOI(saveScene.PPFNGGCBJKC_Id, saveScene.PDNIFBEGMHC_Mb, saveScene.EMOJHJGHJLN_Sb, saveScene.JPIPENJGGDD_Mlt, 1, saveScene.MJBODMOLOBC_Luck, saveScene.LHMOAJAIJCO_New, 0, saveScene.DMNIMMGGJJJ_Leaf);
			}
		}
	...
	public void CLFGOPNDGNL_SetScene(GCIJNCFDNON_SceneInfo IFGEJDMMAHE, int IGNIIEBMFIN, int IMJIADPJJMM)
	{
		...
		{
			NPDOIBMDEGK[IGNIIEBMFIN].JOHLGBDOLNO_AssistScenes[IMJIADPJJMM].KHEKNNFCAOI(IFGEJDMMAHE.BCCHOBPJJKE_SceneId, IFGEJDMMAHE.KBOLNIBLIND_Mb, IFGEJDMMAHE.ODKMKEHJOCK_Sb, IFGEJDMMAHE.JPIPENJGGDD_NumBoard, IFGEJDMMAHE.IELENGDJPHF, IFGEJDMMAHE.MJBODMOLOBC_Luck, false, 0, IFGEJDMMAHE.MKHFCGPJPFI_LimitOverCount);
			CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.IGNHLKEMJND_AssistPlate.LDIINNKMLLO[IGNIIEBMFIN].JOHLGBDOLNO_DataList[IMJIADPJJMM].DOMFHDPMCCO(IFGEJDMMAHE.BCCHOBPJJKE_SceneId, IFGEJDMMAHE.KBOLNIBLIND_Mb, IFGEJDMMAHE.ODKMKEHJOCK_Sb, IFGEJDMMAHE.MJBODMOLOBC_Luck, IFGEJDMMAHE.JPIPENJGGDD_NumBoard, IFGEJDMMAHE.MKHFCGPJPFI_LimitOverCount);
		}
	}
	...
	public void NODLMHKAGFD_RemoveScene(int IGNIIEBMFIN, int IMJIADPJJMM)
	{
		...
		CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.IGNHLKEMJND_AssistPlate.LDIINNKMLLO[IGNIIEBMFIN].JOHLGBDOLNO_DataList[IMJIADPJJMM].KMBPACJNEOF_Reset();
	}

	//// RVA: 0x1C4AEB8 Offset: 0x1C4AEB8 VA: 0x1C4AEB8
	public void EGENJDLKEJP(int IGNIIEBMFIN, string JAOODKBNALI)
	{
		CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.IGNHLKEMJND_AssistPlate.LDIINNKMLLO[IGNIIEBMFIN].JCJNKBKMJFK_Name = JAOODKBNALI;
	}

	//// RVA: 0x1C4AAF4 Offset: 0x1C4AAF4 VA: 0x1C4AAF4
	public void AIMMBGFMFOD(int IGNIIEBMFIN)
	{
		JNMFKOHFAFB_PublicStatus.ONCMONJIPCD data = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.IGNHLKEMJND_AssistPlate.LDIINNKMLLO[IGNIIEBMFIN];
		CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.MHEAEGMIKIE_PublicStatus.MGMFOJPNDGA_AssistData.DOMFHDPMCCO(data.JOHLGBDOLNO_DataList, data.JCJNKBKMJFK_Name);
	}

	//// RVA: 0x1C4AFCC Offset: 0x1C4AFCC VA: 0x1C4AFCC
	public void CEIOGBFIDKI_SetPage(int IGNIIEBMFIN)
	{
		CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.IGNHLKEMJND_AssistPlate.HODDNKENKHD_Page = IGNIIEBMFIN;
	}
