...
public class EAOHMJHHDKN_GachaLimit : KLFDBFMNLBL_ServerSaveBlock
{
	public class EODJHACIKGM
	{
		...
		public int BFINGCJHOHI_Count { get { return IFEHKNJONPL ^ FBGGEFFJJHB_xor; } set { IFEHKNJONPL = value ^ FBGGEFFJJHB_xor; } } //0x14F28DC LFMCLIDAPHB 0x14F28EC EDAEPDGGFJJ
	...
	public int CFLDNJANAPI(int HHGMPEEGFMA)
	{
		...
		{
			//0x14F5B5C
			return HHGMPEEGFMA == _GHPLINIACBB_x.FEFDGBPFKBJ_GId;
		});
	...
	public void KHBNLBNPGPK(int HHGMPEEGFMA, int _DNBFMLBNAEE_Point)
	{
	...
	// public bool JMFILPONAEC(int HHGMPEEGFMA, int _DNBFMLBNAEE_Point) { }
