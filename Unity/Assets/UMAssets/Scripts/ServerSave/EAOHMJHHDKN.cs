...
public class EAOHMJHHDKN_GachaLimit : KLFDBFMNLBL_ServerSaveBlock
{
	...
	{
		BIHCALIAJII_GachaLimit.AICPHCIFEJL a = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.OINLLHOMEAK_GachaLimit.CDENCMNHNGA.Find((BIHCALIAJII_GachaLimit.AICPHCIFEJL GHPLINIACBB) =>
		{
			//0x14F5BA0
			return HHGMPEEGFMA == GHPLINIACBB.FEFDGBPFKBJ_GId;
		});
		...
		{
			OECAPENFOHH[a.PPFNGGCBJKC_Id - 1].FOILNHKHHDF_Pt = DNBFMLBNAEE;
		}
	}
