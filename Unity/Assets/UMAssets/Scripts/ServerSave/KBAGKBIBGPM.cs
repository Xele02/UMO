...
public class KBAGKBIBGPM_EventRaidLobby : KLFDBFMNLBL_ServerSaveBlock
{
	...
	public override bool DMICHEJIAJL { get { TodoLogger.LogError(0, "DMICHEJIAJL"); return false; } } // 0x10182CC NFKFOODCJJB
	...
	{
		TodoLogger.LogError(0, "KBAGKBIBGPM_EventRaidLobby.BMGGKONLFIC");
	}
