...
public class KBAGKBIBGPM_EventRaidLobby : KLFDBFMNLBL_ServerSaveBlock
{
	...
	public override bool DMICHEJIAJL { get { TodoLogger.Log(0, "DMICHEJIAJL"); return false; } } // 0x10182CC NFKFOODCJJB
	...
	{
		TodoLogger.Log(0, "KBAGKBIBGPM_EventRaidLobby.BMGGKONLFIC");
	}
