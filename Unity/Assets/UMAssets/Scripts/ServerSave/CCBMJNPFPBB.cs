...
public class CCBMJNPFPBB_EventGoDiva : KLFDBFMNLBL_ServerSaveBlock
{
	...
	public override bool DMICHEJIAJL { get { TodoLogger.Log(0, "DMICHEJIAJL"); return false; } } // 0x1907094 NFKFOODCJJB
	...
	{
		TodoLogger.Log(0, "CCBMJNPFPBB_EventGoDiva.BMGGKONLFIC");
	}
