...
public class JLOGEHCIBEJ_EventRaid : KLFDBFMNLBL_ServerSaveBlock
{
	...
	// public List<JLOGEHCIBEJ.PMJBKKNNNEM> FBCJICEPLED = new List<JLOGEHCIBEJ.PMJBKKNNNEM>(4); // 0x24

	public override bool DMICHEJIAJL { get { TodoLogger.LogError(0, "DMICHEJIAJL"); return false; } } // 0x1489874 NFKFOODCJJB
	...
	{
		TodoLogger.LogError(0, "JLOGEHCIBEJ_EventRaid.BMGGKONLFIC");
	}
