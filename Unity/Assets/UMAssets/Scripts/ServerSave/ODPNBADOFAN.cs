...
public class ODPNBADOFAN_Quest : KLFDBFMNLBL_ServerSaveBlock
{
	...
	// public List<NFPHOINMHKN> BEGCHDHHEKC { get; private set; } // 0x30 DEBOJOHHPPB CFINEIEEJGN
	// public List<NFPHOINMHKN> GPMKFMFEKLN { get; private set; } // 0x34 HDOHKBOJCDK CDNIDJPOHDJ
