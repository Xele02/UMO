...
public class DAJBODHMLAB_DecoPublicSet : KLFDBFMNLBL_ServerSaveBlock
{
	public class MMLACIFMNBN
	{
		...
		public class MHODOAJPNHD
		{
			...
			internal int GJNKFOGMIMI { get { return LJEEMGKEDNJ ^ ENOBDCFHELD; } set { int val = (int)(value * 0.001f * 1000); LJEEMGKEDNJ = val ^ ENOBDCFHELD; GAKIJIFHEJN = val ^ FCEJCHGLFGN; } } //0x176BFD8 DNLHFDJILLD 0x176C04C AIIJFIDBLFK
			//public float PMBEODGMMBB { get; set; } 0x176D634 AGPLCEEFJLA 0x176D8FC LFCJDENJMLB
			internal int NKMDIBLJJOP { get { return LGIMNGEIJGK ^ ENOBDCFHELD; } set { int val = (int)(value * 0.001f * 1000); LGIMNGEIJGK = val ^ ENOBDCFHELD; CGMGJNDGPPM = val ^ FCEJCHGLFGN; } } //0x176BFE8 COCMHOFBCCK 0x176C090 MNCEODGPKMH
	...
	{
		TodoLogger.LogError(0, "DAJBODHMLAB_DecoPublicSet.BMGGKONLFIC");
	}
