...
public class DAJBODHMLAB_DecoPublicSet : KLFDBFMNLBL_ServerSaveBlock
{
	public class MMLACIFMNBN
	{
		...
		public class MHODOAJPNHD
		{
			...
			public float GHPLINIACBB_x { get { return (ENOBDCFHELD ^ LJEEMGKEDNJ) * 0.001f; } set { LJEEMGKEDNJ = ENOBDCFHELD ^ (int)(value * 1000); GAKIJIFHEJN = FCEJCHGLFGN ^ (int)(value * 1000); } } //0x176D60C GOJKHPHOOEE_bgs 0x176D8C8 IPKNCHLGHFD_bgs
			internal int GJNKFOGMIMI_PosXSerialize { get { return LJEEMGKEDNJ ^ ENOBDCFHELD; } set { int val = (int)(value * 0.001f * 1000); LJEEMGKEDNJ = val ^ ENOBDCFHELD; GAKIJIFHEJN = val ^ FCEJCHGLFGN; } } //0x176BFD8 DNLHFDJILLD_bgs 0x176C04C AIIJFIDBLFK_bgs
			public float PMBEODGMMBB_y { get { return (ENOBDCFHELD ^ LGIMNGEIJGK) * 0.001f; } set { LGIMNGEIJGK = ENOBDCFHELD ^ (int)(value * 1000); CGMGJNDGPPM = FCEJCHGLFGN ^ (int)(value * 1000); } } //0x176D634 AGPLCEEFJLA_bgs 0x176D8FC LFCJDENJMLB_bgs
			internal int NKMDIBLJJOP_PosYSerialize { get { return LGIMNGEIJGK ^ ENOBDCFHELD; } set { int val = (int)(value * 0.001f * 1000); LGIMNGEIJGK = val ^ ENOBDCFHELD; CGMGJNDGPPM = val ^ FCEJCHGLFGN; } } //0x176BFE8 COCMHOFBCCK_bgs 0x176C090 MNCEODGPKMH_bgs
			// ItemId (Ressource)
			public int HAJKNHNAIKL_rsc { get { return PJALGHAOGCE ^ ENOBDCFHELD; } set { PJALGHAOGCE = value ^ ENOBDCFHELD; ADICEMPDBAE = value ^ FCEJCHGLFGN; } } //0x176BFF8 CHDEEDLPLAA_bgs 0x176C0D4 NHADJDKFFIG_bgs
			public bool BDEEIPPDCLE_rvs { get { return PCJHFAAMGAH == 0x38; } set { PCJHFAAMGAH = (sbyte)(value ? 0x38 : 0x53); } } //0x176C008 EFBIEBOEHOJ_bgs 0x176C0F0 PENHPNOFDKB_bgs
			public int BNHOEFJAAKK_prio { get { return JIBCHJDMAFA ^ ENOBDCFHELD; } set { JIBCHJDMAFA = value ^ ENOBDCFHELD; AFNPBPGEDLB = value ^ FCEJCHGLFGN; } } //0x176C01C NNDJHLOPFJB_bgs 0x176C120 EKMPDECBDOB_bgs
			public int BEJGNPAAKNB_word { get { return MJDLLJGJKEI_WordCrypted ^ ENOBDCFHELD; } set { MJDLLJGJKEI_WordCrypted = value ^ ENOBDCFHELD; JAKAGBCBFLO = value ^ FCEJCHGLFGN; } } //0x176C02C PPHPHCADCLJ_get_word 0x176C13C BPMLEPPPCKP_set_word
			// Statusflag
			public int PMIPFEJFIHA_stat { get { return EAPDICKFGNM ^ ENOBDCFHELD; } set { EAPDICKFGNM = value ^ ENOBDCFHELD; JBHCPDGLCOO = value ^ FCEJCHGLFGN; } } //0x176C03C BNGHLGAOGNG_bgs 0x176C158 JEPICLOKDAG_bgs
		...
		public string CPOONLHIMKC_DecoRoomName { get { return KAENAEHCLMP_DecoRoomName; } set { KAENAEHCLMP_DecoRoomName = value; } } //0x176BF24 EGFOKPACAHL_bgs 0x176BF2C NKDCIFIDHDL_bgs
		public int DJCJMCHMIMA_WallLId { get { return LJAADOFBMAJ ^ ENOBDCFHELD; } set { LJAADOFBMAJ = value ^ ENOBDCFHELD; JELNKIBKKIJ = value ^ FCEJCHGLFGN; } } //0x176BF34 LLMDHOMKOHB_bgs 0x176BF44 FHCEBEENCFG_bgs
		public int KCMEAABOIOA_WallRId { get { return JDDKKOAHKPO ^ ENOBDCFHELD; } set { JDDKKOAHKPO = value ^ ENOBDCFHELD; KPJJLKDGEJF = value ^ FCEJCHGLFGN; } } //0x176BF60 LHKGNNDOKLN_bgs 0x176BF70 FGOAMABINND_bgs
		public int KIDHLCNFCKN_FloorId { get { return GIMNIBICIAI ^ ENOBDCFHELD; } set { GIMNIBICIAI = value ^ ENOBDCFHELD; JEBMJANJBFC = value ^ FCEJCHGLFGN; } } //0x176BF8C LFMALKBBENB_bgs 0x176BF9C LJJNNNPDPDM_bgs
	...
	//public bool KCMEDJHEGGM { get; set; } //0x1769500  KPMHCNNEOLK_bgs 0x17695FC HGHNELFKMJF _bgs
	public override bool DMICHEJIAJL { get { return true; } } // 0x176BBB4 NFKFOODCJJB_bgs
