...
public class FJGNPNFLHPH_EventCollection : KLFDBFMNLBL_ServerSaveBlock
{
	...
	public override bool DMICHEJIAJL { get { TodoLogger.LogError(0, "DMICHEJIAJL"); return false; } } // 0x14F0124 NFKFOODCJJB

	// // RVA: 0x14E9B00 Offset: 0x14E9B00 VA: 0x14E9B00
	public FJGNPNFLHPH_EventCollection()
	{
		TodoLogger.LogError(TodoLogger.Event2, "TODO Event");
	}
	...
	{
		TodoLogger.LogError(0, "FJGNPNFLHPH_EventCollection.BMGGKONLFIC");
	}
