...
public class OIGEIIGKMNH_Valkyrie : KLFDBFMNLBL_ServerSaveBlock
{
	public class HLNPGNNPCGO_ValkyrieInfo
	{
		...
		public HLNPGNNPCGO_ValkyrieInfo()
		{
			...
			BBOLHCKJFCA_IdCrypted = FBGGEFFJJHB;
			ACKPOCNHOOP_NewCrypted = JFOFMKBJBBE_False;
			KLAPHOKNEDG_DateCrypted = ~FBGGEFFJJHB;
			NFCALENBIBL_FPtCrypted = FBGGEFFJJHB;
			DLFOHMJLHHP_DvfNewCrypted = CNECJGKECHK_True;
		}
