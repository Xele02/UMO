...
public class NILOACEHJKJ_EventSP : KLFDBFMNLBL_ServerSaveBlock
{
	...
	// public List<NILOACEHJKJ.MDCMFPENCEK> FBCJICEPLED = new List<NILOACEHJKJ.MDCMFPENCEK>(); // 0x24

	public override bool DMICHEJIAJL { get { TodoLogger.Log(0, "DMICHEJIAJL"); return false; } } // 0x18AB184 NFKFOODCJJB
	...
	{
		TodoLogger.Log(0, "NILOACEHJKJ_EventSP.BMGGKONLFIC");
	}
