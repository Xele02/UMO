...
public class NILOACEHJKJ_EventSP : KLFDBFMNLBL_ServerSaveBlock
{
	...
	public class MDCMFPENCEK
	{
		...
		public long EGBOHDFBAPB_closed_at; // 0xB0
		...
		public List<sbyte> LCDIGDMGPGO_TRcv = new List<sbyte>(); // 0xE4

		public int JJMIEHHIKJE_RplQuest { get { return OGDIHNMDHML_Crypted ^ ENOBDCFHELD; } set { OGDIHNMDHML_Crypted = value ^ ENOBDCFHELD; } } // 0x18A3228 JLJEEPEHOPF_bgs 0x18A487C NNGOLJDAHEP_bgs
		public bool HPLMECLKFID_RRcv { get { return MLLPMIHMMFL_Crypted == 113; } set { MLLPMIHMMFL_Crypted = (sbyte)(value ? 113 : 50); } } // 0x18A3164 DCHHABKOMFP_bgs 0x18A47AC EGGIBMLGCOJ_bgs
		public long DNBFMLBNAEE_point { get { return AADPAJOLEEF_PointCrypted ^ ENOBDCFHELD; } set { value = value >= 100000000 ? 99999999 : value; AADPAJOLEEF_PointCrypted = value ^ ENOBDCFHELD; IOJOBGHPLIE_PointCrypted = value ^ FCEJCHGLFGN; } } // 0x18A3134 JKHIIAEMMDE_bgs 0x18A46C4 PFFKLBLEPKB_bgs
		public long NFIOKIBPJCJ_uptime { get { return DLEEMCAPOBP_Crypted ^ ENOBDCFHELD; } set { DLEEMCAPOBP_Crypted = value ^ ENOBDCFHELD; JPNMMOEPAEM_Crypted = value ^ FCEJCHGLFGN; } } // 0x18A314C NGIDBCKCAMO_bgs 0x18A4748_bgs AEHIIPBDNGE_bgs
		public int LGADCGFMLLD_step { get { return AFGHJEJKDHN_StepCrypted ^ ENOBDCFHELD; } set { AFGHJEJKDHN_StepCrypted = value ^ ENOBDCFHELD; FBDJBMDEENG_StepCrypted2 = value ^ FCEJCHGLFGN; } } // 0x18A3178 MAFBDLKFHGJ_get_step 0x18A4770 EPEFBOIALDI_set_step
		public int NKCCNNNJGJF_SelCard { get { return NOOCBEMKDDG_Crypted ^ ENOBDCFHELD; } set { NOOCBEMKDDG_Crypted = value ^ ENOBDCFHELD; HPMDPMFNAAO_Crypted = value ^ FCEJCHGLFGN; } } // 0x18A3188 AOMJCKPMOAI_bgs 0x18A4784_bgs KLMJNGAGDHO_bgs
		public int PFKHDMGPGKL_SelDf { get { return AIONCABLDOC_Crypted ^ ENOBDCFHELD; } set { AIONCABLDOC_Crypted = value ^ ENOBDCFHELD; OAACFDNGGDI_Crypted = value ^ FCEJCHGLFGN; } } // 0x18A3198 BKNGCMPPAAI_bgs 0x18A4798_bgs CIGDNLKIFEM_bgs
		public int POENMEGPHCG_reset { get { return HJDDHKOMADA_Crypted ^ ENOBDCFHELD; } set { HJDDHKOMADA_Crypted = value ^ ENOBDCFHELD; LPMDBMGPCFE_Crypted = value ^ FCEJCHGLFGN; } } // 0x18A31A8 NBIINAFIJEN_bgs 0x18A47DC_bgs FKNEOBLFDIM_bgs
		public int KNOINFOHCAL_DivaTouchCount { get { return MLAHEIEEKBL_Crypted ^ ENOBDCFHELD; } set { MLAHEIEEKBL_Crypted = value ^ ENOBDCFHELD; IOCGPIKNNNO_Crypted = value ^ FCEJCHGLFGN; } } // 0x18A31B8 HCMGKCGCLIF_bgs 0x18A47F0 DCONACCLAED_bgs
		public int CDAHMFBNOFA_DivaIntimacyCount { get { return PFGPGEGKDJE_Crypted ^ ENOBDCFHELD; } set { PFGPGEGKDJE_Crypted = value ^ ENOBDCFHELD; FONJDDLBEOI_Crypted = value ^ FCEJCHGLFGN; } } // 0x18A31C8 BHGPEFNDMJH_bgs 0x18A4804 DCINANHOILH_bgs
		public int ECABPJAIIOM_DivaPresentCount { get { return NGEJNCDBJID_Crypted ^ ENOBDCFHELD; } set { NGEJNCDBJID_Crypted = value ^ ENOBDCFHELD; PEPGHOEFCNP_Crypted = value ^ FCEJCHGLFGN; } } // 0x18A31D8 DJCADKFGHPB_bgs 0x18A4818 KOCLDKDFOPE_bgs
		public int BLPJMHLJGKK_AdvIsShowBits { get { return IJKJKAMLDMF_Crypted ^ ENOBDCFHELD; } set { IJKJKAMLDMF_Crypted = value ^ ENOBDCFHELD; ICHOLIKNAIB_Crypted = value ^ FCEJCHGLFGN; } } // 0x18A31E8 CCFOPOBNKDE_bgs 0x18A482C PCMNHIPAKBG_bgs
		public int JNAHAJFKKCB_EpiCount { get { return JEHBIJBEAMA_Crypted ^ ENOBDCFHELD; } set { JEHBIJBEAMA_Crypted = value ^ ENOBDCFHELD; IHFLDDNELGL_Crypted = value ^ FCEJCHGLFGN; } } // 0x18A31F8 DHIOKCLDFIE_bgs 0x18A4840 AMKBAJJLMGF_bgs
		public int NBNFHHLCMDH_EpiBo { get { return KEOIOOONAPE_Crypted ^ ENOBDCFHELD; } set { KEOIOOONAPE_Crypted = value ^ ENOBDCFHELD; MMNBJIJFOGI_Crypted = value ^ FCEJCHGLFGN; } } // 0x18A3208 LJGJCGBMGPN_bgs 0x18A4854 CBEODBCPDOJ_bgs
		public int OMCAOJJGOGG_Lb { get { return HFIHMDILNFD_LbCrypted ^ ENOBDCFHELD; } set { HFIHMDILNFD_LbCrypted = value ^ ENOBDCFHELD; IGMFFIKLEHP_LbCrypted2 = value ^ FCEJCHGLFGN; } } // 0x18A3218 PBEMPHPDDDB_get_Lb 0x18A4868 MCADMIEOCCF_set_Lb

		// // RVA: 0x18AB260 Offset: 0x18AB260 VA: 0x18AB260
		public void DHHNKEIBCOK(int _OIPCCBHIKIA_index, bool _JKDJCFEBDHC_Enabled)
		{
			if((_OIPCCBHIKIA_index >> 3) > 7)
				return;
			if(_JKDJCFEBDHC_Enabled)
				AKBDBIGGADH_NewFlags[_OIPCCBHIKIA_index >> 3] &= (byte)~(1 << (_OIPCCBHIKIA_index & 7));
			else
				AKBDBIGGADH_NewFlags[_OIPCCBHIKIA_index >> 3] |= (byte)(1 << (_OIPCCBHIKIA_index & 7));
		}

		// // RVA: 0x18AB2D0 Offset: 0x18AB2D0 VA: 0x18AB2D0
		public bool IHPAMMBNOPC(int _OIPCCBHIKIA_index)
		{
			if((_OIPCCBHIKIA_index >> 3) > 7)
				return true;
			return ((1 << (_OIPCCBHIKIA_index & 7)) & AKBDBIGGADH_NewFlags[_OIPCCBHIKIA_index >> 3]) == 0;
		}
		...
		public void ODDIHGPONFL_Copy(MDCMFPENCEK GPBJHKLFCEP)
		{
		...
		// public void AGHKODFKOJI(BHBONAHFKHD JBBHNIACMFJ, string _JIKKNHIAEKG_BlockName, string MJBACHKCIHA, int _OIPCCBHIKIA_index, NILOACEHJKJ_EventSP.MDCMFPENCEK _OHMCIEMIKCE_t, bool EFOEPDLNLJG) { }
	}
	...
	public override bool DMICHEJIAJL { get { return true; } } // 0x18AB184 NFKFOODCJJB_bgs
	...
	public override void OKJPIBHMKMJ(EDOHBJAPLPF_JsonData OILEIIEIBHP, long _MCKEOKFMLAH_SaveId)
	{
		...
		for(int i = 0; i < FBCJICEPLED[0].LCDIGDMGPGO_TRcv.Count; i++)
		{
			data4.Add(FBCJICEPLED[0].BHIAKGKHKGD_IsReceived(i) ? 1 : 0);
		}
		EDOHBJAPLPF_JsonData data5 = new EDOHBJAPLPF_JsonData();
		data5.LAJDIPCJCPO_SetJsonType(JFBMDLGBPEN_JsonType.BDHGEFMCJDF_Array);
		for(int i = 0; i < 180; i++)
		{
			data5.Add(FBCJICEPLED[0].NNMPGOAGEOL_quests[i].NOJCMGAFAAC_ToJsonData());
		}
		...
		data3[AFEHLCGHAEE_Strings.KOMKKBDABJP_end] = FBCJICEPLED[0].EGBOHDFBAPB_closed_at;
		...
		data3[AFEHLCGHAEE_Strings.LDALACBKEJN_r_rcv] = FBCJICEPLED[0].HPLMECLKFID_RRcv ? 1 : 0;
		...
		data3[AFEHLCGHAEE_Strings.MDADLCOCEBN_session_id] = FBCJICEPLED[0].MDADLCOCEBN_session_id;
		...
		if(!EMBGIDLFKGM)
		{
			...
			data6[AFEHLCGHAEE_Strings.KAKFEGGEKLB_save_id] = _MCKEOKFMLAH_SaveId;
			data6[JIKKNHIAEKG_BlockName] = data;
			...
			else
			{
				if(block.HNBFOAJIIAL_Count > 0)
				{
					...
					for(int i = 0; i < 1; i++)
					{
						...
						FGCNMLBACGO_GetString(d, AFEHLCGHAEE_Strings.LJNAKDMILMC_key, "", ref isInvalid);
						MDCMFPENCEK CCBEKGNDDBE = FBCJICEPLED[i];
						CCBEKGNDDBE.MPCAGEPEJJJ_Key = FGCNMLBACGO_GetString(d, AFEHLCGHAEE_Strings.LJNAKDMILMC_key, "", ref isInvalid);
						CCBEKGNDDBE.EGBOHDFBAPB_closed_at = DKMPHAPBDLH_GetLong(d, AFEHLCGHAEE_Strings.KOMKKBDABJP_end, 0, ref isInvalid);
						CCBEKGNDDBE.IMFBCJOIJKJ_Entry = CJAENOMGPDA_GetInt(d, AFEHLCGHAEE_Strings.CDMGDFLPPHN_entry, 0, ref isInvalid) != 0;
						CCBEKGNDDBE.ABBJBPLHFHA_Spurt = CJAENOMGPDA_GetInt(d, AFEHLCGHAEE_Strings.MAFAIIHJAFG_spurt, 0, ref isInvalid) != 0;
						CCBEKGNDDBE.DNBFMLBNAEE_point = DKMPHAPBDLH_GetLong(d, AFEHLCGHAEE_Strings.DNBFMLBNAEE_point, 0, ref isInvalid);
						CCBEKGNDDBE.NFIOKIBPJCJ_uptime = DKMPHAPBDLH_GetLong(d, AFEHLCGHAEE_Strings.NFIOKIBPJCJ_uptime, 0, ref isInvalid);
						CCBEKGNDDBE.LGADCGFMLLD_step = CJAENOMGPDA_GetInt(d, AFEHLCGHAEE_Strings.LGADCGFMLLD_step, 0, ref isInvalid);
						CCBEKGNDDBE.NKCCNNNJGJF_SelCard = CJAENOMGPDA_GetInt(d, AFEHLCGHAEE_Strings.AJACFHJACGK_sel_card, 0, ref isInvalid);
						CCBEKGNDDBE.PFKHDMGPGKL_SelDf = CJAENOMGPDA_GetInt(d, AFEHLCGHAEE_Strings.LOJCJMGPMIG_sel_df, 0, ref isInvalid);
						CCBEKGNDDBE.HPLMECLKFID_RRcv = CJAENOMGPDA_GetInt(d, AFEHLCGHAEE_Strings.LDALACBKEJN_r_rcv, 0, ref isInvalid) != 0;
						CCBEKGNDDBE.POENMEGPHCG_reset = CJAENOMGPDA_GetInt(d, AFEHLCGHAEE_Strings.POENMEGPHCG_reset, 0, ref isInvalid);
						CCBEKGNDDBE.KNOINFOHCAL_DivaTouchCount = CJAENOMGPDA_GetInt(d, "diva_touch_cnt", 0, ref isInvalid);
						CCBEKGNDDBE.CDAHMFBNOFA_DivaIntimacyCount = CJAENOMGPDA_GetInt(d, "diva_intimacy_cnt", 0, ref isInvalid);
						CCBEKGNDDBE.ECABPJAIIOM_DivaPresentCount = CJAENOMGPDA_GetInt(d, "diva_present_cnt", 0, ref isInvalid);
						CCBEKGNDDBE.BLPJMHLJGKK_AdvIsShowBits = CJAENOMGPDA_GetInt(d, "adv_is_show_bits", 0, ref isInvalid);
						CCBEKGNDDBE.JNAHAJFKKCB_EpiCount = CJAENOMGPDA_GetInt(d, "epi_cnt", 0, ref isInvalid);
						CCBEKGNDDBE.NBNFHHLCMDH_EpiBo = CJAENOMGPDA_GetInt(d, "epi_bo", 0, ref isInvalid);
						CCBEKGNDDBE.BEBJKJKBOGH_date = CJAENOMGPDA_GetInt(d, AFEHLCGHAEE_Strings.BEBJKJKBOGH_date, 0, ref isInvalid);
						CCBEKGNDDBE.INLNJOGHLJE_Show = CJAENOMGPDA_GetInt(d, "show", 0, ref isInvalid);
						CCBEKGNDDBE.MDADLCOCEBN_session_id = FGCNMLBACGO_GetString(d, AFEHLCGHAEE_Strings.MDADLCOCEBN_session_id, "", ref isInvalid);
						CCBEKGNDDBE.CCABNCGIHNI_Rslt = CJAENOMGPDA_GetInt(d, "rslt", 0, ref isInvalid);
						CCBEKGNDDBE.OMCAOJJGOGG_Lb = CJAENOMGPDA_GetInt(d, "lb", 0, ref isInvalid);
						CCBEKGNDDBE.LIEKIBHAPKC_FId = CJAENOMGPDA_GetInt(d, "f_id", 0, ref isInvalid);
						CCBEKGNDDBE.PPHEALAJAKD_MiSet = CJAENOMGPDA_GetInt(d, "mi_set", 0, ref isInvalid);
						CCBEKGNDDBE.KGGPBOEPKCE_PrevSel = CJAENOMGPDA_GetInt(d, "prev_sel", 0, ref isInvalid) != 0;
						CCBEKGNDDBE.MHKICPIMFEI_PlayCount = CJAENOMGPDA_GetInt(d, "play_cnt", 0, ref isInvalid);
						CCBEKGNDDBE.PIEBOKFJKKH_RTodayCount = CJAENOMGPDA_GetInt(d, "r_today_cnt", 0, ref isInvalid);
						CCBEKGNDDBE.OOBBAGJNDIH_LstHpTime = DKMPHAPBDLH_GetLong(d, "lst_hp_time", 0, ref isInvalid);
						CCBEKGNDDBE.JJMIEHHIKJE_RplQuest = CJAENOMGPDA_GetInt(d, "rpl_quest", 0, ref isInvalid);
						CEDHHAGBIBA.IFOLECIIDPO_StringToByteArray(CCBEKGNDDBE.AKBDBIGGADH_NewFlags, FGCNMLBACGO_GetString(d, AFEHLCGHAEE_Strings.COJJHFBKGML_new_flag, "", ref isInvalid));
						IBCGPBOGOGP_ReadIntArray(d, AFEHLCGHAEE_Strings.CJCJBKIMLOB_t_rcv, 0, 100, (int _OIPCCBHIKIA_index, int _JBGEEPFKIGG_val) =>
						{
							//0x18AB18C
							CCBEKGNDDBE.IPNLHCLFIDB_SetRewardReceived(_OIPCCBHIKIA_index, _JBGEEPFKIGG_val != 0);
						}, ref isInvalid);
						if(d.BBAJPINMOEP_Contains(AFEHLCGHAEE_Strings.NNMPGOAGEOL_quests))
						{
							...
							for(int j = 0; j < cnt; j++)
							{
								...
								ik.PPFNGGCBJKC_id = CJAENOMGPDA_GetInt(d2[j], AFEHLCGHAEE_Strings.PPFNGGCBJKC_id, j + 1, ref isInvalid);
								ik.EALOBDHOCHP_stat = CJAENOMGPDA_GetInt(d2[j], AFEHLCGHAEE_Strings.EALOBDHOCHP_stat, 0, ref isInvalid);
								ik.HMFFHLPNMPH_count = CJAENOMGPDA_GetInt(d2[j], AFEHLCGHAEE_Strings.HMFFHLPNMPH_count, 0, ref isInvalid);
								ik.BEBJKJKBOGH_date = DKMPHAPBDLH_GetLong(d2[j], AFEHLCGHAEE_Strings.BEBJKJKBOGH_date, 0, ref isInvalid);
								ik.CADENLBDAEB_IsNew = CJAENOMGPDA_GetInt(d2[j], AFEHLCGHAEE_Strings.KLJGEHBKMMG_new, 0, ref isInvalid) == 1;
							}
						}
					}
				}
