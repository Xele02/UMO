...
public class BCGFHLIEKLJ_DecoItem : KLFDBFMNLBL_ServerSaveBlock
{
	public class AKAHOEBACGJ
	{
		...
		private int IFEHKNJONPL_CountCrypted; // 0x28
		public int ONFJFGFNGGD; // 0x2C
		private sbyte ACKPOCNHOOP_IsNewCrypted; // 0x30
		public sbyte KCEAEOMJNFO; // 0x31

		public int PPFNGGCBJKC_id { get { return EHOIENNDEDH_IdCrypted ^ ENOBDCFHELD; } set { EHOIENNDEDH_IdCrypted = value ^ ENOBDCFHELD; INCHFKJOIEK = value ^ FCEJCHGLFGN; } } //0xF30D20 DEMEPMAEJOO_get_id 0xF323A0 HIGKAIDMOKN_set_id
		public int BFINGCJHOHI_cnt { get { return IFEHKNJONPL_CountCrypted ^ ENOBDCFHELD; } set { IFEHKNJONPL_CountCrypted = value ^ ENOBDCFHELD; ONFJFGFNGGD = value ^ FCEJCHGLFGN; } } //0xF30D30 LFMCLIDAPHB_get_cnt 0xF323B4 EDAEPDGGFJJ_set_cnt
		public bool CADENLBDAEB_IsNew { get { return ACKPOCNHOOP_IsNewCrypted == CNECJGKECHK_True; } set { ACKPOCNHOOP_IsNewCrypted = value ? CNECJGKECHK_True : JFOFMKBJBBE_False; KCEAEOMJNFO = value ? JFOFMKBJBBE_False : CNECJGKECHK_True; } } //0xF30D40 KJGFPPLHLAB_bgs 0xF323C8 ILJHLPMDHPO_bgs

		// RVA: 0xF2EE60 Offset: 0xF2EE60 VA: 0xF2EE60
		public AKAHOEBACGJ()
		{
			ENOBDCFHELD = LPDNKHAIOLH.CEIBAFOCNCA_Int();
			FCEJCHGLFGN = LPDNKHAIOLH.CEIBAFOCNCA_Int();
			JHOLGGAKMOH = ~ENOBDCFHELD;
			BCGMFGMCPCP = ~FCEJCHGLFGN;
		}

		//// RVA: 0xF2EF18 Offset: 0xF2EF18 VA: 0xF2EF18
		public void LHPDDGIJKNB_Reset(int _PPFNGGCBJKC_id/* = 0*/)
		{
		...
		public AKAHOEBACGJ ODDIHGPONFL_Copy(AKAHOEBACGJ GPBJHKLFCEP)
		{
		...
		//public void AGHKODFKOJI(BHBONAHFKHD JBBHNIACMFJ, string _JIKKNHIAEKG_BlockName, string MJBACHKCIHA, int _OIPCCBHIKIA_index, BCGFHLIEKLJ_DecoItem.AKAHOEBACGJ _OHMCIEMIKCE_t, bool EFOEPDLNLJG) { }

		//// RVA: 0xF34D3C Offset: 0xF34D3C VA: 0xF34D3C
		//public FENCAJJBLBH PFAKPFKJJKA() { }

		//// RVA: 0xF351F0 Offset: 0xF351F0 VA: 0xF351F0
		public bool PPJAGFPBFHJ_SetItemCount(int _HMFFHLPNMPH_count)
		{
			CADENLBDAEB_IsNew = BFINGCJHOHI_cnt < _HMFFHLPNMPH_count;
			BFINGCJHOHI_cnt = _HMFFHLPNMPH_count;
	...
	{
		public int ICKOHEDLEFP_ValueCrypted; // 0x34
		public int DNNBPDILAKL; // 0x38
		public int MBCPMFPKNBA_LevelCrypted; // 0x3C
		...
		public int JBGEEPFKIGG_val { get { return ICKOHEDLEFP_ValueCrypted ^ ENOBDCFHELD; } set { ICKOHEDLEFP_ValueCrypted = value ^ ENOBDCFHELD; DNNBPDILAKL = value ^ FCEJCHGLFGN; } } //0xF30DD4 OLOCMINKGON_get_val 0xF32420 ABAFHIBFKCE_set_val
		//Level
		public int ANAJIAENLNB_lv { get { return MBCPMFPKNBA_LevelCrypted ^ ENOBDCFHELD; } set { MBCPMFPKNBA_LevelCrypted = value ^ ENOBDCFHELD; DKOGOBKOGBM = value ^ FCEJCHGLFGN; } } //0xF30DE4 MMOMNMBKHJF_get_lv 0xF32438 FEHNFGPFINK_set_lv
		public long FOONCJDLLIK_ChargeTime { get { return MCPHOEIDJAD ^ JHOLGGAKMOH; } set { MCPHOEIDJAD = value ^ JHOLGGAKMOH; LPKAMAJLKPP = value ^ BCGMFGMCPCP; } } //0xF30DF4 BONPKDDFHNB_bgs 0xF32450 OEAGMCNGNLL_bgs
		public long EMHCHMHMFHJ_ChargeTimeOffset { get { return AEHDMHDCOAH ^ JHOLGGAKMOH; } set { AEHDMHDCOAH = value ^ JHOLGGAKMOH; GKBHBHNPMED = value ^ BCGMFGMCPCP; } } //0xF30E08 HEOOBGPDPND_bgs 0xF32474 KFMNIKFMHOD_bgs
		...
		public new void LHPDDGIJKNB_Reset(int _PPFNGGCBJKC_id/* = 0*/)
		{
		...
		public bool AGBOGBEOFME(GNGFGEIAGJL OIKJFMGEICL)
		{
		...
		public bool DFIGPDCBAPB_IsInvalid()
		{
			return ANAJIAENLNB_lv == 1 && BFINGCJHOHI_cnt == 0 && 
				!CADENLBDAEB_IsNew && JBGEEPFKIGG_val == 0 && FOONCJDLLIK_ChargeTime == 0;
		}

		//// RVA: 0xF34460 Offset: 0xF34460 VA: 0xF34460
		//public void AGHKODFKOJI(BHBONAHFKHD JBBHNIACMFJ, string _JIKKNHIAEKG_BlockName, string MJBACHKCIHA, int _OIPCCBHIKIA_index, BCGFHLIEKLJ_DecoItem.GNGFGEIAGJL _OHMCIEMIKCE_t, bool EFOEPDLNLJG) { }
	...
	public List<AKAHOEBACGJ> DJHBDDGEKGO_Bgs { get; private set; } // 0x40 OFEGCFCDMHI_bgs HBAMJHDDJFM_bgs KNHIHMEMJFG_bgs
	public List<AKAHOEBACGJ> KPMFLNOELIN_Objs { get; private set; } // 0x44 CADKDIOOABF_bgs OFBFDEOELGP_bgs PFONKPMNHIC_bgs
	public List<AKAHOEBACGJ> PEBDEIKBCCM_Chars { get; private set; } // 0x48 LEIABNBAPDF_bgs IIKABCDNMHE_bgs NGPIHFEHDCH_bgs
	public List<GNGFGEIAGJL> NBKAMFFIOOG_Sp { get; private set; } // 0x4C ILBDLKBMCLL_bgs HDJOCNANCEI_bgs JMEAGFDOOGE_bgs
	public List<AKAHOEBACGJ> PFNNIMBMKDL_Posters { get; private set; } // 0x50 FIIKAHPNLIE_bgs IGJGKPNGDIH_bgs JNGABBLANIN_bgs
	public List<AKAHOEBACGJ> NOAEDPJGBJK_Sets { get; private set; } // 0x54 PGLOGOHILGI_bgs CIDOGCLBPDM_bgs ILJKEMBMMBG_bgs
	...
	public override bool DMICHEJIAJL { get { return true; } } // 0xF35028 NFKFOODCJJB_bgs
		...
		}
		{
			...
			for (int i = 0; i < NBKAMFFIOOG_Sp.Count; i++)
			{
				if (NBKAMFFIOOG_Sp[i].BFINGCJHOHI_cnt != 0 || NBKAMFFIOOG_Sp[i].CADENLBDAEB_IsNew ||
					...
					NBKAMFFIOOG_Sp[i].ANAJIAENLNB_lv != 1)
				{
					EDOHBJAPLPF_JsonData data3 = new EDOHBJAPLPF_JsonData();
					...
					data3[AFEHLCGHAEE_Strings.ANAJIAENLNB_lv] = NBKAMFFIOOG_Sp[i].ANAJIAENLNB_lv;
		...
		if (!blockMissing)
		{
			...
			else
			{
				if(block.BBAJPINMOEP_Contains(AFEHLCGHAEE_Strings.JMPEGAACBKA_di_bg))
				{
					...
					for(int i = 0; i < 200; i++)
					{
						...
						if (b.BBAJPINMOEP_Contains(str))
						{
							...
							data.CADENLBDAEB_IsNew = CJAENOMGPDA_GetInt(b2, AFEHLCGHAEE_Strings.LHMOAJAIJCO_is_new, 0, ref isInvalid) == 1;
						}
					}
				}
				else
				...
				if (block.BBAJPINMOEP_Contains(AFEHLCGHAEE_Strings.BLJOJBEKFAH_di_sp))
				{
					...
					for (int i = 0; i < 100; i++)
					{
						...
						if (b.BBAJPINMOEP_Contains(str))
						{
							...
							if (data.BFINGCJHOHI_cnt > 0)
								data.BFINGCJHOHI_cnt = 1;
							data.JBGEEPFKIGG_val = CJAENOMGPDA_GetInt(b2, AFEHLCGHAEE_Strings.JBGEEPFKIGG_val, 0, ref isInvalid);
							data.ANAJIAENLNB_lv = CJAENOMGPDA_GetInt(b2, AFEHLCGHAEE_Strings.ANAJIAENLNB_lv, 1, ref isInvalid);
							data.FOONCJDLLIK_ChargeTime = DKMPHAPBDLH_GetLong(b2, AFEHLCGHAEE_Strings.MKHBDJBODON_c_tm, 0, ref isInvalid);
							data.EMHCHMHMFHJ_ChargeTimeOffset = DKMPHAPBDLH_GetLong(b2, AFEHLCGHAEE_Strings.POBGGHEKLIB_c_tm_ofs, 0, ref isInvalid);
							data.CADENLBDAEB_IsNew = CJAENOMGPDA_GetInt(b2, AFEHLCGHAEE_Strings.LHMOAJAIJCO_is_new, 0, ref isInvalid) == 1;
						}
					}
				}
				...
				if (block.BBAJPINMOEP_Contains("di_set"))
				{
					...
					isInvalid = true;
				MKLJLHBHBJA_AcumAt = DKMPHAPBDLH_GetLong(block, AFEHLCGHAEE_Strings.DLLLHFLGBAP_acum_at, 0, ref isInvalid);
			}
	...
	public override void BMGGKONLFIC_Copy(KLFDBFMNLBL_ServerSaveBlock GPBJHKLFCEP)
	{
		...
		for(int i = 0; i < DJHBDDGEKGO_Bgs.Count; i++)
		{
			DJHBDDGEKGO_Bgs[i].ODDIHGPONFL_Copy(d.DJHBDDGEKGO_Bgs[i]);
		}
		for (int i = 0; i < KPMFLNOELIN_Objs.Count; i++)
		{
			KPMFLNOELIN_Objs[i].ODDIHGPONFL_Copy(d.KPMFLNOELIN_Objs[i]);
		}
		for(int i = 0; i < PEBDEIKBCCM_Chars.Count; i++)
		{
			PEBDEIKBCCM_Chars[i].ODDIHGPONFL_Copy(d.PEBDEIKBCCM_Chars[i]);
		}
		for(int i = 0; i < NBKAMFFIOOG_Sp.Count; i++)
		{
			NBKAMFFIOOG_Sp[i].ODDIHGPONFL_Copy(d.NBKAMFFIOOG_Sp[i]);
		}
		for(int i = 0; i < PFNNIMBMKDL_Posters.Count; i++)
		{
			PFNNIMBMKDL_Posters[i].ODDIHGPONFL_Copy(d.PFNNIMBMKDL_Posters[i]);
		}
		for(int i = 0; i < NOAEDPJGBJK_Sets.Count; i++)
		{
			NOAEDPJGBJK_Sets[i].ODDIHGPONFL_Copy(d.NOAEDPJGBJK_Sets[i]);
		}
	...
	public int KFFGHBCCCIJ(NDBFKHKMMCE_DecoItem _EPAHOAKPAJJ_DecoItem, int _NDKJCDGHPLD_MasterVersion, int LNBOIHIGAGL)
	{
		int res = 0;
		foreach(var k in NBKAMFFIOOG_Sp)
		{
			...
			{
				int a = _EPAHOAKPAJJ_DecoItem.CHMNDNFMAGA(k.PPFNGGCBJKC_id);
				if (LNBOIHIGAGL < a && _NDKJCDGHPLD_MasterVersion >= a && res < a)
					res = a;
			}
		}
		return res;
