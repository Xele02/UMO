...
public class JNMFKOHFAFB_PublicStatus : KLFDBFMNLBL_ServerSaveBlock
{
	...
	public class ONCMONJIPCD
	{
		...
		public JNMFKOHFAFB_PublicStatus.KNHIPBADANI[] JOHLGBDOLNO = new JNMFKOHFAFB_PublicStatus.KNHIPBADANI[4]; // 0x8
		...
		public void KMBPACJNEOF(int OIPCCBHIKIA)
		{
			...
			{
				JOHLGBDOLNO[i] = new JNMFKOHFAFB_PublicStatus.KNHIPBADANI();
	...
	public JNMFKOHFAFB_PublicStatus.KNHIPBADANI AFBMEMCHJCL { get; private set; } // 0xA8 KNFCIOAPINN GJBNHLMONNG NNFIJKIAFEN
	public JNMFKOHFAFB_PublicStatus.ONCMONJIPCD MGMFOJPNDGA { get; private set; } // 0xAC IOIMBAECIKN HFCCFNMJALI OMADOLIKBOL
	public List<JNMFKOHFAFB_PublicStatus.KNHIPBADANI> HDJOHAJPGBA { get; private set; } // 0xB0 APOCOCHGFGM NKKJDGBFHOH ENDCIPBGGPI
	...
	public List<JNMFKOHFAFB_PublicStatus.LBGEDDJKOKF> AEIADFODLMC { get; private set; } // 0xB4 FJDIIFNMHGO JJIKNMLEHMO IGJDNMJPJPN
	...
	{
		AFBMEMCHJCL = new JNMFKOHFAFB_PublicStatus.KNHIPBADANI();
		HDJOHAJPGBA = new List<JNMFKOHFAFB_PublicStatus.KNHIPBADANI>();
		AEIADFODLMC = new List<JNMFKOHFAFB_PublicStatus.LBGEDDJKOKF>();
		MGMFOJPNDGA = new JNMFKOHFAFB_PublicStatus.ONCMONJIPCD();
		KMBPACJNEOF();
	}
