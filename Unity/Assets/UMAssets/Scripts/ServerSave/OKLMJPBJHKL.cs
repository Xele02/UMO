...
public class OKLMJPBJHKL_EventMission : KLFDBFMNLBL_ServerSaveBlock
{
	...
	public override bool DMICHEJIAJL { get { TodoLogger.LogError(0, "DMICHEJIAJL"); return false; } } // 0x14AC994 NFKFOODCJJB
	...
	{
		TodoLogger.LogError(0, "OKLMJPBJHKL_EventMission.BMGGKONLFIC");
	}
