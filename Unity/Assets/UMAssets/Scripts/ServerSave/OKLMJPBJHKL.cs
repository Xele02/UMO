...
public class OKLMJPBJHKL_EventMission : KLFDBFMNLBL_ServerSaveBlock
{
	...
	// public List<OKLMJPBJHKL.MKIGCLOBJBI> FBCJICEPLED = new List<OKLMJPBJHKL.MKIGCLOBJBI>(3); // 0x24

	public override bool DMICHEJIAJL { get { TodoLogger.Log(0, "DMICHEJIAJL"); return false; } } // 0x14AC994 NFKFOODCJJB
	...
	{
		TodoLogger.Log(0, "OKLMJPBJHKL_EventMission.BMGGKONLFIC");
	}
