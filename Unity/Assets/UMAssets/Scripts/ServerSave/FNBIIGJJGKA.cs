...
public class FNBIIGJJGKA_Counter : KLFDBFMNLBL_ServerSaveBlock
{
	...
	public override bool IIEMACPEEBJ_Deserialize(EDOHBJAPLPF_JsonData OILEIIEIBHP)
	{
		...
		if(OILEIIEIBHP.BBAJPINMOEP_Contains(AFEHLCGHAEE_Strings.BDLNMOIOMHK_total))
		{
			...
			BDLNMOIOMHK_Total.MILCBLJDADN_MClr = CJAENOMGPDA_ReadInt(b, AFEHLCGHAEE_Strings.EJKHAFIALGK_mclr, 0, ref isInvalid);
			...
			IBCGPBOGOGP_ReadIntArray(b, AFEHLCGHAEE_Strings.BGBKGFDLCME_sclr, 0, BDLNMOIOMHK_Total.LHOCOEOKFNO_SClr.Length, (int OIPCCBHIKIA, int JBGEEPFKIGG) =>
			{
				//0x11A3A48
				BDLNMOIOMHK_Total.LHOCOEOKFNO_SClr[OIPCCBHIKIA] = JBGEEPFKIGG;
			}, ref isInvalid);
			IBCGPBOGOGP_ReadIntArray(b, AFEHLCGHAEE_Strings.HPGEGOONHGD_dclr, 0, BDLNMOIOMHK_Total.PHPPOGOEOAF_DClr.Length, (int OIPCCBHIKIA, int JBGEEPFKIGG) =>
			{
				//0x11A3AA8
				BDLNMOIOMHK_Total.PHPPOGOEOAF_DClr[OIPCCBHIKIA] = JBGEEPFKIGG;
			}, ref isInvalid);
			IBCGPBOGOGP_ReadIntArray(b, "dclr_l6", 0, BDLNMOIOMHK_Total.IAFPEPABGJJ_DClr16.Length, (int OIPCCBHIKIA, int JBGEEPFKIGG) =>
			{
				//0x11A3B08
				BDLNMOIOMHK_Total.IAFPEPABGJJ_DClr16[OIPCCBHIKIA] = JBGEEPFKIGG;
			}, ref isInvalid);
		}
