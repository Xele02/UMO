...
public class GEGHOCKCKKA_LimitedCompoItem : KLFDBFMNLBL_ServerSaveBlock
{
	public class AIAPDPDOIKG
	{
		public class AGGJCJMIIMJ
		{
			...
			{
				int t = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.MBAGKLJDKMH_LimitedCompoItem.OCMMLAOEPIG[PPFNGGCBJKC - 1].EMIJNAFJFJO_Expir;
				if (t * 0x15180 != 0)
					return t * 0x15180;
	...
	public int CPIICACGNBH(int PPFNGGCBJKC, long JHNMKKNEENE, bool _DDGFCOPPBBN_test/* = false*/)
	{
		if(PPFNGGCBJKC > 0)
		{
			...
			if(MinGetIdx > -1)
			{
				...
				{
					return limitedDb.OCMMLAOEPIG[PPFNGGCBJKC - 1].EMIJNAFJFJO_Expir + (int)JHNMKKNEENE;
				}
				AIAPDPDOIKG.AGGJCJMIIMJ data2 = data.PJADHDHKOEJ[MinGetIdx];
				data2.FBGGEFFJJHB_xor = (int)JHNMKKNEENE * 0x2e7;
				...
				data2.FBGGEFFJJHB_xor = (int)JHNMKKNEENE * 0x540545;
				data2.PGPGPJNBIOH_Uid = MaxUid;
				data2.PPFNGGCBJKC_Id = PPFNGGCBJKC;
				data2.DIAPHCJBPFD_Get = (int)JHNMKKNEENE;
				data2.DOJDOLDDBPP_Hav = 1;
