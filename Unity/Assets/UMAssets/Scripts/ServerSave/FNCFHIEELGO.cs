...
public class FNCFHIEELGO_DecoVisit : KLFDBFMNLBL_ServerSaveBlock
{
	...
	public long LIDCDBKAAFL_VisitAcquiredAt { get { return CGMLKDKILPG ^ ENOBDCFHELD; } set { CGMLKDKILPG = value ^ ENOBDCFHELD; DBDOIAONKMK = value ^ FCEJCHGLFGN; } } //CGCJBJJKIEL_bgs 0x13E4760 HDLMMMEKNMC_bgs 0x13E4774
	public long KAIOEKJJAKH_VisitedAt { get { return EKFOHMMFPBI ^ ENOBDCFHELD; } set { EKFOHMMFPBI = value ^ ENOBDCFHELD; IBPGECMMELK = value ^ FCEJCHGLFGN; } } //LGENFPJEOEN_bgs 0x13E4798 KBDKDFAMOMC_bgs 0x13E47AC
	public int HFJADCMLFAN_VisitPrevCntFriend { get { return HPNAEFLIFGD ^ (int)ENOBDCFHELD; } set { HPNAEFLIFGD = value ^ (int)ENOBDCFHELD; POEDGHHLBCC = value ^ (int)FCEJCHGLFGN; } } //OLMDECNACBA_bgs 0x13E47D0 BDFGHCBOBFM_bgs 0x13E47E0
	public int FBINJFGCIOI_VisitPrevCntFan { get { return FNNIPOFDCFB ^ (int)ENOBDCFHELD; } set { FNNIPOFDCFB = value ^ (int)ENOBDCFHELD; AGJAFDKABFI = value ^ (int)FCEJCHGLFGN; } } //JMAKOIDGMCM_bgs 0x13E47F8 BNMCNDEFHFG_bgs 0x13E4808
	public int IAOOCOKEECB_VisitPrevCntOther { get { return IDFIKBHHLNN ^ (int)ENOBDCFHELD; } set { IDFIKBHHLNN = value ^ (int)ENOBDCFHELD; KCAJLAACCKN = value ^ (int)FCEJCHGLFGN; } } //HKCHBKHDOLK_bgs 0x13E4820 OKPAIAMOBHI_bgs 0x13E4830
	public long EILGNIEGDOI_PresentAcquiredAt { get { return OHCKMGGLMPB ^ ENOBDCFHELD; } set { OHCKMGGLMPB = value ^ ENOBDCFHELD; MCCBJMKHPCP = value ^ FCEJCHGLFGN; } } //FHPOOMLLOCL_bgs 0x13E4848 MOFBHEJEGPK_bgs 0x13E485C
	public int GHEBKKHAAPM_PresentPrevCnt { get { return IIKOHDBHLPI ^ (int)ENOBDCFHELD; } set { IIKOHDBHLPI = value ^ (int)ENOBDCFHELD; CMPBMCDNBLN = value ^ (int)FCEJCHGLFGN; } } //KODNPBIFNBI_bgs 0x13E4880 BCLOKNHJDNJ_bgs 0x13E4890
	public override bool DMICHEJIAJL { get { return true; } } // 0x13E5E3C NFKFOODCJJB_bgs
	...
	// private FENCAJJBLBH JJPAJEBBFOB(string _OPFGFINHFCE_name) { }
	...
	public override void OKJPIBHMKMJ(EDOHBJAPLPF_JsonData OILEIIEIBHP, long _MCKEOKFMLAH_SaveId)
	{
		...
		data["present_prev_cnt"] = GHEBKKHAAPM_PresentPrevCnt;
		{
			...
			{
				data2.Add(MPPKMEIEGFE_VisitList[i].NANNGLGOFKH_value);
			}
		...
		}
		{
			...
			{
				data2.Add(MHPDCGNOBHH_PresentSentList[i].NANNGLGOFKH_value);
			}
	...
	// private void EANKOKOGMMI(BHBONAHFKHD JBBHNIACMFJ, string _HDBEJBBPPBK_dn, string PKLPKMLGFGK, List<NDBFKHKMMCE_DecoItem.FKIMJLOFONM> LKCCMBEOLLA, List<NDBFKHKMMCE_DecoItem.FKIMJLOFONM> _GJLFANGDGCL_Target) { }
	...
	public override bool AGBOGBEOFME(KLFDBFMNLBL_ServerSaveBlock GPBJHKLFCEP)
	{
		...
		for(int i = 0; i < MPPKMEIEGFE_VisitList.Count; i++)
		{
			if(MPPKMEIEGFE_VisitList[i].NANNGLGOFKH_value != other.MPPKMEIEGFE_VisitList[i].NANNGLGOFKH_value)
				return false;
		}
		...
		for(int i = 0; i < MHPDCGNOBHH_PresentSentList.Count; i++)
		{
			if(MHPDCGNOBHH_PresentSentList[i].NANNGLGOFKH_value != other.MHPDCGNOBHH_PresentSentList[i].NANNGLGOFKH_value)
				return false;
		}
		return true;
	}
