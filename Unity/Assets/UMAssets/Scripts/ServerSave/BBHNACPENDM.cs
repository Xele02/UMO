...
public class BBHNACPENDM_ServerSaveData
{
	...
	{
		public long MCKEOKFMLAH_SaveId; // 0x8
		...
		public string DLENPPIJNPA_json { get; }
		public bool CHBFPFLGELK { get; }

		// RVA: 0xF20530 Offset: 0xF20530 VA: 0xF20530
		public EMHDCKMFCGE(EDOHBJAPLPF_JsonData HIEGIHHJNAL_i, List<string> _OHNJJIMGKGK_Names, bool LDNHNDGCPJO, long _MCKEOKFMLAH_SaveId)
		{
			KFGDPMNCCFO_NaespaceForSave = _OHNJJIMGKGK_Names;
			this.MCKEOKFMLAH_SaveId = _MCKEOKFMLAH_SaveId;
			OBHAFLMHAKG = HIEGIHHJNAL_i;
	...
	public const ulong GAAEFILMAED_BaseSectionList = 8968715810897911; // 0x1FDCFFDFFFFFF7
	...
	public JBMPOAAMGNB_Base JHFIPCIHJNL_Base { get; private set; } // 0xC KMGGEBHHBAA_bgs ECLNKICNLBG_bgs LBHPNACEDGL_bgs
	public EGOLBAPFHHD_Common KCCLEHLLOFG_Common { get; private set; } // 0x10 EGGBCKDPNNP_bgs ELICAAHFMOE_bgs MCEPFJGMKGK_bgs
	public JNMFKOHFAFB_PublicStatus MHEAEGMIKIE_PublicStatus { get; private set; } // 0x14 IPIDNJLGHHA_bgs IOINJEBJGAL_bgs BGIFNFCAEDH_bgs
	public DEKKMGAFJCG_Diva DGCJCAHIAPP_Diva { get; private set; } // 0x18 MKBNAHMKHDN_bgs POLMIBFALBJ_bgs DHNJHLEPDKD_bgs
	public JDDGGJCGOPA_RecordMusic LCKMBHDMPIP_RecordMusic { get; private set; } // 0x1C NPEKNMGCGLO_bgs ODDNMAACGHL_bgs ANPGADGAIJD_bgs
	public MMPBPOIFDAF_Scene PNLOINMCCKH_Scene { get; private set; } // 0x20 LFEPLGDPHNN_bgs HEDHDEBCDHK_bgs AKJNMANOAOK_bgs
	public NEKDCJKANAH_StoryRecord LNOOKHJBENO_StoryRecord { get; private set; } // 0x24 BFKBGNOEDIK_bgs OEINGEBANNH_bgs DIFDDCMHIID_bgs
	public FKNOCGCODBK_Unit MLAFAACKKBG_Unit { get; private set; } // 0x28 OAIPEIDEOCO_bgs GFMBIMHMNJA_bgs MAKNCHHIOKF_bgs
	public CEDOOHCPHMG_UnitGoDiva KMBJGAHCBDI_UnitGoDiva { get; private set; } // 0x2C LFCFLKOPGJI_bgs MKOMCOGEKDH_bgs OLGDMANGPPF_bgs
	public EBFLJMOCLNA_Costume BEKHNNCGIEL_Costume { get; private set; } // 0x30 PIAGLBICDHH_bgs APEFIJHBGMD_bgs AHMKJHKMCEH_bgs
	public OCLHKHAMDHF_Episode NGHJPEIKLJL_Episode { get; private set; } // 0x34 NNHADBEPECA_bgs AJKOCPKDMEJ_bgs BJAOICEINFJ_bgs
	public OIGEIIGKMNH_Valkyrie JJFFBDLIOCF_Valkyrie { get; private set; } // 0x38 KHBLHGGNPPM_bgs BLDKFABPKAE_bgs JCMIADNDCNP_bgs
	public DDEMMEPBOIA_Sns FLHMJHBOBEA_Sns { get; private set; } // 0x3C NJAJCMECMFE_bgs OOCEKNJPKHO_bgs BDPKHAHGDKL_bgs
	public FJGNPNFLHPH_EventCollection MBAHCFLBDHN_EventCollection { get; private set; } // 0x40 KMAOEHJPMLI_bgs KEFOMFIIMDJ_bgs DNGHKPCPHNJ_bgs
	public ICLNENNIMOP_FreeScoreMax FLBPFBFKBFC_FreeScoreMax { get; private set; } // 0x44 FGDKNELIAAN_bgs EEHIJENEHCF_bgs CHDOPAGKCOL_bgs
	public OFNLIBDEIFA_EventQuest PMMENILLJJE_EventQuest { get; private set; } // 0x48 LGCHDHAPJFL_bgs GPDAOMBGNFN_bgs KNMKHIGHECF_bgs
	public ODPNBADOFAN_Quest GOACJBOCLHH_Quest { get; private set; } // 0x4C ACLKEFBFCBN_bgs PLPJHOEFENP_bgs FKNHKIFCKAA_bgs
	public FNBIIGJJGKA_Counter OEKEIGFAIGN_Counter { get; private set; } // 0x50 NLNIOJAGHPL_bgs NLJLKCCAHGI_bgs IAJEENLGCJP_bgs
	public JGGLDGNKELI_Emblem OFAJDLJBMEM_Emblem { get; private set; } // 0x54 EJCLCEBBHBE_bgs NDABDADDKDA_bgs NICDJPPNPGC_bgs
	public FEHINJKHDAP_EventScore KOOKJBMGBIG_EventScore { get; private set; } // 0x58 DOCFMEIIABM_bgs GMKPFEBBMDE_bgs NHMCGBAOHID_bgs
	public HHDEBNFMIMH_Adventure HBPPNFHOMNB_Adventure { get; private set; } // 0x5C LLKJCKINCGM_bgs AHKKNEFOCCO_bgs HFACFDNLMDP_bgs
	public CCPKHBECNLH_EventBattle DKJBALDICBG_EventBattle { get; private set; } // 0x60 EMHKFNHLLJJ_bgs JMGALBBLDBB_bgs KPMJAFNCECF_bgs
	public BMIODFJCGAJ_EventBattlePlayer HIIJOEHDAIM_EventBattlePlayer { get; private set; } // 0x64 EJBIJABPPLM_bgs HKKPOJFIIJI_bgs ABACLCPJALH_bgs
	public NPOOPJIOMHF_Prism GHDDPJBBEOC_Prism { get; private set; } // 0x68 IPLNONELJJO_bgs FOCMCJMNHBC_bgs MBNICBKCALO_bgs
	public GBEFGAIGGHA_Shop IJOHDAJMBAL_Shop { get; private set; } // 0x6C KFBIDKLIFEA_bgs PNMELHHBKNG_bgs HOABHLGHPJP_bgs
	public OKLMJPBJHKL_EventMission MENGHOKMOIE_EventMission { get; private set; } // 0x70 FNEDOHPFJOM_bgs LFCCLOCCAEL_bgs IOGJIHCKLHG_bgs
	public JLOGEHCIBEJ_EventRaid DMDOCAPGOEE_EventRaid { get; private set; } // 0x74 DJKNMDDAHEG_bgs NIMPKJELABG_bgs ADECIAGKKJK_bgs
	public KBAGKBIBGPM_EventRaidLobby PJCMHDEJLGF_EventRaidLobby { get; private set; } // 0x78 ALKIMKOGGEC_bgs GIBODAGJAGA_bgs KHOKBAJEBHH_bgs
	public LGGPBMPINDL_EventRaidPlayer LLBECHBNIJG_EventRaidPlayer { get; private set; } // 0x7C NFMKIALGGHG_bgs KHNGHBIJICI_bgs JMIMDMKJHBG_bgs
	public NILOACEHJKJ_EventSP DAKCBBBMIMD_EventSP { get; private set; } // 0x80 BOHHFHHDJEB_bgs GDFFALBANKM_bgs CNNEEJHHHEH_bgs
	public ALIPBIMCAPN_EventBoxGacha MMAIJOCPJHP_EventBoxGacha { get; private set; } // 0x84 MAEOOANOPHD_bgs PGKAACOJJHH_bgs CBLMKMMCHLC_bgs
	public GGHPEFNADEN_Ticket CNCBDLFALLD_Ticket { get; private set; } // 0x88 GGLJAIGKBBG_bgs NJPCFNMCNLG_bgs ELMMACMBPIH_bgs
	public KDLBHAKPLPH_ArMarker LCLPLFCBDBB_ArMarker { get; private set; } // 0x8C ILAJMJPAODD_bgs BDJFFEOBFCH_bgs JDHEOHNPIDF_bgs
	public FMFBNHLMHPL_EventAprilFool ILINBDKMAPM_EventAprilFool { get; private set; } // 0x90 OGLGBMBBIFE_bgs AAIDDCJILPI_bgs BILCKHILOHN_bgs
	public OCMJNBIFJNM_Offer DAEJHMCMFJD_Offer { get; private set; } // 0x94 EGIAFFAECNM_bgs OGALHJNMMNL_bgs GEMOMLNAADD_bgs
	public LGIDLHLBFFJ_MonthlyPass HMMNDKHKEBC_MonthlyPass { get; private set; } // 0x98 HBPDMEDPANM_bgs HPNJLDMMLOP_bgs GAEOOJAIHJC_bgs
	public LGIOGDIPNGI_RareUpItem DPNKPPBEAGJ_RareUpItem { get; private set; } // 0x9C MMANMDKOCIH_bgs PHMKDJBPODJ_bgs FDHJGFNNJID_bgs
	public LIFGJMIHHKM_LimitedItem AFHFIPLOKMN_LimitedItem { get; private set; } // 0xA0 MABLGJEDAAO_bgs GEHCLAGHAKB_bgs LLCKLEHDGJM_bgs
	public FFMIPGABHHA_SaveHash FHLMCCPCEAI_SaveHash { get; private set; } // 0xA4 AJPJGBAIBCD_bgs MIFLPDHAFEG_bgs NGGLLCCMKNN_bgs
	 public NFMHCLHEMHB_Bingo PEGNNEFHDOP_Bingo { get; private set; } // 0xA8 DMOGGMEFGII_bgs CAJIJHHMOMG_bgs MOOKFNFALPJ_bgs
	 public DAJBODHMLAB_DecoPublicSet PDKHANKAPCI_DecoPublicSet { get; private set; } // 0xAC GJHOEAFCNDA_bgs KGBNBKPMKDG_bgs PJNPGHDEINA_bgs
	 public AHHPBMBBCFM_DecoPrivateSet DNIPIBICFGN_DecoPrivateSet { get; private set; } // 0xB0 MJMPPFHOLPG_bgs CLOJDOMJNGL_bgs NJDJFEAIEFJ_bgs
	 public BCGFHLIEKLJ_DecoItem OMMNKDEODJP_DecoItem { get; private set; } // 0xB4 NDKFLJOCAKH_bgs AFEJALGJLCG_bgs GCPCAAKJLMA_bgs
	 public LFHGFLJLGFB_FavoritePlayer GAAOPEGIPKA_FavoritePlayer { get; private set; } // 0xB8 LGPCFAGCFEI_bgs EPJOMHAEOCJ_bgs HOHLEKKNGON_bgs
	 public IOEKHJBOMDH_DecoStamp FJPOELGFPBP_DecoStamp { get; private set; } // 0xBC DNHOMJCGDIK_bgs JKCCNNCNIMK_bgs HHILGOLHGEG_bgs
	 public PKLLAKCBPAH_DecoPublicInfo OBDEIEHEPHC_DecoPublicInfo { get; private set; } // 0xC0 MNALFNMMGEP_bgs EBKBEKJHFKJ_bgs EDJENHFLPCC_bgs
	 public FNCFHIEELGO_DecoVisit AJOFHCPLLLC_DecoVisit { get; private set; } // 0xC4 FFAMGKJMGFN_bgs OAOLALOEIFA_bgs AJPKMCCCLJC_bgs
	 public MKNIBACMCDO_AssistPlate IGNHLKEMJND_AssistPlate { get; private set; } // 0xC8 DIIANAANOBE_bgs GGOHHKFJDCJ_bgs ENNNCECDONF_bgs
	 public GEGHOCKCKKA_LimitedCompoItem GJCOJBDOOJG_LimitedCompoItem { get; private set; } // 0xCC CMLGLHKJLNF_bgs KJJJCFABPEH_bgs GKEHKPEGILD_bgs
	 public CCBMJNPFPBB_EventGoDiva JMPNGBGNCFO_EventGoDiva { get; private set; } // 0xD0 LOLEIHDFOKP_bgs BDMCKFAEPIK_bgs NBGJMKCEIOI_bgs
	 public BAHFBCEPFGP_AddMusic MMGKPCIOHHC_AddMusic { get; private set; } // 0xD4 NIGNJMGNLIK_bgs CPFOEMJFADP_bgs JDGDGLJPMHP_bgs
	 public EAOHMJHHDKN_GachaLimit APFILEMHEPG_GachaLimit { get; private set; } // 0xD8 AHEKEIBBGEK_bgs MJKGKBMIEAF_bgs CFHDNDLAEMO_bgs
	public int ABPOMNOIKDA_PlayerId { get { return BFACFIBJBPA_Crypted ^ 0x7654981c; } set { BFACFIBJBPA_Crypted = value ^ 0x7654981c; } } // NMDJOKGPIOA_bgs 0xF1C03C NPALOAPEPAC_bgs 0xF1C050

	// // RVA: 0xF1BAEC Offset: 0xF1BAEC VA: 0xF1BAEC
	private ulong BCJKHLAOLAP_GetLoadFlags(OKGLGHCBCJP_Database _NDFIEMPPMLF_master)
	{
		ulong val = HALKDHEGEDF_DefaultBlockLoad;
		if(_NDFIEMPPMLF_master != null)
		{
			for(int i = 0; i < _NDFIEMPPMLF_master.NDLAAACJOLP.Count; i++)
			{
				switch(_NDFIEMPPMLF_master.NDLAAACJOLP[i]) 
				{
	...
	public static List<string> KPIDBPEKMFD_GetNames(ulong MKDDOJOADMF)
	{
	...
	public KLFDBFMNLBL_ServerSaveBlock LBDOLHGDIEB_Find(string _OPFGFINHFCE_name)
	{
	...
	// |-BBHNACPENDM_ServerSaveData.LBDOLHGDIEB_Find<object>
	// */

	// // RVA: 0xF1C528 Offset: 0xF1C528 VA: 0xF1C528
	public void KHEKNNFCAOI_Init(OKGLGHCBCJP_Database _NKEBMCIMJND_Database)
	{
		KHEKNNFCAOI_Init(BCJKHLAOLAP_GetLoadFlags(_NKEBMCIMJND_Database));
	}
	...
	private KLFDBFMNLBL_ServerSaveBlock MNMFKKKFDCL_NewBlock(ulong _NEJBNCHLMNJ_Type)
	{
		KLFDBFMNLBL_ServerSaveBlock data = null;
		if(BGEJFKHOMOC_CreateFuncs.ContainsKey(_NEJBNCHLMNJ_Type))
		{
			data = BGEJFKHOMOC_CreateFuncs[_NEJBNCHLMNJ_Type]();
			data.LHPDDGIJKNB_Reset();
			data.JIKKNHIAEKG_BlockName = OHNJJIMGKGK_Names[_NEJBNCHLMNJ_Type];
		}
		return data;
	}
	...
	public void ODDIHGPONFL_Copy(BBHNACPENDM_ServerSaveData GPBJHKLFCEP)
	{
		...
		{
			KLFDBFMNLBL_ServerSaveBlock block = MGJKEJHEBPO_Blocks.Find((KLFDBFMNLBL_ServerSaveBlock _GHPLINIACBB_x) =>
			{
				//0xF2AB64
				return _GHPLINIACBB_x.JIKKNHIAEKG_BlockName == GPBJHKLFCEP.MGJKEJHEBPO_Blocks[i].JIKKNHIAEKG_BlockName;
			});
			if(block != null)
			{
	...
	public bool IIEMACPEEBJ_Deserialize(List<string> _ANFNAHPIJDH_BlockNames, EDOHBJAPLPF_JsonData AAEDAEHIONI)
	{
		...
		{			
			...
			// internal bool FIMLFIMCLIK(KLFDBFMNLBL_ServerSaveBlock PKLPKMLGFGK) { }
			string OPFGFINHFCE_name = _ANFNAHPIJDH_BlockNames[i];
	...
	public EMHDCKMFCGE LEMFJICBALP(BBHNACPENDM_ServerSaveData _GJLFANGDGCL_Target, bool NNPGPAPDDMC/* = true*/)
	{
		if (MGJKEJHEBPO_Blocks == null)
			return null;
		...
		for(int i = 0; i < MGJKEJHEBPO_Blocks.Count; i++)
		{
			if(MGJKEJHEBPO_Blocks[i] != null)
			{
				...
				{
					if (MGJKEJHEBPO_Blocks[i].AGBOGBEOFME(_GJLFANGDGCL_Target.MGJKEJHEBPO_Blocks[i]))
						continue;
				}
		...
		if (l1.Count == 0)
			return null;
		long v = _GJLFANGDGCL_Target.MCKEOKFMLAH_SaveId + 1;
		if (NNPGPAPDDMC)
		{
		...
		for (int i = 0; i < l1.Count; i++)
		{
			_GJLFANGDGCL_Target.MGJKEJHEBPO_Blocks[l1[i]].OKJPIBHMKMJ(jsonData, v);
		}
		{
	...
	public void PLCFEICAKBC(List<string> _HHIHCJKLJFF_Names)
	{
		MCKEOKFMLAH_SaveId++;
		for(int i = 0; i < _HHIHCJKLJFF_Names.Count; i++)
		{
            KLFDBFMNLBL_ServerSaveBlock block = LBDOLHGDIEB_Find(_HHIHCJKLJFF_Names[i]);
			if(block != null)
			{
	...
	public bool IPLNOMCCNBI_UpdatePublicStatus()
	{
		...
		if (DGCJCAHIAPP_Diva == null)
			return false;
		int dId = MLAFAACKKBG_Unit.FJDDNKGHPHN_GetDefault().FDBOPFEOENF_diva[0].DIPKCALNIII_diva_id;
		if (dId == 0)
			dId = 1;
		MHEAEGMIKIE_PublicStatus.KIECDDFNCAN_Level = KCCLEHLLOFG_Common.KIECDDFNCAN_Level;
		MHEAEGMIKIE_PublicStatus.DIPKCALNIII_diva_id = dId;
		DEKKMGAFJCG_Diva.MNNLOBDPCCH_DivaInfo divaInfo = DGCJCAHIAPP_Diva.LGKFMLIOPKL_GetDivaInfo(dId);
		MHEAEGMIKIE_PublicStatus.ANAJIAENLNB_lv = divaInfo.HEBKEJBDCBH_diva_lv;
		...
		if(MLAFAACKKBG_Unit.FJDDNKGHPHN_GetDefault().FODKKJIDDKN_vf_Id != 0)
		{
			MHEAEGMIKIE_PublicStatus.FODKKJIDDKN_vf_Id = MLAFAACKKBG_Unit.FJDDNKGHPHN_GetDefault().FODKKJIDDKN_vf_Id;
		}
		MHEAEGMIKIE_PublicStatus.BKIFLJAMJGG_scn_cnt = PNLOINMCCKH_Scene.IGJAAIEAJPB_GetNumUnlockedScene();
		if(OFAJDLJBMEM_Emblem != null)
		{
			MHEAEGMIKIE_PublicStatus.FHCAFLCLGAA_em_cnt = OFAJDLJBMEM_Emblem.MDKOHOCONKE[MHEAEGMIKIE_PublicStatus.ABLOIBMGLFD_em_id - 1].FHCAFLCLGAA_em_cnt;
		}
		MHEAEGMIKIE_PublicStatus.FOFGELKGMAH_cos_cnt = BEKHNNCGIEL_Costume.EFFKJGEDONM_GetNumUnlockedCostume(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MFPNGNMFEAL_Costume, DGCJCAHIAPP_Diva, true);
		MHEAEGMIKIE_PublicStatus.MIFLBHBPBNF_vf_cnt = JJFFBDLIOCF_Valkyrie.IJHGOONDKLI_GetNumUnlocked(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.PEOALFEGNDH_Valkyrie);
		MHEAEGMIKIE_PublicStatus.APFOBLMCLAO_q_cnt = GOACJBOCLHH_Quest.KJJJNMHNMCG(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MHGPMMIDKMM_Quest);
		MHEAEGMIKIE_PublicStatus.JGDNCEANEBB_lv_max_cnt = PNLOINMCCKH_Scene.BNNPJLPMLLK(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game, IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene);
		MHEAEGMIKIE_PublicStatus.LDKEOMCNLBE_pf_tap = OEKEIGFAIGN_Counter.NJIDHLPGBFO_t_tap[4];
		MHEAEGMIKIE_PublicStatus.PCBJHBCNNGD_t_clr = OEKEIGFAIGN_Counter.PCBJHBCNNGD_t_clr;
		if(divaInfo.PIGLAEFPNEK_m_slot > 0 && divaInfo.PIGLAEFPNEK_m_slot < PNLOINMCCKH_Scene.OPIBAPEGCLA_Scenes.Count)
		{
			MMPBPOIFDAF_Scene.PMKOFEIONEG saveScene = PNLOINMCCKH_Scene.OPIBAPEGCLA_Scenes[divaInfo.PIGLAEFPNEK_m_slot - 1];
			MLIBEPGADJH_Scene.KKLDOOJBJMN dbScene = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[divaInfo.PIGLAEFPNEK_m_slot - 1];
			int a = dbScene.AGOEDLNOHND(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, saveScene.EMOJHJGHJLN_Sb, saveScene.JPIPENJGGDD_NumBoard, IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.GENHLFPKOEE(dbScene.EKLIPGELKCL_Rarity, dbScene.MCCIFLKCNKO_Feed));
			MHEAEGMIKIE_PublicStatus.AFBMEMCHJCL_MainScene.DOMFHDPMCCO_Init(divaInfo.PIGLAEFPNEK_m_slot, saveScene.PDNIFBEGMHC_Mb, saveScene.EMOJHJGHJLN_Sb, a, saveScene.JPIPENJGGDD_NumBoard, saveScene.DMNIMMGGJJJ_Leaf);
			//LAB_00f21764
		}
		else
		{
			MHEAEGMIKIE_PublicStatus.AFBMEMCHJCL_MainScene.DOMFHDPMCCO_Init(0, null, null, 0, 0, 0);
		}
		//LAB_00f21764
		for(int i = 0; i < divaInfo.EBDNICPAFLB_s_slot.Count; i++)
		{
			if (divaInfo.EBDNICPAFLB_s_slot[i] > 0 && divaInfo.EBDNICPAFLB_s_slot[i] < PNLOINMCCKH_Scene.OPIBAPEGCLA_Scenes.Count)
			{
				MMPBPOIFDAF_Scene.PMKOFEIONEG saveScene = PNLOINMCCKH_Scene.OPIBAPEGCLA_Scenes[divaInfo.EBDNICPAFLB_s_slot[i] - 1];
				MLIBEPGADJH_Scene.KKLDOOJBJMN dbScene = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[divaInfo.EBDNICPAFLB_s_slot[i] - 1];
				int a = dbScene.AGOEDLNOHND(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, saveScene.EMOJHJGHJLN_Sb, saveScene.JPIPENJGGDD_NumBoard, IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.GENHLFPKOEE(dbScene.EKLIPGELKCL_Rarity, dbScene.MCCIFLKCNKO_Feed));
				MHEAEGMIKIE_PublicStatus.HDJOHAJPGBA_SubScene[i].DOMFHDPMCCO_Init(divaInfo.EBDNICPAFLB_s_slot[i], saveScene.PDNIFBEGMHC_Mb, saveScene.EMOJHJGHJLN_Sb, saveScene.MJBODMOLOBC_luck, saveScene.JPIPENJGGDD_NumBoard, saveScene.DMNIMMGGJJJ_Leaf);
				//LAB_00f21764
			}
			else
			{
				MHEAEGMIKIE_PublicStatus.HDJOHAJPGBA_SubScene[i].DOMFHDPMCCO_Init(0, null, null, 0, 0, 0);
			}
		}
		if(LLBECHBNIJG_EventRaidPlayer != null)
		{
			int uptime = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.GDEKCOOBLMA_System.LPJLEHAJADA_GetIntParam("lobby_uptime_duration", 300);
	...
	public void DOPABKCMOOI(FKAFHLIDAFD KOFLKLHPOBJ, long _JHNMKKNEENE_Time)
	{
		MHEAEGMIKIE_PublicStatus.NAKJJBEIION_DcNm = KOFLKLHPOBJ.AHEFHIMGIBI_PlayerData.PDKHANKAPCI_DecoPublicSet.LJMCPFACDGJ.CPOONLHIMKC_DecoRoomName;
		MHEAEGMIKIE_PublicStatus.DALCINDEJLC_DcTm = _JHNMKKNEENE_Time;
	}
	...
	{
		if(OEKEIGFAIGN_Counter.BDLNMOIOMHK_total.EDLBLCGHECJ_MaxScore < MHEAEGMIKIE_PublicStatus.AEBENOJEGOJ_max_sc)
		{
			OEKEIGFAIGN_Counter.BDLNMOIOMHK_total.EDLBLCGHECJ_MaxScore = MHEAEGMIKIE_PublicStatus.AEBENOJEGOJ_max_sc;
		}
	...
	private void HLKDMJHBPON_UpdateCostumeUnlocked()
	{
		...
		for(int i = 0; i < DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList.Count; i++)
		{
			...
			{
				if(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MFPNGNMFEAL_Costume.OEMKAFGPOCE_IsCostumeAvaiable(DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[i].BEEAIAAJOHD_CostumeId, DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[i].DIPKCALNIII_diva_id))
				{
					if(!BEKHNNCGIEL_Costume.FABAGMLEKIB_CostumeList[DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[i].BEEAIAAJOHD_CostumeId - 1].FJODMPGPDDD_Unlocked)
					{
		...
		for(int i = 0; i < 16; i++)
		{
			for(int j = 0; j < MLAFAACKKBG_Unit.GCINIJEMHFK_Get(i).FDBOPFEOENF_diva.Count; j++)
			{
				if(MLAFAACKKBG_Unit.GCINIJEMHFK_Get(i).FDBOPFEOENF_diva[j].DIPKCALNIII_diva_id != 0)
				{
					if(!IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MFPNGNMFEAL_Costume.OEMKAFGPOCE_IsCostumeAvaiable(MLAFAACKKBG_Unit.GCINIJEMHFK_Get(i).FDBOPFEOENF_diva[j].BEEAIAAJOHD_CostumeId, MLAFAACKKBG_Unit.GCINIJEMHFK_Get(i).FDBOPFEOENF_diva[j].DIPKCALNIII_diva_id))
					{
						MLAFAACKKBG_Unit.GCINIJEMHFK_Get(i).FDBOPFEOENF_diva[j].BEEAIAAJOHD_CostumeId = 0;
					}
					else
					{
						if(!BEKHNNCGIEL_Costume.FABAGMLEKIB_CostumeList[MLAFAACKKBG_Unit.GCINIJEMHFK_Get(i).FDBOPFEOENF_diva[j].BEEAIAAJOHD_CostumeId - 1].FJODMPGPDDD_Unlocked)
						{
							MLAFAACKKBG_Unit.GCINIJEMHFK_Get(i).FDBOPFEOENF_diva[j].BEEAIAAJOHD_CostumeId = 0;
							MLAFAACKKBG_Unit.GCINIJEMHFK_Get(i).FDBOPFEOENF_diva[j].AFNIOJHODAG_CostumeColorId = 0;
						}
					}
				}
			}
	...
	private void LGMPOFPHDAD_UpdateMusicHighScore()
	{
		...
		{
			long time = NKGJPJPHLIF_SakashoManager.HHCJCDFCLOB_Instance.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime();
			List<KEODKEGFDLD_FreeMusicInfo> freeMusicsDb = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.IBPAFKKEKNK_Music.GEAANLPDJBP_FreeMusicData;
			...
			for(int i = 0; i < freeMusicsDb.Count; i++)
			{
				...
				if(dbMusic.PPEGAKEIEGM_Enabled == 2)
				{
					if(dbMusic.DEPGBBJMFED_CategoryId != 5)
					{
						...
						int score = FLBPFBFKBFC_FreeScoreMax.BDCAICINCKK_GetScore(i + 1);
						if(score < a)
						{
	...
	private void OAEFGBOGOEG_UpdateEmblems()
	{
		...
		{
			PEBFNABDJDI_System systemDb = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.GDEKCOOBLMA_System;
			int unlockVal = systemDb.LPJLEHAJADA_GetIntParam("fix_unlock_battle_class_emblem_id", 165);
			if(unlockVal != 0)
			{
	...
	private void DFDDLNKOCEL_UpdateIntimacyExp()
	{
		...
		{
			GJALOMELEHD_Intimacy intimacyDb = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.KDIALKDKBGE_Intimacy;
			GJALOMELEHD_Intimacy.MFMLEAMJJCH_LevelInfo data = intimacyDb.OOCKOCAACMD_DataByLevel[39];
			int exp = data.BDLNMOIOMHK_total;
			for(int i = 0; i < DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList.Count; i++)
			{
	...
	private void MOHHCOKOOGJ_UpdateLimitedItems()
	{
		if(KCCLEHLLOFG_Common.PCBHHJHLOLN)
		{
			if(KCCLEHLLOFG_Common.BBFIGEOBOMB_SpItem != null && GJCOJBDOOJG_LimitedCompoItem != null)
			{
				...
				for(int i = 0; i < cnt; i++)
				{
					GJCOJBDOOJG_LimitedCompoItem.CPIICACGNBH_AddItem(1, time, false);
				}
	...
	{
		if(JHFIPCIHJNL_Base.IJHBIMNKOMC_tutorial_end != 0)
			return;
		KHEKNNFCAOI_Init(BCJKHLAOLAP_GetLoadFlags(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database));
	...
	// private void CEFEHMFEDBK(int IMJIADPJJMM, int _AHHJLDLAPAN_DivaId, int _JPIDIENBGKH_CostumeId, int _EKFONBFDAAP_ColorId, int _AFBMEMCHJCL_MainScene, int JBLIIHOAIJB, int _HAPFNHPFBGD_SubScene1, long _BEBJKJKBOGH_date) { }
	...
	public void NGJEPEPIHIL(int OLNBNMKAGJG)
	{
		...
		KCCLEHLLOFG_Common.NIKCFOALFJC_diva_1st = OLNBNMKAGJG;
		diva.CPGFPEDMDEH_have = 1;
		diva.BEEAIAAJOHD_CostumeId = 0;
		MLAFAACKKBG_Unit.FJDDNKGHPHN_GetDefault().FDBOPFEOENF_diva[0].DIPKCALNIII_diva_id = OLNBNMKAGJG;
		OFAJDLJBMEM_Emblem.MDKOHOCONKE[0].BEBJKJKBOGH_date = t;
		MHEAEGMIKIE_PublicStatus.ABLOIBMGLFD_em_id = 1;
		MLAFAACKKBG_Unit.FJDDNKGHPHN_GetDefault().FODKKJIDDKN_vf_Id = 1;
    }
	...
	public void NELPFCBCJAO()
	{
		...
		MLAFAACKKBG_Unit.FJDDNKGHPHN_GetDefault().FODKKJIDDKN_vf_Id = FBFCCLFFIAF;
	}
