...
public class DEKKMGAFJCG_Diva : KLFDBFMNLBL_ServerSaveBlock
{
	public class MNNLOBDPCCH_DivaInfo
	{
		...
		public int FBGGEFFJJHB_xor = 0x8e; // 0x34
		...
		public int DIPKCALNIII_diva_id { get; set; } // 0x18 HLEPHANBMGN_bgs EOGPBFIDAPF_get_diva_id JDNCGPBAFMB_set_diva_id
		public int HEBKEJBDCBH_diva_lv { get; set; } // 0x1C GHHNOPMHDJE_bgs OMOHEDILHMF_get_diva_lv FCGDHINFKHC_set_diva_lv
		public int BEEAIAAJOHD_CostumeId { get; set; } // 0x20 JPEMECNHGLE_bgs DIIBIOEMHAI_get_CostumeId JIHEDMEFKAF_set_CostumeId
		public int AFNIOJHODAG_CostumeColorId { get; set; } // 0x24 JMNBFBLHJMC_bgs OCABHAPHAMH_bgs DIAIECJEGDG_bgs
		public int HPJMPINPKEP_HomeCostumeId { get; set; } // 0x28 FFHDAPEBIOM_bgs JKALKLILMPH_bgs HALNDNAKBIE_bgs
		public int KKEPMONFGEI_HomeCostumeColorId { get; set; } // 0x2C HGHGFBHGAKL_bgs EDJNFDAPBAP_bgs MJDLBJPPPOL_bgs
		public List<int> ANAJIAENLNB_lv { get { return KJFGPMCKKOD; } } //0x1973BD8 MMOMNMBKHJF_get_lv
		public List<int> LKIFDCEKDCK_exp { get { return OJKHIMDICBI; } } //0x1973BE0 GOKMANFHFPC_get_exp
		public List<int> KBOLNIBLIND_unlock { get { return OGKFEBONAAP; } } //0x1973BE8 HEOJHPJAPJC_bgs
		public List<int> EBDNICPAFLB_s_slot { get { return NBJLJHECGEF; } } //0x1972894 GHDADHFINPE_bgs
		public int KCCONFODCPN_IntimacyLevel { get { int val = LFIEICOKCDE_IntimacyLevelCrypted ^ (FBGGEFFJJHB_xor + 3); return val < 1 ? 0 : val; } set { LFIEICOKCDE_IntimacyLevelCrypted = (value > 0 ? value : 0) ^ (FBGGEFFJJHB_xor + 3); } } //0x1973C20 GMOJMNAFGFF_bgs 0x1975018 AFJNLICPHEM_bgs
		public int BNDNNCHJGBB_IntimacyExp { get { int val = MJJEODANLKB_IntimacyExpCrypted ^ (FBGGEFFJJHB_xor + 99); return val < 1 ? 0 : val; } set { MJJEODANLKB_IntimacyExpCrypted = (value > 0 ? value : 0) ^ (FBGGEFFJJHB_xor + 99); } } //0x1973C3C ACFHGNKOBHK_bgs 0x1975030 JLCPBIOLJON_bgs
		public int JLEPLIHFPKD_IntimacySkillLevel { get { int val = BEMIPFOEHNL_IntimacySkillLevelCrypted ^ (FBGGEFFJJHB_xor + 37); return val < 1 ? 0 : val; } set { BEMIPFOEHNL_IntimacySkillLevelCrypted = (value > 0 ? value : 0) ^ (FBGGEFFJJHB_xor + 37); } } //0x1973C58 IMCFHELDLLB_bgs 0x1975048 BIGDLBNDOEJ_bgs
		public int GCGCFGJCLEL_IntimacyTension { get { int val = CKPNEAELHGB_IntimacyTensionCrypted ^ (FBGGEFFJJHB_xor + 1111); return val < 1 ? 0 : val; } set { CKPNEAELHGB_IntimacyTensionCrypted = (value > 0 ? value : 0) ^ (FBGGEFFJJHB_xor + 1111); } } //0x1973C74 NJEMIKDCDDO_bgs 0x1975060 AOEKFBICAJE_bgs
		public int APKBMBKMPAB_IntimacyPresentCount { get { int val = EFCFPHJBDLF_IntimacyPresentCountCrypted ^ (FBGGEFFJJHB_xor + 137); return val < 1 ? 0 : val; } set { EFCFPHJBDLF_IntimacyPresentCountCrypted = (value > 0 ? value : 0) ^ (FBGGEFFJJHB_xor + 137); } } //0x1973C94 CPIAANDJCBL_bgs 0x197507C ENAGDPKCBJD_bgs
		public int DDODJCCIENF_IntimacyPresentTotal { get { int val = PDFBAFBABNB_IntimacyPresentTotalCrypted ^ (FBGGEFFJJHB_xor + 53); return val < -1 ? 0 : val; } set { PDFBAFBABNB_IntimacyPresentTotalCrypted = (value > -2 ? value : 0) ^ (FBGGEFFJJHB_xor + 53); } } //0x1973CB0 MJBJAFNIMNK_bgs 0x1975094 PECPGGACCMJ_bgs
		public int NFDPLBOIDAB_IntimacyTouchCount { get { int val = NJMEPLMHKGM_IntimacyTouchCountCrypted ^ (FBGGEFFJJHB_xor + 107); return val < 1 ? 0 : val; } set { NJMEPLMHKGM_IntimacyTouchCountCrypted = (value > 0 ? value : 0) ^ (FBGGEFFJJHB_xor + 107); } }// 0x1973CCC PHHGPFOGJPD_bgs 0x19750AC KEIPFIPCDMA_bgs
		public int NEAADNDKGLG_IntimacyTouchTotal { get { int val = BIGEOBIAMCC_IntimacyTouchTotalCrypted ^ (FBGGEFFJJHB_xor + 23); return val < 1 ? 0 : val; } set { BIGEOBIAMCC_IntimacyTouchTotalCrypted = (value > 0 ? value : 0) ^ (FBGGEFFJJHB_xor + 23); } } //0x1973CE8 NNJOIONEHNA_bgs 0x19750C4 AOPELFDEENK_bgs
		public int MMCEMJILMJI_EvSoLevel { get { int val = HMGACICFNNA_EvSoLevelCrypted ^ (FBGGEFFJJHB_xor + 17); return val < 1 ? 0 : val; } set { HMGACICFNNA_EvSoLevelCrypted = (value > 0 ? value : 0) ^ (FBGGEFFJJHB_xor + 17); } } //0x1973D04 LCACIAMABII_bgs 0x19750DC NOKGCDDMCLA_bgs
		public int HDPANGMKKCP_EvVoLevel { get { int val = EDHLMBBAFKM_EvVoLevelCrypted ^ (FBGGEFFJJHB_xor + 33); return val < 1 ? 0 : val; } set { EDHLMBBAFKM_EvVoLevelCrypted = (value > 0 ? value : 0) ^ (FBGGEFFJJHB_xor + 33); } } //0x1973D20 BPLDHGOMIHE_bgs 0x19750F4 KDLHBMNGHOI_bgs
		public int FFMLBEEBHDD_EvChLevel { get { int val = DAAIECDPNBM_EvChLevelCrypted ^ (FBGGEFFJJHB_xor + 94); return val < 1 ? 0 : val; } set { DAAIECDPNBM_EvChLevelCrypted = (value > 0 ? value : 0) ^ (FBGGEFFJJHB_xor + 94); } } //0x1973D3C JJOCEKDMNCN_bgs 0x197510C BBAHDADNMIM_bgs
		public int PIGLAEFPNEK_m_slot { get; set; } // 0x64 NIFCANFEMPB_bgs CIPINKBCEDB_bgs NCGOKHEDOLB_bgs
		public int JCHHIPOPNIN_s_slot_num { get { return 2; } set { return; } } //0x197289C KJGAMDBEKEM_bgs 0x1974FF4 KMEDIPKMMBN_bgs
		public int ACABEFKBBEN_exp_frag { get; set; } // 0x68 AJBEODMJGDN_bgs OFECNFINKEH_bgs NLFNBNNJJJC_bgs

		// // RVA: 0x197B9A8 Offset: 0x197B9A8 VA: 0x197B9A8
		public int OKMELNIIMMO_GetDivaLevel()
		{
			return HEBKEJBDCBH_diva_lv;
		}
		...
		{
			if(ACABEFKBBEN_exp_frag != OIKJFMGEICL.ACABEFKBBEN_exp_frag ||
				DIPKCALNIII_diva_id != OIKJFMGEICL.DIPKCALNIII_diva_id ||
				HEBKEJBDCBH_diva_lv != OIKJFMGEICL.HEBKEJBDCBH_diva_lv ||
				...
				PIGLAEFPNEK_m_slot != OIKJFMGEICL.PIGLAEFPNEK_m_slot ||
		...
		public void ODDIHGPONFL_Copy(MNNLOBDPCCH_DivaInfo GPBJHKLFCEP)
		{
			DIPKCALNIII_diva_id = GPBJHKLFCEP.DIPKCALNIII_diva_id;
			HEBKEJBDCBH_diva_lv = GPBJHKLFCEP.HEBKEJBDCBH_diva_lv;
			ACABEFKBBEN_exp_frag = GPBJHKLFCEP.ACABEFKBBEN_exp_frag;
			PIGLAEFPNEK_m_slot = GPBJHKLFCEP.PIGLAEFPNEK_m_slot;
		...
		// public void AGHKODFKOJI(BHBONAHFKHD JBBHNIACMFJ, string _JIKKNHIAEKG_BlockName, string MJBACHKCIHA, int _OIPCCBHIKIA_index, DEKKMGAFJCG_Diva.MNNLOBDPCCH_DivaInfo _OHMCIEMIKCE_t, bool EFOEPDLNLJG) { }
	}
	...
	public List<MNNLOBDPCCH_DivaInfo> NBIGLBMHEDC_DivaList { get; private set; } // 0x24 ELHJMCKHBBO_bgs DGMMMDMLCJF_bgs PICPPMMJAEH_bgs
	public override bool DMICHEJIAJL { get { return true; } } // 0x197A9C8 NFKFOODCJJB_bgs

	// // RVA: 0x19724F0 Offset: 0x19724F0 VA: 0x19724F0
	public MNNLOBDPCCH_DivaInfo LGKFMLIOPKL_GetDivaInfo(int _PPFNGGCBJKC_id)
	{
		if(_PPFNGGCBJKC_id != 0)
		{
			return NBIGLBMHEDC_DivaList[_PPFNGGCBJKC_id - 1];
		}
		return null;
	}

	// // RVA: 0x1972580 Offset: 0x1972580 VA: 0x1972580
	public IFHCNLAODKG JOGOEIEKIHP_GetDivaInfoWithScene(int _BCCHOBPJJKE_SceneId)
	{
		if(_BCCHOBPJJKE_SceneId == 0)
			return null;
		for(int i = 0; i < NBIGLBMHEDC_DivaList.Count; i++)
		{
			if(NBIGLBMHEDC_DivaList[i].PIGLAEFPNEK_m_slot == _BCCHOBPJJKE_SceneId)
			{
				IFHCNLAODKG res = new IFHCNLAODKG();
				res.LGBDBBFEPGL_SceneSlotIdx = 0;
				res.BCCHOBPJJKE_SceneId = _BCCHOBPJJKE_SceneId;
				res.AHHJLDLAPAN_DivaId = NBIGLBMHEDC_DivaList[i].DIPKCALNIII_diva_id;
				return res;
			}
			for(int j = 0; j < 2; j++)
			{
				if(NBIGLBMHEDC_DivaList[i].EBDNICPAFLB_s_slot[j] == _BCCHOBPJJKE_SceneId)
				{
					IFHCNLAODKG res = new IFHCNLAODKG();
	...
	public override void OKJPIBHMKMJ(EDOHBJAPLPF_JsonData OILEIIEIBHP, long _MCKEOKFMLAH_SaveId)
	{
		...
		for(int i = 0; i < NBIGLBMHEDC_DivaList.Count; i++)
		{
			...
			for(int j = 0; j < 300; j++)
			{
				data3.Add(d.ANAJIAENLNB_lv[j]);
				data4.Add(d.LKIFDCEKDCK_exp[j]);
				data5.Add(d.KBOLNIBLIND_unlock[j]);
			}
			...
			for(int j = 0; j < d.EBDNICPAFLB_s_slot.Count; j++)
			{
				data2[AFEHLCGHAEE_Strings.EBDNICPAFLB_s_slot].Add(d.EBDNICPAFLB_s_slot[j]);
			}
			data2[AFEHLCGHAEE_Strings.JCHHIPOPNIN_s_slot_num] = 2;
			data2[AFEHLCGHAEE_Strings.PIGLAEFPNEK_m_slot] = d.PIGLAEFPNEK_m_slot;
			data2[AFEHLCGHAEE_Strings.DIPKCALNIII_diva_id] = d.DIPKCALNIII_diva_id;
			data2[AFEHLCGHAEE_Strings.HEBKEJBDCBH_diva_lv] = d.HEBKEJBDCBH_diva_lv;
			data2[AFEHLCGHAEE_Strings.ACABEFKBBEN_exp_frag] = d.ACABEFKBBEN_exp_frag;
		...
		if(!blockMissing)
		{
			...
			else
			{
				...
				for(int i = 0; i < data.HNBFOAJIIAL_Count; i++)
				{
					...
					int val = CJAENOMGPDA_GetInt(subData, AFEHLCGHAEE_Strings.DIPKCALNIII_diva_id, i + 1, ref isInvalid);
					if (info.DIPKCALNIII_diva_id != val)
						val = i + 1;
					info.DIPKCALNIII_diva_id = val;
					info.HEBKEJBDCBH_diva_lv = CJAENOMGPDA_GetInt(subData, AFEHLCGHAEE_Strings.HEBKEJBDCBH_diva_lv, 1, ref isInvalid);
					info.ACABEFKBBEN_exp_frag = CJAENOMGPDA_GetInt(subData, AFEHLCGHAEE_Strings.ACABEFKBBEN_exp_frag, 0, ref isInvalid);
					info.PIGLAEFPNEK_m_slot = CJAENOMGPDA_GetInt(subData, AFEHLCGHAEE_Strings.PIGLAEFPNEK_m_slot, 0, ref isInvalid);
					info.BEEAIAAJOHD_CostumeId = CJAENOMGPDA_GetInt(subData, AFEHLCGHAEE_Strings.ODNOJKHHEOP_c_id, 0, ref isInvalid);
					...
					info.CPGFPEDMDEH_have = CJAENOMGPDA_GetInt(subData, AFEHLCGHAEE_Strings.CPGFPEDMDEH_have, 0, ref isInvalid);
					IBCGPBOGOGP_ReadIntArray(subData, AFEHLCGHAEE_Strings.ANAJIAENLNB_lv, 0, 300, (int _OIPCCBHIKIA_index, int _JBGEEPFKIGG_val) =>
					{
						//0x197B738
						info.ANAJIAENLNB_lv[_OIPCCBHIKIA_index] = _JBGEEPFKIGG_val;
					}, ref isInvalid);
					...
					IBCGPBOGOGP_ReadIntArray(subData, AFEHLCGHAEE_Strings.EBDNICPAFLB_s_slot, 0, 2, (int _OIPCCBHIKIA_index, int _JBGEEPFKIGG_val) =>
					{
						//0x197B90C
						info.EBDNICPAFLB_s_slot[_OIPCCBHIKIA_index] = _JBGEEPFKIGG_val;
					}, ref isInvalid);
					info.KCCONFODCPN_IntimacyLevel = CJAENOMGPDA_GetInt(subData, "intm_lv", 1, ref isInvalid);
					info.BNDNNCHJGBB_IntimacyExp = CJAENOMGPDA_GetInt(subData, "intm_exp", 0, ref isInvalid);
					info.JLEPLIHFPKD_IntimacySkillLevel = CJAENOMGPDA_GetInt(subData, "intm_skill_lv", 0, ref isInvalid);
					info.GCGCFGJCLEL_IntimacyTension = CJAENOMGPDA_GetInt(subData, "intm_tension", 0, ref isInvalid);
					info.APKBMBKMPAB_IntimacyPresentCount = CJAENOMGPDA_GetInt(subData, "intm_present_cnt", 1, ref isInvalid);
					info.DDODJCCIENF_IntimacyPresentTotal = CJAENOMGPDA_GetInt(subData, "intm_present_total", -1, ref isInvalid);
					info.NFDPLBOIDAB_IntimacyTouchCount = CJAENOMGPDA_GetInt(subData, "intm_touch_cnt", 0, ref isInvalid);
					info.NEAADNDKGLG_IntimacyTouchTotal = CJAENOMGPDA_GetInt(subData, "intm_touch_total", 0, ref isInvalid);
					...
					for (int j = 0; j < 300; j++)
					{
						...
						{
							if(info.LKIFDCEKDCK_exp[j] < v)
							{
								info.ANAJIAENLNB_lv[j] = 0;
							}
						}
					}
				}
	...
	public override void BMGGKONLFIC_Copy(KLFDBFMNLBL_ServerSaveBlock GPBJHKLFCEP)
	{
		...
		for(int i = 0; i < NBIGLBMHEDC_DivaList.Count; i++)
		{
			NBIGLBMHEDC_DivaList[i].ODDIHGPONFL_Copy(d.NBIGLBMHEDC_DivaList[i]);
		}
	}
	...
	// public void OBDIJIHNKLE(List<int> _HNHCIGMKPDC_DivaIds, ref List<int> _ONOICEHIHPJ_Ids) { }

	// // RVA: 0x197AFF8 Offset: 0x197AFF8 VA: 0x197AFF8
	public int BJBKCMPCPME(int _AHHJLDLAPAN_DivaId, int _DNBFMLBNAEE_point, GJALOMELEHD_Intimacy _NDFIEMPPMLF_master)
	{
		if(_AHHJLDLAPAN_DivaId > 0 && _NDFIEMPPMLF_master != null)
		{
			MNNLOBDPCCH_DivaInfo diva = NBIGLBMHEDC_DivaList[_AHHJLDLAPAN_DivaId - 1];
			int exp = diva.BNDNNCHJGBB_IntimacyExp;
			int maxLevel = _NDFIEMPPMLF_master.GLHEHGGKILG_GetMaxLevel();
			int level = diva.KCCONFODCPN_IntimacyLevel;
			int baseLevel = level;
			int level2 = baseLevel;
			int exp2 = exp;
			while (_DNBFMLBNAEE_point > 0)
			{
				level = maxLevel;
				exp2 = exp;
				if (maxLevel <= level2)
					break;
				int lvlExp = _NDFIEMPPMLF_master.JBKMPBPGFHA(level2);
				level = level2;
				exp2 = exp + _DNBFMLBNAEE_point;
				if (exp + _DNBFMLBNAEE_point < lvlExp)
					break;
				level = level2 + 1;
				if (0 < lvlExp - exp)
					_DNBFMLBNAEE_point -= lvlExp - exp;
				exp = lvlExp;
				level2 = level;
				exp2 = lvlExp;
			}
	...
	public bool EGDJODNNKDE_SetIntimacyTension(int AHHJLDLAPAN_DivaId, int _NHCCINMHEAB_Tension)
	{
		if (AHHJLDLAPAN_DivaId < 1)
			return false;
		NBIGLBMHEDC_DivaList[AHHJLDLAPAN_DivaId - 1].GCGCFGJCLEL_IntimacyTension = _NHCCINMHEAB_Tension;
		return true;
	}
	...
	// public bool BNLJGNBGMFM(int _AHHJLDLAPAN_DivaId, int _HMFFHLPNMPH_count) { }
	...
	public bool IGFOFCEKIAM(int _AHHJLDLAPAN_DivaId, int _HMFFHLPNMPH_count)
	{
		if(_AHHJLDLAPAN_DivaId > 0)
		{
			NBIGLBMHEDC_DivaList[_AHHJLDLAPAN_DivaId - 1].DDODJCCIENF_IntimacyPresentTotal += _HMFFHLPNMPH_count;
			return true;
		}
		return false;
	}
