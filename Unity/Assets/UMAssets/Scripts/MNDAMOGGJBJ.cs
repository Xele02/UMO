...
public class MNDAMOGGJBJ
{
	...
	public int JPLMJPGDPAN(int PPFNGGCBJKC)
	{
		...
		{
				return EKLNMHFCAOI.DLNFNHMPGLI(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_ServerSave, EKLNMHFCAOI.BKHFLDMOGBD_GetItemCategory(INLBMFMOHCI[PPFNGGCBJKC - 1].PPFNGGCBJKC_Id), EKLNMHFCAOI.DEACAHNLMNI_getItemId(INLBMFMOHCI[PPFNGGCBJKC - 1].PPFNGGCBJKC_Id), null);
		}
		return 0;
	}
