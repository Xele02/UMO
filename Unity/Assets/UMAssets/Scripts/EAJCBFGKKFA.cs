...
public class EAJCBFGKKFA_FriendInfo
{
	...
	public void KHEKNNFCAOI(IBIGBMDANNM NIMOGBDCMLJ)
	{
		...
		MGMFOJPNDGA.LDHHJFHGGMA(NIMOGBDCMLJ.AHEFHIMGIBI_PlayerData);
		...
		if(NIMOGBDCMLJ.AHEFHIMGIBI_PlayerData.MHEAEGMIKIE_PublicStatus.DIPKCALNIII_DivaId != 0)
		{
			...
			JIGONEMPPNP_Diva.KHEKNNFCAOI(NIMOGBDCMLJ.AHEFHIMGIBI_PlayerData.MHEAEGMIKIE_PublicStatus.DIPKCALNIII_DivaId,
		...
		{
			NDOLELKAJNL_DegreeData.KHEKNNFCAOI_Init(NIMOGBDCMLJ.AHEFHIMGIBI_PlayerData.MHEAEGMIKIE_PublicStatus.ABLOIBMGLFD_EmId,
	...
	public void KLJNFJJMJMC(IMCBBOAFION _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK _AOCANKOMKFG_OnError, bool OJEBNBLHPNP/* = false*/)
	{
		...
		if(MLPEHNBNOGD_Id > 9999)
		{
			...
			req.BHFHGFKBOHH_OnSuccess = (CACGCMBKHDI_Request JIPCHHHLOMM) =>
			{
				...
				PCEGKKLKFNO.AHEFHIMGIBI_PlayerData.MHEAEGMIKIE_PublicStatus.FOFGELKGMAH_CosCnt = KPMOBPNENCD_serverData.BEKHNNCGIEL_Costume.EFFKJGEDONM_GetNumUnlockedCostume(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.MFPNGNMFEAL_Costume, KPMOBPNENCD_serverData.DGCJCAHIAPP_Diva, true);
				_BHFHGFKBOHH_OnSuccess();
			};
