...
public class EAJCBFGKKFA_FriendInfo
{
	...
	public void KHEKNNFCAOI_Init(IBIGBMDANNM NIMOGBDCMLJ)
	{
		...
		if(NIMOGBDCMLJ.AHEFHIMGIBI_PlayerData.MHEAEGMIKIE_PublicStatus.DIPKCALNIII_diva_id != 0)
		{
			JIGONEMPPNP_Diva = new FFHPBEPOMAK_DivaInfo();
			JIGONEMPPNP_Diva.KHEKNNFCAOI_Init(NIMOGBDCMLJ.AHEFHIMGIBI_PlayerData.MHEAEGMIKIE_PublicStatus.DIPKCALNIII_diva_id,
				NIMOGBDCMLJ.AHEFHIMGIBI_PlayerData.MHEAEGMIKIE_PublicStatus.ANAJIAENLNB_lv,
		...
		else
		{
			...
			LNFMPMEIMPH_SceneCnt = NIMOGBDCMLJ.AHEFHIMGIBI_PlayerData.MHEAEGMIKIE_PublicStatus.BKIFLJAMJGG_scn_cnt;
		}
		...
		{
			NDOLELKAJNL_Degree.KHEKNNFCAOI_Init(NIMOGBDCMLJ.AHEFHIMGIBI_PlayerData.MHEAEGMIKIE_PublicStatus.ABLOIBMGLFD_em_id,
				NIMOGBDCMLJ.AHEFHIMGIBI_PlayerData.MHEAEGMIKIE_PublicStatus.FHCAFLCLGAA_em_cnt);
		}
