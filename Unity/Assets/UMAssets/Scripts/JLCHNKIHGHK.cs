...
public class JLCHNKIHGHK
{
	...
	public void KHEKNNFCAOI_Init()
	{
		...
		if(ev != null && ev.HIDHLFCBIDE_EventType == OHCAABOMEOF.KGOGMKMBCPP_EventType.BNECMLPHAGJ_EventGoDiva)
		{
			...
			KNIFCANOHOC_score = JGEOBNENMAH.HHCJCDFCLOB.GCAPLLEIAAI_LastScore;
			...
			AHOKAPCGJMA_TotalPoint = Mathf.Min(JGEOBNENMAH.HHCJCDFCLOB.MMLPAMGJEOD_NewPoint, 99999999);
			...
			OMOLFAKIDIC_LevelCap = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.GDEKCOOBLMA_System.LPJLEHAJADA_GetIntParam("godiva_max_level", OMOLFAKIDIC_LevelCap);
