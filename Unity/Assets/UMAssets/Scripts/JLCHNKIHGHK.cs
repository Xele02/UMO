...
public class JLCHNKIHGHK
{
    public enum GDJKDOMAAPG_Type
    {
        ...
        LGOHMPBLPKA_2_Charm = 2,
        CKPGGPDJCAL_3 = 3,
    }

	public int LIPIAPOGHIP_EpisodeNum; // 0x8
	...
	public int AHOKAPCGJMA_TotalPoint; // 0x3C
	...
	{
        IKDICBBFBMI_NetEventBaseController ev = JEPBIIJDGEF_NetEventManager.HHCJCDFCLOB_Instance.OIKOHACJPCB_GetEventById(JGEOBNENMAH_NetGameManager.HHCJCDFCLOB_Instance.JKEPHFPCKMD_EventId);
		if(ev != null && ev.HIDHLFCBIDE_EventType == OHCAABOMEOF.KGOGMKMBCPP_EventType.BNECMLPHAGJ_EventGoDiva)
		{
			MANPIONIGNO_NetEventGoDivaController goEv = ev as MANPIONIGNO_NetEventGoDivaController;
			LIPIAPOGHIP_EpisodeNum = goEv.CMCEGEKGEEP.LIPIAPOGHIP_EpisodeNum;
			PFJMBKBEFMA_EpisodeRate = goEv.CMCEGEKGEEP.PFJMBKBEFMA_EpisodeRate;
			...
			ODOOKDGCKMF_MedalNum = JGEOBNENMAH_NetGameManager.HHCJCDFCLOB_Instance.ODOOKDGCKMF_MedalNum;
			KNIFCANOHOC_score = JGEOBNENMAH_NetGameManager.HHCJCDFCLOB_Instance.GCAPLLEIAAI_LastScore;
			LMBFJMBIIGN = goEv.CMCEGEKGEEP.LMBFJMBIIGN;
			JLIKEOKBBAM_HighScore = goEv.CMCEGEKGEEP.JLIKEOKBBAM_HighScore;
			OPILAHLPJGH_ScoreBonus = goEv.CMCEGEKGEEP.JBJJFDIHKMB_ScorePoint;
			FFHMPNGJCLK_NewRecord = goEv.CMCEGEKGEEP.FFHMPNGJCLK_NewRecord;
			FPKGGEIMAFD_HasRanking = goEv.CMCEGEKGEEP.OENBOLPDBAB_FreeMusicId == JGEOBNENMAH_NetGameManager.HHCJCDFCLOB_Instance.PFHMFKKDMBM_FreeMusicId;
			HGHEENFMKGH_ScoreRanking = Mathf.Min(JGEOBNENMAH_NetGameManager.HHCJCDFCLOB_Instance.NEFFKLNAAJI_ScoreRankByDiva[JGEOBNENMAH_NetGameManager.HHCJCDFCLOB_Instance.AMJFOGHBFKJ_DivaIds[0] - 1], 99999999);
			IJCLEDCNFAC_PrevPoint = Mathf.Min(JGEOBNENMAH_NetGameManager.HHCJCDFCLOB_Instance.FFDBCEDKMGN_PrevPoint, 99999999);
			AHOKAPCGJMA_TotalPoint = Mathf.Min(JGEOBNENMAH_NetGameManager.HHCJCDFCLOB_Instance.MMLPAMGJEOD_NewPoint, 99999999);
			JKFCHNEININ_GetPoint = AHOKAPCGJMA_TotalPoint - IJCLEDCNFAC_PrevPoint;
			...
			ib.KHEKNNFCAOI_Init(JGEOBNENMAH_NetGameManager.HHCJCDFCLOB_Instance.PFHMFKKDMBM_FreeMusicId, false, 0, 0, 0, false, false, false);
			...
			CAIDKLILLNO[0] = goEv.CMCEGEKGEEP.MKMIEGPOKGG_Soul.DNBFMLBNAEE_point;
			CAIDKLILLNO[1] = goEv.CMCEGEKGEEP.EACDINDLGLF_Voice.DNBFMLBNAEE_point;
			CAIDKLILLNO[2] = goEv.CMCEGEKGEEP.LDLHPACIIAB_Charm.DNBFMLBNAEE_point;
			...
			OGOJCIIINBG_BonusExp[0] = goEv.CMCEGEKGEEP.MKMIEGPOKGG_Soul.DJJGNDCMNHF_BonusValue;
			OGOJCIIINBG_BonusExp[1] = goEv.CMCEGEKGEEP.EACDINDLGLF_Voice.DJJGNDCMNHF_BonusValue;
			OGOJCIIINBG_BonusExp[2] = goEv.CMCEGEKGEEP.LDLHPACIIAB_Charm.DJJGNDCMNHF_BonusValue;
			...
			MKPAIJGMHOJ_NextExp[0] = goEv.CMCEGEKGEEP.MKMIEGPOKGG_Soul.LKIFDCEKDCK_exp;
			MKPAIJGMHOJ_NextExp[1] = goEv.CMCEGEKGEEP.EACDINDLGLF_Voice.LKIFDCEKDCK_exp;
			MKPAIJGMHOJ_NextExp[2] = goEv.CMCEGEKGEEP.LDLHPACIIAB_Charm.LKIFDCEKDCK_exp;
			FMMNAEJEIFF_BeforeLevel[0] = goEv.CMCEGEKGEEP.MKMIEGPOKGG_Soul.KFEMFDFPCGO_Level0;
			FMMNAEJEIFF_BeforeLevel[1] = goEv.CMCEGEKGEEP.EACDINDLGLF_Voice.KFEMFDFPCGO_Level0;
			FMMNAEJEIFF_BeforeLevel[2] = goEv.CMCEGEKGEEP.LDLHPACIIAB_Charm.KFEMFDFPCGO_Level0;
			HGMAAIJFPOI_AfterLevel[0] = goEv.CMCEGEKGEEP.MKMIEGPOKGG_Soul.CIEOBFIIPLD_Level;
			HGMAAIJFPOI_AfterLevel[1] = goEv.CMCEGEKGEEP.EACDINDLGLF_Voice.CIEOBFIIPLD_Level;
			HGMAAIJFPOI_AfterLevel[2] = goEv.CMCEGEKGEEP.LDLHPACIIAB_Charm.CIEOBFIIPLD_Level;
			...
			AECCBECCINI_AfterValue[0] = goEv.CMCEGEKGEEP.MKMIEGPOKGG_Soul.CMCKNKKCNDK_status;
			AECCBECCINI_AfterValue[1] = goEv.CMCEGEKGEEP.EACDINDLGLF_Voice.CMCKNKKCNDK_status;
			AECCBECCINI_AfterValue[2] = goEv.CMCEGEKGEEP.LDLHPACIIAB_Charm.CMCKNKKCNDK_status;
			OMOLFAKIDIC_LevelCap = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.OAINIGNLJKC_Diva2.NBJKHMLGNPA();
			OMOLFAKIDIC_LevelCap = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.GDEKCOOBLMA_System.LPJLEHAJADA_GetIntParam("godiva_max_level", OMOLFAKIDIC_LevelCap);
			OMOLFAKIDIC_LevelCap = Mathf.Min(OMOLFAKIDIC_LevelCap, IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.OAINIGNLJKC_Diva2.NBJKHMLGNPA());
