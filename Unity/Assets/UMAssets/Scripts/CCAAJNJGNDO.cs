...
public class CCAAJNJGNDO
{
	...
	public class GALFFONBIJG
	{
		...
		//public string FFPANKMKAPD { get; } 0x18FDD70 LLDJLCOLINP
		//public string OJAKFNNKADK { get; } 0x18FDD78 ENODEHGLBMB
		public int PBPOLELIPJI { get { return PPFNGGCBJKC; } } //0x18FD6BC AJNJOPJNMHL
		//public bool KKLDIKMOACO { get; } 0x18FDAD4 KDPOHBICGIG
		//public bool GOBAMBLBCOM { get; } 0x18FDD80 LHCGKFGGKHF
		//public bool CMEKNACNMCE { get; } 0x18FDD98 PLLDDFBFOEK
		//public bool DHJFHNFFDMG { get; } 0x18FDDAC MMKPJMILKBM 
		public NIPDOAIGCIB BMCJDCOEJFH { get { return EMJFHKHLHDB; } } //0x18FD710 DPDGJDLHLCN
		public bool CDOCOLOKCJK { get { return IPJMPBANBPP; } } //0x18FB9E4 CPLCFJBDCJP
		//public bool OKKNPGJAPAO { get; } 0x18FDDC0 NOJBDDDCGIK
		//public int HIGLGJBBPAP { get; } 0x18FDDCC JGFEIGNOGMH
		//public bool OEDKEGEPFKE { get; } 0x18FDDD4 NGINCPFOKOI
		//public int CLIHPOEBELF { get; } 0x18FDDDC KOJLDOBBFLI
		//public bool FICACPOCAPG { get; } 0x18FDDE4 ENGDEDCEKMH
		...
		//public bool IFNIEPPAMBE { get; set; } 0x18FB9EC DDMKFLKBLLM 0x18FDDFC GDNJIFOJKCJ
		//public int DEAKHOJCBDM { get; }  0x18FDE04 NCJIACPIFGD 
		//public bool GELLHOIEABC { get; set; } 0x18FDE0C MHCIBMHLBMN 0x18FD6B4 LAMLNFGBNOF
	...
	//public int PPMNNKKFJNM { get; } 0x18F9AB8 KOGGPFOFOBL
	//public CCAAJNJGNDO.HGIFGFEJLAB IMAGLAKEMIE { get; } 0x18F9AC0 EFMJDECNOLP
	...
	//public void KHEKNNFCAOI(IKDICBBFBMI LIKDEHHKFEH) { }

	//// RVA: 0x18FAE64 Offset: 0x18FAE64 VA: 0x18FAE64
	//public void MFCPHGNMMFA(KNKDBNFMAKF LIKDEHHKFEH) { }
	...
	private int CEAIGKOGLIN(GALFFONBIJG KCADLFGPNKH, GALFFONBIJG NEKKJMFOEDA)
	{
		...
		if (res == 0)
			res = KCADLFGPNKH.PBPOLELIPJI - NEKKJMFOEDA.PBPOLELIPJI;
		return res;
	}
