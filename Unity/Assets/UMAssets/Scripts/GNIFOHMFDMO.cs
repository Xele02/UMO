...
public class GNIFOHMFDMO_DivaResultData
{
	...
	public void KHEKNNFCAOI(int GHBPLHBNMBK_FreeMusicId, bool GIKLNODJKFK_IsLine6)
	{
		...
		AKNELONELJK = JGEOBNENMAH.HHCJCDFCLOB.LBLOIOMNEIH;
		...
		DEKKMGAFJCG_Diva prevSaveDiva = CIOECGOMILE.HHCJCDFCLOB.MNJHBCIIHED.DGCJCAHIAPP_Diva;
		...
		for(int i = 0; i < JGEOBNENMAH.HHCJCDFCLOB.AMJFOGHBFKJ_DivaIds.Count; i++)
		{
			...
			if(val != 0)
			{
				...
				data.EEHOJJNJJAI = KDOMGMCGHDC.ODIAFJCPIFO(DLAEJOBELBH_MusicId, data.AHHJLDLAPAN_DivaId, CIOECGOMILE.HHCJCDFCLOB.MNJHBCIIHED, data.IIHHAFPPFCP_PrevMusicLevel);
				data.OJLEDBKKMLN = KDOMGMCGHDC.NEGKGKKLICK(DLAEJOBELBH_MusicId, data.AHHJLDLAPAN_DivaId, CIOECGOMILE.HHCJCDFCLOB.MNJHBCIIHED);
