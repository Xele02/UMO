...
public class GKFPMAPFHIK_ViewEventAprilFoolMiniGameData
{
	...
	public AMLGMLNGMFB_EventAprilFool OEGDCBLNNFF(long JHNMKKNEENE, KGCNCBOKCBA.GNENJEHKMHD BELFNAHNMDL = KGCNCBOKCBA.GNENJEHKMHD.BCKENOKGLIJ/*9*/)
	{
	...
	{
		long time = NKGJPJPHLIF.HHCJCDFCLOB.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL.KMEFBNBFJHI_GetServerTime();
		AMLGMLNGMFB_EventAprilFool ev = OEGDCBLNNFF(time, KGCNCBOKCBA.GNENJEHKMHD.BCKENOKGLIJ/*9*/);
		if (ev == null)
			return;
