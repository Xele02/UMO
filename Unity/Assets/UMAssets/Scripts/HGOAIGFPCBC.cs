...
public class HGOAIGFPCBC
{
	...
	public void FBANBDCOEJL_Update(LayoutQuestTab.eTabType _INDDJNMPONH_type, bool APEPILNOJHL)
	{
		if (APEPILNOJHL)
			QuestUtility.UpdateQuestData(_INDDJNMPONH_type);
		FBANBDCOEJL_Update(QuestUtility.GetAchievedCount(_INDDJNMPONH_type));
	}

	//// RVA: 0x1752070 Offset: 0x1752070 VA: 0x1752070
	public void FBANBDCOEJL_Update(bool APEPILNOJHL)
	{
		if(APEPILNOJHL)
		{
			QuestUtility.UpdateQuestData();
		}
		FBANBDCOEJL_Update(QuestUtility.GetAchievedCount());
	}

	//// RVA: 0x1751FB4 Offset: 0x1751FB4 VA: 0x1751FB4
	public void FBANBDCOEJL_Update(int _HMFFHLPNMPH_count)
	{
