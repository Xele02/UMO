...
public class JDMLEAOJAJO
{
	...
	public HAEDCCLHEMN_EventBattle GGBDCHMDCFA()
    {
        ...
        {
            return JEPBIIJDGEF_EventInfo.HHCJCDFCLOB.OEGDCBLNNFF(OHCAABOMEOF.KGOGMKMBCPP_EventType.PFKOKHODEGL_EventBattle, KGCNCBOKCBA.GNENJEHKMHD.BCKENOKGLIJ_9) as HAEDCCLHEMN_EventBattle;
        }
        return null;
    }
	...
	public bool FNHNJNEJFLF(int GOBMOGJNEFA, bool DPCFADCFMOA)
    {
        ...
        if(ev != null)
        {
            ...
            if(dbSection != null)
            {
                ...
                saveEv.PCNOCBANFOO_ExResult[GOBMOGJNEFA].EPKDHJLMKLF_C = ev.CKCPAMDDNPF.EIMCIBOANHE;
