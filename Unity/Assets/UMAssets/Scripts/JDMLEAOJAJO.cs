...
public class CDDODEHEKGB : JDMLEAOJAJO
{
    public class BIPCCMDIHKF
    {
        ...
        public void ODNEBIAFLJP(EMGOCNMMPHC LGCIECNGAIL)
        {
            ...
            FDBNFFNFOND_close_at = LGCIECNGAIL.GJFPFFBAKGK_CloseAt;
        }
    }
	...
	public void PJHMKEGKMGH()
    {
        ...
        if(data != null)
        {
            ...
            if(db != null)
            {
                ...
                for(int i = 0; i < dbSection.GCFOLMHPDBG.Count; i++)
                {
                    ...
                    if(info.PPEGAKEIEGM_Enabled == 2)
                    {
                        if(song.PLALNIIBLOF_en == 2)
                        {
                            ...
                            d3.GJFPFFBAKGK_CloseAt = d2.FDBNFFNFOND_close_at;
                            ...
                            prevCloseAt = d2.FDBNFFNFOND_close_at;
                        }
                    }
                }
                ...
                CJFMFAEINBG.Sort((BIPCCMDIHKF _HKICMNAACDA_a, BIPCCMDIHKF _BNKHBCBJBKI_b) =>
                {
                    //0x12AF988
