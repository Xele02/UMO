...
namespace CriWare.CriMana.Detail
{
	...
	{
        [RendererResourceFactoryPriority(5050)] // RVA: 0x6345D0 Offset: 0x6345D0 VA: 0x6345D0
        public class RendererResourceFactoryAndroidSofdecPrimeYuv : RendererResourceFactory
        {
            // RVA: 0x294F75C Offset: 0x294F75C VA: 0x294F75C Slot: 7
            public override RendererResource CreateRendererResource(int playerId, MovieInfo movieInfo, bool additive, Shader userShader)
            {
                if((movieInfo.codecType == CodecType.SofdecPrime || movieInfo.codecType == CodecType.VP9) && SystemInfo.graphicsDeviceType == UnityEngine.Rendering.GraphicsDeviceType.OpenGLES3)
                {
                    return new RendererResourceAndroidSofdecPrimeYuv(playerId, movieInfo, additive, userShader);
                }
                return null;
            }
    ...
    public class RendererResourceAndroidSofdecPrimeYuv : RendererResource
    {
        ...
        public RendererResourceAndroidSofdecPrimeYuv(int playerId, MovieInfo movieInfo, bool additive, Shader userShader)
        {
            ...
            if(userShader == null)
                userShader = Shader.Find("CriMana/AndroidSofdecPrimeYuv");
            shader = userShader;
            if(hasAlpha)
            {
                if(movieInfo.codecType == CodecType.VP9)
                ...
                else
                {
                    ...
                    {
                        /*
                        Ceiling16 : x + 0xfU & 0xfffffff0
                        Ceiling64 : x + 0x3fU & 0xffffffc0
                        Ceiling32 : x + 0x1fU & 0xffffffe0
                        ...
                        */
                        ...
                        //alphaWidth = (int)((((((movieInfo.width + 7 ) & 0xfffffff8) + 0xf) & 0xfffffff0) + 0x1f) & 0xffffffe0);
                        //alphaHeight = (int)((movieInfo.height + 0xf) & 0xfffffff8);
                    }
                }
            }
