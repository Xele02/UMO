...
namespace CriWare
{
	public class CriAtomEx3dListener : CriDisposable
	{
		...
		public IntPtr nativeHandle { get {return this.handle;} } //0x288506C
		...
		#else
		private static IntPtr criAtomEx3dListener_Create(ref CriAtomEx3dListener.Config config, IntPtr work, int work_size)
		{
			return ExternLib.LibCriWare.criAtomEx3dListener_Create(ref config, work, work_size);
		}
		#endif
		...
		{
			ExternLib.LibCriWare.criAtomEx3dListener_Destroy(ex_3d_listener);
		}
		#endif
		...
		{
			ExternLib.LibCriWare.criAtomEx3dListener_Update(ex_3d_listener);
		}
		#endif
