...
// Namespace:
public class DOKOHKJIDBO // TypeDefIndex: 8685
{
        // Fields
        public ANCJLICGOLP IKCAJDOKNOM; // 0x8
        public bool LNAHEIEIBOI; // 0xC
        public string BEIFBNGMFPG; // 0x10
        public Dictionary<int, BEEINMBNKNM_Encryption> KCOIDGJOJHC_EncryptionMap; // 0x14

        // Properties
        public static DOKOHKJIDBO HHCJCDFCLOB { get; set; } // LGMPACEDIJF, Get NKACBOEHELJ, Set OKPMHKNCNAL
        // Methods
        ...
        // RVA: 0x1233040 Offset: 0x1233040 VA: 0x1233040
        public DOKOHKJIDBO()
        {
            KCOIDGJOJHC_EncryptionMap = new Dictionary<int, BEEINMBNKNM_Encryption>();
            BEIFBNGMFPG = "æªåå¾";
        }
}