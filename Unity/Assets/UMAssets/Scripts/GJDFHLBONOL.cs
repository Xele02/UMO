...
public class GJDFHLBONOL
{
	...
	public void DPKCOKLMFMK(EDOHBJAPLPF_JsonData IDLHJIOMJBK)
	{
		...
		HAAJGNCFNJM_ItemName = CEDHHAGBIBA.BNCLNFJHEND_ReadString(IDLHJIOMJBK, AFEHLCGHAEE_Strings.HAAJGNCFNJM_ItemName);
		...
		BIOGKIEECGN_CreatedAt = CEDHHAGBIBA.NIKODNFGCEM_ReadLong(IDLHJIOMJBK, AFEHLCGHAEE_Strings.BIOGKIEECGN_CreatedAt);
