...
public class CANAFALMGLI_EventPresentCampaign : IKDICBBFBMI_EventBase
{
	...
	protected override void KKFLDCBHFJA(long JHNMKKNEENE)
	{
		...
		if(evDb != null)
		{
			...
			DOLJEDAAKNN = "";
			GLIMIGNNGGB_Start = evDb.NGHKJOEDLIP.BONDDBOFBND_Start;
			DPJCPDKALGI_End1 = evDb.NGHKJOEDLIP.HPNOGLIFJOP_End1;
			LOLAANGCGDO = evDb.NGHKJOEDLIP.LNFKGHNHJKE;
			JDDFILGNGFH = evDb.NGHKJOEDLIP.JGMDAOACOJF;
			LJOHLEGGGMC = evDb.NGHKJOEDLIP.IDDBFFBPNGI;
			EMEKFFHCHMH_End = evDb.NGHKJOEDLIP.KNLGKBBIBOH_End;
