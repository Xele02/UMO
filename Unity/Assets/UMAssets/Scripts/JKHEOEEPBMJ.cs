...
public class JKHEOEEPBMJ
{
	...
	{
		return CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.GPHPNEGGGBG_HomeSceneId;
	}
	...
	{
		CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.HLLEEFLLFPD_HomeShowDiva = GOELFAECHGI ? 1 : 0;
	}

	// // RVA: 0x135FC58 Offset: 0x135FC58 VA: 0x135FC58
	public static bool NMKPJJLAONP_GetShowHomeDiva()
    {
        return CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.HLLEEFLLFPD_HomeShowDiva == 1;
    }
