...
public class HLEBAINCOME_EventScore : IKDICBBFBMI_EventBase
{
	...
	public override long FBGDBGKNKOD_GetCurrentPoint()
	{
		...
		if(ev != null)
		{
			FEHINJKHDAP_EventScore.ALGDNCMJHGN save = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.KOOKJBMGBIG_EventScore.FBCJICEPLED[ev.NGHKJOEDLIP_Setting.MOEKELIIDEO_SaveSlot];
	...
	public FEHINJKHDAP_EventScore.ALGDNCMJHGN JIPPHOKGLIH(bool HOENAFAJMGI/* = false*/)
	{
		...
		{
			if(HOENAFAJMGI)
				return CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.KOOKJBMGBIG_EventScore.FBCJICEPLED[ev.NGHKJOEDLIP_Setting.MOEKELIIDEO_SaveSlot];
			else
