...
public class HLEBAINCOME_EventScore : IKDICBBFBMI_EventBase
{
	...
	public override OHCAABOMEOF.KGOGMKMBCPP_EventType HIDHLFCBIDE_EventType { get { return OHCAABOMEOF.KGOGMKMBCPP_EventType.KEILBOLBDHN; } } //0x15EAAEC DKHCGLCNKCD  Slot: 4
	...
	protected override bool JIHMLILFOPG_IsEventActive(long JHNMKKNEENE)
	{
		...
		if(db != null)
		{
			TodoLogger.LogError(0, "HLEBAINCOME_EventScore.JIHMLILFOPG");
		}
		return false;
	}
	...
	{
		TodoLogger.LogError(0, "HLEBAINCOME_EventScore.IMCMNOPNGHO");
		return false;
	}
	...
	{
		TodoLogger.LogError(0, "EventScore JIPPHOKGLIH");
