...
public class NAKMCMEPAGH
{
	...
	public int BJDKMJFCOOM_LCnt { get { return CCNDOFGDOGF ^ FBGGEFFJJHB_xor; } set { CCNDOFGDOGF = value ^ FBGGEFFJJHB_xor; } } //0x17C0578 JKLLJKHDJFM 0x17C0588 OHDMFLKNGDA
	public int BKEKKFPEPBG_LDt { get { return DAPDDMJNNGG ^ FBGGEFFJJHB_xor; } set { DAPDDMJNNGG = value ^ FBGGEFFJJHB_xor; } } //0x17C0598 POIFAKPKGPE 0x17C05A8 KPEDOCAGMJP
