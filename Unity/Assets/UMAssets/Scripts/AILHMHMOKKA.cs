...
public abstract class AILHMHMOKKA_BaseLinkage
{
	...
	public abstract void EMKKJILHOOB_GetLinkageStatus(IMCBBOAFION _BHFHGFKBOHH_OnSuccess, JFDNPFFOACP NIMPEHIECJH, DJBHIFLHJLK _AOCANKOMKFG_OnError);

	//// RVA: -1 Offset: -1 Slot: 5
	public abstract void GGNBIHHFJMP(IMCBBOAFION _BHFHGFKBOHH_OnSuccess, JFDNPFFOACP NIMPEHIECJH, DJBHIFLHJLK _AOCANKOMKFG_OnError);

	//// RVA: -1 Offset: -1 Slot: 6
	public abstract void MOHPODEDIEK(IMCBBOAFION _BHFHGFKBOHH_OnSuccess, JFDNPFFOACP NIMPEHIECJH, DJBHIFLHJLK _AOCANKOMKFG_OnError);

	//// RVA: -1 Offset: -1 Slot: 7
	public abstract void BMJMJCIKALP(IMCBBOAFION _BHFHGFKBOHH_OnSuccess, JFDNPFFOACP NIMPEHIECJH, DJBHIFLHJLK _AOCANKOMKFG_OnError);

	//// RVA: 0xCCB544 Offset: 0xCCB544 VA: 0xCCB544
	protected bool HGOKJBPIDJB(CACGCMBKHDI_NetBaseAction NHECPMNKEFK)
	{
