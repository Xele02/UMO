...
public class NKGJPJPHLIF
{
	...
	public PJKLMCGEJMK IBLPICFDGOF { get; private set; }  // 0x14 BHLNCEJLGII // 0x14 // get OIFEGPGEFEI // set BCEJHLMIIGE
	// public OPKDHAODJOA HKDHHMHHJOJ { get; private set; } // 0x18 KFENGIGCDMF OHMLGPPPNLK 0xC165E8 PPBPMOIOLBM 0xC165F0
	public int MDAMJIGBOLD { get; private set; } // PlayerId // 0xA4 HBKPDFNAAOI PIIJNAHENJE 0xC165F8 HOBDGADNPGJ 0xC16600 
	public bool DCPCLHOJEHE { get; private set; } // 0xA8 JNJNPIHKNHE AHAHNANHOCN 0xC16A3C EGPFAFPDNJH 0xC16A44
	public int AFJEOKGBCNA { get; private set; } // 0xAC BLKAENELKCD AFEOFCFFAHA 0xC16A4C HHLMPHKALAF 0xC16A54
	...
	private IEnumerator PFKIHFCAPNC_Coroutine_InitializePlayerToken(IMCBBOAFION KLMFJJCNBIP, DJBHIFLHJLK JGKOLBLPMPG, bool MKFJAGGLEFL, bool FBBNPFFEJBN)
	{
		...
		else
		{
			//L214
			FFEEIONIBFF = null;
			UnityEngine.Debug.LogError("CreatePlayer");
	...
	public void LLMEJNALPJD(bool FBBNPFFEJBN, IMCBBOAFION BHFHGFKBOHH, DJBHIFLHJLK MOBEEPPKFLG, bool LFIEDDHNLBE)
	{
		...
		IHKOJFIFPKB COJNCNGHIJC = NKGJPJPHLIF.HHCJCDFCLOB.IBLPICFDGOF.IFFNCAFNEAG_AddRequest<IHKOJFIFPKB>(new IHKOJFIFPKB());
		if(!LFIEDDHNLBE)
		{
		...
		COJNCNGHIJC.BHFHGFKBOHH = (CACGCMBKHDI_Request JIPCHHHLOMM) => {
			//0xC1A8F0
			int val = 0;
		...
		COJNCNGHIJC.MOBEEPPKFLG = (CACGCMBKHDI_Request JIPCHHHLOMM) => {
			//0xC1AA34
			AFJEOKGBCNA = 0;
			if(MOBEEPPKFLG != null)
			{
