...
public class NKGJPJPHLIF
{
	...
	public void LLMEJNALPJD(bool FBBNPFFEJBN, IMCBBOAFION BHFHGFKBOHH, DJBHIFLHJLK MOBEEPPKFLG, bool LFIEDDHNLBE)
	{
		...
		IHKOJFIFPKB_RequestInquiryResponsesNumber COJNCNGHIJC = NKGJPJPHLIF.HHCJCDFCLOB.IBLPICFDGOF.IFFNCAFNEAG_AddRequest<IHKOJFIFPKB_RequestInquiryResponsesNumber>(new IHKOJFIFPKB_RequestInquiryResponsesNumber());
		if(!LFIEDDHNLBE)
		{
