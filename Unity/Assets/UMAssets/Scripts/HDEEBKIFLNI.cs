...
public class HDEEBKIFLNI
{
	...
	public void NLCBOJBAJFB_GetLinkageStatuses(IMCBBOAFION _BHFHGFKBOHH_OnSuccess, JFDNPFFOACP NIMPEHIECJH, DJBHIFLHJLK _AOCANKOMKFG_OnError)
	{
		N.a.StartCoroutineWatched(PMPMPFBDFLM_Coroutine_GetLinkageStatuses(_BHFHGFKBOHH_OnSuccess, NIMPEHIECJH, _AOCANKOMKFG_OnError));
	}

	//[IteratorStateMachineAttribute] // RVA: 0x6BAB7C Offset: 0x6BAB7C VA: 0x6BAB7C
	//// RVA: 0x1741080 Offset: 0x1741080 VA: 0x1741080
	private IEnumerator PMPMPFBDFLM_Coroutine_GetLinkageStatuses(IMCBBOAFION _BHFHGFKBOHH_OnSuccess, JFDNPFFOACP NIMPEHIECJH, DJBHIFLHJLK _AOCANKOMKFG_OnError)
	{
		//0x1741C58
	...
	public void IEIDONOJCOB(DGNPPLKNCGH_PlatformLink MKBOKLLDCFI, IMCBBOAFION _BHFHGFKBOHH_OnSuccess, JFDNPFFOACP NIMPEHIECJH, DJBHIFLHJLK _AOCANKOMKFG_OnError)
	{
		PLJLNHGJEIB(MKBOKLLDCFI).GGNBIHHFJMP(() =>
		{
			...
			_BHFHGFKBOHH_OnSuccess();
		}, NIMPEHIECJH, _AOCANKOMKFG_OnError);
	}

	//// RVA: 0x17412CC Offset: 0x17412CC VA: 0x17412CC
	public void LEDGNMBOGJN(DGNPPLKNCGH_PlatformLink MKBOKLLDCFI, IMCBBOAFION _BHFHGFKBOHH_OnSuccess, JFDNPFFOACP NIMPEHIECJH, DJBHIFLHJLK _AOCANKOMKFG_OnError)
	{
	...
	public void AFOLPGDADKI(DGNPPLKNCGH_PlatformLink MKBOKLLDCFI, IMCBBOAFION _BHFHGFKBOHH_OnSuccess, JFDNPFFOACP NIMPEHIECJH, DJBHIFLHJLK _AOCANKOMKFG_OnError)
	{
		N.a.StartCoroutineWatched(EFCCKAMIMAI_Co_CreatePlayer(MKBOKLLDCFI, _BHFHGFKBOHH_OnSuccess, NIMPEHIECJH, _AOCANKOMKFG_OnError));
	}
