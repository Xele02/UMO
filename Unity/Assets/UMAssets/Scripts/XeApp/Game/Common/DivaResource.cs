...
namespace XeApp.Game.Common
{
	public class DivaResource : MonoBehaviour
	{
		...
		{
    		UnityEngine.Debug.LogError("Enter Co_LoadBasicResource");
    		...
    		UnityEngine.Debug.LogError("Exit Co_LoadBasicResource");
		}
		...
		{
    		UnityEngine.Debug.LogError("Enter Co_LoadBoneSpringSuppress");
			// private int <>1__state; // 0x8
			// private object <>2__current; // 0xC
			...
			XeApp.Core.AssetBundleManager.UnloadAssetBundle(bundleName.ToString(), false);
			a_func(pressets);
    		UnityEngine.Debug.LogError("Exit Co_LoadBoneSpringSuppress");
		}
		...
		{
    		UnityEngine.Debug.LogError("Enter Co_LoadComponent");
			// private int <>1__state; // 0x8
			// private object <>2__current; // 0xC
			// public int divaId; // 0x10
			// public int modelId; // 0x14
    		...
    		UnityEngine.Debug.LogError("Exit Co_LoadComponent");
		}
		...
		{
    		UnityEngine.Debug.LogError("Enter Co_LoadMusicAnimationResource");
			// private int <>1__state; // 0x8
			// private object <>2__current; // 0xC
    		...
    		UnityEngine.Debug.LogError("Exit Co_LoadMusicAnimationResource");
		}
		...
		{
    		UnityEngine.Debug.LogError("Enter Co_LoadMikeStandResource");
			// private int <>1__state; // 0x8
			// private object <>2__current; // 0xC
			// public DivaResource <>4__this; // 0x10
			...
			XeApp.Core.AssetBundleManager.UnloadAssetBundle(bundleName.ToString(), false);
    		UnityEngine.Debug.LogError("Exit Co_LoadMikeStandResource");
		}
		...
		{
    		UnityEngine.Debug.LogError("Enter Co_LoadFacialResource");
			// private int <>1__state; // 0x8
			// private object <>2__current; // 0xC
    		...
    		UnityEngine.Debug.LogError("Exit Co_LoadFacialResource");
		}
		...
		{			
    		UnityEngine.Debug.LogError("Enter Co_LoadMenuResource");
			// private int <>1__state; // 0x8
			// private object <>2__current; // 0xC
			// public DivaResource <>4__this; // 0x10
			// public int divaId; // 0x14
    		...
    		UnityEngine.Debug.LogError("Exit Co_LoadMenuResource");
		}
		...
		{			
    		UnityEngine.Debug.LogError("Enter Co_LoadCharacter");
			// private int <>1__state; // 0x8
			// private object <>2__current; // 0xC
			// public DivaResource <>4__this; // 0x10
			// public int divaId; // 0x14
			...
			XeApp.Core.AssetBundleManager.UnloadAssetBundle(bundleName.ToString(), false);
    		UnityEngine.Debug.LogError("Exit Co_LoadCharacter");
		}
