...
namespace XeApp.Game.Common.View
{
	public class ViewBookMarkMusicData : MonoBehaviour
	{
		...
		{
			return CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.NPGGEAJMFCB_GetBookmarkName(OIPCCBHIKIA);
		}
		...
		{
			CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.BAAGCGEGIMK_SetBookmarkName(OIPCCBHIKIA, OPFGFINHFCE);
		}
