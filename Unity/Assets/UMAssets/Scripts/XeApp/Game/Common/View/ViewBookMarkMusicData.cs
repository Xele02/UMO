...
namespace XeApp.Game.Common.View
{
	public class ViewBookMarkMusicData : MonoBehaviour
	{
		...
		{
			return CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.KNKGEALPDGF_GetBookmark(_DLAEJOBELBH_MusicId, _OIPCCBHIKIA_index);
		}
		...
		public static bool KNKGEALPDGF_GetBookmark(int _DLAEJOBELBH_MusicId)
		{
			...
			for(int i = 0; i < 3; i++)
			{
				res |= CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.KNKGEALPDGF_GetBookmark(_DLAEJOBELBH_MusicId, i);
			}
			return res;
		}
		...
		{
			CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.DOGPMKIKKDA_SetBookmark(_DLAEJOBELBH_MusicId, _OIPCCBHIKIA_index, _MHBBJADMHPN_ChoiceSelected);
		}

		//// RVA: 0xD311BC Offset: 0xD311BC VA: 0xD311BC
		public static string BDCDCCJHOCD_GetBookmarkName(int _OIPCCBHIKIA_index)
		{
			return CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.NPGGEAJMFCB_GetBookmarkName(_OIPCCBHIKIA_index);
		}
		...
		{
			CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.BAAGCGEGIMK_SetBookmarkName(_OIPCCBHIKIA_index, _OPFGFINHFCE_name);
		}
