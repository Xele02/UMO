		...
		private void CreateRewardList(PopupRewardEvCheck.ViewRewardEvCheckData data)
		{
			...
			if(data.normal_raidboss_info_list != null)
			{
				for(int i = 0; i < data.normal_raidboss_info_list.Count; i++)
				{
					...
					a3.ILELGGCCGMJ_UtaGrade = data.normal_raidboss_info_list[i].ILELGGCCGMJ_UtaGrade;
					a2.ILELGGCCGMJ_UtaGrade = data.normal_raidboss_info_list[i].ILELGGCCGMJ_UtaGrade;
					a1.ILELGGCCGMJ_UtaGrade = data.normal_raidboss_info_list[i].ILELGGCCGMJ_UtaGrade;
					...
					a3.IOBJDNEGEBB_RankLower = data.normal_raidboss_info_list[i].IOBJDNEGEBB_RankLower;
					a2.IOBJDNEGEBB_RankLower = data.normal_raidboss_info_list[i].IOBJDNEGEBB_RankLower;
					a1.IOBJDNEGEBB_RankLower = data.normal_raidboss_info_list[i].IOBJDNEGEBB_RankLower;
					a3.PKLKOMIAKNL_RankUpper = data.normal_raidboss_info_list[i].PKLKOMIAKNL_RankUpper;
					a2.PKLKOMIAKNL_RankUpper = data.normal_raidboss_info_list[i].PKLKOMIAKNL_RankUpper;
					a1.PKLKOMIAKNL_RankUpper = data.normal_raidboss_info_list[i].PKLKOMIAKNL_RankUpper;
			...
			if(data.ex_raidboss_info_list != null)
			{
				for(int i = 0; i < data.ex_raidboss_info_list.Count; i++)
				{
					...
					d3.ILELGGCCGMJ_UtaGrade = data.ex_raidboss_info_list[i].ILELGGCCGMJ_UtaGrade;
					d2.ILELGGCCGMJ_UtaGrade = data.ex_raidboss_info_list[i].ILELGGCCGMJ_UtaGrade;
					d1.ILELGGCCGMJ_UtaGrade = data.ex_raidboss_info_list[i].ILELGGCCGMJ_UtaGrade;
					...
					d3.IOBJDNEGEBB_RankLower = data.ex_raidboss_info_list[i].IOBJDNEGEBB_RankLower;
					d2.IOBJDNEGEBB_RankLower = data.ex_raidboss_info_list[i].IOBJDNEGEBB_RankLower;
					d1.IOBJDNEGEBB_RankLower = data.ex_raidboss_info_list[i].IOBJDNEGEBB_RankLower;
					d3.PKLKOMIAKNL_RankUpper = data.ex_raidboss_info_list[i].PKLKOMIAKNL_RankUpper;
					d2.PKLKOMIAKNL_RankUpper = data.ex_raidboss_info_list[i].PKLKOMIAKNL_RankUpper;
					d1.PKLKOMIAKNL_RankUpper = data.ex_raidboss_info_list[i].PKLKOMIAKNL_RankUpper;
