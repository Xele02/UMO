...
namespace XeApp.Game.Menu
{
	public class LayoutDecorationVisitRightButtons : LayoutUGUIScriptBase
	{
		...
		{
			FanButtonLabelChange(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.GAAOPEGIPKA_FavoritePlayer.FFKIDMKHIOE(playerData.MLPEHNBNOGD_Id));
		}

		// RVA: 0x18BE8F0 Offset: 0x18BE8F0 VA: 0x18BE8F0
		public void UpdateFriendIcon(EAJCBFGKKFA_FriendInfo playerData)
		{
			m_decoDeco.Change(playerData.JIGONEMPPNP_Diva, playerData, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.GAAOPEGIPKA_FavoritePlayer.FFKIDMKHIOE(playerData.MLPEHNBNOGD_Id), DisplayType.Level);
