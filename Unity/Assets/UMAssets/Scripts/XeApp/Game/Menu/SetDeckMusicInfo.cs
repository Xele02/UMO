...
namespace XeApp.Game.Menu
{
	public class SetDeckMusicInfo : MonoBehaviour
	{
		...
		public void Set(EEDKAACNBBG_MusicData viewMusicData, GameSetupData.MusicInfo musicInfo, bool isMvMode, SetDeckMusicInfo.BottomType bottomType)
		{
			...
			m_musicNameText.text = Database.Instance.musicText.Get(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.IBPAFKKEKNK_Music.INJDLHAEPEK_GetMusicInfo(musicInfo.freeMusicId, musicInfo.musicId).KNMGEEFGDNI_Name).musicName;
