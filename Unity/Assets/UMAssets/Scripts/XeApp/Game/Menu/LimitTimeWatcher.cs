namespace XeApp.Game.Menu
{
	public class LimitTimeWatcher
	{
		...
		// public LimitTimeWatcher.OnElapsedCallback onElapsedCallback { private get; set; } // 0x24
		// public LimitTimeWatcher.OnEndCallback onEndCallback { private get; set; } // 0x28
