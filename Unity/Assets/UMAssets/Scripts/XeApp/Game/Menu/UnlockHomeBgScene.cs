...
namespace XeApp.Game.Menu
{
	public class UnlockHomeBgScene : MonoBehaviour
	{
		...
		public IEnumerator Co_Initialize(int homeBgId)
		{
			...
			if (homeBgId == 0)
				homeBgId = 11;
			ALJHJDHNFFB_HomeBg.ADLLAFIDFAM dbHomeBg = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.PFEKKPABPKL_HomeBg.CDENCMNHNGA_table[homeBgId - 1];
