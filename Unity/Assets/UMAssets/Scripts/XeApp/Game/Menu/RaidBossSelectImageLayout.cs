...
namespace XeApp.Game.Menu
{
	public class RaidBossSelectImageLayout : LayoutUGUIScriptBase
	{
		...
		public override bool InitializeFromLayout(Layout layout, TexUVListManager uvMan)
		{
			...
			m_eventId = JEPBIIJDGEF_NetEventManager.HHCJCDFCLOB_Instance.OEGDCBLNNFF(OHCAABOMEOF.KGOGMKMBCPP_EventType.CADKONMJEDA_11_EventRaid, KGCNCBOKCBA.GNENJEHKMHD_EventStatus.BCKENOKGLIJ_9_ResultRewardreceived).PGIIDPEGGPI_EventId;
			Loaded();
			return true;
		}
