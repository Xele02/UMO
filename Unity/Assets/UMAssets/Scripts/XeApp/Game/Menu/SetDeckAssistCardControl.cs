...
namespace XeApp.Game.Menu
{
	public class SetDeckAssistCardControl : MonoBehaviour
	{
		...
		public void UpdateContent(BKKMNPEEILG ghostData)
		{
			...
			HAEDCCLHEMN_NetEventBattleController ev = JEPBIIJDGEF_NetEventManager.HHCJCDFCLOB_Instance.OEGDCBLNNFF(OHCAABOMEOF.KGOGMKMBCPP_EventType.PFKOKHODEGL_EventBattle, KGCNCBOKCBA.GNENJEHKMHD_EventStatus.BCKENOKGLIJ_9_ResultRewardreceived) as HAEDCCLHEMN_NetEventBattleController;
