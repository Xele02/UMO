...
namespace XeApp.Game.Menu
{
	public class RaidApHealWindow : LayoutUGUIScriptBase
	{
		...
		public void Initialize(Action<Action, CIOECGOMILE.LIILJGHKIDL> onPushPaidButton, Action<Action> onPushApItemLButton, Action<Action> onPushApItemSButton, Action popupCloseEvent)
		{
			...
			m_contents[0].Text1.text = string.Format("pop_raid_ap_heal_item01_text01", CIOECGOMILE.HHCJCDFCLOB.CBOJGDKGCEF_GetApPrice()[1]);
			m_contents[0].Text2.text = string.Format("pop_raid_ap_heal_item01_text02", ev.COEIAHBIFBN(EKLNMHFCAOI.GJEEGMCBGGM_GetItemFullId(EKLNMHFCAOI.FKGCBLHOOCL_Category.PJDEOPMBGKJ_PaidVC, 0), CIOECGOMILE.LIILJGHKIDL.HLAJMFGDAHP_1));
			m_contents[0].Text3.text = string.Format("pop_raid_ap_heal_item01_text03", data.FNCPAEFEECO_CurrencyPaid);
			m_contents[1].Text1.text = string.Format("pop_raid_ap_heal_item01_text01", CIOECGOMILE.HHCJCDFCLOB.CBOJGDKGCEF_GetApPrice()[2]);
			m_contents[1].Text2.text = string.Format("pop_raid_ap_heal_item01_text02", ev.COEIAHBIFBN(EKLNMHFCAOI.GJEEGMCBGGM_GetItemFullId(EKLNMHFCAOI.FKGCBLHOOCL_Category.PJDEOPMBGKJ_PaidVC, 0), CIOECGOMILE.LIILJGHKIDL.FPNFLAAECMK_2));
			m_contents[1].Text3.text = string.Format("pop_raid_ap_heal_item01_text03", data.FNCPAEFEECO_CurrencyPaid);
			m_contents[2].Text1.text = string.Format("pop_raid_ap_heal_item02_text01", EKLNMHFCAOI.INCKKODFJAP_GetItemName(RaidItemConstants.MakeItemId(RaidItemConstants.Type.ApHealS)));
			m_contents[2].Text2.text = string.Format("pop_raid_ap_heal_item02_text02", ev.COEIAHBIFBN(RaidItemConstants.MakeItemId(RaidItemConstants.Type.ApHealS), CIOECGOMILE.LIILJGHKIDL.HLAJMFGDAHP_1));
			...
			m_contents[2].Text3.text = string.Format("pop_raid_ap_heal_item02_text03", numAp1);
			m_contents[3].Text1.text = string.Format("pop_raid_ap_heal_item02_text01", EKLNMHFCAOI.INCKKODFJAP_GetItemName(RaidItemConstants.MakeItemId(RaidItemConstants.Type.ApHealL)));
			m_contents[3].Text2.text = string.Format("pop_raid_ap_heal_item02_text02", ev.COEIAHBIFBN(RaidItemConstants.MakeItemId(RaidItemConstants.Type.ApHealL), CIOECGOMILE.LIILJGHKIDL.FPNFLAAECMK_2));
			...
			m_contents[3].Text3.text = string.Format("pop_raid_ap_heal_item02_text03", numAp2);
