...
namespace XeApp.Game.Menu
{
	public class SetDeckExpectedScoreGauge : MonoBehaviour
	{
		...
		{
			UnitExpectedScore.baseGaugeRatio = Mathf.CeilToInt((IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.LPJLEHAJADA_GetIntParam("score_gauge_rate_margin", 10) * 0.01f + CMMKCEPBIHI.FDLECNKJCGG_GaugeRatio) * 10.0f) / 10.0f;
