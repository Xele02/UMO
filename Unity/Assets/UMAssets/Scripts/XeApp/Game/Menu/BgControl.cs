...
namespace XeApp.Game.Menu
{
	...
	{ 
		...
		private int GetDefaultHomeBg()
		{
			...
			{
				d = GameManager.Instance.ViewPlayerData.NBIGLBMHEDC_DivaList[GameManager.Instance.localSave.EPJOACOONAC_GetSave().CNLJNGLMMHB_Options.BBIOMNCILMC_HomeDivaId - 1];
			}
			int idx = 9;
			if(d != null)
			{
