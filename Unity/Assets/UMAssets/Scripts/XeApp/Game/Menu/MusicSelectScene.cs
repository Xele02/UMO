...
namespace XeApp.Game.Menu
{
	public class MusicSelectScene : MusicSelectSceneBase
	{
		...
		protected override void OnPreSetCanvas()
		{
			if(Args != null)
			{
				UnityEngine.Debug.LogError("TODO OnPreSetCanvas with args");
			}
			else
			{
				m_isLine6Mode = GameManager.Instance.localSave.EPJOACOONAC().MCNEIJAOLNO.BCOIACHCMLA.LMPCJJKHHPA();
			}
			m_pickupFreeMusicId = 0;
			m_pickupFreeCategoryId = 0;
			if(IsCanDoUnitHelp())
			{
				UnityEngine.Debug.LogError("TODO OnPreSetCanvas IsCanDoUnitHelp");
			}
			...
			{
				UnityEngine.Debug.LogError("TODO OnPreSetCanvas !SelectUnitDanceFocus");
			}
			SetupViewMusicData();
			if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND.GDEKCOOBLMA.LPJLEHAJADA("server_time_auto_update", 0) > 0)
			{
		...
		{
			UnityEngine.Debug.LogError("TODO CheckTryInstall");
		}
		...
		protected override IEnumerator Co_Initialize()
		{
			...
			if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND.GDEKCOOBLMA.LPJLEHAJADA("server_time_auto_update", 0) > 1)
			{
			...
			m_sliveButton.SetUnlockRank(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI.KCCLEHLLOFG.KIECDDFNCAN, IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND.GDEKCOOBLMA.LPJLEHAJADA("mv_player_level", 5));
		...
		{
			UnityEngine.Debug.LogError("TODO Release");
		}
		...
		protected override void SetupViewMusicData()
		{
			...
			Difficulty.Type difficulty = GameManager.Instance.localSave.EPJOACOONAC().MCNEIJAOLNO.BCOIACHCMLA.FFACBDAJJJP();
			FreeCategoryId.Type categoryId = GameManager.Instance.localSave.EPJOACOONAC().MCNEIJAOLNO.BCOIACHCMLA.OGJDBPMKJKE();
			int curMusicId = 0;
			OHCAABOMEOF.KGOGMKMBCPP val2 = 0;
			GameManager.Instance.localSave.EPJOACOONAC().MCNEIJAOLNO.BCOIACHCMLA.FKJBADIPKHK(
				categoryId,
			...
			if(mArgs == null || !mArgs.hasSelection)
			{
				...
				diff = difficulty;
				musicDataIdx = m_filteredMusicDataList[(int)categoryId - 1].FindIndex(curMusicId, val2, m_isLine6Mode, m_isSimulationLive);
			...
			{
				UnityEngine.Debug.LogError("TODO init  with args");
				//L230
			}
			//LAB_016819f8:
			ReviseDifficulty();
			...
			{
				UnityEngine.Debug.LogError("TODO init event music");
			}
		...
		{
			UnityEngine.Debug.LogError("TODO DelayedApplyMusicInfo");
		}

		// // RVA: 0x1682DA0 Offset: 0x1682DA0 VA: 0x1682DA0
		private void ApplyEventInfo()
		{
			UnityEngine.Debug.LogError("TODO MusicSelectScene* ApplyEventInfo");
		}
		...
		{
			UnityEngine.Debug.LogError("TODO IsFilter");
			return false;
		}
		...
		{
			UnityEngine.Debug.LogError("TODO OnClickMusicFilterButton");
		}

		// // RVA: 0x168264C Offset: 0x168264C VA: 0x168264C
		private void OnChangeMusicFilter(bool applyDisplay)
		{
			UnityEngine.Debug.LogError("TODO OnChangeMusicFilter");
		}
		...
		{
			UnityEngine.Debug.LogError("TODO OnChangedSeries");
		}
		...
		{
			UnityEngine.Debug.LogError("TODO OnChangeLiveMode");
		}
		...
		{
			UnityEngine.Debug.LogError("TODO OnChangeLineMode");
		}

		// // RVA: 0x1684928 Offset: 0x1684928 VA: 0x1684928
		private void OnClickEventBanner()
		{
			UnityEngine.Debug.LogError("TODO OnClickEventBanner");
		}
		...
		protected override IEnumerator Co_OnActivateScene()
		{
			...
			{
				UnityEngine.Debug.LogError("TODO Co_OnActivateScene display & check unlock");
			}
