...
namespace XeApp.Game.Menu
{
	...
	public class ValkyrieIconTextureCache : IconTextureCache
	{
		...
		{
			return string.Format("ct/vl/01/{0:D2}_{1:D2}.xab", IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.PEOALFEGNDH_Valkyrie.JDMECLDHNOF[valkyrie - 1].LHPKEPPBKPF, form + 1);
		}
