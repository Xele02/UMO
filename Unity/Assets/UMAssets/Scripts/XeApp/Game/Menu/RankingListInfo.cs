...
namespace XeApp.Game.Menu
{
	public class RankingListInfo : PlayerListInfo
	{
		...
		public RankingListInfo(int index, bool isAvailable, EAJCBFGKKFA_FriendInfo friend)
		{
			...
			{
				LCLCCHLDNHJ_Costume.ILODJKFJJDO_CostumeInfo cos = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MFPNGNMFEAL_Costume.LBDOLHGDIEB_Find(friend.JIGONEMPPNP_Diva.AHHJLDLAPAN_DivaId, friend.JIGONEMPPNP_Diva.JPIDIENBGKH_CostumeId);
