...
namespace XeApp.Game.Menu
{
	public class DecoCustomDecorator : MonoBehaviour
	{
		...
		{
			IsLoaded = false;
			int is_enable_famous_phrase_4 = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.GAPONCJOKAC_DecoStamp.LPJLEHAJADA_GetIntParam("is_enable_famous_phrase_4", 0);
