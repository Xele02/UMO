...
namespace XeApp.Game.Menu
{
	public class PopupShopItemContent : UIBehaviour, IPopupContent
	{
		...
		public void Initialize(PopupSetting setting, Vector2 size, PopupWindowControl control)
		{
			...
			OnChange(EKLNMHFCAOI_ItemManager.BKHFLDMOGBD_GetItemCategory(setup.View.KIJAPOFAGPN_ItemId) == EKLNMHFCAOI_ItemManager.FKGCBLHOOCL_Category.ICJOEDJECAP_DecoSetItem ? 1 : 0, false);
		}
