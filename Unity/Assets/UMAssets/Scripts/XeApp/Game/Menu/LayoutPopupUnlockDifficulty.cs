...
namespace XeApp.Game.Menu
{
	public class LayoutPopupUnlockDifficulty : LayoutUGUIScriptBase
	{
		...
		public void SetStatus(PopupUnlock.UnlockInfo info)
		{
			...
			m.KHEKNNFCAOI_Init(info.param.id);
		...
		{
			return KDLPEDBKMID_NetDelayInstaller.HHCJCDFCLOB_Instance.LNHFLJBGGJB_IsRunning || m_isLoadingLogo || m_isLoadingMusicJacket;
		}
