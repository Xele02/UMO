...
namespace XeApp.Game.Menu
{
	public class OfferTransformationScene : TransitionRoot
	{
				...
				if(m_viewValkyrie != null)
				{
					if(m_viewValkyrie.IsShow())
					{
						...
						if(!MenuScene.Instance.DirtyChangeScene)
						{
							...
							BOPFPIHGJMD.ADMNKELOLPN a1 = KDHGBOOECKC.HHCJCDFCLOB.KJGAJBOBIHK(m_offerInfo.FGHGMHPNEMG_Type, m_offerInfo.PPFNGGCBJKC);
		...
		private void AnimationStart()
		{
			...
			{
				KDHGBOOECKC.HHCJCDFCLOB.NKHGLFOBOJD(KDHGBOOECKC.HHCJCDFCLOB.CNNICINEKBJ().FGHGMHPNEMG_Type, KDHGBOOECKC.HHCJCDFCLOB.CNNICINEKBJ().MLDPDLPHJPM, platoonId, form);
				ILCCJNDFFOB.HHCJCDFCLOB.OEGCKACJMPM(KDHGBOOECKC.HHCJCDFCLOB.CNNICINEKBJ().FGHGMHPNEMG_Type, KDHGBOOECKC.HHCJCDFCLOB.CNNICINEKBJ().MLDPDLPHJPM);
			}
			if (CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer != null)
				CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.ILMPHFPFLJE(BOPFPIHGJMD.PDLKAKEABDP.HFKNIAGOFKC_1, true);
		...
		private IEnumerator AllAssetLoad()
		{
			...
			m_transFormationData = d.JGJOAFJPIIH(d1.FGHGMHPNEMG_Type, d1.MLDPDLPHJPM);
