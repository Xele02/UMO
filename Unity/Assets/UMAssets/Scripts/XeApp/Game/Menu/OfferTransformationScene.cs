	...
	public class OfferTransformationScene : TransitionRoot
	{
		...
		private void AnimationStart()
		{
			...
			if(KDHGBOOECKC.HHCJCDFCLOB != null)
			{
				...
				ILCCJNDFFOB.HHCJCDFCLOB.OEGCKACJMPM(KDHGBOOECKC.HHCJCDFCLOB.CNNICINEKBJ().FGHGMHPNEMG_Type, KDHGBOOECKC.HHCJCDFCLOB.CNNICINEKBJ().MLDPDLPHJPM_OfferId);
			}
			if (CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer != null)
				CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.ILMPHFPFLJE_SetTutoStatus(BOPFPIHGJMD.PDLKAKEABDP.HFKNIAGOFKC_1, true);
