	...
	public class SetDeckDivaStatusControl : MonoBehaviour
	{
		...
		private void SetMusicExp(FFHPBEPOMAK_DivaInfo divaData, DFKGGBMFFGB_PlayerInfo playerData, int musicId)
		{
			...
			else
			{
				...
				KDOMGMCGHDC.HJNMIKNAMFH h = KDOMGMCGHDC.ODIAFJCPIFO(musicId, f.AHHJLDLAPAN_DivaId, CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData, f.PKLPGBKKFOL_DivaLevels[musicId - 1]);
				if(h == null)
				{
					SetInvalidMusicExp();
				}
