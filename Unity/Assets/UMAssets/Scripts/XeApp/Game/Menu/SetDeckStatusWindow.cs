...
namespace XeApp.Game.Menu
{
	public class SetDeckStatusWindow : MonoBehaviour
	{
		...
		public void UpdateContent(DFKGGBMFFGB_PlayerInfo viewPlayerData, JLKEOGLJNOD_TeamInfo viewUnitData, EEDKAACNBBG_MusicData viewMusicData, EJKBKMBJMGL_EnemyData enemyData, EAJCBFGKKFA_FriendInfo viewFriendData, UnitWindowConstant.OperationMode opMode, bool isGoDiva)
		{
			...
			if (SubPlateResult.CDOCOLOKCJK_Avaiable())
			{
				m_status[0].Set(m_baseStatus.Total - SubPlateResult.CMCKNKKCNDK_status.Total, m_addStatus.Total - SubPlateResult.CMCKNKKCNDK_status.Total, false, res.IJACIMIPBBK_IsBufftarget(MKHCIKICBOI_ParamFlag.MKADAMIGMPO_7_Total), res.ADENHAHPBCJ_IsDebuffTarget(MKHCIKICBOI_ParamFlag.MKADAMIGMPO_7_Total), "#"+ColorExtension.HexStringRGBA(m_normalColorCode), 9999999);
				m_status[1].Set(m_baseStatus.soul - SubPlateResult.CMCKNKKCNDK_status.soul, m_addStatus.soul - SubPlateResult.CMCKNKKCNDK_status.soul, false, res.IJACIMIPBBK_IsBufftarget(MKHCIKICBOI_ParamFlag.BICPBLMPBPH_1_Soul), res.ADENHAHPBCJ_IsDebuffTarget(MKHCIKICBOI_ParamFlag.BICPBLMPBPH_1_Soul), "#" + ColorExtension.HexStringRGBA(m_normalColorCode), 999999);
				m_status[2].Set(m_baseStatus.vocal - SubPlateResult.CMCKNKKCNDK_status.vocal, m_addStatus.vocal - SubPlateResult.CMCKNKKCNDK_status.vocal, false, res.IJACIMIPBBK_IsBufftarget(MKHCIKICBOI_ParamFlag.GPCMMGOCPHC_2_Vocal), res.ADENHAHPBCJ_IsDebuffTarget(MKHCIKICBOI_ParamFlag.GPCMMGOCPHC_2_Vocal), "#" + ColorExtension.HexStringRGBA(m_normalColorCode), 999999);
				m_status[3].Set(m_baseStatus.charm - SubPlateResult.CMCKNKKCNDK_status.charm, m_addStatus.charm - SubPlateResult.CMCKNKKCNDK_status.charm, false, res.IJACIMIPBBK_IsBufftarget(MKHCIKICBOI_ParamFlag.LGOHMPBLPKA_4_Charm), res.ADENHAHPBCJ_IsDebuffTarget(MKHCIKICBOI_ParamFlag.LGOHMPBLPKA_4_Charm), "#" + ColorExtension.HexStringRGBA(m_normalColorCode), 999999);
			}
			else
			{
				SetInvalidSubPlate();
				m_status[0].Set(m_baseStatus.Total, m_addStatus.Total, false, res.IJACIMIPBBK_IsBufftarget(MKHCIKICBOI_ParamFlag.MKADAMIGMPO_7_Total), res.ADENHAHPBCJ_IsDebuffTarget(MKHCIKICBOI_ParamFlag.MKADAMIGMPO_7_Total), "#" + ColorExtension.HexStringRGBA(m_normalColorCode), 9999999);
				m_status[1].Set(m_baseStatus.soul, m_addStatus.soul, false, res.IJACIMIPBBK_IsBufftarget(MKHCIKICBOI_ParamFlag.BICPBLMPBPH_1_Soul), res.ADENHAHPBCJ_IsDebuffTarget(MKHCIKICBOI_ParamFlag.BICPBLMPBPH_1_Soul), "#" + ColorExtension.HexStringRGBA(m_normalColorCode), 999999);
				m_status[2].Set(m_baseStatus.vocal, m_addStatus.vocal, false, res.IJACIMIPBBK_IsBufftarget(MKHCIKICBOI_ParamFlag.GPCMMGOCPHC_2_Vocal), res.ADENHAHPBCJ_IsDebuffTarget(MKHCIKICBOI_ParamFlag.GPCMMGOCPHC_2_Vocal), "#" + ColorExtension.HexStringRGBA(m_normalColorCode), 999999);
				m_status[3].Set(m_baseStatus.charm, m_addStatus.charm, false, res.IJACIMIPBBK_IsBufftarget(MKHCIKICBOI_ParamFlag.LGOHMPBLPKA_4_Charm), res.ADENHAHPBCJ_IsDebuffTarget(MKHCIKICBOI_ParamFlag.LGOHMPBLPKA_4_Charm), "#" + ColorExtension.HexStringRGBA(m_normalColorCode), 999999);
			}
			m_status[4].Set(m_baseStatus.life, m_addStatus.life, false, res.IJACIMIPBBK_IsBufftarget(MKHCIKICBOI_ParamFlag.ECHJOKLBHEJ_8_Life), res.ADENHAHPBCJ_IsDebuffTarget(MKHCIKICBOI_ParamFlag.ECHJOKLBHEJ_8_Life), "#" + ColorExtension.HexStringRGBA(m_normalColorCode), 999999);
			m_status[7].Set(luck, luck + luck2, false, res.IJACIMIPBBK_IsBufftarget(MKHCIKICBOI_ParamFlag.OHOKFCJNFDO_64_Luck), res.ADENHAHPBCJ_IsDebuffTarget(MKHCIKICBOI_ParamFlag.OHOKFCJNFDO_64_Luck), "#" + ColorExtension.HexStringRGBA(m_normalColorCode), 999999);
			m_status[5].Set(m_baseStatus.support, m_addStatus.support, false, res.IJACIMIPBBK_IsBufftarget(MKHCIKICBOI_ParamFlag.AHJNCHAONGN_16_Support), res.ADENHAHPBCJ_IsDebuffTarget(MKHCIKICBOI_ParamFlag.AHJNCHAONGN_16_Support), "#" + ColorExtension.HexStringRGBA(m_normalColorCode), 999999);
			m_status[6].Set(m_baseStatus.fold, m_addStatus.fold, false, res.IJACIMIPBBK_IsBufftarget(MKHCIKICBOI_ParamFlag.ONBNGGDFAJK_32_Fold), res.ADENHAHPBCJ_IsDebuffTarget(MKHCIKICBOI_ParamFlag.ONBNGGDFAJK_32_Fold), "#" + ColorExtension.HexStringRGBA(m_normalColorCode), 999999);
