...
namespace XeApp.Game.Menu
{
	public class MusicSelectSeriesInfo : LayoutLabelScriptBase
	{
		...
		{
			TodoLogger.LogError(TodoLogger.OldMusicSelect, "MusicSelectSeriesInfo TryLeave");
		}

		// // RVA: 0xF52C34 Offset: 0xF52C34 VA: 0xF52C34
		public void Enter()
		{
			TodoLogger.LogError(TodoLogger.OldMusicSelect, "MusicSelectSeriesInfo Enter");
		}
		...
		{
			TodoLogger.LogError(TodoLogger.OldMusicSelect, "MusicSelectSeriesInfo IsPlaying");
			return false;
		}
		...
		{
			TodoLogger.LogError(TodoLogger.OldMusicSelect, "InitializeFromLayout MusicSelectSeriesInfo");
			return true;
		}
	}
}
