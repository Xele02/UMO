...
namespace XeApp.Game.Menu
{
	public class MusicSelectCDArrow : LayoutLabelScriptBase
	{
		...
		{
			TodoLogger.LogError(TodoLogger.OldMusicSelect, "MusicSelectCDArrow TryLeave");
		}

		// // RVA: 0x166BF04 Offset: 0x166BF04 VA: 0x166BF04
		public void Enter()
		{
			TodoLogger.LogError(TodoLogger.OldMusicSelect, "MusicSelectCDArrow Enter");
		}
		...
		public void Hide()
		{
			TodoLogger.LogError(TodoLogger.OldMusicSelect, "MusicSelectCDArrow Hide");
		}

		// // RVA: 0x166C124 Offset: 0x166C124 VA: 0x166C124
		public bool IsPlaying()
		{
			TodoLogger.LogError(TodoLogger.OldMusicSelect, "MusicSelectCDArrow IsPlaying");
			return false;
		}
		...
		{
			TodoLogger.LogError(TodoLogger.OldMusicSelect, "InitializeFromLayout MusicSelectCDArrow");
			return true;
		}
	}
}
