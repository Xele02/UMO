...
namespace XeApp.Game.Menu
{
	public class MusicSelectCDArrow : LayoutLabelScriptBase
	{
		...
		{
			TodoLogger.LogError(0, "MusicSelectCDArrow TryLeave");
		}

		// // RVA: 0x166BF04 Offset: 0x166BF04 VA: 0x166BF04
		public void Enter()
		{
			TodoLogger.LogError(0, "MusicSelectCDArrow Enter");
		}
		...
		public void Hide()
		{
			TodoLogger.LogError(0, "MusicSelectCDArrow Hide");
		}

		// // RVA: 0x166C124 Offset: 0x166C124 VA: 0x166C124
		public bool IsPlaying()
		{
			TodoLogger.LogError(0, "MusicSelectCDArrow IsPlaying");
			return false;
		}
		...
		{
			TodoLogger.LogError(0, "InitializeFromLayout MusicSelectCDArrow");
			return true;
		}
	}
}
