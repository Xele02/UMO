	...
	public class SetDeckUnitStatus : MonoBehaviour
	{
		...
		public void UpdateContent(SetDeckParamCalculator paramCalculator)
		{
			...
			else
			{
				...
				m_totalStatus.Set(paramCalculator.BaseStatus.Total, paramCalculator.AddStatus.Total, false, paramCalculator.SkillCalcResult.IJACIMIPBBK_IsBufftarget(MKHCIKICBOI_ParamFlag.MKADAMIGMPO_7_Total), paramCalculator.SkillCalcResult.ADENHAHPBCJ_IsDebuffTarget(MKHCIKICBOI_ParamFlag.MKADAMIGMPO_7_Total), null, 0);
			}
