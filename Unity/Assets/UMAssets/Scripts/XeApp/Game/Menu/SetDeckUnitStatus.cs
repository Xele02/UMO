	...
	public class SetDeckUnitStatus : MonoBehaviour
	{
		...
		public void UpdateContent(SetDeckParamCalculator paramCalculator)
		{
			...
			else
			{
				...
				m_totalStatus.Set(paramCalculator.BaseStatus.Total, paramCalculator.AddStatus.Total, false, paramCalculator.SkillCalcResult.IJACIMIPBBK_IsBufftarget(MKHCIKICBOI.MKADAMIGMPO_Total), paramCalculator.SkillCalcResult.ADENHAHPBCJ_IsDebuffTarget(MKHCIKICBOI.MKADAMIGMPO_Total), null, 0);
			}
