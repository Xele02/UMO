...
namespace XeApp.Game.Menu
{
	public class RaidBossInfoLayout : LayoutUGUIScriptBase
	{
		...
		{
			m_bossNameText.text = (JEPBIIJDGEF_NetEventManager.HHCJCDFCLOB_Instance.OEGDCBLNNFF(OHCAABOMEOF.KGOGMKMBCPP_EventType.CADKONMJEDA_11_EventRaid, KGCNCBOKCBA.GNENJEHKMHD_EventStatus.BCKENOKGLIJ_9_ResultRewardreceived) as PKNOKJNLPOE_NetEventRaidController).AGEJGHGEGFF_GetBossName(bossType);
		}
