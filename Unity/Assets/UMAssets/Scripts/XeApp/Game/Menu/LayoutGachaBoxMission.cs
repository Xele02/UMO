...
namespace XeApp.Game.Menu
{
	public class LayoutGachaBoxMission : LayoutGachaBox
	{
		...
		public override void Setup(int eventId, HGFPAFPGIKG view)
		{
			...
			m_numGetPlate.SetNumber(it.BFGKGMOLAFL_MaxPlate - view.NNCCGILOOIE_ListIdx, 0);
			m_numMaxPlate.SetNumber(it.BFGKGMOLAFL_MaxPlate, 0);
			m_layoutGetPickup.StartChildrenAnimGoStop(view.NNCCGILOOIE_ListIdx < it.BFGKGMOLAFL_MaxPlate ? "02" : "01");
			m_buttonNext.Disable = view.NNCCGILOOIE_ListIdx == it.BFGKGMOLAFL_MaxPlate;
			...
			int b = Mathf.Clamp(Mathf.Min(new int[2] { view.JALHJAPAFLK_BoxCurrent, a }), 0, 10);
