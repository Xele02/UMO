...
namespace XeApp.Game.Menu
{
	public class UnitPopupWindowControl
	{
		...
		// public void ShowUnitList(bool isResetPosition, UnityAction callBack, UnityAction<int> unitDatailEvent, EEDKAACNBBG_MusicData musicData, EJKBKMBJMGL_EnemyData enemyData, EAJCBFGKKFA_FriendInfo friendData, DFKGGBMFFGB_PlayerInfo playerData, bool isGoDiva) { }
		...
		{
			for(int i = 0; i < m_unitAutoSettingSetting.PlayerData.NBIGLBMHEDC_DivaList.Count; i++)
			{
				m_unitAutoSettingSetting.PlayerData.NBIGLBMHEDC_DivaList[i].MNBNLONEDPF(false);
