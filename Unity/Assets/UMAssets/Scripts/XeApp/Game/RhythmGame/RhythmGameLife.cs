...
namespace XeApp.Game.RhythmGame
{
	public class RhythmGameLife
	{
		...
		public void Initialize(MusicData musicData, int max, bool a_is_liveskip/* = false*/)
		{
			...
			badDamage = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.HNMMJINNHII_Game.GOLHPPFLJNF(score.ANAJIAENLNB_Level, isLine6);
			missDamage = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.HNMMJINNHII_Game.AOGJFPLIOGB(score.ANAJIAENLNB_Level, isLine6);
			healNotesValue = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.HNMMJINNHII_Game.AFDONIMNHEJ(score.ANAJIAENLNB_Level, isLine6);
