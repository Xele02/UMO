...
namespace XeApp.Game.RhythmGame
{
	public class LiveSkillBase : SkillBase
	{
		...
		//public int skillType { get; } 0xF76E68
		//public override SkillBuffEffect.Type buffEffectType { get; } 0xF76E90  Slot: 4
		//public override int buffEffectValue { get; } 0xF76EF4  Slot: 5
		//public int baseBuffEffectValue { get; } 0xF76F18 
		//public override SkillDuration.Type durationType { get; } 0xF76FB4 Slot: 6
		//public override int durationValue { get; } 0xF77018 Slot: 7
		//public override int lineTarget { get; } 0xF770B4 Slot: 8
		//public int targetSkillType { get; } 0xF770DC
		//public int targetSkillEffectId { get; } 0xF76E1C
