namespace XeApp.Game.RhythmGame
{
	public class ActiveSkill : SkillBase
	{
		...
		//protected List<CDNKOFIELMK> masterSkillList { get; set; } 0xF67D9C 0xF67E78
		//protected CDNKOFIELMK masterSkill { get; set; } 0xF67E7C 0xF67F0C
		//public override SkillBuffEffect.Type buffEffectType { get; } 0xF67F10 Slot: 4
		//public override int buffEffectValue { get; } 0xF67F74 Slot: 5
		//public override SkillDuration.Type durationType { get; } 0xF68010 Slot: 6
		//public override int durationValue { get; } 0xF68074 Slot: 7
		//public override int lineTarget { get; } 0xF68110 Slot: 8
