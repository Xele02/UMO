...
namespace XeApp.Game.Tutorial
{
	...
	public class TutorialProc
	{
		...
		{
			if(!CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.ADKJDHPEAJH(GPFlagConstant.ID.IsAutoSetting))
			{
		...
		{
			return CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.PNLOINMCCKH_Scene.IGJAAIEAJPB_GetNumUnlockedScene() > 2;
		}
		...
		public static IEnumerator Co_TutorialAutoUnitSetting(ButtonBase autoSettingButton, Func<bool> waitAutoSettingWindowFunc)
		{
			...
			{
				CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.BCLKCMDGDLD(GPFlagConstant.ID.IsAutoSetting, true);
		...
		{
			if (musicInfo == null || CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.ADKJDHPEAJH(GPFlagConstant.ID.IsUnit5Help) || musicInfo.onStageDivaNum < 4)
				return false;
		...
		public static IEnumerator Co_TutorialUnit5(ButtonBase unitInfoChangeButton)
		{
			...
			while(isWait)
				yield return null;
			CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.BCLKCMDGDLD(GPFlagConstant.ID.IsUnit5Help, true);
			MenuScene.Instance.InputEnable();
			isWait = true;
			MenuScene.Save(() =>
			{
		...
		{
			if(!CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.ADKJDHPEAJH(GPFlagConstant.ID.IsBeginnerLiveMission))
			{
				if(QuestUtility.m_beginnerViewList.Count != 0)
				{
					FKMOKDCJFEN f = QuestUtility.m_beginnerViewList.Find((FKMOKDCJFEN x) => {
		...
		public static IEnumerator Co_CostumeUpgrade(EBFLJMOCLNA_Costume.NDOPBOCEPJO_TutoUpgradeType type, ButtonBase button, BasicTutorialMessageId messageId, InputLimitButton limitButton/* = InputLimitButton.None*/, TutorialPointer.Direction direction/* = TutorialPointer.Direction.Normal*/)
		{
			...
			//0xE4DC20
			pd = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.BEKHNNCGIEL_Costume;
		...
		public static IEnumerator Co_McrsLobby(HomeLobbyButtonController lobbyCtrl, Action proc)
		{
			...
			//0x1910FAC
			if(CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.ADKJDHPEAJH(GPFlagConstant.ID.IsMcrsLobby))
				yield break;
			if(proc != null)
				proc();
			MenuScene.Instance.InputDisable();
		...
		public static IEnumerator Co_RaidFromMcrsLobby(ButtonBase button)
		{
			...
			if(CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.ADKJDHPEAJH(GPFlagConstant.ID.IsRaidFromMcrsLobby))
				yield break;
			CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.BCLKCMDGDLD(GPFlagConstant.ID.IsRaidFromMcrsLobby, true);
			MenuScene.Instance.InputDisable();
			BasicTutorialManager.Initialize();
			mrg = BasicTutorialManager.Instance;
			bool isWait = true;
		...
		public static IEnumerator Co_RaidUseFoldRadar(ButtonBase button, Func<bool> waitPopupWindowFunc, IEnumerator popupItemGetColoutine, Func<int> waitRaidBossEncountFunc)
		{
			...
			if(CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.ADKJDHPEAJH(GPFlagConstant.ID.IsRaidUseFoldRadar))
				yield break;
			CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.BCLKCMDGDLD(GPFlagConstant.ID.IsRaidUseFoldRadar, true);
			mrg = BasicTutorialManager.Instance;
			bool isWait = true;
			MenuScene.Instance.InputDisable();
			mrg.PreLoadResource(() =>
		...
		public static IEnumerator Co_BeginnerMissionLiveClearMissionList()
		{
			...
			while(isWait)
				yield return null;
			CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.BCLKCMDGDLD(GPFlagConstant.ID.IsBeginnerLiveMission, true);
			MenuScene.Instance.InputDisable();
			isWait = true;
			MenuScene.Save(() =>
			{
		...
		{
			if(!CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.ADKJDHPEAJH(GPFlagConstant.ID.IsSelectAssist))
			{
				if (!CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.ADKJDHPEAJH(GPFlagConstant.ID.IsAutoSetting))
				{
					return true;
		...
		public static IEnumerator Co_AssistSelect(ActionButton button)
		{
			...
			while(isWait)
				yield return null;
			GameManager.Instance.RemovePushBackButtonHandler(dymmyBackHandler);
			CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.BCLKCMDGDLD(GPFlagConstant.ID.IsSelectAssist, true);
			isWait = true;
			MenuScene.Save(() =>
			{
				//0xE4C47C
		...
		public static bool IsUnlockTutorialInRank()
		{
			...
			if(!CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.MLBBKNLPBBD_IsTutoDone(BOPFPIHGJMD.PDLKAKEABDP_Tuto.EILIAPKFCEO_0_OfferRelease))
			{
			...
			{
				return !CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.ADKJDHPEAJH(GPFlagConstant.ID.IsValkyrieUpgrade);
			}
			return false;
		}
