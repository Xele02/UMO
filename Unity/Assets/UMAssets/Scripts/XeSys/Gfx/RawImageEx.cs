...
namespace XeSys.Gfx
{
	public class RawImageEx : RawImage, IAlphaTexture
	{
		...
		public Texture alphaTexture { get { return m_AlphaTexture; } set { if (m_AlphaTexture != value) m_AlphaTexture = value; } } //0x1F0FF60 0x1EFF6B8
		public string TextureName { get { return m_TextureName; } set { m_TextureName = value; } } //0x1F0FFF4 0x1EFF820
