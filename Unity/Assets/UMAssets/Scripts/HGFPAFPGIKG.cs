	...
	public void HCDGELDHFHB(CHHECNJBMLA_EventBoxGacha MOHDLLIJELH)
    {
        ...
        if(LOMNOJCONHP.Count > 0)
        {
            ...
            for(int i = 0; i < HCIDHHLOPLK.Count; i++)
            {
                ...
                HCIDHHLOPLK[i].LJKMKCOAICL = MOHDLLIJELH.JMLKAGOACAE[HCIDHHLOPLK[i].OIPCCBHIKIA_Idx].HMFFHLPNMPH;
                HCIDHHLOPLK[i].NNCCGILOOIE = MOHDLLIJELH.JMLKAGOACAE[HCIDHHLOPLK[i].OIPCCBHIKIA_Idx].AGKANHNHECE;
                HCIDHHLOPLK[i].BFGKGMOLAFL_MaxPlate = MOHDLLIJELH.JMLKAGOACAE[HCIDHHLOPLK[i].OIPCCBHIKIA_Idx].GCEANEOEGMD;
                HCIDHHLOPLK[i].JOPPFEHKNFO_IsPickup = MOHDLLIJELH.JMLKAGOACAE[HCIDHHLOPLK[i].OIPCCBHIKIA_Idx].AEDMJLGNDHN;
            }
