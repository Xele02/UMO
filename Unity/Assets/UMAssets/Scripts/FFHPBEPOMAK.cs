...
public class FFHPBEPOMAK
{
	...
	public void KHEKNNFCAOI(int AHHJLDLAPAN_DivaId, BBHNACPENDM_ServerSaveData NIMOGBDCMLJ, bool OJEBNBLHPNP = false)
	{
		...
		FFKMJNHFFFL.KHEKNNFCAOI(AHHJLDLAPAN_DivaId, JPIDIENBGKH_CostumeId, LDEGEHAEALK, OJEBNBLHPNP);
	...
	public void KHEKNNFCAOI(int AHHJLDLAPAN_DivaId, int PAOGPLDOMMI_Level, int PDEEMMEHDPK_CostumeId, int KOHAAFNNBOE_ColorId, GCIJNCFDNON AFBMEMCHJCL_MainScene, List<GCIJNCFDNON> HDJOHAJPGBA_SubScene, bool LGNOCBFCAAK = false)
	{
		...
		if(!LGNOCBFCAAK)
		{
			FFKMJNHFFFL.KHEKNNFCAOI(AHHJLDLAPAN_DivaId,PDEEMMEHDPK_CostumeId,0,false);
		}
		else
		{
			FFKMJNHFFFL.KHEKNNFCAOI(AHHJLDLAPAN_DivaId,PDEEMMEHDPK_CostumeId,CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_ServerSave,false);
		}
		FJODMPGPDDD = false;
