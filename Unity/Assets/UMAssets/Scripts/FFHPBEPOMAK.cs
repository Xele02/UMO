...
public class FFHPBEPOMAK
{
	public class CLKBDNBMJCO
	{
		...
		{
			DEKKMGAFJCG.MNNLOBDPCCH a = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI.DGCJCAHIAPP.NBIGLBMHEDC[AHHJLDLAPAN - 1];
	...
	public void KHEKNNFCAOI(int AHHJLDLAPAN_DivaId, int PAOGPLDOMMI, int PDEEMMEHDPK, int KOHAAFNNBOE, GCIJNCFDNON AFBMEMCHJCL, List<GCIJNCFDNON> HDJOHAJPGBA, bool LGNOCBFCAAK = false)
	{
		...
		{
			FFKMJNHFFFL.KHEKNNFCAOI(AHHJLDLAPAN_DivaId,PDEEMMEHDPK,CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI,false);
		}
		FJODMPGPDDD = false;
	...
	public void HCDGELDHFHB()
	{
		...
		{
			JLJGCBOHJID_Status.Add(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI.BEKHNNCGIEL.NNIKNCGNDHK(AHHJLDLAPAN_DivaId));
		}
