...
public class FFHPBEPOMAK
{
	public class CLKBDNBMJCO
	{
		...
		{
			DEKKMGAFJCG_Diva.MNNLOBDPCCH a = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_Save.DGCJCAHIAPP_Diva.NBIGLBMHEDC[AHHJLDLAPAN - 1];
	...
	public void KHEKNNFCAOI(int AHHJLDLAPAN_DivaId, BBHNACPENDM_ServerSaveData NIMOGBDCMLJ, bool OJEBNBLHPNP = false)
	{
		...
		PKLPGBKKFOL = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC[AHHJLDLAPAN_DivaId - 1].ANAJIAENLNB;
		HMBECPGHPOE = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC[AHHJLDLAPAN_DivaId - 1].LKIFDCEKDCK;
		FOHEIOLPAOG = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC[AHHJLDLAPAN_DivaId - 1].KBOLNIBLIND;
		FJODMPGPDDD = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC[AHHJLDLAPAN_DivaId - 1].CPGFPEDMDEH != 0;
		IPJMPBANBPP = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.MGFMPKLLGHE_Diva.CDENCMNHNGA[AHHJLDLAPAN_DivaId - 1].PPEGAKEIEGM == 2;
		CIEOBFIIPLD = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC[AHHJLDLAPAN_DivaId - 1].OKMELNIIMMO();
		...
		for(int i = 0; i < LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC[AHHJLDLAPAN_DivaId - 1].JCHHIPOPNIN; i++)
		{
			int val = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC[AHHJLDLAPAN_DivaId - 1].EBDNICPAFLB[i];
			DJICAKGOGFO.Add(val);
			if(val == 0)
			{
		...
		FGFIBOBAPIA = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC[AHHJLDLAPAN_DivaId - 1].PIGLAEFPNEK;
		if(FGFIBOBAPIA != 0)
		{
		...
		JPIDIENBGKH = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC[AHHJLDLAPAN_DivaId - 1].BEEAIAAJOHD_CostumeId;
		EKFONBFDAAP_ColorId = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC[AHHJLDLAPAN_DivaId - 1].AFNIOJHODAG;
		FFKMJNHFFFL.KHEKNNFCAOI(AHHJLDLAPAN_DivaId, JPIDIENBGKH, LDEGEHAEALK, OJEBNBLHPNP);
		KIIMFCFMMDN = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC[AHHJLDLAPAN_DivaId - 1].HPJMPINPKEP;
		JFFLFIMIMOI = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC[AHHJLDLAPAN_DivaId - 1].KKEPMONFGEI;
		EGAFMGDFFCH.KHEKNNFCAOI(AHHJLDLAPAN_DivaId, LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC[AHHJLDLAPAN_DivaId - 1].HPJMPINPKEP, 
	...
	public void HCDGELDHFHB()
	{
		...
		{
			JLJGCBOHJID_Status.Add(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_Save.BEKHNNCGIEL_Costume.NNIKNCGNDHK(AHHJLDLAPAN_DivaId));
		}
