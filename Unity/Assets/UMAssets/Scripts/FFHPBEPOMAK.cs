...
public class FFHPBEPOMAK_DivaInfo
{
	public class CLKBDNBMJCO
	{
		...
		public void KHEKNNFCAOI(int _AHHJLDLAPAN_DivaId)
		{
	...
	public void KHEKNNFCAOI(int _AHHJLDLAPAN_DivaId, BBHNACPENDM_ServerSaveData NIMOGBDCMLJ, bool OJEBNBLHPNP/* = false*/)
	{
		BNFDBPPOAOE = true;
		EEBBAGGJOGH = false;
		if(NIMOGBDCMLJ == null)
		{
			LDEGEHAEALK = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData;
		...
		PKLPGBKKFOL_DivaLevels = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[_AHHJLDLAPAN_DivaId - 1].ANAJIAENLNB_Level;
		HMBECPGHPOE_DivaExps = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[_AHHJLDLAPAN_DivaId - 1].LKIFDCEKDCK_Exps;
		FOHEIOLPAOG_DivaUnlocks = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[_AHHJLDLAPAN_DivaId - 1].KBOLNIBLIND_Unlocks;
		FJODMPGPDDD_Unlocked = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[_AHHJLDLAPAN_DivaId - 1].CPGFPEDMDEH_Have != 0/* || RuntimeSettings.CurrentSettings.ForceDivaUnlock*/;
		...
		CIEOBFIIPLD_Level = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[_AHHJLDLAPAN_DivaId - 1].OKMELNIIMMO_GetDivaLevel();
		...
		for(int i = 0; i < LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[_AHHJLDLAPAN_DivaId - 1].JCHHIPOPNIN; i++)
		{
			int val = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[_AHHJLDLAPAN_DivaId - 1].EBDNICPAFLB_SSlot[i];
		...
		FGFIBOBAPIA_SceneId = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[_AHHJLDLAPAN_DivaId - 1].PIGLAEFPNEK_MSlot;
		...
		JPIDIENBGKH_CostumeId = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[_AHHJLDLAPAN_DivaId - 1].BEEAIAAJOHD_CostumeId;
		EKFONBFDAAP_ColorId = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[_AHHJLDLAPAN_DivaId - 1].AFNIOJHODAG_CostumeColorId;
		FFKMJNHFFFL_Costume.KHEKNNFCAOI(_AHHJLDLAPAN_DivaId, JPIDIENBGKH_CostumeId, LDEGEHAEALK, OJEBNBLHPNP);
		KIIMFCFMMDN_HomeCostumeId = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[_AHHJLDLAPAN_DivaId - 1].HPJMPINPKEP_HomeCostumeId;
		JFFLFIMIMOI_HomeColorId = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[_AHHJLDLAPAN_DivaId - 1].KKEPMONFGEI_HomeCostumeColorId;
		EGAFMGDFFCH_HomeDivaCostume.KHEKNNFCAOI(_AHHJLDLAPAN_DivaId, LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[_AHHJLDLAPAN_DivaId - 1].HPJMPINPKEP_HomeCostumeId, 
		...
		else
		{
			...
			JLKPGDEKPEO_IsHave = LDEGEHAEALK.BEKHNNCGIEL_Costume.FABAGMLEKIB_CostumeList[JPIDIENBGKH_CostumeId - 1].CGKAEMGLHNK_Possessed();
			MBFADDHOEOK_IsNew = LDEGEHAEALK.BEKHNNCGIEL_Costume.FABAGMLEKIB_CostumeList[JPIDIENBGKH_CostumeId - 1].CADENLBDAEB_IsNew;
			CPGDEPMPMFK_EpisodeUnlocked = false;
		...
		IHANGGCHPAL.KHEKNNFCAOI(_AHHJLDLAPAN_DivaId);
		HCDGELDHFHB();

	}

	// RVA: 0x14DFA1C Offset: 0x14DFA1C VA: 0x14DFA1C
	public void KHEKNNFCAOI(int _AHHJLDLAPAN_DivaId, int PAOGPLDOMMI_Level, int PDEEMMEHDPK_CostumeId, int KOHAAFNNBOE_ColorId, GCIJNCFDNON_SceneInfo AFBMEMCHJCL_MainScene, List<GCIJNCFDNON_SceneInfo> HDJOHAJPGBA_SubScene, bool LGNOCBFCAAK/* = false*/)
	{
		...
		if(!LGNOCBFCAAK)
		{
			FFKMJNHFFFL_Costume.KHEKNNFCAOI(_AHHJLDLAPAN_DivaId,PDEEMMEHDPK_CostumeId,0,false);
		}
		else
		{
			FFKMJNHFFFL_Costume.KHEKNNFCAOI(_AHHJLDLAPAN_DivaId,PDEEMMEHDPK_CostumeId,CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData,false);
		}
	...
	public bool OKDIEDCGODF(int _BCCHOBPJJKE_SceneId, bool ILBBPPMLLFM, KDMCFCBMAOI BBEBHGEHMMI, BLHOMPPGBMI NGMPDMCBNJB)
	{
		...
		{
			DEKKMGAFJCG_Diva.IFHCNLAODKG d = LDEGEHAEALK.DGCJCAHIAPP_Diva.JOGOEIEKIHP(_BCCHOBPJJKE_SceneId);
			if(d != null)
			{
				if(BBEBHGEHMMI == null)
					return false;
			...
			if(!ILBBPPMLLFM)
			{
				...
				saveDiva.PIGLAEFPNEK_MSlot = _BCCHOBPJJKE_SceneId;
				FGFIBOBAPIA_SceneId = _BCCHOBPJJKE_SceneId;
				AICGALGPFMO_NumBoard = 0;
				...
				{
					FFKMEFKOBHO_Mb = LDEGEHAEALK.PNLOINMCCKH_Scene.OPIBAPEGCLA[_BCCHOBPJJKE_SceneId - 1].PDNIFBEGMHC_Mb;
					PFCJIKGENEH_Sb = LDEGEHAEALK.PNLOINMCCKH_Scene.OPIBAPEGCLA[_BCCHOBPJJKE_SceneId - 1].EMOJHJGHJLN_Sb;
					AICGALGPFMO_NumBoard = LDEGEHAEALK.PNLOINMCCKH_Scene.OPIBAPEGCLA[_BCCHOBPJJKE_SceneId - 1].JPIPENJGGDD_Mlt;
				}
				HCDGELDHFHB();
	...
	public bool IFFMDJHENHB(int IMJIADPJJMM, int _BCCHOBPJJKE_SceneId, bool ILBBPPMLLFM, KDMCFCBMAOI BBEBHGEHMMI, BLHOMPPGBMI NGMPDMCBNJB)
	{
		...
		else
		{
			...
			DJICAKGOGFO_SubSceneIds[IMJIADPJJMM] = _BCCHOBPJJKE_SceneId;
			saveDiva.EBDNICPAFLB_SSlot[IMJIADPJJMM] = _BCCHOBPJJKE_SceneId;
			if(_BCCHOBPJJKE_SceneId == 0)
			{
				FGBKIPNGGJM_SubSceneMbs[IMJIADPJJMM] = null;
				GDJPNDKMKPG_SubSceneSbs[IMJIADPJJMM] = null;
			...
			{
				FGBKIPNGGJM_SubSceneMbs[IMJIADPJJMM] = LDEGEHAEALK.PNLOINMCCKH_Scene.OPIBAPEGCLA[_BCCHOBPJJKE_SceneId - 1].PDNIFBEGMHC_Mb;
				GDJPNDKMKPG_SubSceneSbs[IMJIADPJJMM] = LDEGEHAEALK.PNLOINMCCKH_Scene.OPIBAPEGCLA[_BCCHOBPJJKE_SceneId - 1].EMOJHJGHJLN_Sb;
				HHKFOOFPOJL_SubSceneNumBoard[IMJIADPJJMM] = LDEGEHAEALK.PNLOINMCCKH_Scene.OPIBAPEGCLA[_BCCHOBPJJKE_SceneId - 1].JPIPENJGGDD_Mlt;
			}
			HCDGELDHFHB();
			if(NGMPDMCBNJB != null && d != null && oldSlot != 0)
			{
	...
	public void CJBBDBGDFKJ(GCIJNCFDNON_SceneInfo PNLOINMCCKH, bool _FBBNPFFEJBN_Force/* = false*/)
	{
		bool a = false;
		if(PNLOINMCCKH != null)
		{
	...
	public void GIGDKIHBDHB(GCIJNCFDNON_SceneInfo PNLOINMCCKH, int IMJIADPJJMM, bool _FBBNPFFEJBN_Force/* = false*/)
	{
		if(_FBBNPFFEJBN_Force || (PNLOINMCCKH != null && DJICAKGOGFO_SubSceneIds[IMJIADPJJMM] == PNLOINMCCKH.BCCHOBPJJKE_SceneId))
		{
			DJICAKGOGFO_SubSceneIds[IMJIADPJJMM] = 0;
			FGBKIPNGGJM_SubSceneMbs[IMJIADPJJMM] = null;
			GDJPNDKMKPG_SubSceneSbs[IMJIADPJJMM] = null;
	...
	// public static int PFAGNJEPBCB(int _AHHJLDLAPAN_DivaId, int JPIDIENBGKH) { }
			...
			if (cosInfo.AHHJLDLAPAN_DivaId == _AHHJLDLAPAN_DivaId)
			{
				if(cosInfo.PPEGAKEIEGM_Enabled == 2)
				{
					if(cosInfo.DAJGPBLEEOB_ModelId == 1 || OJEBNBLHPNP)
					{
						...
						data.KHEKNNFCAOI(_AHHJLDLAPAN_DivaId, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, false);
            ...
            if (cos.AHHJLDLAPAN_DivaId == _AHHJLDLAPAN_DivaId)
			{
				if(cos.PPEGAKEIEGM_Enabled == 2)
				{
					...
					if(PFEPMCNHEMJ.EBDNICPAFLB_SSlot[0] != 0)
					{
						...
						{
							MMPBPOIFDAF_Scene.PMKOFEIONEG ss = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.PNLOINMCCKH_Scene.OPIBAPEGCLA.Find((MMPBPOIFDAF_Scene.PMKOFEIONEG IBDJFHFIIHN) =>
							{
								//0x14E475C
					...
					d.KHEKNNFCAOI(_AHHJLDLAPAN_DivaId, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, false);
					d.ODFBCANBLIJ(s);
