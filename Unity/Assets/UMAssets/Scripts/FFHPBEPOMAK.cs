...
public class FFHPBEPOMAK
{
	...
	public bool OKDIEDCGODF(int BCCHOBPJJKE, bool ILBBPPMLLFM, KDMCFCBMAOI BBEBHGEHMMI, BLHOMPPGBMI NGMPDMCBNJB)
	{
		...
		else
		{
			...
			if(!ILBBPPMLLFM)
			{
				...
				{
					FFKMEFKOBHO = LDEGEHAEALK.PNLOINMCCKH_Scene.OPIBAPEGCLA[BCCHOBPJJKE - 1].PDNIFBEGMHC_Mb;
					PFCJIKGENEH = LDEGEHAEALK.PNLOINMCCKH_Scene.OPIBAPEGCLA[BCCHOBPJJKE - 1].EMOJHJGHJLN;
					AICGALGPFMO = LDEGEHAEALK.PNLOINMCCKH_Scene.OPIBAPEGCLA[BCCHOBPJJKE - 1].JPIPENJGGDD_Mlt;
				}
				HCDGELDHFHB();
	...
	public bool IFFMDJHENHB(int IMJIADPJJMM, int BCCHOBPJJKE, bool ILBBPPMLLFM, KDMCFCBMAOI BBEBHGEHMMI, BLHOMPPGBMI NGMPDMCBNJB)
	{
		if(!BNFDBPPOAOE)
		{
			...
			FGBKIPNGGJM[IMJIADPJJMM] = null;
			GDJPNDKMKPG[IMJIADPJJMM] = null;
			HHKFOOFPOJL[IMJIADPJJMM] = 0;
		}
		else
		{
			DEKKMGAFJCG_Diva.IFHCNLAODKG d = LDEGEHAEALK.DGCJCAHIAPP_Diva.JOGOEIEKIHP(BCCHOBPJJKE);
			...
			{
				FGBKIPNGGJM[IMJIADPJJMM] = LDEGEHAEALK.PNLOINMCCKH_Scene.OPIBAPEGCLA[BCCHOBPJJKE - 1].PDNIFBEGMHC_Mb;
				GDJPNDKMKPG[IMJIADPJJMM] = LDEGEHAEALK.PNLOINMCCKH_Scene.OPIBAPEGCLA[BCCHOBPJJKE - 1].EMOJHJGHJLN;
				HHKFOOFPOJL[IMJIADPJJMM] = LDEGEHAEALK.PNLOINMCCKH_Scene.OPIBAPEGCLA[BCCHOBPJJKE - 1].JPIPENJGGDD_Mlt;
			}
			HCDGELDHFHB();
			if(NGMPDMCBNJB != null && d != null && oldSlot != 0)
			{
