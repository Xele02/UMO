...
public class FFHPBEPOMAK_DivaInfo
{
	...
	public void LEHDLBJJBNC()
	{
		...
		if(!BNFDBPPOAOE || JPIDIENBGKH_CostumeId == 0)
			return;
		CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.BEKHNNCGIEL_Costume.FABAGMLEKIB_List[JPIDIENBGKH_CostumeId - 1].CADENLBDAEB_IsNew = false;
	}
	...
	public void KHEKNNFCAOI(int _AHHJLDLAPAN_DivaId, BBHNACPENDM_ServerSaveData NIMOGBDCMLJ, bool OJEBNBLHPNP/* = false*/)
	{
		...
		PKLPGBKKFOL_DivaLevels = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[_AHHJLDLAPAN_DivaId - 1].ANAJIAENLNB_Levels;
		...
		FJODMPGPDDD_DivaHave = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[_AHHJLDLAPAN_DivaId - 1].CPGFPEDMDEH_Have != 0/* || RuntimeSettings.CurrentSettings.ForceDivaUnlock*/;
		IPJMPBANBPP_Enabled = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.MGFMPKLLGHE_Diva.CDENCMNHNGA_Divas[_AHHJLDLAPAN_DivaId - 1].PPEGAKEIEGM_Enabled == 2;
		CIEOBFIIPLD_Level = LDEGEHAEALK.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList[_AHHJLDLAPAN_DivaId - 1].OKMELNIIMMO_GetDivaLevel();
		AIHCEGFANAM_SerieAttr = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.MGFMPKLLGHE_Diva.CDENCMNHNGA_Divas[_AHHJLDLAPAN_DivaId - 1].AIHCEGFANAM_SerieAttr;
	...
	public void KHEKNNFCAOI(int _AHHJLDLAPAN_DivaId, int PAOGPLDOMMI_Level, int PDEEMMEHDPK_CostumeId, int KOHAAFNNBOE_ColorId, GCIJNCFDNON_SceneInfo AFBMEMCHJCL_MainScene, List<GCIJNCFDNON_SceneInfo> HDJOHAJPGBA_SubScene, bool LGNOCBFCAAK/* = false*/)
	{
		...
		BJPLLEBHAGO_DivaInfo d = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.MGFMPKLLGHE_Diva.CDENCMNHNGA_Divas[_AHHJLDLAPAN_DivaId-1];
			...
			if (cosInfo.AHHJLDLAPAN_DivaId == _AHHJLDLAPAN_DivaId)
			{
				if(cosInfo.PPEGAKEIEGM_Enabled == 2)
				{
					...
					else
					{
						...
						if (a == 0)
						{
							if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.BEKHNNCGIEL_Costume.FABAGMLEKIB_List[costumeId - 1].CGKAEMGLHNK_Possessed())
							{
								FFHPBEPOMAK_DivaInfo data = new FFHPBEPOMAK_DivaInfo();
								data.KHEKNNFCAOI(_AHHJLDLAPAN_DivaId, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, false);
								data.HOOJOFACOEK_SetCostume(cosInfo.JPIDIENBGKH_CostumeId, 0, true, OJEBNBLHPNP);
            ...
            if (cos.AHHJLDLAPAN_DivaId == _AHHJLDLAPAN_DivaId)
			{
				if(cos.PPEGAKEIEGM_Enabled == 2)
				{
					...
					else
					{
						...
						if(ep == 0)
						{
							if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.BEKHNNCGIEL_Costume.FABAGMLEKIB_List[cos.JPIDIENBGKH_CostumeId - 1].CGKAEMGLHNK_Possessed())
							{
								//LAB_014e36c4
							}
							else
					...
					//LAB_014e36c4
					AMCGONHBGGF PFEPMCNHEMJ = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.KMBJGAHCBDI_UnitGoDiva.ALDOJAEAMCJ(_AHHJLDLAPAN_DivaId, 0).FDBOPFEOENF_MainDivas[0];
