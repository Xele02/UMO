...
public class FFHPBEPOMAK_DivaInfo
{
	...
	public void KHEKNNFCAOI(int AHHJLDLAPAN_DivaId, BBHNACPENDM_ServerSaveData NIMOGBDCMLJ, bool OJEBNBLHPNP = false)
	{
		...
		AIHCEGFANAM_Serie = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.MGFMPKLLGHE_Diva.CDENCMNHNGA[AHHJLDLAPAN_DivaId - 1].AIHCEGFANAM_Attr;
	...
	public void HCDGELDHFHB()
	{
		...
		if(FGFIBOBAPIA_SceneId != 0)
		{
			CMCKNKKCNDK_EquippedStatus.Add(GCIJNCFDNON_SceneInfo.JPCAIAAOOLN(FGFIBOBAPIA_SceneId, FFKMEFKOBHO, PFCJIKGENEH, AICGALGPFMO, 0));
		}
		if(DJICAKGOGFO_SubSceneIds != null)
		{
			for(int i = 0; i < DJICAKGOGFO_SubSceneIds.Count; i++)
			{
				...
				{
					CMCKNKKCNDK_EquippedStatus.Add(GCIJNCFDNON_SceneInfo.JPCAIAAOOLN(DJICAKGOGFO_SubSceneIds[i], FGBKIPNGGJM[i], GDJPNDKMKPG[i], HHKFOOFPOJL[i], 0));
				}
			}
		}
	}
