...
public class GCIJNCFDNON_SceneInfo
{
	...
	{
		return (AOLIJKMIJJE_DivaCompatible & (1 << (_AHHJLDLAPAN_DivaId - 1))) != 0;
	}
	...
	public void JNNHIDMNBFG(string IDMLDEJMMED_Name/* = ""*/, int DMNIMMGGJJJ_Leaf/* = -1*/)
	{
		...
		{
			DMNIMMGGJJJ_Leaf = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.PNLOINMCCKH_Scene.OPIBAPEGCLA[BCCHOBPJJKE_SceneId - 1].DMNIMMGGJJJ_Leaf;
		}
	...
	public static int CGJCEHGFHMA(int BCCHOBPJJKE)
	{
		...
		MMPBPOIFDAF_Scene.PMKOFEIONEG saveScene = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.PNLOINMCCKH_Scene.OPIBAPEGCLA[BCCHOBPJJKE - 1];
