...
public class GCIJNCFDNON
{
		...
		if(KBOLNIBLIND == null)
		{
			if(IJIKIPDKCPP == 0)
			{
				...
				if(HGONFBDIBPM_ActiveSkillId != 0)
				{
					...
					BEKGEAMJGEN = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.FOFADHAENKC_Skill.PABCHCAAEAA[HGONFBDIBPM_ActiveSkillId - 1].JGNHOGKKPDM;
				}
	...
	public string PCMEMHPDABG(int CNLIAMIIJID, string HCAHCFGPJIF)
	{
		if (HGONFBDIBPM_ActiveSkillId == 0)
			return HCAHCFGPJIF;
		return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.FOFADHAENKC_Skill.PABCHCAAEAA[HGONFBDIBPM_ActiveSkillId - 1].KMFMGLENCJH(HCAHCFGPJIF, CNLIAMIIJID);
	}
