...
public class GCIJNCFDNON
{
	...
	public byte EKLIPGELKCL; // 0xC
	public byte JKGFBFPIMGA; // 0xD
	public bool JOKJBMJBLBB; // 0xE
	public sbyte JGJFIJOCPAG; // 0xF
	public SeriesAttr.Type AIHCEGFANAM; // 0x10
	...
	public int DDEDANKHHPN; // 0x54
	public int PNHJPCPFNFI; // 0x58
	public int AADFFCIDJCB; // 0x5C
	public int DHEFMEGKKDN; // 0x60
	public int FFDCGHDNDFJ; // 0x64
	...
	public int MJBODMOLOBC; // 0xA4
	public int CIEOBFIIPLD; // 0xA8
	public int MKHFCGPJPFI; // 0xAC
	...
	public StatusData CMCKNKKCNDK { get; private set; } = new StatusData(); // 0x98 CLCJNFNMNBH CNKGOPKANGF CHJGGLFGALP
