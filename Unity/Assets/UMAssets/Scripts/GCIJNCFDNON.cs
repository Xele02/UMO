...
public class GCIJNCFDNON_SceneInfo
{
	public enum HINAICIJJJC
	{
		...
		BPMNCMICDAF = 1,
		JIKCABGFIEG_2_Unlock = 2,
		LAHFPKEJLCA_3 = 3,
		LBODGCPCGHA_4 = 4,
	}

	public enum DLAMEBMGKDO_SkillType
	{
		DJECFFENCND_Active = 0,
		DFAPCDGNNPN_Center = 1,
		OONCLCEAICE_Live = 2,
	}
	...
	public DMPDJFAGCPN_BoardLayout DKFCPBEOBHB_Layout; // 0xC0
	public DMPDJFAGCPN_BoardLayout JCNIAPAJAOB; // 0xC4
	public DMPDJFAGCPN_BoardLayout IKBBCHGLLKB; // 0xC8
	...
	public string BGJNIABLBDB_get_description()
	{
	...
	{
		CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.PNLOINMCCKH_Scene.OPIBAPEGCLA_Scenes[BCCHOBPJJKE_SceneId - 1].LHMOAJAIJCO_is_new = false;
	}
	...
	public bool JFDLBEOGGID()
	{
		if((JKGFBFPIMGA_Rarity & 254) == 4 && JPIPENJGGDD_NumBoard > 0)
		{
			...
			{
				if (IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database != null && IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game != null)
					return JPIPENJGGDD_NumBoard < IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.GENHLFPKOEE(JKGFBFPIMGA_Rarity, MCCIFLKCNKO_Feed);
				return false;
			}
			return true;
		}
	...
	public int EMPEHJLBIKC(JLKEOGLJNOD_TeamInfo _MLAFAACKKBG_Unit)
	{
		int r = 0;
		foreach(var d in _MLAFAACKKBG_Unit.BCJEAJPLGMB_MainDivas)
		{
			if(d != null)
			{
	...
	private JNKEEAOKNCI_Skill PJNDCOJNILE_GetSkillDb()
	{
		...
		{
			return IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill;
		}
		return null;
	}
	...
	{
		if(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database != null && HCHBCMGPMNC_CenterSkillId > 0)
		{
			return (SkillSwitchPatternCondition.Type)IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.BNAPNENIMBO[HCHBCMGPMNC_CenterSkillId - 1].CHOFDPDFPDC_ConfigValue;
		}
		return SkillSwitchPatternCondition.Type.None;
	}

	// // RVA: 0x16ABE4C Offset: 0x16ABE4C VA: 0x16ABE4C
	public bool IFBJBPEBAFH_HasCenterSkillCondSerie(EONOEHOKBEB_Music _KKHIDFKKFJE_MusicData, bool HBPAFCLFCAL/* = false*/)
	{
		JNKEEAOKNCI_Skill s = PJNDCOJNILE_GetSkillDb();
		if (s != null)
		{
			int a = MEOOLHNNMHL_GetCenterSkillId(HBPAFCLFCAL, _KKHIDFKKFJE_MusicData == null ? 0 : _KKHIDFKKFJE_MusicData.FKDCCLPGKDK_JacketAttr, _KKHIDFKKFJE_MusicData == null ? 0 : _KKHIDFKKFJE_MusicData.AIHCEGFANAM_SerieAttr);
	...
	public SeriesAttr.Type COONMFMEDFJ_GetSerieAttr(EONOEHOKBEB_Music _EPMMNEFADAP_Music, bool HBPAFCLFCAL/* = false*/)
	{
		JNKEEAOKNCI_Skill s = PJNDCOJNILE_GetSkillDb();
		if(s != null)
		{
			int a = MEOOLHNNMHL_GetCenterSkillId(HBPAFCLFCAL, _EPMMNEFADAP_Music == null ? 0 : _EPMMNEFADAP_Music.FKDCCLPGKDK_JacketAttr, _EPMMNEFADAP_Music == null ? 0 : _EPMMNEFADAP_Music.AIHCEGFANAM_SerieAttr);
			HBDCPGLAPHH h = LGONDBKGPMH(s, a);
			if (h == null)
	...
	public bool JDAEAJNJBGI_IsMatchCenterSkillSerie(int _DLAEJOBELBH_MusicId)
	{
		...
		{
			music = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.IBPAFKKEKNK_Music.IAJLOELFHKC_GetMusicInfo(_DLAEJOBELBH_MusicId);
		}
	...
	// public bool JDAEAJNJBGI_IsMatchCenterSkillSerie(int _DLAEJOBELBH_MusicId, bool HBPAFCLFCAL) { }
	...
	public bool PKPCDAAHJGP_HasLiveSkillCondMusic()
	{
		...
		{
			return IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.PNJMFKFGIML_LiveSkills[FILPDDHMKEJ_GetLiveSkillId(false, 0, 0) - 1].CEFHDLLAPDH_MusicId > 0;
		}
		return false;
	}
	...
	public bool ADDCCPKEFOC_IsMatchLiveSkillMusic(int _DLAEJOBELBH_MusicId)
	{
		if (FILPDDHMKEJ_GetLiveSkillId(false, 0, 0) != 0)
		{
			return IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.PNJMFKFGIML_LiveSkills[FILPDDHMKEJ_GetLiveSkillId(false, IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.IBPAFKKEKNK_Music.EPMMNEFADAP_Music[_DLAEJOBELBH_MusicId - 1].FKDCCLPGKDK_JacketAttr, IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.IBPAFKKEKNK_Music.EPMMNEFADAP_Music[_DLAEJOBELBH_MusicId - 1].AIHCEGFANAM_SerieAttr) - 1].CEFHDLLAPDH_MusicId == _DLAEJOBELBH_MusicId;
		}
		return false;
	}

	// // RVA: 0x16ACB2C Offset: 0x16ACB2C VA: 0x16ACB2C
	public bool FCGHOLNFDDF_HasCenterSkillCondMusicAttr(EONOEHOKBEB_Music _EPMMNEFADAP_Music, bool HBPAFCLFCAL/* = false*/)
	{
		bool res = false;
		int a = MEOOLHNNMHL_GetCenterSkillId(HBPAFCLFCAL, _EPMMNEFADAP_Music == null ? 0 : _EPMMNEFADAP_Music.FKDCCLPGKDK_JacketAttr, _EPMMNEFADAP_Music == null ? 0 : _EPMMNEFADAP_Music.AIHCEGFANAM_SerieAttr);
		if(a != 0)
	...
	public GameAttribute.Type NNOLHKHJPFJ_GetCenterSkillMusicAttr(EONOEHOKBEB_Music _EPMMNEFADAP_Music, bool HBPAFCLFCAL/* = false*/)
	{
		int a = MEOOLHNNMHL_GetCenterSkillId(HBPAFCLFCAL, _EPMMNEFADAP_Music == null ? 0 : _EPMMNEFADAP_Music.FKDCCLPGKDK_JacketAttr, _EPMMNEFADAP_Music == null ? 0 : _EPMMNEFADAP_Music.AIHCEGFANAM_SerieAttr);
	...
	public bool KAFAAPEBCPD_IsMatchCenterSkillMusicAttr(int _DLAEJOBELBH_MusicId)
	{
		if(_DLAEJOBELBH_MusicId > 0)
		{
			EONOEHOKBEB_Music music = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.IBPAFKKEKNK_Music.IAJLOELFHKC_GetMusicInfo(_DLAEJOBELBH_MusicId);
			if (FCGHOLNFDDF_HasCenterSkillCondMusicAttr(music, false))
			{
				GameAttribute.Type a = 0;
				if (music != null)
					a = (GameAttribute.Type)music.FKDCCLPGKDK_JacketAttr;
	...
	public bool KAFAAPEBCPD_IsMatchCenterSkillMusicAttr(int _DLAEJOBELBH_MusicId, bool HBPAFCLFCAL/* = false*/)
	{
		if(_DLAEJOBELBH_MusicId > 0)
		{
			EONOEHOKBEB_Music m = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.IBPAFKKEKNK_Music.IAJLOELFHKC_GetMusicInfo(_DLAEJOBELBH_MusicId);
			if (FCGHOLNFDDF_HasCenterSkillCondMusicAttr(m, HBPAFCLFCAL))
			{
				return (int)NNOLHKHJPFJ_GetCenterSkillMusicAttr(m, false) == (m != null ? m.FKDCCLPGKDK_JacketAttr : 0);
			}
		}
		return true;
	}
	...
	public bool GOEFBDNFNAA_HasLiveSkillCondAttr()
	{
		...
		{
			return IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.PNJMFKFGIML_LiveSkills[FILPDDHMKEJ_GetLiveSkillId(false, 0, 0) - 1].NFIBKOACELP_Attr > 0 ||
				IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.PNJMFKFGIML_LiveSkills[FILPDDHMKEJ_GetLiveSkillId(true, 0, 0) - 1].NFIBKOACELP_Attr > 0;
		}
		return false;
	}
	...
	public GameAttribute.Type EOIGNOLJGDG_GetLiveSkillMusicAttr(int _DLAEJOBELBH_MusicId, bool GAMJCMKKHBM)
	{
		...
		if (FILPDDHMKEJ_GetLiveSkillId(false, 0, 0) != 0 || FILPDDHMKEJ_GetLiveSkillId(true, 0, 0) != 0)
		{
			...
			if(_DLAEJOBELBH_MusicId > 0)
			{
				b = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.IBPAFKKEKNK_Music.EPMMNEFADAP_Music[_DLAEJOBELBH_MusicId - 1].FKDCCLPGKDK_JacketAttr;
				c = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.IBPAFKKEKNK_Music.EPMMNEFADAP_Music[_DLAEJOBELBH_MusicId - 1].AIHCEGFANAM_SerieAttr;
			}
			int a = FILPDDHMKEJ_GetLiveSkillId(GAMJCMKKHBM, b, c);
			PPGHMBNIAEC p = new PPGHMBNIAEC();
			if(a > 0)
			{
				if(a <= IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.PNJMFKFGIML_LiveSkills.Count)
				{
					p = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.PNJMFKFGIML_LiveSkills[a - 1];
				}
			}
	...
	public bool JEDMBJEICBB_IsLiveSkillMatchAttr(int _DLAEJOBELBH_MusicId, bool GAMJCMKKHBM)
	{
		...
		{
			EONOEHOKBEB_Music m = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.IBPAFKKEKNK_Music.IAJLOELFHKC_GetMusicInfo(_DLAEJOBELBH_MusicId);
			return (int)EOIGNOLJGDG_GetLiveSkillMusicAttr(_DLAEJOBELBH_MusicId, GAMJCMKKHBM) == (m != null ? m.FKDCCLPGKDK_JacketAttr : 0);
		}
		return true;
	}
	...
	public void KHEKNNFCAOI_Init(int _PPFNGGCBJKC_id, byte[] _KBOLNIBLIND_unlock, byte[] _ODKMKEHJOCK_Sb, int _JPIPENJGGDD_NumBoard/* = 0*/, int _IELENGDJPHF_Ulk/* = 0*/, int _MJBODMOLOBC_luck/* = 0*/, bool _CADENLBDAEB_IsNew/* = false*/, long _NPHOIEOPIJO_Date/* = 0*/, int BLHGJPIFKCL_Leaf_/* = 0*/)
	{
		...
		BBHNACPENDM_ServerSaveData server = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData;
		...
		JGJFIJOCPAG_SceneAttr = s.FKDCCLPGKDK_JacketAttr;
	...
	public void JNNHIDMNBFG(string IDMLDEJMMED_Name/* = ""*/, int _DMNIMMGGJJJ_Leaf/* = -1*/)
	{
		...
		{
			_DMNIMMGGJJJ_Leaf = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.PNLOINMCCKH_Scene.OPIBAPEGCLA_Scenes[BCCHOBPJJKE_SceneId - 1].DMNIMMGGJJJ_Leaf;
		}
	...
	{
		return IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.ELKHCOEMNOJ_IsKira(BCCHOBPJJKE_SceneId, MKHFCGPJPFI_LimitOverCount, IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HDGOHBFKKDM_LimitOver);
	}
	...
	public void HCDGELDHFHB_UpdateStatus()
	{
		...
		MLIBEPGADJH_Scene.KKLDOOJBJMN s = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[BCCHOBPJJKE_SceneId - 1];
		...
		if(KBOLNIBLIND_unlock == null)
		{
			if(IJIKIPDKCPP == 0)
			{
				...
				if(a != 0)
				{
					DDEDANKHHPN_SkillLevel = s.MGKDKGOACDB_GetSkillLevel(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, null);
					DHEFMEGKKDN_CenterSkillRank = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.COLCPGFABLP_CenterSkills[a - 1].JGNHOGKKPDM;
				}
				if(b != 0)
				{
					DDEDANKHHPN_SkillLevel = s.MGKDKGOACDB_GetSkillLevel(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, KBOLNIBLIND_unlock);
					FFDCGHDNDFJ_CenterSkillRank2 = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.COLCPGFABLP_CenterSkills[b - 1].JGNHOGKKPDM;
				}
				if(HGONFBDIBPM_ActiveSkillId != 0)
				{
					PNHJPCPFNFI_ActiveSkillLevel = s.CMPJFHEFIND_GetActiveSkillLevel(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, KBOLNIBLIND_unlock);
					BEKGEAMJGEN_ActiveSkillRank = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.PABCHCAAEAA_ActiveSkills[HGONFBDIBPM_ActiveSkillId - 1].JGNHOGKKPDM;
				}
				int c = FILPDDHMKEJ_GetLiveSkillId(false, 0, 0);
				if(c != 0)
				{
					AADFFCIDJCB_LiveSkillLevel = s.BBGLLMIFPMA_GetLiveSkillLevel(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, KBOLNIBLIND_unlock);
					OAHMFMJIENM_LiveSkillRank = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.PNJMFKFGIML_LiveSkills[c - 1].JGNHOGKKPDM;
					BJJNCCGPBGN = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.PNJMFKFGIML_LiveSkills[c - 1].AOPELJFAMCL_LiveSkillType;
				}
				int d = FILPDDHMKEJ_GetLiveSkillId(true, 0, 0);
				if(d != 0)
				{
					AADFFCIDJCB_LiveSkillLevel = s.BBGLLMIFPMA_GetLiveSkillLevel(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, KBOLNIBLIND_unlock);
					ELNJADBILOM_LiveSkillRank2 = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.PNJMFKFGIML_LiveSkills[d - 1].JGNHOGKKPDM;
					BJJNCCGPBGN = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.PNJMFKFGIML_LiveSkills[d - 1].AOPELJFAMCL_LiveSkillType;
				}
			}
			else
			{
				CIEOBFIIPLD_Level = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.LAGGGIEIPEG(JKGFBFPIMGA_Rarity, IJIKIPDKCPP == 2, MCCIFLKCNKO_Feed) + 1;
				byte[] g = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.DNMKPAKOJFA(JKGFBFPIMGA_Rarity, IJIKIPDKCPP == 2, MCCIFLKCNKO_Feed);
				if (a != 0)
				{
					DDEDANKHHPN_SkillLevel = s.MGKDKGOACDB_GetSkillLevel(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, g);
					DHEFMEGKKDN_CenterSkillRank = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.COLCPGFABLP_CenterSkills[a - 1].JGNHOGKKPDM;
				}
				if(b != 0)
				{
				...
				if(HGONFBDIBPM_ActiveSkillId != 0)
				{
					PNHJPCPFNFI_ActiveSkillLevel = s.CMPJFHEFIND_GetActiveSkillLevel(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, g);
					BEKGEAMJGEN_ActiveSkillRank = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.PABCHCAAEAA_ActiveSkills[HGONFBDIBPM_ActiveSkillId - 1].JGNHOGKKPDM;
				}
				int c = FILPDDHMKEJ_GetLiveSkillId(false, 0, 0);
				if (c != 0)
				{
					AADFFCIDJCB_LiveSkillLevel = s.BBGLLMIFPMA_GetLiveSkillLevel(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, g);
					OAHMFMJIENM_LiveSkillRank = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.PNJMFKFGIML_LiveSkills[c - 1].JGNHOGKKPDM;
					BJJNCCGPBGN = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.PNJMFKFGIML_LiveSkills[c - 1].AOPELJFAMCL_LiveSkillType;
				}
				int d = FILPDDHMKEJ_GetLiveSkillId(true, 0, 0);
		...
		int f = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.GENHLFPKOEE(s.EKLIPGELKCL_Rarity, s.MCCIFLKCNKO_Feed);
		if (IJIKIPDKCPP == 2)
		{
			MJBODMOLOBC_luck = s.PKNGPIFNIGN(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, f, f);
		}
		else
		{
			MJBODMOLOBC_luck = s.AGOEDLNOHND(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, ODKMKEHJOCK_Sb, JPIPENJGGDD_NumBoard, f);
		}
	}
	...
	public static StatusData JPCAIAAOOLN(int _BCCHOBPJJKE_SceneId, byte[] _KBOLNIBLIND_unlock, byte[] _ODKMKEHJOCK_Sb, int _JPIPENJGGDD_NumBoard, int DPCIPDAECEA/* = 0*/)
	{
		...
		if(_BCCHOBPJJKE_SceneId == 0)
			return res;
		MLIBEPGADJH_Scene.KKLDOOJBJMN d = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[_BCCHOBPJJKE_SceneId - 1];
		if(_KBOLNIBLIND_unlock == null)
		{
			if(DPCIPDAECEA == 1)
			{
				res.life = d.CGMFEOFCKPA_GetLife(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.DNMKPAKOJFA(d.EKLIPGELKCL_Rarity, false, d.MCCIFLKCNKO_Feed));
				res.soul = d.ONBGNBDIGPF_GetSoul(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.DNMKPAKOJFA(d.EKLIPGELKCL_Rarity, false, d.MCCIFLKCNKO_Feed));
				res.vocal = d.DPDGKOBDBJF_GetVocal(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.DNMKPAKOJFA(d.EKLIPGELKCL_Rarity, false, d.MCCIFLKCNKO_Feed));
				res.charm = d.JEDMOOILJOJ_GetCharm(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.DNMKPAKOJFA(d.EKLIPGELKCL_Rarity, false, d.MCCIFLKCNKO_Feed));
				res.sceneBonus = 0;
			...
			else if(DPCIPDAECEA == 2)
			{
				...
				b.KHEKNNFCAOI_Init(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, d.AOPBAOJIOGO_Sb, 0, IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.GENHLFPKOEE(d.EKLIPGELKCL_Rarity, d.MCCIFLKCNKO_Feed), IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.GENHLFPKOEE(d.EKLIPGELKCL_Rarity, d.MCCIFLKCNKO_Feed), d.ILABPFOMEAG_Va, d.FKDCCLPGKDK_JacketAttr);
		...
		{
			res.life = d.CGMFEOFCKPA_GetLife(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, _KBOLNIBLIND_unlock);
			res.soul = d.ONBGNBDIGPF_GetSoul(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, _KBOLNIBLIND_unlock);
			res.vocal = d.DPDGKOBDBJF_GetVocal(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, _KBOLNIBLIND_unlock);
			res.charm = d.JEDMOOILJOJ_GetCharm(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, _KBOLNIBLIND_unlock);
			res.sceneBonus = 0;
			res.support = d.HCFOMFDPGEC_Support;
			res.fold = d.ONDFNOOICLE_Fold;
			res.spNoteExpected[d.FIHNJFKBKBD_NoteType] = d.FLGDCCFAGEL_NotesExpected;
			...
			if (d.ILABPFOMEAG_Va < 1)
				return res;
			KOGHKIODHPA_Board.ADPMJDMFEIK b = new KOGHKIODHPA_Board.ADPMJDMFEIK();
			b.KHEKNNFCAOI_Init(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, d.AOPBAOJIOGO_Sb, 0, _JPIPENJGGDD_NumBoard, IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.GENHLFPKOEE(d.EKLIPGELKCL_Rarity, d.MCCIFLKCNKO_Feed), d.ILABPFOMEAG_Va, d.FKDCCLPGKDK_JacketAttr);
	...
	public AFIFDLOAKGI LDGCIDPEMPG(int _OIPCCBHIKIA_index)
	{
		if(DKFCPBEOBHB_Layout != null)
		{
			if(_OIPCCBHIKIA_index < DKFCPBEOBHB_Layout.PDKGMFHIFML_Panels.Count)
			{
				...
				AFIFDLOAKGI a = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board.DDGNLCJGFJF_Object(n.JBGEEPFKIGG_val);
				if(a != null)
				{
	...
	public AFIFDLOAKGI CDDHNNLPOLG(int _OIPCCBHIKIA_index, int _ILABPFOMEAG_Va, int _JGJFIJOCPAG_SceneAttr)
	{
		MLIBEPGADJH_Scene.KKLDOOJBJMN dbscene = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[BCCHOBPJJKE_SceneId - 1];
		int a = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.GENHLFPKOEE(dbscene.EKLIPGELKCL_Rarity, dbscene.MCCIFLKCNKO_Feed);
		return IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board.PBINAHNEFIK(dbscene.AOPBAOJIOGO_Sb, _OIPCCBHIKIA_index, JPIPENJGGDD_NumBoard, a, _ILABPFOMEAG_Va, _JGJFIJOCPAG_SceneAttr);
	}
	...
	public HINAICIJJJC FAPMGGOMCOE(int _OIPCCBHIKIA_index)
	{
		...
		MLIBEPGADJH_Scene.KKLDOOJBJMN scene = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[BCCHOBPJJKE_SceneId - 1];
		AFIFDLOAKGI b = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board.BHMFCIIGKCB(scene.BJNBBEMBMIK_BoardId, _OIPCCBHIKIA_index);
		if(b != null && b.INDDJNMPONH_type != 0)
		{
			...
			return HINAICIJJJC.JIKCABGFIEG_2_Unlock/*2*/;
		}
	...
	public HINAICIJJJC OIEHPHINMIO(int _OIPCCBHIKIA_index)
	{
		MLIBEPGADJH_Scene.KKLDOOJBJMN dbscene = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[BCCHOBPJJKE_SceneId - 1];
		int a = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.GENHLFPKOEE(dbscene.EKLIPGELKCL_Rarity, dbscene.MCCIFLKCNKO_Feed);
		AFIFDLOAKGI b = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board.PBINAHNEFIK(dbscene.AOPBAOJIOGO_Sb, _OIPCCBHIKIA_index, JPIPENJGGDD_NumBoard, a, dbscene.ILABPFOMEAG_Va, dbscene.FKDCCLPGKDK_JacketAttr);
		if(b != null)
		{
	...
	public void EFLDHMMGALP(int _OIPCCBHIKIA_index, HINAICIJJJC _LHMDABPNDDH_state)
	{
		if(FAPMGGOMCOE(_OIPCCBHIKIA_index) != HINAICIJJJC.HJNNKCMLGFL_0_None && KBOLNIBLIND_unlock != null)
		{
			if (KBOLNIBLIND_unlock.Length <= (_OIPCCBHIKIA_index >> 3))
				return;
			if(_LHMDABPNDDH_state == HINAICIJJJC.JIKCABGFIEG_2_Unlock)
			{
	...
	public bool OEIFKIPOHME(int _OIPCCBHIKIA_index, int _HMFFHLPNMPH_count)
	{
		if (OIEHPHINMIO(_OIPCCBHIKIA_index) != HINAICIJJJC.LAHFPKEJLCA_3)
			return false;
		MLIBEPGADJH_Scene.KKLDOOJBJMN scene = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[BCCHOBPJJKE_SceneId - 1];
		MMPBPOIFDAF_Scene.PMKOFEIONEG scene2 = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.PNLOINMCCKH_Scene.OPIBAPEGCLA_Scenes[BCCHOBPJJKE_SceneId - 1];
		return scene2.LMLDPHIAOPH(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.GENHLFPKOEE(scene.EKLIPGELKCL_Rarity, MCCIFLKCNKO_Feed), _HMFFHLPNMPH_count);
	}
	...
	public int KPCLNEADGEM(int _OIPCCBHIKIA_index)
	{
		...
		if (a < HINAICIJJJC.LAHFPKEJLCA_3 || a > HINAICIJJJC.LBODGCPCGHA_4)
			return 0;
		MMPBPOIFDAF_Scene.PMKOFEIONEG scene = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.PNLOINMCCKH_Scene.OPIBAPEGCLA_Scenes[BCCHOBPJJKE_SceneId - 1];
		MLIBEPGADJH_Scene.KKLDOOJBJMN dbScene = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[BCCHOBPJJKE_SceneId - 1];
		int b = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.GENHLFPKOEE(dbScene.EKLIPGELKCL_Rarity, dbScene.MCCIFLKCNKO_Feed);
	...
	public int MCDPPBBLDKA(int _OIPCCBHIKIA_index)
	{
		if (OIEHPHINMIO(_OIPCCBHIKIA_index) < HINAICIJJJC.LAHFPKEJLCA_3/*3*/ || OIEHPHINMIO(_OIPCCBHIKIA_index) > HINAICIJJJC.LBODGCPCGHA_4/*4*/)
			return 0;
		return CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.PNLOINMCCKH_Scene.OPIBAPEGCLA_Scenes[BCCHOBPJJKE_SceneId - 1].CDOBCKMHAOK_inf;
	}
	...
	public int MEOOLHNNMHL_GetCenterSkillId(bool GAMJCMKKHBM, int _DEIHLMHACCH__Attribute/* = 0*/, int _LMLNKHMPOIG__Serie/* = 0*/)
	{
		if (HCHBCMGPMNC_CenterSkillId < 1)
			return 0;
		BMMNKCJOHOM a = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.BNAPNENIMBO[HCHBCMGPMNC_CenterSkillId - 1];
		bool b = false;
	...
	public string IHLINMFMCDN_GetCenterSkillDesc(int _CNLIAMIIJID_AbilityLevel, string _HCAHCFGPJIF_Desc, bool GAMJCMKKHBM/* = false*/)
	{
		...
		return IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.COLCPGFABLP_CenterSkills[MEOOLHNNMHL_GetCenterSkillId(GAMJCMKKHBM, 0, 0) - 1].KMFMGLENCJH_FormatDesc(_HCAHCFGPJIF_Desc, _CNLIAMIIJID_AbilityLevel);
	}
	...
	public string PCMEMHPDABG_GetActiveSkillDesc(int _CNLIAMIIJID_AbilityLevel, string _HCAHCFGPJIF_Desc)
	{
		if (HGONFBDIBPM_ActiveSkillId == 0)
			return _HCAHCFGPJIF_Desc;
		return IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.PABCHCAAEAA_ActiveSkills[HGONFBDIBPM_ActiveSkillId - 1].KMFMGLENCJH_FormatDesc(_HCAHCFGPJIF_Desc, _CNLIAMIIJID_AbilityLevel);
	}
	...
	{
		return IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.PNJMFKFGIML_LiveSkills[FILPDDHMKEJ_GetLiveSkillId(GAMJCMKKHBM, 0, 0) - 1].KMFMGLENCJH_FormatDesc(_HCAHCFGPJIF_Desc, _CNLIAMIIJID_AbilityLevel);
	}
	...
	public int FILPDDHMKEJ_GetLiveSkillId(bool GAMJCMKKHBM, int _DEIHLMHACCH__Attribute/* = 0*/, int _LMLNKHMPOIG__Serie/* = 0*/)
	{
		if (PLDALOJIFBE_LiveSkillId < 1)
			return 0;
		EDPDCLMMBPL a = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.KGKICLDOOKG[PLDALOJIFBE_LiveSkillId - 1];
		bool b = false;
		if(a.CHOFDPDFPDC_ConfigValue == 2)
		{
			b = (int)AIHCEGFANAM_SerieAttr == _LMLNKHMPOIG__Serie;
	...
	public SkillSwitchPatternCondition.Type GPLOOJCLNBL_GetLiveSkillSwitchPatternCond()
	{
		...
		{
			return (SkillSwitchPatternCondition.Type)IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.KGKICLDOOKG[PLDALOJIFBE_LiveSkillId - 1].CHOFDPDFPDC_ConfigValue;
		}
		return SkillSwitchPatternCondition.Type.None;
	}
	...
	{
		if(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database != null && PLDALOJIFBE_LiveSkillId > 0)
		{
			return IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.FOFADHAENKC_Skill.KGKICLDOOKG[PLDALOJIFBE_LiveSkillId - 1].CHOFDPDFPDC_ConfigValue != 0;
		}
		return false;
	}
	...
	{
		MLIBEPGADJH_Scene.KKLDOOJBJMN k = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[BCCHOBPJJKE_SceneId - 1];
		return k.NGGBHLCKJGO(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, KBOLNIBLIND_unlock, ODKMKEHJOCK_Sb, JPIPENJGGDD_NumBoard, IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.GENHLFPKOEE(k.EKLIPGELKCL_Rarity, k.MCCIFLKCNKO_Feed), CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.PNLOINMCCKH_Scene.OPIBAPEGCLA_Scenes[BCCHOBPJJKE_SceneId - 1].CDOBCKMHAOK_inf);
	}
	...
	public int FGMPFHOEPEL_GetNumUnlockedStory()
	{
		if (JKGFBFPIMGA_Rarity < 6)
			return 0;
		return IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[BCCHOBPJJKE_SceneId - 1].JGKOJEOLMIL_GetNumUnlockedStory(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, KBOLNIBLIND_unlock);
	}

	// // RVA: 0x16B2A54 Offset: 0x16B2A54 VA: 0x16B2A54
	public static int CGJCEHGFHMA(int _BCCHOBPJJKE_SceneId)
	{
		MLIBEPGADJH_Scene.KKLDOOJBJMN k = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[_BCCHOBPJJKE_SceneId - 1];
		MMPBPOIFDAF_Scene.PMKOFEIONEG saveScene = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.PNLOINMCCKH_Scene.OPIBAPEGCLA_Scenes[_BCCHOBPJJKE_SceneId - 1];
		return k.NGGBHLCKJGO(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, saveScene.PDNIFBEGMHC_Mb, saveScene.EMOJHJGHJLN_Sb, saveScene.JPIPENJGGDD_NumBoard, IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.GENHLFPKOEE(k.EKLIPGELKCL_Rarity, k.MCCIFLKCNKO_Feed), saveScene.CDOBCKMHAOK_inf);
	}
	...
	{
		MLIBEPGADJH_Scene.KKLDOOJBJMN s = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[_BCCHOBPJJKE_SceneId - 1];
		int i = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.GENHLFPKOEE(s.EKLIPGELKCL_Rarity, s.MCCIFLKCNKO_Feed);
		return s.NGGBHLCKJGO(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.DNMKPAKOJFA(_JKGFBFPIMGA_Rarity, OOCNLBJJBKI, s.MCCIFLKCNKO_Feed),
			IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HNMMJINNHII_Game.CEKGFNKJDCF(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.JEMMMJEJLNL_Board, Mathf.Min(_JPIPENJGGDD_NumBoard, i), (int)s.AOPBAOJIOGO_Sb, s.ILABPFOMEAG_Va, OOCNLBJJBKI ? 1 : 0 + _JKGFBFPIMGA_Rarity, s.MCCIFLKCNKO_Feed),
	...
	public bool KEJMFDLFIEO()
	{
		...
		{
			BENDGHHBHFN = scene.ANAJIAENLNB_lv;
	...
	public void OHJIKMCAOLE()
	{
		if(BPJEOPHAJPP_PrevTotalPoint < CGJCEHGFHMA())
		{
			...
			{
				OCLHKHAMDHF_Episode.JEHNEEBBDBO_EpisodeInfo ep = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.NGHJPEIKLJL_Episode.BBAJKJPKOHD_EpisodeList[scene.KELFCMEOPPM_EpisodeId - 1];
				int a = ep.OGDBKJKIGAJ_CurrentPoint;
				ep.MOACIBEKLEN(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MOLEPBNJAGE_Episode, CGJCEHGFHMA() - BPJEOPHAJPP_PrevTotalPoint, false);
				ILCCJNDFFOB.HHCJCDFCLOB_Instance.BBDKHAMANCB_Episode(scene.KELFCMEOPPM_EpisodeId, a, ep.OGDBKJKIGAJ_CurrentPoint, ep.EBIIIAELNAA_Step, JpStringLiterals.StringLiteral_10443, 0, 0);
			}
		}
		ILLPDLODANB.MOFIPNGNNPA(ILLPDLODANB.LOEGALDKHPL_ValueType.MCBICLJIJMK_42_DebutMission2PlateUpgrade, 2, false);
		CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.PNLOINMCCKH_Scene.OPIBAPEGCLA_Scenes[BCCHOBPJJKE_SceneId - 1].IDBDAPPJOND();
	}
	...
	public void EJLGAMEIMEG(MNDAMOGGJBJ KNAELKENHPF, List<int> FHHIONFFABP)
	{
		...
		ILCCJNDFFOB.HHCJCDFCLOB_Instance.NNAPCDMAAJM_Enhance(BCCHOBPJJKE_SceneId, scene.JPIPENJGGDD_NumBoard, BENDGHHBHFN, scene.ANAJIAENLNB_lv, l1, l2, KNAELKENHPF.PGGKBIIJOND, FHHIONFFABP);
	}
	...
	public int MNODFKEOPGK()
	{
		if (JKGFBFPIMGA_Rarity < 4)
			return 0;
		int res = 0;
		int a = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HDGOHBFKKDM_LimitOver.JNLLKKHJCAD(JKGFBFPIMGA_Rarity, MJBODMOLOBC_luck);
		...
		{
			if(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HDGOHBFKKDM_LimitOver.PIPHIPNEJCM[i].EKLIPGELKCL_Rarity == JKGFBFPIMGA_Rarity)
			{
				if (IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HDGOHBFKKDM_LimitOver.PIPHIPNEJCM[i].GNFJOONKCFH > a)
					return res;
				if (IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.HDGOHBFKKDM_LimitOver.PIPHIPNEJCM[i].GNFJOONKCFH > MKHFCGPJPFI_LimitOverCount)
					res++;
			}
		}
		return res;
