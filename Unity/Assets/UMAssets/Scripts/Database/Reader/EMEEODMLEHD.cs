...
public class JOEEBALPECG
{
	...
	public int NDFOAINJPIN_pos { get; set; } // 0x10 MJDPJMGBMAA CLKKCPLEKBC CLJOOFCICMO
	public int[] OGDLCNPFODO { get; set; } // 0x14 CHFPHOCONMF IKPNMPPCGDA GBOBCAKPDIA
	public string[] IPBHCLIHAPG_Msg { get; set; } // 0x18 PGDNLLBNAFF CBMCOGPJADM BAIGLALPKDE
}
public class EMEEODMLEHD
{
	...
	public static EMEEODMLEHD HEGEKFMJNCC(byte[] NIODCJLINJN)// 0x130947C
	{
		...
		for(int DKBBEHIHBEK_idx = 0; DKBBEHIHBEK_idx < res_readData.IDNFMKCJFDGLength; DKBBEHIHBEK_idx++)
		{
			...
			DKBBEHIHBEK_data.PPFNGGCBJKC_id = DKBBEHIHBEK_readData.BBPHAPFBFHK;
			...
			DKBBEHIHBEK_data.NDFOAINJPIN_pos = DKBBEHIHBEK_readData.LGEDAJAFHGG;
			...
			DKBBEHIHBEK_data.IPBHCLIHAPG_Msg = IPBHCLIHAPG_list.ToArray();
