...
public class MBBEDEBFEHK
{
	...
	public static MBBEDEBFEHK HEGEKFMJNCC(byte[] NIODCJLINJN)// 0xA2D1D0
	{
		...
		for(int KNCEIKIFAGD_idx = 0; KNCEIKIFAGD_idx < res_readData.ECIELLPPMPPLength; KNCEIKIFAGD_idx++)
		{
			...
			KNCEIKIFAGD_data.PPFNGGCBJKC_id = KNCEIKIFAGD_readData.BBPHAPFBFHK;
			KNCEIKIFAGD_data.IJEKNCDIIAE_mver = KNCEIKIFAGD_readData.OFMGALJGDAO;
			KNCEIKIFAGD_data.PLALNIIBLOF_en = KNCEIKIFAGD_readData.CFLMCGOJJJD;
			KNCEIKIFAGD_data.PDBPFJJCADD_open_at = KNCEIKIFAGD_readData.NJLJEKDBPCH;
			KNCEIKIFAGD_data.FDBNFFNFOND_close_at = KNCEIKIFAGD_readData.MAOAGDBDBIB;
