...
public class GEAAFPCHGFA
{
	...
	public uint[] JGOHPDKCJKB_rw { get; set; } // 0x10 HOBIJNCHJHA MJFPLENCCCP OKELMCNLMDD
	public uint BDJMFDKLHPM_s_id { get; set; } // 0x14 EOBCNECIOMH GFMBGPMJPLJ ENAMMCHJBDE
...
public class INBANFOPJLF
{
	...
	public int[] FOILNHKHHDF_pt { get; set; } // 0xC LNNCNOIGMGM FOFBHPJDHFO LHPMDDKPJDP
}
public class INMFBOOGCLB
{
	public uint FCEJJEPFIPH_rwid { get; set; } // 0x8 ACOJMMLFGOK LLLKCLJBPBL IBLEKPDKFDO
...
public class MHNEAKBPPDA
{
	...
	public static MHNEAKBPPDA HEGEKFMJNCC(byte[] NIODCJLINJN)// 0x195363C
	{
		...
		for(int LCLJDEHGMCO_idx = 0; LCLJDEHGMCO_idx < res_readData.BHHFEPOGOIGLength; LCLJDEHGMCO_idx++)
		{
			...
			LCLJDEHGMCO_data.PPFNGGCBJKC_id = LCLJDEHGMCO_readData.BBPHAPFBFHK;
			LCLJDEHGMCO_data.PLALNIIBLOF_en = LCLJDEHGMCO_readData.CFLMCGOJJJD;
			...
			LCLJDEHGMCO_data.JGOHPDKCJKB_rw = JGOHPDKCJKB_list.ToArray();

			LCLJDEHGMCO_data.BDJMFDKLHPM_s_id = LCLJDEHGMCO_readData.MJOCIHPPKNO;
			LCLJDEHGMCO_data.FPOMEEJFBIG_odr = LCLJDEHGMCO_readData.AEAKMMJLLDK;
			LCLJDEHGMCO_data.IJEKNCDIIAE_mver = LCLJDEHGMCO_readData.OFMGALJGDAO;
		...
		for(int ECPDOFEOIPA_idx = 0; ECPDOFEOIPA_idx < res_readData.CMAPNGGMDOILength; ECPDOFEOIPA_idx++)
		{
			...
			ECPDOFEOIPA_data.BDJMFDKLHPM_s_id = ECPDOFEOIPA_readData.MJOCIHPPKNO;
			...
			ECPDOFEOIPA_data.FOILNHKHHDF_pt = FOILNHKHHDF_list.ToArray();
		...
		for(int APHNKNGKKFC_idx = 0; APHNKNGKKFC_idx < res_readData.ILBKJACHOHMLength; APHNKNGKKFC_idx++)
		{
			...
			APHNKNGKKFC_data.FCEJJEPFIPH_rwid = APHNKNGKKFC_readData.LNHODOPAJIL;
			APHNKNGKKFC_data.AIHOJKFNEEN_itm = APHNKNGKKFC_readData.LHMHAFHMNFF;
			APHNKNGKKFC_data.BFINGCJHOHI_cnt = APHNKNGKKFC_readData.CLEEFGNMCEL;
