...
public class HMJNEBPFCKE
{
	...
	public uint GJDNBENICPF_vcid { get; set; } // 0xC HPJECMJNMPM AFNFOLBCEAH NAFMLADMAGK
...
public class ONPNHODCGFB
{
	...
	public static ONPNHODCGFB HEGEKFMJNCC(byte[] NIODCJLINJN)// 0xCAFF8C
	{
		...
		for(int IGBEFKKKMKJ_idx = 0; IGBEFKKKMKJ_idx < res_readData.LLDMPBONLLMLength; IGBEFKKKMKJ_idx++)
		{
			...
			IGBEFKKKMKJ_data.PPFNGGCBJKC_id = IGBEFKKKMKJ_readData.BBPHAPFBFHK;
			IGBEFKKKMKJ_data.GJDNBENICPF_vcid = IGBEFKKKMKJ_readData.HHBHJBIAAAD;
			IGBEFKKKMKJ_data.IJEKNCDIIAE_mver = IGBEFKKKMKJ_readData.OFMGALJGDAO;
			IGBEFKKKMKJ_data.PLALNIIBLOF_en = IGBEFKKKMKJ_readData.CFLMCGOJJJD;
			IGBEFKKKMKJ_data.DOOGFEGEKLG_max = IGBEFKKKMKJ_readData.GEJGMBBCFEE;
