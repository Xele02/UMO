...
public class EJLDLIODAID
{
	...
	public uint AGNHPHEJKMK_tgt { get; set; } // 0xC BCKMGEBHABF MNJIGLFFJAH MEHEHNALGIH
	public uint DHIPGHBJLIL_coef { get; set; } // 0x10 KPOCJEKICDF PEIEKKODNKE MHBDIGBDPNK
}
public class PCFOIOGMHHL
{
	...
	public uint[] JPFFIBCDCNJ_friend { get; set; } // 0x24 CMMMMFKLOEI PFHOLHLIENA LMMBLLEOLEI
	public static PCFOIOGMHHL HEGEKFMJNCC(byte[] NIODCJLINJN)// 0xCBF638
	{
		...
		res_data.FDBOPFEOENF_diva = FDBOPFEOENF_list.ToArray();
		...
		res_data.BPLOEAHOPFI_stamina = BPLOEAHOPFI_list.ToArray();
		...
		for(int OGGLMPCHEDD_idx = 0; OGGLMPCHEDD_idx < res_readData.IBLGLCALOMGLength; OGGLMPCHEDD_idx++)
		{
			...
			OGGLMPCHEDD_data.PPFNGGCBJKC_id = OGGLMPCHEDD_readData.BBPHAPFBFHK;
			OGGLMPCHEDD_data.AGNHPHEJKMK_tgt = OGGLMPCHEDD_readData.HLPHBGLMBIO;
			OGGLMPCHEDD_data.DHIPGHBJLIL_coef = OGGLMPCHEDD_readData.KBPBECKBGMH;
		...
		res_data.JPFFIBCDCNJ_friend = JPFFIBCDCNJ_list.ToArray();
