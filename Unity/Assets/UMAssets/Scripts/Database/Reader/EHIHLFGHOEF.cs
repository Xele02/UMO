...
public class EHIHLFGHOEF
{
	...
	public static EHIHLFGHOEF HEGEKFMJNCC(byte[] NIODCJLINJN)// 0x12EA1E4
	{
		...
		for(int AJJAKJEMCID_idx = 0; AJJAKJEMCID_idx < res_readData.HBPDIEOICJPLength; AJJAKJEMCID_idx++)
		{
			...
			AJJAKJEMCID_data.PPFNGGCBJKC_id = AJJAKJEMCID_readData.BBPHAPFBFHK;
			AJJAKJEMCID_data.FBFLDFMFFOH_rar = AJJAKJEMCID_readData.ODBPKGJPLMD;
			AJJAKJEMCID_data.JBGEEPFKIGG_val = AJJAKJEMCID_readData.KJFEBMBHKOC;
