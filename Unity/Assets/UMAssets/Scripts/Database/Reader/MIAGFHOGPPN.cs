...
public class NPBFADCGACE
{
	...
	public int DOOGFEGEKLG_max { get; set; } // 0x14 IKKMNBJGBJK AECMFIOFFJN NGOJJDOCIDG
...
public class JIABMKPKEOP
{
	...
	public int ODMJFHDIGLP_cnd { get; set; } // 0x18 DKHKAJOLLPE IEACLNIEABJ KEOPEEKGMDO
...
public class MIAGFHOGPPN
{
	...
	public static MIAGFHOGPPN HEGEKFMJNCC(byte[] NIODCJLINJN)// 0x1953F84
	{
		...
		for(int MMJDALHDALP_idx = 0; MMJDALHDALP_idx < res_readData.DECLAPPHHLJLength; MMJDALHDALP_idx++)
		{
			...
			MMJDALHDALP_data.PPFNGGCBJKC_id = MMJDALHDALP_readData.BBPHAPFBFHK;
			MMJDALHDALP_data.IJEKNCDIIAE_mver = MMJDALHDALP_readData.OFMGALJGDAO;
			MMJDALHDALP_data.PLALNIIBLOF_en = MMJDALHDALP_readData.CFLMCGOJJJD;
			MMJDALHDALP_data.DOOGFEGEKLG_max = MMJDALHDALP_readData.GEJGMBBCFEE;
		...
		for(int JNEJFDOCIDN_idx = 0; JNEJFDOCIDN_idx < res_readData.CMMCFMNDNAGLength; JNEJFDOCIDN_idx++)
		{
			...
			JNEJFDOCIDN_data.PPFNGGCBJKC_id = JNEJFDOCIDN_readData.BBPHAPFBFHK;
			...
			JNEJFDOCIDN_data.ODMJFHDIGLP_cnd = JNEJFDOCIDN_readData.NCIKNCJLFBI;
			...
			JNEJFDOCIDN_data.KFCIJBLDHOK_v1 = KFCIJBLDHOK_list.ToArray();
		...
		for(int FLDJCNDHENP_idx = 0; FLDJCNDHENP_idx < res_readData.NIIBHCNIBKJLength; FLDJCNDHENP_idx++)
		{
			...
			FLDJCNDHENP_data.PPFNGGCBJKC_id = FLDJCNDHENP_readData.BBPHAPFBFHK;
		...
		for(int KMAFAMDPEKG_idx = 0; KMAFAMDPEKG_idx < res_readData.HKEKGDIIMHOLength; KMAFAMDPEKG_idx++)
		{
			...
			KMAFAMDPEKG_data.PPFNGGCBJKC_id = KMAFAMDPEKG_readData.BBPHAPFBFHK;
