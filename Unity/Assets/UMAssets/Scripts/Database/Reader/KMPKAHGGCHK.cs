...
{
	public int PNDNJDMIKAN { get; set; } // 0x8 PECAMELOBCB PMOHAHMFELP CIMIIFHBEGB
	public int[] CBDOEDKIOJK_ev { get; set; } // 0xC CENBLPHOLKK COMDLMJJFFN MJNJNAHIJCO
}
...
{
	public int GNFJOONKCFH { get; set; } // 0x8 JGLANLMLCNL LOFPOONPOMC KEGADDBFANM
	public int GLCLFMGPMAN_ItemId { get; set; } // 0xC KCELNMGLKHH LNJAENEGDEL JHIDBGCHOKL
	public int ADPPAIPFHML_num { get; set; } // 0x10 LONDDHLNFBL LJMLHOOPGEM PHNIOCPOBGO
	public int ACGLMKEBMDL_uc { get; set; } // 0x14 EPENFLDKGJE ALOLFIJOOHG JDPCOMJIMHG
	public int FBFLDFMFFOH_rar { get; set; } // 0x18 LMKEDCAPLEE HNLMNIOMOLI CHHJKABBIBL
}
...
public class KMPKAHGGCHK
{
	...
	public static KMPKAHGGCHK HEGEKFMJNCC(byte[] NIODCJLINJN)// 0x1120554
	{
		...
		for(int GOKCDMKKCMD_idx = 0; GOKCDMKKCMD_idx < res_readData.LDCIJBPBLPPLength; GOKCDMKKCMD_idx++)
		{
			...
			GOKCDMKKCMD_data.CBDOEDKIOJK_ev = CBDOEDKIOJK_list.ToArray();
		...
		for(int PFGDBAIFLGL_idx = 0; PFGDBAIFLGL_idx < res_readData.FHDMFCBDPHALength; PFGDBAIFLGL_idx++)
		{
			...
			PFGDBAIFLGL_data.CBDOEDKIOJK_ev = CBDOEDKIOJK_list.ToArray();
		...
		for(int PPMOLKLDNLB_idx = 0; PPMOLKLDNLB_idx < res_readData.LCCFMDJBNABLength; PPMOLKLDNLB_idx++)
		{
			...
			PPMOLKLDNLB_data.GLCLFMGPMAN_ItemId = PPMOLKLDNLB_readData.MBBJMJAAODG;
			PPMOLKLDNLB_data.ADPPAIPFHML_num = PPMOLKLDNLB_readData.LFFMNLEJJMH;
			PPMOLKLDNLB_data.ACGLMKEBMDL_uc = PPMOLKLDNLB_readData.PAEGHLMNPNO;
			PPMOLKLDNLB_data.FBFLDFMFFOH_rar = PPMOLKLDNLB_readData.ODBPKGJPLMD;
