...
{
	public uint LJELGFAFGAB_so { get; set; } // 0x8 CJCOPPAFPKE APHFJDOOLCK KBEAJHMCGPM
	public uint KNEDJFLCCLN_vo { get; set; } // 0xC HJMKHFAHBIO DKJNGOIGJGH EOMMBJGKKJI
	public uint MBAMIOJNGBD_ch { get; set; } // 0x10 PJHOHPBOIDJ NJBKAFBFJML IGAFGHBHMIF
}
public class PBLHKFHDMGG
{
	...
	public static PBLHKFHDMGG HEGEKFMJNCC(byte[] NIODCJLINJN)// 0xCBD46C
	{
		...
		for(int HNKCJKLONLN_idx = 0; HNKCJKLONLN_idx < res_readData.NEKBFHJGJLLLength; HNKCJKLONLN_idx++)
		{
			...
			HNKCJKLONLN_data.LJELGFAFGAB_so = HNKCJKLONLN_readData.FHLKEIBOFNN;
			HNKCJKLONLN_data.KNEDJFLCCLN_vo = HNKCJKLONLN_readData.EGEFMJCLNDM;
			HNKCJKLONLN_data.MBAMIOJNGBD_ch = HNKCJKLONLN_readData.KDPKPOBKKMJ;
