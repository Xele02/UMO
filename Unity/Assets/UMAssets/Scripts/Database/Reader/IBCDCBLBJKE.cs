...
public class FGABLOBFLHC
{
	...
	public uint OCAMDLMPBGA_dv { get; set; } // 0xC JKDMAFHPKDJ DHOGDENEIOI DBDFNFLGDFN
	public uint LKMHPJKIFDN_md { get; set; } // 0x10 CJAAANEJOAK LAGBBLNKFFG OBHBLAIPBFO
	public uint DLAIGBEOGNN_ex { get; set; } // 0x14 ADEEDEMALFA KFHHLPALPDI PEPBOMHIJNH
...
{
	public int PGPGPJNBIOH_uid { get; set; } // 0x8 CAIBNHDMKJD CJEDGLPDJBN EKJKPIKJLJJ
...
public class IBCDCBLBJKE
{
	...
	public static IBCDCBLBJKE HEGEKFMJNCC(byte[] NIODCJLINJN)// 0x1211238
	{
		...
		for(int MDFBOCBCGGE_idx = 0; MDFBOCBCGGE_idx < res_readData.AMNNIENGDHILength; MDFBOCBCGGE_idx++)
		{
			...
			MDFBOCBCGGE_data.PPFNGGCBJKC_id = MDFBOCBCGGE_readData.BBPHAPFBFHK;
			MDFBOCBCGGE_data.OCAMDLMPBGA_dv = MDFBOCBCGGE_readData.DDMBKEJNPJK;
			MDFBOCBCGGE_data.LKMHPJKIFDN_md = MDFBOCBCGGE_readData.JLBMBKHBKBG;
			MDFBOCBCGGE_data.DLAIGBEOGNN_ex = MDFBOCBCGGE_readData.EHIBOEAILLI;
			MDFBOCBCGGE_data.PLALNIIBLOF_en = MDFBOCBCGGE_readData.CFLMCGOJJJD;
			MDFBOCBCGGE_data.IJEKNCDIIAE_mver = MDFBOCBCGGE_readData.OFMGALJGDAO;
		...
		for(int EIDOFLACDGH_idx = 0; EIDOFLACDGH_idx < res_readData.OAHKOBDODPGLength; EIDOFLACDGH_idx++)
		{
			...
			EIDOFLACDGH_data.MJMPANIBFED_pid = EIDOFLACDGH_readData.COPFAKAHEMN;
		...
		for(int HJPKLNPDDHN_idx = 0; HJPKLNPDDHN_idx < res_readData.PMHBCDENHAILength; HJPKLNPDDHN_idx++)
		{
			...
			HJPKLNPDDHN_data.PGPGPJNBIOH_uid = HJPKLNPDDHN_readData.LLJMKBDBIGN;
