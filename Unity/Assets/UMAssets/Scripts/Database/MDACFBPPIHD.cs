...
public class MDACFBPPIHD_PresentItem : DIHHCBACKGG_DbSection
{
	public class GPFDNMMCPHB
	{
		...
		public int PPFNGGCBJKC { get { return EHOIENNDEDH_IdCrypted ^ FBGGEFFJJHB_xor; } set { EHOIENNDEDH_IdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x130E3A0 DEMEPMAEJOO 0x130DEF4 HIGKAIDMOKN
		public int JBGEEPFKIGG { get { return ICKOHEDLEFP ^ FBGGEFFJJHB_xor; } set { ICKOHEDLEFP = value ^ FBGGEFFJJHB_xor; } } //0x130E438 OLOCMINKGON 0x130DF90 ABAFHIBFKCE
		public int PLALNIIBLOF { get { return HNJHPNPFAAN ^ FBGGEFFJJHB_xor; } set { HNJHPNPFAAN = value ^ FBGGEFFJJHB_xor; } } //0x130E4D0 JPCJNLHHIPE 0x130E02C JJFJNEJLBDG
		public int IJEKNCDIIAE { get { return GNGNIKNNCNH_MVerCrypted ^ FBGGEFFJJHB_xor; } set { GNGNIKNNCNH_MVerCrypted = value ^ FBGGEFFJJHB_xor; } } //0x130E568 KJIMMIBDCIL 0x130E0C8 DMEGNOKIKCD
	...
	{
		LGCNKCBKJBA parser = LGCNKCBKJBA.HEGEKFMJNCC(_DBBGALAPFGC_Data);
