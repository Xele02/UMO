...
public class LAEGMENIEDB_Story : DIHHCBACKGG_DbSection
{
	public class ALGOILKGAAH
	{
		...
		public int LFLLLOPAKCO_Id { get { return KFAJGFGFFPJ ^ FBGGEFFJJHB; } set { KFAJGFGFFPJ = value ^ FBGGEFFJJHB; } } //0xD8F13C ELEKBNDPLGB 0xD8F758 HDKGOIOBCFI
		...
		public int KLCIIHKFPPO_StoryMusicId { get { return HKILOJEJAIH ^ FBGGEFFJJHB; } set { HKILOJEJAIH = value ^ FBGGEFFJJHB; } } //0xD8EF8C CPDGCNILCII 0xD8F778 IILKMGEKOBG
		...
		public int JIHMAJENMDO_MinLevel { get { return EGFIMHJIFKP ^ FBGGEFFJJHB; } set { EGFIMHJIFKP = value ^ FBGGEFFJJHB; } } //0xD8FA40 OBBAHPDEEFA 0xD8F7A8 HPJAHFOODLM
		...
		public int ICKPLIABPKC_FreeMusicId { get { return BKHDKHFBAPG ^ FBGGEFFJJHB; } set { BKHDKHFBAPG = value ^ FBGGEFFJJHB; } } //0xD8FA60 DMHPENAMNJH 0xD8F7C8 NDFINNLJJMF
		public int JOPNDOKOIHI_Difficulty { get { return MLFBNJDFNAO ^ FBGGEFFJJHB; } set { MLFBNJDFNAO = value ^ FBGGEFFJJHB; } } //0xD8FA70 MGFAKJJGIKL 0xD8F7D8 DKMKKNDBDPC
		public int GGOCFLLMHPH_Rank { get { return DHNEKDEDIND ^ FBGGEFFJJHB; } set { DHNEKDEDIND = value ^ FBGGEFFJJHB; } } //0xD8FA80 PFBGJGDACNP 0xD8F7E8 GDLDINAMCOP
		public int OMMEPCGNHFM_FreeMusicId2 { get { return MMBAHPBKNDN ^ FBGGEFFJJHB; } set { MMBAHPBKNDN = value ^ FBGGEFFJJHB; } } //0xD8EF7C DEKIKCKDFME 0xD8F7F8 MDFDOBGMHKL
	...
	public int JOHMIPPKPPM_GetStoryUnlockingMusic(int GHBPLHBNMBK)
	{
		for(int i = 0; i < CDENCMNHNGA.Count; i++)
		{
			if(CDENCMNHNGA[i].PPEGAKEIEGM_Enabled == 2)
			{
				if(CDENCMNHNGA[i].OMMEPCGNHFM_FreeMusicId2 == GHBPLHBNMBK)
				{
					return CDENCMNHNGA[i].LFLLLOPAKCO_Id;
				}
			}
		}
		return 0;
	...
	public override bool IIEMACPEEBJ(byte[] DBBGALAPFGC)
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			...
			data.FBGGEFFJJHB = k;
			data.LFLLLOPAKCO_Id = (int)array[i].PPFNGGCBJKC;
