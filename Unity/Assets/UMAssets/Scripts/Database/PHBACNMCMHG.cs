...
public class PHBACNMCMHG_EventCollection : DIHHCBACKGG_DbSection
{
	public class IHCDILMMOJM
	{
		...
		public string OCDMGOGMHGE { get { return EBGIDCIIGDO.DNJEJEANJGL_Value; } set { EBGIDCIIGDO.DNJEJEANJGL_Value = value; } } //0x16CF088 HBAAAKFHDBB 0x16CD898 NHJLJOIPOFK
	...
	public class ALBKHBLGHHN
	{
		...
		public int CNKFPJCGNFE { get { return FMDDJNKEBBB_Crypted ^ FBGGEFFJJHB; } set { FMDDJNKEBBB_Crypted = value ^ FBGGEFFJJHB; } } //0x16CEFCC GJBOGOFHGNP 0x16CEFDC GJDGIDCMJMH
		public int GNFBMCGMCFO { get { return MDKGAAMBJDJ_Crypted ^ FBGGEFFJJHB; } set { MDKGAAMBJDJ_Crypted = value ^ FBGGEFFJJHB; } } //0x16CEFEC NCIMMDJLPLJ 0x16CEFFC HNAJAFBHOLM
		public int BFFGFAMJAIG { get { return GGEBNMPPEID_Crypted ^ FBGGEFFJJHB; } set { GGEBNMPPEID_Crypted = value ^ FBGGEFFJJHB; } } //0x16CF00C PKMNOMELPMN 0x16CF01C IABBJBAHKCE
	...
	public class MAPOMNOALHJ
	{
		...
		public int GNFBMCGMCFO { get { return MDKGAAMBJDJ_Crypted ^ FBGGEFFJJHB; } set { MDKGAAMBJDJ_Crypted = value ^ FBGGEFFJJHB; } } //0x16CF428 NCIMMDJLPLJ 0x16CF438 HNAJAFBHOLM
		public int BFFGFAMJAIG { get { return GGEBNMPPEID_Crypted ^ FBGGEFFJJHB; } set { GGEBNMPPEID_Crypted = value ^ FBGGEFFJJHB; } } //0x16CF448 PKMNOMELPMN 0x16CF458 IABBJBAHKCE
	...
	public class ABGNMIEBCDN
	{
		...
		public int KHPHAAMGMJP { get { return HHEEHHHLKHC_Crypted ^ FBGGEFFJJHB; } set { HHEEHHHLKHC_Crypted = value ^ FBGGEFFJJHB; } } //0x16CEEE4 ABFDDKBBPCH 0x16CEEF4 MHDOIIEMDEH
		public int OFIAENKCJME { get { return LGAIHLFAPDC_Crypted ^ FBGGEFFJJHB; } set { LGAIHLFAPDC_Crypted = value ^ FBGGEFFJJHB; } } //0x16CEF04 KADLAKFANGA 0x16CEF14 AIDAPNCEPOB
	...
	public class PFGFDNLGPKP
	{
		...
		public int GLCLFMGPMAN { get { return AHGCGHAAHOO_Crypted ^ FBGGEFFJJHB; } set { AHGCGHAAHOO_Crypted = value ^ FBGGEFFJJHB; } } //0x16CF478 LNJAENEGDEL 0x16CDE3C JHIDBGCHOKL
		public int HMFFHLPNMPH { get { return HLMAFFLCCKD_Crypted ^ FBGGEFFJJHB; } set { HLMAFFLCCKD_Crypted = value ^ FBGGEFFJJHB; } } //0x16CF488 NJOGDDPICKG 0x16CDE4C NBBGMMBICNA
		public int NMKEOMCMIPP { get { return JCCHHFPCACO_Crypted ^ FBGGEFFJJHB; } set { JCCHHFPCACO_Crypted = value ^ FBGGEFFJJHB; } } //0x16CF498 EKDBBLNLMBC 0x16CDE5C LJHKEDCGLPO
		public bool PJPDOCNJNGJ { get { return HJAFPEBIBOP_Cryped == 117; } set { HJAFPEBIBOP_Cryped = value ? 117 : 85; } } //0x16CF4A8 MBEBLALDBHJ 0x16CDE6C ENPODKCLKMC
	...
	public class GBBANJEDBOP
	{
		...
		public int DNBFMLBNAEE { get { return AADPAJOLEEF_Crypted ^ FBGGEFFJJHB; } set { AADPAJOLEEF_Crypted = value ^ FBGGEFFJJHB; } } //0x16CF050 JKHIIAEMMDE 0x16CDE18 PFFKLBLEPKB
	...
	{
		NGHKJOEDLIP.OBGBAOLONDD = (int)OPHJCBPIPLM.HMBHNLCFDIH.OBGBAOLONDD;
		NGHKJOEDLIP.OPFGFINHFCE = OPHJCBPIPLM.HMBHNLCFDIH.OPFGFINHFCE;
		...
		NGHKJOEDLIP.BONDDBOFBND = OPHJCBPIPLM.HMBHNLCFDIH.BONDDBOFBND;
		NGHKJOEDLIP.EHHFFKAFOMC = OPHJCBPIPLM.HMBHNLCFDIH.EHHFFKAFOMC;
		NGHKJOEDLIP.HPNOGLIFJOP = OPHJCBPIPLM.HMBHNLCFDIH.HPNOGLIFJOP;
		...
		NGHKJOEDLIP.KNLGKBBIBOH = OPHJCBPIPLM.HMBHNLCFDIH.KNLGKBBIBOH;
		NGHKJOEDLIP.JBFDHOIKAIK = OPHJCBPIPLM.HMBHNLCFDIH.JBFDHOIKAIK;
		...
		NGHKJOEDLIP.OCDMGOGMHGE = OPHJCBPIPLM.HMBHNLCFDIH.OCDMGOGMHGE;
		NGHKJOEDLIP.PJBILOFOCIC = OPHJCBPIPLM.HMBHNLCFDIH.PJBILOFOCIC;
		NGHKJOEDLIP.MJBKGOJBPAD = OPHJCBPIPLM.HMBHNLCFDIH.MJBKGOJBPAD;
		...
		NGHKJOEDLIP.FEMMDNIELFC = OPHJCBPIPLM.HMBHNLCFDIH.FEMMDNIELFC;
		NGHKJOEDLIP.HKKNEAGCIEB = (sbyte)OPHJCBPIPLM.HMBHNLCFDIH.HKKNEAGCIEB;
		NGHKJOEDLIP.HIOOGLEJBKM = OPHJCBPIPLM.HMBHNLCFDIH.HIOOGLEJBKM;
		NGHKJOEDLIP.FJCADCDNPMP = OPHJCBPIPLM.HMBHNLCFDIH.FJCADCDNPMP;
		NGHKJOEDLIP.EJBGHLOOLBC = OPHJCBPIPLM.HMBHNLCFDIH.EJBGHLOOLBC;
	...
	private bool GPEKKMGGBPF(HMNJADGBKFA OPHJCBPIPLM)
	{
		...
		for(int i = 0; i < array.Length; i++)
		{
			...
			d.DNBFMLBNAEE = (int)array[i].FOILNHKHHDF;
			...
			for(int j = 0; j < array[i].AIHOJKFNEEN.Length; j++)
			{
				...
				d2.GLCLFMGPMAN = array[i].AIHOJKFNEEN[j];
				d2.HMFFHLPNMPH = (int)array[i].BFINGCJHOHI[j];
				d2.NMKEOMCMIPP = (int)array[i].JJHPDDPKBHF[j];
				d2.PJPDOCNJNGJ = array[i].HJAFPEBIBOP[j] != 0;
