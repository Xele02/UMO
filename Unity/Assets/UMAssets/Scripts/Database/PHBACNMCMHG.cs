...
public class PHBACNMCMHG_Event { }
public class PHBACNMCMHG_EventCollection : DIHHCBACKGG_DbSection
{
	public class IHCDILMMOJM
	{
		...
		public string FEMMDNIELFC; // 0x20
		public long BONDDBOFBND; // 0x28
		public long EHHFFKAFOMC; // 0x30
		public long HPNOGLIFJOP; // 0x38
		...
		public int HIOOGLEJBKM; // 0xAC
		public int FJCADCDNPMP; // 0xB0
		public int[] EJBGHLOOLBC; // 0xB4
		public List<int> EEOGPJJCKHH = new List<int>(); // 0xB8

		//public string OCDMGOGMHGE { get; set; } 0x16CF088 HBAAAKFHDBB 0x16CD898 NHJLJOIPOFK
		//public string PJBILOFOCIC { get; set; } 0x16CF0B4 NOEFEAIFHCL 0x16CD8CC GJIJFGNONEL
	...
	public class ALBKHBLGHHN
	{
		...
		//public int PPFNGGCBJKC { get; set; } 0x16CEFAC DEMEPMAEJOO 0x16CEFBC HIGKAIDMOKN
		//public int CNKFPJCGNFE { get; set; } 0x16CEFCC GJBOGOFHGNP 0x16CEFDC GJDGIDCMJMH
		//public int GNFBMCGMCFO { get; set; } 0x16CEFEC NCIMMDJLPLJ 0x16CEFFC HNAJAFBHOLM
		//public int BFFGFAMJAIG { get; set; } 0x16CF00C PKMNOMELPMN 0x16CF01C IABBJBAHKCE
	...
	public class MAPOMNOALHJ
	{
		...
		//public int PPFNGGCBJKC { get; set; } 0x16CF408 DEMEPMAEJOO 0x16CF418 HIGKAIDMOKN
		//public int GNFBMCGMCFO { get; set; } 0x16CF428 NCIMMDJLPLJ 0x16CF438 HNAJAFBHOLM
		//public int BFFGFAMJAIG { get; set; } 0x16CF448 PKMNOMELPMN 0x16CF458 IABBJBAHKCE
	...
	public class ABGNMIEBCDN
	{
		...
		//public int KHPHAAMGMJP { get; set; } 0x16CEEE4 ABFDDKBBPCH 0x16CEEF4 MHDOIIEMDEH
		//public int OFIAENKCJME { get; set; } 0x16CEF04 KADLAKFANGA 0x16CEF14 AIDAPNCEPOB
	...
	public class PFGFDNLGPKP
	{
		...
		public int HLMAFFLCCKD; // 0x10
		public int JCCHHFPCACO; // 0x14
		public bool JOPPFEHKNFO; // 0x18
		private int HJAFPEBIBOP; // 0x1C

		//public int GLCLFMGPMAN { get; set; } 0x16CF478 LNJAENEGDEL 0x16CDE3C JHIDBGCHOKL
		//public int HMFFHLPNMPH { get; set; } 0x16CF488 NJOGDDPICKG 0x16CDE4C NBBGMMBICNA
		//public int NMKEOMCMIPP { get; set; } 0x16CF498 EKDBBLNLMBC 0x16CDE5C LJHKEDCGLPO
		//public bool PJPDOCNJNGJ { get; set; } 0x16CF4A8 MBEBLALDBHJ 0x16CDE6C ENPODKCLKMC
	...
	public class GBBANJEDBOP
	{
		...
		public List<PFGFDNLGPKP> AHJNPEAMCCH = new List<PFGFDNLGPKP>(); // 0x18

		//public int PPFNGGCBJKC { get; set; } 0x16CF040 DEMEPMAEJOO 0x16CDE08 HIGKAIDMOKN
		//public int DNBFMLBNAEE { get; set; } 0x16CF050 JKHIIAEMMDE 0x16CDE18 PFFKLBLEPKB
	...
	public List<GBBANJEDBOP> FCIPEDFHFEM = new List<GBBANJEDBOP>(); // 0x24
	public List<LLFNMNJGLNL> IJJHFGOIDOK = new List<LLFNMNJGLNL>(); // 0x28
	//public List<AKIIJBEJOEP> NNMPGOAGEOL = new List<AKIIJBEJOEP>(); // 0x2C
	public List<ALBKHBLGHHN> GEGAEDDGNMA = new List<ALBKHBLGHHN>(); // 0x30
	public List<MAPOMNOALHJ> OGMHMAGDNAM = new List<MAPOMNOALHJ>(); // 0x34
	public List<ABGNMIEBCDN> LHAKGDAGEMM = new List<ABGNMIEBCDN>(); // 0x38
	...
	{
		TodoLogger.Log(TodoLogger.Database, "PHBACNMCMHG_EventCollection.KMBPACJNEOF");
	}

	// RVA: 0x16CB9A8 Offset: 0x16CB9A8 VA: 0x16CB9A8 Slot: 9
	public override bool IIEMACPEEBJ(byte[] DBBGALAPFGC)
	{
		TodoLogger.Log(TodoLogger.Database, "PHBACNMCMHG_EventCollection.IIEMACPEEBJ");
		return true;
	}
	...
	{
		TodoLogger.Log(TodoLogger.DbIntegrityCheck, "PHBACNMCMHG_EventCollection.CAOGDCBPBAN");
		return 0;
	}
}
