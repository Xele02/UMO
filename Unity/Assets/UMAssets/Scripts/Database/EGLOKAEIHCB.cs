...
public class EGLOKAEIHCB_LimitedItem : DIHHCBACKGG_DbSection
{
	public class DEOCBHAGEEH
	{
		...
		public int PPFNGGCBJKC { get { return EHOIENNDEDH_IdCrypted ^ FBGGEFFJJHB_xor; } set { EHOIENNDEDH_IdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x1C50B4C DEMEPMAEJOO 0x1C5035C HIGKAIDMOKN
		public int DMEDKJPOLCH_Category { get { return HNNLOMMFHEN ^ FBGGEFFJJHB_xor; } set { HNNLOMMFHEN = value ^ FBGGEFFJJHB_xor; } } //0x1C50BE4 IPKCKAAEEOE 0x1C503F8 JOGLLINFLJN
		public int JBGEEPFKIGG { get { return ICKOHEDLEFP ^ FBGGEFFJJHB_xor; } set { ICKOHEDLEFP = value ^ FBGGEFFJJHB_xor; } } //0x1C50C7C OLOCMINKGON 0x1C50494 ABAFHIBFKCE
		public int DOOGFEGEKLG_Max { get { return LCGJKAGIFGO ^ FBGGEFFJJHB_xor; } set { LCGJKAGIFGO = value ^ FBGGEFFJJHB_xor; } } //0x1C50D14 AECMFIOFFJN 0x1C50530 NGOJJDOCIDG
		public int PLALNIIBLOF { get { return HNJHPNPFAAN ^ FBGGEFFJJHB_xor; } set { HNJHPNPFAAN = value ^ FBGGEFFJJHB_xor; } } //0x1C50DAC JPCJNLHHIPE 0x1C505CC JJFJNEJLBDG
		public int IJEKNCDIIAE { get { return GNGNIKNNCNH_MVerCrypted ^ FBGGEFFJJHB_xor; } set { GNGNIKNNCNH_MVerCrypted = value ^ FBGGEFFJJHB_xor; } } //0x1C50E44 KJIMMIBDCIL 0x1C50668 DMEGNOKIKCD
		...
		public int EILKGEADKGH_Order { get { return HHPFFPINGAA ^ FBGGEFFJJHB_xor; } set { HHPFFPINGAA = value ^ FBGGEFFJJHB_xor; } } //0x1C50F74 NPDDACIHBKD 0x1C507A0 BJJMCKHBPNH
	...
	{
		KNJFLGCKEIF parser = KNJFLGCKEIF.HEGEKFMJNCC(_DBBGALAPFGC_Data);
