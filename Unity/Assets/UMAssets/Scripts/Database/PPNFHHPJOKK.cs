...
public class PPNFHHPJOKK_SpItem : DIHHCBACKGG_DbSection
{
	public class JBBIPIAABOJ
	{
		...
		public int PPFNGGCBJKC_Id { get { return EHOIENNDEDH ^ FBGGEFFJJHB; } set { EHOIENNDEDH = value ^ FBGGEFFJJHB; } } //0xDF8948 DEMEPMAEJOO 0xDF8210 HIGKAIDMOKN
		...
		public int EILKGEADKGH_Order { get { return HHPFFPINGAA ^ FBGGEFFJJHB; } set { HHPFFPINGAA = value ^ FBGGEFFJJHB; } } //0xDF8CD8 NPDDACIHBKD 0xDF8654 BJJMCKHBPNH
