...
public class LLKLAKGKNLD_LimitOver : DIHHCBACKGG_DbSection
{
	...
	public class ENKHACHPPFA
	{
		...
		public int DNLHENCICKD_Crypted; // 0x10
		public int MMEINLBEOMK_Crypted; // 0x14
		public int EAJCFBCHIFB_Crypted; // 0x18

		public int GNFJOONKCFH { get { return PLNGGLJCGNM_Crypted ^ FBGGEFFJJHB; } set { PLNGGLJCGNM_Crypted = value ^ FBGGEFFJJHB; } } //0x18106E8 LOFPOONPOMC 0x180FDF8 KEGADDBFANM
		public int GLCLFMGPMAN { get { return AHGCGHAAHOO_ItemIdCrypted ^ FBGGEFFJJHB; } set { AHGCGHAAHOO_ItemIdCrypted = value ^ FBGGEFFJJHB; } } //0x1810780 LNJAENEGDEL 0x180FE94 JHIDBGCHOKL
		public int ACGLMKEBMDL_Uc { get { return DNLHENCICKD_Crypted ^ FBGGEFFJJHB; } set { DNLHENCICKD_Crypted = value ^ FBGGEFFJJHB; } } //0x1810818 ALOLFIJOOHG 0x180FFCC JDPCOMJIMHG
		public int ADPPAIPFHML_Num { get { return MMEINLBEOMK_Crypted ^ FBGGEFFJJHB; } set { MMEINLBEOMK_Crypted = value ^ FBGGEFFJJHB; } } //0x18108B0 LJMLHOOPGEM 0x180FF30 PHNIOCPOBGO
		public int EKLIPGELKCL { get { return EAJCFBCHIFB_Crypted ^ FBGGEFFJJHB; } set { EAJCFBCHIFB_Crypted = value ^ FBGGEFFJJHB; } } //0x1810948 OEEHBGECGKL 0x1810068 GHLMHLJJBIG
