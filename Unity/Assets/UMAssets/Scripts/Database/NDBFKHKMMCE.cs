...
public class NDBFKHKMMCE : DIHHCBACKGG
{
	...
	// public List<NDBFKHKMMCE.EHLEEEBJLAM> GJLHEJPHEDA; // 0x20
	// public List<NDBFKHKMMCE.NIBEBIGPKLA> GHOLIPLDMPJ; // 0x24
	// public List<NDBFKHKMMCE.FIDBAFHNGCF> GMONECJCJFK; // 0x28
	// public List<NDBFKHKMMCE.PELPLGBMOII> ONODAPNHMPB; // 0x2C
