...
public class JJOPEDJCCJK_Exp : DIHHCBACKGG
{
    public class GDBAIHMLCBI
    {
        ...
        public int GJLFANGDGCL; // 0xC
        public int KFJDNFCBBBL; // 0x10
        public int MNEDFIBOJAI; // 0x14

        // public int DHIPGHBJLIL { get; } 0x135620C PEIEKKODNKE
    }

    public class GPLPAOGMPAM
    {
        public int LKIFDCEKDCK; // 0x8
	...
	private List<int> HLFGFGPCKNP; // 0x20
	private List<int> MLMGJJAGKDL; // 0x24
	private List<int> FKHFJAFKLPA; // 0x28
	private List<int> ILJKACFDKHI; // 0x2C
	private List<int> BKGEDIBAPPJ; // 0x30
	private List<int> LEKPPFJMFMH; // 0x34
	private List<int> HALPANEEGHO; // 0x38
	private List<int> OBGMHMBHKIH; // 0x3C
	private List<int> LMFNPINMOGK; // 0x40
	private List<int> JNIHDCMHINF; // 0x44
	private List<int> AOLNJDHGNGA; // 0x48
	...
	public JJOPEDJCCJK_Exp()
    {
        ...
        BKGEDIBAPPJ = new List<int>(300);
        LMFNPINMOGK = new List<int>(150);
        MLMGJJAGKDL = new List<int>(300);
