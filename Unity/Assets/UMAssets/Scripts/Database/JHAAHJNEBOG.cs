...
public class JHAAHJNEBOG_LimitedCompoItem : DIHHCBACKGG_DbSection
{
	public class AOBHKONKIPF
	{
		...
		public int PPFNGGCBJKC_Id { get { return EHOIENNDEDH_IdCrypted ^ FBGGEFFJJHB_xor; } set { EHOIENNDEDH_IdCrypted = value ^ FBGGEFFJJHB_xor; } } //0xB1CF6C DEMEPMAEJOO 0xB1C42C HIGKAIDMOKN
		public int IJEKNCDIIAE { get { return GNGNIKNNCNH_MVerCrypted ^ FBGGEFFJJHB_xor; } set { GNGNIKNNCNH_MVerCrypted = value ^ FBGGEFFJJHB_xor; } } //0xB1D004 KJIMMIBDCIL 0xB1C4C8 DMEGNOKIKCD
		public int PLALNIIBLOF { get { return HNJHPNPFAAN ^ FBGGEFFJJHB_xor; } set { HNJHPNPFAAN = value ^ FBGGEFFJJHB_xor; } } //0xB1D09C JPCJNLHHIPE 0xB1C564 JJFJNEJLBDG
		...
		public int EILKGEADKGH_Order { get { return HHPFFPINGAA ^ FBGGEFFJJHB_xor; } set { HHPFFPINGAA = value ^ FBGGEFFJJHB_xor; } } //0xB1D1CC NPDDACIHBKD 0xB1C69C BJJMCKHBPNH
		public int JBGEEPFKIGG { get { return ICKOHEDLEFP ^ FBGGEFFJJHB_xor; } set { ICKOHEDLEFP = value ^ FBGGEFFJJHB_xor; } } //0xB1D264 OLOCMINKGON 0xB1C7D4 ABAFHIBFKCE
	...
	public class JMJKJFKAFCJ
	{
		...
		public int PENIOLJHIPK { get { return BFEJGHJHIOF ^ FBGGEFFJJHB_xor; } set { BFEJGHJHIOF = value ^ FBGGEFFJJHB_xor; } } //0xB1D4A4 AHIONKNDHHH 0xB1C1B4 NEOFLJKHAKC
		public int DOOGFEGEKLG_Max { get { return LCGJKAGIFGO ^ FBGGEFFJJHB_xor; } set { LCGJKAGIFGO = value ^ FBGGEFFJJHB_xor; } } //0xB1D53C AECMFIOFFJN 0xB1C250 NGOJJDOCIDG
		public int HHGFOIMIGED { get { return PLFKPDAHHBK ^ FBGGEFFJJHB_xor; } set { PLFKPDAHHBK = value ^ FBGGEFFJJHB_xor; } } //0xB1D5D4 POJLCAFLBGA 0xB1C2EC MNDPEODCBPL
		public int DODGLIDGBBC { get { return CILEPBKEOHB ^ FBGGEFFJJHB_xor; } set { CILEPBKEOHB = value ^ FBGGEFFJJHB_xor; } } //0xB1D66C PAACNLDBGKP 0xB1C388 AHIHPMDINHA
	...
	public class LACKNDBIIJD
	{
		...
		public int LHHOODFPCEL { get { return FDJAHLIICNO ^ FBGGEFFJJHB_xor; } set { FDJAHLIICNO = value ^ FBGGEFFJJHB_xor; } } //0xB1D704 OIIOODJFKHJ 0xB1CA40 FKBIADOGCPM
		public int ALEDAGOCGGH { get { return CCKDEMEECCJ ^ FBGGEFFJJHB_xor; } set { CCKDEMEECCJ = value ^ FBGGEFFJJHB_xor; } } //0xB1D79C BAFMOENIDCC 0xB1CADC GNCKMAMFEGA
		public int JKDFMICLDJO { get { return POCPJBJKPOB ^ FBGGEFFJJHB_xor; } set { POCPJBJKPOB = value ^ FBGGEFFJJHB_xor; } }// 0xB1D834 GLLNPHGPPHH 0xB1CB78 HDBFLHONIHA
		public int EIEOBPKBJDN { get { return FPJAOBICLDI ^ FBGGEFFJJHB_xor; } set { FPJAOBICLDI = value ^ FBGGEFFJJHB_xor; } }// 0xB1D8CC JMLDPKECNKD 0xB1CC14 DFDGEGBHOFL
	...
	{
		MAPLLKFHCLF parser = MAPLLKFHCLF.HEGEKFMJNCC(_DBBGALAPFGC_Data);
		{
