...
public class NEGELNMPEPH_DecoSpSetting : DIHHCBACKGG_DbSection
{
	public class DAGLEHBMBLF
	{
		...
		public int NANNGLGOFKH_MaxNumber { get { return OHMGPDPKGLF ^ FBGGEFFJJHB_xor; } set { OHMGPDPKGLF = value ^ FBGGEFFJJHB_xor; } } //0x1AE66A8 EDFAHCMGHKM 0x1AE62AC BKPDFNKGNHA
	...
	public class NDONMEAEGFF
	{
		...
		public int HMFFHLPNMPH { get { return HLMAFFLCCKD ^ FBGGEFFJJHB_xor; } set { HLMAFFLCCKD = value ^ FBGGEFFJJHB_xor; } } //0x1AE66C8 NJOGDDPICKG 0x1AE62F4 NBBGMMBICNA
			...
			for(int i = 0; i < array.Length; i++)
			{
				List<DAGLEHBMBLF> lData = new List<DAGLEHBMBLF>();
				{
					...
					for(int j = 0; j < array2.Length; j++)
					{
						...
						data.NANNGLGOFKH_MaxNumber = array[i].JBGEEPFKIGG[j];
						lData.Add(data);
					}
				}
