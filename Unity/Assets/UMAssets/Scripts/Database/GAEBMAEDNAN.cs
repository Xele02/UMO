...
public class GAEBMAEDNAN_DecoPoint : DIHHCBACKGG_DbSection
{
	...
	public class KFFELNOEBPB
	{
		...
		public int JBGEEPFKIGG_Value { get { return ICKOHEDLEFP_Value ^ FBGGEFFJJHB_xor; } set { ICKOHEDLEFP_Value = value ^ FBGGEFFJJHB_xor; } }// 0x13FDEE0 OLOCMINKGON 0x13FDB9C ABAFHIBFKCE
