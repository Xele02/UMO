...
public class KCGOMAFPGDD_EventAprilFool : DIHHCBACKGG_DbSection
{
	public class OEHCHEEEBDC
	{
		...
		//public string OCDMGOGMHGE { get; set; } 0x1021EE8 HBAAAKFHDBB 0x102138C NHJLJOIPOFK
		//public string PJBILOFOCIC { get; set; } 0x1021F14 NOEFEAIFHCL 0x10213C0 GJIJFGNONEL
	...
	public List<EIEGCBJHGCP> IJJHFGOIDOK = new List<EIEGCBJHGCP>(); // 0x24
	...
	public List<int> IHKIFGPICLG = new List<int>(); // 0x38
	...
	{
		TodoLogger.LogError(TodoLogger.Database, "KCGOMAFPGDD_EventAprilFool.KMBPACJNEOF");
	}

	// RVA: 0x1020530 Offset: 0x1020530 VA: 0x1020530 Slot: 9
	public override bool IIEMACPEEBJ(byte[] DBBGALAPFGC)
	{
		TodoLogger.LogError(TodoLogger.Database, "KCGOMAFPGDD_EventAprilFool.IIEMACPEEBJ");
		return true;
	}
