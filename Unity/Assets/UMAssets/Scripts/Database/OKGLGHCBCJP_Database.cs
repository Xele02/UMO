...
public class OKGLGHCBCJP_Database
{
	public enum BEOKNKGHFFE_Section
	{
		...
		HGOGFPOCKFA_102_Sns = 102,
		LCEEHPPLHNC_SpItem = 103,
		AOPBBHMIEPB_104_Story = 104,
	...
	public static BEOKNKGHFFE_Section[] GAAEFILMAED_BaseSectionList = new BEOKNKGHFFE_Section[0x47]
	{
		...
		BEOKNKGHFFE_Section.MLNHHIIDJAO_1_Anketo,
		...
		BEOKNKGHFFE_Section.PGHFPIMIOKE_19_Emblem,
		...
		BEOKNKGHFFE_Section.HGOGFPOCKFA_102_Sns,
		BEOKNKGHFFE_Section.LCEEHPPLHNC_SpItem,
		BEOKNKGHFFE_Section.AOPBBHMIEPB_104_Story,
	...
	public static readonly string[] IJBLEJOKEFH_Name = new string[0x75] {
  		"adventure",
		"anketo",
		"asset",
		"bingo",
	...
	private List<DIHHCBACKGG_DbSection> MGJKEJHEBPO_Blocks; // 0x130
	private static Dictionary<int, BIFFPAKDHJJ_CreateSectionDelegate> BGEJFKHOMOC_CreateFuncs = new Dictionary<int, BIFFPAKDHJJ_CreateSectionDelegate>() {
		...
		{(int)BEOKNKGHFFE_Section.MLNHHIIDJAO_1_Anketo,() => { return new IPJBAPLFECP_Anketo(); } }, //0x149D56C				"anketo",
		...
		{(int)BEOKNKGHFFE_Section.PGHFPIMIOKE_19_Emblem,() => { return new IHGBPAJMJFK_Emblem(); } }, //0x149DD04				"emblem",
		...
		{(int)BEOKNKGHFFE_Section.COFHBPGDPML_EventBoxGachaA,() => { return new IMDBGDNPLJA_EventBoxGacha(); } }, //0x149E430				"event_box_gacha_a",
		{(int)BEOKNKGHFFE_Section.BHJGBPLKMBK_EventBoxGachaB,() => { return new IMDBGDNPLJA_EventBoxGacha(); } }, //0x149E49C				"event_box_gacha_b",
		{(int)BEOKNKGHFFE_Section.AHDKIFOPEHM_EventBoxGachaC,() => { return new IMDBGDNPLJA_EventBoxGacha(); } }, //0x149E508				"event_box_gacha_c",
		{(int)BEOKNKGHFFE_Section.LLEDCLGDDCD_EventBoxGachaD,() => { return new IMDBGDNPLJA_EventBoxGacha(); } }, //0x149E574				"event_box_gacha_d",
		{(int)BEOKNKGHFFE_Section.ACNPHHGCHAF_EventBoxGachaE,() => { return new IMDBGDNPLJA_EventBoxGacha(); } }, //0x149E5E0				"event_box_gacha_e",
		{(int)BEOKNKGHFFE_Section.FEICGBHOIPB_EventBoxGachaF,() => { return new IMDBGDNPLJA_EventBoxGacha(); } }, //0x149E64C				"event_box_gacha_f",
		{(int)BEOKNKGHFFE_Section.OAOKLHCDPON_EventCollectionA,() => { return new PHBACNMCMHG_EventCollection(); } }, //0x149E6B8				"event_collection_a",
		{(int)BEOKNKGHFFE_Section.GGKFEJFMNGP_EventCollectionB,() => { return new PHBACNMCMHG_EventCollection(); } }, //0x149E724				"event_collection_b",
		{(int)BEOKNKGHFFE_Section.LLHBBEMKIGD_EventCollectionC,() => { return new PHBACNMCMHG_EventCollection(); } }, //0x149E790				"event_collection_c",
		{(int)BEOKNKGHFFE_Section.HJDJGMNAJFJ_EventGachaTicket,() => { return new JNGINLMOJKH_EventGachaTicket(); } }, //0x149E7FC				"event_gacha_ticket",
		{(int)BEOKNKGHFFE_Section.MBMNNEODFFP_EventGoDivaA,() => { return new LNELCMNJPIC_EventGoDiva(); } }, //0x149E868				"event_godiva_a",
		{(int)BEOKNKGHFFE_Section.NLIBPDOHAPH_EventGoDivaB,() => { return new LNELCMNJPIC_EventGoDiva(); } }, //0x149E8D4				"event_godiva_b",
		{(int)BEOKNKGHFFE_Section.JLGODHLEBMK_EventGoDivaC,() => { return new LNELCMNJPIC_EventGoDiva(); } }, //0x149E940				"event_godiva_c",
		{(int)BEOKNKGHFFE_Section.OFAAHIINGFD_EventGoDivaRanking,() => { return new JPJGOECJFEE_EventGoDivaRanking(); } }, //0x149E9AC				"event_godiva_ranking",
		{(int)BEOKNKGHFFE_Section.OFGFNFAJHFE_EventItem,() => { return new HGLPLKKBBOL_EventItem(); } }, //0x149EA18				"event_item",
		{(int)BEOKNKGHFFE_Section.DCBIDPBJHOC_EventMissionA,() => { return new ACBAHDMEFFL_EventMission(); } }, //0x149EA84				"event_mission_a",
		{(int)BEOKNKGHFFE_Section.BNCLLKEHEFH_EventMissionB,() => { return new ACBAHDMEFFL_EventMission(); } }, //0x149EAF0				"event_mission_b",
		{(int)BEOKNKGHFFE_Section.BDGKKLAAJJB_EventMissionC,() => { return new ACBAHDMEFFL_EventMission(); } }, //0x149EB5C				"event_mission_c",
		{(int)BEOKNKGHFFE_Section.CLKOFJKPPEP_EventPresentCampaignA,() => { return new HIADOIECMFP_EventPresentCampaign(); } }, //0x149EBC8				"event_present_campaign_a",
		{(int)BEOKNKGHFFE_Section.DCEHHGDDBPP_EventRaidA,() => { return new BKOGPDBKFFJ_EventRaid(); } }, //0x149EC34				"event_raid_a",
		{(int)BEOKNKGHFFE_Section.PLNOKLOLJEP_EventRaidB,() => { return new BKOGPDBKFFJ_EventRaid(); } }, //0x149ECA0				"event_raid_b",
		{(int)BEOKNKGHFFE_Section.IJEIEHHAJNM_EventRaidC,() => { return new BKOGPDBKFFJ_EventRaid(); } }, //0x149ED0C				"event_raid_c",
		{(int)BEOKNKGHFFE_Section.DMKFEJGOELJ_EventRaidD,() => { return new BKOGPDBKFFJ_EventRaid(); } }, //0x149ED78				"event_raid_d",
		{(int)BEOKNKGHFFE_Section.IEBPINPALBD_EventRaidLobbyA,() => { return new LDEBIBGHCGD_EventRaidLobby(); } }, //0x149EDE4				"event_raidlobby_a",
		{(int)BEOKNKGHFFE_Section.CHNHFHCEKGN_EventRaidLobbyB,() => { return new LDEBIBGHCGD_EventRaidLobby(); } }, //0x149EE50				"event_raidlobby_b",
		{(int)BEOKNKGHFFE_Section.FCAJCEOCDFF_EventRaidLobbyC,() => { return new LDEBIBGHCGD_EventRaidLobby(); } }, //0x149EEBC				"event_raidlobby_c",
		{(int)BEOKNKGHFFE_Section.IJOLIEAOOJC_EventRaidLobbyD,() => { return new LDEBIBGHCGD_EventRaidLobby(); } }, //0x149EF28				"event_raidlobby_d",
		{(int)BEOKNKGHFFE_Section.MDAEJLJPIHN_EventRaidItem,() => { return new NKBOMKGFGIO_EventRaidItem(); } }, //0x149EF94				"event_raid_item",
		{(int)BEOKNKGHFFE_Section.OJAHCPGNPDB_EventQuestA,() => { return new LMBBEGIAKAD_EventQuest(); } }, //0x149F000				"event_quest_a",
		{(int)BEOKNKGHFFE_Section.KGJMEGLKJDM_EventQuestB,() => { return new LMBBEGIAKAD_EventQuest(); } }, //0x149F06C				"event_quest_b",
		{(int)BEOKNKGHFFE_Section.LNBMDELKFHI_EventQuestC,() => { return new LMBBEGIAKAD_EventQuest(); } }, //0x149F0D8				"event_quest_c",
		{(int)BEOKNKGHFFE_Section.FMHLCBNFAOC_EventScoreA,() => { return new HIHJGPDLNDN_EventScore(); } }, //0x149F144				"event_score_a",
		{(int)BEOKNKGHFFE_Section.LCJACACCKFC_EventScoreB,() => { return new HIHJGPDLNDN_EventScore(); } }, //0x149F1B0				"event_score_b",
		{(int)BEOKNKGHFFE_Section.BPOFGIDPMBF_EventScoreC,() => { return new HIHJGPDLNDN_EventScore(); } }, //0x149F21C				"event_score_c",
		...
		{(int)BEOKNKGHFFE_Section.FPFHPCDNIDN_GachaLimit,() => { return new BIHCALIAJII_GachaLimit(); } }, //0x149F5E8				"gacha_limit",
		...
		{(int)BEOKNKGHFFE_Section.MGLIHABHABA_HelpBrowser,() => { return new KCDJCKCKKFM_HelpBrowser(); } }, //0x149F798				"help_browser",
		{(int)BEOKNKGHFFE_Section.JHIAPFBBCCJ_HomeBg,() => { return new ALJHJDHNFFB_HomeBg(); } }, //0x149F804				"home_bg",
		{(int)BEOKNKGHFFE_Section.FLANCIJMJHP_HomePickup,() => { return new JJCJKALEIAC_HomePickup(); } }, //0x149F870				"home_pickup",
		{(int)BEOKNKGHFFE_Section.BKGFKGIGJNL_HomeVoice,() => { return new NPCCDMKJBMM_HomeVoice(); } }, //0x149F8DC				"home_voice",
		{(int)BEOKNKGHFFE_Section.NLIJGKHKMII_RichBanner,() => { return new JKMLBONMAHD_RichBanner(); } }, //0x149F948				"rich_banner",
		...
		{(int)BEOKNKGHFFE_Section.KPBNAHEIJIC_LimitedItem,() => { return new EGLOKAEIHCB_LimitedItem(); } }, //0x149FA8C				"limited_item",
		...
		{(int)BEOKNKGHFFE_Section.JMJMNDKFOIF_MvTicket,() => { return new GJAEGCMKMEK_MvTicket(); } }, //0x149FC3C				"mv_ticket",
		{(int)BEOKNKGHFFE_Section.LNCIOFKDBHD_Offer,() => { return new LGHIPHEDCNC_Offer(); } }, //0x149FCA8				"offer",
		{(int)BEOKNKGHFFE_Section.GPEFCGBGIHD_Pilot,() => { return new MPOEMCEBBJH_Pilot(); } }, //0x149FD14				"pilot",
		{(int)BEOKNKGHFFE_Section.JFDOPKICHPJ_PresentItem,() => { return new MDACFBPPIHD_PresentItem(); } }, //0x149FD80				"present_item",
		{(int)BEOKNKGHFFE_Section.HDJDAENLIBF_Quest,() => { return new DHOJHGODBAB_Quest(); } }, //0x149FDEC				"quest",
		{(int)BEOKNKGHFFE_Section.KOALKJHIHFC_RareUpItem,() => { return new CKDOOBKOJBB_RareUpItem(); } }, //0x149FE58				"rareup_item",
		{(int)BEOKNKGHFFE_Section.KNMIJOPCJCH_Scene,() => { return new MLIBEPGADJH_Scene(); } }, //0x149FEC4					"scene",
		{(int)BEOKNKGHFFE_Section.ELBGPMIFOHO_Shop,() => { return new BKPAPCMJKHE_Shop(); } }, //0x149FF30				"shop",
		{(int)BEOKNKGHFFE_Section.ABANJLALLBK_Skill,() => { return new JNKEEAOKNCI_Skill(); } }, //0x149FF9C				"skill",
		{(int)BEOKNKGHFFE_Section.HGOGFPOCKFA_102_Sns,() => { return new BOKMNHAFJHF_Sns(); } }, //0x14A0008				"sns",
		{(int)BEOKNKGHFFE_Section.LCEEHPPLHNC_SpItem,() => { return new PPNFHHPJOKK_SpItem(); } }, //0x14A0074				"sp_item",
		{(int)BEOKNKGHFFE_Section.AOPBBHMIEPB_104_Story,() => { return new LAEGMENIEDB_Story(); } }, //0x14A00E0				"story",
		{(int)BEOKNKGHFFE_Section.HGFDKEMHGHK_System,() => { return new PEBFNABDJDI_System(); } }, //0x14A014C					"system",
		{(int)BEOKNKGHFFE_Section.ACECCMLEDMO_Tips,() => { return new BCKMELFCKKN_Tips(); } }, //0x14A01B8				"tips",
		{(int)BEOKNKGHFFE_Section.HDDBEGLGIDK_TitleBanner,() => { return new JOHKNBEFHHP_TitleBanner(); } }, //0x14A0224					"title_banner",
		{(int)BEOKNKGHFFE_Section.EMHPGEHBKPG_TutorialMiniAdv,() => { return new ILLPGHGGKLL_TutorialMiniAdv(); } }, //0x14A0290				"tutorial_mini_adv",
		{(int)BEOKNKGHFFE_Section.JJMBJBFKJHK_TutorialPict,() => { return new PJANOOPJIDE_TutorialPict(); } }, //0x14A02FC				"tutorial_pict",
		{(int)BEOKNKGHFFE_Section.EKLPMPHCIDL_UcItem,() => { return new DGDIEDDPNNG_UcItem(); } }, //0x14A0368				"uc_item",
		{(int)BEOKNKGHFFE_Section.OPHNLHMINEO_ValItem,() => { return new INDEPDKCJDD_ValItem(); } }, //0x14A03D4				"val_item",
		...
		{(int)BEOKNKGHFFE_Section.LJKEOODGGJF_VcItem,() => { return new DKJMDIFAKKD_VcItem(); } }, //0x14A0518				"vc_item",
		{(int)BEOKNKGHFFE_Section.NPOPGPFPLOL_HighscoreRating,() => { return new HGPEFPFODHO_HighScoreRanking(); } }, //0x14A0584				"highscore_rating",
		{(int)BEOKNKGHFFE_Section.AHKEJPLNAJK_LimitedCompoItem,() => { return new JHAAHJNEBOG_LimitedCompoItem(); } }, //0x14A05F0				"limited_compo_item"
	}; // 0x8

	public GPMHOAKFALE_Adventure EFMAIKAHFEK_Adventure { get; private set; } // 0x14 JLLBGAHIIBG_bgs LLCFMAELHEP_bgs IEBCIAFOBIN_bgs
	public IPJBAPLFECP_Anketo OILKBADFBOK_Anketo { get; private set; } // 0x18 PMEPLHGCOPN_bgs ACKDFMAHCPG_bgs IKNMGMOEIBJ_bgs
	public LFPJCEMANCK_Asset IELDDHJMFKN_Asset { get; private set; } // 0x1C POIPNMNLPII_bgs LDEGIHHDKIM_bgs OPKDGNFPLMJ_bgs
	public JKICPBIIHNE_Bingo FPOIPGFFAPE_Bingo { get; private set; } // 0x20 IGDEDAEJHHE_bgs DGFJAPEKHFO_bgs GNMGEPPDCKA_bgs
	public KOGHKIODHPA_Board JEMMMJEJLNL_Board { get; private set; } // 0x24 JCNENMIJKJM_bgs LEOMPFKGIDH_bgs OJLDODJNICJ_bgs
	public HHJHIFJIKAC_BonusVc NBKNAAPBFFL_BonusVc { get; private set; } // 0x28 DPLHDEEFDJM_bgs ADJIKEFIPJA_bgs JNIKDFJOHFA_bgs
	public AIPOFGJGPKI_CampaignDiva NGCCGLLLDIB_CampaignDiva { get; private set; } // 0x2C AKMEDCJEFIM_bgs ONFFEFOLNJA_bgs KHNFCNCCAJE_bgs
	public HHPEMHHCKBE_Compo ALFKMKICDPP_Compo { get; private set; } // 0x30 EGAMKFEHKOH_bgs OFKPEOKIBOP_bgs FBMPHCEEOGP_bgs
	public PLPBJOFICEJ_CosItem GOGFKAECFIP_CosItem { get; private set; } // 0x34 MFAKBNOPMAL_bgs ONAJMJDFKII_bgs OKGBJKKKBJK_bgs
	public LCLCCHLDNHJ_Costume MFPNGNMFEAL_Costume { get; private set; } // 0x38 BNPFDJNHBIN_bgs BHOKMJJHOOK_bgs PCDDICJFIEI_bgs
	public NDBFKHKMMCE_DecoItem EPAHOAKPAJJ_DecoItem { get; private set; } // 0x3C LKAKMHGBHKJ_bgs JHPEPALKAMJ_bgs BHEAGEGHAJB_bgs
	public JEPMHCPBIGD_DecoItemInit CIGBHCHOPEO_DecoItemInit { get; private set; } // 0x40 BONFHNBALOL_bgs GNIGMPDFEPP_bgs LFDFGOBDAMF_bgs
	public GAEBMAEDNAN_DecoPoint PJGDIJPCHAK_DecoPoint { get; private set; } // 0x44 JCDPLJOOJLG_bgs CMDIEHHIFOK_bgs CMJFJNNDFJJ_bgs
	public BBLECJKKKLA_DecoSetItem MJALLIOHKEJ_DecoSetItem { get; private set; } // 0x48 ABEMGBAJEBL_bgs BABMGOIFCOH_bgs GIIEMCFFDBD_bgs
	public NEGELNMPEPH_DecoSpSetting BGKKOOGPEFD_DecoSpSetting { get; private set; } // 0x4C AAPCGHFOHFC_bgs BALCOIHEDMF_bgs BKGBCKMOMGN_bgs
	public IHFIAFDLAAK_DecoStamp GAPONCJOKAC_DecoStamp { get; private set; } // 0x50 NCNFBFCCPGG_bgs OJGMINMADBB_bgs NEPJLJDPKKN_bgs
	public HPBPIOPPDCB_Diva MGFMPKLLGHE_Diva { get; private set; } // 0x54 ONCMJNDIMPD_bgs // ODGINDHEIBJ_bgs GIFOPLEGJCI_bgs
	public HMIJOOPHJLB_Diva2 OAINIGNLJKC_Diva2 { get; private set; } // 0x58 EFGHBGKGCDI_bgs KNBBENGMPJL_bgs MAPJOGCOBCF_bgs
	public NBPHJDCOECH_Drop HGLIIPFLMFB_Drop { get; private set; } // 0x5C DNBKBMJEDFG_bgs GEHKLFKNGDK_bgs DAEJHNBAAHD_bgs
	public IHGBPAJMJFK_Emblem LBNBNAFGMDE_Emblem { get; private set; } // 0x60 DOKBBBOMOIP_bgs AEKIOLPFPCO_bgs PMEOIDAFOLD_bgs
	public MHDFCLCMDKO_Enemy OPFBEAJJMJB_Enemy { get; private set; } // 0x64 DMKMEHGHLAL_bgs EDGAJGHMGOK_bgs AIBFBDMGEAL_bgs
	public JKDKODAPGBJ_EnergyItem KOPOGNLKAEN_EnergyItem { get; private set; } // 0x68 DACOHEDKLPD_bgs AEOJDBAPOEN_bgs PABHKGHLLLJ_bgs
	public KIICLPJJBNL_EpiItem NEGGMILDEEF_EpiItem { get; private set; } // 0x6C EEAPHFKEOOP_bgs EPDABADJFBH_bgs CFGCGOGNBMM_bgs
	public KMOGDEOKHPG_Episode MOLEPBNJAGE_Episode { get; private set; } // 0x70 PKELMNGHNJI_bgs GJAGLJAIAGC_bgs ECGGGFGFEOH_bgs
	public JNGINLMOJKH_EventGachaTicket NKOKFIMNCJM_EventGachaTicket { get; private set; } // 0x74 OOLBNNCGINP_bgs CHGCEALBNFF_bgs BDBOOJDGKFP_bgs
	public JPJGOECJFEE_EventGoDivaRanking EFHMLHKODOD_EventGoDivaRanking { get; private set; } // 0x78 KAOFKMKMDPH_bgs PAGHOGPONBK_bgs AODLPJLNDBK_bgs
	public HGLPLKKBBOL_EventItem DHOFNBMPBAG_EventItem { get; private set; } // 0x7C HLPDMEMHECG_bgs ILMEKLNLPND_bgs HMDGNIKNDKM_bgs
	public NKBOMKGFGIO_EventRaidItem ONOJBMDKBLE_EventRaidItem { get; private set; } // 0x80 OLLFECMFKIC_bgs JOKCENNIGCE_bgs IJCDMHJCMBO_bgs
	public ABBOEIPOBLJ_EventTicket KHPOJKHKLEM_EventTicket { get; private set; } // 0x84 MOKKFOJJBOL_bgs GPOGPBKFNLJ_bgs DILCIJAHIOB_bgs
	public DKCJADHKGAN_EventWeekDay CLLPBOPLICM_EventWeekDay { get; private set; } // 0x88 FNJBPMENMGD_bgs GFEDAIKEGGC_bgs AIDDOHHKJGG_bgs
	public FBIOJHECAHB_EventStory NBEMLGADAGK_EventStory { get; private set; } // 0x8C DCKAOHBMJLM_bgs INDINPLHFPO_bgs CJBHGJLJBNJ_bgs
	public JJOPEDJCCJK_Exp FMPEMFPLPDA_Exp { get; private set; } // 0x90 NFHAGPKJMCM_bgs JBOGJKMKPHB_bgs LJNHCFIIOBB_bgs
	public BIHCALIAJII_GachaLimit OINLLHOMEAK_GachaLimit { get; private set; } // 0x94 NFNMMHLNOME_bgs ACMDICBGLLH_bgs AECOJNDBPPA_bgs
	public PMDCIJMMNGK_GachaTicket GKMAHADAAFI_GachaTicket { get; private set; } // 0x98 CDPNLBODAFG_bgs MIOKEFPFJPL_bgs JCGBPLBDCED_bgs
	public LDDDBPNGGIN_Game HNMMJINNHII_Game { get; private set; } // 0x9C OEGOKKFEMLN_bgs // NNKOOANMMJN_bgs FDBLNEBHBKD_bgs
	public KEEKEFEPKFN_GrowItem NKDGLGCAPEI_GrowItem { get; private set; } // 0xA0 OEBKCKBOHDC_bgs GKNAKMMFPJG_bgs FPNMNKOHIDL_bgs
	public KCDJCKCKKFM_HelpBrowser LOJAMHAADBF_HelpBrowser { get; private set; } // 0xA4 PHJBEOHOPNK_bgs BEONJGJAHHA_bgs GKIMOCCMPNE_bgs
	public ALJHJDHNFFB_HomeBg PFEKKPABPKL_HomeBg { get; private set; } // 0xA8 ODEEPLDCIDD_bgs CJNCHHCJDLG_bgs EJKAKGDGDOJ_bgs
	public JJCJKALEIAC_HomePickup NFDHMGGLEPN_HomePickup { get; private set; } // 0xAC GGHPDLEFLAF_bgs KFBIAJPDFOL_bgs BLPBJMIOOHJ_bgs
	public NPCCDMKJBMM_HomeVoice MGIMEEEALPK_HomeVoice { get; private set; } // 0xB0 IIGKAHAPDCK_bgs EMOJEAIPDCL_bgs KJJAAHMMPDD_bgs
	public JKMLBONMAHD_RichBanner MLGEHCJPAFB_RichBanner { get; private set; } // 0xB4 DIOBCOIDGBL_bgs KLENJIKKNGL_bgs MCEKLAONFOO_bgs
	public GJALOMELEHD_Intimacy KDIALKDKBGE_Intimacy { get; private set; } // 0xB8 AJILIAMLKCN_bgs OHOFMNKPACI_bgs AJNFIOMEBPE_bgs
	public LLKLAKGKNLD_LimitOver HDGOHBFKKDM_LimitOver { get; private set; } // 0xBC GOCPJPDCIFF_bgs HNHCBNDJBIL_bgs OMHPACMOBMD_bgs
	public EGLOKAEIHCB_LimitedItem IHPFCIJKFIC_LimitedItem { get; private set; } // 0xC0 DLCGGEGFOFM_bgs BKAPBBKJELI_bgs MINMKCJFHDG_bgs
	public HHFFOACILKG_Medal ICICKEBMEFA_Medal { get; private set; } // 0xC4 BLEKIIHCAEL_bgs ECAMAOEFEJK_bgs IEOJCBOIKPN_bgs
	public KBCCGHLCFNO_MonthlyPass MEGJDBJCEOC_MonthlyPass { get; private set; } // 0xC8 LAJCNNENFPJ_bgs MIALNGOCOPJ_bgs NABHFEAEHFH_bgs
	public LPPGENBEECK_MusicMaster IBPAFKKEKNK_Music { get; private set; } // 0xCC CKFEJCIKLAE_bgs AHENIIKNNJF_bgs HMKLOBHNMMI_bgs
	public GJAEGCMKMEK_MvTicket NEGKEEAFKHP_MvTicket { get; private set; } // 0xD0 NFCPFDJHNFE_bgs HEMDMBJABPN_bgs EJFOCHNEPKD_bgs
	public LGHIPHEDCNC_Offer LBCMJGOOHLJ_Offer { get; private set; } // 0xD4 NAAKJHEPHGP_bgs NFGKMIAHJHD_bgs FMJANBICBME_bgs
	public MPOEMCEBBJH_Pilot OBGGLAKOHKP_Pilot { get; private set; } // 0xD8 AHLBGPDJMCC_bgs PLOCKLBILGJ_bgs CFGIBLPKPOH_bgs
	public MDACFBPPIHD_PresentItem LPFEHNJEJFB_PresentItem { get; private set; } // 0xDC HFOPPMPKKFL_bgs BCAGHHBCENF_bgs FKMAMMGADKI_bgs
	public DHOJHGODBAB_Quest MHGPMMIDKMM_Quest { get; private set; } // 0xE0 HFKCBLFIKEC_bgs BODCNAFFNII_bgs JFGOKBPMCFL_bgs
	public CKDOOBKOJBB_RareUpItem KKIMFMKOHFH_RareUpItem { get; private set; } // 0xE4 NFOFMEKFHEA_bgs AMANIEHMCLH_bgs OHKJEENNABM_bgs
	public MLIBEPGADJH_Scene ECNHDEHADGL_Scene { get; private set; } // 0xE8 IEIOOBGMFNI_bgs ACAKHGDFOPE_bgs MINEODNFCJG_bgs
	public BKPAPCMJKHE_Shop IFLGCDGOLOP_Shop { get; private set; } // 0xEC LPLEPMGGDMC_bgs JPPGBAEFJHD_bgs NNMGMDJDAEB_bgs
	public JNKEEAOKNCI_Skill FOFADHAENKC_Skill { get; private set; } // 0xF0 EMMJGCNLPIC_bgs AIKMDJIOIPO_bgs ODHIIKEDPDK_bgs
	public BOKMNHAFJHF_Sns OMGFKMANMAB_Sns { get; private set; } // 0xF4 MFLNAPMHPKD_bgs IEFPCCJONCN_bgs FJJMCAEKDCM_bgs
	public PPNFHHPJOKK_SpItem OOEPHOEFBNL_SpItem { get; private set; } // 0xF8 GEDHKEFKHEH_bgs HCAIIFDMGHF_bgs ELGOCAOHJBM_bgs
	public LAEGMENIEDB_Story OHCIFMDPAPD_Story { get; private set; } // 0xFC OCCBGBFIPFH_bgs HLLFEGMBGLE_bgs IKHIJOGKIAL_bgs
	public PEBFNABDJDI_System GDEKCOOBLMA_System { get; private set; } // 0x100 PINEBDOIEIB_bgs LIJDDDCBNPL_bgs AAEDGCBNJAO_bgs
	public BCKMELFCKKN_Tips KNMFNBEOGON_Tips { get; private set; } // 0x104 CLNAKEBEBIM_bgs HAAKPEOBDIO_bgs JNKAICHDNND_bgs
	public JOHKNBEFHHP_TitleBanner ACPALDEELCL_TitleBanner { get; private set; } // 0x108 MOHDEFAGJCD_bgs HCJMPMCLFAL_bgs OEBNPODPBGG_bgs
	public DGDIEDDPNNG_UcItem NMJEDFNPIPL_UcItem { get; private set; } // 0x10C AIDFHJFIJJE_bgs BOGKAJBELIJ_bgs ONFDHFKPFHK_bgs
	public DKJMDIFAKKD_VcItem KCCDBKIOLDJ_VcItem { get; private set; } // 0x110 NFOKONGDFNH_bgs MJBBGKMNMKH_bgs LFKKHMAFIBA_bgs
	public INDEPDKCJDD_ValItem FBGKBGNIHGC_ValItem { get; private set; } // 0x114 MOPJLGOMNLJ_bgs BAGFGFIMNLH_bgs KPAEENCFPIH_bgs
	public GKFMJAHKEMA_ValSkill DIAEPFPGPEP_ValSkill { get; private set; } // 0x118 BCDPCPEGMHC_bgs MOJPFJFKFPG_bgs IMCKGLCKPED_bgs
	public JPIANKEOOMB_Valkyrie PEOALFEGNDH_Valkyrie { get; private set; } // 0x11C IOEEBHMLNFN_bgs HFDLJDHDCED_bgs MJFJKMCBIHC_bgs
	public HGPEFPFODHO_HighScoreRanking DCNNPEDOGOG_HighScoreRanking { get; private set; } // 0x120 DGEJGGLIBPK_bgs DDMLBAIOIHC_bgs ADFIKFDMPAN_bgs
	public ILLPGHGGKLL_TutorialMiniAdv LINHIDCNAMG_TutorialMiniAdv { get; private set; } // 0x124 CKMGPFOBCMH_bgs FAIKNJFGDIB_bgs MLLLCNLNJBI_bgs
	public PJANOOPJIDE_TutorialPict KIBMNCOLJNC_TutorialPict { get; private set; } // 0x128 KNIHEPFNDKP_bgs FDIFJJONAEA_bgs MLKGAOGFOPI_bgs
	public JHAAHJNEBOG_LimitedCompoItem MBAGKLJDKMH_LimitedCompoItem { get; private set; } // 0x12C HKMFFDNMOBN_bgs BDENFILNIID_bgs BHGPHONEKGL_bgs

	// // RVA: 0x149049C Offset: 0x149049C VA: 0x149049C
	// private static bool LIPIIKKIKOI(OKGLGHCBCJP_Database.BEOKNKGHFFE_Section[] NNDGIAEFMOG, OKGLGHCBCJP_Database.BEOKNKGHFFE_Section _PPFNGGCBJKC_id) { }

	// // RVA: 0x1490508 Offset: 0x1490508 VA: 0x1490508
	// private static bool LIPIIKKIKOI(List<OKGLGHCBCJP_Database.BEOKNKGHFFE_Section> NNDGIAEFMOG, OKGLGHCBCJP_Database.BEOKNKGHFFE_Section _PPFNGGCBJKC_id) { }
	...
	// private static string JEHFDJPOEFF_str(string _HKICMNAACDA_a) { }

	// // RVA: 0x1490738 Offset: 0x1490738 VA: 0x1490738
	// private static bool FNHALBBECIM(OKGLGHCBCJP_Database.BEOKNKGHFFE_Section _NEJBNCHLMNJ_Type) { }
	...
	public DIHHCBACKGG_DbSection LBDOLHGDIEB_Find(string _OPFGFINHFCE_name)
	{
		return MGJKEJHEBPO_Blocks.Find((DIHHCBACKGG_DbSection PKLPKMLGFGK) => {
			//0x14A065C
			return PKLPKMLGFGK.JIKKNHIAEKG_BlockName == _OPFGFINHFCE_name;
		});
	}

	// // RVA: -1 Offset: -1
	// public T LBDOLHGDIEB_Find<T>(string _OPFGFINHFCE_name) { }
	// /* GenericInstMethod :
	// |
	// |-RVA: 0x1AB61C8 Offset: 0x1AB61C8 VA: 0x1AB61C8
	// |-OKGLGHCBCJP_Database.LBDOLHGDIEB_Find<object>
	// */
	...
	public bool LGLJALBIIIB_IsRaidLobbyLoaded()
	{
		for (int i = 0; i < MGJKEJHEBPO_Blocks.Count; i++)
		{
			if(MGJKEJHEBPO_Blocks[i].JIKKNHIAEKG_BlockName.Contains("event_raidlobby_"))
			{
				return true;
			}
		}
	...
	public List<BEOKNKGHFFE_Section> BPCKOIDILDK_GetSectionsValid(List<GDIPLANPCEI> _JOBKIDDLCPL_schedules, long _JHNMKKNEENE_Time)
	{
		...
		for(int i = 0; i < 117; i++)
		{
			...
			if(valid)
			{
				TodoLogger.Log(TodoLogger.Database, "Database will load : " + IJBLEJOKEFH_Name[i]);
				res.Add((BEOKNKGHFFE_Section)i);
			}
			else
			{
				TodoLogger.Log(TodoLogger.Database, "Wont load " + IJBLEJOKEFH_Name[i]);
			}
		}
		return res;
	}
	...
	{
		MGJKEJHEBPO_Blocks = new List<DIHHCBACKGG_DbSection>();
		...
		NKOKFIMNCJM_EventGachaTicket = null;
		EFHMLHKODOD_EventGoDivaRanking = null;
		DHOFNBMPBAG_EventItem = null;
		ONOJBMDKBLE_EventRaidItem = null;
		KHPOJKHKLEM_EventTicket = null;
		CLLPBOPLICM_EventWeekDay = null;
		NBEMLGADAGK_EventStory = null;
		FMPEMFPLPDA_Exp = null;
		OINLLHOMEAK_GachaLimit = null;
		GKMAHADAAFI_GachaTicket = null;
		HNMMJINNHII_Game = null;
		NKDGLGCAPEI_GrowItem = null;
		LOJAMHAADBF_HelpBrowser = null;
		PFEKKPABPKL_HomeBg = null;
		NFDHMGGLEPN_HomePickup = null;
		MGIMEEEALPK_HomeVoice = null;
		MLGEHCJPAFB_RichBanner = null;
		KDIALKDKBGE_Intimacy = null;
		HDGOHBFKKDM_LimitOver = null;
		IHPFCIJKFIC_LimitedItem = null;
		ICICKEBMEFA_Medal = null;
		MEGJDBJCEOC_MonthlyPass = null;
		IBPAFKKEKNK_Music = null;
		NEGKEEAFKHP_MvTicket = null;
		LBCMJGOOHLJ_Offer = null;
		OBGGLAKOHKP_Pilot = null;
		LPFEHNJEJFB_PresentItem = null;
		MHGPMMIDKMM_Quest = null;
		KKIMFMKOHFH_RareUpItem = null;
		ECNHDEHADGL_Scene = null;
		IFLGCDGOLOP_Shop = null;
		FOFADHAENKC_Skill = null;
		OMGFKMANMAB_Sns = null;
		OOEPHOEFBNL_SpItem = null;
		OHCIFMDPAPD_Story = null;
		GDEKCOOBLMA_System = null;
		KNMFNBEOGON_Tips = null;
		ACPALDEELCL_TitleBanner = null;
		NMJEDFNPIPL_UcItem = null;
		KCCDBKIOLDJ_VcItem = null;
		FBGKBGNIHGC_ValItem = null;
		DIAEPFPGPEP_ValSkill = null;
		PEOALFEGNDH_Valkyrie = null;
		DCNNPEDOGOG_HighScoreRanking = null;
		LINHIDCNAMG_TutorialMiniAdv = null;
		KIBMNCOLJNC_TutorialPict = null;
		MBAGKLJDKMH_LimitedCompoItem = null;
		NDLAAACJOLP.Clear();
		...
		for(int i = 0; i < INBBCDGDMLC.Length; i++)
		{
			...
			if(item != null)
			{
				...
				switch(INBBCDGDMLC[i])
				{
					...
					case BEOKNKGHFFE_Section.MLNHHIIDJAO_1_Anketo: OILKBADFBOK_Anketo = (IPJBAPLFECP_Anketo)item; break;
					...
					case BEOKNKGHFFE_Section.PGHFPIMIOKE_19_Emblem: LBNBNAFGMDE_Emblem = (IHGBPAJMJFK_Emblem)item; break;
					...
					case BEOKNKGHFFE_Section.HJDJGMNAJFJ_EventGachaTicket: NKOKFIMNCJM_EventGachaTicket = (JNGINLMOJKH_EventGachaTicket)item; break;
					case BEOKNKGHFFE_Section.OFAAHIINGFD_EventGoDivaRanking: EFHMLHKODOD_EventGoDivaRanking = (JPJGOECJFEE_EventGoDivaRanking)item; break;
					case BEOKNKGHFFE_Section.OFGFNFAJHFE_EventItem: DHOFNBMPBAG_EventItem = (HGLPLKKBBOL_EventItem)item; break;
					case BEOKNKGHFFE_Section.MDAEJLJPIHN_EventRaidItem: ONOJBMDKBLE_EventRaidItem = (NKBOMKGFGIO_EventRaidItem)item; break;
					case BEOKNKGHFFE_Section.AMGKNGLDHMG_EventTicket: KHPOJKHKLEM_EventTicket = (ABBOEIPOBLJ_EventTicket)item; break;
					case BEOKNKGHFFE_Section.BKEKCFONNBG_EventWeekDay: CLLPBOPLICM_EventWeekDay = (DKCJADHKGAN_EventWeekDay)item; break;
					case BEOKNKGHFFE_Section.JLNNFLCLGBM_EventStory: NBEMLGADAGK_EventStory = (FBIOJHECAHB_EventStory)item; break;
					case BEOKNKGHFFE_Section.MHNJLGONIPK_Exp: FMPEMFPLPDA_Exp = (JJOPEDJCCJK_Exp)item; break;
					case BEOKNKGHFFE_Section.FPFHPCDNIDN_GachaLimit: OINLLHOMEAK_GachaLimit = (BIHCALIAJII_GachaLimit)item; break;
					...
					case BEOKNKGHFFE_Section.MGLIHABHABA_HelpBrowser: LOJAMHAADBF_HelpBrowser = (KCDJCKCKKFM_HelpBrowser)item; break;
					case BEOKNKGHFFE_Section.JHIAPFBBCCJ_HomeBg: PFEKKPABPKL_HomeBg = (ALJHJDHNFFB_HomeBg)item; break;
					case BEOKNKGHFFE_Section.FLANCIJMJHP_HomePickup: NFDHMGGLEPN_HomePickup = (JJCJKALEIAC_HomePickup)item; break;
					case BEOKNKGHFFE_Section.BKGFKGIGJNL_HomeVoice: MGIMEEEALPK_HomeVoice = (NPCCDMKJBMM_HomeVoice)item; break;
					case BEOKNKGHFFE_Section.NLIJGKHKMII_RichBanner: MLGEHCJPAFB_RichBanner = (JKMLBONMAHD_RichBanner)item; break;
					...
					case BEOKNKGHFFE_Section.KPBNAHEIJIC_LimitedItem: IHPFCIJKFIC_LimitedItem = (EGLOKAEIHCB_LimitedItem)item; break;
					...
					case BEOKNKGHFFE_Section.JMJMNDKFOIF_MvTicket: NEGKEEAFKHP_MvTicket = (GJAEGCMKMEK_MvTicket)item; break;
					case BEOKNKGHFFE_Section.LNCIOFKDBHD_Offer: LBCMJGOOHLJ_Offer = (LGHIPHEDCNC_Offer)item; break;
					case BEOKNKGHFFE_Section.GPEFCGBGIHD_Pilot: OBGGLAKOHKP_Pilot = (MPOEMCEBBJH_Pilot)item; break;
					case BEOKNKGHFFE_Section.JFDOPKICHPJ_PresentItem: LPFEHNJEJFB_PresentItem = (MDACFBPPIHD_PresentItem)item; break;
					case BEOKNKGHFFE_Section.HDJDAENLIBF_Quest: MHGPMMIDKMM_Quest = (DHOJHGODBAB_Quest)item; break;
					case BEOKNKGHFFE_Section.KOALKJHIHFC_RareUpItem: KKIMFMKOHFH_RareUpItem = (CKDOOBKOJBB_RareUpItem)item; break;
					case BEOKNKGHFFE_Section.KNMIJOPCJCH_Scene: ECNHDEHADGL_Scene = (MLIBEPGADJH_Scene)item; break;
					case BEOKNKGHFFE_Section.ELBGPMIFOHO_Shop: IFLGCDGOLOP_Shop = (BKPAPCMJKHE_Shop)item; break;
					case BEOKNKGHFFE_Section.ABANJLALLBK_Skill: FOFADHAENKC_Skill = (JNKEEAOKNCI_Skill)item; break;
					case BEOKNKGHFFE_Section.HGOGFPOCKFA_102_Sns: OMGFKMANMAB_Sns = (BOKMNHAFJHF_Sns)item; break;
					case BEOKNKGHFFE_Section.LCEEHPPLHNC_SpItem: OOEPHOEFBNL_SpItem = (PPNFHHPJOKK_SpItem)item; break;
					case BEOKNKGHFFE_Section.AOPBBHMIEPB_104_Story: OHCIFMDPAPD_Story = (LAEGMENIEDB_Story)item; break;
					case BEOKNKGHFFE_Section.HGFDKEMHGHK_System: GDEKCOOBLMA_System = (PEBFNABDJDI_System)item; break;
					case BEOKNKGHFFE_Section.ACECCMLEDMO_Tips: KNMFNBEOGON_Tips = (BCKMELFCKKN_Tips)item; break;
					case BEOKNKGHFFE_Section.HDDBEGLGIDK_TitleBanner: ACPALDEELCL_TitleBanner = (JOHKNBEFHHP_TitleBanner)item; break;
					case BEOKNKGHFFE_Section.EMHPGEHBKPG_TutorialMiniAdv: LINHIDCNAMG_TutorialMiniAdv = (ILLPGHGGKLL_TutorialMiniAdv)item; break;
					case BEOKNKGHFFE_Section.JJMBJBFKJHK_TutorialPict: KIBMNCOLJNC_TutorialPict = (PJANOOPJIDE_TutorialPict)item; break;
					case BEOKNKGHFFE_Section.EKLPMPHCIDL_UcItem: NMJEDFNPIPL_UcItem = (DGDIEDDPNNG_UcItem)item; break;
					case BEOKNKGHFFE_Section.OPHNLHMINEO_ValItem: FBGKBGNIHGC_ValItem = (INDEPDKCJDD_ValItem)item; break;
	...
	private DIHHCBACKGG_DbSection MNMFKKKFDCL(OKGLGHCBCJP_Database.BEOKNKGHFFE_Section _NEJBNCHLMNJ_Type)
	{
		DIHHCBACKGG_DbSection res = null;
		if(BGEJFKHOMOC_CreateFuncs.ContainsKey((int)_NEJBNCHLMNJ_Type))
		{
			res = BGEJFKHOMOC_CreateFuncs[(int)_NEJBNCHLMNJ_Type]();
			res.LHPDDGIJKNB_Reset();
			res.JIKKNHIAEKG_BlockName = IIILDINMAKI_SectionNames[(int)_NEJBNCHLMNJ_Type];
		}
		return res;
	}
	...
	public bool IIEMACPEEBJ_Deserialize(List<string> _ANFNAHPIJDH_BlockNames, CBBJHPBGBAJ_Archive OCMCEKEKAPI)
	{
		...
		if(found != null)
		{
			...
			{
				string str = array[i].OPFGFINHFCE_name;
				int val = array[i].IOIMHJAOKOO_Hash;
				data.Add(str, val);
			}
		}
		for(int i = 0; i < _ANFNAHPIJDH_BlockNames.Count; i++)
		{
			string str2 = _ANFNAHPIJDH_BlockNames[i];
			DIHHCBACKGG_DbSection item = MGJKEJHEBPO_Blocks.Find((DIHHCBACKGG_DbSection PKLPKMLGFGK) => {
				//0x14A06E4
	...
	// public bool ALKOAPJCNFD(long _JHNMKKNEENE_Time) { }
	...
	public int PFAKPFKJJKA()
	{
		...
		for(int i = 0; i < MGJKEJHEBPO_Blocks.Count; i++)
		{
			if(MGJKEJHEBPO_Blocks[i].HHPOFCILDGN != MGJKEJHEBPO_Blocks[i].CAOGDCBPBAN())
			{
				res |= 1 << (i & 0x1f);
			}
		}
	...
	public void IDBDAPPJOND()
	{
		for(int i = 0; i < MGJKEJHEBPO_Blocks.Count; i++)
		{
			MGJKEJHEBPO_Blocks[i].HHPOFCILDGN = MGJKEJHEBPO_Blocks[i].CAOGDCBPBAN();
		}
	}
