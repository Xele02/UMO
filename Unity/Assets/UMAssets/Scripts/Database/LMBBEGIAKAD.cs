...
public class LMBBEGIAKAD_EventQuest : DIHHCBACKGG_DbSection
{
	public class BILPFCFHJLE
	{
		...
		public List<int> HIAMHLLHAON = new List<int>(); // 0x84
		...
		//public string OCDMGOGMHGE { get; set; } 0x10BB8BC HBAAAKFHDBB 0x10BA320 NHJLJOIPOFK
	...
	public class PAPFNFFDMHG
	{
		...
		//public int PPFNGGCBJKC { get; set; } 0x10BBA20 DEMEPMAEJOO 0x10BBA30 HIGKAIDMOKN
		//public int CNKFPJCGNFE { get; set; } 0x10BBA40 GJBOGOFHGNP 0x10BBA50 GJDGIDCMJMH
		//public int GNFBMCGMCFO { get; set; } 0x10BBA60 NCIMMDJLPLJ 0x10BBA70 HNAJAFBHOLM
		//public int BFFGFAMJAIG { get; set; } 0x10BBA80 PKMNOMELPMN 0x10BBA90 IABBJBAHKCE
	...
	public class OMHPMBCNAPC
	{
		...
		//public int PPFNGGCBJKC { get; set; } 0x10BB9B0 DEMEPMAEJOO 0x10BB9C0 HIGKAIDMOKN
		//public int GNFBMCGMCFO { get; set; } 0x10BB9D0 NCIMMDJLPLJ 0x10BB9E0 HNAJAFBHOLM
		//public int BFFGFAMJAIG { get; set; } 0x10BB9F0 PKMNOMELPMN 0x10BBA00 IABBJBAHKCE
	...
	public class JGMJOONMPJN
	{
		...
		//public int KHPHAAMGMJP { get; set; } 0x10BB8E8 ABFDDKBBPCH 0x10BB8F8 MHDOIIEMDEH
		//public int OFIAENKCJME { get; set; } 0x10BB908 KADLAKFANGA 0x10BB918 AIDAPNCEPOB
	...
	public BILPFCFHJLE NGHKJOEDLIP = new BILPFCFHJLE(); // 0x20
	public List<LNGOGDOIJHI> FCIPEDFHFEM = new List<LNGOGDOIJHI>(); // 0x24
	public List<AKIIJBEJOEP> NNMPGOAGEOL = new List<AKIIJBEJOEP>(); // 0x28
	//public List<PKADMPNDMGP> HKODBHPMLCP = new List<PKADMPNDMGP>(); // 0x2C
	public List<PAPFNFFDMHG> GEGAEDDGNMA = new List<PAPFNFFDMHG>(); // 0x30
	public List<OMHPMBCNAPC> OGMHMAGDNAM = new List<OMHPMBCNAPC>(); // 0x34
	public List<JGMJOONMPJN> LHAKGDAGEMM = new List<JGMJOONMPJN>(); // 0x38
	...
	{
		TodoLogger.LogError(TodoLogger.EventQuest_2, "LMBBEGIAKAD_EventQuest.KMBPACJNEOF");
	}

	// RVA: 0x10B89F0 Offset: 0x10B89F0 VA: 0x10B89F0 Slot: 9
	public override bool IIEMACPEEBJ(byte[] DBBGALAPFGC)
	{
		TodoLogger.LogError(TodoLogger.EventQuest_2, "LMBBEGIAKAD_EventQuest.IIEMACPEEBJ");
		return true;
	}
