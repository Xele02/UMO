...
public class BBLECJKKKLA_DecoSetItem : DIHHCBACKGG_DbSection
{
	public class GJBPBKNHLHC
	{
		...
		// public int PPFNGGCBJKC_Id { get; set; } 0xF2C094 DEMEPMAEJOO 0xF2BA2C HIGKAIDMOKN
		// public int PLALNIIBLOF { get; set; } 0xF2C12C JPCJNLHHIPE 0xF2BB64 JJFJNEJLBDG
		// public int EKLIPGELKCL { get; set; } 0xF2C1C4 OEEHBGECGKL 0xF2BAC8 GHLMHLJJBIG
		// public int CPKMLLNADLJ { get; set; } 0xF2C25C BJPJMGHCDNO 0xF2BC00 BPKIOJBKNBP
		// public int MLMCEBBDJOE { get; set; } 0xF2C2F4 IGMHCODOFKG 0xF2BC9C IIIGDLGGEGK
		// public int ODNILEDOAIP { get; set; } 0xF2C38C GNKPMBBAJHI 0xF2BD38 PPMACIMALAC
		// public int NPPGKNGIFGK { get; set; } 0xF2C424 FLMDBAFHDNJ 0xF2BDD4 DIHIEJPOCOJ
		// public int KEJMJPHFFOJ { get; set; } 0xF2C4BC FMNMLNIALNE 0xF2BE70 GBEPCBPOGDB
