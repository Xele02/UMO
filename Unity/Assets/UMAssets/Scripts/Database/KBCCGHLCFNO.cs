...
public class KBCCGHLCFNO : DIHHCBACKGG
{
	...
	// public Dictionary<string, CEBFFLDKAEC> OHJFBLFELNK { get; private set; } // 0x2C AEMNOGNEBOJ DGKDBOAMNBB
	// public Dictionary<string, string> FJOEBCMGDMI { get; private set; } // 0x30 GAMGELHIHHI DDDEJIJGGBJ
