...
public class KBCCGHLCFNO : DIHHCBACKGG
{
	public class JKGFAIPDNDL
	{
		...
		// public int PPFNGGCBJKC_Id { get; set; } 0x101A7D0 DEMEPMAEJOO 0x1019DC4 HIGKAIDMOKN
		// public int JJPDPNJFBHN { get; set; } 0x101A634 OFDIOBMHMHA 0x1019E60 PLFBKOJLLEG
		// public int BAOFEFFADPD { get; set; } 0x101A6CC KHNONKOPIPO 0x101A034 LBJPPBMDOGE
		// public int HNHOGHMLFNL { get; set; } 0x101A868 BJJCCMJIGJG 0x1019EFC MCCPONEGMLB
		// public int PHHBIBOJAEI { get; set; } 0x101A900 KDCHICNAKGB 0x1019F98 NBOCNPBIPFD
	...
	public class OFCDEIEAKLN
	{
		...
		// public int PPFNGGCBJKC_Id { get; set; } 0x101AD48 DEMEPMAEJOO 0x101ADE0 HIGKAIDMOKN
		// public int JJPDPNJFBHN { get; set; } 0x101AE7C OFDIOBMHMHA 0x101A0D8 PLFBKOJLLEG
		// public int PLALNIIBLOF { get; set; } 0x10187E8 JPCJNLHHIPE 0x101A174 JJFJNEJLBDG
		// public int HIPBLKBEPAJ { get; set; } 0x1018750 PFCFHLFHLIA 0x101A210 BLCKIAIDGDM
	...
	protected override void KMBPACJNEOF()
    {
		...
		OHJFBLFELNK.Clear();
		FJOEBCMGDMI.Clear();
		EHKFGCPHHJJ = 0x46c0baf;
		NLLNHNGMHGP = 0x46c0baf;
    }
