...
public class LNELCMNJPIC_EventGoDiva : DIHHCBACKGG_DbSection
{
	...
	public class POLLFBLLAHL
	{
		...
		public int PPFNGGCBJKC { get { return EHOIENNDEDH_IdCrypted ^ FBGGEFFJJHB_xor; } set { EHOIENNDEDH_IdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x10C2330 DEMEPMAEJOO 0x10C2340 HIGKAIDMOKN
		public int JBGEEPFKIGG { get { return ICKOHEDLEFP_Crypted ^ FBGGEFFJJHB_xor; } set { ICKOHEDLEFP_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x10C2350 OLOCMINKGON 0x10C2360 ABAFHIBFKCE
		public int PDBPFJJCADD_StartDate { get { return PCLNFCNIECH_Crypted ^ FBGGEFFJJHB_xor; } set { PCLNFCNIECH_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x10C2370 FOACOMBHPAC 0x10C2380 NBACOBCOJCA
		public int FDBNFFNFOND_CloseAt { get { return HHPIJHADAOB_Crypted ^ FBGGEFFJJHB_xor; } set { HHPIJHADAOB_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x10C2390 BPJOGHJCLDJ 0x10C23A0 NLJKMCHOCBK
	...
	public class DPKGKNJBFBJ
	{
		...
		public int PPFNGGCBJKC { get { return EHOIENNDEDH_IdCrypted ^ FBGGEFFJJHB_xor; } set { EHOIENNDEDH_IdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x10C1AF8 DEMEPMAEJOO 0x10C1B08 HIGKAIDMOKN
		public int LJELGFAFGAB { get { return OAMCHDAAINE_Crypted ^ FBGGEFFJJHB_xor; } set { OAMCHDAAINE_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x10C1B18 APHFJDOOLCK 0x10C1B28 KBEAJHMCGPM
		public int KNEDJFLCCLN { get { return NKBIFNAGIMH_Crypted ^ FBGGEFFJJHB_xor; } set { NKBIFNAGIMH_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x10C1B38 DKJNGOIGJGH 0x10C1B48 EOMMBJGKKJI
		public int MBAMIOJNGBD { get { return LBPNMNOCJMH_Crypted ^ FBGGEFFJJHB_xor; } set { LBPNMNOCJMH_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x10C1B58 NJBKAFBFJML 0x10C1B68 IGAFGHBHMIF
	...
	public class BGDLJMBDNOL
	{
		...
		public int PPFNGGCBJKC { get { return EHOIENNDEDH_IdCrypted ^ FBGGEFFJJHB_xor; } set { EHOIENNDEDH_IdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x10C1998 DEMEPMAEJOO 0x10C19A8 HIGKAIDMOKN
		...
		private int JBGEEPFKIGG { get { return ICKOHEDLEFP_Crypted ^ FBGGEFFJJHB_xor; } set { ICKOHEDLEFP_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x10C19F8 OLOCMINKGON 0x10C1A08 ABAFHIBFKCE
		public int LJELGFAFGAB { get { return ECLAOLBGCDD_tbl != 0 && ECLAOLBGCDD_tbl != 1 ? ECLAOLBGCDD_tbl : JBGEEPFKIGG; } } //0x10C1A18 APHFJDOOLCK
		public int KNEDJFLCCLN { get { return ECLAOLBGCDD_tbl != 0 && ECLAOLBGCDD_tbl != 2 ? ECLAOLBGCDD_tbl : JBGEEPFKIGG; } } //0x10C1A5C DKJNGOIGJGH
		public int MBAMIOJNGBD { get { return ECLAOLBGCDD_tbl != 0 && ECLAOLBGCDD_tbl != 3 ? ECLAOLBGCDD_tbl : JBGEEPFKIGG; } } //0x10C1A88 NJBKAFBFJML
	...
	public class EOJAGLGHMCL
	{
		...
		public int PPFNGGCBJKC { get { return EHOIENNDEDH_IdCrypted ^ FBGGEFFJJHB_xor; } set { EHOIENNDEDH_IdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x10C1B8C DEMEPMAEJOO 0x10C1B9C HIGKAIDMOKN
		public int PLALNIIBLOF_Enabled { get { return HNJHPNPFAAN_Crypted ^ FBGGEFFJJHB_xor; } set { HNJHPNPFAAN_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x10C1BAC JPCJNLHHIPE 0x10C1BBC JJFJNEJLBDG
		public int JBGEEPFKIGG_BonusRate { get { return ICKOHEDLEFP_Crypted ^ FBGGEFFJJHB_xor; } set { ICKOHEDLEFP_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x10C1BCC OLOCMINKGON 0x10C1BDC ABAFHIBFKCE
	...
	public class LDAGBDINHMC
	{
		...
		public int PPFNGGCBJKC { get { return EHOIENNDEDH_IdCrypted ^ FBGGEFFJJHB_xor; } set { EHOIENNDEDH_IdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x10C2288 DEMEPMAEJOO 0x10C2298 HIGKAIDMOKN
	...
	public class IONELJACGCL
	{
		...
		public int PPFNGGCBJKC { get { return EHOIENNDEDH_IdCrypted ^ FBGGEFFJJHB_xor; } set { EHOIENNDEDH_IdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x10C2150 DEMEPMAEJOO 0x10C2160 HIGKAIDMOKN
		...
		public void KHEKNNFCAOI(int OIPCCBHIKIA, int KNEFBLHBDBG, FOKPKJFHNLO JMHECKKKMLK)
		{
			...
			GNFBMCGMCFO_BonusBefore = JMHECKKKMLK.MIOCOKLMLBD[OIPCCBHIKIA - 1].GNFBMCGMCFO;
			BFFGFAMJAIG_BonusAfter = JMHECKKKMLK.MIOCOKLMLBD[OIPCCBHIKIA - 1].BFFGFAMJAIG;
		}
	...
	public class HGLNJDGOPMM
	{
		...
		public int PLALNIIBLOF_En { get { return HNJHPNPFAAN_Crypted ^ FBGGEFFJJHB_xor; } set { HNJHPNPFAAN_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x10C1DDC JPCJNLHHIPE 0x10C1DEC JJFJNEJLBDG
		public int MPLGPBNJDJB_FMusicId { get { return CNMODNFFBLP_FMusicIdCrypted ^ FBGGEFFJJHB_xor; } set { CNMODNFFBLP_FMusicIdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x10C1DFC KADAEAOKJNE 0x10C1E0C MBKFNLHPNPP
		public long PDBPFJJCADD_OpenAt { get { return PCLNFCNIECH_Crypted ^ FBGGEFFJJHB_xor; } set { PCLNFCNIECH_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x10C1E1C FOACOMBHPAC 0x10C1E34 NBACOBCOJCA
		public long FDBNFFNFOND_CloseAt { get { return HHPIJHADAOB_Crypted ^ FBGGEFFJJHB_xor; } set { HHPIJHADAOB_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x10C1E48 BPJOGHJCLDJ 0x10C1E60 NLJKMCHOCBK
	...
	public override bool IIEMACPEEBJ(byte[] _DBBGALAPFGC_Data)
	{
		...
		if (CurrenEvent != null && CurrenEvent.EnableBlock(JIKKNHIAEKG_BlockName))
		{
			...
			{
				if (EAPOKGEIFKA[i].PDBPFJJCADD_StartDate != 0) EAPOKGEIFKA[i].PDBPFJJCADD_StartDate = (int)NGHKJOEDLIP.BONDDBOFBND_RankingStart;
				if (EAPOKGEIFKA[i].FDBNFFNFOND_CloseAt != 0) EAPOKGEIFKA[i].FDBNFFNFOND_CloseAt = (int)NGHKJOEDLIP.HPNOGLIFJOP_End1;
			}
	...
	private bool DGKKMKLCEDF(FOKPKJFHNLO JMHECKKKMLK)
	{
		...
		NGHKJOEDLIP.FEMMDNIELFC_Desc = JMHECKKKMLK.HMBHNLCFDIH.FEMMDNIELFC;
		...
		NGHKJOEDLIP.FJCADCDNPMP_EndAdventureId = JMHECKKKMLK.HMBHNLCFDIH.FJCADCDNPMP;
