...
public class JJCJKALEIAC_HomePickup : DIHHCBACKGG_DbSection
{
	public class COBEFDFGLKA
	{
		...
		public int PPFNGGCBJKC { get { return EHOIENNDEDH_IdCrypted ^ FBGGEFFJJHB_xor; } set { EHOIENNDEDH_IdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x134F1B8 DEMEPMAEJOO 0x134EB80 HIGKAIDMOKN
		...
		public int KNHOMNONOEB { get { return AECMLPKCEAE ^ FBGGEFFJJHB_xor; } set { AECMLPKCEAE = value ^ FBGGEFFJJHB_xor; } } //0x134F1D8 NECFMEFKKPH 0x134EBA0 MHNEFLJACHA
		...
		public long PDBPFJJCADD { get { return PCLNFCNIECH ^ BBEGLBMOBOF_xorl; } set { PCLNFCNIECH = value ^ BBEGLBMOBOF_xorl; } } //0x134F260 FOACOMBHPAC 0x134ECAC NBACOBCOJCA
		public long FDBNFFNFOND_CloseAt { get { return HHPIJHADAOB ^ BBEGLBMOBOF_xorl; } set { HHPIJHADAOB = value ^ BBEGLBMOBOF_xorl; } } //0x134F274 BPJOGHJCLDJ 0x134ECCC NLJKMCHOCBK
		public int KGICDMIJGDF { get { return NNDGELGIMAO ^ FBGGEFFJJHB_xor; } set { NNDGELGIMAO = value ^ FBGGEFFJJHB_xor; } } //0x134F288 ENACPBCEBLF 0x134ECEC KPCDPMGBPAG
	...
	public class KOCBFBJBHLJ
	{
		...
		public int PPFNGGCBJKC { get { return EHOIENNDEDH_IdCrypted ^ FBGGEFFJJHB_xor; } set { EHOIENNDEDH_IdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x134F350 DEMEPMAEJOO 0x134EE0C HIGKAIDMOKN
		public int KNHOMNONOEB { get { return AECMLPKCEAE ^ FBGGEFFJJHB_xor; } set { AECMLPKCEAE = value ^ FBGGEFFJJHB_xor; } } //0x134F360 NECFMEFKKPH 0x134EE1C MHNEFLJACHA
	...
	public class OHPHKIFMPEK
	{
		...
		public int PPFNGGCBJKC { get { return EHOIENNDEDH_IdCrypted ^ FBGGEFFJJHB_xor; } set { EHOIENNDEDH_IdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x134F39C DEMEPMAEJOO 0x134EF64 HIGKAIDMOKN
		...
		public int GBJFNGCDKPM_Type { get { return NOFECLGOLAI ^ FBGGEFFJJHB_xor; } set { NOFECLGOLAI = value ^ FBGGEFFJJHB_xor; } } //0x134DD58 CEJJMKODOGK 0x134EF94 HOHCEBMMACI
		public int JOFAGCFNKIO { get { return BOBIDKJJEIM ^ FBGGEFFJJHB_xor; } set { BOBIDKJJEIM = value ^ FBGGEFFJJHB_xor; } } //0x134DD7C JDJIHKNFDLG 0x134EFA4 JNKGBAPAGOB
		...
		public int KNHOMNONOEB { get { return AECMLPKCEAE ^ FBGGEFFJJHB_xor; } set { AECMLPKCEAE = value ^ FBGGEFFJJHB_xor; } } //0x134F3AC NECFMEFKKPH 0x134EFC4 MHNEFLJACHA
	...
	public OHPHKIFMPEK OKMGCLFJDJI(int IHDHKBEMADL, long _EOLFJGMAJAB_CurrentTime)
	{
		...
		{
			if(HOFCPIHMHNB[i].PLALNIIBLOF_Enabled == 2 && HOFCPIHMHNB[i].GBJFNGCDKPM_Type == IHDHKBEMADL)
			{
				if(_EOLFJGMAJAB_CurrentTime >= HOFCPIHMHNB[i].CCPECDBPFCJ + HOFCPIHMHNB[i].JOFAGCFNKIO)
				{
	...
	{
		MFNEHMPBDKK parser = MFNEHMPBDKK.HEGEKFMJNCC(_DBBGALAPFGC_Data);
		{
