...
public class JJCJKALEIAC_HomePickup : DIHHCBACKGG_DbSection
{
	...
	public class COBEFDFGLKA
	{
		...
		private sbyte BHMMADINAJO_sxor; // 0x18
		private int EHOIENNDEDH_IdCrypted; // 0x1C
		private int DGLIDLIIILE_PrioCrypted; // 0x20
		private int AECMLPKCEAE_AssetIdCrypted; // 0x24
		private sbyte OIFAFKDMEEJ_EnabledCrypted; // 0x28
		private sbyte ECDMGKIIKFL_PickupCrypted; // 0x29
		private sbyte NFMBDLMHEKK_PopupCrypted; // 0x2A
		private sbyte PLOLPNDKCDM_Crypted; // 0x2B
		private sbyte OEPIBOJMOBF_Crypted; // 0x2C
		private sbyte NJCHGIFEIKF_Crypted; // 0x2D
		...
		private int LCMLPPFCGJA_Crypted; // 0x44
		private int KEEEAALEKDG_Crypted; // 0x48
		private sbyte KHNPKIBAKFB_Crypted; // 0x4C
		...
		[UMOMember()]
		public int KNHOMNONOEB_AssetId { get { return AECMLPKCEAE_AssetIdCrypted ^ FBGGEFFJJHB_xor; } set { AECMLPKCEAE_AssetIdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x134F1D8 NECFMEFKKPH_get_AssetId 0x134EBA0 MHNEFLJACHA_set_AssetId
		[UMOMember()]
		public sbyte PPEGAKEIEGM_Enabled { get { return (sbyte)(OIFAFKDMEEJ_EnabledCrypted ^ BHMMADINAJO_sxor); } set { OIFAFKDMEEJ_EnabledCrypted = (sbyte)(value ^ BHMMADINAJO_sxor); } } //0x134F1E8 KPOEEPIMMJP_bgs 0x134EBB0 NCIEAFEDPBH_bgs
		[UMOMember()]
		public sbyte JOPPFEHKNFO_Pickup { get { return (sbyte)(ECDMGKIIKFL_PickupCrypted ^ BHMMADINAJO_sxor); } set { ECDMGKIIKFL_PickupCrypted = (sbyte)(value ^ BHMMADINAJO_sxor); } } //0x134F1FC FNIOGOJFLMG_get_Pickup 0x134EBC0 AJIOKKIJBED_set_Pickup
		[UMOMember()]
		public sbyte OFMECFHNCHA_Popup { get { return (sbyte)(NFMBDLMHEKK_PopupCrypted ^ BHMMADINAJO_sxor); } set { NFMBDLMHEKK_PopupCrypted = (sbyte)(value ^ BHMMADINAJO_sxor); } } //0x134F210 OCBFEBBDDFI_get_Popup 0x134EBD0 BMFCGGIPJDL_set_Popup
		[UMOMember()]
		public sbyte GMELAKNFKMG { get { return (sbyte)(PLOLPNDKCDM_Crypted ^ BHMMADINAJO_sxor); } set { PLOLPNDKCDM_Crypted = (sbyte)(value ^ BHMMADINAJO_sxor); } } //0x134F224 GNIIGNBNAJF_get_ 0x134EBE0 DNGBCJOKLND_set_
		[UMOMember()]
		public sbyte ODOAFNMJIMA { get { return (sbyte)(OEPIBOJMOBF_Crypted ^ BHMMADINAJO_sxor); } set { OEPIBOJMOBF_Crypted = (sbyte)(value ^ BHMMADINAJO_sxor); } } //0x134F238 GGOLPHFOEAJ_get_ 0x134EC9C FKMPBPDOBIO_set_
		[UMOMember()]
		public sbyte ADHCKHFANAL { get { return (sbyte)(NJCHGIFEIKF_Crypted ^ BHMMADINAJO_sxor); } set { NJCHGIFEIKF_Crypted = (sbyte)(value ^ BHMMADINAJO_sxor); } } //0x134F24C LPICEPPJOMO_get_ 0x134EC8C EHJIKIJEILL_set_
		[UMOMember()]
		...
		[UMOMember()]
		public int JPKPDCCGGLA { get { return LCMLPPFCGJA_Crypted ^ FBGGEFFJJHB_xor; } set { LCMLPPFCGJA_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x134F298 KMHGMKABEAE_get_ 0x134ECFC PCFICMIDNGC_set_
		[UMOMember()]
		public int AMKJDECHIOF { get { return KEEEAALEKDG_Crypted ^ FBGGEFFJJHB_xor; } set { KEEEAALEKDG_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x134F2A8 CFKKLJPHGJL_get_ 0x134ED0C BNAMIEALHOB_set_
		[UMOMember()]
		public sbyte KLHGOPBIOCN { get { return (sbyte)(KHNPKIBAKFB_Crypted ^ BHMMADINAJO_sxor); } set { KHNPKIBAKFB_Crypted = (sbyte)(value ^ BHMMADINAJO_sxor); } } //0x134F2B8 PGEKHCMFGAB_get_ 0x134ED1C INPFJDENBAC_set_
		[UMOMember()]
		...
		public COBEFDFGLKA()
		{
			...
			BBEGLBMOBOF_xorl = -1;
			BHMMADINAJO_sxor = (sbyte)FBGGEFFJJHB_xor;
			KLHGOPBIOCN = 0;
			KGICDMIJGDF_Group = 0;
			JPKPDCCGGLA = 0;
			AMKJDECHIOF = 0;
	...
	public class KOCBFBJBHLJ
	{
		...
		public int AECMLPKCEAE_AssetIdCrypted; // 0x14
		...
		[UMOMember()]
		public int KNHOMNONOEB_AssetId { get { return AECMLPKCEAE_AssetIdCrypted ^ FBGGEFFJJHB_xor; } set { AECMLPKCEAE_AssetIdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x134F360 NECFMEFKKPH_get_AssetId 0x134EE1C MHNEFLJACHA_set_AssetId
		[UMOMember()]
	...
	public class OHPHKIFMPEK
	{
		...
		private int EHOIENNDEDH_IdCrypted; // 0x1C
		private int AECMLPKCEAE_AssetIdCrypted; // 0x20
		private int NOFECLGOLAI_TypeCrypted; // 0x24
		private int BOBIDKJJEIM_OpenTimeCrypted; // 0x28
		private int EIJOIHNONKF_EndCrypted; // 0x2C
		private long OHCFBOKAOFO_Crypted; // 0x30
		...
		[UMOMember()]
		public long CCPECDBPFCJ { get { return OHCFBOKAOFO_Crypted ^ BBEGLBMOBOF_xorl; } set { OHCFBOKAOFO_Crypted = value ^ BBEGLBMOBOF_xorl; } } //0x134DD68 AALOFMLBJJG_get_ 0x134EF74 MJNKKKHHMGF_set_
		// Type
		[UMOMember()]
		...
		[UMOMember()]
		public int JOFAGCFNKIO_OpenTime { get { return BOBIDKJJEIM_OpenTimeCrypted ^ FBGGEFFJJHB_xor; } set { BOBIDKJJEIM_OpenTimeCrypted = value ^ FBGGEFFJJHB_xor; } } //0x134DD7C JDJIHKNFDLG_get_OpenTime 0x134EFA4 JNKGBAPAGOB_set_OpenTime
		[UMOMember()]
		public int EBCHFBIINDP_End { get { return EIJOIHNONKF_EndCrypted ^ FBGGEFFJJHB_xor; } set { EIJOIHNONKF_EndCrypted = value ^ FBGGEFFJJHB_xor; } } //0x134DD8C LHAMEHALKDB_get_End 0x134EFB4 DHAPDOLCLHO_set_End
		[UMOMember()]
		public int KNHOMNONOEB_AssetId { get { return AECMLPKCEAE_AssetIdCrypted ^ FBGGEFFJJHB_xor; } set { AECMLPKCEAE_AssetIdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x134F3AC NECFMEFKKPH_get_AssetId 0x134EFC4 MHNEFLJACHA_set_AssetId
		[UMOMember()]
