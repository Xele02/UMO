...
public class GJALOMELEHD_Intimacy : DIHHCBACKGG
{
	public class ELAIMNHBCFB
	{
		...
		// public int PPFNGGCBJKC_Id { get; set; } 0xAAADE4 DEMEPMAEJOO 0xAA9C0C HIGKAIDMOKN
	...
	public class AHIGPDEDCFO
	{
		...
		// public int PPFNGGCBJKC_Id { get; set; } 0xAAACB4 DEMEPMAEJOO 0xAAA430 HIGKAIDMOKN
