...
public sealed class NKMABFBAGCI : Table {
  public static NKMABFBAGCI GetRootAsNKMABFBAGCI(ByteBuffer _bb) { return GetRootAsNKMABFBAGCI(_bb, new NKMABFBAGCI()); }
  public static NKMABFBAGCI GetRootAsNKMABFBAGCI(ByteBuffer _bb, NKMABFBAGCI obj) { return (obj.__init(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public NKMABFBAGCI __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public static Offset<NKMABFBAGCI> CreateNKMABFBAGCI(FlatBufferBuilder builder,
      int BBPHAPFBFHK = 0,
    ...
    NKMABFBAGCI.AddNMEEJNHKPCN(builder, NMEEJNHKPCNOffset);
    NKMABFBAGCI.AddNGGAJCBPGFI(builder, NGGAJCBPGFIOffset);
    NKMABFBAGCI.AddBNCIPLKECMC(builder, BNCIPLKECMCOffset);
    NKMABFBAGCI.AddLEFPIGNDJNC(builder, LEFPIGNDJNCOffset);
    NKMABFBAGCI.AddBBPHAPFBFHK(builder, BBPHAPFBFHK);
    return NKMABFBAGCI.EndNKMABFBAGCI(builder);
  }

  public static void StartNKMABFBAGCI(FlatBufferBuilder builder) { builder.StartObject(5); }
  ...
  public static Offset<NKMABFBAGCI> EndNKMABFBAGCI(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<NKMABFBAGCI>(o);
  }
};
