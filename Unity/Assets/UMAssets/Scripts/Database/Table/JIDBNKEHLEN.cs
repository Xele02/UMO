...
public sealed class JIDBNKEHLEN : Table {
  public static JIDBNKEHLEN GetRootAsJIDBNKEHLEN(ByteBuffer _bb) { return GetRootAsJIDBNKEHLEN(_bb, new JIDBNKEHLEN()); }
  public static JIDBNKEHLEN GetRootAsJIDBNKEHLEN(ByteBuffer _bb, JIDBNKEHLEN obj) { return (obj.__init(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public JIDBNKEHLEN __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public static Offset<JIDBNKEHLEN> CreateJIDBNKEHLEN(FlatBufferBuilder builder,
      uint BBPHAPFBFHK = 0,
      uint CFLMCGOJJJD = 0,
      uint LPJPOOHJKAE = 0,
      uint AEAKMMJLLDK = 0,
    ...
    JIDBNKEHLEN.AddHBHEHJDPEBI(builder, HBHEHJDPEBI);
    JIDBNKEHLEN.AddKMEODDMBHHE(builder, KMEODDMBHHE);
    JIDBNKEHLEN.AddGLIIHLOLPEF(builder, GLIIHLOLPEF);
    JIDBNKEHLEN.AddEBBBDFADIPN(builder, EBBBDFADIPN);
    JIDBNKEHLEN.AddGPBKFHCJEPD(builder, GPBKFHCJEPD);
    JIDBNKEHLEN.AddEGCKDOIIACL(builder, EGCKDOIIACL);
    JIDBNKEHLEN.AddOADMJNEOKLC(builder, OADMJNEOKLC);
    JIDBNKEHLEN.AddIMCFOKIBEMC(builder, IMCFOKIBEMC);
    JIDBNKEHLEN.AddMBBJMJAAODG(builder, MBBJMJAAODG);
    JIDBNKEHLEN.AddENECIEOGIJC(builder, ENECIEOGIJC);
    JIDBNKEHLEN.AddMPMOLHBIKKG(builder, MPMOLHBIKKG);
    JIDBNKEHLEN.AddPBAJJGLCCDO(builder, PBAJJGLCCDO);
    JIDBNKEHLEN.AddAJHANMOKKDF(builder, AJHANMOKKDF);
    JIDBNKEHLEN.AddGJJPLLHMMAF(builder, GJJPLLHMMAF);
    JIDBNKEHLEN.AddANOHJLDOAAK(builder, ANOHJLDOAAK);
    JIDBNKEHLEN.AddGAHFANCNFIH(builder, GAHFANCNFIH);
    JIDBNKEHLEN.AddPJCPCILBICH(builder, PJCPCILBICH);
    JIDBNKEHLEN.AddNFPKGHADCCP(builder, NFPKGHADCCP);
    JIDBNKEHLEN.AddNMGIFIOPMIJ(builder, NMGIFIOPMIJ);
    JIDBNKEHLEN.AddJGAGKFPAAIB(builder, JGAGKFPAAIBOffset);
    JIDBNKEHLEN.AddNNKLANONDOM(builder, NNKLANONDOMOffset);
    JIDBNKEHLEN.AddAEAKMMJLLDK(builder, AEAKMMJLLDK);
    JIDBNKEHLEN.AddLPJPOOHJKAE(builder, LPJPOOHJKAE);
    JIDBNKEHLEN.AddCFLMCGOJJJD(builder, CFLMCGOJJJD);
    JIDBNKEHLEN.AddBBPHAPFBFHK(builder, BBPHAPFBFHK);
    return JIDBNKEHLEN.EndJIDBNKEHLEN(builder);
  }

  public static void StartJIDBNKEHLEN(FlatBufferBuilder builder) { builder.StartObject(25); }
  ...
  public static Offset<JIDBNKEHLEN> EndJIDBNKEHLEN(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<JIDBNKEHLEN>(o);
  }
};
