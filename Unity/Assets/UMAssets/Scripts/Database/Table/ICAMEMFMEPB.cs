...
public sealed class ICAMEMFMEPB : Table {
  public static ICAMEMFMEPB GetRootAsICAMEMFMEPB(ByteBuffer _bb) { return GetRootAsICAMEMFMEPB(_bb, new ICAMEMFMEPB()); }
  public static ICAMEMFMEPB GetRootAsICAMEMFMEPB(ByteBuffer _bb, ICAMEMFMEPB obj) { return (obj.__init(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public ICAMEMFMEPB __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public static Offset<ICAMEMFMEPB> CreateICAMEMFMEPB(FlatBufferBuilder builder,
      uint BBPHAPFBFHK = 0,
      uint NJLJEKDBPCH = 0,
      uint MAOAGDBDBIB = 0,
      StringOffset NNKLANONDOMOffset = default(StringOffset)) {
    builder.StartObject(4);
    ICAMEMFMEPB.AddNNKLANONDOM(builder, NNKLANONDOMOffset);
    ICAMEMFMEPB.AddMAOAGDBDBIB(builder, MAOAGDBDBIB);
    ICAMEMFMEPB.AddNJLJEKDBPCH(builder, NJLJEKDBPCH);
    ICAMEMFMEPB.AddBBPHAPFBFHK(builder, BBPHAPFBFHK);
    return ICAMEMFMEPB.EndICAMEMFMEPB(builder);
  }

  public static void StartICAMEMFMEPB(FlatBufferBuilder builder) { builder.StartObject(4); }
  ...
  public static Offset<ICAMEMFMEPB> EndICAMEMFMEPB(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<ICAMEMFMEPB>(o);
  }
};
