...
public sealed class ILCAGMDDGIO : Table {
  public static ILCAGMDDGIO GetRootAsILCAGMDDGIO(ByteBuffer _bb) { return GetRootAsILCAGMDDGIO(_bb, new ILCAGMDDGIO()); }
  public static ILCAGMDDGIO GetRootAsILCAGMDDGIO(ByteBuffer _bb, ILCAGMDDGIO obj) { return (obj.__init(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public ILCAGMDDGIO __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public static Offset<ILCAGMDDGIO> CreateILCAGMDDGIO(FlatBufferBuilder builder,
      uint BBPHAPFBFHK = 0,
      uint CFLMCGOJJJD = 0,
      uint HHFEPINGMEI = 0,
      uint NJLJEKDBPCH = 0,
    ...
    ILCAGMDDGIO.AddMAOAGDBDBIB(builder, MAOAGDBDBIB);
    ILCAGMDDGIO.AddNJLJEKDBPCH(builder, NJLJEKDBPCH);
    ILCAGMDDGIO.AddHHFEPINGMEI(builder, HHFEPINGMEI);
    ILCAGMDDGIO.AddCFLMCGOJJJD(builder, CFLMCGOJJJD);
    ILCAGMDDGIO.AddBBPHAPFBFHK(builder, BBPHAPFBFHK);
    return ILCAGMDDGIO.EndILCAGMDDGIO(builder);
  }

  public static void StartILCAGMDDGIO(FlatBufferBuilder builder) { builder.StartObject(5); }
  ...
  public static Offset<ILCAGMDDGIO> EndILCAGMDDGIO(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<ILCAGMDDGIO>(o);
  }
};
