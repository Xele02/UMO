...
public sealed class ODMKHCAIAAI : Table {
  public static ODMKHCAIAAI GetRootAsODMKHCAIAAI(ByteBuffer _bb) { return GetRootAsODMKHCAIAAI(_bb, new ODMKHCAIAAI()); }
  public static ODMKHCAIAAI GetRootAsODMKHCAIAAI(ByteBuffer _bb, ODMKHCAIAAI obj) { return (obj.__init(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public ODMKHCAIAAI __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public static Offset<ODMKHCAIAAI> CreateODMKHCAIAAI(FlatBufferBuilder builder,
      uint BBPHAPFBFHK = 0,
      uint CFLMCGOJJJD = 0,
      uint LPJPOOHJKAE = 0,
      uint AEAKMMJLLDK = 0,
    ...
    ODMKHCAIAAI.AddKMEODDMBHHE(builder, KMEODDMBHHE);
    ODMKHCAIAAI.AddGLIIHLOLPEF(builder, GLIIHLOLPEF);
    ODMKHCAIAAI.AddEBBBDFADIPN(builder, EBBBDFADIPN);
    ODMKHCAIAAI.AddGPBKFHCJEPD(builder, GPBKFHCJEPD);
    ODMKHCAIAAI.AddEGCKDOIIACL(builder, EGCKDOIIACL);
    ODMKHCAIAAI.AddOADMJNEOKLC(builder, OADMJNEOKLC);
    ODMKHCAIAAI.AddIMCFOKIBEMC(builder, IMCFOKIBEMC);
    ODMKHCAIAAI.AddMBBJMJAAODG(builder, MBBJMJAAODG);
    ODMKHCAIAAI.AddENECIEOGIJC(builder, ENECIEOGIJC);
    ODMKHCAIAAI.AddMPMOLHBIKKG(builder, MPMOLHBIKKG);
    ODMKHCAIAAI.AddPBAJJGLCCDO(builder, PBAJJGLCCDO);
    ODMKHCAIAAI.AddAJHANMOKKDF(builder, AJHANMOKKDF);
    ODMKHCAIAAI.AddGJJPLLHMMAF(builder, GJJPLLHMMAF);
    ODMKHCAIAAI.AddANOHJLDOAAK(builder, ANOHJLDOAAK);
    ODMKHCAIAAI.AddGAHFANCNFIH(builder, GAHFANCNFIH);
    ODMKHCAIAAI.AddPJCPCILBICH(builder, PJCPCILBICH);
    ODMKHCAIAAI.AddNFPKGHADCCP(builder, NFPKGHADCCP);
    ODMKHCAIAAI.AddNMGIFIOPMIJ(builder, NMGIFIOPMIJ);
    ODMKHCAIAAI.AddJGAGKFPAAIB(builder, JGAGKFPAAIBOffset);
    ODMKHCAIAAI.AddNNKLANONDOM(builder, NNKLANONDOMOffset);
    ODMKHCAIAAI.AddAEAKMMJLLDK(builder, AEAKMMJLLDK);
    ODMKHCAIAAI.AddLPJPOOHJKAE(builder, LPJPOOHJKAE);
    ODMKHCAIAAI.AddCFLMCGOJJJD(builder, CFLMCGOJJJD);
    ODMKHCAIAAI.AddBBPHAPFBFHK(builder, BBPHAPFBFHK);
    return ODMKHCAIAAI.EndODMKHCAIAAI(builder);
  }

  public static void StartODMKHCAIAAI(FlatBufferBuilder builder) { builder.StartObject(24); }
  ...
  public static Offset<ODMKHCAIAAI> EndODMKHCAIAAI(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<ODMKHCAIAAI>(o);
  }
};
