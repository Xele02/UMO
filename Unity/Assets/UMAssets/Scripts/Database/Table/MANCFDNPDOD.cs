...
public sealed class MANCFDNPDOD : Table {
  public static MANCFDNPDOD GetRootAsMANCFDNPDOD(ByteBuffer _bb) { return GetRootAsMANCFDNPDOD(_bb, new MANCFDNPDOD()); }
  public static MANCFDNPDOD GetRootAsMANCFDNPDOD(ByteBuffer _bb, MANCFDNPDOD obj) { return (obj.__init(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public MANCFDNPDOD __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public static Offset<MANCFDNPDOD> CreateMANCFDNPDOD(FlatBufferBuilder builder,
      int OEBLGFLPMNE = 0,
      int BJELMJJFMBI = 0,
      VectorOffset IHNCJBFCAAIOffset = default(VectorOffset)) {
    builder.StartObject(3);
    MANCFDNPDOD.AddIHNCJBFCAAI(builder, IHNCJBFCAAIOffset);
    MANCFDNPDOD.AddBJELMJJFMBI(builder, BJELMJJFMBI);
    MANCFDNPDOD.AddOEBLGFLPMNE(builder, OEBLGFLPMNE);
    return MANCFDNPDOD.EndMANCFDNPDOD(builder);
  }

  public static void StartMANCFDNPDOD(FlatBufferBuilder builder) { builder.StartObject(3); }
  ...
  public static Offset<MANCFDNPDOD> EndMANCFDNPDOD(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<MANCFDNPDOD>(o);
  }
};
