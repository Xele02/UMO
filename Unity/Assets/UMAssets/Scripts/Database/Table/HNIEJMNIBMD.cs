...
public sealed class HNIEJMNIBMD : Table {
  public static HNIEJMNIBMD GetRootAsHNIEJMNIBMD(ByteBuffer _bb) { return GetRootAsHNIEJMNIBMD(_bb, new HNIEJMNIBMD()); }
  public static HNIEJMNIBMD GetRootAsHNIEJMNIBMD(ByteBuffer _bb, HNIEJMNIBMD obj) { return (obj.__init(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public HNIEJMNIBMD __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public static Offset<HNIEJMNIBMD> CreateHNIEJMNIBMD(FlatBufferBuilder builder,
      uint BBPHAPFBFHK = 0,
      uint CFLMCGOJJJD = 0,
      uint LPJPOOHJKAE = 0,
      uint AEAKMMJLLDK = 0,
    ...
    HNIEJMNIBMD.AddHBHEHJDPEBI(builder, HBHEHJDPEBI);
    HNIEJMNIBMD.AddKMEODDMBHHE(builder, KMEODDMBHHE);
    HNIEJMNIBMD.AddGLIIHLOLPEF(builder, GLIIHLOLPEF);
    HNIEJMNIBMD.AddEBBBDFADIPN(builder, EBBBDFADIPN);
    HNIEJMNIBMD.AddGPBKFHCJEPD(builder, GPBKFHCJEPD);
    HNIEJMNIBMD.AddEGCKDOIIACL(builder, EGCKDOIIACL);
    HNIEJMNIBMD.AddOADMJNEOKLC(builder, OADMJNEOKLC);
    HNIEJMNIBMD.AddIMCFOKIBEMC(builder, IMCFOKIBEMC);
    HNIEJMNIBMD.AddMBBJMJAAODG(builder, MBBJMJAAODG);
    HNIEJMNIBMD.AddENECIEOGIJC(builder, ENECIEOGIJC);
    HNIEJMNIBMD.AddMPMOLHBIKKG(builder, MPMOLHBIKKG);
    HNIEJMNIBMD.AddPBAJJGLCCDO(builder, PBAJJGLCCDO);
    HNIEJMNIBMD.AddAJHANMOKKDF(builder, AJHANMOKKDF);
    HNIEJMNIBMD.AddGJJPLLHMMAF(builder, GJJPLLHMMAF);
    HNIEJMNIBMD.AddANOHJLDOAAK(builder, ANOHJLDOAAK);
    HNIEJMNIBMD.AddGAHFANCNFIH(builder, GAHFANCNFIH);
    HNIEJMNIBMD.AddPJCPCILBICH(builder, PJCPCILBICH);
    HNIEJMNIBMD.AddNFPKGHADCCP(builder, NFPKGHADCCP);
    HNIEJMNIBMD.AddNMGIFIOPMIJ(builder, NMGIFIOPMIJ);
    HNIEJMNIBMD.AddJGAGKFPAAIB(builder, JGAGKFPAAIBOffset);
    HNIEJMNIBMD.AddNNKLANONDOM(builder, NNKLANONDOMOffset);
    HNIEJMNIBMD.AddAEAKMMJLLDK(builder, AEAKMMJLLDK);
    HNIEJMNIBMD.AddLPJPOOHJKAE(builder, LPJPOOHJKAE);
    HNIEJMNIBMD.AddCFLMCGOJJJD(builder, CFLMCGOJJJD);
    HNIEJMNIBMD.AddBBPHAPFBFHK(builder, BBPHAPFBFHK);
    return HNIEJMNIBMD.EndHNIEJMNIBMD(builder);
  }

  public static void StartHNIEJMNIBMD(FlatBufferBuilder builder) { builder.StartObject(25); }
  ...
  public static Offset<HNIEJMNIBMD> EndHNIEJMNIBMD(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<HNIEJMNIBMD>(o);
  }
};
