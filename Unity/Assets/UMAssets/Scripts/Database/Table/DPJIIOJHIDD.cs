...
public sealed class DPJIIOJHIDD : Table {
  public static DPJIIOJHIDD GetRootAsDPJIIOJHIDD(ByteBuffer _bb) { return GetRootAsDPJIIOJHIDD(_bb, new DPJIIOJHIDD()); }
  public static DPJIIOJHIDD GetRootAsDPJIIOJHIDD(ByteBuffer _bb, DPJIIOJHIDD obj) { return (obj.__init(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public DPJIIOJHIDD __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public static Offset<DPJIIOJHIDD> CreateDPJIIOJHIDD(FlatBufferBuilder builder,
      uint BBPHAPFBFHK = 0,
      uint HJNPKHJJDBB = 0,
    ...
    DPJIIOJHIDD.AddPODPGCKCBEO(builder, PODPGCKCBEOOffset);
    DPJIIOJHIDD.AddALPALMJMJJK(builder, ALPALMJMJJK);
    DPJIIOJHIDD.AddOOJBHHPJONJ(builder, OOJBHHPJONJOffset);
    DPJIIOJHIDD.AddBNCIPLKECMC(builder, BNCIPLKECMCOffset);
    DPJIIOJHIDD.AddLEFPIGNDJNC(builder, LEFPIGNDJNCOffset);
    DPJIIOJHIDD.AddHJNPKHJJDBB(builder, HJNPKHJJDBB);
    DPJIIOJHIDD.AddBBPHAPFBFHK(builder, BBPHAPFBFHK);
    return DPJIIOJHIDD.EndDPJIIOJHIDD(builder);
  }

  public static void StartDPJIIOJHIDD(FlatBufferBuilder builder) { builder.StartObject(7); }
  ...
  public static Offset<DPJIIOJHIDD> EndDPJIIOJHIDD(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<DPJIIOJHIDD>(o);
  }
};
