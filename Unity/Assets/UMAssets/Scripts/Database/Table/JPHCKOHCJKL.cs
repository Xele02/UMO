...
public sealed class JPHCKOHCJKL : Table {
  public static JPHCKOHCJKL GetRootAsJPHCKOHCJKL(ByteBuffer _bb) { return GetRootAsJPHCKOHCJKL(_bb, new JPHCKOHCJKL()); }
  public static JPHCKOHCJKL GetRootAsJPHCKOHCJKL(ByteBuffer _bb, JPHCKOHCJKL obj) { return (obj.__init(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public JPHCKOHCJKL __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public static Offset<JPHCKOHCJKL> CreateJPHCKOHCJKL(FlatBufferBuilder builder,
      uint BBPHAPFBFHK = 0,
      uint HJNPKHJJDBB = 0,
    ...
    JPHCKOHCJKL.AddPODPGCKCBEO(builder, PODPGCKCBEOOffset);
    JPHCKOHCJKL.AddALPALMJMJJK(builder, ALPALMJMJJK);
    JPHCKOHCJKL.AddOOJBHHPJONJ(builder, OOJBHHPJONJOffset);
    JPHCKOHCJKL.AddBNCIPLKECMC(builder, BNCIPLKECMCOffset);
    JPHCKOHCJKL.AddLEFPIGNDJNC(builder, LEFPIGNDJNCOffset);
    JPHCKOHCJKL.AddHJNPKHJJDBB(builder, HJNPKHJJDBB);
    JPHCKOHCJKL.AddBBPHAPFBFHK(builder, BBPHAPFBFHK);
    return JPHCKOHCJKL.EndJPHCKOHCJKL(builder);
  }

  public static void StartJPHCKOHCJKL(FlatBufferBuilder builder) { builder.StartObject(7); }
  ...
  public static Offset<JPHCKOHCJKL> EndJPHCKOHCJKL(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<JPHCKOHCJKL>(o);
  }
};
