...
public sealed class NKAGFIBDIJL : Table {
  public static NKAGFIBDIJL GetRootAsNKAGFIBDIJL(ByteBuffer _bb) { return GetRootAsNKAGFIBDIJL(_bb, new NKAGFIBDIJL()); }
  public static NKAGFIBDIJL GetRootAsNKAGFIBDIJL(ByteBuffer _bb, NKAGFIBDIJL obj) { return (obj.__init(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public NKAGFIBDIJL __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public static Offset<NKAGFIBDIJL> CreateNKAGFIBDIJL(FlatBufferBuilder builder,
      uint BBPHAPFBFHK = 0,
      uint HJNPKHJJDBB = 0,
    ...
    NKAGFIBDIJL.AddPODPGCKCBEO(builder, PODPGCKCBEOOffset);
    NKAGFIBDIJL.AddALPALMJMJJK(builder, ALPALMJMJJK);
    NKAGFIBDIJL.AddOOJBHHPJONJ(builder, OOJBHHPJONJOffset);
    NKAGFIBDIJL.AddBNCIPLKECMC(builder, BNCIPLKECMCOffset);
    NKAGFIBDIJL.AddLEFPIGNDJNC(builder, LEFPIGNDJNCOffset);
    NKAGFIBDIJL.AddHJNPKHJJDBB(builder, HJNPKHJJDBB);
    NKAGFIBDIJL.AddBBPHAPFBFHK(builder, BBPHAPFBFHK);
    return NKAGFIBDIJL.EndNKAGFIBDIJL(builder);
  }

  public static void StartNKAGFIBDIJL(FlatBufferBuilder builder) { builder.StartObject(7); }
  ...
  public static Offset<NKAGFIBDIJL> EndNKAGFIBDIJL(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<NKAGFIBDIJL>(o);
  }
};
