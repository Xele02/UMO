...
public sealed class LKEFGGDDBJK : Table {
  public static LKEFGGDDBJK GetRootAsLKEFGGDDBJK(ByteBuffer _bb) { return GetRootAsLKEFGGDDBJK(_bb, new LKEFGGDDBJK()); }
  public static LKEFGGDDBJK GetRootAsLKEFGGDDBJK(ByteBuffer _bb, LKEFGGDDBJK obj) { return (obj.__init(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public LKEFGGDDBJK __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public uint CFMIBDJFAMO { get { int o = __offset(52); return o != 0 ? bb.GetUint(o + bb_pos) : (uint)0; } }

  public static Offset<LKEFGGDDBJK> CreateLKEFGGDDBJK(FlatBufferBuilder builder,
      uint BBPHAPFBFHK = 0,
      uint CFLMCGOJJJD = 0,
      uint LPJPOOHJKAE = 0,
      uint AEAKMMJLLDK = 0,
    ...
    LKEFGGDDBJK.AddCFMIBDJFAMO(builder, CFMIBDJFAMO);
    LKEFGGDDBJK.AddKMEODDMBHHE(builder, KMEODDMBHHE);
    LKEFGGDDBJK.AddGLIIHLOLPEF(builder, GLIIHLOLPEF);
    LKEFGGDDBJK.AddEBBBDFADIPN(builder, EBBBDFADIPN);
    LKEFGGDDBJK.AddGPBKFHCJEPD(builder, GPBKFHCJEPD);
    LKEFGGDDBJK.AddEGCKDOIIACL(builder, EGCKDOIIACL);
    LKEFGGDDBJK.AddOADMJNEOKLC(builder, OADMJNEOKLC);
    LKEFGGDDBJK.AddIMCFOKIBEMC(builder, IMCFOKIBEMC);
    LKEFGGDDBJK.AddMBBJMJAAODG(builder, MBBJMJAAODG);
    LKEFGGDDBJK.AddENECIEOGIJC(builder, ENECIEOGIJC);
    LKEFGGDDBJK.AddMPMOLHBIKKG(builder, MPMOLHBIKKG);
    LKEFGGDDBJK.AddPBAJJGLCCDO(builder, PBAJJGLCCDO);
    LKEFGGDDBJK.AddAJHANMOKKDF(builder, AJHANMOKKDF);
    LKEFGGDDBJK.AddGJJPLLHMMAF(builder, GJJPLLHMMAF);
    LKEFGGDDBJK.AddANOHJLDOAAK(builder, ANOHJLDOAAK);
    LKEFGGDDBJK.AddGAHFANCNFIH(builder, GAHFANCNFIH);
    LKEFGGDDBJK.AddPJCPCILBICH(builder, PJCPCILBICH);
    LKEFGGDDBJK.AddNFPKGHADCCP(builder, NFPKGHADCCP);
    LKEFGGDDBJK.AddNMGIFIOPMIJ(builder, NMGIFIOPMIJ);
    LKEFGGDDBJK.AddJGAGKFPAAIB(builder, JGAGKFPAAIBOffset);
    LKEFGGDDBJK.AddNNKLANONDOM(builder, NNKLANONDOMOffset);
    LKEFGGDDBJK.AddAEAKMMJLLDK(builder, AEAKMMJLLDK);
    LKEFGGDDBJK.AddLPJPOOHJKAE(builder, LPJPOOHJKAE);
    LKEFGGDDBJK.AddCFLMCGOJJJD(builder, CFLMCGOJJJD);
    LKEFGGDDBJK.AddBBPHAPFBFHK(builder, BBPHAPFBFHK);
    return LKEFGGDDBJK.EndLKEFGGDDBJK(builder);
  }

  public static void StartLKEFGGDDBJK(FlatBufferBuilder builder) { builder.StartObject(25); }
  ...
  public static void AddCFMIBDJFAMO(FlatBufferBuilder builder, uint CFMIBDJFAMO) { builder.AddUint(24, CFMIBDJFAMO, 0); }
  public static Offset<LKEFGGDDBJK> EndLKEFGGDDBJK(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<LKEFGGDDBJK>(o);
  }
};
