...
public sealed class PHLPHMPPNON : Table {
  public static PHLPHMPPNON GetRootAsPHLPHMPPNON(ByteBuffer _bb) { return GetRootAsPHLPHMPPNON(_bb, new PHLPHMPPNON()); }
  public static PHLPHMPPNON GetRootAsPHLPHMPPNON(ByteBuffer _bb, PHLPHMPPNON obj) { return (obj.__init(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public PHLPHMPPNON __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public static Offset<PHLPHMPPNON> CreatePHLPHMPPNON(FlatBufferBuilder builder,
      uint BBPHAPFBFHK = 0,
      uint NJLJEKDBPCH = 0,
      uint MAOAGDBDBIB = 0,
      StringOffset NNKLANONDOMOffset = default(StringOffset)) {
    builder.StartObject(4);
    PHLPHMPPNON.AddNNKLANONDOM(builder, NNKLANONDOMOffset);
    PHLPHMPPNON.AddMAOAGDBDBIB(builder, MAOAGDBDBIB);
    PHLPHMPPNON.AddNJLJEKDBPCH(builder, NJLJEKDBPCH);
    PHLPHMPPNON.AddBBPHAPFBFHK(builder, BBPHAPFBFHK);
    return PHLPHMPPNON.EndPHLPHMPPNON(builder);
  }

  public static void StartPHLPHMPPNON(FlatBufferBuilder builder) { builder.StartObject(4); }
  ...
  public static Offset<PHLPHMPPNON> EndPHLPHMPPNON(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<PHLPHMPPNON>(o);
  }
};
