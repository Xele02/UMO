...
public sealed class MINHCKEGNDL : Table {
  public static MINHCKEGNDL GetRootAsMINHCKEGNDL(ByteBuffer _bb) { return GetRootAsMINHCKEGNDL(_bb, new MINHCKEGNDL()); }
  public static MINHCKEGNDL GetRootAsMINHCKEGNDL(ByteBuffer _bb, MINHCKEGNDL obj) { return (obj.__init(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public MINHCKEGNDL __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public static Offset<MINHCKEGNDL> CreateMINHCKEGNDL(FlatBufferBuilder builder,
      uint BBPHAPFBFHK = 0,
      uint CFLMCGOJJJD = 0,
      uint LPJPOOHJKAE = 0,
      uint AEAKMMJLLDK = 0,
    ...
    MINHCKEGNDL.AddHBHEHJDPEBI(builder, HBHEHJDPEBI);
    MINHCKEGNDL.AddKMEODDMBHHE(builder, KMEODDMBHHE);
    MINHCKEGNDL.AddGLIIHLOLPEF(builder, GLIIHLOLPEF);
    MINHCKEGNDL.AddEBBBDFADIPN(builder, EBBBDFADIPN);
    MINHCKEGNDL.AddGPBKFHCJEPD(builder, GPBKFHCJEPD);
    MINHCKEGNDL.AddEGCKDOIIACL(builder, EGCKDOIIACL);
    MINHCKEGNDL.AddOADMJNEOKLC(builder, OADMJNEOKLC);
    MINHCKEGNDL.AddIMCFOKIBEMC(builder, IMCFOKIBEMC);
    MINHCKEGNDL.AddMBBJMJAAODG(builder, MBBJMJAAODG);
    MINHCKEGNDL.AddENECIEOGIJC(builder, ENECIEOGIJC);
    MINHCKEGNDL.AddMPMOLHBIKKG(builder, MPMOLHBIKKG);
    MINHCKEGNDL.AddPBAJJGLCCDO(builder, PBAJJGLCCDO);
    MINHCKEGNDL.AddAJHANMOKKDF(builder, AJHANMOKKDF);
    MINHCKEGNDL.AddGJJPLLHMMAF(builder, GJJPLLHMMAF);
    MINHCKEGNDL.AddANOHJLDOAAK(builder, ANOHJLDOAAK);
    MINHCKEGNDL.AddGAHFANCNFIH(builder, GAHFANCNFIH);
    MINHCKEGNDL.AddPJCPCILBICH(builder, PJCPCILBICH);
    MINHCKEGNDL.AddNFPKGHADCCP(builder, NFPKGHADCCP);
    MINHCKEGNDL.AddNMGIFIOPMIJ(builder, NMGIFIOPMIJ);
    MINHCKEGNDL.AddJGAGKFPAAIB(builder, JGAGKFPAAIBOffset);
    MINHCKEGNDL.AddNNKLANONDOM(builder, NNKLANONDOMOffset);
    MINHCKEGNDL.AddAEAKMMJLLDK(builder, AEAKMMJLLDK);
    MINHCKEGNDL.AddLPJPOOHJKAE(builder, LPJPOOHJKAE);
    MINHCKEGNDL.AddCFLMCGOJJJD(builder, CFLMCGOJJJD);
    MINHCKEGNDL.AddBBPHAPFBFHK(builder, BBPHAPFBFHK);
    return MINHCKEGNDL.EndMINHCKEGNDL(builder);
  }

  public static void StartMINHCKEGNDL(FlatBufferBuilder builder) { builder.StartObject(25); }
  ...
  public static Offset<MINHCKEGNDL> EndMINHCKEGNDL(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<MINHCKEGNDL>(o);
  }
};
