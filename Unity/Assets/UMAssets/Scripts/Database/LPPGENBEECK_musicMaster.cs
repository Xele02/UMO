...
public class KLBKPANJCPL_Score
{
	...
	public int GKNBCINLIJJ_Scid { get; set; } // PIEBLLLAAEF // 0xC ECBOBCJLLOD LFMJPMIHHBF
	public int ANAJIAENLNB_F_pt { get; set; } // IKMILCFHBGA // 0x10 MMOMNMBKHJF FEHNFGPFINK
	public int NLKEBAOBJCM_Cb { get; set; } // ABLBDMPGEHA // 0x14 AECNKGBNKHH ECHLKFHOJFP
	public int KNIFCANOHOC_Ss { get; set; } // DKDLLFCBBCE // 0x18 EOJEPLIPOMJ AEEMBPAEAAI
	public int CKDPPJAHAIP_Dn { get; set; } // MBBGDHGPJDM // 0x1C DBMNFCDGGEC JEFJBPPGBOK
	public int NPKMKMBEOAG_Dnc { get; set; } // AKAEHHAHFDM // 0x20 GHJDKBCAGLL IIEJNMBABCK
	public int NPGCIDONKOP_Sp { get; set; } // AHONHAIELEA // 0x24 GKHINHNGCKE LLPNJHACHEB
	public int MCMIPODICAN { get; set; } // IFGANBEKEAE // 0x28 DAGDLFMEAKG FNGANMMAACC
	public int KIEHDJFCCNM { get; set; } // EGKCBOHGFBA // 0x2C LNPKNMONEFI CEPCIKJKLLF
	public int GEIDIHCKDNO { get; set; } // DDIGBBJDNLF // 0x30 JAOFBBKGCHP IBIPFCNGHFF
	public int JJBOEMOJPEC { get; set; } // BAGPHOPPPPC // 0x34 FGMMNEIIHKM MFKGPCOLFLA
	public int OABPNBLPHHP { get; set; } // GJJGLNLOGHN // 0x38 BMCLOFLOPLO IABNMIBLHAA
	public int GIABDDFGHOK { get; set; } // COGAGDDAEFD // 0x3C EHAGPCANMCN FMJMCAEJMPG
