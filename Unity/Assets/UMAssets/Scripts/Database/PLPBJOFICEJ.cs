...
public class PLPBJOFICEJ_CosItem : DIHHCBACKGG_DbSection
{
	...
	public class IBEMFIAFIKH_ItemInfo
	{
		...
		public int JBGEEPFKIGG_PointValue { get { return ICKOHEDLEFP_PointValueCrypted ^ FBGGEFFJJHB_xor; } set { ICKOHEDLEFP_PointValueCrypted = value ^ FBGGEFFJJHB_xor; } } //0xFEC544 OLOCMINKGON 0xFEBF00 ABAFHIBFKCE
		...
		public int INDDJNMPONH_Category { get { return MKENMKMJFKP_CategoryCrypted ^ FBGGEFFJJHB_xor; } set { MKENMKMJFKP_CategoryCrypted = value ^ FBGGEFFJJHB_xor; } } //0xFEC37C GHAILOLPHPF 0xFEC038 BACGOKIGMBC
	...
	{
		return CDENCMNHNGA_table[OIPCCBHIKIA];
	}
	...
	{
		return CDENCMNHNGA_table.Find((IBEMFIAFIKH_ItemInfo KOGBMDOONFA) =>
		{
			//0xFEC274
			return KOGBMDOONFA.FDBOPFEOENF_Diva == MCDINKAKFGG && KOGBMDOONFA.INDDJNMPONH_Category == (int)_INDDJNMPONH_Cat;
		});
	}
