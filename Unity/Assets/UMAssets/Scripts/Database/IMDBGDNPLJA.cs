...
public class IMDBGDNPLJA_EventBoxGacha : DIHHCBACKGG_DbSection
{
	...
	public override bool IIEMACPEEBJ(byte[] _DBBGALAPFGC_Data)
	{
		...
		if (CurrenEvent != null && CurrenEvent.EnableBlock(JIKKNHIAEKG_BlockName))
		{
			...
			long rDate = /*NGHKJOEDLIP.OHGDNJLFDFF > NGHKJOEDLIP.BONDDBOFBND_RankingStart ? NGHKJOEDLIP.OHGDNJLFDFF : */NGHKJOEDLIP.BONDDBOFBND_RankingStart;
			...
			/*UnityEngine.Debug.LogError(Utility.GetLocalDateTime(NGHKJOEDLIP.BONDDBOFBND_RankingStart).ToLongDateString()+" "+
			...
			NGHKJOEDLIP.OHGDNJLFDFF = NGHKJOEDLIP.BONDDBOFBND_RankingStart;
			NGHKJOEDLIP.PHKLJGNMFBL = NGHKJOEDLIP.HPNOGLIFJOP_End1;

			for(int i = 0; i < KGDBEMPMAIJ_Boxes.Count; i++)
			{
				if (KGDBEMPMAIJ_Boxes[i].PDBPFJJCADD_OpenAt != 0) KGDBEMPMAIJ_Boxes[i].PDBPFJJCADD_OpenAt = NGHKJOEDLIP.BONDDBOFBND_RankingStart;
	...
	private bool DGKKMKLCEDF(KBFIJHDHOGA FGBHBEPCPFI)
	{
		...
		NGHKJOEDLIP.BONDDBOFBND_RankingStart = FGBHBEPCPFI.HMBHNLCFDIH.BONDDBOFBND;
		...
		NGHKJOEDLIP.AHKNMANFILO_DayGroup = (sbyte)FGBHBEPCPFI.HMBHNLCFDIH.AHKNMANFILO;
		...
		NGHKJOEDLIP.FEMMDNIELFC_Desc = FGBHBEPCPFI.HMBHNLCFDIH.FEMMDNIELFC;
