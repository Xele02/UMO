...
public class IMDBGDNPLJA_EventBoxGacha : DIHHCBACKGG_DbSection
{
	public class NFDDNDNBIHB
	{
		...
		public string OCDMGOGMHGE { get { return EBGIDCIIGDO_KeyPrefix.DNJEJEANJGL_Value; } set { EBGIDCIIGDO_KeyPrefix.DNJEJEANJGL_Value = value; } } //0x9FA5E8 HBAAAKFHDBB 0x9F8F08 NHJLJOIPOFK
	...
	public class BKGONBEMGED
	{
		...
		public int JBGEEPFKIGG_Value; // 0x1C
	...
	public class BKEFFIMGDNH
	{
		public int PPFNGGCBJKC_id; // 0x8
		public int PLALNIIBLOF_en; // 0xC
		public int FPOMEEJFBIG_Order; // 0x10
	...
	public Dictionary<string, CEBFFLDKAEC_SecureInt> OHJFBLFELNK_IntArray { get; private set; } // 0x34 KLDCHOIPJGB AEMNOGNEBOJ DGKDBOAMNBB
	...
	{
		KBFIJHDHOGA data = KBFIJHDHOGA.HEGEKFMJNCC(_DBBGALAPFGC_Data);
		DGKKMKLCEDF(data);
		GMILHDEGFDE(data);
		HMGBIBOJDBA(data);
		BJEKIGFCNGJ(data);
		...
		if (CurrenEvent != null && CurrenEvent.EnableBlock(JIKKNHIAEKG_BlockName))
		{
			...
			/*UnityEngine.Debug.LogError(Utility.GetLocalDateTime(NGHKJOEDLIP_Settings.BONDDBOFBND_RankingStart).ToLongDateString()+" "+
				Utility.GetLocalDateTime(NGHKJOEDLIP_Settings.HPNOGLIFJOP_End1).ToLongDateString()+" "+
			...
			for(int i = 0; i < KGDBEMPMAIJ_Boxes.Count; i++)
			{
				...
				if (KGDBEMPMAIJ_Boxes[i].FDBNFFNFOND_CloseAt != 0) KGDBEMPMAIJ_Boxes[i].FDBNFFNFOND_CloseAt = NGHKJOEDLIP_Settings.HPNOGLIFJOP_RankingEnd;
			}
		}
		return true;
	}
	...
	{
		NGHKJOEDLIP_Settings.OBGBAOLONDD_UniqueId = (int)FGBHBEPCPFI.HMBHNLCFDIH.OBGBAOLONDD;
		NGHKJOEDLIP_Settings.OPFGFINHFCE_name = FGBHBEPCPFI.HMBHNLCFDIH.OPFGFINHFCE;
		NGHKJOEDLIP_Settings.OCGFKMHNEOF_name_for_api = FGBHBEPCPFI.HMBHNLCFDIH.OCGFKMHNEOF;
		NGHKJOEDLIP_Settings.BONDDBOFBND_RankingStart = FGBHBEPCPFI.HMBHNLCFDIH.BONDDBOFBND;
		NGHKJOEDLIP_Settings.HPNOGLIFJOP_RankingEnd = FGBHBEPCPFI.HMBHNLCFDIH.HPNOGLIFJOP;
		NGHKJOEDLIP_Settings.LNFKGHNHJKE_RankingEnd2 = FGBHBEPCPFI.HMBHNLCFDIH.LNFKGHNHJKE;
		NGHKJOEDLIP_Settings.FCNKIKOOFKE = FGBHBEPCPFI.HMBHNLCFDIH.FCNKIKOOFKE;
		NGHKJOEDLIP_Settings.JGMDAOACOJF_RewardStart = FGBHBEPCPFI.HMBHNLCFDIH.JGMDAOACOJF;
		NGHKJOEDLIP_Settings.IDDBFFBPNGI_RewardEnd = FGBHBEPCPFI.HMBHNLCFDIH.IDDBFFBPNGI;
		NGHKJOEDLIP_Settings.KNLGKBBIBOH_RewardEnd2 = FGBHBEPCPFI.HMBHNLCFDIH.KNLGKBBIBOH;
		NGHKJOEDLIP_Settings.POGEFBMBPCB_MonthOdd = (sbyte)FGBHBEPCPFI.HMBHNLCFDIH.JMJDLDEIFKE;
		NGHKJOEDLIP_Settings.AHKNMANFILO_DayGroup = (sbyte)FGBHBEPCPFI.HMBHNLCFDIH.AHKNMANFILO;
		NGHKJOEDLIP_Settings.MOEKELIIDEO_SaveIdx = (sbyte)FGBHBEPCPFI.HMBHNLCFDIH.MOEKELIIDEO;
		NGHKJOEDLIP_Settings.OCDMGOGMHGE = FGBHBEPCPFI.HMBHNLCFDIH.OCDMGOGMHGE;
		NGHKJOEDLIP_Settings.MJBKGOJBPAD_item_type = FGBHBEPCPFI.HMBHNLCFDIH.MJBKGOJBPAD;
		NGHKJOEDLIP_Settings.FEMMDNIELFC_Desc = FGBHBEPCPFI.HMBHNLCFDIH.FEMMDNIELFC;
		NGHKJOEDLIP_Settings.HKKNEAGCIEB_RankingSupport = (sbyte)FGBHBEPCPFI.HMBHNLCFDIH.HKKNEAGCIEB;
		NGHKJOEDLIP_Settings.HIOOGLEJBKM_StartAdventureId = FGBHBEPCPFI.HMBHNLCFDIH.HIOOGLEJBKM;
		NGHKJOEDLIP_Settings.FJCADCDNPMP_EndAdventureId = FGBHBEPCPFI.HMBHNLCFDIH.FJCADCDNPMP;
		NGHKJOEDLIP_Settings.EJBGHLOOLBC_HelpIds = FGBHBEPCPFI.HMBHNLCFDIH.EJBGHLOOLBC;
		NGHKJOEDLIP_Settings.OMCAOJJGOGG_Lb = FGBHBEPCPFI.HMBHNLCFDIH.OMCAOJJGOGG;
		NGHKJOEDLIP_Settings.GMFNMNOIJHI = FGBHBEPCPFI.HMBHNLCFDIH.GMFNMNOIJHI;
		NGHKJOEDLIP_Settings.OHGDNJLFDFF_Start = FGBHBEPCPFI.HMBHNLCFDIH.OHGDNJLFDFF;
		NGHKJOEDLIP_Settings.PHKLJGNMFBL_End = FGBHBEPCPFI.HMBHNLCFDIH.PHKLJGNMFBL;
		return true;
	}
	...
	private bool GMILHDEGFDE(KBFIJHDHOGA FGBHBEPCPFI)
	{
		for(int i = 0; i < FGBHBEPCPFI.GCMONMILNMH.Length; i++)
		{
			...
			d.PLALNIIBLOF_en = (int)FGBHBEPCPFI.GCMONMILNMH[i].PLALNIIBLOF;
			...
			d.PDBPFJJCADD_open_at = FGBHBEPCPFI.GCMONMILNMH[i].PDBPFJJCADD;
	...
	//private bool GMILHDEGFDE(EDOHBJAPLPF OBHAFLMHAKG, int _KAPMOPMDHJE_label) { }
	...
	private bool HMGBIBOJDBA(KBFIJHDHOGA FGBHBEPCPFI)
	{
		for(int i = 0; i < FGBHBEPCPFI.BNHMOENHDFB.Length; i++)
		{
			...
			d.PLALNIIBLOF_en = (int)FGBHBEPCPFI.BNHMOENHDFB[i].PLALNIIBLOF;
			...
			d.JBGEEPFKIGG_Value = FGBHBEPCPFI.BNHMOENHDFB[i].JBGEEPFKIGG;
	...
	//private bool HMGBIBOJDBA(EDOHBJAPLPF OBHAFLMHAKG, int _KAPMOPMDHJE_label) { }
	...
	private bool BJEKIGFCNGJ(KBFIJHDHOGA FGBHBEPCPFI)
	{
		for(int i = 0; i < FGBHBEPCPFI.EBJIGPIKKNB.Length; i++)
		{
			...
			d.PLALNIIBLOF_en = (int)FGBHBEPCPFI.EBJIGPIKKNB[i].PLALNIIBLOF;
			d.FPOMEEJFBIG_Order = (int)FGBHBEPCPFI.EBJIGPIKKNB[i].FPOMEEJFBIG;
	...
	//private bool BJEKIGFCNGJ(EDOHBJAPLPF OBHAFLMHAKG, int _KAPMOPMDHJE_label) { }
