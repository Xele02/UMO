...
public class IMDBGDNPLJA_Event { }
public class IMDBGDNPLJA_EventBoxGacha : DIHHCBACKGG_DbSection
{
	public class NFDDNDNBIHB
	{
		...
		public int HIOOGLEJBKM; // 0x7C
		public int FJCADCDNPMP; // 0x80
		public int[] EJBGHLOOLBC; // 0x84

		//public string OCDMGOGMHGE { get; set; } 0x9FA5E8 HBAAAKFHDBB 0x9F8F08 NHJLJOIPOFK
	...
	public class NEFJBPECLKJ
	{
		...
		public int HLOBFDBFINJ; // 0x14
		public int IHGDLBBPKFI; // 0x18
		public string OPFGFINHFCE; // 0x1C
		public int GLCLFMGPMAN; // 0x20
		public int NDNHKMJPBCM; // 0x24
		public long PDBPFJJCADD; // 0x28
		public long FDBNFFNFOND; // 0x30
	...
	public class BKGONBEMGED
	{
		...
		public int IMMDGJAOPCD; // 0x10
		public int AEDMJLGNDHN; // 0x14
		public int GLCLFMGPMAN; // 0x18
		public int JBGEEPFKIGG; // 0x1C
		public int ADPPAIPFHML; // 0x20
	...
	public class BKEFFIMGDNH
	{
		public int PPFNGGCBJKC; // 0x8
		public int PLALNIIBLOF; // 0xC
		public int FPOMEEJFBIG; // 0x10
		public int GPJKJCBPBIP; // 0x14
		public int OAFPGJLCNFM; // 0x18
		public int GBJFNGCDKPM; // 0x1C
		public int NKNAECHNACI; // 0x20
	...
	public List<NEFJBPECLKJ> KGDBEMPMAIJ = new List<NEFJBPECLKJ>(); // 0x24
	public List<BKGONBEMGED> PKPLOGBIDIG = new List<BKGONBEMGED>(); // 0x28
	...
	{
		TodoLogger.Log(TodoLogger.Database, "IMDBGDNPLJA_EventBoxGacha.KMBPACJNEOF");
	}

	// RVA: 0x9F7D50 Offset: 0x9F7D50 VA: 0x9F7D50 Slot: 9
	public override bool IIEMACPEEBJ(byte[] DBBGALAPFGC)
	{
		TodoLogger.Log(TodoLogger.Database, "IMDBGDNPLJA_EventBoxGacha.IIEMACPEEBJ");
		return true;
	}
	...
	{
		TodoLogger.Log(TodoLogger.DbIntegrityCheck, "IMDBGDNPLJA_EventBoxGacha.CAOGDCBPBAN");
		return 0;
	}
}
