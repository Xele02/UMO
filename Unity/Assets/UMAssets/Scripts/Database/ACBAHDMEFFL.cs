...
public class ACBAHDMEFFL_EventMission : DIHHCBACKGG_DbSection
{
	public class IEPCJEPOFCO
	{
		...
		public int HIOOGLEJBKM; // 0x88
		public int FJCADCDNPMP; // 0x8C
		public int[] EJBGHLOOLBC; // 0x90
		public List<int> JKFPADIAKCK = new List<int>(); // 0x94
		public List<int> EEOGPJJCKHH = new List<int>(); // 0x98

		//public string OCDMGOGMHGE { get; set; } 0x15B7B48 HBAAAKFHDBB 0x15B5690 NHJLJOIPOFK
		//public string PJBILOFOCIC { get; set; } 0x15B7B74 NOEFEAIFHCL 0x15B56C4 GJIJFGNONEL
	...
	public class APANPEKLFBC
	{
		...
		//public int PPFNGGCBJKC { get; set; } 0x15B73E0 DEMEPMAEJOO 0x15B73F0 HIGKAIDMOKN
		//public int CNKFPJCGNFE { get; set; } 0x15B7400 GJBOGOFHGNP 0x15B7410 GJDGIDCMJMH
		//public int GNFBMCGMCFO { get; set; } 0x15B7420 NCIMMDJLPLJ 0x15B7430 HNAJAFBHOLM
		//public int BFFGFAMJAIG { get; set; } 0x15B7440 PKMNOMELPMN 0x15B7450 IABBJBAHKCE
	...
	public class HJEGIDJGEBO
	{
		...
		//public int PPFNGGCBJKC { get; set; } 0x15B7AD8 DEMEPMAEJOO 0x15B7AE8 HIGKAIDMOKN
		//public int GNFBMCGMCFO { get; set; } 0x15B7AF8 NCIMMDJLPLJ 0x15B7B08 HNAJAFBHOLM
		//public int BFFGFAMJAIG { get; set; } 0x15B7B18 PKMNOMELPMN 0x15B7B28 IABBJBAHKCE
	...
	public class JGNKPAJPDLN
	{
		...
		//public int KHPHAAMGMJP { get; set; } 0x15B7BA0 ABFDDKBBPCH 0x15B7BB0 MHDOIIEMDEH
		//public int OFIAENKCJME { get; set; } 0x15B7BC0 KADLAKFANGA 0x15B7BD0 AIDAPNCEPOB
	...
	public class PFKENFLKIOP
	{
		...
		//public bool PJPDOCNJNGJ { get; } 0x15B81CC MBEBLALDBHJ
	}
	...
	public class IOFFAADEIGD
	{
		...
		public List<PFKENFLKIOP> AHJNPEAMCCH = new List<PFKENFLKIOP>(); // 0x10
	...
	public class FILIHFENGDB
	{
		...
		public int MPLGPBNJDJB; // 0x10
		public int CJFEGGPILMF; // 0x14
		public int GBJBMBEABOP; // 0x18
		public int DKHIHHMOIKM; // 0x1C
	...
	public class ONECEEIOJCP
	{
		public int PPFNGGCBJKC; // 0x8
		public int PLALNIIBLOF; // 0xC
		public int FCBDGLEPGFJ; // 0x10
		public string FEMMDNIELFC; // 0x14
		public int MLKFDMFDFCE; // 0x18
		public int DKOPDNHDLIA; // 0x1C

		//public bool JKPDKNPDEBC { get; } 0x15B7EA0 CPKGABEEPPO
	...
	public class BIMNGKEMMJM
	{
		...
		public int BGFPMGPHGJJ; // 0x14
		public int KEEHMNJCONJ; // 0x18
		public int CFMIPHDGCAG; // 0x1C
		public int JKAEKMMOJMF; // 0x20
		public int DHDBOPKADII; // 0x24
		public int OPNNCHMFEBH; // 0x28
	...
	public IEPCJEPOFCO NGHKJOEDLIP = new IEPCJEPOFCO(); // 0x20
	public List<IOFFAADEIGD> FCIPEDFHFEM = new List<IOFFAADEIGD>(); // 0x24
	public List<AKIIJBEJOEP> NNMPGOAGEOL = new List<AKIIJBEJOEP>(); // 0x28
	public List<FILIHFENGDB> IJJHFGOIDOK = new List<FILIHFENGDB>(); // 0x2C
	public List<BFHPHDAPEKA> GAAHOOBMDEE = new List<BFHPHDAPEKA>(); // 0x30
	public List<ONECEEIOJCP> LGODPKPFGHF = new List<ONECEEIOJCP>(); // 0x34
	public List<BIMNGKEMMJM> ABJIDJODLIM = new List<BIMNGKEMMJM>(); // 0x38
	public List<KOBIAJFBPKG> FHDCGHEKJLL = new List<KOBIAJFBPKG>(); // 0x3C
	public List<KOBIAJFBPKG> JFJJOCODMIB = new List<KOBIAJFBPKG>(); // 0x40
	public List<APANPEKLFBC> GEGAEDDGNMA = new List<APANPEKLFBC>(); // 0x44
	public List<HJEGIDJGEBO> OGMHMAGDNAM = new List<HJEGIDJGEBO>(); // 0x48
	public List<JGNKPAJPDLN> LHAKGDAGEMM = new List<JGNKPAJPDLN>(); // 0x4C
	public List<ACBAHDMEFFL_EventMission.FFAKNKMPIPH> ADPFKHEMNBL = new List<FFAKNKMPIPH>(); // 0x58
	//public List<AIGOEAPJGEB> MBHDIJJEOFL = new List<AIGOEAPJGEB>(); // 0x5C
	//public List<IJNOIMLNBGN> LLCLJBEJOPM = new List<IJNOIMLNBGN>(); // 0x60
	...
	{
		TodoLogger.LogError(TodoLogger.Database, "ACBAHDMEFFL_EventMission.KMBPACJNEOF");
	}

	// RVA: 0x15B33F8 Offset: 0x15B33F8 VA: 0x15B33F8 Slot: 9
	public override bool IIEMACPEEBJ(byte[] DBBGALAPFGC)
	{
		TodoLogger.LogError(TodoLogger.Database, "ACBAHDMEFFL_EventMission.IIEMACPEEBJ");
		return true;
	}
	...
	{
		TodoLogger.LogError(TodoLogger.Database, "ACBAHDMEFFL_EventMission.CAOGDCBPBAN");
		return 0;
	}
}
