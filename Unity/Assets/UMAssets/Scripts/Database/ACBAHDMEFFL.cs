...
public class ACBAHDMEFFL_EventMission : DIHHCBACKGG_DbSection
{
	...
	public class IEPCJEPOFCO
	{
		...
		public string OCDMGOGMHGE_KeyPrefix { get { return EBGIDCIIGDO_KeyPrefix.DNJEJEANJGL_Value; } set { EBGIDCIIGDO_KeyPrefix.DNJEJEANJGL_Value = value; } } //0x15B7B48 HBAAAKFHDBB_get_KeyPrefix 0x15B5690 NHJLJOIPOFK_set_KeyPrefix
		public string PJBILOFOCIC { get { return NJKIMJAFCPC.DNJEJEANJGL_Value; } set { NJKIMJAFCPC.DNJEJEANJGL_Value = value; } } //0x15B7B74 NOEFEAIFHCL_get_ 0x15B56C4 GJIJFGNONEL_set_
	...
	public class APANPEKLFBC
	{
		...
		[UMOMember()]
		public int PPFNGGCBJKC_id { get { return EHOIENNDEDH_IdCrypted ^ FBGGEFFJJHB_xor; } set { EHOIENNDEDH_IdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x15B73E0 DEMEPMAEJOO_get_id 0x15B73F0 HIGKAIDMOKN_set_id
		[UMOMember()]
		public int CNKFPJCGNFE_SceneId { get { return FMDDJNKEBBB_Crypted ^ FBGGEFFJJHB_xor; } set { FMDDJNKEBBB_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x15B7400 GJBOGOFHGNP_get_SceneId 0x15B7410 GJDGIDCMJMH_set_SceneId
		[UMOMember()]
		public int GNFBMCGMCFO_BonusBefore { get { return MDKGAAMBJDJ_Crypted ^ FBGGEFFJJHB_xor; } set { MDKGAAMBJDJ_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x15B7420 NCIMMDJLPLJ_get_BonusBefore 0x15B7430 HNAJAFBHOLM_set_BonusBefore
		[UMOMember()]
		public int BFFGFAMJAIG_BonusAfter { get { return GGEBNMPPEID_Crypted ^ FBGGEFFJJHB_xor; } set { GGEBNMPPEID_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x15B7440 PKMNOMELPMN_get_BonusAfter 0x15B7450 IABBJBAHKCE_set_BonusAfter
		...
		public void BAFFAONJPCE(int JBGJDEELLOP, int KNEFBLHBDBG, EDHLNJNFNDN JMHECKKKMLK)
		{
			...
			PPFNGGCBJKC_id = d.PPFNGGCBJKC_id;
			CNKFPJCGNFE_SceneId = d.CNKFPJCGNFE_SceneId;
			GNFBMCGMCFO_BonusBefore = d.GNFBMCGMCFO_BonusBefore;
			BFFGFAMJAIG_BonusAfter = d.BFFGFAMJAIG_BonusAfter;
		}
	...
	public class HJEGIDJGEBO
	{
		...
		[UMOMember()]
		public int PPFNGGCBJKC_id { get { return EHOIENNDEDH_IdCrypted ^ FBGGEFFJJHB_xor; } set { EHOIENNDEDH_IdCrypted = value ^ FBGGEFFJJHB_xor; } } //0x15B7AD8 DEMEPMAEJOO_get_id 0x15B7AE8 HIGKAIDMOKN_set_id
		[UMOMember()]
		public int GNFBMCGMCFO_BonusBefore { get { return MDKGAAMBJDJ_Crypted ^ FBGGEFFJJHB_xor; } set { MDKGAAMBJDJ_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x15B7AF8 NCIMMDJLPLJ_get_BonusBefore 0x15B7B08 HNAJAFBHOLM_set_BonusBefore
		[UMOMember()]
		public int BFFGFAMJAIG_BonusAfter { get { return GGEBNMPPEID_Crypted ^ FBGGEFFJJHB_xor; } set { GGEBNMPPEID_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x15B7B18 PKMNOMELPMN_get_BonusAfter 0x15B7B28 IABBJBAHKCE_set_BonusAfter
	...
	public class JGNKPAJPDLN
	{
		...
		[UMOMember()]
		public int KHPHAAMGMJP_EpId { get { return HHEEHHHLKHC_Crypted ^ FBGGEFFJJHB_xor; } set { HHEEHHHLKHC_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x15B7BA0 ABFDDKBBPCH_get_EpId 0x15B7BB0 MHDOIIEMDEH_set_EpId
		[UMOMember()]
		public int OFIAENKCJME_BaseBonus { get { return LGAIHLFAPDC_Crypted ^ FBGGEFFJJHB_xor; } set { LGAIHLFAPDC_Crypted = value ^ FBGGEFFJJHB_xor; } } //0x15B7BC0 KADLAKFANGA_get_BaseBonus 0x15B7BD0 AIDAPNCEPOB_set_BaseBonus
	...
	public class PFKENFLKIOP
	{
		...
		public bool PJPDOCNJNGJ_IsLimited { get { return HJAFPEBIBOP_Limit > 0; } } //0x15B81CC MBEBLALDBHJ_bgs
	}
	...
	public class FILIHFENGDB
	{
		...
		public void KHEKNNFCAOI_Init(int _PPFNGGCBJKC_id, EDHLNJNFNDN JMHECKKKMLK)
		{
			...
			CJFEGGPILMF_MusicAttr = d.CJFEGGPILMF_MusicAttr;
			GBJBMBEABOP_SerieAttr = d.GBJBMBEABOP_SerieAttr;
	...
	public class ONECEEIOJCP
	{
		...
		public bool JKPDKNPDEBC_EnemyHasSkill { get { return MLKFDMFDFCE_enemy_c_skill > 0 || DKOPDNHDLIA_enemy_l_skill > 0; } } //0x15B7EA0 CPKGABEEPPO_bgs
		...
		public void KHEKNNFCAOI_Init(string blockName, int _PPFNGGCBJKC_id, EDHLNJNFNDN JMHECKKKMLK)
		{
			...
			PPFNGGCBJKC_id = (int)d.PPFNGGCBJKC_id;
			PLALNIIBLOF_en = (int)d.PLALNIIBLOF_en;
			FCBDGLEPGFJ_mid = (int)d.FCBDGLEPGFJ_mid;
			FEMMDNIELFC_Desc = DatabaseTextConverter.TranslateEventMissionMissionDesc(blockName, PPFNGGCBJKC_id, d.FEMMDNIELFC_Desc);
			MLKFDMFDFCE_enemy_c_skill = (int)d.MLKFDMFDFCE_enemy_c_skill;
			DKOPDNHDLIA_enemy_l_skill = (int)d.DKOPDNHDLIA_enemy_l_skill;
		}
	...
	public class BIMNGKEMMJM
	{
		...
		public void KHEKNNFCAOI_Init(int _PPFNGGCBJKC_id, EDHLNJNFNDN JMHECKKKMLK)
		{
			...
			PPFNGGCBJKC_id = (int)d.PPFNGGCBJKC_id;
			PLALNIIBLOF_en = (int)d.PLALNIIBLOF_en;
			MKNDAOHGOAK_weight = (int)d.MKNDAOHGOAK_weight;
			BGFPMGPHGJJ_Mid1 = (int)d.BGFPMGPHGJJ_Mid1;
			KEEHMNJCONJ_Mid2 = (int)d.KEEHMNJCONJ_Mid2;
			CFMIPHDGCAG_Mid3 = (int)d.CFMIPHDGCAG_Mid3;
			JKAEKMMOJMF_Bns1 = (int)d.JKAEKMMOJMF_Bns1;
			DHDBOPKADII_Bns2 = (int)d.DHDBOPKADII_Bns2;
			OPNNCHMFEBH_Bns3 = (int)d.OPNNCHMFEBH_Bns3;
		}
	...
	public class KOBIAJFBPKG
	{
		...
		public void KHEKNNFCAOI_Init(int _PPFNGGCBJKC_id, EDHLNJNFNDN JMHECKKKMLK)
		{
			...
			PPFNGGCBJKC_id = (int)d.PPFNGGCBJKC_id;
			FEMMDNIELFC_Desc = d.FEMMDNIELFC_Desc;
			NANNGLGOFKH_value = (int)d.NANNGLGOFKH_value;
		}
	...
	public override bool IIEMACPEEBJ_Deserialize(byte[] _DBBGALAPFGC_bytes)
	{
		...
		for(int i = 0; i < reader.BHGDNGHDDAC.Length; i++)
		{
			...
			d.DNJEJEANJGL_Value = reader.BHGDNGHDDAC[i].JBGEEPFKIGG_val;
			OHJFBLFELNK_m_intParam.Add(reader.BHGDNGHDDAC[i].LJNAKDMILMC_key, d);
		}
		for(int i = 0; i < reader.MHGMDJNOLMI.Length; i++)
		{
			NNJFKLBPBNK_SecureString d = new NNJFKLBPBNK_SecureString();
			d.DNJEJEANJGL_Value = reader.MHGMDJNOLMI[i].JBGEEPFKIGG_val;
			FJOEBCMGDMI_m_stringParam.Add(reader.MHGMDJNOLMI[i].LJNAKDMILMC_key, d);
		}
		for(int i = 0; i < reader.KIEKMCKCMGD.Length; i++)
		{
			FFAKNKMPIPH d = new FFAKNKMPIPH();
			d.PPFNGGCBJKC_id = reader.KIEKMCKCMGD[i].PPFNGGCBJKC_id;
			d.KFCIJBLDHOK_v1 = reader.KIEKMCKCMGD[i].KFCIJBLDHOK_v1;
			d.JLEIHOEGMOP_v2 = reader.KIEKMCKCMGD[i].JLEIHOEGMOP_v2;
			ADPFKHEMNBL.Add(d);
		}
	...
	public override bool IIEMACPEEBJ_Deserialize(EDOHBJAPLPF_JsonData OILEIIEIBHP, int _KAPMOPMDHJE_label)
	{
		...
		TodoLogger.LogError(TodoLogger.DbJson, "ACBAHDMEFFL_EventMission.IIEMACPEEBJ_Deserialize");
		return true;
	}
	...
	private bool DGKKMKLCEDF_DeserializeSetting(EDHLNJNFNDN LKOMBCHIDMB)
	{
		...
		NGHKJOEDLIP_Settings.HEDAGCNPHGD_RankingName = LKOMBCHIDMB.HMBHNLCFDIH.HEDAGCNPHGD_RankingName;
		NGHKJOEDLIP_Settings.OCGFKMHNEOF_name_for_api = LKOMBCHIDMB.HMBHNLCFDIH.OCGFKMHNEOF_name_for_api;
		NGHKJOEDLIP_Settings.BONDDBOFBND_RankingStart = LKOMBCHIDMB.HMBHNLCFDIH.BONDDBOFBND_RankingStart;
		NGHKJOEDLIP_Settings.HPNOGLIFJOP_RankingEnd = LKOMBCHIDMB.HMBHNLCFDIH.HPNOGLIFJOP_RankingEnd;
		NGHKJOEDLIP_Settings.EHHFFKAFOMC = LKOMBCHIDMB.HMBHNLCFDIH.EHHFFKAFOMC;
		NGHKJOEDLIP_Settings.LNFKGHNHJKE_RankingEnd2 = LKOMBCHIDMB.HMBHNLCFDIH.LNFKGHNHJKE_RankingEnd2;
		NGHKJOEDLIP_Settings.JGMDAOACOJF_RewardStart = LKOMBCHIDMB.HMBHNLCFDIH.JGMDAOACOJF_RewardStart;
		NGHKJOEDLIP_Settings.IDDBFFBPNGI_RewardEnd = LKOMBCHIDMB.HMBHNLCFDIH.IDDBFFBPNGI_RewardEnd;
		NGHKJOEDLIP_Settings.KNLGKBBIBOH_RewardEnd2 = LKOMBCHIDMB.HMBHNLCFDIH.KNLGKBBIBOH_RewardEnd2;
		NGHKJOEDLIP_Settings.JBFDHOIKAIK_InventoryEndDate = LKOMBCHIDMB.HMBHNLCFDIH.JBFDHOIKAIK_InventoryEndDate;
		NGHKJOEDLIP_Settings.KHIKEGLBGAF_RankingRewardScene = (int)LKOMBCHIDMB.HMBHNLCFDIH.KHIKEGLBGAF_RankingRewardScene;
		NGHKJOEDLIP_Settings.DPJCFLKFEPN_RankingRewardScene2 = (int)LKOMBCHIDMB.HMBHNLCFDIH.DPJCFLKFEPN_RankingRewardScene2;
		...
		NGHKJOEDLIP_Settings.HKKNEAGCIEB_RankingSupport = (sbyte)LKOMBCHIDMB.HMBHNLCFDIH.HKKNEAGCIEB_RankingSupport;
		NGHKJOEDLIP_Settings.HIOOGLEJBKM_StartAdventureId = LKOMBCHIDMB.HMBHNLCFDIH.HIOOGLEJBKM_StartAdventureId;
		NGHKJOEDLIP_Settings.FJCADCDNPMP_EndAdventureId = LKOMBCHIDMB.HMBHNLCFDIH.FJCADCDNPMP_EndAdventureId;
		NGHKJOEDLIP_Settings.EJBGHLOOLBC_HelpIds = LKOMBCHIDMB.HMBHNLCFDIH.EJBGHLOOLBC_HelpIds;
		NGHKJOEDLIP_Settings.AHKPNPNOAMO_ExtreamOpen = (sbyte)LKOMBCHIDMB.HMBHNLCFDIH.AHKPNPNOAMO_ExtreamOpen;
		NGHKJOEDLIP_Settings.OMCAOJJGOGG_Lb = LKOMBCHIDMB.HMBHNLCFDIH.OMCAOJJGOGG_Lb;
		NGHKJOEDLIP_Settings.EKJFNHHKBPL = LKOMBCHIDMB.HMBHNLCFDIH.EKJFNHHKBPL;
		for(int i = 0; i < LKOMBCHIDMB.HMBHNLCFDIH.JHPCPNJJHLI_RankingThreshold.Length; i++)
		{
			if(LKOMBCHIDMB.HMBHNLCFDIH.JHPCPNJJHLI_RankingThreshold[i] < 1001)
			{
				NGHKJOEDLIP_Settings.JHPCPNJJHLI_RankingThreshold.Add(LKOMBCHIDMB.HMBHNLCFDIH.JHPCPNJJHLI_RankingThreshold[i]);
			}
		}
		NGHKJOEDLIP_Settings.JKFPADIAKCK_Songs.Clear();
		for(int i = 0; i < LKOMBCHIDMB.HMBHNLCFDIH.JKFPADIAKCK_Songs.Length; i++)
		{
			NGHKJOEDLIP_Settings.JKFPADIAKCK_Songs.Add(LKOMBCHIDMB.HMBHNLCFDIH.JKFPADIAKCK_Songs[i]);
		}
		NGHKJOEDLIP_Settings.EEOGPJJCKHH_Drops.Clear();
		for(int i = 0; i < LKOMBCHIDMB.HMBHNLCFDIH.EEOGPJJCKHH_Drops.Length; i++)
		{
			NGHKJOEDLIP_Settings.EEOGPJJCKHH_Drops.Add((int)LKOMBCHIDMB.HMBHNLCFDIH.EEOGPJJCKHH_Drops[i]);
		}
	...
	private bool GPEKKMGGBPF(EDHLNJNFNDN LKOMBCHIDMB)
	{
		for(int i = 0; i < LKOMBCHIDMB.MCHFABAKPMH.Length; i++)
		{
			...
			d.PPFNGGCBJKC_id = (int)LKOMBCHIDMB.MCHFABAKPMH[i].PPFNGGCBJKC_id;
			d.DNBFMLBNAEE_point = (int)LKOMBCHIDMB.MCHFABAKPMH[i].FOILNHKHHDF_pt;
			d.JOPPFEHKNFO_Pickup = LKOMBCHIDMB.MCHFABAKPMH[i].JOPPFEHKNFO_Pickup != 0;
			for(int j = 0; j < LKOMBCHIDMB.MCHFABAKPMH[i].AIHOJKFNEEN_itm.Length; j++)
			{
				PFKENFLKIOP d2 = new PFKENFLKIOP();
				d2.GLCLFMGPMAN_ItemId = LKOMBCHIDMB.MCHFABAKPMH[i].AIHOJKFNEEN_itm[j];
				d2.HMFFHLPNMPH_count = (int)LKOMBCHIDMB.MCHFABAKPMH[i].BFINGCJHOHI_cnt[j];
				d2.NMKEOMCMIPP_RewardId = (int)LKOMBCHIDMB.MCHFABAKPMH[i].JJHPDDPKBHF[j];
				d2.HJAFPEBIBOP_Limit = (int)LKOMBCHIDMB.MCHFABAKPMH[i].HJAFPEBIBOP_Limit[j];
	...
	{
		int xor = NKGJPJPHLIF_SakashoManager.HHCJCDFCLOB_Instance != null ? (int)NKGJPJPHLIF_SakashoManager.HHCJCDFCLOB_Instance.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime() * 77 : 0;
