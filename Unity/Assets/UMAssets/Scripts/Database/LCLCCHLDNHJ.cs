...
public class LCLCCHLDNHJ : DIHHCBACKGG
{
    ...
    {
        private static int FBGGEFFJJHB; // 0x0
        ...
        // public int PPEGAKEIEGM { get; set; } // KPOEEPIMMJP 0xD9D5B8 NCIEAFEDPBH 0xD9CCEC
	...
	// public LCLCCHLDNHJ.ILODJKFJJDO EEOADCECNOM(int PPFNGGCBJKC) { }

	// // RVA: 0xD9AF18 Offset: 0xD9AF18 VA: 0xD9AF18
	// public LCLCCHLDNHJ.ILODJKFJJDO LBDOLHGDIEB(int AHHJLDLAPAN, int JPIDIENBGKH) { }
