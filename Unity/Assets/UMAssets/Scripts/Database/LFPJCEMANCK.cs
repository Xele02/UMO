...
{
	// public Regex FPEEJDLMOJB { get; private set; } // 0x8 KGCPPEAFJFC JNDAHPAODAB EAFPHJKJHPD
	// public string IOMHINDAFOH { get; private set; } // 0xC HFKJBIDDJHL EIAEEOGCIMA MMFKGDDAIDG
	public int KPNKPGLPDHI { get; private set; } // 0x10 OLDMILDBDME EDAJJEJELHN HLIEKAOJIGI
	public int PAAPNEMBHGN { get; private set; } // 0x14 BFBNPHPDOCP LGLMKGLDFME BGNMBMCHOCF
	...
	public bool PEOIMDCECDL { get { return ((KPNKPGLPDHI >> 6) & 1) != 0; } } //0x197E4B4 ANNFICFGPIK
...
{
	public string MIMGPBHAJCO { get; private set; } // 0x8 ICEMDJBNGJA JPMHJMDLFPI NLHKGLABKDI
	public int IJEKNCDIIAE { get; private set; } // 0xC FAHNCMHNFCG KJIMMIBDCIL DMEGNOKIKCD
...
{
	public DFHCLGPLJCP NKGJOAEDCPH; // 0x8
	// public Match MABBBOEAPAA; // 0xC
	public int KKPAHLMJKIH; // 0x10
	public int EKANGPODCEP; // 0x14
	public int HHGMPEEGFMA; // 0x18
	public int DIDOFBIHPMB; // 0x1C
	public int INFIBMLIHLO; // 0x20
...
public class LFPJCEMANCK_Asset : DIHHCBACKGG
{
	...
	public List<DFHCLGPLJCP> KCMFDGNNPIL { get; private set; } // 0x20 LOJMMLKKEEP JGCLPBFPPHI OBABGCHHDDH
	public List<NLEFIGMHGCO> OAOOIDNBOGA { get; private set; } // 0x24 NPFKICOMNGC LKMOIDPNAPB JHMPDPDLAIN
	...
	public LFPJCEMANCK_Asset()
    {
        JIKKNHIAEKG = "";
        LNIMEIMBCMF = false;
        KCMFDGNNPIL = new List<DFHCLGPLJCP>(100);
        LMHMIIKCGPE = 5;
        OAOOIDNBOGA = new List<NLEFIGMHGCO>();
    }
