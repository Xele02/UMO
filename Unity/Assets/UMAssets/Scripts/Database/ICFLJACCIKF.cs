...
public class ICFLJACCIKF_Event { }
public class ICFLJACCIKF_EventBattle : DIHHCBACKGG_DbSection
{
	public class KNLJPCCDPDK
	{
		...
		public long BONDDBOFBND; // 0x28
		public long HPNOGLIFJOP; // 0x30
		public long EHHFFKAFOMC; // 0x38
		public long LNFKGHNHJKE; // 0x40
		public long JGMDAOACOJF; // 0x48
		public long IDDBFFBPNGI; // 0x50
		public long KNLGKBBIBOH; // 0x58
		public long JBFDHOIKAIK; // 0x60
		...
		private List<int> HIAMHLLHAON = new List<int>(); // 0x98
		private List<int> LFHLCBEBPPK = new List<int>(); // 0x9C
		public int HIOOGLEJBKM; // 0xA0
		public int FJCADCDNPMP; // 0xA4
		public int[] EJBGHLOOLBC; // 0xA8
		public List<int> EEOGPJJCKHH = new List<int>(); // 0xAC

		//public string OCDMGOGMHGE { get; set; } 0x11E8E00 HBAAAKFHDBB 0x11E8E2C NHJLJOIPOFK
		//public string PJBILOFOCIC { get; set; } 0x11E8E60 NOEFEAIFHCL 0x11E8E8C GJIJFGNONEL
		...
		//public int GEDKCAODLMM(int AKNELONELJK, bool GIKLNODJKFK) { }
	...
	public class FGBJDLLLBEF
	{
		...
		private int FMDDJNKEBBB; // 0x10
		private int MDKGAAMBJDJ; // 0x14
		private int GGEBNMPPEID; // 0x18

		//public int PPFNGGCBJKC { get; set; } 0x11E8048 DEMEPMAEJOO 0x11E8058 HIGKAIDMOKN
		//public int CNKFPJCGNFE { get; set; } 0x11E8068 GJBOGOFHGNP 0x11E8078 GJDGIDCMJMH
		//public int GNFBMCGMCFO { get; set; } 0x11E8088 NCIMMDJLPLJ 0x11E8098 HNAJAFBHOLM
		//public int BFFGFAMJAIG { get; set; } 0x11E80A8 PKMNOMELPMN 0x11E80B8 IABBJBAHKCE
	...
	public class DGBPOCFMKMJ
	{
		public int FBGGEFFJJHB; // 0x8
		private int EHOIENNDEDH; // 0xC
		private int MDKGAAMBJDJ; // 0x10
		private int GGEBNMPPEID; // 0x14

		//public int PPFNGGCBJKC { get; set; } 0x11E71AC DEMEPMAEJOO 0x11E71BC HIGKAIDMOKN
		//public int GNFBMCGMCFO { get; set; } 0x11E71CC NCIMMDJLPLJ 0x11E71DC HNAJAFBHOLM
		//public int BFFGFAMJAIG { get; set; } 0x11E71EC PKMNOMELPMN 0x11E71FC IABBJBAHKCE
	...
	{
		public int FBGGEFFJJHB; // 0x8
		private int HHEEHHHLKHC; // 0xC
		private int LGAIHLFAPDC; // 0x10
		public List<int> KDNMBOBEGJM = new List<int>(); // 0x14

		//public int KHPHAAMGMJP { get; set; } 0x11E84D0 ABFDDKBBPCH 0x11E84E0 MHDOIIEMDEH
		//public int OFIAENKCJME { get; set; } 0x11E84F0 KADLAKFANGA 0x11E8500 AIDAPNCEPOB
	...
	public class BEFNBMEMFOB
	{
		...
		//public bool PJPDOCNJNGJ { get; } 0x11E6F58 MBEBLALDBHJ
	}
	...
	public class LPJIKDAMGPC
	{
		...
		public int PEBHLFLDIGC; // 0x28

		//public int EEAPIKNJNDB { get; set; } 0x11E94BC KNLJPLHJMHI 0x11E94CC IMHAJFDFGJL
		//public int NNDBJGDFEEM { get; set; } 0x11E94DC EHNOFMPHLFC 0x11E94EC GCANPOPEKEE
		//public int DOOGFEGEKLG { get; set; } 0x11E94FC AECMFIOFFJN 0x11E950C NGOJJDOCIDG
		//public int DJJGNDCMNHF { get; set; } 0x11E951C GEPCOAPEAJM 0x11E952C MIFJBBAJAJP
	...
	public class FKACPHEKBNF
	{
		...
		public int[] MJNMPAKBNKB = new int[5]; // 0x10
		public int ENNCJKLIGKE; // 0x14
		public int PALEGNNHIKH; // 0x18
		public int JCDEDIOAGKE; // 0x1C
		public int BJHHOBEMBJG; // 0x20
		public int CPCKPCJBDEL; // 0x24
		public int AOFGNAJLLPD; // 0x28
		public int ENEKCBCOKNM; // 0x2C
		public int HNJHPNPFAAN; // 0x30
		public int CJAOMKLHFJL; // 0x34
		public int EHOIENNDEDH; // 0x38
		public int KPLDLGGMOMH; // 0x3C
		public int HIJDFKKMONB; // 0x40
		public int MHGDDPCAGAJ; // 0x44
		public int GIELAFNPOCG; // 0x48
		public int GHJIBEMCKLA; // 0x4C
		public int NBOLDNMPJFG; // 0x50
		public int EOPEEENMHEN; // 0x54
		public int BCKCCHGMPBG; // 0x58
		public int JKJDDGGNEAB; // 0x5C

		//public int BEEAIAAJOHD { get; set; } 0x11E8254 DIIBIOEMHAI 0x11E8264 JIHEDMEFKAF
		//public int AKNELONELJK { get; set; } 0x11E8274 BPPILHGDABB 0x11E8284 PMMIIHKEGCI
		//public int DIPKCALNIII { get; set; } 0x11E8294 EOGPBFIDAPF 0x11E82A4 JDNCGPBAFMB
		//public int HEBKEJBDCBH { get; set; } 0x11E82B4 OMOHEDILHMF 0x11E82C4 FCGDHINFKHC
		//public int PLALNIIBLOF { get; set; } 0x11E82D4 JPCJNLHHIPE 0x11E82E4 JJFJNEJLBDG
		//public int GOIKCKHMBDL { get; set; } 0x11E82F4 BPGCGEDHBEH 0x11E8304 ICPMFBIDFFO
		//public int PPFNGGCBJKC { get; set; } 0x11E8314 DEMEPMAEJOO 0x11E8324 HIGKAIDMOKN
		//public int EDJMDDAGCEJ { get; set; } 0x11E8334 BCMKDNCFOJO 0x11E8344 DDIAEKOKDIE
		//public int HEFPAIOLBAG { get; set; } 0x11E8354 EAGPNJEBOCP 0x11E8364 LLIGHINHLOL
		//public int GLILAGLJLEP { get; set; } 0x11E8374 HGPGPALMELF 0x11E8384 ECHLNFNJFFO
		//public int ECOLMPLOPFM { get; set; } 0x11E8394 BFLCGLBAFOE 0x11E83A4 NJGKCLHFDIB
		//public int CFCIMKOHLIG { get; set; } 0x11E83B4 AJNACFGNOAA 0x11E83C4 LCGAFCPHDKA
		//public int BDLNMOIOMHK { get; set; } 0x11E83D4 MKMAKAEDMBG 0x11E83E4 GIJPLHEDIKD
		//public int NLKEBAOBJCM { get; set; } 0x11E83F4 AECNKGBNKHH 0x11E8404 ECHLKFHOJFP
		//public int KNIFCANOHOC { get; set; } 0x11E8414 EOJEPLIPOMJ 0x11E8424 AEEMBPAEAAI
		//public int IPPNCOHEEOD { get; set; } 0x11E8434 BNFNPCNAGAF 0x11E8444 GEMDEGDPJPK
	}
	...
	public class OABJKIKLDKP
	{
		...
		public int CNMODNFFBLP; // 0x14
		public int CHDLCOGBCNK; // 0x18
		public int KNALPNKGKHD; // 0x1C
		public long PCLNFCNIECH; // 0x20
		public long HHPIJHADAOB; // 0x28

		//public int PPFNGGCBJKC { get; set; } 0x11E9594 DEMEPMAEJOO 0x11E95A0 HIGKAIDMOKN
		//public int PLALNIIBLOF { get; set; } 0x11E95B0 JPCJNLHHIPE 0x11E95C0 JJFJNEJLBDG
		//public int MPLGPBNJDJB { get; set; } 0x11E95D0 KADAEAOKJNE 0x11E95E0 MBKFNLHPNPP
		//public int CPBFAMJEODF { get; set; } 0x11E95F0 GEPFGJBNHNL 0x11E9600 MHBECPNIHLA
		//public int MGHPJNNDCIG { get; set; } 0x11E9610 GFADFBMKBMD 0x11E9620 JECIKFDJMOB
		//public long PDBPFJJCADD { get; set; } 0x11E9630 FOACOMBHPAC 0x11E9648 NBACOBCOJCA
		//public long FDBNFFNFOND { get; set; } 0x11E965C BPJOGHJCLDJ 0x11E9674 NLJKMCHOCBK
		...
		//public void KHEKNNFCAOI(int PPFNGGCBJKC, int KNEFBLHBDBG, OPHFFGFJIBJ JMHECKKKMLK) { }
	...
	public class KGHHHPHBGGM
	{
		...
		public int EHOIENNDEDH; // 0xC
		public int HNJHPNPFAAN; // 0x10
		public int OGBOECHJCML; // 0x14
		public long PCLNFCNIECH; // 0x18
		public long HHPIJHADAOB; // 0x20

		//public int PPFNGGCBJKC { get; set; } 0x11E88D0 DEMEPMAEJOO 0x11E88DC HIGKAIDMOKN
		//public int PLALNIIBLOF { get; set; } 0x11E88EC JPCJNLHHIPE 0x11E88FC JJFJNEJLBDG
		//public int KOJMEPJBOJM { get; set; } 0x11E890C JFLEJAJJMPF 0x11E891C DLOCAEEEJAE
		//public long PDBPFJJCADD { get; set; } 0x11E892C FOACOMBHPAC 0x11E8944 NBACOBCOJCA
		//public long FDBNFFNFOND { get; set; } 0x11E8958 BPJOGHJCLDJ 0x11E8970 NLJKMCHOCBK
	...
	public class EIIMIHPLDFJ
	{
		...
		public int EHOIENNDEDH; // 0xC
		public int HNJHPNPFAAN; // 0x10
		public int AGACCBBEEDJ; // 0x14
		public int PCFFCAAIPNB; // 0x18
		public int[] NDOGDOPFNEG = new int[4]; // 0x1C
		public int LNCOADKBAAP; // 0x20
		public int LGFBLINAGGI; // 0x24
		public int FNHJGFMGBDK; // 0x28
		public int GPAKDLBNIOI; // 0x2C
		public int CLGFJMEKLKH; // 0x30
		public int AJKKBHJHHLA; // 0x34
		public int MJBNEHAKLGP; // 0x38
		public int FOJMCKKDDHP; // 0x3C
		public int LOFGKCCABFA; // 0x40

		//public int PPFNGGCBJKC { get; set; } 0x11E734C DEMEPMAEJOO 0x11E735C HIGKAIDMOKN
		//public int PLALNIIBLOF { get; set; } 0x11E736C JPCJNLHHIPE 0x11E737C JJFJNEJLBDG
		//public int APGKOJKNNGP { get; set; } 0x11E738C KGLCIOHDBLL 0x11E739C DJKADEGEAHE
		//public int AFKHNFBOMKI { get; set; } 0x11E73AC NMHOKCJEIDP 0x11E73BC MPFMEIDKANE
		//public int GCPKJPNENJJ { get; set; } 0x11E73CC DEFEJOEMOBM 0x11E73DC POILGINHMFI
		//public int FLOAHHHAOLE { get; set; } 0x11E73EC LFPPNCDDIIL 0x11E73FC AANNOOHGHHI
		//public int COJMPBFFJFI { get; set; } 0x11E740C JPPCEEKHOFC 0x11E741C HIOGIOLAEOI
		//public int KPFDEBIEAME { get; set; } 0x11E742C IIMKGJJGKLL 0x11E743C MDFOJINDCCM
		//public int MCBDCDLKACL { get; set; } 0x11E744C GCJBJKEJMPN 0x11E745C GNLEHPCNIFN
		//public int JLDNDNNDEEH { get; set; } 0x11E746C IONADHGPJOM 0x11E747C EIBPMJPKBMG
		//public int LIIIGJFLAAB { get; set; } 0x11E748C JPIBNDOCFKB 0x11E749C AGFPHGNJJIH
		//public int NGNKKFNDEPD { get; set; } 0x11E74AC DDOMBIIGHJH 0x11E74BC OHENGMHAJHL
		//public int MKOKEGGPFBC { get; set; } 0x11E74CC LGAMCIJDOOL 0x11E74DC CJGNIOCOPEO
	...
	//public List<AKIIJBEJOEP> NNMPGOAGEOL = List<AKIIJBEJOEP>(); // 0x28
	public List<LPJIKDAMGPC> AFHHBNBCOKI = new List<LPJIKDAMGPC>(); // 0x2C
	public List<FKACPHEKBNF> OCPGCHOGHPB = new List<FKACPHEKBNF>(); // 0x30
	...
	//public List<IJNOIMLNBGN> LLCLJBEJOPM = new List<IJNOIMLNBGN>(); // 0x4C
	public List<OABJKIKLDKP> IJJHFGOIDOK = new List<OABJKIKLDKP>(); // 0x50
	public List<KGHHHPHBGGM> GCFOLMHPDBG = new List<KGHHHPHBGGM>(); // 0x54
	public List<EIIMIHPLDFJ> PMJLEPGCAOA = new List<EIIMIHPLDFJ>(); // 0x58
	...
	{
		TodoLogger.Log(TodoLogger.Database, "ICFLJACCIKF_EventBattle.KMBPACJNEOF");
	}

	// RVA: 0x122183C Offset: 0x122183C VA: 0x122183C Slot: 9
	public override bool IIEMACPEEBJ(byte[] DBBGALAPFGC)
	{
		TodoLogger.Log(TodoLogger.Database, "ICFLJACCIKF_EventBattle.IIEMACPEEBJ");
		return true;
	}
	...
	{
		TodoLogger.Log(TodoLogger.DbIntegrityCheck, "ICFLJACCIKF_EventBattle.CAOGDCBPBAN");
		return 0;
	}
}
