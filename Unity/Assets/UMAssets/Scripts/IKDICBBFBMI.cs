...
{
	public long DNBFMLBNAEE_point; // 0x8
...
[System.Obsolete("Use IKDICBBFBMI_NetEventBaseController", true)]
public abstract class IKDICBBFBMI { }
public abstract class IKDICBBFBMI_NetEventBaseController
{
	public class NJJDBBCHBNP
	{
		public int GJEADBKFAPA; // 0x8
		public int IJKFFIKGLJM_BonusBefore; // 0xC
		public int DCBMFNOIENM_BonusAfter; // 0x10
	}

	public class MEBJJBHPMEO
	{
		public int PPFNGGCBJKC_id; // 0x8
		public int CNKFPJCGNFE_SceneId; // 0xC
		public int GNFBMCGMCFO_BonusBefore; // 0x10
		public int BFFGFAMJAIG_BonusAfter; // 0x14
	}

	public class CEGDBNNIDIG
	{
		public int KELFCMEOPPM_EpisodeId; // 0x8
		public float MIHNKIHNBBL_BaseBonus; // 0xC
		public List<int> MLLPMJFOKEC_GachaIds = new List<int>(); // 0x10
	}

	public class GNPOABJANKO
	{
		public int KELFCMEOPPM_EpisodeId; // 0x8
		public bool JKDJCFEBDHC_Enabled; // 0xC // bonus enabled
	...
	public bool PJLNJJIBFBN_HasExtremeDiff; // 0x24
	...
	public JKNGJFOBADP JANMJPOKLFL_InventoryUtil = new JKNGJFOBADP(); // 0x84
	...
	protected bool CMEOKJMCEBH_IsGoDiva; // 0x95
	public int GFIBLLLHMPD_StartAdventureId; // 0x98
	public int CAKEOPLJDAF_EndAdventureId; // 0x9C
	public bool FKKDIDMGLMI_IsDroppedPlayer; // 0xA0
	public bool PLOOEECNHFB_IsDone; // 0xA1
	public bool GPHEKCNDDIK; // 0xA2
	public bool NPNNPNAIONN_IsError; // 0xA3
	public long EJDJIBPKKNO_BasePoint; // 0xA8
	...
	public List<CEGDBNNIDIG> LHAKGDAGEMM_EpBonusInfos = new List<CEGDBNNIDIG>(); // 0xC0
	public List<NJJDBBCHBNP> PGDAMNENGDA_EpBonusBySceneRarity = new List<NJJDBBCHBNP>(); // 0xC4
	public List<MEBJJBHPMEO> DHOMAEOEFMJ_EpBonuByScene = new List<MEBJJBHPMEO>(); // 0xC8
	...
	public static string HOEKCEJINNA_new_episode_mver = "new_episode_mver"; // 0x0
	public static string FOKNMOMNHHD_new_episode_help_pict_id = "new_episode_help_pict_id"; // 0x4
	public const string IKCKAAKLNPL_main_ranking_index = "main_ranking_index";
	public const string HNBFGNJGNDP_event_prologue_achv_key = "event_prologue_achv_key";
	public const string ELJKLANPBIF_event_epilogue_achv_key = "event_epilogue_achv_key";
	public const string PKCHABKLDOC_event_prologue_achv_item_id = "event_prologue_achv_item_id";
	public const string HMEFMAPKOBF_event_epilogue_achv_item_id = "event_epilogue_achv_item_id";

	public virtual OHCAABOMEOF.KGOGMKMBCPP_EventType HIDHLFCBIDE_EventType { get { return OHCAABOMEOF.KGOGMKMBCPP_EventType.HJNNKCMLGFL_0_None; } } //0x8DD514 DKHCGLCNKCD_bgs Slot: 4
	...
	public IKDICBBFBMI_NetEventBaseController(string _OPFGFINHFCE_name)
	{
		JOPOPMLFINI_QuestName = _OPFGFINHFCE_name;
	}
	...
	public virtual int OMJHBJPCFFC_GetEventBonusPercent(int _EHDDADDKMFI_f_id)
	{
		return 0;
	}

	// // RVA: 0x8DD53C Offset: 0x8DD53C VA: 0x8DD53C Slot: 9
	public virtual long HOOBCIIOCJD_GetSongEndTime(int _GHBPLHBNMBK_FreeMusicId)
	{
		return DPJCPDKALGI_RankingEnd;
	}

	// // RVA: 0x8DD544 Offset: 0x8DD544 VA: 0x8DD544 Slot: 10
	public virtual bool GIDDKGMPIOK_IsLimited(int _GHBPLHBNMBK_FreeMusicId)
	{
		return false;
	}

	// // RVA: 0x8DD54C Offset: 0x8DD54C VA: 0x8DD54C Slot: 11
	public virtual int AELBIEDNPGB_GetTicketCount(BBHNACPENDM_ServerSaveData _LDEGEHAEALK_ServerData)
	{
		return 0;
	}
	...
	public virtual bool NLFIGGNLEFP(int _AKNELONELJK_difficulty, bool _GIKLNODJKFK_IsLine6, int _LCCGDFGGIHI_PlayCount)
	{
		return false;
	}

	// // RVA: 0x8DD564 Offset: 0x8DD564 VA: 0x8DD564 Slot: 14
	public virtual void HPENJEOAMBK_SetTicket(int _JKIADEKHGLC_TicketItemId, int _HMFFHLPNMPH_count, BBHNACPENDM_ServerSaveData _AHEFHIMGIBI_PlayerData)
	{
		return;
	}
	...
	{
		return EJFIKLONGDD.FKDIMODKKJD_GetList(PFPJHJJAGAG_Rewards, MAICAKMIBEM("total_reward_feature_option", ""));
	}
	...
	public virtual int GBADILEHLGC_GetStatus(int _CMEJFJFOIIJ_QuestId)
	{
		if(_CMEJFJFOIIJ_QuestId != 0)
		{
			if(AGLILDLEFDK_Missions != null && OLDFFDMPEBM_Quests != null && AGLILDLEFDK_Missions.Count >= _CMEJFJFOIIJ_QuestId && OLDFFDMPEBM_Quests.Count >= _CMEJFJFOIIJ_QuestId)
			{
				return OLDFFDMPEBM_Quests[_CMEJFJFOIIJ_QuestId - 1].EALOBDHOCHP_stat;
			}
		}
		return 0;
	}
	...
	public virtual int GMFLMIHJAHB(int _CMEJFJFOIIJ_QuestId)
	{
		if(_CMEJFJFOIIJ_QuestId != 0)
		{
			if(AGLILDLEFDK_Missions != null && OLDFFDMPEBM_Quests != null && _CMEJFJFOIIJ_QuestId <= AGLILDLEFDK_Missions.Count && _CMEJFJFOIIJ_QuestId <= OLDFFDMPEBM_Quests.Count)
			{
				return OLDFFDMPEBM_Quests[_CMEJFJFOIIJ_QuestId - 1].HMFFHLPNMPH_count;
			}
		}
		return 0;
	}
	...
	public void BOHCAIIBPEJ(AKIIJBEJOEP _NDFIEMPPMLF_master, IKCGAJKCPFN NHLBKJCPLBL, JGEOBNENMAH_NetGameManager.HAJIFNABIFF _OMNOFMEBLAD_clearSetup, IKDICBBFBMI_NetEventBaseController LIKDEHHKFEH)
	{
		if(!OEHCGLGNNPD)
		{
			GBNDFCEDNMG.BBEKHCGKIAJ(_NDFIEMPPMLF_master, NHLBKJCPLBL, _OMNOFMEBLAD_clearSetup, LIKDEHHKFEH);
		}
		else
		{
			if(FHKCEPMCGCK())
			{
				GBNDFCEDNMG.MDBLPCIKHBJ(PGIIDPEGGPI_EventId, KFNINHEJCLF(), _NDFIEMPPMLF_master, NHLBKJCPLBL);
			}
		}
	}
	...
	public virtual void HEFIKPAHCIA_UpdateMission(GBNDFCEDNMG.CJDGJFINBFH_ClearType _HDAMBOOCIAA_ClearType)
    {
        if(AGLILDLEFDK_Missions != null && OLDFFDMPEBM_Quests != null && NGOFCFJHOMI_Status < KGCNCBOKCBA.GNENJEHKMHD_EventStatus.EMAMLLFAOJI_6_Counting/*6*/)
		{
			...
			for(int i = 0; i < c; i++)
			{
				...
				{
					if (GBNDFCEDNMG.HANGCDOFING(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database, CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData, AGLILDLEFDK_Missions[i], this, _HDAMBOOCIAA_ClearType))
					{
	...
	public virtual void EBHPADDEJKH(JGEOBNENMAH_NetGameManager.EDHCNKBMLGI _OMNOFMEBLAD_clearSetup, GBNDFCEDNMG.CJDGJFINBFH_ClearType _HDAMBOOCIAA_ClearType)
	{
		if(AGLILDLEFDK_Missions != null && OLDFFDMPEBM_Quests != null && _OMNOFMEBLAD_clearSetup != null)
		{
			int c = AGLILDLEFDK_Missions.Count;
			if (OLDFFDMPEBM_Quests.Count < c)
				c = OLDFFDMPEBM_Quests.Count;
			JGEOBNENMAH_NetGameManager.HAJIFNABIFF data = new JGEOBNENMAH_NetGameManager.HAJIFNABIFF();
			data.KNIFCANOHOC_score = -1;
			data.GHBPLHBNMBK_FreeMusicId = _OMNOFMEBLAD_clearSetup.GHBPLHBNMBK_FreeMusicId;
			data.AKNELONELJK_difficulty = _OMNOFMEBLAD_clearSetup.AKNELONELJK_difficulty;
			data.LFGNLKKFOCD_IsLine6 = _OMNOFMEBLAD_clearSetup.LFGNLKKFOCD_IsLine6;
			data.MNNHHJBBICA_GameEventType = _OMNOFMEBLAD_clearSetup.MNNHHJBBICA_GameEventType;
			data.OEILJHENAHN_PlayEventType = _OMNOFMEBLAD_clearSetup.OEILJHENAHN_PlayEventType;
			data.OBOPMHBPCFE_MvMode = _OMNOFMEBLAD_clearSetup.OBOPMHBPCFE_MvMode;
			...
			data.NFFDIGEJHGL_ServerTime = JGEOBNENMAH_NetGameManager.HHCJCDFCLOB_Instance.GJIICCJMDIF_GetServerTime();
			for(int i = 0; i < c; i++)
			{
				if(OLDFFDMPEBM_Quests[i].EALOBDHOCHP_stat == 1)
				{
					if(GBNDFCEDNMG.DACHEKFEFNN(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database, CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData, AGLILDLEFDK_Missions[i], data, this, false, _HDAMBOOCIAA_ClearType))
					{
						BOHCAIIBPEJ(AGLILDLEFDK_Missions[i], OLDFFDMPEBM_Quests[i], null, this);
					}
				}
	...
	public virtual void CNPHACDBLMD(JGEOBNENMAH_NetGameManager.HAJIFNABIFF _OMNOFMEBLAD_clearSetup)
	{
		if(AGLILDLEFDK_Missions != null && OLDFFDMPEBM_Quests != null && _OMNOFMEBLAD_clearSetup != null)
		{
			int c = AGLILDLEFDK_Missions.Count;
			...
			for(int i = 0; i < c; i++)
			{
				if(OLDFFDMPEBM_Quests[i].EALOBDHOCHP_stat == 1)
				{
					if(GBNDFCEDNMG.EIJIGDCMJLB(IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database, CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData, AGLILDLEFDK_Missions[i], _OMNOFMEBLAD_clearSetup, this, false))
					{
						BOHCAIIBPEJ(AGLILDLEFDK_Missions[i], OLDFFDMPEBM_Quests[i], _OMNOFMEBLAD_clearSetup, this);
					}
				}
			}
		}
	...
	public virtual void FHGEJBKNBLP(List<int> _CGCFENMHJIM_Ids)
	{
		if(AGLILDLEFDK_Missions != null && OLDFFDMPEBM_Quests != null)
		{
			...
			for(int i = 0; i < _CGCFENMHJIM_Ids.Count; i++)
			{
				if(OLDFFDMPEBM_Quests[_CGCFENMHJIM_Ids[i] - 1].EALOBDHOCHP_stat == 2)
				{
					OLDFFDMPEBM_Quests[_CGCFENMHJIM_Ids[i] - 1].JIOMCDGKIAF = 1;
				}
			}
		}
	}
					...
					for(int j = 0; j < strs.Length; j+=4)
					{
						...
						if(KLGILMKOHOI[c - 1].EALOBDHOCHP_stat < 2)
						{
							if(KLGILMKOHOI[d - 1].EALOBDHOCHP_stat < 2)
							{
								...
								int num = EKLNMHFCAOI_ItemManager.ALHCGDMEMID_GetNumItems(null, CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData, cat, id, null);
								NJEKJBDJKLH[c - 1].PPEGAKEIEGM_Enabled = 2;
								NJEKJBDJKLH[d - 1].PPEGAKEIEGM_Enabled = 0;
								if (num < b)
								{
									NJEKJBDJKLH[c - 1].PPEGAKEIEGM_Enabled = 0;
									NJEKJBDJKLH[d - 1].PPEGAKEIEGM_Enabled = 2;
								}
								else
									res |= 1 << i;
							}
	...
	public virtual void CFIINCJGBJB(bool _OAFPGJLCNFM_cond, int AHGHKCGLFBG)
	{
	...
	public virtual void KMCAIFKIFHM(IMCBBOAFION _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK _MOBEEPPKFLG_OnFail)
	{
		...
		{
			long LKCCMBEOLLA = NKGJPJPHLIF_SakashoManager.HHCJCDFCLOB_Instance.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime();
			PBJPACKDIIB_NetCoopQuestManager.Instance.HPFJOBPMNCP(PGIIDPEGGPI_EventId, KFNINHEJCLF(), true, LKCCMBEOLLA, (List<PBJPACKDIIB_NetCoopQuestManager.JBJMNJMJFOJ> ONIOKEOLKNK) =>
			{
				//0x8E2A74
				int cnt = AGLILDLEFDK_Missions.Count;
				if(OLDFFDMPEBM_Quests.Count < cnt)
					cnt = OLDFFDMPEBM_Quests.Count;
				int v = 0;
				if(HIDHLFCBIDE_EventType == OHCAABOMEOF.KGOGMKMBCPP_EventType.ENPJADLIFAB_EventSp && this is KNKDBNFMAKF_NetEventSpController)
				{
					v = (this as KNKDBNFMAKF_NetEventSpController).MEDEJHKNAFG_GetCurrentMissionGroup(LKCCMBEOLLA);
				}
				for(int i = 0; i < cnt; i++)
				{
					...
					{
						PBJPACKDIIB_NetCoopQuestManager.JBJMNJMJFOJ d = ONIOKEOLKNK.Find((PBJPACKDIIB_NetCoopQuestManager.JBJMNJMJFOJ AOIKKLBKEBC) =>
						{
							//0x8E2EE8
							return AOIKKLBKEBC.CMEJFJFOIIJ_QuestId == NHLBKJCPLBL.PPFNGGCBJKC_id;
						});
						int v2 = 0;
						if(d != null)
							v2 = d.HMFFHLPNMPH_count;
	...
	public virtual bool KKFEDJNIAAG(long _JHNMKKNEENE_Time)
	{
		if (_JHNMKKNEENE_Time < GLIMIGNNGGB_RankingStart)
			return false;
		return LJOHLEGGGMC_RewardEnd >= _JHNMKKNEENE_Time;
	}
	...
	public virtual int HLOGNJNGDJO_GetHelpId(int _OIPCCBHIKIA_index/* = 0*/)
	{
		return 0;
	}
	...
	{
		EJDJIBPKKNO_BasePoint = FBGDBGKNKOD_GetCurrentPoint();
	}

	// // RVA: 0x8DF718 Offset: 0x8DF718 VA: 0x8DF718 Slot: 29
	public virtual void MJFKJHJJLMN_GetRanks(int LHJCOPMMIGO/* = 0*/, bool _FBBNPFFEJBN_Force/* = false*/)
	{
	...
	protected abstract bool JIHMLILFOPG_IsEventActive(long _JHNMKKNEENE_Time);

	// // RVA: -1 Offset: -1 Slot: 31
	protected abstract bool IMCMNOPNGHO(long _JHNMKKNEENE_Time);
	...
	public virtual int JDFHIHPPAHN_GetNormalSetOverride(int NHIJBNLJGDJ, OHCAABOMEOF.KGOGMKMBCPP_EventType _INDDJNMPONH_type)
	{
		return NHIJBNLJGDJ;
	}

	// // RVA: 0x8DF78C Offset: 0x8DF78C VA: 0x8DF78C Slot: 35
	public virtual int NCHKBINKKBH_GetNormalRateOverride(int _BFOLFCOBBJD_RateId, OHCAABOMEOF.KGOGMKMBCPP_EventType _INDDJNMPONH_type)
	{
		return _BFOLFCOBBJD_RateId;
	}

	// // RVA: 0x8DF794 Offset: 0x8DF794 VA: 0x8DF794 Slot: 36
	public virtual int EEMGDCPJNEG_GetRare2SetOverride(int JEAHDIOLGEL, OHCAABOMEOF.KGOGMKMBCPP_EventType _INDDJNMPONH_type)
	{
		return JEAHDIOLGEL;
	}

	// // RVA: 0x8DF79C Offset: 0x8DF79C VA: 0x8DF79C Slot: 37
	public virtual int DJHOMGLGAHA_GetRare2RateOverride(int PLLAIBDLKHB, OHCAABOMEOF.KGOGMKMBCPP_EventType _INDDJNMPONH_type)
	{
		return PLLAIBDLKHB;
	}
	...
	public bool GHKKPKBBEAN_Prepare(long _JHNMKKNEENE_Time)
	{
		return ENBOJGJCPCP(_JHNMKKNEENE_Time);
	}

	// // RVA: 0x8DF8E0 Offset: 0x8DF8E0 VA: 0x8DF8E0 Slot: 39
	protected virtual bool ENBOJGJCPCP(long _JHNMKKNEENE_Time)
	{
		if(JIHMLILFOPG_IsEventActive(_JHNMKKNEENE_Time))
		{
			return IMCMNOPNGHO(_JHNMKKNEENE_Time);
		}
		return false;
	}

	// // RVA: 0x8DF94C Offset: 0x8DF94C VA: 0x8DF94C
	public void EHNHJKBDIJN(long _JHNMKKNEENE_Time)
	{
		NPNNPNAIONN_IsError = false;
		PLOOEECNHFB_IsDone = false;
		GPHEKCNDDIK = false;
		KKFLDCBHFJA(_JHNMKKNEENE_Time);
	}

	// // RVA: 0x8DF980 Offset: 0x8DF980 VA: 0x8DF980 Slot: 40
	protected virtual void KKFLDCBHFJA(long _JHNMKKNEENE_Time)
	{
		PLOOEECNHFB_IsDone = true;
	}
	...
	public virtual int DEECKJADNMJ(int _LAJNCHHNLBI_n)
	{
	...
	protected virtual IEnumerator JEIJKLPOAHP_ReceivePrologueRepeatedAchievement(DJBHIFLHJLK _AOCANKOMKFG_OnError)
	{
		//0x8E4088
	...
	protected virtual IEnumerator KPBNMAEHHDF_ReceiveEpilogueRepeatedAchivement(DJBHIFLHJLK _AOCANKOMKFG_OnError)
	{
		//0x8E38F4
		KGBCKPKLKHM_RewardItems.Clear();
		yield break;
	...
	protected IEnumerator AOGIMHOLIFB_ReceiveLoguinRepetedAchivement(List<string> _MIDAMHNABAJ_Keys, DJBHIFLHJLK _AOCANKOMKFG_OnError)
	{
		//0x8E3A34
		...
		req.MIDAMHNABAJ_Keys = _MIDAMHNABAJ_Keys;
		req.BHFHGFKBOHH_OnSuccess = (CACGCMBKHDI_NetBaseAction NHECPMNKEFK) =>
		{
			...
			for(int i = 0; i < r.NFEAMMJIMPG_Result.CEDLLCCONJP_achievement_prizes.Count; i++)
			{
				if(!r.NFEAMMJIMPG_Result.CEDLLCCONJP_achievement_prizes[i].OOIJCMLEAJP_is_received)
				{
					...
					JKGAGLAIEHH.Add(r.NFEAMMJIMPG_Result.CEDLLCCONJP_achievement_prizes[i].LJNAKDMILMC_key, r.NFEAMMJIMPG_Result.CEDLLCCONJP_achievement_prizes[i].HBHMAKNGKFK_items);
				}
			}
			NKGNJJDFMPH = true;
		};
		...
		if(CLPMDJFKJBO.Count != 0)
		{
			...
			req2.MIDAMHNABAJ_Keys = _MIDAMHNABAJ_Keys;
			NKGNJJDFMPH = false;
			req2.BHFHGFKBOHH_OnSuccess = (CACGCMBKHDI_NetBaseAction NHECPMNKEFK) =>
			{
				//0x8E32E0
				NKGNJJDFMPH = true;
				...
				for(int i = 0; i < r.NFEAMMJIMPG_Result.CEDLLCCONJP_achievement_prizes.Count; i++)
				{
					KGBCKPKLKHM_RewardItems.AddRange(JKGAGLAIEHH[r.NFEAMMJIMPG_Result.CEDLLCCONJP_achievement_prizes[i].LJNAKDMILMC_key]);
				}
			};
			req2.MOBEEPPKFLG_OnFail = (CACGCMBKHDI_NetBaseAction NHECPMNKEFK) =>
			{
				//0x8E354C
				NKGNJJDFMPH = true;
				KPIGMCJMFAN = true;
	...
	public void HCDGELDHFHB_UpdateStatus(long _JHNMKKNEENE_Time)
	{
		PJDGDNJNCNM_UpdateStatusImpl(_JHNMKKNEENE_Time);
	}

	// // RVA: 0x8DFC34 Offset: 0x8DFC34 VA: 0x8DFC34 Slot: 46
	protected virtual void PJDGDNJNCNM_UpdateStatusImpl(long _JHNMKKNEENE_Time)
	{
		return;
	}

	// // RVA: 0x8DFC38 Offset: 0x8DFC38 VA: 0x8DFC38 Slot: 47
	public virtual void NBMDAOFPKGK(int _DNBFMLBNAEE_point)
	{
		return;
	}
	...
	public void FGMOMBKGCNF_UpdateRankingValue(int LHJCOPMMIGO/* = 0*/)
	{
        NPNNPNAIONN_IsError = false;
        PLOOEECNHFB_IsDone = false;
	...
	public virtual void FAMFKPBPIAA_GetRankingPlayerList(bool PFFJNEFNAMI, int _CJHEHIMLGGL_Position, int LHJCOPMMIGO, LIOLBKLMMIK _KLMFJJCNBIP_OnSuccess, DJBHIFLHJLK _IDAEHNGOKAE_OnRankingError, DJBHIFLHJLK _JGKOLBLPMPG_OnFail)
	{
		PLOOEECNHFB_IsDone = true;
	...
	public virtual void JPNACOLKHLB_AddRankingPlayerListSecond(int NICJGAJKODN, int NEFEFHBHFFF, LIOLBKLMMIK _KLMFJJCNBIP_OnSuccess, DJBHIFLHJLK _IDAEHNGOKAE_OnRankingError, DJBHIFLHJLK _JGKOLBLPMPG_OnFail)
	{
		PLOOEECNHFB_IsDone = true;
		_IDAEHNGOKAE_OnRankingError();
	}
	...
	public virtual void LHAEPPFACOB_SetRewardReceived(int LHJCOPMMIGO, bool _OAFPGJLCNFM_cond)
	{
		return;
	}
	...
	public virtual bool EMNKNFNKPAD_SetIsPickup(bool _JKDJCFEBDHC_Enabled)
	{
		return true;
	}
	...
	public List<int> LEPNPBIMHGM_GetEquippedEpisodesWithBonus(int BMMPAHHEOJC)
	{
		...
		for(int i = 0; i < 3; i++)
		{
			AMCGONHBGGF d = GameManager.Instance.ViewPlayerData.DPLBHAIKPGL_GetTeam(CMEOKJMCEBH_IsGoDiva).DJPFJGKGOOF_Setting.FDBOPFEOENF_diva[i];
			if(d.DIPKCALNIII_diva_id != 0)
			{
				for(int j = 0; j < 3; j++)
				{
					if(d.EBDNICPAFLB_s_slot[j] != 0)
					{
						MLIBEPGADJH_Scene.KKLDOOJBJMN scene = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[d.EBDNICPAFLB_s_slot[j] - 1];
						if(scene.PPEGAKEIEGM_Enabled == 2)
						{
							int KELFCMEOPPM_EpisodeId = scene.KELFCMEOPPM_EpisodeId;
							if(KELFCMEOPPM_EpisodeId != 0)
							{
								HMGPODKEFBA_EpisodeInfo ep = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MOLEPBNJAGE_Episode.BBAJKJPKOHD_EpisodeList[KELFCMEOPPM_EpisodeId - 1];
								if(ep.PPEGAKEIEGM_Enabled == 2)
								{
									int idx = LHAKGDAGEMM_EpBonusInfos.FindIndex((IKDICBBFBMI_NetEventBaseController.CEGDBNNIDIG _GHPLINIACBB_x) =>
									{
										//0x8E2700
										return _GHPLINIACBB_x.KELFCMEOPPM_EpisodeId == KELFCMEOPPM_EpisodeId;
									});
									if(idx > -1)
									{
										int idx2 = res.FindIndex((int _GHPLINIACBB_x) =>
										{
											//0x8E2738
											return KELFCMEOPPM_EpisodeId == _GHPLINIACBB_x;
										});
										if(idx2 < 0)
										{
											res.Add(KELFCMEOPPM_EpisodeId);
										}
									}
								}
							}
		...
		if(BMMPAHHEOJC != 0)
		{
			MLIBEPGADJH_Scene.KKLDOOJBJMN scene = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[BMMPAHHEOJC - 1];
			int KELFCMEOPPM_EpisodeId = scene.KELFCMEOPPM_EpisodeId;
			int idx = LHAKGDAGEMM_EpBonusInfos.FindIndex((IKDICBBFBMI_NetEventBaseController.CEGDBNNIDIG _GHPLINIACBB_x) =>
			{
				//0x8E274C
	...
	{
		return EACFDLHOHKE(GameManager.Instance.ViewPlayerData.DPLBHAIKPGL_GetTeam(CMEOKJMCEBH_IsGoDiva), BMMPAHHEOJC, MHADLGMJKGK);
	}
	...
	{
		return EACFDLHOHKE(GameManager.Instance.ViewPlayerData.JKIJFGGMNAN_GetUnit(CEHNJCIIKDN, CMEOKJMCEBH_IsGoDiva), BMMPAHHEOJC, MHADLGMJKGK);
	}

	// // RVA: 0x8E07F8 Offset: 0x8E07F8 VA: 0x8E07F8
	private List<GNPOABJANKO> EACFDLHOHKE(JLKEOGLJNOD_TeamInfo _MLAFAACKKBG_Unit, int BMMPAHHEOJC, int MHADLGMJKGK)
	{
		List<GNPOABJANKO> res = new List<GNPOABJANKO>(LHAKGDAGEMM_EpBonusInfos.Count);
		...
		for(int i = 0; i < LHAKGDAGEMM_EpBonusInfos.Count; i++)
		{
			if(epList[LHAKGDAGEMM_EpBonusInfos[i].KELFCMEOPPM_EpisodeId - 1].PPEGAKEIEGM_Enabled == 2)
			{
				GNPOABJANKO g = new GNPOABJANKO();
				g.JKDJCFEBDHC_Enabled = false;
				g.KELFCMEOPPM_EpisodeId = LHAKGDAGEMM_EpBonusInfos[i].KELFCMEOPPM_EpisodeId;
				g.HEDODOBGPPM_BonusValue = 0;
				res.Add(g);
			}
		}
		CIKHPBBNEIM cData = new CIKHPBBNEIM();
		cData.OBKGEDCKHHE_Init(this, CMEOKJMCEBH_IsGoDiva);
		for(int i = 0; i < 3; i++)
		{
			if(_MLAFAACKKBG_Unit.DJPFJGKGOOF_Setting.FDBOPFEOENF_diva[i].DIPKCALNIII_diva_id != 0)
			{
				for(int j = 0; j < 3; j++)
				{
                    int JGJPKLCCOIO_scene_id = _MLAFAACKKBG_Unit.DJPFJGKGOOF_Setting.FDBOPFEOENF_diva[i].EBDNICPAFLB_s_slot[j];
					if(JGJPKLCCOIO_scene_id != 0)
					{
						MMPBPOIFDAF_Scene.PMKOFEIONEG saveScene = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData.PNLOINMCCKH_Scene.OPIBAPEGCLA_Scenes[JGJPKLCCOIO_scene_id - 1];
						MLIBEPGADJH_Scene.KKLDOOJBJMN dbScene = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[JGJPKLCCOIO_scene_id - 1];
						bool b = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.OEEJKKFOBKD(JGJPKLCCOIO_scene_id);
						int KELFCMEOPPM_EpisodeId = dbScene.KELFCMEOPPM_EpisodeId;
						if(KELFCMEOPPM_EpisodeId != 0)
						{
							HMGPODKEFBA_EpisodeInfo dbEp = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.MOLEPBNJAGE_Episode.BBAJKJPKOHD_EpisodeList[KELFCMEOPPM_EpisodeId - 1];
							if(dbEp.PPEGAKEIEGM_Enabled == 2)
							{
								int idx = LHAKGDAGEMM_EpBonusInfos.FindIndex((CEGDBNNIDIG _GHPLINIACBB_x) =>
								{
									//0x8E27D0
									return _GHPLINIACBB_x.KELFCMEOPPM_EpisodeId == KELFCMEOPPM_EpisodeId;
								});
								if(idx > -1)
								{
									CIKHPBBNEIM.PBJEFDNBBCD l = cData.GGHMLFOFELH(KELFCMEOPPM_EpisodeId);
									GNPOABJANKO g = res.Find((GNPOABJANKO _GHPLINIACBB_x) =>
									{
										//0x8E2808
										return _GHPLINIACBB_x.KELFCMEOPPM_EpisodeId == KELFCMEOPPM_EpisodeId;
									});
									if(g != null)
									{
										g.JKDJCFEBDHC_Enabled = true;
										CIKHPBBNEIM.ODGCADPPIFA d = l.FLJNOOPOAGI.Find((CIKHPBBNEIM.ODGCADPPIFA _GHPLINIACBB_x) =>
										{
											//0x8E2798
											return _GHPLINIACBB_x.BCCHOBPJJKE_SceneId == JGJPKLCCOIO_scene_id;
										});
										int a1 = d.ALDAOOLPHCH_BonusAfter;
										if(saveScene.JPIPENJGGDD_NumBoard <= 0 && !b)
										{
		...
		if(BMMPAHHEOJC != 0)
		{
			MLIBEPGADJH_Scene.KKLDOOJBJMN dbScene = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[BMMPAHHEOJC - 1];
			int KELFCMEOPPM_EpisodeId = dbScene.KELFCMEOPPM_EpisodeId;
			int PONFKONDHAC = BMMPAHHEOJC;
			int LBDAABHNLGI = dbScene.KELFCMEOPPM_EpisodeId;
			int idx = LHAKGDAGEMM_EpBonusInfos.FindIndex((CEGDBNNIDIG _GHPLINIACBB_x) =>
			{
				//0x8E2840
				return _GHPLINIACBB_x.KELFCMEOPPM_EpisodeId == LBDAABHNLGI;
			});
			if(idx > -1)
			{
				...
				if(g != null)
				{
					bool b = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.OEEJKKFOBKD(BMMPAHHEOJC);
					g.JKDJCFEBDHC_Enabled = true;
					CIKHPBBNEIM.ODGCADPPIFA d = l.FLJNOOPOAGI.Find((CIKHPBBNEIM.ODGCADPPIFA _GHPLINIACBB_x) =>
					{
						//0x8E28B0
						return _GHPLINIACBB_x.BCCHOBPJJKE_SceneId == PONFKONDHAC;
					});
					int a1 = d.ALDAOOLPHCH_BonusAfter;
					if(MHADLGMJKGK <= 0 && !b)
					{
		...
		else
		{
			...
			MLIBEPGADJH_Scene.KKLDOOJBJMN dbScene = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[BNJGNKCKCBD.BCCHOBPJJKE_SceneId - 1];
			int KELFCMEOPPM_EpisodeId = dbScene.KELFCMEOPPM_EpisodeId;
			CIKHPBBNEIM.PBJEFDNBBCD l = cData.GGHMLFOFELH(KELFCMEOPPM_EpisodeId);
			int idx = LHAKGDAGEMM_EpBonusInfos.FindIndex((CEGDBNNIDIG _GHPLINIACBB_x) =>
			{
			...
			if(idx >= 0)
			{
				...
				if(g != null)
				{
					bool b = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.OEEJKKFOBKD(BNJGNKCKCBD.BCCHOBPJJKE_SceneId);
					g.JKDJCFEBDHC_Enabled = true;
					CIKHPBBNEIM.ODGCADPPIFA d = l.FLJNOOPOAGI.Find((CIKHPBBNEIM.ODGCADPPIFA _GHPLINIACBB_x) =>
					{
						//0x8E28E8
						return _GHPLINIACBB_x.BCCHOBPJJKE_SceneId == BNJGNKCKCBD.BCCHOBPJJKE_SceneId;
					});
					int a1 = d.ALDAOOLPHCH_BonusAfter;
	...
	public virtual void FGDDBFHGCGP_SetStartAdventureShown(bool _JKDJCFEBDHC_Enabled, long _JHNMKKNEENE_Time/* = 0*/)
	{
		return;
	}
	...
	public virtual void ADACMHAHHKC_PreSetupEventHome(IMCBBOAFION _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK _AOCANKOMKFG_OnError)
	{
		NPNNPNAIONN_IsError = false;
		PLOOEECNHFB_IsDone = true;
	...
	public virtual int BAEPGOAMBDK(string _LJNAKDMILMC_key, int MNCOAGOKNAO)
	{
		return MNCOAGOKNAO;
	}

	// // RVA: 0x8E2394 Offset: 0x8E2394 VA: 0x8E2394 Slot: 72
	public virtual string MAICAKMIBEM(string _LJNAKDMILMC_key, string MNCOAGOKNAO)
	{
		return MNCOAGOKNAO;
	}

	// // RVA: 0x8E239C Offset: 0x8E239C VA: 0x8E239C Slot: 73
	public virtual List<string> IJCPBPFEGDM_GetResourcesFilePathList(long _JHNMKKNEENE_Time)
	{
		return null;
	}

	// // RVA: 0x8E23A4 Offset: 0x8E23A4 VA: 0x8E23A4
	protected bool MNNNLDFNNCD(long _JHNMKKNEENE_Time)
	{
		if(_JHNMKKNEENE_Time < GLIMIGNNGGB_RankingStart)
			return false;
		return LJOHLEGGGMC_RewardEnd > _JHNMKKNEENE_Time;
	...
	protected bool DLHEEOIELBA(int _IJEKNCDIIAE_mver)
	{
		return _IJEKNCDIIAE_mver <= DIHHCBACKGG_DbSection.IEFOPDOOLOK_MasterVersion;
	}
