...
public class KFKCGKGKBJL
{
	...
	public int HHPFFPINGAA_IdxCrypted = FBGGEFFJJHB_xor; // 0x2C
	...
	public int EILKGEADKGH_Order { get { return HHPFFPINGAA_IdxCrypted ^ FBGGEFFJJHB_xor; } set { HHPFFPINGAA_IdxCrypted = value ^ FBGGEFFJJHB_xor; } } //0x19FD4DC NPDDACIHBKD 0x19FD4F0 BJJMCKHBPNH
	...
	public void KHEKNNFCAOI(EDOHBJAPLPF_JsonData IDLHJIOMJBK)
	{
		...
		if(OPFGFINHFCE_Name == AFEHLCGHAEE_Strings.COIODGJDJEJ_scene)
		{
			...
			{
				GDEJFKCMNAC_EpisodeId = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[NANNGLGOFKH_Value - 1].KELFCMEOPPM_Ep;
			}
		}
