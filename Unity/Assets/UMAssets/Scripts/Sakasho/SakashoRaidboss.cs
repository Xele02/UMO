...
public class SakashoRaidboss : SakashoAPIBase
{
	...
	// private static extern int SakashoRaidbossAttackRaidbossAndSave(int callbackId, string json) { }
    ...
    {
        TodoLogger.LogError(TodoLogger.EventRaid_11_13, "SakashoRaidbossEncounterRaidboss");
        return 0;
    }
    ...
    {
        TodoLogger.LogError(TodoLogger.EventRaid_11_13, "SakashoRaidbossGetMyRaidbosses");
        return 0;
    }

	// // RVA: 0x2E5EFD0 Offset: 0x2E5EFD0 VA: 0x2E5EFD0
	// private static extern int SakashoRaidbossSetRaidbossRewardsReceivedAndSave(int callbackId, string json) { }

	// // RVA: 0x2E5F0F0 Offset: 0x2E5F0F0 VA: 0x2E5F0F0
	private static int SakashoRaidbossGetRaidboss(int callbackId, string json)
	{
        TodoLogger.LogError(TodoLogger.EventRaid_11_13, "SakashoRaidbossGetRaidboss");
        return 0;
	}
	...
	{
        TodoLogger.LogError(TodoLogger.EventRaid_11_13, "SakashoRaidbossRequestRaidbossHelp");
        return 0;
	}
