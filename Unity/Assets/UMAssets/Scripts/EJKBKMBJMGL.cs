...
public class EJKBKMBJMGL_EnemyData
{
	...
	public void KHEKNNFCAOI_Init(int _EJNIMIAPJFJ_Id, int IHKNHNKMGAD)
	{
		...
		MHDFCLCMDKO_Enemy.CJLENGHPIDH_EnemyInfo dbEnnemy = IMMAOANGPNK_NetMasterDataManager.HHCJCDFCLOB_Instance.NKEBMCIMJND_Database.OPFBEAJJMJB_Enemy.INONDJKKOKG(_EJNIMIAPJFJ_Id);
