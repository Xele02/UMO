...
public class EJKBKMBJMGL_EnemyData
{
	...
	public int ADMMEMNGKEN = 0; // 0x10
	public int EAHPLCJMPHD = 0; // 0x14
	public int EELBHDJJJHH = 1; // 0x18
	public int JMEGLFEKEBD = 1; // 0x1C
	public int MOMCFBMJJKB = 1; // 0x20
	public string OPFGFINHFCE; // 0x24
	public string KLMPFGOCBHC; // 0x28
	public string NDPPEMCHKHA; // 0x2C
	public string PFHJFIHGCKP; // 0x30
	public int DCOALMMJDJK; // 0x34
	public int KKPLDFNDFDE; // 0x38

	//public int LMJFFFOEPLE { get; } 0x12F3790 CGIJHCKFOKG
	public int PDHCABLLJPB { get { return DCOALMMJDJK < 1 ? MOMCFBMJJKB : DCOALMMJDJK; } } //0x12F37A4 LJKILMHFCCK
