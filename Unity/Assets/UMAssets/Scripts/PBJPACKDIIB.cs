...
public class PBJPACKDIIB : Singleton<PBJPACKDIIB>, IDisposable
{
	...
	public void KNPBADBCOLO_Send(IMCBBOAFION _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK _MOBEEPPKFLG_OnFail)
	{
		N.a.StartCoroutineWatched(MCHIFJFALGL_Coroutine_Send(_BHFHGFKBOHH_OnSuccess, _MOBEEPPKFLG_OnFail));
	}

	// [IteratorStateMachineAttribute] // RVA: 0x6BA674 Offset: 0x6BA674 VA: 0x6BA674
	// // RVA: 0xCBC31C Offset: 0xCBC31C VA: 0xCBC31C
	private IEnumerator MCHIFJFALGL_Coroutine_Send(IMCBBOAFION _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK _MOBEEPPKFLG_OnFail)
	{
