...
public class KBPDNHOKEKD_ProductId
{
	...
	public void KHEKNNFCAOI(EDOHBJAPLPF_JsonData IDLHJIOMJBK)
	{
		...
		GLHKICCPGKJ_PlatformProductId = CEDHHAGBIBA.BNCLNFJHEND_ReadString(IDLHJIOMJBK, AFEHLCGHAEE_Strings.GLHKICCPGKJ_PlatformProductId);
		...
		GIEBJDKLCDH_BoughtQuantity = CEDHHAGBIBA.GNJBKANDLEE_ReadInt(IDLHJIOMJBK, AFEHLCGHAEE_Strings.GIEBJDKLCDH_BoughtQuantity);
		...
		EGBOHDFBAPB_ClosedAt = CEDHHAGBIBA.NIKODNFGCEM_ReadLong(IDLHJIOMJBK, AFEHLCGHAEE_Strings.EGBOHDFBAPB_CloseAt);
		...
		if(IDLHJIOMJBK.BBAJPINMOEP_Contains(AFEHLCGHAEE_Strings.GJEBPJHECIK_ItemSetNameForApi))
		{
			EDOHBJAPLPF_JsonData a = IDLHJIOMJBK[AFEHLCGHAEE_Strings.GJEBPJHECIK_ItemSetNameForApi];
			if(a != null)
			{
