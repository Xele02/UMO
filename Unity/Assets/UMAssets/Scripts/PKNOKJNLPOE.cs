...
public class PKNOKJNLPOE_EventRaid : IKDICBBFBMI_EventBase
{
	...
	public class MJFMOPMOFDJ : FCDIHBGEKOB
	{
		...
		// public static int CKHGLECNCAG(JLOGEHCIBEJ_EventRaid.JJAFLOEBLDH _INDDJNMPONH_type) { }

		// // RVA: 0xFDCD30 Offset: 0xFDCD30 VA: 0xFDCD30
		// public static int OHPCPAGKKCF(JLOGEHCIBEJ_EventRaid.JJAFLOEBLDH _INDDJNMPONH_type) { }
	...
	protected override void KKFLDCBHFJA(long _JHNMKKNEENE_Time)
	{
		...
		if(LKOLAGLKIDA != null)
		{
			...
			for(int i = 0; i < LKOLAGLKIDA.LHAKGDAGEMM_EpBonusInfos.Count; i++)
			{
				...
				c.KELFCMEOPPM_EpisodeId = LKOLAGLKIDA.LHAKGDAGEMM_EpBonusInfos[i].KHPHAAMGMJP_Id;
				c.MIHNKIHNBBL_BaseBonus = LKOLAGLKIDA.LHAKGDAGEMM_EpBonusInfos[i].OFIAENKCJME / 100.0f;
