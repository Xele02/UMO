...
public class FOCPLKMMCAL
{
	...
	//public List<int> IONINNDIAFO { get; } 0x13E8874 IICAOCOECKE
		...
		if(music != null)
		{
			...
			if(k != null)
			{
				...
				else
				{
					...
					LDNMDBMFIIK(OMNOFMEBLAD, music, true);
	...
	//public bool HNNPBABEPBP(JGEOBNENMAH.HAJIFNABIFF OMNOFMEBLAD, EAJCBFGKKFA IPGFALGDLHN) { }
	...
	//private bool ILDLMKGBKIL(JGEOBNENMAH.HAJIFNABIFF OMNOFMEBLAD, EONOEHOKBEB EPMMNEFADAP, bool JCCBGECHIEI) { }
	...
	//private void EMLKKEHCKMI(JGEOBNENMAH.HAJIFNABIFF OMNOFMEBLAD, EONOEHOKBEB EPMMNEFADAP, bool JCCBGECHIEI) { }
	...
	//private void LDNMDBMFIIK(JGEOBNENMAH.HAJIFNABIFF OMNOFMEBLAD, EONOEHOKBEB EPMMNEFADAP, bool IKGLAFOHGDO) { }
}
