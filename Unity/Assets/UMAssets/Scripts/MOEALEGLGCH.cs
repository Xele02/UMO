...
public class MOEALEGLGCH
{
				...
				if (d.KBOLNIBLIND[i].INDDJNMPONH_UnlockCondition < LCLCCHLDNHJ_Costume.LKLGPLFNJBA_UnlockCondition.AEFCOHJBLPO/*4*/)
				{
					switch(d.KBOLNIBLIND[i].INDDJNMPONH_UnlockCondition)
					{
						...
						case LCLCCHLDNHJ_Costume.LKLGPLFNJBA_UnlockCondition.BCJHILDCONA_2_UseItems/*2*/:
							...
							b = d.KBOLNIBLIND[i].PIBLLGLCJEO_UnlockValue[0] <= CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.EFBKCNNFIPJ(dbCosItem.PPFNGGCBJKC_Id).BFINGCJHOHI_Cnt;
							break;
	...
	public int DLJJACACBDI(int JBPCPCBLNDC, int MHFBCINOJEE, int HMFFHLPNMPH)
	{
		if(HMFFHLPNMPH > 0)
		{
            ...
            if (saveCos.BEEAIAAJOHD_CostumeId == JBPCPCBLNDC)
			{
				...
				{
					return HMFFHLPNMPH <= CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.EFBKCNNFIPJ(MHFBCINOJEE).BFINGCJHOHI_Cnt ? 1 : 0;
				}
            }
		}
		return -1;
	...
	private IEnumerator FOALKNNPKHG_Co_SaveAndUpdateRanking(int _AHHJLDLAPAN_DivaId, int CBGMGJLLDOO, IMCBBOAFION BHFHGFKBOHH)
	{
