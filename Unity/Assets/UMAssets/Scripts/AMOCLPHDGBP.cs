...
public delegate void ELBOJBBIBFM(LGDNAJACFHI PPFNGGCBJKC);
...
public class AMOCLPHDGBP
{
	...
	// private bool DDGIEBFGGDF(SakashoErrorId PPFNGGCBJKC) { }

	// // RVA: 0xCEA274 Offset: 0xCEA274 VA: 0xCEA274
	// public static bool ELDMAINJHJI(SakashoErrorId PPFNGGCBJKC) { }
