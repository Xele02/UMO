...
public class KDHGBOOECKC
{
	...
	public class CBJJINJDFDC
	{
		...
		public bool BOAOOEIIAHG(BOPFPIHGJMD.MLBMHDCCGHI FGHGMHPNEMG, int MLDPDLPHJPM, List<IBAOKNMIBCL> NNDGIAEFMOG)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				...
				for(int i = 0; i < NNDGIAEFMOG.Count; i++)
				{
					OIBNJADJHHG(CIOECGOMILE.HHCJCDFCLOB.JANMJPOKLFL, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, NNDGIAEFMOG[i].PPFNGGCBJKC_Id, NNDGIAEFMOG[i].BFINGCJHOHI_Cnt, FGHGMHPNEMG, MLDPDLPHJPM);
				}
				return true;
			}
			return false;
		...
		public bool BOAOOEIIAHG(JKNGJFOBADP JANMJPOKLFL, BOPFPIHGJMD.MLBMHDCCGHI FGHGMHPNEMG, int MLDPDLPHJPM, List<IBAOKNMIBCL> NNDGIAEFMOG)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				for(int i = 0; i < NNDGIAEFMOG.Count; i++)
				{
					OIBNJADJHHG(JANMJPOKLFL, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, NNDGIAEFMOG[i].PPFNGGCBJKC_Id, NNDGIAEFMOG[i].BFINGCJHOHI_Cnt, FGHGMHPNEMG, MLDPDLPHJPM);
				}
			}
			return false;
		}
	...
	public bool MDKADMHKOLN(OKGLGHCBCJP_Database LKMHPJKIFDN, BBHNACPENDM_ServerSaveData LDEGEHAEALK, BOPFPIHGJMD.MLBMHDCCGHI FGHGMHPNEMG, int MLDPDLPHJPM, bool FAGEBAKNAOB/* = false*/, int KDLDOLENIDG/* = 0*/, int _AHHJLDLAPAN_DivaId/* = 0*/, long KOOEOKEDJDO/* = 0*/, bool AGELHLFEJNG/* = true*/)
	{
		...
		if (FGHGMHPNEMG == BOPFPIHGJMD.MLBMHDCCGHI.FMLPIOFBCMA_3_Diva)
		{
			...
			{
				sOf.PIBLLGLCJEO_Prm = _AHHJLDLAPAN_DivaId;
			}
		}
		else
		{
	...
	public bool FGFJMGLFNNF(long KGIBHAGPCGE, long JHNMKKNEENE, ref List<LGHIPHEDCNC_Offer.LHDLCLNBPLB> ELAOAOKEJHN)
	{
		if(NHPDPKHMFEP.HHCJCDFCLOB.GBCPDBJEDHL(false) || NHPDPKHMFEP.HHCJCDFCLOB.ENAAHAPDMCO())
		{
			if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
			{
				...
				{
					bool res = false;
					if (!LNFMLNDHFHI(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, JHNMKKNEENE, BOPFPIHGJMD.DLDOEOEFJKA.LJJODKKOOFD_3))
						res = HDNBNNKHCPA(BOPFPIHGJMD.DLDOEOEFJKA.LJJODKKOOFD_3, JHNMKKNEENE, ref ELAOAOKEJHN);
					if(NHPDPKHMFEP.HHCJCDFCLOB.ENAAHAPDMCO())
					{
						if (!LNFMLNDHFHI(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, JHNMKKNEENE, BOPFPIHGJMD.DLDOEOEFJKA.MOADAEHPFPA_4))
		...
		if(!PEMMDEMCHAH())
		{
			if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
			{
				if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
				{
					...
					if (LJPLPIOJCNK == 0)
					{
						LJPLPIOJCNK = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.LJPLPIOJCNK_LastShowAt;
					}
	...
	public List<LGHIPHEDCNC_Offer.LHDLCLNBPLB> MIMNFDFLFFA(long JHNMKKNEENE)
	{
		...
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				...
				CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.LJPLPIOJCNK_LastShowAt = JHNMKKNEENE;
				...
				if(l3.Count > 0)
				{
					...
					{
						MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI.HEFPAOLDHCK_1_Day, l4[i].PPFNGGCBJKC, l4[i].PDBPFJJCADD != 0 || l4[i].FDBNFFNFOND != 0, l4[i].JBHBGOIMALD, 0, l4[i].KOOEOKEDJDO, false);
					}
				...
				if(AJAAFLHLNKP(JHNMKKNEENE, ref l5))
				{
					...
					{
						MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI.HEFPAOLDHCK_1_Day, l5[i].PPFNGGCBJKC, l5[i].PDBPFJJCADD != 0 || l5[i].FDBNFFNFOND != 0, l5[i].JBHBGOIMALD, 0, l5[i].KOOEOKEDJDO, false);
					}
				}
				...
				if(FGFJMGLFNNF(0, JHNMKKNEENE, ref l6))
				{
					...
					{
						MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI.HEFPAOLDHCK_1_Day, l6[i].PPFNGGCBJKC, l6[i].PDBPFJJCADD != 0 || l6[i].FDBNFFNFOND != 0, l6[i].JBHBGOIMALD, 0, l6[i].KOOEOKEDJDO, false);
					}
					DGCOECIKEGA |= BOPFPIHGJMD.GNGGLPCONLM.OCKIDPJNNBP_1;
				}
				BJIPLMJFAGH();
				...
				if (a4 != 0)
				{
					if(LJPLPIOJCNK >= a4 && a4 != CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.JKIFLFKFHPB_LastAddAt)
					{
						DGCOECIKEGA |= BOPFPIHGJMD.GNGGLPCONLM.OCKIDPJNNBP_1;
	...
	public List<LGHIPHEDCNC_Offer.BFEIHCJHHAJ> NHHLDEPNCNG(long JHNMKKNEENE)
	{
		...
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				...
				for(int i = 0; i < l.Count; i++)
				{
					MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI.FDOOAJLGFAE_2_Week, l[i].PPFNGGCBJKC, l[i].PDBPFJJCADD != 0 || l[i].FDBNFFNFOND != 0, 0, 0, 0, false);
				}
				BJIPLMJFAGH();
				bool b = false;
				for(int i = 0; i < JGPJCOCHJFJ.Count; i++)
		...
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				...
				for (int i = 0; i < IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.LBCMJGOOHLJ_Offer.OICGEEKOLOG.Count; i++)
				{
					...
					MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI.GENEIBGNMPH_4_Debut, of.PPFNGGCBJKC, of.PDBPFJJCADD != 0 || of.FDBNFFNFOND != 0, 0, 0, 0, false);
				}
				BJIPLMJFAGH();
				for(int i = 0; i < JGPJCOCHJFJ.Count; i++)
				{
	...
	public BOPFPIHGJMD.AHIOHONIGDH EKAECAHFMKE(LGHIPHEDCNC_Offer.NONCDAINJLD KOGBMDOONFA)
	{
		...
		if(d.OCAMDLMPBGA > 0)
		{
			if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
			{
				return (BOPFPIHGJMD.AHIOHONIGDH)IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.MGFMPKLLGHE_Diva.CDENCMNHNGA_Divas[d.OCAMDLMPBGA - 1].AIHCEGFANAM_SerieAttr;
			}
		}
	...
	public int LBDENPEGONA(int OIOECMEEFKJ, BOPFPIHGJMD.HBJMIJIOCAM DGGBOFDCOLG)
	{
		...
		if (IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				...
				{
					OCMJNBIFJNM_Offer.PMOECIDOLNA of = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.NEGDGHKOFFF_VFplatoon[OIOECMEEFKJ - 1];
					if(of != null)
					{
						int a1 = 100;
						int a2 = 50;
	...
	public bool PGGLEDMJEHB(BOPFPIHGJMD.MLBMHDCCGHI FGHGMHPNEMG, int MLDPDLPHJPM, int BFINGCJHOHI)
	{
		...
		if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null && CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.OEKEIGFAIGN_Counter != null)
		{
			...
			{
				CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.OEKEIGFAIGN_Counter.BDLNMOIOMHK_Total.KNGCKBNFEGM_AddVOp((int)FGHGMHPNEMG, BFINGCJHOHI);
				CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.OEKEIGFAIGN_Counter.BDLNMOIOMHK_Total.KNGCKBNFEGM_AddVOp(0, BFINGCJHOHI);
				if(FGHGMHPNEMG == BOPFPIHGJMD.MLBMHDCCGHI.FMLPIOFBCMA_3_Diva)
				{
					CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.OEKEIGFAIGN_Counter.BDLNMOIOMHK_Total.PMDMJKCANFF_AddDOp(of.PIBLLGLCJEO_Prm, BFINGCJHOHI);
				}
			}
		}
		...
		if(FGHGMHPNEMG < BOPFPIHGJMD.MLBMHDCCGHI.GEJGMBBCFEE/*5*/)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.OEKEIGFAIGN_Counter != null)
				{
					if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.OEKEIGFAIGN_Counter.BDLNMOIOMHK_Total != null)
					{
						return CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.OEKEIGFAIGN_Counter.BDLNMOIOMHK_Total.GKOAPFJFKEJ_VOpC[(int)FGHGMHPNEMG];
					}
				}
			}
		}
	...
	public int MAPECPHBNGM(int _AHHJLDLAPAN_DivaId)
	{
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			...
			data.KHEKNNFCAOI(_AHHJLDLAPAN_DivaId);
	...
	public LGHIPHEDCNC_Offer.PDLENIHAMBC AGFFPFCADJK(int _AHHJLDLAPAN_DivaId, List<LGHIPHEDCNC_Offer.PDLENIHAMBC> ABKBDLNLJDI, List<OCMJNBIFJNM_Offer.JPOHOLBBFGP> OMABPKCJECB)
	{
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			...
			for(int i = 0; i < ABKBDLNLJDI.Count; i++)
			{
				...
				if(d.OCAMDLMPBGA == _AHHJLDLAPAN_DivaId)
				{
					if(d.GOKJLBDJOLA == 1)
					{
						l.Add(d);
			...
			for(int i = 0; i < OMABPKCJECB.Count; i++)
			{
				...
				if(EILKGEADKGH.PIBLLGLCJEO_Prm == _AHHJLDLAPAN_DivaId)
				{
	...
	public BOPFPIHGJMD.LEIPFJHOFPC PANBPMDADAH(int BBIOMNCILMC, int _AKNELONELJK_Difficulty)
	{
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database == null)
		...
		if(of2 == null)
		{
			...
			if(!MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI.FMLPIOFBCMA_3_Diva, of3.PPFNGGCBJKC, of3.PDBPFJJCADD != 0 || of3.FDBNFFNFOND != 0, 0, a1, t + diva_offer_time_limit, false))
			{
				return BOPFPIHGJMD.LEIPFJHOFPC.HJNNKCMLGFL_0;
			}
			BJIPLMJFAGH();
		...
		else
		{
			...
			{
				JNIGHEHKAHG = 0;
				CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.JNIGHEHKAHG_DvPow = JNIGHEHKAHG;
				return BOPFPIHGJMD.LEIPFJHOFPC.HJNNKCMLGFL_0;
			}
			JNIGHEHKAHG = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.JNIGHEHKAHG_DvPow;
			LGHIPHEDCNC_Offer.PCOENHPINEI of4 = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.LBCMJGOOHLJ_Offer.JNIGHEHKAHG[_AKNELONELJK_Difficulty];
			...
			if(of3.PFJJFCPPNIN > 0)
			{
				...
				if(!MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI.FMLPIOFBCMA_3_Diva, of5.PPFNGGCBJKC, of5.PDBPFJJCADD != 0 || of5.FDBNFFNFOND != 0, 0, a1, t + diva_offer_time_limit, false))
				{
					return BOPFPIHGJMD.LEIPFJHOFPC.HJNNKCMLGFL_0;
				}
	...
	public void CGBBDJBEFAM(OKGLGHCBCJP_Database LKMHPJKIFDN, BBHNACPENDM_ServerSaveData LDEGEHAEALK, int KIJAPOFAGPN, int _ADPPAIPFHML_Num)
	{
		EKLNMHFCAOI.DPHGFMEPOCA_SetNumItems(LKMHPJKIFDN, LDEGEHAEALK, EKLNMHFCAOI.BKHFLDMOGBD_GetItemCategory(KIJAPOFAGPN), EKLNMHFCAOI.DEACAHNLMNI_getItemId(KIJAPOFAGPN), _ADPPAIPFHML_Num, null);
	}
	...
	public int BCJNPJKGNHF(int JBGEEPFKIGG)
	{
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				...
				int a = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.KPAJEAHFPFH_FastCmp + JBGEEPFKIGG;
	...
	public bool NKEKPBALJGD_IsFirstAdvOfferDone()
	{
		if (IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database == null || CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData == null)
			return false;
		return CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.HBPPNFHOMNB_Adventure.FABEJIHKFGN_IsReleased(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.LBCMJGOOHLJ_Offer.LPJLEHAJADA("first_adv_id", 88));
	}
