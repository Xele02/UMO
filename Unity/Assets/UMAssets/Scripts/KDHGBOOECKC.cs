...
public class KDHGBOOECKC
{
			...
			if(KDHGBOOECKC.HHCJCDFCLOB != null)
			{
				if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
				{
					if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
					{
						...
						List<IBAOKNMIBCL> l3 = KDHGBOOECKC.HHCJCDFCLOB.FOACCNFAGCH(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.LBCMJGOOHLJ_Offer.CIMLFGFMFCH, BOPFPIHGJMD.CJDCPBACOLH.CCAPCGPIIPF_3_Normal, of2.FFCJEOLDKGN(a1), d.EGDEGGMPIGA_normal);
	...
	public static KDHGBOOECKC HHCJCDFCLOB { get; private set; } // 0x0 LGMPACEDIJF_bgs NKACBOEHELJ_bgs OKPMHKNCNAL_bgs
	...
	public bool MDKADMHKOLN(OKGLGHCBCJP_Database _LKMHPJKIFDN_md, BBHNACPENDM_ServerSaveData _LDEGEHAEALK_ServerData, BOPFPIHGJMD.MLBMHDCCGHI_OfferType _FGHGMHPNEMG_Type, int _MLDPDLPHJPM_OfferId, bool _FAGEBAKNAOB_IsEvent/* = false*/, int KDLDOLENIDG/* = 0*/, int _AHHJLDLAPAN_DivaId/* = 0*/, long _KOOEOKEDJDO_expr/* = 0*/, bool AGELHLFEJNG/* = true*/)
	{
		...
		ILCCJNDFFOB.HHCJCDFCLOB.DAGHKCKEJPA_VopAppearence(_FGHGMHPNEMG_Type, _MLDPDLPHJPM_OfferId);
		return true;
	}
		...
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				...
				if(l3.Count > 0)
				{
					...
					{
						MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI_OfferType.HEFPAOLDHCK_1_Daily, l4[i].PPFNGGCBJKC_id, l4[i].PDBPFJJCADD_open_at != 0 || l4[i].FDBNFFNFOND_close_at != 0, l4[i].JBHBGOIMALD, 0, l4[i].KOOEOKEDJDO_expr, false);
					}
				...
				if(AJAAFLHLNKP(_JHNMKKNEENE_Time, ref l5))
				{
					...
					{
						MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI_OfferType.HEFPAOLDHCK_1_Daily, l5[i].PPFNGGCBJKC_id, l5[i].PDBPFJJCADD_open_at != 0 || l5[i].FDBNFFNFOND_close_at != 0, l5[i].JBHBGOIMALD, 0, l5[i].KOOEOKEDJDO_expr, false);
					}
				}
				...
				if(FGFJMGLFNNF(0, _JHNMKKNEENE_Time, ref l6))
				{
					...
					{
						MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI_OfferType.HEFPAOLDHCK_1_Daily, l6[i].PPFNGGCBJKC_id, l6[i].PDBPFJJCADD_open_at != 0 || l6[i].FDBNFFNFOND_close_at != 0, l6[i].JBHBGOIMALD, 0, l6[i].KOOEOKEDJDO_expr, false);
					}
					DGCOECIKEGA |= BOPFPIHGJMD.GNGGLPCONLM_OperationsStatusFlag.OCKIDPJNNBP_1_OpUpdated;
				}
				BJIPLMJFAGH();
	...
	public List<LGHIPHEDCNC_Offer.BFEIHCJHHAJ> NHHLDEPNCNG(long _JHNMKKNEENE_Time)
	{
		...
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				...
				for(int i = 0; i < l.Count; i++)
				{
					MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI_OfferType.FDOOAJLGFAE_2_Week, l[i].PPFNGGCBJKC_id, l[i].PDBPFJJCADD_open_at != 0 || l[i].FDBNFFNFOND_close_at != 0, 0, 0, 0, false);
				}
				BJIPLMJFAGH();
				bool b = false;
				for(int i = 0; i < JGPJCOCHJFJ.Count; i++)
		...
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				...
				for (int i = 0; i < IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.LBCMJGOOHLJ_Offer.OICGEEKOLOG.Count; i++)
				{
					...
					MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI_OfferType.GENEIBGNMPH_4_Debut, of.PPFNGGCBJKC_id, of.PDBPFJJCADD_open_at != 0 || of.FDBNFFNFOND_close_at != 0, 0, 0, 0, false);
				}
				BJIPLMJFAGH();
				for(int i = 0; i < JGPJCOCHJFJ.Count; i++)
				{
	...
	public BOPFPIHGJMD.AHIOHONIGDH_SeriesFlag EKAECAHFMKE(LGHIPHEDCNC_Offer.NONCDAINJLD _KOGBMDOONFA_Info)
	{
		...
		if(d.OCAMDLMPBGA_dv > 0)
		{
			if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
			{
				return (BOPFPIHGJMD.AHIOHONIGDH_SeriesFlag)IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.MGFMPKLLGHE_Diva.CDENCMNHNGA_table[d.OCAMDLMPBGA_dv - 1].AIHCEGFANAM_SerieAttr;
			}
		}
				...
				if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.PEOALFEGNDH_Valkyrie != null)
				{
					...
					if(of != null)
					{
						...
						for(int i = 0; i < 3; i++)
						{
							...
							if (a3 > 0)
							{
								JPIANKEOOMB_Valkyrie.KJPIDJOMODA_ValkyrieInfo valk = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.PEOALFEGNDH_Valkyrie.GCINIJEMHFK_Get(a3);
	...
	public int KGLLKKCFDEL(FKGMGBHBNOC.HPJOCKGKNCC_Form _MNCEBKHBBEF_VFform, BOPFPIHGJMD.ADMNKELOLPN _CGKPIIFCCLD_OfferType, BOPFPIHGJMD.HBJMIJIOCAM DGGBOFDCOLG)
	{
		if(_MNCEBKHBBEF_VFform < FKGMGBHBNOC.HPJOCKGKNCC_Form.AEFCOHJBLPO_3_Num && _CGKPIIFCCLD_OfferType > BOPFPIHGJMD.ADMNKELOLPN.HJNNKCMLGFL_0_None && _CGKPIIFCCLD_OfferType <= BOPFPIHGJMD.ADMNKELOLPN.GEJGMBBCFEE_5__max)
		{
			if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
			{
				if(DGGBOFDCOLG == BOPFPIHGJMD.HBJMIJIOCAM.JIOPJDJBLFK_1_Hit)
				{
					LGHIPHEDCNC_Offer.OKNFCMGANNF of = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.LBCMJGOOHLJ_Offer.KJEKILELBAB[(int)_MNCEBKHBBEF_VFform];
	...
	public bool PGGLEDMJEHB(BOPFPIHGJMD.MLBMHDCCGHI_OfferType _FGHGMHPNEMG_Type, int _MLDPDLPHJPM_OfferId, int _BFINGCJHOHI_cnt)
	{
		...
		{
			GNGMCIAIKMA.HHCJCDFCLOB.GJENEJOANEL(DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType.KENMCJCIGIB_3_VaklOp, (int)_FGHGMHPNEMG_Type, _BFINGCJHOHI_cnt, null);
			if(_FGHGMHPNEMG_Type == BOPFPIHGJMD.MLBMHDCCGHI_OfferType.FMLPIOFBCMA_3_Diva)
			{
				GNGMCIAIKMA.HHCJCDFCLOB.GJENEJOANEL(DKFJADMCNPI.NLKCMNHOBAI_BingoMissionType.LFLMBPJJEEG_4_DivaOp, of.PIBLLGLCJEO_Param, _BFINGCJHOHI_cnt, null);
			}
	...
	public BOPFPIHGJMD.LEIPFJHOFPC PANBPMDADAH(int _BBIOMNCILMC_HomeDivaId, int _AKNELONELJK_difficulty)
	{
		...
		if(of2 == null)
		{
			...
			if(!MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI_OfferType.FMLPIOFBCMA_3_Diva, of3.PPFNGGCBJKC_id, of3.PDBPFJJCADD_open_at != 0 || of3.FDBNFFNFOND_close_at != 0, 0, a1, t + diva_offer_time_limit, false))
			{
				return BOPFPIHGJMD.LEIPFJHOFPC.HJNNKCMLGFL_0_None;
			}
			BJIPLMJFAGH();
		...
		else
		{
			...
			if(of3.PFJJFCPPNIN_nx > 0)
			{
				...
				if(!MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI_OfferType.FMLPIOFBCMA_3_Diva, of5.PPFNGGCBJKC_id, of5.PDBPFJJCADD_open_at != 0 || of5.FDBNFFNFOND_close_at != 0, 0, a1, t + diva_offer_time_limit, false))
				{
					return BOPFPIHGJMD.LEIPFJHOFPC.HJNNKCMLGFL_0_None;
				}
	...
	public bool MGHPDFMDFCJ()
	{
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			return IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.GDEKCOOBLMA_System.LPJLEHAJADA_GetIntParam("vfo_diva_unlock_complete_offer_num", 10) <= DEAIKHLFFCL_GetTotalVOp(BOPFPIHGJMD.MLBMHDCCGHI_OfferType.HJNNKCMLGFL_0_None);
		}
		return false;
	}
	...
	public int JMGECJKIJJF()
	{
		if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
		{
			...
			if (a > 0 && !AHKAIKMNKJL())
			{
				...
				data.CPIICACGNBH_AddItem(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, EKLNMHFCAOI.GJEEGMCBGGM_GetItemFullId(EKLNMHFCAOI.FKGCBLHOOCL_Category.PFIOMNHDHCO_6_Valkyrie, a), 1, null, 0);
			}
			return a;
		}
		return 0;
	...
	{
		EKLNMHFCAOI.FKGCBLHOOCL_Category cat = EKLNMHFCAOI.BKHFLDMOGBD_GetItemCategory(_MBBJMJAAODG__ItemId);
		int id = EKLNMHFCAOI.DEACAHNLMNI_getItemId(_MBBJMJAAODG__ItemId);
		int num = EKLNMHFCAOI.ALHCGDMEMID_GetNumItems(_JLBMBKHBKBG__md, LNEAHKALBHN, cat, id, null);
		if(cat != EKLNMHFCAOI.FKGCBLHOOCL_Category.PJDEOPMBGKJ_PaidVC && cat != EKLNMHFCAOI.FKGCBLHOOCL_Category.MHKFDBLMOGF_Scene)
		{
			...
			{
				if (EKLNMHFCAOI.AFEONHCADEL_GetMaxAllowed(_JLBMBKHBKBG__md, LNEAHKALBHN, cat, id, null) < num + ENHEJFPMPJH)
					return true;
			}
		}
		return false;
