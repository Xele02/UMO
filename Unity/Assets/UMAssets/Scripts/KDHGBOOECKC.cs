...
public class KDHGBOOECKC
{
	...
	{
		List<OCMJNBIFJNM_Offer.JPOHOLBBFGP> l = ONEMGDCCPPM(LDEGEHAEALK, BOPFPIHGJMD.IGHPDAGKIKO.EBAPFCDNMGD_1, NPFIFEIOGAM == BOPFPIHGJMD.DLDOEOEFJKA.MOADAEHPFPA_4 ? BOPFPIHGJMD.CMBJEEGFODD.HIJBHIFABFC_32 : BOPFPIHGJMD.CMBJEEGFODD.JPFLFLFFEDD_16);
		DateTime date = Utility.GetLocalDateTime(JHNMKKNEENE);
		for(int i = 0; i < l.Count; i++)
		{
		...
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_ServerSave != null)
			{
				...
				if (FGHGMHPNEMG == BOPFPIHGJMD.DLDOEOEFJKA.MOADAEHPFPA_4)
					a = GOJDPOGJOLM(BOPFPIHGJMD.IGHPDAGKIKO.EBAPFCDNMGD_1, false);
				else
					a = MPPINCEGOJE(BOPFPIHGJMD.IGHPDAGKIKO.EBAPFCDNMGD_1, false);
		...
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_ServerSave != null)
			{
				...
				for (int i = 0; i < IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.LBCMJGOOHLJ_Offer.OICGEEKOLOG.Count; i++)
				{
					...
					MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_ServerSave, BOPFPIHGJMD.MLBMHDCCGHI.GENEIBGNMPH_4_Bg, of.PPFNGGCBJKC, of.PDBPFJJCADD != 0 || of.FDBNFFNFOND != 0, 0, 0, 0, false);
				}
				BJIPLMJFAGH();
				for(int i = 0; i < JGPJCOCHJFJ.Count; i++)
				{
					...
					if(of.GBJFNGCDKPM_Type == 4)
					{
						if(of.EALOBDHOCHP_Stat > 0)
						{
							LGHIPHEDCNC_Offer.FCOBCHHKMOA d = GKIOIHLDBGF(BOPFPIHGJMD.MLBMHDCCGHI.GENEIBGNMPH_4_Bg, of.MLDPDLPHJPM_OfferId) as LGHIPHEDCNC_Offer.FCOBCHHKMOA;
							if(d != null)
							{
	...
	{
		int a1 = ECBHIIOABCK();
		int a2 = LJMOMAGLEGL(BOPFPIHGJMD.MLBMHDCCGHI.GENEIBGNMPH_4_Bg, BOPFPIHGJMD.IGHPDAGKIKO.CADDNFIKDLG_4, true);
	...
	public string GEGAJLNPMEC(BOPFPIHGJMD.MLBMHDCCGHI FGHGMHPNEMG, int MLDPDLPHJPM)
	{
		...
		switch(FGHGMHPNEMG)
		{
			...
			case BOPFPIHGJMD.MLBMHDCCGHI.GENEIBGNMPH_4_Bg:
	...
	public BOPFPIHGJMD.LEIPFJHOFPC PANBPMDADAH(int BBIOMNCILMC, int AKNELONELJK)
	{
		...
		if (l == null)
			l = BJIPLMJFAGH();
		if (ECBHIIOABCK() - LJMOMAGLEGL(BOPFPIHGJMD.MLBMHDCCGHI.GENEIBGNMPH_4_Bg, BOPFPIHGJMD.IGHPDAGKIKO.CADDNFIKDLG_4, true) > 0)
	...
	public string JIMBMBEEMHI()
	{
		...
		if (ECBHIIOABCK() - LJMOMAGLEGL(BOPFPIHGJMD.MLBMHDCCGHI.GENEIBGNMPH_4_Bg, BOPFPIHGJMD.IGHPDAGKIKO.CADDNFIKDLG_4, true) < 1)
		{
	...
	public string JIDINGHMOJF()
	{
		...
		else
		{
			...
			for(int i = 0; i < 5; i++)
			{
				a += LJMOMAGLEGL((BOPFPIHGJMD.MLBMHDCCGHI) i, BOPFPIHGJMD.IGHPDAGKIKO.FJGFAPKLLCL_3/* 3*/, false);
			}
