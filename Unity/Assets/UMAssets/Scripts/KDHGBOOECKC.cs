...
public class KDHGBOOECKC
{
	...
	public class IBAOKNMIBCL
	{
		...
		public int BFINGCJHOHI_Count { get { return IFEHKNJONPL ^ 0x7138b4a5; } set { IFEHKNJONPL = value ^ 0x7138b4a5; } } //0xE720B8 LFMCLIDAPHB 0xE724B4 EDAEPDGGFJJ
	...
	public class CBJJINJDFDC
	{
		...
		public CBJJINJDFDC FKDIMODKKJD(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM)
		{
			if(KDHGBOOECKC.HHCJCDFCLOB != null)
			{
				if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
				{
					...
					{
						LGHIPHEDCNC_Offer.NONCDAINJLD of2 = KDHGBOOECKC.HHCJCDFCLOB.GKIOIHLDBGF(_FGHGMHPNEMG_Type, MLDPDLPHJPM);
						OCMJNBIFJNM_Offer.JPOHOLBBFGP of = KDHGBOOECKC.HHCJCDFCLOB.BKJJKHIBIGP(_FGHGMHPNEMG_Type, MLDPDLPHJPM);
						...
						List<IBAOKNMIBCL> l = KDHGBOOECKC.HHCJCDFCLOB.NLAPKNDOEPL_GetConfirmList(_FGHGMHPNEMG_Type, MLDPDLPHJPM);
						...
						{
							OKDOMNJHGNF_Confirm += l[i].BFINGCJHOHI_Count;
						}
						for(int i = 0; i < l2.Count; i++)
						{
							MFNCONLNBPB_Rare += l2[i].BFINGCJHOHI_Count;
						}
						for (int i = 0; i < l3.Count; i++)
						{
							OOEFNNNFOLF_Nomal += l3[i].BFINGCJHOHI_Count;
						}
		...
		public void CDNFIAKLGLH(ref List<IBAOKNMIBCL> FFKPGLNBMNL, List<IBAOKNMIBCL> PEGBLDOPIPM, bool AJBPBOECIMB)
		{
			...
			for (int i = 0; i < PEGBLDOPIPM.Count; i++)
			{
				...
				{
					d.BFINGCJHOHI_Count += PEGBLDOPIPM[i].BFINGCJHOHI_Count;
				}
			}
		...
		public List<IBAOKNMIBCL> JEMJKEPLPAA(int KGMACNGGCNB, BOPFPIHGJMD.CJDCPBACOLH HHACNFODNEF)
		{
			for(int i = 0; i < ENEHOPNDNAF.Count; i++)
			{
				...
				{
					int a = (ENEHOPNDNAF[i].BFINGCJHOHI_Count * KGMACNGGCNB + 99) / 100;
					ENEHOPNDNAF[i].BFINGCJHOHI_Count += a;
				...
				for(int i = 0; i < NNDGIAEFMOG.Count; i++)
				{
					if(EKLNMHFCAOI.BKHFLDMOGBD_GetItemCategory(NNDGIAEFMOG[i].PPFNGGCBJKC_Id) == EKLNMHFCAOI.FKGCBLHOOCL_Category.ACGHELNGNGK_UnionCredit)
					{
						...
						if (id > 0)
						{
							...
							res += dbItem.JBGEEPFKIGG_Val * NNDGIAEFMOG[i].BFINGCJHOHI_Count;
						}
					}
				}
			}
		...
		private void OIBNJADJHHG(JKNGJFOBADP JANMJPOKLFL, BBHNACPENDM_ServerSaveData LDEGEHAEALK, int KIJAPOFAGPN, int HMFFHLPNMPH, BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM)
		{
			...
			str.Append(':');
			str.Append(KDHGBOOECKC.HHCJCDFCLOB.OHDGMEGGLDP_GetSessionId(_FGHGMHPNEMG_Type, MLDPDLPHJPM));
		...
		public bool BOAOOEIIAHG(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM, List<IBAOKNMIBCL> NNDGIAEFMOG)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				...
				for(int i = 0; i < NNDGIAEFMOG.Count; i++)
				{
					OIBNJADJHHG(CIOECGOMILE.HHCJCDFCLOB.JANMJPOKLFL, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, NNDGIAEFMOG[i].PPFNGGCBJKC_Id, NNDGIAEFMOG[i].BFINGCJHOHI_Count, _FGHGMHPNEMG_Type, MLDPDLPHJPM);
				}
				return true;
			}
			return false;
		...
		public bool BOAOOEIIAHG(JKNGJFOBADP JANMJPOKLFL, BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM, List<IBAOKNMIBCL> NNDGIAEFMOG)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				for(int i = 0; i < NNDGIAEFMOG.Count; i++)
				{
					OIBNJADJHHG(JANMJPOKLFL, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, NNDGIAEFMOG[i].PPFNGGCBJKC_Id, NNDGIAEFMOG[i].BFINGCJHOHI_Count, _FGHGMHPNEMG_Type, MLDPDLPHJPM);
				}
			}
			return false;
		}
	...
	public class JNHGHDKLDEM
	{
		...
		public JNHGHDKLDEM JGJOAFJPIIH(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM)
		{
			...
			if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
			{
				if(HHCJCDFCLOB != null)
				{
					switch(HHCJCDFCLOB.KJGAJBOBIHK(_FGHGMHPNEMG_Type, MLDPDLPHJPM))
					{
	...
	public bool MDKADMHKOLN(OKGLGHCBCJP_Database LKMHPJKIFDN, BBHNACPENDM_ServerSaveData LDEGEHAEALK, BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM, bool FAGEBAKNAOB/* = false*/, int KDLDOLENIDG/* = 0*/, int _AHHJLDLAPAN_DivaId/* = 0*/, long KOOEOKEDJDO/* = 0*/, bool AGELHLFEJNG/* = true*/)
	{
		OCMJNBIFJNM_Offer saveOffer = LDEGEHAEALK.DAEJHMCMFJD_Offer;
		//LKMHPJKIFDN.LBCMJGOOHLJ_Offer;
		BJIPLMJFAGH();
		OCMJNBIFJNM_Offer.JPOHOLBBFGP sOf = BKJJKHIBIGP(_FGHGMHPNEMG_Type, MLDPDLPHJPM);
		if(sOf == null)
		{
		...
		sOf.GBJFNGCDKPM_Type = (int)_FGHGMHPNEMG_Type;
		sOf.EALOBDHOCHP_Stat = 1;
		sOf.LHMOAJAIJCO_IsNew = sOf.BFINGCJHOHI_Count == 0;
		...
		ILCCJNDFFOB.HHCJCDFCLOB.DAGHKCKEJPA(_FGHGMHPNEMG_Type, MLDPDLPHJPM);
		return true;
	}

	// // RVA: 0x1027FD0 Offset: 0x1027FD0 VA: 0x1027FD0
	public bool NEGHCLNLFEM(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM)
	{
		OCMJNBIFJNM_Offer.JPOHOLBBFGP of = BKJJKHIBIGP(_FGHGMHPNEMG_Type, MLDPDLPHJPM);
		if(of != null && of.EALOBDHOCHP_Stat == 2)
		{
			of.EALOBDHOCHP_Stat = 1;
			of.DFJLNPFJGDK_StartDate = 0;
	...
	public List<LGHIPHEDCNC_Offer.LHDLCLNBPLB> IOCBIDHIIAE(int AHCDMDKCDFM, int GPABMPAPIEC, long JHNMKKNEENE, BOPFPIHGJMD.FPKMKLDDCNL LJHNOBJJBJA, BOPFPIHGJMD.DLDOEOEFJKA INDDJNMPONH, int _BAOFEFFADPD_Day, bool BPAOFBAIAIK)
	{
			...
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				...
				for(int i = 0; i < IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.LBCMJGOOHLJ_Offer.HOJPJAFDIAD.Count; i++)
				{
					...
					if(dbOf.PLALNIIBLOF == 2)
					{
						if(BPAOFBAIAIK)
						{
							OCMJNBIFJNM_Offer.JPOHOLBBFGP d = BKJJKHIBIGP((BOPFPIHGJMD.MLBMHDCCGHI)dbOf.GBJFNGCDKPM_Type, dbOf.PPFNGGCBJKC);
						...
						switch(INDDJNMPONH)
						{
							...
							case BOPFPIHGJMD.DLDOEOEFJKA.PLFJBGJMMDP_1:
								{
									if (dbOf.PDBPFJJCADD == 0 && dbOf.FDBNFFNFOND_CloseAt == 0)
									{
										int a = 1;
							...
							case BOPFPIHGJMD.DLDOEOEFJKA.CCDOBDNDPIL_2:
								{
									if (dbOf.PDBPFJJCADD == 0 && dbOf.FDBNFFNFOND_CloseAt == 0)
										break;
									if (dbOf.FDBNFFNFOND_CloseAt != 0 && JHNMKKNEENE >= dbOf.FDBNFFNFOND_CloseAt)
										break;
	...
	// public int PEJKAKECJNI(int NNDBJGDFEEM, int _DOOGFEGEKLG_Max) { }
	...
	public LGHIPHEDCNC_Offer.LHDLCLNBPLB GABIMDJLBAG(ref List<LGHIPHEDCNC_Offer.LHDLCLNBPLB> CLMLKNCOOHH)
	{
		...
		for(int i = 0; i < CLMLKNCOOHH.Count; i++)
		{
			OCMJNBIFJNM_Offer.JPOHOLBBFGP of = BKJJKHIBIGP((BOPFPIHGJMD.MLBMHDCCGHI)CLMLKNCOOHH[i].GBJFNGCDKPM_Type, CLMLKNCOOHH[i].PPFNGGCBJKC);
			if(of == null || (of.EALOBDHOCHP_Stat == 0 && of.BFINGCJHOHI_Count == 0))
			{
				l.Add(CLMLKNCOOHH[i]);
			}
		}
	...
	public bool AJAAFLHLNKP(long JHNMKKNEENE, ref List<LGHIPHEDCNC_Offer.LHDLCLNBPLB> ELAOAOKEJHN)
	{
		...
		for(int i = 0; i < l.Count; i++)
		{
			OCMJNBIFJNM_Offer.JPOHOLBBFGP of = BKJJKHIBIGP((BOPFPIHGJMD.MLBMHDCCGHI)l[i].GBJFNGCDKPM_Type, l[i].PPFNGGCBJKC);
	...
	public List<OCMJNBIFJNM_Offer.JPOHOLBBFGP> ONEMGDCCPPM(BBHNACPENDM_ServerSaveData LDEGEHAEALK, BOPFPIHGJMD.IGHPDAGKIKO CMCKNKKCNDK_Status, BOPFPIHGJMD.CMBJEEGFODD IBADNKFPNPI)
	{
		BJIPLMJFAGH();
	...
	public bool LNFMLNDHFHI(BBHNACPENDM_ServerSaveData LDEGEHAEALK, long JHNMKKNEENE, BOPFPIHGJMD.DLDOEOEFJKA NPFIFEIOGAM)
	{
		...
		for(int i = 0; i < l.Count; i++)
		{
			...
			{
				DateTime date2 = Utility.GetLocalDateTime(l[i].DFJLNPFJGDK_StartDate);
	...
	public bool HDNBNNKHCPA(BOPFPIHGJMD.DLDOEOEFJKA _FGHGMHPNEMG_Type, long JHNMKKNEENE, ref List<LGHIPHEDCNC_Offer.LHDLCLNBPLB> ELAOAOKEJHN)
	{
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				...
				for(int i = 0; i < l.Count; i++)
				{
					...
					if (a < a3)
					{
						List<LGHIPHEDCNC_Offer.LHDLCLNBPLB> l2 = IOCBIDHIIAE(1, 5, JHNMKKNEENE, BOPFPIHGJMD.FPKMKLDDCNL.HJNNKCMLGFL_0, _FGHGMHPNEMG_Type, 1, true);
						for (int j = 0; j < l2.Count; j++)
						{
							OCMJNBIFJNM_Offer.JPOHOLBBFGP of2 = BKJJKHIBIGP((BOPFPIHGJMD.MLBMHDCCGHI)l2[i].GBJFNGCDKPM_Type, l2[i].PPFNGGCBJKC);
							if (of2 == null || (of2.EALOBDHOCHP_Stat == 0 && of2.BFINGCJHOHI_Count == 0))
							{
		...
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				...
				if(l3.Count > 0)
				{
					...
					{
						MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI.HEFPAOLDHCK_1_Day, l4[i].PPFNGGCBJKC, l4[i].PDBPFJJCADD != 0 || l4[i].FDBNFFNFOND_CloseAt != 0, l4[i].JBHBGOIMALD, 0, l4[i].KOOEOKEDJDO, false);
					}
				...
				if(AJAAFLHLNKP(JHNMKKNEENE, ref l5))
				{
					...
					{
						MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI.HEFPAOLDHCK_1_Day, l5[i].PPFNGGCBJKC, l5[i].PDBPFJJCADD != 0 || l5[i].FDBNFFNFOND_CloseAt != 0, l5[i].JBHBGOIMALD, 0, l5[i].KOOEOKEDJDO, false);
					}
				}
				...
				if(FGFJMGLFNNF(0, JHNMKKNEENE, ref l6))
				{
					...
					{
						MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI.HEFPAOLDHCK_1_Day, l6[i].PPFNGGCBJKC, l6[i].PDBPFJJCADD != 0 || l6[i].FDBNFFNFOND_CloseAt != 0, l6[i].JBHBGOIMALD, 0, l6[i].KOOEOKEDJDO, false);
					}
					DGCOECIKEGA |= BOPFPIHGJMD.GNGGLPCONLM.OCKIDPJNNBP_1;
				}
				BJIPLMJFAGH();
								...
								else if(!dbOf.DPMCPMJJGAA_HasFlag(BOPFPIHGJMD.CMBJEEGFODD.JPFLFLFFEDD_16))
								{
									if(dbOf.DPMCPMJJGAA_HasFlag(BOPFPIHGJMD.CMBJEEGFODD.DPNBNKOOJHI_1))
									{
										if(DCKHPFDIMFI_IsDayOfWeek(d.PPMBFJJDCPP, JHNMKKNEENE))
										{
											...
											{
												if(d.FDBNFFNFOND_CloseAt >= LJPLPIOJCNK)
												{
													res.Add(d);
												}
											}
		...
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				...
				for (int i = 0; i < IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.LBCMJGOOHLJ_Offer.FFKIBJKEBNP.Count; i++)
				{
					...
					if(of.PDBPFJJCADD == 0 && of.FDBNFFNFOND_CloseAt == 0)
					{
						if (of.HAHMHBNPGFM == a)
							l.Add(of);
					}
					...
					{
						if (JHNMKKNEENE >= of.FDBNFFNFOND_CloseAt)
							l.Add(of);
					}
				}
				for(int i = 0; i < CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.FOFLMHELILC.Count; i++)
				{
					...
					if(of.GBJFNGCDKPM_Type == 2)
					{
						...
						else
						{
							...
							{
								if (((JHNMKKNEENE - sDate) / 604800) != (of.DFJLNPFJGDK_StartDate - HCHNGGAMGAD) / 604800)
									FGDFFDELFIO(of);
							}
						}
					}
				...
				for(int i = 0; i < l.Count; i++)
				{
					MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI.FDOOAJLGFAE_2_Week, l[i].PPFNGGCBJKC, l[i].PDBPFJJCADD != 0 || l[i].FDBNFFNFOND_CloseAt != 0, 0, 0, 0, false);
				}
				BJIPLMJFAGH();
				bool b = false;
				for(int i = 0; i < JGPJCOCHJFJ.Count; i++)
					...
					if(of.GBJFNGCDKPM_Type == 2)
					{
						if(of.EALOBDHOCHP_Stat > 0)
						{
							...
							if(d != null)
							{
								...
								{
									if (d.PDBPFJJCADD != 0 || d.FDBNFFNFOND_CloseAt != 0)
									{
										if (JHNMKKNEENE >= d.PDBPFJJCADD)
										{
											if (d.FDBNFFNFOND_CloseAt >= JHNMKKNEENE)
											{
			...
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				...
				{ 
					for(int i = 0; i < IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.LBCMJGOOHLJ_Offer.OICGEEKOLOG.Count; i++)
					{
						...
						if(GJLFANGDGCL_Target.PLALNIIBLOF == 2)
						{
							if(GJLFANGDGCL_Target.DMEDKJPOLCH_Category == j)
							{
								...
								{
									//0xE6FAF4
									if(JPAEDJJFFOI.GBJFNGCDKPM_Type == GJLFANGDGCL_Target.GBJFNGCDKPM_Type)
									{
										if(JPAEDJJFFOI.MLDPDLPHJPM_OfferId == GJLFANGDGCL_Target.PPFNGGCBJKC)
										{
				...
				for (int i = 0; i < IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.LBCMJGOOHLJ_Offer.OICGEEKOLOG.Count; i++)
				{
					...
					MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI.GENEIBGNMPH_4_Debut, of.PPFNGGCBJKC, of.PDBPFJJCADD != 0 || of.FDBNFFNFOND_CloseAt != 0, 0, 0, 0, false);
				}
				BJIPLMJFAGH();
				for(int i = 0; i < JGPJCOCHJFJ.Count; i++)
				{
					...
					if(of.GBJFNGCDKPM_Type == 4)
					{
						if(of.EALOBDHOCHP_Stat > 0)
						{
							...
							if(d != null)
							{
								if(d.DMEDKJPOLCH_Category != found)
								{
									if (of.EALOBDHOCHP_Stat != 4)
										continue;
								}
	...
	public int LJMOMAGLEGL(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, BOPFPIHGJMD.IGHPDAGKIKO _CMCKNKKCNDK_Status, bool PFCKDGKGBMM)
	{
		...
		if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
		{
			...
			{
				OCMJNBIFJNM_Offer.JPOHOLBBFGP d = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.FOFLMHELILC[JGPJCOCHJFJ[i].OIPCCBHIKIA_Index];
				if(d.GBJFNGCDKPM_Type == (int)_FGHGMHPNEMG_Type)
				{
					if (PFCKDGKGBMM)
					{
						if ((int)_CMCKNKKCNDK_Status <= d.EALOBDHOCHP_Stat)
	...
	public string GEGAJLNPMEC(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM)
	{
	...
	// public BOPFPIHGJMD.AHIOHONIGDH EKAECAHFMKE(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM) { }
	...
	{
		if(KOGBMDOONFA.GBJFNGCDKPM_Type != 3)
		{
			return (BOPFPIHGJMD.AHIOHONIGDH)KOGBMDOONFA.CPKMLLNADLJ_Serie;
		}
		...
		if(d.OCAMDLMPBGA > 0)
		{
			if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
			{
				return (BOPFPIHGJMD.AHIOHONIGDH)IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.MGFMPKLLGHE_Diva.CDENCMNHNGA_table[d.OCAMDLMPBGA - 1].AIHCEGFANAM_SerieAttr;
			}
		}
	...
	public BOPFPIHGJMD.ADMNKELOLPN KJGAJBOBIHK(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM)
	{
		LGHIPHEDCNC_Offer.NONCDAINJLD of = GKIOIHLDBGF(_FGHGMHPNEMG_Type, MLDPDLPHJPM);
		if(of != null)
		{
						...
						for(int i = 0; i < 3; i++)
						{
							...
							if (a3 > 0)
							{
								...
								if(valk != null && valk.PPEGAKEIEGM_Enabled == 2)
								{
									...
									{
										if(valk.GPPEFLKGGGJ_ValkyrieId == saveValk.FODKKJIDDKN_VfId)
										{
	...
	public void JPHPEIFPKDL(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM)
	{
	...
	public OCMJNBIFJNM_Offer.JPOHOLBBFGP BKJJKHIBIGP(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM)
	{
		if(JGPJCOCHJFJ != null)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
	...
	public LGHIPHEDCNC_Offer.NONCDAINJLD GKIOIHLDBGF(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM)
	{
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			switch(_FGHGMHPNEMG_Type)
	...
	{
		if(_DFMOGBOPLEF_Series > BOPFPIHGJMD.LGEIPIHHNPH.HJNNKCMLGFL_0 && _DFMOGBOPLEF_Series <= BOPFPIHGJMD.LGEIPIHHNPH.LCBPJOKNKPL_7)
		{
	...
	public bool NKHGLFOBOJD(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM, int OIOECMEEFKJ, int MNCEBKHBBEF)
	{
		if(OIOECMEEFKJ > 0)
		{
			long t = NKGJPJPHLIF.HHCJCDFCLOB.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime();
			...
			if(of != null)
			{
				OCMJNBIFJNM_Offer.JPOHOLBBFGP of2 = BKJJKHIBIGP(_FGHGMHPNEMG_Type, MLDPDLPHJPM);
				if(of2 != null)
				{
					if(of2.EALOBDHOCHP_Stat == 1)
					{
						...
						//of.AIIOIKGMOBD
						of2.DFJLNPFJGDK_StartDate = t;
						of2.NCDHKKCCGOD_Edt = t + NPEFMNPOMMJ(_FGHGMHPNEMG_Type, MLDPDLPHJPM, OIOECMEEFKJ, (FKGMGBHBNOC.HPJOCKGKNCC_Form) MNCEBKHBBEF, true);
	...
	public long NPEFMNPOMMJ(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM, int OIOECMEEFKJ, FKGMGBHBNOC.HPJOCKGKNCC_Form MNCEBKHBBEF, bool FMCIBHOHDAH/* = true*/)
	{
		LGHIPHEDCNC_Offer.NONCDAINJLD of = GKIOIHLDBGF(_FGHGMHPNEMG_Type, MLDPDLPHJPM);
		...
		BOPFPIHGJMD.ADMNKELOLPN a5 = KJGAJBOBIHK(_FGHGMHPNEMG_Type, MLDPDLPHJPM);
	...
	{
		if(MNCEBKHBBEF < FKGMGBHBNOC.HPJOCKGKNCC_Form.AEFCOHJBLPO_Num && _CGKPIIFCCLD_OfferType > BOPFPIHGJMD.ADMNKELOLPN.HJNNKCMLGFL_0 && _CGKPIIFCCLD_OfferType <= BOPFPIHGJMD.ADMNKELOLPN.GEJGMBBCFEE_5)
		{
			if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
			{
				if(DGGBOFDCOLG == BOPFPIHGJMD.HBJMIJIOCAM.JIOPJDJBLFK_1)
	...
	public bool JPNPPIHOJFC(long JHNMKKNEENE)
	{
		if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
		{
			...
			for(int i = 0; i < JGPJCOCHJFJ.Count; i++)
			{
				...
				{
					if(of.DFJLNPFJGDK_StartDate != 0 && of.NCDHKKCCGOD_Edt != 0)
					{
	...
	public BOPFPIHGJMD.IGHPDAGKIKO KOGFFBBKOPB(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM)
	{
		OCMJNBIFJNM_Offer.JPOHOLBBFGP d = BKJJKHIBIGP(_FGHGMHPNEMG_Type, MLDPDLPHJPM);
		if (d != null)
	...
	public bool MOOJLBNGNOB(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM, BOPFPIHGJMD.IGHPDAGKIKO _CMCKNKKCNDK_Status)
	{
		OCMJNBIFJNM_Offer.JPOHOLBBFGP d = BKJJKHIBIGP(_FGHGMHPNEMG_Type, MLDPDLPHJPM);
		if(d != null)
		{
			...
			if(d.GBJFNGCDKPM_Type == 2 && d.EALOBDHOCHP_Stat == 4)
			{
				if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
				{
					d.PIBLLGLCJEO_Prm = (int)((NKGJPJPHLIF.HHCJCDFCLOB.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime() - Utility.RoundDownDayUnixTime(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.LBCMJGOOHLJ_Offer.LPJLEHAJADA("start_date", 1), 86400)) / 604800) % 4 + 1;
				}
			}
			return true;
		}
	...
	public bool PGGLEDMJEHB(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM, int _BFINGCJHOHI_Count)
	{
		OCMJNBIFJNM_Offer.JPOHOLBBFGP of = BKJJKHIBIGP(_FGHGMHPNEMG_Type, MLDPDLPHJPM);
		if(of != null)
		{
			of.BFINGCJHOHI_Count += _BFINGCJHOHI_Count;
		}
		if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null && CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.OEKEIGFAIGN_Counter != null)
		{
			...
			{
				CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.OEKEIGFAIGN_Counter.BDLNMOIOMHK_Total.KNGCKBNFEGM_AddVOp((int)_FGHGMHPNEMG_Type, _BFINGCJHOHI_Count);
				CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.OEKEIGFAIGN_Counter.BDLNMOIOMHK_Total.KNGCKBNFEGM_AddVOp(0, _BFINGCJHOHI_Count);
				if(_FGHGMHPNEMG_Type == BOPFPIHGJMD.MLBMHDCCGHI.FMLPIOFBCMA_3_Diva)
				{
					CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.OEKEIGFAIGN_Counter.BDLNMOIOMHK_Total.PMDMJKCANFF_AddDOp(of.PIBLLGLCJEO_Prm, _BFINGCJHOHI_Count);
				}
			}
		}
		if(GNGMCIAIKMA.HHCJCDFCLOB != null)
		{
			GNGMCIAIKMA.HHCJCDFCLOB.GJENEJOANEL(DKFJADMCNPI.NLKCMNHOBAI.KENMCJCIGIB_3, (int)_FGHGMHPNEMG_Type, _BFINGCJHOHI_Count, null);
			if(_FGHGMHPNEMG_Type == BOPFPIHGJMD.MLBMHDCCGHI.FMLPIOFBCMA_3_Diva)
			{
				GNGMCIAIKMA.HHCJCDFCLOB.GJENEJOANEL(DKFJADMCNPI.NLKCMNHOBAI.LFLMBPJJEEG_4, of.PIBLLGLCJEO_Prm, _BFINGCJHOHI_Count, null);
			}
	...
	// public int MJILMJNJGFH(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM) { }
	...
	public JLLOKCFPOFH DOBIMMEGLOB(int _GOKJLBDJOLA_df, bool _BCGLDMKODLC_IsClear)
	{
		if(_BCGLDMKODLC_IsClear)
		{
			...
			{
				KPNGLBDMEBF.EKLIPGELKCL_Rarity = UnityEngine.Random.Range(0, of.NDGBHPJJPAB_BonusAddMax + 1) + of.PONECEJICJC_BonusBase;
			}
	...
	public List<IBAOKNMIBCL> FOACCNFAGCH(List<LGHIPHEDCNC_Offer.NACBCEDKEPF> NNDGIAEFMOG, BOPFPIHGJMD.CJDCPBACOLH HHACNFODNEF, int PPFNGGCBJKC, int _BFINGCJHOHI_Count)
	{
		...
		if(of != null)
		{
			...
			for(int i = 0; i < d.JPHGMBLDFOM.Length; i++)
			{
				...
				{
					d.CJEGGLPCIOD(i, _BFINGCJHOHI_Count);
				}
			}
			List<IBAOKNMIBCL> res = new List<IBAOKNMIBCL>();
			for(int i = 0; i < _BFINGCJHOHI_Count; i++)
			{
				...
				data.BFINGCJHOHI_Count = d.GMLLLODBHDB_GetCount(a);
	...
	public List<IBAOKNMIBCL> NLAPKNDOEPL_GetConfirmList(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM)
	{
		LGHIPHEDCNC_Offer.NONCDAINJLD of = GKIOIHLDBGF(_FGHGMHPNEMG_Type, MLDPDLPHJPM);
		List<IBAOKNMIBCL> res = new List<IBAOKNMIBCL>();
		for(int i = 0; i < 3; i++)
	...
	public IBAOKNMIBCL LEPDAMFKAJP(List<LGHIPHEDCNC_Offer.NACBCEDKEPF> NNDGIAEFMOG, int FCDMDDIHMPO)
	{
		...
		if(FCDMDDIHMPO > 0)
		{
			...
			res.BFINGCJHOHI_Count = of.GMLLLODBHDB_GetCount(0);
	...
	public int MAPECPHBNGM(int _AHHJLDLAPAN_DivaId)
	{
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			...
			for(int i = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.LBCMJGOOHLJ_Offer.KGHEHEDBPFL.Count - 1; i >= 0; i--)
			{
                ...
                if (of.ANAJIAENLNB_Level <= data.HEKJGCMNJAB_CurrentLevel)
				{
	...
	public LGHIPHEDCNC_Offer.PDLENIHAMBC AGFFPFCADJK(int _AHHJLDLAPAN_DivaId, List<LGHIPHEDCNC_Offer.PDLENIHAMBC> ABKBDLNLJDI, List<OCMJNBIFJNM_Offer.JPOHOLBBFGP> OMABPKCJECB)
	{
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			...
			for(int i = 0; i < OMABPKCJECB.Count; i++)
			{
				...
				if(EILKGEADKGH_Order.PIBLLGLCJEO_Prm == _AHHJLDLAPAN_DivaId)
				{
					LGHIPHEDCNC_Offer.PDLENIHAMBC GJLFANGDGCL_Target = ABKBDLNLJDI.Find((LGHIPHEDCNC_Offer.PDLENIHAMBC JPAEDJJFFOI) =>
					{
						//0xE6F33C
						if(JPAEDJJFFOI.PFJJFCPPNIN != EILKGEADKGH_Order.MLDPDLPHJPM_OfferId)
						{
							if(JPAEDJJFFOI.PPFNGGCBJKC == EILKGEADKGH_Order.MLDPDLPHJPM_OfferId)
								return true;
							return false;
						}
						return true;
					...
					if(GJLFANGDGCL_Target != null)
					{
						...
						{
							//0xE6F3F4
							return JPAEDJJFFOI.PPFNGGCBJKC == GJLFANGDGCL_Target.PPFNGGCBJKC;
						});
	...
	public BOPFPIHGJMD.LEIPFJHOFPC PANBPMDADAH(int _BBIOMNCILMC_HomeDivaId, int _AKNELONELJK_Difficulty)
	{
		...
		if(of2 == null)
		{
			...
			for(int i = 0; i < CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DGCJCAHIAPP_Diva.NBIGLBMHEDC_DivaList.Count; i++)
			{
				...
				{
					if(dInfo.DIPKCALNIII_DivaId != _BBIOMNCILMC_HomeDivaId)
					{
			...
			if(!MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI.FMLPIOFBCMA_3_Diva, of3.PPFNGGCBJKC, of3.PDBPFJJCADD != 0 || of3.FDBNFFNFOND_CloseAt != 0, 0, a1, t + diva_offer_time_limit, false))
			{
				return BOPFPIHGJMD.LEIPFJHOFPC.HJNNKCMLGFL_0;
			}
			BJIPLMJFAGH();
		...
		else
		{
			...
			if(of3.PFJJFCPPNIN > 0)
			{
				...
				if(!MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI.FMLPIOFBCMA_3_Diva, of5.PPFNGGCBJKC, of5.PDBPFJJCADD != 0 || of5.FDBNFFNFOND_CloseAt != 0, 0, a1, t + diva_offer_time_limit, false))
				{
					return BOPFPIHGJMD.LEIPFJHOFPC.HJNNKCMLGFL_0;
				}
	...
	public bool FGDFFDELFIO(OCMJNBIFJNM_Offer.JPOHOLBBFGP EILKGEADKGH_Order)
	{
		...
		{
			if (EILKGEADKGH_Order.BFINGCJHOHI_Count < 1)
				EILKGEADKGH_Order.LHPDDGIJKNB(-1);
			else
			{
				EILKGEADKGH_Order.EALOBDHOCHP_Stat = 0;
				EILKGEADKGH_Order.DFJLNPFJGDK_StartDate = 0;
				...
				EILKGEADKGH_Order.LHMOAJAIJCO_IsNew = false;
				EILKGEADKGH_Order.PIBLLGLCJEO_Prm = 0;
				EILKGEADKGH_Order.NACGJGLGOHM_EvFlg = 0;
				EILKGEADKGH_Order.JBPOABLNLHC_UpPer = 0;
				EILKGEADKGH_Order.BDJMFDKLHPM_SessionId = "";
			}
	...
	// public bool FGDFFDELFIO(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM) { }
	...
	public bool AHKAIKMNKJL()
	{
		if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
		{
			...
			{
				//0xE6F4CC
				return JPAEDJJFFOI.FODKKJIDDKN_VfId == FODKKJIDDKN && JPAEDJJFFOI.FJODMPGPDDD_Unlocked;
			}) != null;
		}
		return false;
	}
	...
	public int HFLNFKFGEJH(int _AHHJLDLAPAN_DivaId)
	{
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			...
			{
				if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.LBCMJGOOHLJ_Offer.DMOLOCBIDBD[i].ANAJIAENLNB_Level <= data.HEKJGCMNJAB_CurrentLevel)
				{
	...
	public LKBMNFAOOII NNMPMKGBJFB(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM, BOPFPIHGJMD.AGGLEGJDLGF FLGECLFIGPL, long JHNMKKNEENE/* = -1*/)
	{
		LKBMNFAOOII res = new LKBMNFAOOII();
		OCMJNBIFJNM_Offer.JPOHOLBBFGP of = BKJJKHIBIGP(_FGHGMHPNEMG_Type, MLDPDLPHJPM);
		if(of != null)
		{
			if(JHNMKKNEENE < 0)
			{
				JHNMKKNEENE = NKGJPJPHLIF.HHCJCDFCLOB.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime();
			}
	...
	public string PBKNBDCABDM_CreateSessionId(OCMJNBIFJNM_Offer.JPOHOLBBFGP _GJLFANGDGCL_Target, bool _FBBNPFFEJBN_Force/* = false*/)
	{
		if(_GJLFANGDGCL_Target != null)
		{
			...
			{
				if(_GJLFANGDGCL_Target.BDJMFDKLHPM_SessionId != "")
					return _GJLFANGDGCL_Target.BDJMFDKLHPM_SessionId;
			}
			string res = JDDGPJDKHNE.GPLMOKEIOLE();
			_GJLFANGDGCL_Target.BDJMFDKLHPM_SessionId = res;
			return res;
		}
		return "";
	}
	...
	// public string PBKNBDCABDM(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM, bool _FBBNPFFEJBN_Force = False) { }

	// // RVA: 0x1036574 Offset: 0x1036574 VA: 0x1036574
	public string OHDGMEGGLDP_GetSessionId(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM)
	{
		OCMJNBIFJNM_Offer.JPOHOLBBFGP of = BKJJKHIBIGP(_FGHGMHPNEMG_Type, MLDPDLPHJPM);
		if (of != null)
	...
	// public bool MPEEILDOBCJ(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM) { }
	...
	public BOPFPIHGJMD.JFHCHOILMEL HKDGKDNIGDD()
	{
		...
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			long JHNMKKNEENE = NKGJPJPHLIF.HHCJCDFCLOB.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime();
			DateTime date = Utility.GetLocalDateTime(JHNMKKNEENE);
			...
			if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.LBCMJGOOHLJ_Offer.CDCCOJKCHIG.Count > 0)
			{
				...
				{
					//0xE6F57C
					return JHNMKKNEENE >= JPAEDJJFFOI.PDBPFJJCADD && JPAEDJJFFOI.FDBNFFNFOND_CloseAt >= JHNMKKNEENE;
				});
				if (dbOffer2 != null)
				{
					GINJHBLEALE = (BOPFPIHGJMD.JFHCHOILMEL)dbOffer2.GBJFNGCDKPM_Type;
	...
	public void EBJOGGIHHBA(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM, bool FMLIHIEMBBH/* = false*/)
	{
		NGHMGNMNNEP.FKDIMODKKJD(_FGHGMHPNEMG_Type, MLDPDLPHJPM);
		...
		NGHMGNMNNEP.BOAOOEIIAHG(_FGHGMHPNEMG_Type, MLDPDLPHJPM, a2);
		if(of.BFINGCJHOHI_Count == 1)
		{
			if (of.JIOMCDGKIAF == 0)
				of.JIOMCDGKIAF = 1;
		}
	...
	public void EBJOGGIHHBA(JKNGJFOBADP JANMJPOKLFL, BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM, ref bool GHEHKJFGOIE)
	{
		GHEHKJFGOIE = false;
		NGHMGNMNNEP.FKDIMODKKJD(_FGHGMHPNEMG_Type, MLDPDLPHJPM);
		NGHMGNMNNEP.CDNFIAKLGLH();
		...
		ViewOfferCompensation v = ViewOfferCompensation.CreateList(_FGHGMHPNEMG_Type, MLDPDLPHJPM);
		...
		NGHMGNMNNEP.BOAOOEIIAHG(JANMJPOKLFL, _FGHGMHPNEMG_Type, MLDPDLPHJPM, a2);
		if(of.BFINGCJHOHI_Count == 1)
		{
			if(of.JIOMCDGKIAF == 0)
			{
	...
	public PGCENGCEJGB OFJFGHEIMAH(BOPFPIHGJMD.DBNJDPHLLHI _CIANOCNPIFF_Type)
	{
		...
		if(_CIANOCNPIFF_Type > 0)
		{
			if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
			{
				...
				res.LHMDABPNDDH = _CIANOCNPIFF_Type == BOPFPIHGJMD.DBNJDPHLLHI.KMCGPEACGEE_11 ? BOPFPIHGJMD.MGPIJGMDLOM.JIOPJDJBLFK_2 : (_CIANOCNPIFF_Type == BOPFPIHGJMD.DBNJDPHLLHI.LKFPALJBJFM_10 ? BOPFPIHGJMD.MGPIJGMDLOM.FMHLGHDKJBC_1 : BOPFPIHGJMD.MGPIJGMDLOM.INIMBLOHIEF_0);
			}
		}
		return res;
	}
					...
					if(MAHHCPJIKHA_VopVcAchvtCnt != 0)
					{
						...
						while(HLOHHJKCOIP.Count > 0)
						{
							...
							CACGCMBKHDI_Request.HDHIKGLMOGF KDFFGLHBDLO = (CACGCMBKHDI_Request NHECPMNKEFK) =>
							{
								...
								List<PNFCNPCGKDM> AHOECALHPCP = t.NFEAMMJIMPG.CEDLLCCONJP_AchievementPrizes;
