...
public class KDHGBOOECKC
{
	...
	{
		if(_MNCEBKHBBEF_VFform < FKGMGBHBNOC.HPJOCKGKNCC_Form.AEFCOHJBLPO_3_Num && _CGKPIIFCCLD_OfferType > BOPFPIHGJMD.ADMNKELOLPN.HJNNKCMLGFL_0_None && _CGKPIIFCCLD_OfferType <= BOPFPIHGJMD.ADMNKELOLPN.GEJGMBBCFEE_5_Max)
		{
			if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
			{
				if(DGGBOFDCOLG == BOPFPIHGJMD.HBJMIJIOCAM.JIOPJDJBLFK_1_Hit)
	...
	{
		if(_FGHGMHPNEMG_Type < BOPFPIHGJMD.MLBMHDCCGHI.GEJGMBBCFEE_5_Max/*5*/)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
