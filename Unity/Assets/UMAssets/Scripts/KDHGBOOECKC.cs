...
public class KDHGBOOECKC
{
	public class NKMCJCAJIGD
	{
		...
		public BOPFPIHGJMD.MLBMHDCCGHI FGHGMHPNEMG_Type { get { return (BOPFPIHGJMD.MLBMHDCCGHI)(KDPLFFJOLFI ^ 0x7138b4a5); } set { KDPLFFJOLFI = (int)value ^ 0x7138b4a5; } } //0xE74844 PCFFCOKAHBD_bgs 0xE74858 JBCALBBCBLF_bgs
	...
	public class CBJJINJDFDC
	{
		...
		public CBJJINJDFDC FKDIMODKKJD_GetList(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int _MLDPDLPHJPM_OfferId)
		{
	...
	public bool MDKADMHKOLN(OKGLGHCBCJP_Database _LKMHPJKIFDN_md, BBHNACPENDM_ServerSaveData _LDEGEHAEALK_ServerData, BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int _MLDPDLPHJPM_OfferId, bool _FAGEBAKNAOB_IsEvent/* = false*/, int KDLDOLENIDG/* = 0*/, int _AHHJLDLAPAN_DivaId/* = 0*/, long _KOOEOKEDJDO_expr/* = 0*/, bool AGELHLFEJNG/* = true*/)
	{
							...
							case BOPFPIHGJMD.DLDOEOEFJKA.PLFJBGJMMDP_1:
								{
									...
									{
										int a = 1;
										if (LJHNOBJJBJA < BOPFPIHGJMD.FPKMKLDDCNL.HNOJIKHAPHA_1_Morning)
	...
	public bool HNPIJCCBLIA(LGHIPHEDCNC_Offer.HEECIKHJOBM KIOFLAGHLGD, long _JHNMKKNEENE_Time, ref List<LGHIPHEDCNC_Offer.LHDLCLNBPLB> ELAOAOKEJHN)
	{
		...
		List<LGHIPHEDCNC_Offer.LHDLCLNBPLB> l2 = IOCBIDHIIAE(2, 2, _JHNMKKNEENE_Time, (BOPFPIHGJMD.FPKMKLDDCNL)KIOFLAGHLGD.LJHNOBJJBJA, BOPFPIHGJMD.DLDOEOEFJKA.CCAPCGPIIPF_0_Normal, 1, true);
		...
		List<LGHIPHEDCNC_Offer.LHDLCLNBPLB> l3 = IOCBIDHIIAE(3, 3, _JHNMKKNEENE_Time, (BOPFPIHGJMD.FPKMKLDDCNL) KIOFLAGHLGD.LJHNOBJJBJA, BOPFPIHGJMD.DLDOEOEFJKA.CCAPCGPIIPF_0_Normal, 1, true);
		...
		List<LGHIPHEDCNC_Offer.LHDLCLNBPLB> l4 = IOCBIDHIIAE(4, 4, _JHNMKKNEENE_Time, (BOPFPIHGJMD.FPKMKLDDCNL) KIOFLAGHLGD.LJHNOBJJBJA, BOPFPIHGJMD.DLDOEOEFJKA.CCAPCGPIIPF_0_Normal, 1, true);
		...
		List<LGHIPHEDCNC_Offer.LHDLCLNBPLB> l5 = IOCBIDHIIAE(5, 5, _JHNMKKNEENE_Time, (BOPFPIHGJMD.FPKMKLDDCNL) KIOFLAGHLGD.LJHNOBJJBJA, BOPFPIHGJMD.DLDOEOEFJKA.CCAPCGPIIPF_0_Normal, 1, true);
	...
	{
		bool res = false;
		List<LGHIPHEDCNC_Offer.LHDLCLNBPLB> l = IOCBIDHIIAE(1, 5, _JHNMKKNEENE_Time, BOPFPIHGJMD.FPKMKLDDCNL.HJNNKCMLGFL_0_None, BOPFPIHGJMD.DLDOEOEFJKA.CCDOBDNDPIL_2_Event, 1, true);
		for(int i = 0; i < l.Count; i++)
		{
		...
		if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				...
				if(l3.Count > 0)
				{
					...
					{
						MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI.HEFPAOLDHCK_1_Daily, l4[i].PPFNGGCBJKC_id, l4[i].PDBPFJJCADD_open_at != 0 || l4[i].FDBNFFNFOND_close_at != 0, l4[i].JBHBGOIMALD, 0, l4[i].KOOEOKEDJDO_expr, false);
					}
				...
				if(AJAAFLHLNKP(_JHNMKKNEENE_Time, ref l5))
				{
					...
					{
						MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI.HEFPAOLDHCK_1_Daily, l5[i].PPFNGGCBJKC_id, l5[i].PDBPFJJCADD_open_at != 0 || l5[i].FDBNFFNFOND_close_at != 0, l5[i].JBHBGOIMALD, 0, l5[i].KOOEOKEDJDO_expr, false);
					}
				}
				...
				if(FGFJMGLFNNF(0, _JHNMKKNEENE_Time, ref l6))
				{
					...
					{
						MDKADMHKOLN(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, BOPFPIHGJMD.MLBMHDCCGHI.HEFPAOLDHCK_1_Daily, l6[i].PPFNGGCBJKC_id, l6[i].PDBPFJJCADD_open_at != 0 || l6[i].FDBNFFNFOND_close_at != 0, l6[i].JBHBGOIMALD, 0, l6[i].KOOEOKEDJDO_expr, false);
					}
					DGCOECIKEGA |= BOPFPIHGJMD.GNGGLPCONLM.OCKIDPJNNBP_1;
				}
				BJIPLMJFAGH();
				...
				for(int i = 0; i < JGPJCOCHJFJ.Count; i++)
				{
					...
					if (dbOf.GBJFNGCDKPM_typ == 1)
					{
						...
						{
							LGHIPHEDCNC_Offer.LHDLCLNBPLB d = GKIOIHLDBGF(BOPFPIHGJMD.MLBMHDCCGHI.HEFPAOLDHCK_1_Daily, dbOf.MLDPDLPHJPM_OfferId) as LGHIPHEDCNC_Offer.LHDLCLNBPLB;
							if(d != null)
							{
	...
	{
		int a1 = ECBHIIOABCK();
		int a2 = LJMOMAGLEGL(BOPFPIHGJMD.MLBMHDCCGHI.GENEIBGNMPH_4_Debut, BOPFPIHGJMD.IGHPDAGKIKO.CADDNFIKDLG_4_Received, true);
	...
	public string GEGAJLNPMEC(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int _MLDPDLPHJPM_OfferId)
	{
		...
		{
			case BOPFPIHGJMD.MLBMHDCCGHI.HEFPAOLDHCK_1_Daily:
	...
	public bool CKBDHFNLLJE(BOPFPIHGJMD.LGEIPIHHNPH _DFMOGBOPLEF_Series, SeriesAttr.Type LLNKADMJODG)
	{
		if(_DFMOGBOPLEF_Series > BOPFPIHGJMD.LGEIPIHHNPH.HJNNKCMLGFL_0_None && _DFMOGBOPLEF_Series <= BOPFPIHGJMD.LGEIPIHHNPH.LCBPJOKNKPL_7)
		{
			switch(_DFMOGBOPLEF_Series)
			{
				...
				case BOPFPIHGJMD.LGEIPIHHNPH.DBPDLIPKFAL_4_First:
	...
	public BOPFPIHGJMD.LGEIPIHHNPH MDNPDBIPKLB(BOPFPIHGJMD.AHIOHONIGDH AELKJEKCJND, int JBHBGOIMALD)
	{
		switch(AELKJEKCJND)
		{
			...
			case BOPFPIHGJMD.AHIOHONIGDH.DBPDLIPKFAL_8_First:
				return BOPFPIHGJMD.LGEIPIHHNPH.DBPDLIPKFAL_4_First;
	...
	public bool NKHGLFOBOJD(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int _MLDPDLPHJPM_OfferId, int _OIOECMEEFKJ_VFp, int _MNCEBKHBBEF_VFform)
	{
		if(_OIOECMEEFKJ_VFp > 0)
		{
			long t = NKGJPJPHLIF.HHCJCDFCLOB.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime();
	...
	public long NPEFMNPOMMJ(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int _MLDPDLPHJPM_OfferId, int _OIOECMEEFKJ_VFp, FKGMGBHBNOC.HPJOCKGKNCC_Form _MNCEBKHBBEF_VFform, bool FMCIBHOHDAH/* = true*/)
	{
		LGHIPHEDCNC_Offer.NONCDAINJLD of = GKIOIHLDBGF(_FGHGMHPNEMG_Type, _MLDPDLPHJPM_OfferId);
	...
	{
		if(_FGHGMHPNEMG_Type < BOPFPIHGJMD.MLBMHDCCGHI.GEJGMBBCFEE_5__max/*5*/)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
	...
	public BOPFPIHGJMD.LEIPFJHOFPC PANBPMDADAH(int _BBIOMNCILMC_HomeDivaId, int _AKNELONELJK_difficulty)
	{
		...
		if (l == null)
			l = BJIPLMJFAGH();
		if (ECBHIIOABCK() - LJMOMAGLEGL(BOPFPIHGJMD.MLBMHDCCGHI.GENEIBGNMPH_4_Debut, BOPFPIHGJMD.IGHPDAGKIKO.CADDNFIKDLG_4_Received, true) > 0)
			return BOPFPIHGJMD.LEIPFJHOFPC.HJNNKCMLGFL_0_None;
		if(!MGHPDFMDFCJ())
			return BOPFPIHGJMD.LEIPFJHOFPC.HJNNKCMLGFL_0_None;
	...
	{
		MessageBank bk = MessageManager.Instance.GetBank("menu");
		if (ECBHIIOABCK() - LJMOMAGLEGL(BOPFPIHGJMD.MLBMHDCCGHI.GENEIBGNMPH_4_Debut, BOPFPIHGJMD.IGHPDAGKIKO.CADDNFIKDLG_4_Received, true) < 1)
		{
	...
	public long IILNIBNFOLG(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type)
	{
		if (_FGHGMHPNEMG_Type == BOPFPIHGJMD.MLBMHDCCGHI.FDOOAJLGFAE_2_Week)
			return HCHNGGAMGAD;
		else if (_FGHGMHPNEMG_Type == BOPFPIHGJMD.MLBMHDCCGHI.HEFPAOLDHCK_1_Daily)
			return AIHOHDONCND;
		else return 0;
	}
	...
	// public string PBKNBDCABDM_CreateSessionId(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int _MLDPDLPHJPM_OfferId, bool _FBBNPFFEJBN_Force = False) { }
	...
	public PGCENGCEJGB OFJFGHEIMAH(BOPFPIHGJMD.DBNJDPHLLHI _CIANOCNPIFF_Type)
	{
		...
		if(_CIANOCNPIFF_Type > 0)
		{
			if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
			{
				...
				res.LHMDABPNDDH_state = _CIANOCNPIFF_Type == BOPFPIHGJMD.DBNJDPHLLHI.KMCGPEACGEE_11 ? BOPFPIHGJMD.MGPIJGMDLOM.JIOPJDJBLFK_2_Hit : (_CIANOCNPIFF_Type == BOPFPIHGJMD.DBNJDPHLLHI.LKFPALJBJFM_10 ? BOPFPIHGJMD.MGPIJGMDLOM.FMHLGHDKJBC_1_Atk : BOPFPIHGJMD.MGPIJGMDLOM.INIMBLOHIEF_0_set_Item);
			}
		}
		return res;
	}
