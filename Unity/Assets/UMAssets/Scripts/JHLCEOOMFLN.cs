	...
	public static void PBKLIKNOMEG()
	{
		if(IMMAOANGPNK.HHCJCDFCLOB != null && CIOECGOMILE.HHCJCDFCLOB != null)
		{
			...
			if(rareup_item_convert_count <= cnt)
			{
				...
				CIOECGOMILE.HHCJCDFCLOB.JANMJPOKLFL.CPIICACGNBH_AddItem(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_ServerSave, EKLNMHFCAOI.FKGCBLHOOCL_Category.CIOGEKJNMBB_RareUpItem, 1, part, null, 0);
