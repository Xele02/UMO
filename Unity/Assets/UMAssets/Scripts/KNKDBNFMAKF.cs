...
public class KNKDBNFMAKF_EventSp : IKDICBBFBMI_EventBase
{
	...
	{
		OEIJEFBBJBD_EventSp ev = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.LBDOLHGDIEB_Find(JOPOPMLFINI_QuestName) as OEIJEFBBJBD_EventSp;
	...
	public override void MJFKJHJJLMN_GetRanks(int LHJCOPMMIGO/* = 0*/, bool _FBBNPFFEJBN_Force/* = false*/)
	{
		...
		OEIJEFBBJBD_EventSp ev/*OHGNMDOGLJM*/ = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.LBDOLHGDIEB_Find(JOPOPMLFINI_QuestName) as OEIJEFBBJBD_EventSp;
		if(ev != null && GPHEKCNDDIK)
		{
	...
	private IEnumerator NJIEIJJMAHK_Corotuine_PreSetupEventHome(IMCBBOAFION _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK _AOCANKOMKFG_OnError)
	{
		...
		KEHCNBNPJHB = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.LBDOLHGDIEB_Find(JOPOPMLFINI_QuestName) as OEIJEFBBJBD_EventSp;
		if(KEHCNBNPJHB != null)
		{
