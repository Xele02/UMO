...
public class LGDNAJACFHI
{
	...
	public long EBEOPONDEKB; // 0x18
	public long EMEKFFHCHMH; // 0x20
	public string PGODOPKCHBD; // 0x28
	public string EFIMCLPAEEN; // 0x2C
	public int NPPGKNGIFGK; // 0x30
	public int GCJMGMBNBCB; // 0x34
	public int AJIFADGGAAJ; // 0x38
	...
	public int KAPMOPMDHJE; // 0x4C
	public string NGIKLCDKAMB; // 0x50
	public string JKKNIEHJBAP; // 0x54
	public int[] BIOHCFLJDCH; // 0x58
	...
	// public CBMFOOHOAOE DMFHKJBCFBK() { }
