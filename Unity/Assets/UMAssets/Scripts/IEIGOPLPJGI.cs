...
public class IEIGOPLPJGI_PilotInfo
{
	...
	{
		PFGJJLGLPAC_PilotId = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.OBGGLAKOHKP_Pilot.GCINIJEMHFK_GetPilot(_PFGJJLGLPAC_PilotId).PFGJJLGLPAC_PilotId;
		AIHCEGFANAM_SerieAttr = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.OBGGLAKOHKP_Pilot.GCINIJEMHFK_GetPilot(_PFGJJLGLPAC_PilotId).AIHCEGFANAM_SerieAttr;
		CHIMPKJDCPP_Pid = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.OBGGLAKOHKP_Pilot.GCINIJEMHFK_GetPilot(_PFGJJLGLPAC_PilotId).CHIMPKJDCPP_Pid;
