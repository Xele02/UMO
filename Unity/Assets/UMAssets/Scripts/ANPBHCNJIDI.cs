...
public class ANPBHCNJIDI
{
	...
	public class NNPGLGHDBKN
	{
		...
		internal virtual bool KLAOLMDCLHO(BNAAJMBJFPG LBJACBOOLEL, EDOHBJAPLPF_JsonData _DLENPPIJNPA_json)
		{
			...
			{
				NNOHKLNKGAD_CostumeId = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.MFPNGNMFEAL_Costume.LBDOLHGDIEB_Find(AHHJLDLAPAN_DivaId, 0).JPIDIENBGKH_CostumeId;
			}
	...
	public class BNEIDPGIAFM : NNPGLGHDBKN
	{
		...
		internal override bool KLAOLMDCLHO(BNAAJMBJFPG LBJACBOOLEL, EDOHBJAPLPF_JsonData _DLENPPIJNPA_json)
		{
			if(base.KLAOLMDCLHO(LBJACBOOLEL, _DLENPPIJNPA_json))
			{
				...
				{
					if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.FJPOELGFPBP_DecoStamp.DDKEJHIGBGK_IsStampEnabled(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.GAPONCJOKAC_DecoStamp, HEKIEDEBAEO_StampId))
					{
						if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.FJPOELGFPBP_DecoStamp.HOAKPBBIGPK_IsSerifEnabled(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.GAPONCJOKAC_DecoStamp, EKAMPLIAENM_SerifId))
							return true;
					}
				}
			}
	...
	public class JLHGKKIEALB : KNGOGLLMKDL
	{
		...
		internal override bool KLAOLMDCLHO(BNAAJMBJFPG LBJACBOOLEL, EDOHBJAPLPF_JsonData _DLENPPIJNPA_json)
		{
			if(base.KLAOLMDCLHO(LBJACBOOLEL, _DLENPPIJNPA_json))
			{
				...
				if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.IBPAFKKEKNK_Music.BHJKMPBACAC_IsFreeMusicAvaiable(ADHMMMEOJMK_FreeMusicId))
				{
	...
	{
		AMDPJLBPLIG.EMHMAJDNEJB(_KPNKPGLPDHI_Op, (List<KEPNMGHABPI.CAIPMAMHNJP> CEGPFLLDBGM) =>
		{
			//0xD550F8
	...
	private SakashoBbsCommentInfo EEGECGEGPHM(NNPGLGHDBKN _HCAHCFGPJIF_Desc)
	{
		...
		_HCAHCFGPJIF_Desc.OPFGFINHFCE_name = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.JHFIPCIHJNL_Base.OPFGFINHFCE_name;
	...
	{
		AMDPJLBPLIG.OMEFFONNMBC(_KPNKPGLPDHI_Op, (KEPNMGHABPI.LNCLNAOPNKF _PMDLBHLNIDP_Target) =>
		{
			//0xD55248
