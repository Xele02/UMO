...
public class BEPHBEGDFFK
{
	...
	public bool NLFPCMJMAEM()
	{
		...
		{
			if(DPBDFPPMIPH.KACECFNECON.PGKIHFOKEHL != null)
			{
				for(int i = 0; i < DPBDFPPMIPH.KACECFNECON.PGKIHFOKEHL.Count; i++)
				{
					MLIBEPGADJH_Scene.KKLDOOJBJMN scene = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_SceneList[DPBDFPPMIPH.KACECFNECON.PGKIHFOKEHL[i].DNJEJEANJGL_Value - 1];
