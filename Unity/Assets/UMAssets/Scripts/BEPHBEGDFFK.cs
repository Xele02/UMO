...
public class BEPHBEGDFFK
{
	...
	{
		public LOBDIAABMKG DPBDFPPMIPH_Gacha { get; set; } // 0x8 MEMIBJHJPHG_bgs HLFDKACMMPC_bgs POCCHIIKMHM_bgs
	...
	public LOBDIAABMKG DPBDFPPMIPH_Gacha { get; private set; } // 0x14 MEMIBJHJPHG_bgs HLFDKACMMPC_bgs POCCHIIKMHM_bgs
	...
	public void DOMFHDPMCCO_Init(LOBDIAABMKG _NDNHHGJKJGM_Gach, int IMKLJJIBHCN, long _EOLFJGMAJAB_CurrentTime)
	{
						...
						if(((1 << (int)data.BJLONGBNPCI_SummonType) & 0x22AU) == 0) // 010 0010 1010
						{
							...
							else // 2/4/6/10
							{
								...
								else
								{
									...
									EGOLBAPFHHD_Common.PCHECKGDJDK l = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.KCCLEHLLOFG_Common.BGDMJGDEKFJ_GetGachaDraw(DPBDFPPMIPH_Gacha.FDEBLMKEMLF_TypeAndSeriesId);
	...
	{
		BGMDABJBHDM_Hour_Morning_4 = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.GDEKCOOBLMA_System.NGHKJOEDLIP_Settings.FPBEBCIPEPI_GachaHour[0];
		NDNHABFJNDB_Hour2_Noon_12 = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.GDEKCOOBLMA_System.NGHKJOEDLIP_Settings.FPBEBCIPEPI_GachaHour[1];
		ACDBBJBNLLG_Hour3_Evening_20 = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.GDEKCOOBLMA_System.NGHKJOEDLIP_Settings.FPBEBCIPEPI_GachaHour[2];
	...
	public static int CMHHHCAKPCD(LOBDIAABMKG _DPBDFPPMIPH_Gacha, GCAHJLOGMCI.NFCAJPIJFAM_SummonType _BJLONGBNPCI_SummonType)
	{
		if(_DPBDFPPMIPH_Gacha.INDDJNMPONH_type != GCAHJLOGMCI.KNMMOMEHDON_GachaType.DLOPEFGOAPD_10_LimitedItem)
		{
			return CIOECGOMILE.HHCJCDFCLOB.NBJOCMAJLPK_GetTotalCurrency(_DPBDFPPMIPH_Gacha.OMNAPCHLBHF_GetPurchaseCurrencyId(_BJLONGBNPCI_SummonType));
		}
		return EKLNMHFCAOI.ALHCGDMEMID_GetNumItems(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, EKLNMHFCAOI.BKHFLDMOGBD_GetItemCategory(_DPBDFPPMIPH_Gacha.MJNOAMAFNHA_CostItemId), EKLNMHFCAOI.DEACAHNLMNI_getItemId(_DPBDFPPMIPH_Gacha.MJNOAMAFNHA_CostItemId), null);
	}
	...
	public static long ENDIPBKOIOL(LOBDIAABMKG _DPBDFPPMIPH_Gacha, long _JHNMKKNEENE_Time)
	{
	...
	public static List<NKFJNAANPNP.MOJLCADLMKH> BNGLMLIMFDM(LOBDIAABMKG _DPBDFPPMIPH_Gacha, long _JHNMKKNEENE_Time)
	{
		...
		else if(_DPBDFPPMIPH_Gacha.INDDJNMPONH_type != GCAHJLOGMCI.KNMMOMEHDON_GachaType.DLOPEFGOAPD_10_LimitedItem)
		{
			...
			if (a == 0)
				a = _DPBDFPPMIPH_Gacha.OMNAPCHLBHF_GetPurchaseCurrencyId(GCAHJLOGMCI.NFCAJPIJFAM_SummonType.LMHDFEKIDKG_6);
			List<HPBDNNACBAK.MBMMGKJBJGD> d = NKGJPJPHLIF.HHCJCDFCLOB.FPNBCFJHENI.GGKFCDDFHFP.FindAll((HPBDNNACBAK.MBMMGKJBJGD _GHPLINIACBB_x) =>
			{
				//0xC799B8
		...
		EKLNMHFCAOI.FKGCBLHOOCL_Category cat = EKLNMHFCAOI.BKHFLDMOGBD_GetItemCategory(_DPBDFPPMIPH_Gacha.MJNOAMAFNHA_CostItemId);
		int itemId = EKLNMHFCAOI.DEACAHNLMNI_getItemId(_DPBDFPPMIPH_Gacha.MJNOAMAFNHA_CostItemId);
		if(cat == EKLNMHFCAOI.FKGCBLHOOCL_Category.CKCPFLDGILD_LimitedCompoItem)
		{
			res.AddRange(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.GJCOJBDOOJG_LimitedCompoItem.BNGLMLIMFDM(itemId, _JHNMKKNEENE_Time));
		}
		else if(cat == EKLNMHFCAOI.FKGCBLHOOCL_Category.DLOPEFGOAPD_24_LimitedItem)
		{
			res.AddRange(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.AFHFIPLOKMN_LimitedItem.BNGLMLIMFDM(itemId, _JHNMKKNEENE_Time));
		}
		else if(cat == EKLNMHFCAOI.FKGCBLHOOCL_Category.CIOGEKJNMBB_RareUpItem)
		{
			res.AddRange(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DPNKPPBEAGJ_RareUpItem.MCPIBDPKBBD(_JHNMKKNEENE_Time));
		}
		else
		{
			NKFJNAANPNP.MOJLCADLMKH data = new NKFJNAANPNP.MOJLCADLMKH();
	...
	public bool NLFPCMJMAEM()
	{
		if(DPBDFPPMIPH_Gacha.KACECFNECON_extra != null)
		{
			if(DPBDFPPMIPH_Gacha.KACECFNECON_extra.PGKIHFOKEHL_Feature != null)
			{
				...
				{
					MLIBEPGADJH_Scene.KKLDOOJBJMN scene = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.ECNHDEHADGL_Scene.CDENCMNHNGA_table[DPBDFPPMIPH_Gacha.KACECFNECON_extra.PGKIHFOKEHL_Feature[i].DNJEJEANJGL_Value - 1];
