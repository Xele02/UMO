...
public class BEPHBEGDFFK
{
	...
	public class DMBKENKBIJD
	{
		...
		//public GCAHJLOGMCI.KNMMOMEHDON INDDJNMPONH_type { get; } 0xC773E4 GHAILOLPHPF
		...
		public int ILFAHJEJCMH_GetPrice()
		{
			...
			{
				if(DPBDFPPMIPH_Gacha.INDDJNMPONH_type != GCAHJLOGMCI.KNMMOMEHDON_GachaType.DLOPEFGOAPD_10_PassGacha)
				{
	...
	public void DOMFHDPMCCO(LOBDIAABMKG _NDNHHGJKJGM_Gach, int IMKLJJIBHCN, long _EOLFJGMAJAB_CurrentTime)
	{
	...
	public DMBKENKBIJD PANFEKFCCOA()
	{
		for (int i = 0; i < FEMAEEHOCIJ.Count; i++)
		{
			if (FEMAEEHOCIJ[i].DPBDFPPMIPH_Gacha.INDDJNMPONH_type == GCAHJLOGMCI.KNMMOMEHDON_GachaType.DLOPEFGOAPD_10_PassGacha)
				return FEMAEEHOCIJ[i];
	...
	//public int CMHHHCAKPCD(GCAHJLOGMCI.NFCAJPIJFAM _BJLONGBNPCI_SummonType) { }

	//// RVA: 0xC76EA0 Offset: 0xC76EA0 VA: 0xC76EA0
	public static int CMHHHCAKPCD(LOBDIAABMKG DPBDFPPMIPH, GCAHJLOGMCI.NFCAJPIJFAM_SummonType _BJLONGBNPCI_SummonType)
	{
		if(DPBDFPPMIPH.INDDJNMPONH_type != GCAHJLOGMCI.KNMMOMEHDON_GachaType.DLOPEFGOAPD_10_PassGacha)
		{
			return CIOECGOMILE.HHCJCDFCLOB.NBJOCMAJLPK_GetTotalCurrency(DPBDFPPMIPH.OMNAPCHLBHF(_BJLONGBNPCI_SummonType));
		}
		return EKLNMHFCAOI.ALHCGDMEMID_GetNumItems(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, EKLNMHFCAOI.BKHFLDMOGBD_GetItemCategory(DPBDFPPMIPH.MJNOAMAFNHA_CostItemId), EKLNMHFCAOI.DEACAHNLMNI_getItemId(DPBDFPPMIPH.MJNOAMAFNHA_CostItemId), null);
	}
	...
	public static long ENDIPBKOIOL(LOBDIAABMKG DPBDFPPMIPH, long _JHNMKKNEENE_Time)
	{
		List<NKFJNAANPNP.MOJLCADLMKH> l = BNGLMLIMFDM(DPBDFPPMIPH, _JHNMKKNEENE_Time);
		if(l.Count > 0)
		{
	...
	public static List<NKFJNAANPNP.MOJLCADLMKH> BNGLMLIMFDM(LOBDIAABMKG DPBDFPPMIPH, long _JHNMKKNEENE_Time)
	{
		List<NKFJNAANPNP.MOJLCADLMKH> res = new List<NKFJNAANPNP.MOJLCADLMKH>();
		if(DPBDFPPMIPH.INDDJNMPONH_type == GCAHJLOGMCI.KNMMOMEHDON_GachaType.OOABDNHIEFK_9)
		{
		...
		else if(DPBDFPPMIPH.INDDJNMPONH_type != GCAHJLOGMCI.KNMMOMEHDON_GachaType.DLOPEFGOAPD_10_PassGacha)
		{
			int a = DPBDFPPMIPH.OMNAPCHLBHF(GCAHJLOGMCI.NFCAJPIJFAM_SummonType.GOAHICNDICO_5);
			if (a == 0)
				a = DPBDFPPMIPH.OMNAPCHLBHF(GCAHJLOGMCI.NFCAJPIJFAM_SummonType.LMHDFEKIDKG_6);
