...
public class JJPEIELNEJB
{
	public class LKDLJCCJJNK
	{
		...
		private int EHOIENNDEDH_Crypted; // 0x1C
		private int CGIGOFKGCII_Crypted; // 0x20
		...
		public int APFDNBGMMMM_BingoId { get { return AEMBNNJLEIB_Crypted ^ FBGGEFFJJHB; } set { AEMBNNJLEIB_Crypted = value ^ FBGGEFFJJHB; } } //0x1358E4C PBHPNJNEMHN 0x1358E5C KLPENCIJKME
		public int PPFNGGCBJKC { get { return EHOIENNDEDH_Crypted ^ FBGGEFFJJHB; } set { EHOIENNDEDH_Crypted = value ^ FBGGEFFJJHB; } } //0x1358E6C DEMEPMAEJOO 0x1358E7C HIGKAIDMOKN
		public int AHHJLDLAPAN_DivaId { get { return CGIGOFKGCII_Crypted ^ FBGGEFFJJHB; } set { CGIGOFKGCII_Crypted = value ^ FBGGEFFJJHB; } } //0x1358E8C IPKDLMIDMHH 0x1358E9C IENNENMKEFO
		public int JPIDIENBGKH { get { return HFJLOKDMJHI_Crypted ^ FBGGEFFJJHB; } set { HFJLOKDMJHI_Crypted = value ^ FBGGEFFJJHB; } } //0x1358EAC PHLLMIGCPCB 0x1358EBC BLBNMENMCIF
		public int DAJGPBLEEOB_CostumeId { get { return HNJNKCPDKAL_Crypted ^ FBGGEFFJJHB; } set { HNJNKCPDKAL_Crypted = value ^ FBGGEFFJJHB; } } //0x1358ECC LHPKEPPBKPF 0x1358EDC OIOEEEDODJA
		...
		public int BCCHOBPJJKE_SceneId { get { return POAOLKIEOHC_Crypted ^ FBGGEFFJJHB; } set { POAOLKIEOHC_Crypted = value ^ FBGGEFFJJHB; } } //0x1358F4C COHCNONLPAC 0x1358F5C HJEBBEHGHGG
		public int BOCDGDKMMIP_Rarity { get { return HHNNGNKEBDA_Crypted ^ FBGGEFFJJHB; } set { HHNNGNKEBDA_Crypted = value ^ FBGGEFFJJHB; } } //0x1358F6C JGEHNNFJBFC 0x1358F7C MMFLIFJMIJK
		...
		public int FOAPHMMBKDM { get { return NCPKEALEIIG_Crypted ^ FBGGEFFJJHB; } set { NCPKEALEIIG_Crypted = value ^ FBGGEFFJJHB; } } //0x1359090 LKOFKKOGJHL 0x13590A0 JDEIGMAHFKP
	...
	public class OMMBBPKFLNH
	{
		...
		public void FBANBDCOEJL()
		{
			if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null && GNGMCIAIKMA.HHCJCDFCLOB != null)
			{
				...
				{
					CPKMLLNADLJ_Attr = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.MGFMPKLLGHE_Diva.GCINIJEMHFK_GetInfo(AHHJLDLAPAN_DivaId).AIHCEGFANAM_SerieAttr;
				}
	...
	public class CJBKOOCMLEO
	{
		private int FBGGEFFJJHB = GNGMCIAIKMA.FBGGEFFJJHB; // 0x8
		private long BBEGLBMOBOF = GNGMCIAIKMA.BBEGLBMOBOF; // 0x10
		private int EHOIENNDEDH_Crypted; // 0x18
		...
		private sbyte ALPDMEILILP_Crypted; // 0x48
		private sbyte MCFFGKAOIHP_Crypted; // 0x49

		public int PPFNGGCBJKC { get { return EHOIENNDEDH_Crypted ^ FBGGEFFJJHB; } set { EHOIENNDEDH_Crypted = value ^ FBGGEFFJJHB; } } //0x13586A8 DEMEPMAEJOO 0x13586B8 HIGKAIDMOKN
		public int NDFOAINJPIN { get { return MEJIFDMJHLM_Crypted ^ FBGGEFFJJHB; } set { MEJIFDMJHLM_Crypted = value ^ FBGGEFFJJHB; } } //0x13586C8 CLKKCPLEKBC 0x13586D8 CLJOOFCICMO
		...
		public int GLCLFMGPMAN_ItemId { get { return AHGCGHAAHOO_ItemIdCrypted ^ FBGGEFFJJHB; } set { AHGCGHAAHOO_ItemIdCrypted = value ^ FBGGEFFJJHB; } } //0x13587A8 LNJAENEGDEL 0x13587B8 JHIDBGCHOKL
		public int LJKMKCOAICL_ItemCount { get { return CMBLIDNDLOO_Crypted ^ FBGGEFFJJHB; } set { CMBLIDNDLOO_Crypted = value ^ FBGGEFFJJHB; } } //0x13587C8 KJPMAPBJBKE 0x13587D8 PPBMLEFDPOF
		...
		public int CMCKNKKCNDK_MsStat { get { return NLBLLLLBHOP_Crypted ^ FBGGEFFJJHB; } set { NLBLLLLBHOP_Crypted = value ^ FBGGEFFJJHB; } } //0x1358848 CNKGOPKANGF 0x1358858 CHJGGLFGALP
		public int GMGGCIJHDJH_ConditionType { get { return KFEPIAKDDHA_Crypted ^ FBGGEFFJJHB; } set { KFEPIAKDDHA_Crypted = value ^ FBGGEFFJJHB; } } //0x1358868 BIPCONAFCPO 0x1358878 PKGLOAAEKHI
		public int DODGLIDGBBC_ConditionValue { get { return CILEPBKEOHB_Crypted ^ FBGGEFFJJHB; } set { CILEPBKEOHB_Crypted = value ^ FBGGEFFJJHB; } } //0x1358888 PAACNLDBGKP 0x1358898 AHIHPMDINHA
		public int GIKJNDFJFPM_MsCnt { get { return FANHHAHBDPA_Crypted ^ FBGGEFFJJHB; } set { FANHHAHBDPA_Crypted = value ^ FBGGEFFJJHB; } } //0x13588A8 IBMKJNJCEDO 0x13588B8 LJPNAJOLKNG
		public int MPBADMODLOJ_MsTarget { get { return JCCJFCHMDBF_Crypted ^ FBGGEFFJJHB; } set { JCCJFCHMDBF_Crypted = value ^ FBGGEFFJJHB; } } //0x13588C8 AMOLLDKGIPD 0x13588D8 GGPADGDEHMO
		public bool BCGLDMKODLC_IsSingle { get { return ALPDMEILILP_Crypted == 0x1d; } set { ALPDMEILILP_Crypted = (sbyte)(value ? 0x1d : 0x3f); } } //0x13588E8 NNGALFPBDNA 0x13588FC JJBMOHCMALD
	...
	public class JLHHGLANHGE
	{
		...
		public int PPFNGGCBJKC { get { return EHOIENNDEDH_Crypted ^ FBGGEFFJJHB; } set { EHOIENNDEDH_Crypted = value ^ FBGGEFFJJHB; } } //0x1358B30 DEMEPMAEJOO 0x1358B40 HIGKAIDMOKN
		public int GLCLFMGPMAN_ItemFullId { get { return AHGCGHAAHOO_ItemIdCrypted ^ FBGGEFFJJHB; } set { AHGCGHAAHOO_ItemIdCrypted = value ^ FBGGEFFJJHB; } } //0x1358B50 LNJAENEGDEL 0x1358B60 JHIDBGCHOKL
		public int LJKMKCOAICL_ItemCount { get { return CMBLIDNDLOO_Crypted ^ FBGGEFFJJHB; } set { CMBLIDNDLOO_Crypted = value ^ FBGGEFFJJHB; } } //0x1358B70 KJPMAPBJBKE 0x1358B80 PPBMLEFDPOF
		...
		public EKLNMHFCAOI.FKGCBLHOOCL_Category MJBKGOJBPAD_ItemCat { get { return (EKLNMHFCAOI.FKGCBLHOOCL_Category)(BFNCPNIMLGJ_Crypted ^ FBGGEFFJJHB); } set { BFNCPNIMLGJ_Crypted = (int)value ^ FBGGEFFJJHB; } } //0x1358C50 COFMKKJBELJ 0x1358C64 KHOHIGFNIIF
		public int OCNINMIMHGC_ItemId { get { return OBNCDLMGDFG_Crypted ^ FBGGEFFJJHB; } set { OBNCDLMGDFG_Crypted = value ^ FBGGEFFJJHB; } } //0x1358C74 BGCLLLFODPB 0x1358C84 FILEGBHDMFC
