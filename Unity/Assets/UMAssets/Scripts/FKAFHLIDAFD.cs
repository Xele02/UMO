...
public class FKAFHLIDAFD
{
	...
	public void BELHFJNAEKB()
	{
		...
		AHEFHIMGIBI_PlayerData.HFCOIIHIENB = BBHNACPENDM_ServerSaveData.BDADJONBIBO_DataType.FKNGHCNOEHO_1_Local;
		AHEFHIMGIBI_PlayerData.HIJAFAIOLIL();
		CCNKAKCBBDJ = new BBHNACPENDM_ServerSaveData();
		CCNKAKCBBDJ.HFCOIIHIENB = BBHNACPENDM_ServerSaveData.BDADJONBIBO_DataType.AFGALHECDIJ_3;
		CCNKAKCBBDJ.HIJAFAIOLIL();
		FMFKHDPKLOC = new BBHNACPENDM_ServerSaveData();
		FMFKHDPKLOC.HFCOIIHIENB = BBHNACPENDM_ServerSaveData.BDADJONBIBO_DataType.GGEELFGJAMP_2;
