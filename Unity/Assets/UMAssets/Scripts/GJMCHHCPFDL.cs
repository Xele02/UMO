...
public class GJMCHHCPFDL
{
	...
	public void KHEKNNFCAOI(bool DLKLEFMHJBN/* = False*/)
	{
		...
		if(ev != null && ev.HIDHLFCBIDE_EventType == OHCAABOMEOF.KGOGMKMBCPP_EventType.CADKONMJEDA_EventRaid)
		{
			...
			FJOLNJLLJEJ_Rank = ev.JIBMOEHKMGB.FJOLNJLLJEJ_Rank;
			MPKBLMCNHOM_MissionIsSpecial = ev.JIBMOEHKMGB.IKICLMGFFPB_IsSpecial;
			HPPDFBKEJCG_BgId = ev.JIBMOEHKMGB.HPPDFBKEJCG_BgId;
			OPFGFINHFCE_Name = ev.AGEJGHGEGFF_GetBossName(ev.JIBMOEHKMGB.INDDJNMPONH_Type);
		}
	}
}
