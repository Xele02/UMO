...
public class IBIGBMDANNM
{
	...
	public string LBODHBDOMGK_Name { get { return AHEFHIMGIBI_ServerData.JHFIPCIHJNL_Base.OPFGFINHFCE_PlayerName; } set { AHEFHIMGIBI_ServerData.JHFIPCIHJNL_Base.OPFGFINHFCE_PlayerName = value; } }// 0x12125FC JLFIGDAGIEB 0x1212648 KMHENDLDBEA
	...
	public int FCKJJGIMPPI_Level { get { return AHEFHIMGIBI_ServerData.MHEAEGMIKIE_PublicStatus.ANAJIAENLNB_Level; } set { AHEFHIMGIBI_ServerData.MHEAEGMIKIE_PublicStatus.ANAJIAENLNB_Level = value; } } //0x121274C KHAEBKHHDDH 0x1212798 FODBHLHKHFI
	public int NOEAJIJIIHK_McPower { get { return AHEFHIMGIBI_ServerData.MHEAEGMIKIE_PublicStatus.OENMBJEKJII_McPower; } set { AHEFHIMGIBI_ServerData.MHEAEGMIKIE_PublicStatus.OENMBJEKJII_McPower = value; } } //0x12127EC IKHEOMAMDGP 0x1212838 MMLGLIOAOBA
	...
	{
		AHEFHIMGIBI_ServerData = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_ServerSave;
		MLPEHNBNOGD_Id = NKGJPJPHLIF.HHCJCDFCLOB.MDAMJIGBOLD_PlayerId;
		AJECHDLMKOE_LastLogin = NKGJPJPHLIF.HHCJCDFCLOB.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL.KMEFBNBFJHI_GetServerTime();
