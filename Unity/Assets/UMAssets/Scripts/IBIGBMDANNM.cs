...
public class IBIGBMDANNM
{
	...
	protected virtual bool NLENMNMCJCJ(int _PPFNGGCBJKC_id, long _IFNLEKOILPM_updated_at, bool _MLEHCBKPNGK_IsFriend, List<string> _OHNJJIMGKGK_Names, EDOHBJAPLPF_JsonData _IDLHJIOMJBK_data, BBHNACPENDM_ServerSaveData _AHEFHIMGIBI_PlayerData)
	{
		if(_AHEFHIMGIBI_PlayerData.IIEMACPEEBJ_Deserialize(_OHNJJIMGKGK_Names, _IDLHJIOMJBK_data))
		{
			...
			LFKJNMFFCLH_LastLoginString = PIGBKEIAMPE_NetFriendManager.MKILKPFAOIC_GetLastLoginString(_IFNLEKOILPM_updated_at, NKGJPJPHLIF_SakashoManager.HHCJCDFCLOB_Instance.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime());
	...
	//|-IBIGBMDANNM.HEGEKFMJNCC<NKOBMDPHNGP_NetEventRaidLobbyController.ELKMKCNPDFO>
	...
	{
		AHEFHIMGIBI_PlayerData = CIOECGOMILE_NetPlayerDataManager.HHCJCDFCLOB_Instance.AHEFHIMGIBI_PlayerData;
		MLPEHNBNOGD_PlayerId = NKGJPJPHLIF_SakashoManager.HHCJCDFCLOB_Instance.MDAMJIGBOLD_PlayerId;
		AJECHDLMKOE_LastLogin = NKGJPJPHLIF_SakashoManager.HHCJCDFCLOB_Instance.IBLPICFDGOF_ServerRequester.FJDBNGEPKHL_Time.KMEFBNBFJHI_GetServerTime();
		LFKJNMFFCLH_LastLoginString = PIGBKEIAMPE_NetFriendManager.MKILKPFAOIC_GetLastLoginString(AJECHDLMKOE_LastLogin, AJECHDLMKOE_LastLogin);
