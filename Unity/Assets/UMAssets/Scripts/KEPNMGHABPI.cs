...
public class KEPNMGHABPI
{
	...
	public void FNKJBKJIKPC(int _KPNKPGLPDHI_Op, bool PAEAHCEJLKG, Action<List<LNCLNAOPNKF>> _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK _MOBEEPPKFLG_OnFail, KEPNMGHABPI.AELPHOILEBM _NGHKJOEDLIP_Settings, SakashoBbsThreadCriteria _IPKCADIAAPG_Criteria)
	{
		...
		OMBENJEDFLJ(_KPNKPGLPDHI_Op, _NGHKJOEDLIP_Settings, new List<List<LNCLNAOPNKF>>(), _BHFHGFKBOHH_OnSuccess, _MOBEEPPKFLG_OnFail, PAEAHCEJLKG);
	}
	...
	// public void EBMBDKCCPOG(int _BOINIEAKFPL_ThreadId, int EMGJJFKONHK, IMCBBOAFION _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK _MOBEEPPKFLG_OnFail) { }
	...
	private void OMBENJEDFLJ(int _KPNKPGLPDHI_Op, AELPHOILEBM _NGHKJOEDLIP_Settings, List<List<LNCLNAOPNKF>> CHGLFGOKKJG, Action<List<LNCLNAOPNKF>> _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK _MOBEEPPKFLG_OnFail, bool PAEAHCEJLKG)
	{
		OMBENJEDFLJ_GetThreads(_KPNKPGLPDHI_Op, _NGHKJOEDLIP_Settings, (MMCLJMPEFEP_GetBbsThreads.CAMBPKCCBDO CHCEIJOJDHL) =>
		{
			//0x19F92D4
			ALNCDMPMEHP(_KPNKPGLPDHI_Op, null, _NGHKJOEDLIP_Settings, CHCEIJOJDHL.NMHGLNGACMI_Threads, (List<LNCLNAOPNKF> AIMLPJOGPID) =>
			{
				//0x19F989C
				...
				if(CHCEIJOJDHL.MDIBIIHAAPN_next_page > 0)
				{
					...
					OMBENJEDFLJ(_KPNKPGLPDHI_Op, _NGHKJOEDLIP_Settings, CHGLFGOKKJG, _BHFHGFKBOHH_OnSuccess, _MOBEEPPKFLG_OnFail, PAEAHCEJLKG);
					return;
				}
