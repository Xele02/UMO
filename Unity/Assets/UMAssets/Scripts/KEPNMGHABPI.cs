...
public class KEPNMGHABPI
{
    ...
    public class CAIPMAMHNJP
    {
        ...
        public CAIPMAMHNJP(int BOINIEAKFPL, string KGICDMIJGDF, string _ADCMNODJBGJ_Title, BNAAJMBJFPG CCBEKGNDDBE)
		{
			MENAGBMBJFJ = new LNCLNAOPNKF(BOINIEAKFPL, KGICDMIJGDF, _ADCMNODJBGJ_Title);
			OIPCCBHIKIA_Idx = CCBEKGNDDBE.NPAHGHOHMHN_Idx;
			this.CCBEKGNDDBE = CCBEKGNDDBE;
		}
    }
