...
// namespace XeApp.Game.Net.Bbs
[System.Obsolete()]
public class KEPNMGHABPI {}
public class KEPNMGHABPI_NetBbsController
{
    //[DefaultMemberAttribute("Item")] // RVA: 0x63D4EC Offset: 0x63D4EC VA: 0x63D4EC
    public class FKGOOHONBGI
    {
        private Dictionary<string, KEPNMGHABPI_NetBbsController> GCOJLMHEBNJ = new Dictionary<string, KEPNMGHABPI_NetBbsController>(); // 0x8

        // public KEPNMGHABPI_NetBbsController INIMBLOHIEF_set_Item { get; }

        // RVA: 0x19FC68C Offset: 0x19FC68C VA: 0x19FC68C
        public KEPNMGHABPI_NetBbsController GOAMILGNJIE(BNJJHPEGNAI.HCAJEKFFNBM PNOEDHCKCEJ)
        {
            string str = PNOEDHCKCEJ.KGICDMIJGDF_Group + PNOEDHCKCEJ.ADCMNODJBGJ_title;
            KEPNMGHABPI_NetBbsController res = null;
            if(!GCOJLMHEBNJ.TryGetValue(str, out res))
            {
                res = new KEPNMGHABPI_NetBbsController(PNOEDHCKCEJ);
    ...
    public class AELPHOILEBM
    {
        ...
        public AELPHOILEBM(KEPNMGHABPI_NetBbsController PAKIOKPJOBF)
        {
            KHEKNNFCAOI_Init(PAKIOKPJOBF);
        }

        // RVA: 0x19FC234 Offset: 0x19FC234 VA: 0x19FC234
        public void KHEKNNFCAOI_Init(KEPNMGHABPI_NetBbsController PAKIOKPJOBF)
        {
	...
	private PJKLMCGEJMK_NetActionManager CPHFEPHDJIB_ServerRequester { get { return NKGJPJPHLIF_SakashoManager.HHCJCDFCLOB_Instance.IBLPICFDGOF_ServerRequester; } } //0x19F3D04 JPEBBKJAMCK_bgs

	// // RVA: 0x19F3DA0 Offset: 0x19F3DA0 VA: 0x19F3DA0
	internal KEPNMGHABPI_NetBbsController(BNJJHPEGNAI.HCAJEKFFNBM MENAGBMBJFJ)
    {
	...
	public void FNKJBKJIKPC(int _KPNKPGLPDHI_Op, bool PAEAHCEJLKG, Action<List<LNCLNAOPNKF>> _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK _MOBEEPPKFLG_OnFail, KEPNMGHABPI_NetBbsController.AELPHOILEBM _NGHKJOEDLIP_Settings, SakashoBbsThreadCriteria _IPKCADIAAPG_Criteria)
	{
	...
	// public SakashoBbsThreadInfo LFAJKNNALBJ(KEPNMGHABPI_NetBbsController.LNCLNAOPNKF MENAGBMBJFJ) { }
	...
	public void HMOPLMHMNNP_GetComments(int _KPNKPGLPDHI_Op, int _BOINIEAKFPL_ThreadId, EIAMFNIAFGN _NGHKJOEDLIP_Settings, Action<NFIMGIABIOI_GetBbsThreadComments.CIIDLDOOKBB> _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK _MOBEEPPKFLG_OnFail)
	{
		...
		{
			NFIMGIABIOI_GetBbsThreadComments COJNCNGHIJC_Req = NKGJPJPHLIF_SakashoManager.HHCJCDFCLOB_Instance.HKDHHMHHJOJ.IFFNCAFNEAG_AddRequest(new NFIMGIABIOI_GetBbsThreadComments());
			COJNCNGHIJC_Req.BOINIEAKFPL_ThreadId = _BOINIEAKFPL_ThreadId;
			COJNCNGHIJC_Req.IPKCADIAAPG_Criteria = _NGHKJOEDLIP_Settings.IPKCADIAAPG_Criteria;
			COJNCNGHIJC_Req.MLMHPBOKJCL_SortOrder = _NGHKJOEDLIP_Settings.MLMHPBOKJCL_SortOrder;
			COJNCNGHIJC_Req.IGNIIEBMFIN_Page = _NGHKJOEDLIP_Settings.IGNIIEBMFIN_Page;
	...
	public void IFFGEIMIKHH(int _KPNKPGLPDHI_Op, SakashoBbsCommentInfo _KOGBMDOONFA_Info, KEPNMGHABPI_NetBbsController.DALALJLBNPL _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK _MOBEEPPKFLG_OnFail, DJBHIFLHJLK NKGHADCBGJO)
    {
        if(LHKOLKACMPA != null)
        {
	...
	private void OMBENJEDFLJ_GetThreads(int _KPNKPGLPDHI_Op, AELPHOILEBM _NGHKJOEDLIP_Settings, Action<MMCLJMPEFEP_GetBbsThreads.CAMBPKCCBDO> _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK _MOBEEPPKFLG_OnFail)
	{
		...
		{
			MMCLJMPEFEP_GetBbsThreads COJNCNGHIJC_Req = NKGJPJPHLIF_SakashoManager.HHCJCDFCLOB_Instance.HKDHHMHHJOJ.IFFNCAFNEAG_AddRequest(new MMCLJMPEFEP_GetBbsThreads());
			COJNCNGHIJC_Req.IPKCADIAAPG_Criteria = _NGHKJOEDLIP_Settings.IPKCADIAAPG_Criteria == null ? BIBOMJHJHMG : _NGHKJOEDLIP_Settings.IPKCADIAAPG_Criteria;
			COJNCNGHIJC_Req.MLPLGFLKKLI_Ipp = _NGHKJOEDLIP_Settings.MLPLGFLKKLI_Ipp;
			COJNCNGHIJC_Req.IGNIIEBMFIN_Page = _NGHKJOEDLIP_Settings.IGNIIEBMFIN_Page;
			COJNCNGHIJC_Req.DFJDDIGFGKJ_SortKey = _NGHKJOEDLIP_Settings.DFJDDIGFGKJ_SortKey;
	...
	private void OCKOIMLGLCF(int _KPNKPGLPDHI_Op, List<List<CAIPMAMHNJP>> GHIHLNKPKGH, int _POMLAOPLMNA_offset, int _HMFFHLPNMPH_count, List<KEPNMGHABPI_NetBbsController.LNCLNAOPNKF> _NMHGLNGACMI_Threads, KEPNMGHABPI_NetBbsController.EIAMFNIAFGN _NGHKJOEDLIP_Settings, Action<List<KEPNMGHABPI_NetBbsController.CAIPMAMHNJP>> _BHFHGFKBOHH_OnSuccess, DJBHIFLHJLK _MOBEEPPKFLG_OnFail)
	{
	...
	// |-KEPNMGHABPI_NetBbsController.GAOPGAEHPEE<KEPNMGHABPI_NetBbsController.CAIPMAMHNJP>
	// |-KEPNMGHABPI_NetBbsController.GAOPGAEHPEE<KEPNMGHABPI_NetBbsController.LNCLNAOPNKF>
	// |-KEPNMGHABPI_NetBbsController.GAOPGAEHPEE<object>
	// */
