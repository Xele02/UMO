...
public class BAJFMCIDGOK
{
	...
	public int GOIKCKHMBDL_FreeMusicId { get { return CJAOMKLHFJL_Crypted ^ ENOBDCFHELD; } set { CJAOMKLHFJL_Crypted = value ^ ENOBDCFHELD; } } //0xF15FE8 BPGCGEDHBEH 0xF15FF8 ICPMFBIDFFO
	public int KNIFCANOHOC_score { get { return NBOLDNMPJFG_scoreCrypted ^ ENOBDCFHELD; } set { NBOLDNMPJFG_scoreCrypted = value ^ ENOBDCFHELD; } } //0xF16008 EOJEPLIPOMJ 0xF16018 AEEMBPAEAAI
	public int JKAMFMNGEBB_high_score { get { return JBFANBKCHMG_Crypted ^ ENOBDCFHELD; } set { JBFANBKCHMG_Crypted = value ^ ENOBDCFHELD; } } //0xF16028 EAOCMNMBDEG 0xF16038 ILFAFLEFJCF
