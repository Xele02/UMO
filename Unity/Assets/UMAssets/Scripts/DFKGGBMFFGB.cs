...
public class DFKGGBMFFGB_PlayerInfo
{
	...
	public BBHNACPENDM_ServerSaveData AHEFHIMGIBI_PlayerData { get { return LDEGEHAEALK_ServerData; } } // GNMGJMDJEGI_bgs 0x197E7F0
	// public int NLMELNHPIID { get; set; }//DBEFCECMFMG_bgs 0x197E8C0 ILFOOPKEKLC_bgs 0x197E90C
	...
	public void LCCKKHFEIGH(int IMJIADPJJMM)
	{
		...
		NPFCMHCCDDH.HCDGELDHFHB_UpdateStatus();
	}
	...
	public void JHDADIMLHII(int _AHHJLDLAPAN_DivaId, int IMJIADPJJMM)
	{
		...
		LEIGKLOGCPF_MainUnitGoDiva.HCDGELDHFHB_UpdateStatus();
	...
	public void HOOJOFACOEK_SetCostume(int _AHHJLDLAPAN_DivaId, int _JPIDIENBGKH_CostumeId, int _EKFONBFDAAP_ColorId)
	{
		NBIGLBMHEDC_DivaList[_AHHJLDLAPAN_DivaId - 1].HOOJOFACOEK_SetCostume(_JPIDIENBGKH_CostumeId, _EKFONBFDAAP_ColorId, false, false);
		NPFCMHCCDDH.HCDGELDHFHB_UpdateStatus();
	}

	// // RVA: 0x19811EC Offset: 0x19811EC VA: 0x19811EC
	public void OPDBFHFKKJN_SetHomeCostume(int _AHHJLDLAPAN_DivaId, int _JPIDIENBGKH_CostumeId, int _EKFONBFDAAP_ColorId)
	{
		NBIGLBMHEDC_DivaList[_AHHJLDLAPAN_DivaId - 1].OPDBFHFKKJN_SetHomeCostume(_JPIDIENBGKH_CostumeId, _EKFONBFDAAP_ColorId, false);
	}
