...
public class ALEKLHIANJN
{
	...
	public int KBFDFIBDOKC(IMCBBOAFION _BHFHGFKBOHH_OnSuccess)
	{
		...
		if(f == null)
		{
			...
			ILCCJNDFFOB.HHCJCDFCLOB.ELDCONNMDGN_ValkyrieEnhance(GPPEFLKGGGJ_ValkyrieId, a5, CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.JJFFBDLIOCF_Valkyrie.OEMMJCLJMGB_GetLevel(GPPEFLKGGGJ_ValkyrieId), a1, a2, a3, a4);
		}
