...
public class NCPPAHHCCAO
{
	...
	//public int PPFNGGCBJKC { get; set; } 0x1ADA0E0 0x1ADA0F0
	//public int INDDJNMPONH { get; set; } 0x1ADA100 0x1ADA110
	//public int IDELKEKDIFD { get; set; } 0x1ADA120 0x1ADA130
	//public int BEHMEDMNJMC { get; set; } 0x1ADA140 0x1ADA150
	//public int EKLIPGELKCL { get; set; } 0x1ADA160 0x1ADA170
	//public int EDEEMPJPFCP { get; set; } 0x1ADA180 0x1ADA190
	//public int HDHNEILDILJ { get; set; } 0x1ADA1A0 0x1ADA1B0
	//public int CPKMLLNADLJ { get; set; } 0x1ADA1C0 0x1ADA1D0
	//public int BFINGCJHOHI { get; set; } 0x1ADA1E0 0x1ADA1F0
	...
	public static string EFNHFKLKNHJ(int PPFNGGCBJKC)
	{
		...
		if(PPFNGGCBJKC > 0)
		{
			if(PPFNGGCBJKC <= IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.GAPONCJOKAC_DecoStamp.DMKMNGELNAE_Serif.Count)
			{
				...
				{
					if(serif.JBFLEDKDFCO <= IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.OMGFKMANMAB_Sns.KHCACDIKJLG.Count)
					{
						BOKMNHAFJHF_Sns.JFMDDEBLCAA sns = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.OMGFKMANMAB_Sns.KHCACDIKJLG[serif.JBFLEDKDFCO - 1];
						return sns.OPFGFINHFCE + IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.GAPONCJOKAC_DecoStamp.EFEGBHACJAL("desc_string_senyo", JpStringLiterals.StringLiteral_12528);
					}
				}
			}
		}
