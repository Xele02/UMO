...
public class JFOBOMOMENL
{
	...
	public static bool AOFAHDGAMKH(DAJBODHMLAB_DecoPublicSet PDKHANKAPCI, List<JEPMHCPBIGD_DecoItemInit.MPIILICCLDD> _CBBLAMDGOGK_bg, List<JEPMHCPBIGD_DecoItemInit.MPIILICCLDD> LMNBBOIJBBL, List<JEPMHCPBIGD_DecoItemInit.MPIILICCLDD> MBAMIOJNGBD, List<JEPMHCPBIGD_DecoItemInit.MPIILICCLDD> OFGHDIFGIPK, List<JEPMHCPBIGD_DecoItemInit.MPIILICCLDD> PIPCIMIALOO, bool OELFMOMMPMC/* = false*/)
    {
        ...
        if(!OELFMOMMPMC)
            MBFFGGFGPEN(PDKHANKAPCI, _CBBLAMDGOGK_bg, LMNBBOIJBBL, MBAMIOJNGBD, OFGHDIFGIPK, PIPCIMIALOO);
        return true;
    }

	// // RVA: 0x1C45DB0 Offset: 0x1C45DB0 VA: 0x1C45DB0
	private static void MBFFGGFGPEN(DAJBODHMLAB_DecoPublicSet PDKHANKAPCI, List<JEPMHCPBIGD_DecoItemInit.MPIILICCLDD> _CBBLAMDGOGK_bg, List<JEPMHCPBIGD_DecoItemInit.MPIILICCLDD> LMNBBOIJBBL, List<JEPMHCPBIGD_DecoItemInit.MPIILICCLDD> MBAMIOJNGBD, List<JEPMHCPBIGD_DecoItemInit.MPIILICCLDD> OFGHDIFGIPK, List<JEPMHCPBIGD_DecoItemInit.MPIILICCLDD> PIPCIMIALOO)
    {
	...
	private static void MBFFGGFGPEN(DAJBODHMLAB_DecoPublicSet PDKHANKAPCI, JEPMHCPBIGD_DecoItemInit.MPIILICCLDD IDLHJIOMJBK, EKLNMHFCAOI.FKGCBLHOOCL_Category NPADACLCNAN)
    {
        ...
        a.GHPLINIACBB_x = IDLHJIOMJBK.FBNCFENGOOD_PosX;
