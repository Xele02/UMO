...
public class MOLKENLNCPE_DropData
{
	...
	public void KHEKNNFCAOI()
    {
		...
		for (int i = 0; i < JGEOBNENMAH.HHCJCDFCLOB.DCELMKFJHPG.Count; i++)
		{
			...
			data.MHFBCINOJEE = EKLNMHFCAOI.DEACAHNLMNI_getItemId(data.KIJAPOFAGPN_ItemId);
			...
			data.LIDBKCIMCKE_Rarity = EKLNMHFCAOI.FABCKNDLPDH_GetItemRarity(data.HHACNFODNEF_Category, data.MHFBCINOJEE);
