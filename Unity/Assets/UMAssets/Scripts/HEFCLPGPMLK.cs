...
public class HEFCLPGPMLK
{
	...
	public class DNNODDKHJBJ : IComparer<AAOPGOGGMID>
	{
		...
		public int Compare(AAOPGOGGMID HKICMNAACDA, AAOPGOGGMID BNKHBCBJBKI)
		{
			if(HKICMNAACDA.CIEOBFIIPLD_Level == BNKHBCBJBKI.CIEOBFIIPLD_Level)
			{
				...
				{
					if(HKICMNAACDA.NONBCCLGBAO_hit == BNKHBCBJBKI.NONBCCLGBAO_hit)
					{
						if (HKICMNAACDA.PPFNGGCBJKC_id == BNKHBCBJBKI.PPFNGGCBJKC_id)
							return 0;
						if (HKICMNAACDA.PPFNGGCBJKC_id <= BNKHBCBJBKI.PPFNGGCBJKC_id)
							return OJDPFLDPODB;
					}
					else if(HKICMNAACDA.NONBCCLGBAO_hit <= BNKHBCBJBKI.NONBCCLGBAO_hit)
						return OJDPFLDPODB;
				}
	...
	public void KJODFBIBFFO(BBHNACPENDM_ServerSaveData _LDEGEHAEALK_ServerData, ref AAOPGOGGMID _IDLHJIOMJBK_Data, int _FGHGMHPNEMG_Type, int _MLDPDLPHJPM_OfferId, long _JHNMKKNEENE_Time)
	{
		if(KDHGBOOECKC.HHCJCDFCLOB != null)
		{
			...
			if(d != null)
			{
				...
				_IDLHJIOMJBK_Data.KINJOEIAHFK_StartTime = d.DFJLNPFJGDK_StartDate;
				...
				_IDLHJIOMJBK_Data.MNPEAHNONAI_Cnt = d.BFINGCJHOHI_Count;
				_IDLHJIOMJBK_Data.CADENLBDAEB_IsNew = d.BFINGCJHOHI_Count == 0;
		...
		if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
		{
			if(KDHGBOOECKC.HHCJCDFCLOB != null)
			{
				...
				for(int i = 0; i < l1.Count; i++)
				{
					...
					data.IJOLPDKFLPO_OfferName = KDHGBOOECKC.HHCJCDFCLOB.GEGAJLNPMEC((BOPFPIHGJMD.MLBMHDCCGHI)l1[i].GBJFNGCDKPM_Type, l1[i].PPFNGGCBJKC_id);
					...
					data.FGHGMHPNEMG_Type = (BOPFPIHGJMD.MLBMHDCCGHI)l1[i].GBJFNGCDKPM_Type;
					...
					KJODFBIBFFO(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, ref data, l1[i].GBJFNGCDKPM_Type, l1[i].PPFNGGCBJKC_id, _JHNMKKNEENE_Time);
					res.Add(data);
				}
		...
		if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
		{
			if(KDHGBOOECKC.HHCJCDFCLOB != null)
			{
				...
				for(int i = 0; i < l.Count; i++)
				{
					...
					data.IJOLPDKFLPO_OfferName = KDHGBOOECKC.HHCJCDFCLOB.GEGAJLNPMEC((BOPFPIHGJMD.MLBMHDCCGHI)l[i].GBJFNGCDKPM_Type, l[i].PPFNGGCBJKC_id);
					...
					data.FGHGMHPNEMG_Type = (BOPFPIHGJMD.MLBMHDCCGHI)l[i].GBJFNGCDKPM_Type;
					...
					KJODFBIBFFO(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, ref data, l[i].GBJFNGCDKPM_Type, l[i].PPFNGGCBJKC_id, _JHNMKKNEENE_Time);
					res.Add(data);
				}
	...
	public List<ANKPCIEKPAH> AANFIKBAJPI_GetValkyrieList()
	{
		...
		if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
		{
			if(IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database != null)
			{
				...
				{
					if(vList[i].FODKKJIDDKN_VfId > 0)
					{
						JPIANKEOOMB_Valkyrie.KJPIDJOMODA_ValkyrieInfo dbValk = IMMAOANGPNK.HHCJCDFCLOB.NKEBMCIMJND_Database.PEOALFEGNDH_Valkyrie.CDENCMNHNGA_table[vList[i].FODKKJIDDKN_VfId - 1];
						if(dbValk.PPEGAKEIEGM_Enabled == 2)
						{
							if(vList[i].FJODMPGPDDD_Unlocked)
							{
								if(vList[i].FODKKJIDDKN_VfId == dbValk.GPPEFLKGGGJ_ValkyrieId)
								{
									ANKPCIEKPAH data = new ANKPCIEKPAH();
									data.LLOBHDMHJIG_Id = vList[i].FODKKJIDDKN_VfId;
	...
	public int LHFJMGDOBEK(int _FODKKJIDDKN_VfId)
	{
		if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
		{
			for(int i = 0; i < CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.NEGDGHKOFFF_VFplatoon.Count; i++)
			{
				for(int j = 0; j < 3; j++)
				{
					if (CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.NEGDGHKOFFF_VFplatoon[i].LBCCCKNANMJ_GetValkyrieId(j) == _FODKKJIDDKN_VfId)
						return i + 1;
				}
			}
		}
	...
	public int NAEMOCCOGAA(int _PPFNGGCBJKC_id, int _FODKKJIDDKN_VfId)
	{
		if(_PPFNGGCBJKC_id > 0 && _PPFNGGCBJKC_id <= 5)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				...
				for (int j = 0; j < 3; j++)
				{
					if (d.LBCCCKNANMJ_GetValkyrieId(j) == _FODKKJIDDKN_VfId)
						return j;
				}
			}
		}
	...
	public bool JBHBEKJHLFE(int _PPFNGGCBJKC_id, int _ADPPAIPFHML_Num, int _FODKKJIDDKN_VfId)
	{
		if(_PPFNGGCBJKC_id > 0 && _PPFNGGCBJKC_id <= 5 && _FODKKJIDDKN_VfId > -1)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				int a = LHFJMGDOBEK(_FODKKJIDDKN_VfId);
				if(a > 0)
				{
					int a2 = NAEMOCCOGAA(a, _FODKKJIDDKN_VfId);
					CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.NEGDGHKOFFF_VFplatoon[a - 1].ODGFPJFJPFP(a2, 0);
				}
				return CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.NEGDGHKOFFF_VFplatoon[_PPFNGGCBJKC_id - 1].ODGFPJFJPFP(_ADPPAIPFHML_Num, _FODKKJIDDKN_VfId);
			}
		}
		return false;
	}
	...
	public bool JHBMCGABHMD(int _FODKKJIDDKN_VfId)
	{
		int a = LHFJMGDOBEK(_FODKKJIDDKN_VfId);
		if (a > 0)
		{
