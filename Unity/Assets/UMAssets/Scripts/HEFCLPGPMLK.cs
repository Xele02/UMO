...
public class HEFCLPGPMLK
{
	...
	public AAOPGOGGMID HHPEMLOLJIH()
	{
		...
		{
			//0x1747EE0
			return _GHPLINIACBB_x.PCCFAKEOBIC_EndDate;
		}).FirstOrDefault();
	}

	//// RVA: 0x17456B8 Offset: 0x17456B8 VA: 0x17456B8
	public List<AAOPGOGGMID> PDFOBMKIKKJ(BOPFPIHGJMD.MLBMHDCCGHI INDDJNMPONH, bool CILNIPJEECH/* = false*/, bool _GJAFIADJFHH_IsSortDesc/* = false*/)
	{
	...
	public void KJODFBIBFFO(BBHNACPENDM_ServerSaveData LDEGEHAEALK, ref AAOPGOGGMID IDLHJIOMJBK, int _FGHGMHPNEMG_Type, int MLDPDLPHJPM, long JHNMKKNEENE)
	{
		if(KDHGBOOECKC.HHCJCDFCLOB != null)
		{
			...
			OCMJNBIFJNM_Offer.JPOHOLBBFGP d = KDHGBOOECKC.HHCJCDFCLOB.BKJJKHIBIGP((BOPFPIHGJMD.MLBMHDCCGHI)_FGHGMHPNEMG_Type, MLDPDLPHJPM);
			if(d != null)
			{
				IDLHJIOMJBK.CMCKNKKCNDK_Status = (BOPFPIHGJMD.IGHPDAGKIKO) d.EALOBDHOCHP_Stat;
				IDLHJIOMJBK.KINJOEIAHFK_StartDate = d.DFJLNPFJGDK_StartDate;
				...
				IDLHJIOMJBK.MNPEAHNONAI_Cnt = d.BFINGCJHOHI_Count;
				IDLHJIOMJBK.CADENLBDAEB_IsNew = d.BFINGCJHOHI_Count == 0;
				...
				IDLHJIOMJBK.CADENLBDAEB_IsNew = false;
			}
		}
	}
		...
		if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
		{
			if(KDHGBOOECKC.HHCJCDFCLOB != null)
			{
				...
				for(int i = 0; i < l1.Count; i++)
				{
					...
					data.IJOLPDKFLPO_OfferName = KDHGBOOECKC.HHCJCDFCLOB.GEGAJLNPMEC((BOPFPIHGJMD.MLBMHDCCGHI)l1[i].GBJFNGCDKPM_Type, l1[i].PPFNGGCBJKC);
					...
					data.KINFGHHNFCF = l1[i].FCBJFKGDINH_Atk;
					data.NONBCCLGBAO = l1[i].NONBCCLGBAO_Hit;
					...
					KJODFBIBFFO(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, ref data, l1[i].GBJFNGCDKPM_Type, l1[i].PPFNGGCBJKC, JHNMKKNEENE);
					res.Add(data);
				}
		...
		if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
		{
			if(KDHGBOOECKC.HHCJCDFCLOB != null)
			{
				...
				for(int i = 0; i < l.Count; i++)
				{
					...
					data.IJOLPDKFLPO_OfferName = KDHGBOOECKC.HHCJCDFCLOB.GEGAJLNPMEC((BOPFPIHGJMD.MLBMHDCCGHI)l[i].GBJFNGCDKPM_Type, l[i].PPFNGGCBJKC);
					data.DFMOGBOPLEF_Series = KDHGBOOECKC.HHCJCDFCLOB.MDNPDBIPKLB((BOPFPIHGJMD.AHIOHONIGDH)l[i].CPKMLLNADLJ_Serie, 0);
					data.KINFGHHNFCF = l[i].FCBJFKGDINH_Atk;
					data.NONBCCLGBAO = l[i].NONBCCLGBAO_Hit;
					...
					KJODFBIBFFO(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, ref data, l[i].GBJFNGCDKPM_Type, l[i].PPFNGGCBJKC, JHNMKKNEENE);
					res.Add(data);
				}
			...
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				if(KDHGBOOECKC.HHCJCDFCLOB != null)
				{
					...
					for(int i = 0; i < l.Count; i++)
					{
						...
						data.AHHJLDLAPAN_DivaId = l[i].OCAMDLMPBGA;
						data.DFMOGBOPLEF_Series = KDHGBOOECKC.HHCJCDFCLOB.MDNPDBIPKLB((BOPFPIHGJMD.AHIOHONIGDH)l[i].CPKMLLNADLJ_Serie, 0);
						data.BIEGNEGKLDE_SpItemId = l[i].BBMBLOABEOK;
						for(int j = 0; j < l[i].AGMPIKBJPPB(); j++)
						{
	...
	public int NAEMOCCOGAA(int PPFNGGCBJKC, int _FODKKJIDDKN_VfId)
	{
		if(PPFNGGCBJKC > 0 && PPFNGGCBJKC <= 5)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				OCMJNBIFJNM_Offer.PMOECIDOLNA d = CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.NEGDGHKOFFF_VFplatoon[PPFNGGCBJKC - 1];
				for (int j = 0; j < 3; j++)
				{
	...
	public bool JBHBEKJHLFE(int PPFNGGCBJKC, int _ADPPAIPFHML_Num, int _FODKKJIDDKN_VfId)
	{
		if(PPFNGGCBJKC > 0 && PPFNGGCBJKC <= 5 && _FODKKJIDDKN_VfId > -1)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				...
				return CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.NEGDGHKOFFF_VFplatoon[PPFNGGCBJKC - 1].ODGFPJFJPFP(_ADPPAIPFHML_Num, _FODKKJIDDKN_VfId);
			}
		}
		return false;
	}
	...
	public bool PFEMFIICBCE(int PPFNGGCBJKC, string OPFGFINHFCE)
	{
		if(PPFNGGCBJKC > 0)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.NEGDGHKOFFF_VFplatoon[PPFNGGCBJKC - 1].OPFGFINHFCE_Name = OPFGFINHFCE;
			}
		}
		return false;
	}
	...
	{
		if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null && KDHGBOOECKC.HHCJCDFCLOB != null && OIOECMEEFKJ > 0)
		{
	...
	public List<int> LOEDABGEMFJ(int _CPKMLLNADLJ_Serie)
	{
		...
		for(int i = 0; i < MDNHCIKGEAE.Count; i++)
		{
			if((int)MDNHCIKGEAE[i].CPKMLLNADLJ_Serie == _CPKMLLNADLJ_Serie)
			{
	...
	public int LLMEKDNIOEF(BOPFPIHGJMD.MLBMHDCCGHI _FGHGMHPNEMG_Type, int MLDPDLPHJPM)
	{
		if(KDHGBOOECKC.HHCJCDFCLOB != null)
		{
			List<KDHGBOOECKC.NOCAJFGHDPC> l = KDHGBOOECKC.HHCJCDFCLOB.NBIJDMOOILH();
