...
public class HEFCLPGPMLK
{
	...
	public List<AAOPGOGGMID> OEMBGNHHONF(List<AAOPGOGGMID> NNDGIAEFMOG, bool DACKJBKIDOM = false)
	{
		...
		for(int i = 0; i < NNDGIAEFMOG.Count; i++)
		{
			...
			{
				case BOPFPIHGJMD.IGHPDAGKIKO.EBAPFCDNMGD_1:
					if (NNDGIAEFMOG[i].HBJEDMOMAEE == BOPFPIHGJMD.HDHDOOLPBEO.MOADAEHPFPA_3)
						l2.Add(NNDGIAEFMOG[i]);
					else if (NNDGIAEFMOG[i].HBJEDMOMAEE == BOPFPIHGJMD.HDHDOOLPBEO.LJJODKKOOFD_2)
						l1.Add(NNDGIAEFMOG[i]);
					else if (NNDGIAEFMOG[i].HBJEDMOMAEE == BOPFPIHGJMD.HDHDOOLPBEO.CCDOBDNDPIL_1)
						l3.Add(NNDGIAEFMOG[i]);
					else
						l4.Add(NNDGIAEFMOG[i]);
					break;
				case BOPFPIHGJMD.IGHPDAGKIKO.LGOIJAPMEBG_2:
					l5.Add(NNDGIAEFMOG[i]);
					break;
				case BOPFPIHGJMD.IGHPDAGKIKO.FJGFAPKLLCL_3:
					l6.Add(NNDGIAEFMOG[i]);
					break;
				case BOPFPIHGJMD.IGHPDAGKIKO.CADDNFIKDLG_4:
		...
		if(KDHGBOOECKC.HHCJCDFCLOB != null)
		{
			...
			if(d != null)
			{
				...
				if (d.DPMCPMJJGAA_HasFlag(BOPFPIHGJMD.CMBJEEGFODD.HIJBHIFABFC_32))
					IDLHJIOMJBK.HBJEDMOMAEE = BOPFPIHGJMD.HDHDOOLPBEO.MOADAEHPFPA_3;
				else if (d.DPMCPMJJGAA_HasFlag(BOPFPIHGJMD.CMBJEEGFODD.JPFLFLFFEDD_16))
					IDLHJIOMJBK.HBJEDMOMAEE = BOPFPIHGJMD.HDHDOOLPBEO.LJJODKKOOFD_2;
				else
				{
					IDLHJIOMJBK.HBJEDMOMAEE = d.DPMCPMJJGAA_HasFlag(BOPFPIHGJMD.CMBJEEGFODD.DPNBNKOOJHI_1) ? BOPFPIHGJMD.HDHDOOLPBEO.CCDOBDNDPIL_1 : BOPFPIHGJMD.HDHDOOLPBEO.HJNNKCMLGFL_0;
					return;
				}
		...
		if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_ServerSave != null)
		{
			if(KDHGBOOECKC.HHCJCDFCLOB != null)
			{
				...
				for(int i = 0; i < l1.Count; i++)
				{
					...
					data.IJOLPDKFLPO = KDHGBOOECKC.HHCJCDFCLOB.GEGAJLNPMEC((BOPFPIHGJMD.MLBMHDCCGHI)l1[i].GBJFNGCDKPM, l1[i].PPFNGGCBJKC);
					data.DFMOGBOPLEF = KDHGBOOECKC.HHCJCDFCLOB.MDNPDBIPKLB((BOPFPIHGJMD.AHIOHONIGDH)l1[i].CPKMLLNADLJ, l1[i].JBHBGOIMALD);
		...
		if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_ServerSave != null)
		{
			if(KDHGBOOECKC.HHCJCDFCLOB != null)
			{
				...
				for(int i = 0; i < l.Count; i++)
				{
					...
					data.IJOLPDKFLPO = KDHGBOOECKC.HHCJCDFCLOB.GEGAJLNPMEC((BOPFPIHGJMD.MLBMHDCCGHI)l[i].GBJFNGCDKPM, l[i].PPFNGGCBJKC);
					data.DFMOGBOPLEF = KDHGBOOECKC.HHCJCDFCLOB.MDNPDBIPKLB((BOPFPIHGJMD.AHIOHONIGDH)l[i].CPKMLLNADLJ, 0);
					data.KINFGHHNFCF = l[i].FCBJFKGDINH;
					data.NONBCCLGBAO = l[i].NONBCCLGBAO;
					data.FGHGMHPNEMG = (BOPFPIHGJMD.MLBMHDCCGHI)l[i].GBJFNGCDKPM;
					data.CGKPIIFCCLD = (BOPFPIHGJMD.ADMNKELOLPN)l[i].CECKOCLEABH;
					data.CIEOBFIIPLD = l[i].GOKJLBDJOLA;
					data.NBLBJCLIDNN = l[i].GOKJLBDJOLA;
					data.NBHEBLNHOJO = false;
					data.AHHJLDLAPAN = 0;
					data.BIEGNEGKLDE = l[i].BBMBLOABEOK;
					...
					data.KPFHAMNOIAG = 5;
					data.HBJEDMOMAEE = BOPFPIHGJMD.HDHDOOLPBEO.HJNNKCMLGFL_0;
					data.IMPNNOLLMBK = (int)data.JGAMLEMMJCJ;
			...
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_ServerSave != null)
			{
				if(KDHGBOOECKC.HHCJCDFCLOB != null)
				{
					...
					for(int i = 0; i < l.Count; i++)
					{
						...
						data.CGKPIIFCCLD = (BOPFPIHGJMD.ADMNKELOLPN)l[i].CECKOCLEABH;
						data.CIEOBFIIPLD = l[i].GOKJLBDJOLA;
						data.NBLBJCLIDNN = KDHGBOOECKC.HHCJCDFCLOB.HFLNFKFGEJH(l[i].OCAMDLMPBGA);
						data.NBHEBLNHOJO = data.NBLBJCLIDNN <= data.CIEOBFIIPLD;
