...
public class HEFCLPGPMLK
{
		...
		if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
		{
			if(KDHGBOOECKC.HHCJCDFCLOB != null)
			{
				...
				for(int i = 0; i < l1.Count; i++)
				{
					...
					KJODFBIBFFO(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, ref data, l1[i].GBJFNGCDKPM, l1[i].PPFNGGCBJKC, JHNMKKNEENE);
					res.Add(data);
				}
		...
		if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
		{
			if(KDHGBOOECKC.HHCJCDFCLOB != null)
			{
				...
				for(int i = 0; i < l.Count; i++)
				{
					...
					KJODFBIBFFO(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData, ref data, l[i].GBJFNGCDKPM, l[i].PPFNGGCBJKC, JHNMKKNEENE);
					res.Add(data);
				}
						...
						if(dbValk.PPEGAKEIEGM_Enabled == 2)
						{
							if(vList[i].FJODMPGPDDD)
							{
								if(vList[i].FODKKJIDDKN_Id == dbValk.GPPEFLKGGGJ_Id)
								{
									...
									data.CPKMLLNADLJ_Attr = (SeriesAttr.Type)dbValk.AIHCEGFANAM_SerieAttr;
	...
	public int LHFJMGDOBEK(int FODKKJIDDKN)
	{
		if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
		{
			for(int i = 0; i < CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.NEGDGHKOFFF_VFplatoon.Count; i++)
			{
				for(int j = 0; j < 3; j++)
				{
					if (CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.NEGDGHKOFFF_VFplatoon[i].LBCCCKNANMJ_GetValkyrieId(j) == FODKKJIDDKN)
						return i + 1;
				}
			}
		}
	...
	public bool JBHBEKJHLFE(int PPFNGGCBJKC, int _ADPPAIPFHML_Num, int FODKKJIDDKN)
	{
		if(PPFNGGCBJKC > 0 && PPFNGGCBJKC <= 5 && FODKKJIDDKN > -1)
		{
			if(CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData != null)
			{
				...
				return CIOECGOMILE.HHCJCDFCLOB.AHEFHIMGIBI_PlayerData.DAEJHMCMFJD_Offer.NEGDGHKOFFF_VFplatoon[PPFNGGCBJKC - 1].ODGFPJFJPFP(_ADPPAIPFHML_Num, FODKKJIDDKN);
			}
		}
		return false;
	}
