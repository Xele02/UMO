Shader "Unlit/RBreakPlateShader" {
	Properties {
...
/*
			GpuProgramID 1514
			Program "vp" {
				SubProgram "gles hw_tier02 " { 			Keywords { "_BACK1TEX_POLAR" "_BACK2TEX_POLAR" "_DISTOTIONTEX_SCROLL" "_FRONT1TEX_POLAR" "_FRONT2TEX_ROTATE" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlat16_2.xy = u_xlat16_17.xy * vec2(0.0208350997, 0.0208350997) + vec2(-0.0851330012, -0.0851330012);
					    u_xlat16_2.xy = u_xlat16_17.xy * u_xlat16_2.xy + vec2(0.180141002, 0.180141002);
					    u_xlat16_2.xy = u_xlat16_17.xy * u_xlat16_2.xy + vec2(-0.330299497, -0.330299497);
					    u_xlat16_2.xy = u_xlat16_17.xy * u_xlat16_2.xy + vec2(0.999866009, 0.999866009);
					    u_xlat16_18.xy = u_xlat16_1.xy * u_xlat16_2.xy;
					    u_xlat18.xy = u_xlat16_18.xy * vec2(-2.0, -2.0) + vec2(1.57079637, 1.57079637);
					    u_xlatb3.xy = lessThan(abs(u_xlat16_0.ywyy), abs(u_xlat16_0.xzxx)).xy;
					    u_xlat18.xy = mix(vec2(0.0, 0.0), u_xlat18.xy, vec2(u_xlatb3.xy));
					    u_xlat2.xy = u_xlat16_1.xy * u_xlat16_2.xy + u_xlat18.xy;
					    u_xlatb18.xy = lessThan(u_xlat16_0.ywyw, (-u_xlat16_0.ywyw)).xy;
					    u_xlat18.xy = mix(vec2(0.0, 0.0), vec2(-3.14159274, -3.14159274), vec2(u_xlatb18.xy));
					    u_xlat2.xy = u_xlat18.xy + u_xlat2.xy;
					    u_xlat16_1.xy = min(u_xlat16_0.yw, u_xlat16_0.xz);
					    u_xlatb18.xy = lessThan(u_xlat16_1.xyxy, (-u_xlat16_1.xyxy)).xy;
					    u_xlat16_1.xy = max(u_xlat16_0.yw, u_xlat16_0.xz);
					    u_xlatb3.xy = greaterThanEqual(u_xlat16_1.xyxx, (-u_xlat16_1.xyxx)).xy;
					    u_xlati18.xy = op_and((ivec2(u_xlatb18.xy) * -1), (ivec2(u_xlatb3.xy) * -1));
					    {
					    ...
					    u_xlat16_8.xy = u_xlat16_4.xy * vec2(vec2(_Back2TexDistotion, _Back2TexDistotion)) + u_xlat1.yw;
					    u_xlat10_10.xyz = texture2D(_Back2Tex, u_xlat16_8.xy).xyz;
					    ...
					    u_xlat16_20.xy = vs_TEXCOORD1.yx * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
					    u_xlat16_24 = max(abs(u_xlat16_20.y), abs(u_xlat16_20.x));
					    u_xlat16_24 = float(1.0) / u_xlat16_24;
					    u_xlat16_7 = min(abs(u_xlat16_20.y), abs(u_xlat16_20.x));
					    u_xlat16_24 = u_xlat16_24 * u_xlat16_7;
					    u_xlat16_7 = u_xlat16_24 * u_xlat16_24;
					    u_xlat16_10.x = u_xlat16_7 * 0.0208350997 + -0.0851330012;
					    u_xlat16_10.x = u_xlat16_7 * u_xlat16_10.x + 0.180141002;
					    u_xlat16_10.x = u_xlat16_7 * u_xlat16_10.x + -0.330299497;
					    u_xlat16_10.x = u_xlat16_7 * u_xlat16_10.x + 0.999866009;
					    u_xlat16_18.x = u_xlat16_24 * u_xlat16_10.x;
					    u_xlat18.x = u_xlat16_18.x * -2.0 + 1.57079637;
					    u_xlatb26 = abs(u_xlat16_20.y)<abs(u_xlat16_20.x);
					    u_xlat18.x = u_xlatb26 ? u_xlat18.x : float(0.0);
					    u_xlat10 = u_xlat16_24 * u_xlat16_10.x + u_xlat18.x;
					    u_xlatb18.x = u_xlat16_20.y<(-u_xlat16_20.y);
					    u_xlat18.x = u_xlatb18.x ? -3.14159274 : float(0.0);
					    u_xlat10 = u_xlat18.x + u_xlat10;
					    u_xlat16_24 = min(u_xlat16_20.y, u_xlat16_20.x);
					    u_xlatb18.x = u_xlat16_24<(-u_xlat16_24);
					    u_xlat16_24 = max(u_xlat16_20.y, u_xlat16_20.x);
					    u_xlat16_20.x = dot(u_xlat16_20.xy, u_xlat16_20.xy);
					    u_xlat16_20.x = sqrt(u_xlat16_20.x);
					    u_xlat16_20.x = (-u_xlat16_20.x) + 1.0;
					    u_xlat5.y = _Front1TexAnimeSpeed * u_xlat2.x + u_xlat16_20.x;
					    u_xlatb26 = u_xlat16_24>=(-u_xlat16_24);
					    u_xlatb18.x = u_xlatb26 && u_xlatb18.x;
					    u_xlat10 = (u_xlatb18.x) ? (-u_xlat10) : u_xlat10;
					    u_xlat16_24 = u_xlat10 * 0.159154937 + 0.75;
					    u_xlat5.x = _Front1TexAnimeSpeed2 * u_xlat2.x + u_xlat16_24;
					    u_xlat16_20.xy = u_xlat16_4.xy * vec2(vec2(_Front1TexDistotion, _Front1TexDistotion)) + u_xlat5.xy;
					    ...
					    u_xlat10_11.xyz = texture2D(_Front1Tex, u_xlat16_20.xy).xyz;
				...
				SubProgram "gles hw_tier02 " {  		Keywords { "_BACK1TEX_POLAR" "_BACK2TEX_POLAR" "_FRONT1TEX_POLAR" "_FRONT2TEX_ROTATE" "_DISTOTIONTEX_POLAR" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlat18.x = u_xlatb26 ? u_xlat18.x : float(0.0);
					    u_xlat10 = u_xlat16_20.x * u_xlat16_10.x + u_xlat18.x;
					    ...
					    u_xlatb18.x = u_xlatb26 && u_xlatb18.x;
					    u_xlat10 = (u_xlatb18.x) ? (-u_xlat10) : u_xlat10;
					    u_xlat16_4.x = u_xlat10 * 0.159154937 + 0.75;
					    u_xlat3.x = _DistotionTexAnimeSpeed2 * u_xlat2.x + u_xlat16_4.x;
					    u_xlat10_10.xy = texture2D(_DistotionTex, u_xlat3.xy).xy;
					    u_xlat16_10.xy = u_xlat10_10.xy + vec2(-0.5, -0.5);
					    u_xlat16_10.xy = u_xlat16_10.xy * vec2(vec2(_DistotionTexPower, _DistotionTexPower));
					    u_xlat10_3.xyz = texture2D(_MaskTex, vs_TEXCOORD0.xy).xyz;
					    u_xlat16_4.xy = u_xlat16_10.xy * u_xlat10_3.zz;
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK2TEX_POLAR" "_FRONT1TEX_POLAR" "_FRONT2TEX_ROTATE" "_BACK1TEX_ROTATE" "_DISTOTIONTEX_POLAR" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlat16_14 = max(abs(u_xlat16_0.y), abs(u_xlat16_0.x));
					    u_xlat16_14 = float(1.0) / u_xlat16_14;
					    u_xlat16_21 = min(abs(u_xlat16_0.y), abs(u_xlat16_0.x));
					    u_xlat16_14 = u_xlat16_14 * u_xlat16_21;
					    u_xlat16_21 = u_xlat16_14 * u_xlat16_14;
					    u_xlat16_1.x = u_xlat16_21 * 0.0208350997 + -0.0851330012;
					    u_xlat16_1.x = u_xlat16_21 * u_xlat16_1.x + 0.180141002;
					    u_xlat16_1.x = u_xlat16_21 * u_xlat16_1.x + -0.330299497;
					    u_xlat16_1.x = u_xlat16_21 * u_xlat16_1.x + 0.999866009;
					    u_xlat16_8.x = u_xlat16_14 * u_xlat16_1.x;
					    u_xlat8 = u_xlat16_8.x * -2.0 + 1.57079637;
					    u_xlatb15 = abs(u_xlat16_0.y)<abs(u_xlat16_0.x);
					    u_xlat8 = u_xlatb15 ? u_xlat8 : float(0.0);
					    u_xlat1 = u_xlat16_14 * u_xlat16_1.x + u_xlat8;
					    u_xlatb8 = u_xlat16_0.y<(-u_xlat16_0.y);
					    u_xlat8 = u_xlatb8 ? -3.14159274 : float(0.0);
					    u_xlat1 = u_xlat8 + u_xlat1;
					    u_xlat16_14 = min(u_xlat16_0.y, u_xlat16_0.x);
					    u_xlatb8 = u_xlat16_14<(-u_xlat16_14);
					    u_xlat16_14 = max(u_xlat16_0.y, u_xlat16_0.x);
					    u_xlat16_0.x = dot(u_xlat16_0.xy, u_xlat16_0.xy);
					    u_xlat16_0.x = sqrt(u_xlat16_0.x);
					    u_xlatb15 = u_xlat16_14>=(-u_xlat16_14);
					    u_xlatb8 = u_xlatb15 && u_xlatb8;
					    u_xlat1 = (u_xlatb8) ? (-u_xlat1) : u_xlat1;
					    u_xlat16_7.x = u_xlat1 * 0.159154937 + 0.75;
					    u_xlat1 = fract(_Time.x);
					    u_xlat2.x = _Back2TexAnimeSpeed2 * u_xlat1 + u_xlat16_7.x;
					    u_xlat16_7.xy = vs_TEXCOORD3.yx * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
					    u_xlat16_21 = max(abs(u_xlat16_7.y), abs(u_xlat16_7.x));
					    u_xlat16_21 = float(1.0) / u_xlat16_21;
					    u_xlat16_3.x = min(abs(u_xlat16_7.y), abs(u_xlat16_7.x));
					    u_xlat16_21 = u_xlat16_21 * u_xlat16_3.x;
					    u_xlat16_3.x = u_xlat16_21 * u_xlat16_21;
					    u_xlat16_8.x = u_xlat16_3.x * 0.0208350997 + -0.0851330012;
					    u_xlat16_8.x = u_xlat16_3.x * u_xlat16_8.x + 0.180141002;
					    u_xlat16_8.x = u_xlat16_3.x * u_xlat16_8.x + -0.330299497;
					    u_xlat16_8.x = u_xlat16_3.x * u_xlat16_8.x + 0.999866009;
					    u_xlat16_15 = u_xlat16_21 * u_xlat16_8.x;
					    u_xlat15 = u_xlat16_15 * -2.0 + 1.57079637;
					    u_xlatb22 = abs(u_xlat16_7.y)<abs(u_xlat16_7.x);
					    u_xlat15 = u_xlatb22 ? u_xlat15 : float(0.0);
					    u_xlat8 = u_xlat16_21 * u_xlat16_8.x + u_xlat15;
					    u_xlatb15 = u_xlat16_7.y<(-u_xlat16_7.y);
					    u_xlat15 = u_xlatb15 ? -3.14159274 : float(0.0);
					    u_xlat8 = u_xlat15 + u_xlat8;
					    u_xlat16_21 = min(u_xlat16_7.y, u_xlat16_7.x);
					    u_xlatb15 = u_xlat16_21<(-u_xlat16_21);
					    u_xlat16_21 = max(u_xlat16_7.y, u_xlat16_7.x);
					    u_xlat16_7.x = dot(u_xlat16_7.xy, u_xlat16_7.xy);
					    u_xlat16_0.y = sqrt(u_xlat16_7.x);
					    u_xlat16_0.xy = (-u_xlat16_0.xy) + vec2(1.0, 1.0);
					    u_xlat4.y = _DistotionTexAnimeSpeed * u_xlat1 + u_xlat16_0.y;
					    u_xlatb22 = u_xlat16_21>=(-u_xlat16_21);
					    u_xlatb15 = u_xlatb22 && u_xlatb15;
					    u_xlat8 = (u_xlatb15) ? (-u_xlat8) : u_xlat8;
					    u_xlat16_7.x = u_xlat8 * 0.159154937 + 0.75;
					    u_xlat4.x = _DistotionTexAnimeSpeed2 * u_xlat1 + u_xlat16_7.x;
					    u_xlat10_8.xy = texture2D(_DistotionTex, u_xlat4.xy).xy;
					    u_xlat16_8.xy = u_xlat10_8.xy + vec2(-0.5, -0.5);
					    u_xlat16_8.xy = u_xlat16_8.xy * vec2(vec2(_DistotionTexPower, _DistotionTexPower));
					    u_xlat10_4.xyz = texture2D(_MaskTex, vs_TEXCOORD0.xy).xyz;
					    u_xlat16_7.xy = u_xlat16_8.xy * u_xlat10_4.zz;
					    u_xlat2.y = _Back2TexAnimeSpeed * u_xlat1 + u_xlat16_0.x;
					    u_xlat16_0.xw = u_xlat16_7.xy * vec2(vec2(_Back2TexDistotion, _Back2TexDistotion)) + u_xlat2.xy;
					    u_xlat10_8.xyz = texture2D(_Back2Tex, u_xlat16_0.xw).xyz;
					    u_xlat16_8.xyz = u_xlat10_8.xyz * _Back2TexColor.xyz;
					    u_xlat16_0.xw = u_xlat16_7.xy * vec2(vec2(_Back1TexDistotion, _Back1TexDistotion)) + vs_TEXCOORD2.xy;
					    u_xlat10_2.xyz = texture2D(_Back1Tex, u_xlat16_0.xw).xyz;
					    u_xlat16_2.xyz = u_xlat10_2.xyz * _Back1TexColor.xyz;
					    u_xlat16_0.xw = u_xlat16_7.xy * vec2(vec2(_MainTexDistotion, _MainTexDistotion)) + vs_TEXCOORD0.xy;
					    u_xlat10_5.xyz = texture2D(_MainTex, u_xlat16_0.xw).xyz;
					    u_xlat16_3.xyz = u_xlat16_2.xyz * u_xlat10_4.yyy + u_xlat10_5.xyz;
					    u_xlat16_3.xyz = u_xlat16_8.xyz * u_xlat10_4.yyy + u_xlat16_3.xyz;
					    u_xlat16_0.xw = vs_TEXCOORD1.yx * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
					    u_xlat16_24 = max(abs(u_xlat16_0.w), abs(u_xlat16_0.x));
					    u_xlat16_24 = float(1.0) / u_xlat16_24;
					    u_xlat16_6 = min(abs(u_xlat16_0.w), abs(u_xlat16_0.x));
					    u_xlat16_24 = u_xlat16_24 * u_xlat16_6;
					    u_xlat16_6 = u_xlat16_24 * u_xlat16_24;
					    u_xlat16_8.x = u_xlat16_6 * 0.0208350997 + -0.0851330012;
					    u_xlat16_8.x = u_xlat16_6 * u_xlat16_8.x + 0.180141002;
					    u_xlat16_8.x = u_xlat16_6 * u_xlat16_8.x + -0.330299497;
					    u_xlat16_8.x = u_xlat16_6 * u_xlat16_8.x + 0.999866009;
					    u_xlat16_15 = u_xlat16_8.x * u_xlat16_24;
					    u_xlat15 = u_xlat16_15 * -2.0 + 1.57079637;
					    u_xlatb22 = abs(u_xlat16_0.w)<abs(u_xlat16_0.x);
					    u_xlat15 = u_xlatb22 ? u_xlat15 : float(0.0);
					    u_xlat8 = u_xlat16_24 * u_xlat16_8.x + u_xlat15;
					    u_xlatb15 = u_xlat16_0.w<(-u_xlat16_0.w);
					    u_xlat15 = u_xlatb15 ? -3.14159274 : float(0.0);
					    u_xlat8 = u_xlat15 + u_xlat8;
					    u_xlat16_24 = min(u_xlat16_0.w, u_xlat16_0.x);
					    u_xlatb15 = u_xlat16_24<(-u_xlat16_24);
					    u_xlat16_24 = max(u_xlat16_0.w, u_xlat16_0.x);
					    u_xlat16_0.x = dot(u_xlat16_0.xw, u_xlat16_0.xw);
					    u_xlat16_0.x = sqrt(u_xlat16_0.x);
					    u_xlat16_0.x = (-u_xlat16_0.x) + 1.0;
					    u_xlat2.y = _Front1TexAnimeSpeed * u_xlat1 + u_xlat16_0.x;
					    u_xlatb22 = u_xlat16_24>=(-u_xlat16_24);
					    u_xlatb15 = u_xlatb22 && u_xlatb15;
					    u_xlat8 = (u_xlatb15) ? (-u_xlat8) : u_xlat8;
					    u_xlat16_0.x = u_xlat8 * 0.159154937 + 0.75;
					    u_xlat2.x = _Front1TexAnimeSpeed2 * u_xlat1 + u_xlat16_0.x;
					    u_xlat16_0.xw = u_xlat16_7.xy * vec2(vec2(_Front1TexDistotion, _Front1TexDistotion)) + u_xlat2.xy;
					    u_xlat16_7.xy = u_xlat16_7.xy * vec2(_Front2TexDistotion) + vs_TEXCOORD1.zw;
					    u_xlat10_1.xyz = texture2D(_Front2Tex, u_xlat16_7.xy).xyz;
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK1TEX_POLAR" "_BACK2TEX_POLAR" "_DISTOTIONTEX_SCROLL" "_FRONT2TEX_ROTATE" "_FRONT1TEX_ROTATE" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlat16_1.xy = max(abs(u_xlat16_0.yw), abs(u_xlat16_0.xz));
					    u_xlat16_1.xy = vec2(1.0, 1.0) / u_xlat16_1.xy;
					    u_xlat16_15.xy = min(abs(u_xlat16_0.yw), abs(u_xlat16_0.xz));
					    u_xlat16_1.xy = u_xlat16_1.xy * u_xlat16_15.xy;
					    u_xlat16_15.xy = u_xlat16_1.xy * u_xlat16_1.xy;
					    u_xlat16_2.xy = u_xlat16_15.xy * vec2(0.0208350997, 0.0208350997) + vec2(-0.0851330012, -0.0851330012);
					    u_xlat16_2.xy = u_xlat16_15.xy * u_xlat16_2.xy + vec2(0.180141002, 0.180141002);
					    u_xlat16_2.xy = u_xlat16_15.xy * u_xlat16_2.xy + vec2(-0.330299497, -0.330299497);
					    u_xlat16_2.xy = u_xlat16_15.xy * u_xlat16_2.xy + vec2(0.999866009, 0.999866009);
					    u_xlat16_16.xy = u_xlat16_1.xy * u_xlat16_2.xy;
					    u_xlat16.xy = u_xlat16_16.xy * vec2(-2.0, -2.0) + vec2(1.57079637, 1.57079637);
					    u_xlatb3.xy = lessThan(abs(u_xlat16_0.ywyy), abs(u_xlat16_0.xzxx)).xy;
					    u_xlat16.xy = mix(vec2(0.0, 0.0), u_xlat16.xy, vec2(u_xlatb3.xy));
					    u_xlat2.xy = u_xlat16_1.xy * u_xlat16_2.xy + u_xlat16.xy;
					    u_xlatb16.xy = lessThan(u_xlat16_0.ywyw, (-u_xlat16_0.ywyw)).xy;
					    u_xlat16.xy = mix(vec2(0.0, 0.0), vec2(-3.14159274, -3.14159274), vec2(u_xlatb16.xy));
					    u_xlat2.xy = u_xlat16.xy + u_xlat2.xy;
					    u_xlat16_1.xy = min(u_xlat16_0.yw, u_xlat16_0.xz);
					    u_xlatb16.xy = lessThan(u_xlat16_1.xyxy, (-u_xlat16_1.xyxy)).xy;
					    u_xlat16_1.xy = max(u_xlat16_0.yw, u_xlat16_0.xz);
					    u_xlatb3.xy = greaterThanEqual(u_xlat16_1.xyxx, (-u_xlat16_1.xyxx)).xy;
					    u_xlati16.xy = op_and((ivec2(u_xlatb16.xy) * -1), (ivec2(u_xlatb3.xy) * -1));
					    {
					        vec2 hlslcc_movcTemp = u_xlat2;
					        hlslcc_movcTemp.x = (u_xlati16.x != 0) ? (-u_xlat2.x) : u_xlat2.x;
					        hlslcc_movcTemp.y = (u_xlati16.y != 0) ? (-u_xlat2.y) : u_xlat2.y;
					        u_xlat2 = hlslcc_movcTemp;
					    }
					    u_xlat16_1.xy = u_xlat2.xy * vec2(0.159154937, 0.159154937) + vec2(0.75, 0.75);
					    u_xlat2.x = fract(_Time.x);
					    ...
					    u_xlat16_14.xy = u_xlat16_0.xy * vec2(vec2(_Back1TexDistotion, _Back1TexDistotion)) + u_xlat1.xz;
					    ...
					    u_xlat10_5.xyz = texture2D(_Back1Tex, u_xlat16_14.xy).xyz;
					    u_xlat16_5.xyz = u_xlat10_5.xyz * _Back1TexColor.xyz;
					    u_xlat16_14.xy = u_xlat16_0.xy * vec2(vec2(_MainTexDistotion, _MainTexDistotion)) + vs_TEXCOORD0.xy;
					    ...
					    u_xlat16_14.xy = u_xlat16_0.xy * vec2(vec2(_Front1TexDistotion, _Front1TexDistotion)) + vs_TEXCOORD1.xy;
					    ...
					    u_xlat16_2.xyz = u_xlat10_2.xyz * _Front2TexColor.xyz;
					    u_xlat10_10.xyz = texture2D(_Front1Tex, u_xlat16_14.xy).xyz;
					    u_xlat16_10.xyz = u_xlat10_10.xyz * _Front1TexColor.xyz;
					    u_xlat16_0.xyz = u_xlat16_10.xyz * u_xlat10_3.xxx + u_xlat16_4.xyz;
					    u_xlat16_0.xyz = u_xlat16_2.xyz * u_xlat10_3.xxx + u_xlat16_0.xyz;
					    SV_Target0.xyz = u_xlat16_0.xyz * vs_COLOR0.xyz;
					    SV_Target0.w = vs_COLOR0.w;
					    return;
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK1TEX_POLAR" "_BACK2TEX_POLAR" "_FRONT2TEX_ROTATE" "_DISTOTIONTEX_POLAR" "_FRONT1TEX_ROTATE" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlat1.xy = vec2(_Back1TexAnimeSpeed2, _Back2TexAnimeSpeed2) * u_xlat2.xx + u_xlat16_1.xy;
					    u_xlat16_4.xy = vs_TEXCOORD3.yx * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
					    u_xlat16_18.x = max(abs(u_xlat16_4.y), abs(u_xlat16_4.x));
					    u_xlat16_18.x = float(1.0) / u_xlat16_18.x;
					    u_xlat16_25 = min(abs(u_xlat16_4.y), abs(u_xlat16_4.x));
					    u_xlat16_18.x = u_xlat16_18.x * u_xlat16_25;
					    u_xlat16_25 = u_xlat16_18.x * u_xlat16_18.x;
					    u_xlat16_9.x = u_xlat16_25 * 0.0208350997 + -0.0851330012;
					    u_xlat16_9.x = u_xlat16_25 * u_xlat16_9.x + 0.180141002;
					    u_xlat16_9.x = u_xlat16_25 * u_xlat16_9.x + -0.330299497;
					    u_xlat16_9.x = u_xlat16_25 * u_xlat16_9.x + 0.999866009;
					    u_xlat16_16.x = u_xlat16_9.x * u_xlat16_18.x;
					    u_xlat16.x = u_xlat16_16.x * -2.0 + 1.57079637;
					    u_xlatb23 = abs(u_xlat16_4.y)<abs(u_xlat16_4.x);
					    u_xlat16.x = u_xlatb23 ? u_xlat16.x : float(0.0);
					    u_xlat9 = u_xlat16_18.x * u_xlat16_9.x + u_xlat16.x;
					    u_xlatb16.x = u_xlat16_4.y<(-u_xlat16_4.y);
					    u_xlat16.x = u_xlatb16.x ? -3.14159274 : float(0.0);
					    u_xlat9 = u_xlat16.x + u_xlat9;
					    u_xlat16_18.x = min(u_xlat16_4.y, u_xlat16_4.x);
					    u_xlatb16.x = u_xlat16_18.x<(-u_xlat16_18.x);
					    u_xlat16_18.x = max(u_xlat16_4.y, u_xlat16_4.x);
					    u_xlat16_4.x = dot(u_xlat16_4.xy, u_xlat16_4.xy);
					    u_xlat16_4.x = sqrt(u_xlat16_4.x);
					    u_xlat16_4.x = (-u_xlat16_4.x) + 1.0;
					    u_xlat3.y = _DistotionTexAnimeSpeed * u_xlat2.x + u_xlat16_4.x;
					    u_xlatb23 = u_xlat16_18.x>=(-u_xlat16_18.x);
					    u_xlatb16.x = u_xlatb23 && u_xlatb16.x;
					    u_xlat9 = (u_xlatb16.x) ? (-u_xlat9) : u_xlat9;
					    u_xlat16_4.x = u_xlat9 * 0.159154937 + 0.75;
					    u_xlat3.x = _DistotionTexAnimeSpeed2 * u_xlat2.x + u_xlat16_4.x;
					    u_xlat10_9.xy = texture2D(_DistotionTex, u_xlat3.xy).xy;
					    u_xlat16_9.xy = u_xlat10_9.xy + vec2(-0.5, -0.5);
					    u_xlat16_9.xy = u_xlat16_9.xy * vec2(vec2(_DistotionTexPower, _DistotionTexPower));
					    u_xlat10_3.xyz = texture2D(_MaskTex, vs_TEXCOORD0.xy).xyz;
					    u_xlat16_4.xy = u_xlat16_9.xy * u_xlat10_3.zz;
					    u_xlat16_0.x = dot(u_xlat16_0.xy, u_xlat16_0.xy);
					    u_xlat16_0.y = dot(u_xlat16_0.zw, u_xlat16_0.zw);
					    u_xlat16_0.xy = sqrt(u_xlat16_0.xy);
					    u_xlat16_0.xy = (-u_xlat16_0.xy) + vec2(1.0, 1.0);
					    u_xlat1.w = _Back2TexAnimeSpeed * u_xlat2.x + u_xlat16_0.y;
					    u_xlat16_7.xy = u_xlat16_4.xy * vec2(vec2(_Back2TexDistotion, _Back2TexDistotion)) + u_xlat1.yw;
					    u_xlat10_9.xyz = texture2D(_Back2Tex, u_xlat16_7.xy).xyz;
					    ...
					    u_xlat10_6.xyz = texture2D(_MainTex, u_xlat16_0.xy).xyz;
					    u_xlat16_0.xyz = u_xlat16_5.xyz * u_xlat10_3.yyy + u_xlat10_6.xyz;
					    u_xlat16_0.xyz = u_xlat16_9.xyz * u_xlat10_3.yyy + u_xlat16_0.xyz;
					    u_xlat16_18.xy = u_xlat16_4.xy * vec2(vec2(_Front1TexDistotion, _Front1TexDistotion)) + vs_TEXCOORD1.xy;
					    u_xlat16_4.xy = u_xlat16_4.xy * vec2(_Front2TexDistotion) + vs_TEXCOORD1.zw;
					    u_xlat10_2.xyz = texture2D(_Front2Tex, u_xlat16_4.xy).xyz;
					    u_xlat16_2.xyz = u_xlat10_2.xyz * _Front2TexColor.xyz;
					    u_xlat10_10.xyz = texture2D(_Front1Tex, u_xlat16_18.xy).xyz;
					    u_xlat16_10.xyz = u_xlat10_10.xyz * _Front1TexColor.xyz;
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK2TEX_POLAR" "_FRONT2TEX_ROTATE" "_BACK1TEX_ROTATE" "_DISTOTIONTEX_POLAR" "_FRONT1TEX_ROTATE" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					{
					    u_xlat16_0.xy = vs_TEXCOORD2.wz * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
					    u_xlat16_12.x = max(abs(u_xlat16_0.y), abs(u_xlat16_0.x));
					    u_xlat16_12.x = float(1.0) / u_xlat16_12.x;
					    u_xlat16_18 = min(abs(u_xlat16_0.y), abs(u_xlat16_0.x));
					    u_xlat16_12.x = u_xlat16_12.x * u_xlat16_18;
					    u_xlat16_18 = u_xlat16_12.x * u_xlat16_12.x;
					    u_xlat16_1.x = u_xlat16_18 * 0.0208350997 + -0.0851330012;
					    u_xlat16_1.x = u_xlat16_18 * u_xlat16_1.x + 0.180141002;
					    u_xlat16_1.x = u_xlat16_18 * u_xlat16_1.x + -0.330299497;
					    u_xlat16_1.x = u_xlat16_18 * u_xlat16_1.x + 0.999866009;
					    u_xlat16_7 = u_xlat16_12.x * u_xlat16_1.x;
					    u_xlat7 = u_xlat16_7 * -2.0 + 1.57079637;
					    u_xlatb13 = abs(u_xlat16_0.y)<abs(u_xlat16_0.x);
					    u_xlat7 = u_xlatb13 ? u_xlat7 : float(0.0);
					    u_xlat1 = u_xlat16_12.x * u_xlat16_1.x + u_xlat7;
					    u_xlatb7 = u_xlat16_0.y<(-u_xlat16_0.y);
					    u_xlat7 = u_xlatb7 ? -3.14159274 : float(0.0);
					    u_xlat1 = u_xlat7 + u_xlat1;
					    u_xlat16_12.x = min(u_xlat16_0.y, u_xlat16_0.x);
					    u_xlatb7 = u_xlat16_12.x<(-u_xlat16_12.x);
					    u_xlat16_12.x = max(u_xlat16_0.y, u_xlat16_0.x);
					    u_xlat16_0.x = dot(u_xlat16_0.xy, u_xlat16_0.xy);
					    u_xlat16_0.x = sqrt(u_xlat16_0.x);
					    u_xlatb13 = u_xlat16_12.x>=(-u_xlat16_12.x);
					    u_xlatb7 = u_xlatb13 && u_xlatb7;
					    u_xlat1 = (u_xlatb7) ? (-u_xlat1) : u_xlat1;
					    u_xlat16_6.x = u_xlat1 * 0.159154937 + 0.75;
					    u_xlat1 = fract(_Time.x);
					    u_xlat2.x = _Back2TexAnimeSpeed2 * u_xlat1 + u_xlat16_6.x;
					    u_xlat16_6.xy = vs_TEXCOORD3.yx * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
					    u_xlat16_18 = max(abs(u_xlat16_6.y), abs(u_xlat16_6.x));
					    u_xlat16_18 = float(1.0) / u_xlat16_18;
					    u_xlat16_3.x = min(abs(u_xlat16_6.y), abs(u_xlat16_6.x));
					    u_xlat16_18 = u_xlat16_18 * u_xlat16_3.x;
					    u_xlat16_3.x = u_xlat16_18 * u_xlat16_18;
					    u_xlat16_7 = u_xlat16_3.x * 0.0208350997 + -0.0851330012;
					    u_xlat16_7 = u_xlat16_3.x * u_xlat16_7 + 0.180141002;
					    u_xlat16_7 = u_xlat16_3.x * u_xlat16_7 + -0.330299497;
					    u_xlat16_7 = u_xlat16_3.x * u_xlat16_7 + 0.999866009;
					    u_xlat16_13 = u_xlat16_18 * u_xlat16_7;
					    u_xlat13 = u_xlat16_13 * -2.0 + 1.57079637;
					    u_xlatb19 = abs(u_xlat16_6.y)<abs(u_xlat16_6.x);
					    u_xlat13 = u_xlatb19 ? u_xlat13 : float(0.0);
					    u_xlat7 = u_xlat16_18 * u_xlat16_7 + u_xlat13;
					    u_xlatb13 = u_xlat16_6.y<(-u_xlat16_6.y);
					    u_xlat13 = u_xlatb13 ? -3.14159274 : float(0.0);
					    u_xlat7 = u_xlat13 + u_xlat7;
					    u_xlat16_18 = min(u_xlat16_6.y, u_xlat16_6.x);
					    u_xlatb13 = u_xlat16_18<(-u_xlat16_18);
					    u_xlat16_18 = max(u_xlat16_6.y, u_xlat16_6.x);
					    u_xlat16_6.x = dot(u_xlat16_6.xy, u_xlat16_6.xy);
					    u_xlat16_0.y = sqrt(u_xlat16_6.x);
					    u_xlat16_0.xy = (-u_xlat16_0.xy) + vec2(1.0, 1.0);
					    u_xlat4.y = _DistotionTexAnimeSpeed * u_xlat1 + u_xlat16_0.y;
					    u_xlatb19 = u_xlat16_18>=(-u_xlat16_18);
					    u_xlatb13 = u_xlatb19 && u_xlatb13;
					    u_xlat7 = (u_xlatb13) ? (-u_xlat7) : u_xlat7;
					    u_xlat16_6.x = u_xlat7 * 0.159154937 + 0.75;
					    u_xlat4.x = _DistotionTexAnimeSpeed2 * u_xlat1 + u_xlat16_6.x;
					    u_xlat2.y = _Back2TexAnimeSpeed * u_xlat1 + u_xlat16_0.x;
					    ...
					    u_xlat16_12.xy = u_xlat16_0.xy * vec2(vec2(_Back2TexDistotion, _Back2TexDistotion)) + u_xlat2.xy;
					    u_xlat10_1.xyz = texture2D(_Back2Tex, u_xlat16_12.xy).xyz;
					    u_xlat16_1.xyz = u_xlat10_1.xyz * _Back2TexColor.xyz;
					    u_xlat16_12.xy = u_xlat16_0.xy * vec2(vec2(_Back1TexDistotion, _Back1TexDistotion)) + vs_TEXCOORD2.xy;
					    u_xlat10_2.xyz = texture2D(_Back1Tex, u_xlat16_12.xy).xyz;
					    u_xlat16_2.xyz = u_xlat10_2.xyz * _Back1TexColor.xyz;
					    u_xlat16_12.xy = u_xlat16_0.xy * vec2(vec2(_MainTexDistotion, _MainTexDistotion)) + vs_TEXCOORD0.xy;
					    u_xlat10_5.xyz = texture2D(_MainTex, u_xlat16_12.xy).xyz;
					    u_xlat16_3.xyz = u_xlat16_2.xyz * u_xlat10_4.yyy + u_xlat10_5.xyz;
					    u_xlat16_3.xyz = u_xlat16_1.xyz * u_xlat10_4.yyy + u_xlat16_3.xyz;
					    u_xlat16_12.xy = u_xlat16_0.xy * vec2(vec2(_Front1TexDistotion, _Front1TexDistotion)) + vs_TEXCOORD1.xy;
					    u_xlat16_0.xy = u_xlat16_0.xy * vec2(_Front2TexDistotion) + vs_TEXCOORD1.zw;
					    u_xlat10_1.xyz = texture2D(_Front2Tex, u_xlat16_0.xy).xyz;
					    u_xlat16_1.xyz = u_xlat10_1.xyz * _Front2TexColor.xyz;
					    u_xlat10_2.xyz = texture2D(_Front1Tex, u_xlat16_12.xy).xyz;
					    u_xlat16_2.xyz = u_xlat10_2.xyz * _Front1TexColor.xyz;
					    u_xlat16_0.xyz = u_xlat16_2.xyz * u_xlat10_4.xxx + u_xlat16_3.xyz;
					    u_xlat16_0.xyz = u_xlat16_1.xyz * u_xlat10_4.xxx + u_xlat16_0.xyz;
					    SV_Target0.xyz = u_xlat16_0.xyz * vs_COLOR0.xyz;
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK2TEX_POLAR" "_FRONT1TEX_POLAR" "_BACK1TEX_ROTATE" "_DISTOTIONTEX_POLAR" "_FRONT2TEX_SCROLL" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK2TEX_POLAR" "_BACK1TEX_ROTATE" "_DISTOTIONTEX_POLAR" "_FRONT1TEX_ROTATE" "_FRONT2TEX_SCROLL" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK2TEX_POLAR" "_FRONT2TEX_ROTATE" "_BACK1TEX_ROTATE" "_DISTOTIONTEX_POLAR" "_FRONT1TEX_SCROLL" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK1TEX_POLAR" "_BACK2TEX_POLAR" "_DISTOTIONTEX_SCROLL" "_FRONT2TEX_SCROLL" "_FRONT1TEX_SCROLL" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlat5 = fract(_Time.x);
					    u_xlat0.zw = vec2(_DistotionTexAnimeSpeed, _DistotionTexAnimeSpeed2) * vec2(u_xlat5) + u_xlat1.xy;
					    phase0_Output0_0 = u_xlat0;
					    u_xlat0.xy = in_TEXCOORD0.xy * _Front1Tex_ST.xy + _Front1Tex_ST.zw;
					    u_xlat0.xy = vec2(_Front1TexAnimeSpeed, _Front1TexAnimeSpeed2) * vec2(u_xlat5) + u_xlat0.xy;
					    u_xlat1.xy = in_TEXCOORD0.xy * _Front2Tex_ST.xy + _Front2Tex_ST.zw;
					    u_xlat0.zw = vec2(_Front2TexAnimeSpeed, _Front2TexAnimeSpeed2) * vec2(u_xlat5) + u_xlat1.xy;
					    vs_TEXCOORD1 = u_xlat0;
					    u_xlat0.xy = in_TEXCOORD0.xy * _Back1Tex_ST.xy + _Back1Tex_ST.zw;
					    u_xlat0.zw = in_TEXCOORD0.xy * _Back2Tex_ST.xy + _Back2Tex_ST.zw;
					    vs_TEXCOORD2 = u_xlat0;
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK2TEX_POLAR" "_BACK1TEX_ROTATE" "_DISTOTIONTEX_POLAR" "_FRONT2TEX_SCROLL" "_FRONT1TEX_SCROLL" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK2TEX_POLAR" "_FRONT1TEX_POLAR" "_FRONT2TEX_ROTATE" "_DISTOTIONTEX_POLAR" "_BACK1TEX_SCROLL" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK2TEX_POLAR" "_FRONT2TEX_ROTATE" "_DISTOTIONTEX_POLAR" "_FRONT1TEX_SCROLL" "_BACK1TEX_SCROLL" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK1TEX_POLAR" "_FRONT1TEX_POLAR" "_FRONT2TEX_ROTATE" "_DISTOTIONTEX_POLAR" "_BACK2TEX_ROTATE" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlat16_12 = max(abs(u_xlat16_0.y), abs(u_xlat16_0.x));
					    ...
					    u_xlat16_1.x = u_xlat16_18 * u_xlat16_1.x + -0.330299497;
					    u_xlat16_1.x = u_xlat16_18 * u_xlat16_1.x + 0.999866009;
					    u_xlat16_7.x = u_xlat16_12 * u_xlat16_1.x;
					    u_xlat7 = u_xlat16_7.x * -2.0 + 1.57079637;
					    u_xlatb13 = abs(u_xlat16_0.y)<abs(u_xlat16_0.x);
					    u_xlat7 = u_xlatb13 ? u_xlat7 : float(0.0);
					    u_xlat1 = u_xlat16_12 * u_xlat16_1.x + u_xlat7;
					    u_xlatb7 = u_xlat16_0.y<(-u_xlat16_0.y);
					    u_xlat7 = u_xlatb7 ? -3.14159274 : float(0.0);
					    u_xlat1 = u_xlat7 + u_xlat1;
					    u_xlat16_12 = min(u_xlat16_0.y, u_xlat16_0.x);
					    u_xlatb7 = u_xlat16_12<(-u_xlat16_12);
					    u_xlat16_12 = max(u_xlat16_0.y, u_xlat16_0.x);
					    u_xlat16_0.x = dot(u_xlat16_0.xy, u_xlat16_0.xy);
					    u_xlat16_0.x = sqrt(u_xlat16_0.x);
					    u_xlatb13 = u_xlat16_12>=(-u_xlat16_12);
					    u_xlatb7 = u_xlatb13 && u_xlatb7;
					    u_xlat1 = (u_xlatb7) ? (-u_xlat1) : u_xlat1;
					    u_xlat16_6.x = u_xlat1 * 0.159154937 + 0.75;
					    u_xlat1 = fract(_Time.x);
					    u_xlat2.x = _Back1TexAnimeSpeed2 * u_xlat1 + u_xlat16_6.x;
					    u_xlat16_6.xy = vs_TEXCOORD3.yx * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
					    u_xlat16_18 = max(abs(u_xlat16_6.y), abs(u_xlat16_6.x));
					    u_xlat16_18 = float(1.0) / u_xlat16_18;
					    u_xlat16_3.x = min(abs(u_xlat16_6.y), abs(u_xlat16_6.x));
					    u_xlat16_18 = u_xlat16_18 * u_xlat16_3.x;
					    u_xlat16_3.x = u_xlat16_18 * u_xlat16_18;
					    u_xlat16_7.x = u_xlat16_3.x * 0.0208350997 + -0.0851330012;
					    u_xlat16_7.x = u_xlat16_3.x * u_xlat16_7.x + 0.180141002;
					    u_xlat16_7.x = u_xlat16_3.x * u_xlat16_7.x + -0.330299497;
					    u_xlat16_7.x = u_xlat16_3.x * u_xlat16_7.x + 0.999866009;
					    u_xlat16_13 = u_xlat16_18 * u_xlat16_7.x;
					    u_xlat13 = u_xlat16_13 * -2.0 + 1.57079637;
					    u_xlatb19 = abs(u_xlat16_6.y)<abs(u_xlat16_6.x);
					    u_xlat13 = u_xlatb19 ? u_xlat13 : float(0.0);
					    u_xlat7 = u_xlat16_18 * u_xlat16_7.x + u_xlat13;
					    u_xlatb13 = u_xlat16_6.y<(-u_xlat16_6.y);
					    u_xlat13 = u_xlatb13 ? -3.14159274 : float(0.0);
					    u_xlat7 = u_xlat13 + u_xlat7;
					    u_xlat16_18 = min(u_xlat16_6.y, u_xlat16_6.x);
					    ...
					    u_xlat16_6.x = u_xlat7 * 0.159154937 + 0.75;
					    u_xlat4.x = _DistotionTexAnimeSpeed2 * u_xlat1 + u_xlat16_6.x;
					    u_xlat10_7.xy = texture2D(_DistotionTex, u_xlat4.xy).xy;
					    u_xlat16_7.xy = u_xlat10_7.xy + vec2(-0.5, -0.5);
					    u_xlat16_7.xy = u_xlat16_7.xy * vec2(vec2(_DistotionTexPower, _DistotionTexPower));
					    u_xlat10_4.xyz = texture2D(_MaskTex, vs_TEXCOORD0.xy).xyz;
					    u_xlat16_6.xy = u_xlat16_7.xy * u_xlat10_4.zz;
					    u_xlat2.y = _Back1TexAnimeSpeed * u_xlat1 + u_xlat16_0.x;
					    u_xlat16_0.xw = u_xlat16_6.xy * vec2(vec2(_Back1TexDistotion, _Back1TexDistotion)) + u_xlat2.xy;
					    u_xlat10_7.xyz = texture2D(_Back1Tex, u_xlat16_0.xw).xyz;
					    u_xlat16_7.xyz = u_xlat10_7.xyz * _Back1TexColor.xyz;
					    u_xlat16_0.xw = u_xlat16_6.xy * vec2(vec2(_MainTexDistotion, _MainTexDistotion)) + vs_TEXCOORD0.xy;
					    u_xlat10_2.xyz = texture2D(_MainTex, u_xlat16_0.xw).xyz;
					    u_xlat16_3.xyz = u_xlat16_7.xyz * u_xlat10_4.yyy + u_xlat10_2.xyz;
					    u_xlat16_0.xw = u_xlat16_6.xy * vec2(vec2(_Back2TexDistotion, _Back2TexDistotion)) + vs_TEXCOORD2.zw;
					    u_xlat10_7.xyz = texture2D(_Back2Tex, u_xlat16_0.xw).xyz;
					    u_xlat16_7.xyz = u_xlat10_7.xyz * _Back2TexColor.xyz;
					    u_xlat16_3.xyz = u_xlat16_7.xyz * u_xlat10_4.yyy + u_xlat16_3.xyz;
					    u_xlat16_0.xw = vs_TEXCOORD1.yx * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
					    u_xlat16_21 = max(abs(u_xlat16_0.w), abs(u_xlat16_0.x));
					    u_xlat16_21 = float(1.0) / u_xlat16_21;
					    u_xlat16_5 = min(abs(u_xlat16_0.w), abs(u_xlat16_0.x));
					    u_xlat16_21 = u_xlat16_21 * u_xlat16_5;
					    u_xlat16_5 = u_xlat16_21 * u_xlat16_21;
					    u_xlat16_7.x = u_xlat16_5 * 0.0208350997 + -0.0851330012;
					    u_xlat16_7.x = u_xlat16_5 * u_xlat16_7.x + 0.180141002;
					    u_xlat16_7.x = u_xlat16_5 * u_xlat16_7.x + -0.330299497;
					    u_xlat16_7.x = u_xlat16_5 * u_xlat16_7.x + 0.999866009;
					    u_xlat16_13 = u_xlat16_7.x * u_xlat16_21;
					    u_xlat13 = u_xlat16_13 * -2.0 + 1.57079637;
					    u_xlatb19 = abs(u_xlat16_0.w)<abs(u_xlat16_0.x);
					    u_xlat13 = u_xlatb19 ? u_xlat13 : float(0.0);
					    u_xlat7 = u_xlat16_21 * u_xlat16_7.x + u_xlat13;
					    u_xlatb13 = u_xlat16_0.w<(-u_xlat16_0.w);
					    u_xlat13 = u_xlatb13 ? -3.14159274 : float(0.0);
					    u_xlat7 = u_xlat13 + u_xlat7;
					    u_xlat16_21 = min(u_xlat16_0.w, u_xlat16_0.x);
					    u_xlatb13 = u_xlat16_21<(-u_xlat16_21);
					    u_xlat16_21 = max(u_xlat16_0.w, u_xlat16_0.x);
					    u_xlat16_0.x = dot(u_xlat16_0.xw, u_xlat16_0.xw);
					    u_xlat16_0.x = sqrt(u_xlat16_0.x);
					    u_xlat16_0.x = (-u_xlat16_0.x) + 1.0;
					    u_xlat2.y = _Front1TexAnimeSpeed * u_xlat1 + u_xlat16_0.x;
					    u_xlatb19 = u_xlat16_21>=(-u_xlat16_21);
					    u_xlatb13 = u_xlatb19 && u_xlatb13;
					    u_xlat7 = (u_xlatb13) ? (-u_xlat7) : u_xlat7;
					    u_xlat16_0.x = u_xlat7 * 0.159154937 + 0.75;
					    u_xlat2.x = _Front1TexAnimeSpeed2 * u_xlat1 + u_xlat16_0.x;
					    u_xlat16_0.xw = u_xlat16_6.xy * vec2(vec2(_Front1TexDistotion, _Front1TexDistotion)) + u_xlat2.xy;
					    u_xlat16_6.xy = u_xlat16_6.xy * vec2(_Front2TexDistotion) + vs_TEXCOORD1.zw;
					    u_xlat10_1.xyz = texture2D(_Front2Tex, u_xlat16_6.xy).xyz;
					    u_xlat16_1.xyz = u_xlat10_1.xyz * _Front2TexColor.xyz;
					    u_xlat10_2.xyz = texture2D(_Front1Tex, u_xlat16_0.xw).xyz;
					    u_xlat16_2.xyz = u_xlat10_2.xyz * _Front1TexColor.xyz;
					    u_xlat16_0.xyz = u_xlat16_2.xyz * u_xlat10_4.xxx + u_xlat16_3.xyz;
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK1TEX_POLAR" "_DISTOTIONTEX_SCROLL" "_FRONT2TEX_ROTATE" "_FRONT1TEX_ROTATE" "_BACK2TEX_ROTATE" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					{
					    u_xlat16_0.xy = vs_TEXCOORD2.yx * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
					    u_xlat16_10.x = max(abs(u_xlat16_0.y), abs(u_xlat16_0.x));
					    u_xlat16_10.x = float(1.0) / u_xlat16_10.x;
					    u_xlat16_15 = min(abs(u_xlat16_0.y), abs(u_xlat16_0.x));
					    u_xlat16_10.x = u_xlat16_10.x * u_xlat16_15;
					    u_xlat16_15 = u_xlat16_10.x * u_xlat16_10.x;
					    u_xlat16_1.x = u_xlat16_15 * 0.0208350997 + -0.0851330012;
					    u_xlat16_1.x = u_xlat16_15 * u_xlat16_1.x + 0.180141002;
					    u_xlat16_1.x = u_xlat16_15 * u_xlat16_1.x + -0.330299497;
					    u_xlat16_1.x = u_xlat16_15 * u_xlat16_1.x + 0.999866009;
					    u_xlat16_6 = u_xlat16_10.x * u_xlat16_1.x;
					    u_xlat6 = u_xlat16_6 * -2.0 + 1.57079637;
					    u_xlatb11 = abs(u_xlat16_0.y)<abs(u_xlat16_0.x);
					    u_xlat6 = u_xlatb11 ? u_xlat6 : float(0.0);
					    u_xlat1 = u_xlat16_10.x * u_xlat16_1.x + u_xlat6;
					    u_xlatb6 = u_xlat16_0.y<(-u_xlat16_0.y);
					    u_xlat6 = u_xlatb6 ? -3.14159274 : float(0.0);
					    u_xlat1 = u_xlat6 + u_xlat1;
					    u_xlat16_10.x = min(u_xlat16_0.y, u_xlat16_0.x);
					    u_xlatb6 = u_xlat16_10.x<(-u_xlat16_10.x);
					    u_xlat16_10.x = max(u_xlat16_0.y, u_xlat16_0.x);
					    u_xlat16_0.x = dot(u_xlat16_0.xy, u_xlat16_0.xy);
					    u_xlat16_0.x = sqrt(u_xlat16_0.x);
					    u_xlat16_0.x = (-u_xlat16_0.x) + 1.0;
					    u_xlatb11 = u_xlat16_10.x>=(-u_xlat16_10.x);
					    u_xlatb6 = u_xlatb11 && u_xlatb6;
					    u_xlat1 = (u_xlatb6) ? (-u_xlat1) : u_xlat1;
					    u_xlat16_5 = u_xlat1 * 0.159154937 + 0.75;
					    u_xlat1 = fract(_Time.x);
					    u_xlat2.x = _Back1TexAnimeSpeed2 * u_xlat1 + u_xlat16_5;
					    u_xlat2.y = _Back1TexAnimeSpeed * u_xlat1 + u_xlat16_0.x;
					    ...
					    u_xlat16_10.xy = u_xlat16_0.xy * vec2(vec2(_Back1TexDistotion, _Back1TexDistotion)) + u_xlat2.xy;
					    u_xlat10_1.xyz = texture2D(_Back1Tex, u_xlat16_10.xy).xyz;
					    u_xlat16_1.xyz = u_xlat10_1.xyz * _Back1TexColor.xyz;
					    u_xlat16_10.xy = u_xlat16_0.xy * vec2(vec2(_MainTexDistotion, _MainTexDistotion)) + vs_TEXCOORD0.xy;
					    u_xlat10_2.xyz = texture2D(_MainTex, u_xlat16_10.xy).xyz;
					    u_xlat16_4.xyz = u_xlat16_1.xyz * u_xlat10_3.yyy + u_xlat10_2.xyz;
					    u_xlat16_10.xy = u_xlat16_0.xy * vec2(vec2(_Back2TexDistotion, _Back2TexDistotion)) + vs_TEXCOORD2.zw;
					    u_xlat10_1.xyz = texture2D(_Back2Tex, u_xlat16_10.xy).xyz;
					    u_xlat16_1.xyz = u_xlat10_1.xyz * _Back2TexColor.xyz;
					    u_xlat16_4.xyz = u_xlat16_1.xyz * u_xlat10_3.yyy + u_xlat16_4.xyz;
					    u_xlat16_10.xy = u_xlat16_0.xy * vec2(vec2(_Front1TexDistotion, _Front1TexDistotion)) + vs_TEXCOORD1.xy;
					    u_xlat16_0.xy = u_xlat16_0.xy * vec2(_Front2TexDistotion) + vs_TEXCOORD1.zw;
					    u_xlat10_1.xyz = texture2D(_Front2Tex, u_xlat16_0.xy).xyz;
					    u_xlat16_1.xyz = u_xlat10_1.xyz * _Front2TexColor.xyz;
					    u_xlat10_2.xyz = texture2D(_Front1Tex, u_xlat16_10.xy).xyz;
					    u_xlat16_2.xyz = u_xlat10_2.xyz * _Front1TexColor.xyz;
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_FRONT2TEX_ROTATE" "_BACK1TEX_ROTATE" "_DISTOTIONTEX_POLAR" "_FRONT1TEX_ROTATE" "_BACK2TEX_ROTATE" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlat16_5 = u_xlat1 * 0.159154937 + 0.75;
					    u_xlat1 = fract(_Time.x);
					    u_xlat2.x = _DistotionTexAnimeSpeed2 * u_xlat1 + u_xlat16_5;
					    ...
					    u_xlat16_10.xy = u_xlat16_0.xy * vec2(vec2(_Back1TexDistotion, _Back1TexDistotion)) + vs_TEXCOORD2.xy;
					    u_xlat10_1.xyz = texture2D(_Back1Tex, u_xlat16_10.xy).xyz;
					    u_xlat16_1.xyz = u_xlat10_1.xyz * _Back1TexColor.xyz;
					    u_xlat16_10.xy = u_xlat16_0.xy * vec2(vec2(_MainTexDistotion, _MainTexDistotion)) + vs_TEXCOORD0.xy;
					    ...
					    u_xlat10_1.xyz = texture2D(_Front2Tex, u_xlat16_0.xy).xyz;
					    u_xlat16_1.xyz = u_xlat10_1.xyz * _Front2TexColor.xyz;
					    u_xlat10_7.xyz = texture2D(_Front1Tex, u_xlat16_10.xy).xyz;
					    u_xlat16_7.xyz = u_xlat10_7.xyz * _Front1TexColor.xyz;
					    u_xlat16_0.xyz = u_xlat16_7.xyz * u_xlat10_2.xxx + u_xlat16_4.xyz;
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK1TEX_POLAR" "_DISTOTIONTEX_POLAR" "_FRONT1TEX_ROTATE" "_FRONT2TEX_SCROLL" "_BACK2TEX_ROTATE" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlatb6 = u_xlatb11 && u_xlatb6;
					    u_xlat1 = (u_xlatb6) ? (-u_xlat1) : u_xlat1;
					    u_xlat16_5.x = u_xlat1 * 0.159154937 + 0.75;
					    u_xlat1 = fract(_Time.x);
					    u_xlat2.x = _Back1TexAnimeSpeed2 * u_xlat1 + u_xlat16_5.x;
					    u_xlat16_5.xy = vs_TEXCOORD3.yx * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
					    u_xlat16_15 = max(abs(u_xlat16_5.y), abs(u_xlat16_5.x));
					    u_xlat16_15 = float(1.0) / u_xlat16_15;
					    u_xlat16_3.x = min(abs(u_xlat16_5.y), abs(u_xlat16_5.x));
					    ...
					    u_xlat16_11 = u_xlat16_15 * u_xlat16_6;
					    u_xlat11 = u_xlat16_11 * -2.0 + 1.57079637;
					    u_xlatb16 = abs(u_xlat16_5.y)<abs(u_xlat16_5.x);
					    u_xlat11 = u_xlatb16 ? u_xlat11 : float(0.0);
					    u_xlat6 = u_xlat16_15 * u_xlat16_6 + u_xlat11;
					    u_xlatb11 = u_xlat16_5.y<(-u_xlat16_5.y);
					    u_xlat11 = u_xlatb11 ? -3.14159274 : float(0.0);
					    u_xlat6 = u_xlat11 + u_xlat6;
					    u_xlat16_15 = min(u_xlat16_5.y, u_xlat16_5.x);
					    u_xlatb11 = u_xlat16_15<(-u_xlat16_15);
					    u_xlat16_15 = max(u_xlat16_5.y, u_xlat16_5.x);
					    u_xlat16_5.x = dot(u_xlat16_5.xy, u_xlat16_5.xy);
					    u_xlat16_0.y = sqrt(u_xlat16_5.x);
					    u_xlat16_0.xy = (-u_xlat16_0.xy) + vec2(1.0, 1.0);
					    u_xlat4.y = _DistotionTexAnimeSpeed * u_xlat1 + u_xlat16_0.y;
					    u_xlatb16 = u_xlat16_15>=(-u_xlat16_15);
					    u_xlatb11 = u_xlatb16 && u_xlatb11;
					    u_xlat6 = (u_xlatb11) ? (-u_xlat6) : u_xlat6;
					    u_xlat16_5.x = u_xlat6 * 0.159154937 + 0.75;
					    u_xlat4.x = _DistotionTexAnimeSpeed2 * u_xlat1 + u_xlat16_5.x;
					    u_xlat2.y = _Back1TexAnimeSpeed * u_xlat1 + u_xlat16_0.x;
					    u_xlat10_1.xy = texture2D(_DistotionTex, u_xlat4.xy).xy;
					    u_xlat16_1.xy = u_xlat10_1.xy + vec2(-0.5, -0.5);
					    u_xlat16_1.xy = u_xlat16_1.xy * vec2(vec2(_DistotionTexPower, _DistotionTexPower));
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK1TEX_POLAR" "_DISTOTIONTEX_SCROLL" "_FRONT2TEX_ROTATE" "_FRONT1TEX_SCROLL" "_BACK2TEX_ROTATE" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_FRONT2TEX_ROTATE" "_BACK1TEX_ROTATE" "_DISTOTIONTEX_POLAR" "_FRONT1TEX_SCROLL" "_BACK2TEX_ROTATE" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_DISTOTIONTEX_SCROLL" "_FRONT2TEX_ROTATE" "_FRONT1TEX_ROTATE" "_BACK1TEX_SCROLL" "_BACK2TEX_ROTATE" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlat16_12.xy = u_xlat16_2.xy * vec2(vec2(_Back1TexDistotion, _Back1TexDistotion)) + vs_TEXCOORD2.xy;
					    u_xlat10_0.xyz = texture2D(_Back1Tex, u_xlat16_12.xy).xyz;
					    u_xlat16_0.xyz = u_xlat10_0.xyz * _Back1TexColor.xyz;
					    u_xlat16_12.xy = u_xlat16_2.xy * vec2(vec2(_MainTexDistotion, _MainTexDistotion)) + vs_TEXCOORD0.xy;
					    u_xlat10_3.xyz = texture2D(_MainTex, u_xlat16_12.xy).xyz;
					    u_xlat16_4.xyz = u_xlat16_0.xyz * u_xlat10_1.yyy + u_xlat10_3.xyz;
					    u_xlat16_12.xy = u_xlat16_2.xy * vec2(vec2(_Back2TexDistotion, _Back2TexDistotion)) + vs_TEXCOORD2.zw;
					    u_xlat10_0.xyz = texture2D(_Back2Tex, u_xlat16_12.xy).xyz;
					    u_xlat16_0.xyz = u_xlat10_0.xyz * _Back2TexColor.xyz;
					    u_xlat16_4.xyz = u_xlat16_0.xyz * u_xlat10_1.yyy + u_xlat16_4.xyz;
					    u_xlat16_12.xy = u_xlat16_2.xy * vec2(vec2(_Front1TexDistotion, _Front1TexDistotion)) + vs_TEXCOORD1.xy;
					    u_xlat16_2.xy = u_xlat16_2.xy * vec2(_Front2TexDistotion) + vs_TEXCOORD1.zw;
					    u_xlat10_0.xyz = texture2D(_Front2Tex, u_xlat16_2.xy).xyz;
					    u_xlat16_0.xyz = u_xlat10_0.xyz * _Front2TexColor.xyz;
					    u_xlat10_6.xyz = texture2D(_Front1Tex, u_xlat16_12.xy).xyz;
					    u_xlat16_6.xyz = u_xlat10_6.xyz * _Front1TexColor.xyz;
					    u_xlat16_2.xyz = u_xlat16_6.xyz * u_xlat10_1.xxx + u_xlat16_4.xyz;
					    u_xlat16_2.xyz = u_xlat16_0.xyz * u_xlat10_1.xxx + u_xlat16_2.xyz;
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_FRONT2TEX_ROTATE" "_DISTOTIONTEX_POLAR" "_FRONT1TEX_SCROLL" "_BACK1TEX_SCROLL" "_BACK2TEX_ROTATE" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_DISTOTIONTEX_SCROLL" "_FRONT1TEX_POLAR" "_FRONT2TEX_ROTATE" "_BACK1TEX_ROTATE" "_BACK2TEX_SCROLL" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlatb7 = u_xlatb13 && u_xlatb7;
					    u_xlat1 = (u_xlatb7) ? (-u_xlat1) : u_xlat1;
					    u_xlat16_6 = u_xlat1 * 0.159154937 + 0.75;
					    u_xlat1 = fract(_Time.x);
					    u_xlat2.x = _Front1TexAnimeSpeed2 * u_xlat1 + u_xlat16_6;
					    u_xlat2.y = _Front1TexAnimeSpeed * u_xlat1 + u_xlat16_0.x;
					    u_xlat10_1.xy = texture2D(_DistotionTex, vs_TEXCOORD3.xy).xy;
					    u_xlat16_1.xy = u_xlat10_1.xy + vec2(-0.5, -0.5);
					    u_xlat16_1.xy = u_xlat16_1.xy * vec2(vec2(_DistotionTexPower, _DistotionTexPower));
					    u_xlat10_3.xyz = texture2D(_MaskTex, vs_TEXCOORD0.xy).xyz;
					    u_xlat16_0.xy = u_xlat16_1.xy * u_xlat10_3.zz;
					    u_xlat16_12.xy = u_xlat16_0.xy * vec2(vec2(_Front1TexDistotion, _Front1TexDistotion)) + u_xlat2.xy;
					    u_xlat10_1.xyz = texture2D(_Front1Tex, u_xlat16_12.xy).xyz;
					    u_xlat16_1.xyz = u_xlat10_1.xyz * _Front1TexColor.xyz;
					    u_xlat16_12.xy = u_xlat16_0.xy * vec2(vec2(_Back1TexDistotion, _Back1TexDistotion)) + vs_TEXCOORD2.xy;
					    u_xlat10_2.xyz = texture2D(_Back1Tex, u_xlat16_12.xy).xyz;
					    u_xlat16_2.xyz = u_xlat10_2.xyz * _Back1TexColor.xyz;
					    u_xlat16_12.xy = u_xlat16_0.xy * vec2(vec2(_MainTexDistotion, _MainTexDistotion)) + vs_TEXCOORD0.xy;
					    u_xlat10_4.xyz = texture2D(_MainTex, u_xlat16_12.xy).xyz;
					    u_xlat16_5.xyz = u_xlat16_2.xyz * u_xlat10_3.yyy + u_xlat10_4.xyz;
					    u_xlat16_12.xy = u_xlat16_0.xy * vec2(vec2(_Back2TexDistotion, _Back2TexDistotion)) + vs_TEXCOORD2.zw;
					    u_xlat16_0.xy = u_xlat16_0.xy * vec2(_Front2TexDistotion) + vs_TEXCOORD1.zw;
					    u_xlat10_2.xyz = texture2D(_Front2Tex, u_xlat16_0.xy).xyz;
					    u_xlat16_2.xyz = u_xlat10_2.xyz * _Front2TexColor.xyz;
					    u_xlat10_4.xyz = texture2D(_Back2Tex, u_xlat16_12.xy).xyz;
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK1TEX_POLAR" "_DISTOTIONTEX_SCROLL" "_FRONT2TEX_ROTATE" "_FRONT1TEX_ROTATE" "_BACK2TEX_SCROLL" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK1TEX_POLAR" "_DISTOTIONTEX_SCROLL" "_FRONT1TEX_POLAR" "_FRONT2TEX_SCROLL" "_BACK2TEX_SCROLL" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    phase0_Output0_0 = u_xlat0;
					    u_xlat0.xy = in_TEXCOORD0.xy * _Front2Tex_ST.xy + _Front2Tex_ST.zw;
					    u_xlat0.zw = vec2(_Front2TexAnimeSpeed, _Front2TexAnimeSpeed2) * vec2(u_xlat5) + u_xlat0.xy;
					    u_xlat0.xy = in_TEXCOORD0.xy * _Front1Tex_ST.xy + _Front1Tex_ST.zw;
					    vs_TEXCOORD1 = u_xlat0;
					    u_xlat0.xy = in_TEXCOORD0.xy * _Back2Tex_ST.xy + _Back2Tex_ST.zw;
					    u_xlat0.zw = vec2(_Back2TexAnimeSpeed, _Back2TexAnimeSpeed2) * vec2(u_xlat5) + u_xlat0.xy;
					    u_xlat0.xy = in_TEXCOORD0.xy * _Back1Tex_ST.xy + _Back1Tex_ST.zw;
					    vs_TEXCOORD2 = u_xlat0;
					    vs_COLOR0 = in_COLOR0;
					    u_xlat0 = in_POSITION0.yyyy * hlslcc_mtx4x4unity_ObjectToWorld[1];
					...
					void main()
					{
					    ...
					    u_xlat16_1.x = u_xlat16_18 * u_xlat16_1.x + -0.330299497;
					    u_xlat16_1.x = u_xlat16_18 * u_xlat16_1.x + 0.999866009;
					    u_xlat16_7.x = u_xlat16_12.x * u_xlat16_1.x;
					    u_xlat7 = u_xlat16_7.x * -2.0 + 1.57079637;
					    u_xlatb13 = abs(u_xlat16_0.y)<abs(u_xlat16_0.x);
					    u_xlat7 = u_xlatb13 ? u_xlat7 : float(0.0);
					    u_xlat1 = u_xlat16_12.x * u_xlat16_1.x + u_xlat7;
					    ...
					    u_xlat16_6 = u_xlat1 * 0.159154937 + 0.75;
					    u_xlat1 = fract(_Time.x);
					    u_xlat2.x = _Back1TexAnimeSpeed2 * u_xlat1 + u_xlat16_6;
					    u_xlat2.y = _Back1TexAnimeSpeed * u_xlat1 + u_xlat16_0.x;
					    u_xlat10_7.xy = texture2D(_DistotionTex, vs_TEXCOORD3.xy).xy;
					    u_xlat16_7.xy = u_xlat10_7.xy + vec2(-0.5, -0.5);
					    u_xlat16_7.xy = u_xlat16_7.xy * vec2(vec2(_DistotionTexPower, _DistotionTexPower));
					    u_xlat10_3.xyz = texture2D(_MaskTex, vs_TEXCOORD0.xy).xyz;
					    u_xlat16_0.xy = u_xlat16_7.xy * u_xlat10_3.zz;
					    u_xlat16_12.xy = u_xlat16_0.xy * vec2(vec2(_Back1TexDistotion, _Back1TexDistotion)) + u_xlat2.xy;
					    u_xlat10_7.xyz = texture2D(_Back1Tex, u_xlat16_12.xy).xyz;
					    u_xlat16_7.xyz = u_xlat10_7.xyz * _Back1TexColor.xyz;
					    u_xlat16_12.xy = u_xlat16_0.xy * vec2(vec2(_MainTexDistotion, _MainTexDistotion)) + vs_TEXCOORD0.xy;
					    u_xlat10_2.xyz = texture2D(_MainTex, u_xlat16_12.xy).xyz;
					    u_xlat16_4.xyz = u_xlat16_7.xyz * u_xlat10_3.yyy + u_xlat10_2.xyz;
					    u_xlat16_12.xy = u_xlat16_0.xy * vec2(vec2(_Back2TexDistotion, _Back2TexDistotion)) + vs_TEXCOORD2.zw;
					    u_xlat10_7.xyz = texture2D(_Back2Tex, u_xlat16_12.xy).xyz;
					    u_xlat16_7.xyz = u_xlat10_7.xyz * _Back2TexColor.xyz;
					    u_xlat16_4.xyz = u_xlat16_7.xyz * u_xlat10_3.yyy + u_xlat16_4.xyz;
					    u_xlat16_12.xy = vs_TEXCOORD1.yx * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
					    u_xlat16_22 = max(abs(u_xlat16_12.y), abs(u_xlat16_12.x));
					    u_xlat16_22 = float(1.0) / u_xlat16_22;
					    u_xlat16_5 = min(abs(u_xlat16_12.y), abs(u_xlat16_12.x));
					    ...
					    u_xlat16_7.x = u_xlat16_5 * u_xlat16_7.x + -0.330299497;
					    u_xlat16_7.x = u_xlat16_5 * u_xlat16_7.x + 0.999866009;
					    u_xlat16_13 = u_xlat16_7.x * u_xlat16_22;
					    u_xlat13 = u_xlat16_13 * -2.0 + 1.57079637;
					    u_xlatb19 = abs(u_xlat16_12.y)<abs(u_xlat16_12.x);
					    u_xlat13 = u_xlatb19 ? u_xlat13 : float(0.0);
					    u_xlat7 = u_xlat16_22 * u_xlat16_7.x + u_xlat13;
					    u_xlatb13 = u_xlat16_12.y<(-u_xlat16_12.y);
					    u_xlat13 = u_xlatb13 ? -3.14159274 : float(0.0);
					    u_xlat7 = u_xlat13 + u_xlat7;
					    u_xlat16_22 = min(u_xlat16_12.y, u_xlat16_12.x);
					    u_xlatb13 = u_xlat16_22<(-u_xlat16_22);
					    u_xlat16_22 = max(u_xlat16_12.y, u_xlat16_12.x);
					    u_xlat16_12.x = dot(u_xlat16_12.xy, u_xlat16_12.xy);
					    u_xlat16_12.x = sqrt(u_xlat16_12.x);
					    u_xlat16_12.x = (-u_xlat16_12.x) + 1.0;
					    u_xlat2.y = _Front1TexAnimeSpeed * u_xlat1 + u_xlat16_12.x;
					    u_xlatb19 = u_xlat16_22>=(-u_xlat16_22);
					    u_xlatb13 = u_xlatb19 && u_xlatb13;
					    u_xlat7 = (u_xlatb13) ? (-u_xlat7) : u_xlat7;
					    u_xlat16_12.x = u_xlat7 * 0.159154937 + 0.75;
					    u_xlat2.x = _Front1TexAnimeSpeed2 * u_xlat1 + u_xlat16_12.x;
					    u_xlat16_12.xy = u_xlat16_0.xy * vec2(vec2(_Front1TexDistotion, _Front1TexDistotion)) + u_xlat2.xy;
					    u_xlat16_0.xy = u_xlat16_0.xy * vec2(_Front2TexDistotion) + vs_TEXCOORD1.zw;
					    u_xlat10_1.xyz = texture2D(_Front2Tex, u_xlat16_0.xy).xyz;
					    u_xlat16_1.xyz = u_xlat10_1.xyz * _Front2TexColor.xyz;
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK1TEX_POLAR" "_DISTOTIONTEX_SCROLL" "_FRONT1TEX_ROTATE" "_FRONT2TEX_SCROLL" "_BACK2TEX_SCROLL" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK1TEX_POLAR" "_DISTOTIONTEX_POLAR" "_FRONT1TEX_ROTATE" "_FRONT2TEX_SCROLL" "_BACK2TEX_SCROLL" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_FRONT2TEX_ROTATE" "_BACK1TEX_ROTATE" "_DISTOTIONTEX_POLAR" "_FRONT1TEX_SCROLL" "_BACK2TEX_SCROLL" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_FRONT2TEX_ROTATE" "_DISTOTIONTEX_POLAR" "_FRONT1TEX_ROTATE" "_BACK1TEX_SCROLL" "_BACK2TEX_SCROLL" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_DISTOTIONTEX_SCROLL" "_FRONT2TEX_ROTATE" "_FRONT1TEX_SCROLL" "_BACK1TEX_SCROLL" "_BACK2TEX_SCROLL" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_FRONT2TEX_ROTATE" "_DISTOTIONTEX_POLAR" "_FRONT1TEX_SCROLL" "_BACK1TEX_SCROLL" "_BACK2TEX_SCROLL" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_DISTOTIONTEX_SCROLL" "_FRONT2TEX_SCROLL" "_FRONT1TEX_SCROLL" "_BACK1TEX_SCROLL" "_BACK2TEX_SCROLL" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    vs_TEXCOORD1 = u_xlat0;
					    u_xlat0.xy = in_TEXCOORD0.xy * _Back1Tex_ST.xy + _Back1Tex_ST.zw;
					    u_xlat0.xy = vec2(_Back1TexAnimeSpeed, _Back1TexAnimeSpeed2) * vec2(u_xlat5) + u_xlat0.xy;
					    u_xlat1.xy = in_TEXCOORD0.xy * _Back2Tex_ST.xy + _Back2Tex_ST.zw;
					    u_xlat0.zw = vec2(_Back2TexAnimeSpeed, _Back2TexAnimeSpeed2) * vec2(u_xlat5) + u_xlat1.xy;
					    vs_TEXCOORD2 = u_xlat0;
					    vs_COLOR0 = in_COLOR0;
					    u_xlat0 = in_POSITION0.yyyy * hlslcc_mtx4x4unity_ObjectToWorld[1];
					    u_xlat0 = hlslcc_mtx4x4unity_ObjectToWorld[0] * in_POSITION0.xxxx + u_xlat0;
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_DISTOTIONTEX_POLAR" "_FRONT2TEX_SCROLL" "_FRONT1TEX_SCROLL" "_BACK1TEX_SCROLL" "_BACK2TEX_SCROLL" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    phase0_Output0_0 = u_xlat0;
					    u_xlat0.xy = in_TEXCOORD0.xy * _Front1Tex_ST.xy + _Front1Tex_ST.zw;
					    u_xlat4 = fract(_Time.x);
					    u_xlat1.xy = vec2(_Front1TexAnimeSpeed, _Front1TexAnimeSpeed2) * vec2(u_xlat4) + u_xlat0.xy;
					    u_xlat0.xy = in_TEXCOORD0.xy * _Front2Tex_ST.xy + _Front2Tex_ST.zw;
					    u_xlat1.zw = vec2(_Front2TexAnimeSpeed, _Front2TexAnimeSpeed2) * vec2(u_xlat4) + u_xlat0.xy;
					    vs_TEXCOORD1 = u_xlat1;
					    u_xlat0.xy = in_TEXCOORD0.xy * _Back1Tex_ST.xy + _Back1Tex_ST.zw;
					    u_xlat1.xy = vec2(_Back1TexAnimeSpeed, _Back1TexAnimeSpeed2) * vec2(u_xlat4) + u_xlat0.xy;
					    u_xlat0.xy = in_TEXCOORD0.xy * _Back2Tex_ST.xy + _Back2Tex_ST.zw;
					    u_xlat1.zw = vec2(_Back2TexAnimeSpeed, _Back2TexAnimeSpeed2) * vec2(u_xlat4) + u_xlat0.xy;
					    vs_TEXCOORD2 = u_xlat1;
					    vs_COLOR0 = in_COLOR0;
					    u_xlat0 = in_POSITION0.yyyy * hlslcc_mtx4x4unity_ObjectToWorld[1];
					    u_xlat0 = hlslcc_mtx4x4unity_ObjectToWorld[0] * in_POSITION0.xxxx + u_xlat0;
				...
				SubProgram "gles hw_tier02 " {			Keywords { "_BACK1TEX_POLAR" "_BACK2TEX_POLAR" "_FRONT1TEX_POLAR" "_FRONT2TEX_ROTATE" "_DISTOTIONTEX_ROTATE" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK1TEX_POLAR" "_BACK2TEX_POLAR" "_FRONT2TEX_ROTATE" "_FRONT1TEX_ROTATE" "_DISTOTIONTEX_ROTATE" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles hw_tier02 " {			Keywords { "_BACK1TEX_ROTATE" "_FRONT2TEX_SCROLL" "_FRONT1TEX_SCROLL" "_BACK2TEX_ROTATE" "_DISTOTIONTEX_ROTATE" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles hw_tier02 " {			Keywords { "_BACK1TEX_POLAR" "_BACK2TEX_POLAR" "_FRONT1TEX_POLAR" "_DISTOTIONTEX_POLAR" "_FRONT2TEX_POLAR" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlat16_10.xy = u_xlat16_7.xy * vec2(0.0208350997, 0.0208350997) + vec2(-0.0851330012, -0.0851330012);
					    u_xlat16_10.xy = u_xlat16_7.xy * u_xlat16_10.xy + vec2(0.180141002, 0.180141002);
					    u_xlat16_10.xy = u_xlat16_7.xy * u_xlat16_10.xy + vec2(-0.330299497, -0.330299497);
					    u_xlat16_10.xy = u_xlat16_7.xy * u_xlat16_10.xy + vec2(0.999866009, 0.999866009);
					    u_xlat16_11.xy = u_xlat16_10.xy * u_xlat16_20.xy;
					    u_xlat11.xy = u_xlat16_11.xy * vec2(-2.0, -2.0) + vec2(1.57079637, 1.57079637);
					    u_xlatb5.xy = lessThan(abs(u_xlat16_1.ywyy), abs(u_xlat16_1.xzxx)).xy;
					    u_xlat11.xy = mix(vec2(0.0, 0.0), u_xlat11.xy, vec2(u_xlatb5.xy));
					    u_xlat10.xy = u_xlat16_20.xy * u_xlat16_10.xy + u_xlat11.xy;
					    u_xlatb11.xy = lessThan(u_xlat16_1.ywyy, (-u_xlat16_1.ywyy)).xy;
					    u_xlat11.xy = mix(vec2(0.0, 0.0), vec2(-3.14159274, -3.14159274), vec2(u_xlatb11.xy));
					    u_xlat10.xy = u_xlat10.xy + u_xlat11.xy;
					    u_xlat16_20.xy = min(u_xlat16_1.yw, u_xlat16_1.xz);
					    u_xlatb11.xy = lessThan(u_xlat16_20.xyxx, (-u_xlat16_20.xyxx)).xy;
					    u_xlat16_20.xy = max(u_xlat16_1.yw, u_xlat16_1.xz);
					    u_xlatb5.xy = greaterThanEqual(u_xlat16_20.xyxx, (-u_xlat16_20.xyxx)).xy;
					    u_xlati11.xy = op_and((ivec2(u_xlatb11.xy) * -1), (ivec2(u_xlatb5.xy) * -1));
					    {
					    ...
					    u_xlat16_20.xy = u_xlat10.xy * vec2(0.159154937, 0.159154937) + vec2(0.75, 0.75);
					    u_xlat5.xy = vec2(_Front1TexAnimeSpeed2, _Front2TexAnimeSpeed2) * u_xlat2.xx + u_xlat16_20.xy;
					    ...
					    u_xlat16_20.xy = u_xlat16_4.xy * vec2(_Front2TexDistotion) + u_xlat5.yw;
					    u_xlat10_10.xyz = texture2D(_Front2Tex, u_xlat16_20.xy).xyz;
					    ...
					    u_xlat10_11.xyz = texture2D(_Front1Tex, u_xlat16_4.xy).xyz;
					    u_xlat16_11.xyz = u_xlat10_11.xyz * _Front1TexColor.xyz;
					    u_xlat16_0.xyz = u_xlat16_11.xyz * u_xlat10_3.xxx + u_xlat16_0.xyz;
					    u_xlat16_0.xyz = u_xlat16_10.xyz * u_xlat10_3.xxx + u_xlat16_0.xyz;
					    SV_Target0.xyz = u_xlat16_0.xyz * vs_COLOR0.xyz;
				...
				SubProgram "gles hw_tier02 " {  	Keywords { "_BACK1TEX_POLAR" "_BACK2TEX_POLAR" "_DISTOTIONTEX_POLAR" "_FRONT1TEX_ROTATE" "_FRONT2TEX_POLAR" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlat16_0.xyz = u_xlat16_5.xyz * u_xlat10_3.yyy + u_xlat10_6.xyz;
					    u_xlat16_0.xyz = u_xlat16_10.xyz * u_xlat10_3.yyy + u_xlat16_0.xyz;
					    u_xlat16_20.xy = u_xlat16_4.xy * vec2(vec2(_Front1TexDistotion, _Front1TexDistotion)) + vs_TEXCOORD1.xy;
					    u_xlat10_10.xyz = texture2D(_Front1Tex, u_xlat16_20.xy).xyz;
					    u_xlat16_10.xyz = u_xlat10_10.xyz * _Front1TexColor.xyz;
					    u_xlat16_0.xyz = u_xlat16_10.xyz * u_xlat10_3.xxx + u_xlat16_0.xyz;
					    ...
					    u_xlat16_20.x = sqrt(u_xlat16_20.x);
					    u_xlat16_20.x = (-u_xlat16_20.x) + 1.0;
					    u_xlat5.y = _Front2TexAnimeSpeed * u_xlat2.x + u_xlat16_20.x;
					    u_xlatb26 = u_xlat16_24>=(-u_xlat16_24);
					    u_xlatb18.x = u_xlatb26 && u_xlatb18.x;
					    u_xlat10 = (u_xlatb18.x) ? (-u_xlat10) : u_xlat10;
					    u_xlat16_24 = u_xlat10 * 0.159154937 + 0.75;
					    u_xlat5.x = _Front2TexAnimeSpeed2 * u_xlat2.x + u_xlat16_24;
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK2TEX_POLAR" "_BACK1TEX_ROTATE" "_DISTOTIONTEX_POLAR" "_FRONT1TEX_ROTATE" "_FRONT2TEX_POLAR" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlat16_3.xyz = u_xlat16_2.xyz * u_xlat10_4.yyy + u_xlat10_5.xyz;
					    u_xlat16_3.xyz = u_xlat16_8.xyz * u_xlat10_4.yyy + u_xlat16_3.xyz;
					    u_xlat16_0.xw = u_xlat16_7.xy * vec2(vec2(_Front1TexDistotion, _Front1TexDistotion)) + vs_TEXCOORD1.xy;
					    u_xlat10_8.xyz = texture2D(_Front1Tex, u_xlat16_0.xw).xyz;
					    u_xlat16_8.xyz = u_xlat10_8.xyz * _Front1TexColor.xyz;
					    u_xlat16_3.xyz = u_xlat16_8.xyz * u_xlat10_4.xxx + u_xlat16_3.xyz;
					    ...
					    u_xlat16_0.xy = u_xlat16_7.xy * vec2(_Front2TexDistotion) + u_xlat2.xy;
					    u_xlat10_1.xyz = texture2D(_Front2Tex, u_xlat16_0.xy).xyz;
					    u_xlat16_1.xyz = u_xlat10_1.xyz * _Front2TexColor.xyz;
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK2TEX_POLAR" "_DISTOTIONTEX_SCROLL" "_FRONT1TEX_POLAR" "_BACK1TEX_SCROLL" "_FRONT2TEX_POLAR" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlat16_14 = u_xlat16_14 * u_xlat16_21;
					    u_xlat16_21 = u_xlat16_14 * u_xlat16_14;
					    u_xlat16_1 = u_xlat16_21 * 0.0208350997 + -0.0851330012;
					    u_xlat16_1 = u_xlat16_21 * u_xlat16_1 + 0.180141002;
					    u_xlat16_1 = u_xlat16_21 * u_xlat16_1 + -0.330299497;
					    u_xlat16_1 = u_xlat16_21 * u_xlat16_1 + 0.999866009;
					    u_xlat16_8.x = u_xlat16_14 * u_xlat16_1;
					    u_xlat8.x = u_xlat16_8.x * -2.0 + 1.57079637;
					    u_xlatb15 = abs(u_xlat16_0.y)<abs(u_xlat16_0.x);
					    u_xlat8.x = u_xlatb15 ? u_xlat8.x : float(0.0);
					    u_xlat1 = u_xlat16_14 * u_xlat16_1 + u_xlat8.x;
					    u_xlatb8 = u_xlat16_0.y<(-u_xlat16_0.y);
					    ...
					    u_xlat1 = fract(_Time.x);
					    u_xlat2.x = _Back2TexAnimeSpeed2 * u_xlat1 + u_xlat16_7.x;
					    u_xlat10_8.xy = texture2D(_DistotionTex, vs_TEXCOORD3.xy).xy;
					    u_xlat16_8.xy = u_xlat10_8.xy + vec2(-0.5, -0.5);
					    u_xlat16_8.xy = u_xlat16_8.xy * vec2(vec2(_DistotionTexPower, _DistotionTexPower));
					    u_xlat10_3.xyz = texture2D(_MaskTex, vs_TEXCOORD0.xy).xyz;
					    u_xlat16_7.xy = u_xlat16_8.xy * u_xlat10_3.zz;
					    u_xlat2.y = _Back2TexAnimeSpeed * u_xlat1 + u_xlat16_0.x;
					    u_xlat16_0.xw = u_xlat16_7.xy * vec2(vec2(_Back2TexDistotion, _Back2TexDistotion)) + u_xlat2.xy;
					    u_xlat10_8.xyz = texture2D(_Back2Tex, u_xlat16_0.xw).xyz;
					    u_xlat16_8.xyz = u_xlat10_8.xyz * _Back2TexColor.xyz;
					    ...
					    u_xlat16_5.xyz = u_xlat16_2.xyz * u_xlat10_3.yyy + u_xlat10_4.xyz;
					    u_xlat16_5.xyz = u_xlat16_8.xyz * u_xlat10_3.yyy + u_xlat16_5.xyz;
					    ...
					    u_xlat16_8.xy = u_xlat16_6.xy * vec2(0.0208350997, 0.0208350997) + vec2(-0.0851330012, -0.0851330012);
					    u_xlat16_8.xy = u_xlat16_6.xy * u_xlat16_8.xy + vec2(0.180141002, 0.180141002);
					    u_xlat16_8.xy = u_xlat16_6.xy * u_xlat16_8.xy + vec2(-0.330299497, -0.330299497);
					    u_xlat16_8.xy = u_xlat16_6.xy * u_xlat16_8.xy + vec2(0.999866009, 0.999866009);
					    u_xlat16_10.xy = u_xlat16_0.xw * u_xlat16_8.xy;
					    u_xlat10.xy = u_xlat16_10.xy * vec2(-2.0, -2.0) + vec2(1.57079637, 1.57079637);
					    u_xlatb4.xy = lessThan(abs(u_xlat16_2.ywyy), abs(u_xlat16_2.xzxx)).xy;
					    u_xlat10.xy = mix(vec2(0.0, 0.0), u_xlat10.xy, vec2(u_xlatb4.xy));
					    u_xlat8.xy = u_xlat16_0.xw * u_xlat16_8.xy + u_xlat10.xy;
					    u_xlatb10.xy = lessThan(u_xlat16_2.ywyy, (-u_xlat16_2.ywyy)).xy;
					    u_xlat10.xy = mix(vec2(0.0, 0.0), vec2(-3.14159274, -3.14159274), vec2(u_xlatb10.xy));
					    u_xlat8.xy = u_xlat8.xy + u_xlat10.xy;
					    u_xlat16_0.xw = min(u_xlat16_2.yw, u_xlat16_2.xz);
					    u_xlatb10.xy = lessThan(u_xlat16_0.xwxx, (-u_xlat16_0.xwxx)).xy;
					    u_xlat16_0.xw = max(u_xlat16_2.yw, u_xlat16_2.xz);
					    u_xlatb4.xy = greaterThanEqual(u_xlat16_0.xwxx, (-u_xlat16_0.xwxx)).xy;
					    u_xlati10.xy = op_and((ivec2(u_xlatb10.xy) * -1), (ivec2(u_xlatb4.xy) * -1));
					    {
					        vec2 hlslcc_movcTemp = u_xlat8;
					        hlslcc_movcTemp.x = (u_xlati10.x != 0) ? (-u_xlat8.x) : u_xlat8.x;
					        hlslcc_movcTemp.y = (u_xlati10.y != 0) ? (-u_xlat8.y) : u_xlat8.y;
					        u_xlat8 = hlslcc_movcTemp;
					    }
					    u_xlat16_0.xw = u_xlat8.xy * vec2(0.159154937, 0.159154937) + vec2(0.75, 0.75);
					    ...
					    u_xlat16_6.xy = u_xlat16_7.xy * vec2(_Front2TexDistotion) + u_xlat4.yw;
					    u_xlat10_8.xyz = texture2D(_Front2Tex, u_xlat16_6.xy).xyz;
					    u_xlat16_8.xyz = u_xlat10_8.xyz * _Front2TexColor.xyz;
					    u_xlat4.z = _Front1TexAnimeSpeed * u_xlat1 + u_xlat16_0.x;
					    u_xlat16_0.xy = u_xlat16_7.xy * vec2(vec2(_Front1TexDistotion, _Front1TexDistotion)) + u_xlat4.xz;
					    u_xlat10_10.xyz = texture2D(_Front1Tex, u_xlat16_0.xy).xyz;
					    u_xlat16_10.xyz = u_xlat10_10.xyz * _Front1TexColor.xyz;
					    u_xlat16_0.xyz = u_xlat16_10.xyz * u_xlat10_3.xxx + u_xlat16_5.xyz;
					    u_xlat16_0.xyz = u_xlat16_8.xyz * u_xlat10_3.xxx + u_xlat16_0.xyz;
					    SV_Target0.xyz = u_xlat16_0.xyz * vs_COLOR0.xyz;
					    SV_Target0.w = vs_COLOR0.w;
					    return;
					}
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK2TEX_POLAR" "_FRONT1TEX_POLAR" "_DISTOTIONTEX_POLAR" "_BACK1TEX_SCROLL" "_FRONT2TEX_POLAR" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlat0.xy = in_TEXCOORD0.xy * _Back1Tex_ST.xy + _Back1Tex_ST.zw;
					    u_xlat4 = fract(_Time.x);
					    u_xlat0.xy = vec2(_Back1TexAnimeSpeed, _Back1TexAnimeSpeed2) * vec2(u_xlat4) + u_xlat0.xy;
					    u_xlat0.zw = in_TEXCOORD0.xy * _Back2Tex_ST.xy + _Back2Tex_ST.zw;
					    vs_TEXCOORD2 = u_xlat0;
					    vs_COLOR0 = in_COLOR0;
					    u_xlat0 = in_POSITION0.yyyy * hlslcc_mtx4x4unity_ObjectToWorld[1];
					...
					void main()
					{
					    ...
					    u_xlatb22 = abs(u_xlat16_7.y)<abs(u_xlat16_7.x);
					    u_xlat15 = u_xlatb22 ? u_xlat15 : float(0.0);
					    u_xlat8.x = u_xlat16_21 * u_xlat16_8.x + u_xlat15;
					    u_xlatb15 = u_xlat16_7.y<(-u_xlat16_7.y);
					    u_xlat15 = u_xlatb15 ? -3.14159274 : float(0.0);
					    ...
					    u_xlat16_7.x = u_xlat8.x * 0.159154937 + 0.75;
					    u_xlat4.x = _DistotionTexAnimeSpeed2 * u_xlat1 + u_xlat16_7.x;
					    u_xlat10_8.xy = texture2D(_DistotionTex, u_xlat4.xy).xy;
					    u_xlat16_8.xy = u_xlat10_8.xy + vec2(-0.5, -0.5);
					    u_xlat16_8.xy = u_xlat16_8.xy * vec2(vec2(_DistotionTexPower, _DistotionTexPower));
					    ...
					    u_xlat16_8.xy = u_xlat16_6.xy * u_xlat16_8.xy + vec2(-0.330299497, -0.330299497);
					    u_xlat16_8.xy = u_xlat16_6.xy * u_xlat16_8.xy + vec2(0.999866009, 0.999866009);
					    u_xlat16_11.xy = u_xlat16_0.xw * u_xlat16_8.xy;
					    u_xlat11.xy = u_xlat16_11.xy * vec2(-2.0, -2.0) + vec2(1.57079637, 1.57079637);
					    u_xlatb5.xy = lessThan(abs(u_xlat16_2.ywyy), abs(u_xlat16_2.xzxx)).xy;
					    u_xlat11.xy = mix(vec2(0.0, 0.0), u_xlat11.xy, vec2(u_xlatb5.xy));
					    u_xlat8.xy = u_xlat16_0.xw * u_xlat16_8.xy + u_xlat11.xy;
					    u_xlatb11.xy = lessThan(u_xlat16_2.ywyy, (-u_xlat16_2.ywyy)).xy;
					    u_xlat11.xy = mix(vec2(0.0, 0.0), vec2(-3.14159274, -3.14159274), vec2(u_xlatb11.xy));
					    u_xlat8.xy = u_xlat8.xy + u_xlat11.xy;
					    u_xlat16_0.xw = min(u_xlat16_2.yw, u_xlat16_2.xz);
					    u_xlatb11.xy = lessThan(u_xlat16_0.xwxx, (-u_xlat16_0.xwxx)).xy;
					    u_xlat16_0.xw = max(u_xlat16_2.yw, u_xlat16_2.xz);
					    u_xlatb5.xy = greaterThanEqual(u_xlat16_0.xwxx, (-u_xlat16_0.xwxx)).xy;
					    u_xlati11.xy = op_and((ivec2(u_xlatb11.xy) * -1), (ivec2(u_xlatb5.xy) * -1));
					    {
					        vec2 hlslcc_movcTemp = u_xlat8;
					        hlslcc_movcTemp.x = (u_xlati11.x != 0) ? (-u_xlat8.x) : u_xlat8.x;
					        hlslcc_movcTemp.y = (u_xlati11.y != 0) ? (-u_xlat8.y) : u_xlat8.y;
					        u_xlat8 = hlslcc_movcTemp;
					    }
					    u_xlat16_0.xw = u_xlat8.xy * vec2(0.159154937, 0.159154937) + vec2(0.75, 0.75);
					    ...
					    u_xlat16_6.xy = u_xlat16_7.xy * vec2(_Front2TexDistotion) + u_xlat5.yw;
					    u_xlat10_8.xyz = texture2D(_Front2Tex, u_xlat16_6.xy).xyz;
					    u_xlat16_8.xyz = u_xlat10_8.xyz * _Front2TexColor.xyz;
					    u_xlat5.z = _Front1TexAnimeSpeed * u_xlat1 + u_xlat16_0.x;
					    u_xlat16_0.xy = u_xlat16_7.xy * vec2(vec2(_Front1TexDistotion, _Front1TexDistotion)) + u_xlat5.xz;
					    u_xlat10_11.xyz = texture2D(_Front1Tex, u_xlat16_0.xy).xyz;
					    u_xlat16_11.xyz = u_xlat10_11.xyz * _Front1TexColor.xyz;
					    u_xlat16_0.xyz = u_xlat16_11.xyz * u_xlat10_4.xxx + u_xlat16_3.xyz;
					    u_xlat16_0.xyz = u_xlat16_8.xyz * u_xlat10_4.xxx + u_xlat16_0.xyz;
					    SV_Target0.xyz = u_xlat16_0.xyz * vs_COLOR0.xyz;
					    SV_Target0.w = vs_COLOR0.w;
					    return;
					}
				...
				SubProgram "gles hw_tier02 " {  	Keywords { "_DISTOTIONTEX_SCROLL" "_FRONT1TEX_POLAR" "_BACK1TEX_ROTATE" "_BACK2TEX_ROTATE" "_FRONT2TEX_POLAR" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlat16_1.xy = max(abs(u_xlat16_0.yw), abs(u_xlat16_0.xz));
					    u_xlat16_1.xy = vec2(1.0, 1.0) / u_xlat16_1.xy;
					    u_xlat16_19.xy = min(abs(u_xlat16_0.yw), abs(u_xlat16_0.xz));
					    u_xlat16_1.xy = u_xlat16_1.xy * u_xlat16_19.xy;
					    u_xlat16_19.xy = u_xlat16_1.xy * u_xlat16_1.xy;
					    u_xlat16_2.xy = u_xlat16_19.xy * vec2(0.0208350997, 0.0208350997) + vec2(-0.0851330012, -0.0851330012);
					    u_xlat16_2.xy = u_xlat16_19.xy * u_xlat16_2.xy + vec2(0.180141002, 0.180141002);
					    u_xlat16_2.xy = u_xlat16_19.xy * u_xlat16_2.xy + vec2(-0.330299497, -0.330299497);
					    u_xlat16_2.xy = u_xlat16_19.xy * u_xlat16_2.xy + vec2(0.999866009, 0.999866009);
					    u_xlat16_20.xy = u_xlat16_1.xy * u_xlat16_2.xy;
					    u_xlat20.xy = u_xlat16_20.xy * vec2(-2.0, -2.0) + vec2(1.57079637, 1.57079637);
					    u_xlatb3.xy = lessThan(abs(u_xlat16_0.ywyy), abs(u_xlat16_0.xzxx)).xy;
					    u_xlat20.xy = mix(vec2(0.0, 0.0), u_xlat20.xy, vec2(u_xlatb3.xy));
					    u_xlat2.xy = u_xlat16_1.xy * u_xlat16_2.xy + u_xlat20.xy;
					    u_xlatb20.xy = lessThan(u_xlat16_0.ywyw, (-u_xlat16_0.ywyw)).xy;
					    u_xlat20.xy = mix(vec2(0.0, 0.0), vec2(-3.14159274, -3.14159274), vec2(u_xlatb20.xy));
					    u_xlat2.xy = u_xlat20.xy + u_xlat2.xy;
					    u_xlat16_1.xy = min(u_xlat16_0.yw, u_xlat16_0.xz);
					    u_xlatb20.xy = lessThan(u_xlat16_1.xyxy, (-u_xlat16_1.xyxy)).xy;
					    u_xlat16_1.xy = max(u_xlat16_0.yw, u_xlat16_0.xz);
					    u_xlatb3.xy = greaterThanEqual(u_xlat16_1.xyxx, (-u_xlat16_1.xyxx)).xy;
					    u_xlati20.xy = op_and((ivec2(u_xlatb20.xy) * -1), (ivec2(u_xlatb3.xy) * -1));
					    {
					        vec2 hlslcc_movcTemp = u_xlat2;
					        hlslcc_movcTemp.x = (u_xlati20.x != 0) ? (-u_xlat2.x) : u_xlat2.x;
					        hlslcc_movcTemp.y = (u_xlati20.y != 0) ? (-u_xlat2.y) : u_xlat2.y;
					        u_xlat2 = hlslcc_movcTemp;
					    }
					    u_xlat16_1.xy = u_xlat2.xy * vec2(0.159154937, 0.159154937) + vec2(0.75, 0.75);
					    u_xlat2.x = fract(_Time.x);
					    ...
					    u_xlat10_3.xyz = texture2D(_MaskTex, vs_TEXCOORD0.xy).xyz;
					    u_xlat16_0.xy = u_xlat16_2.xy * u_xlat10_3.zz;
					    u_xlat16_18.xy = u_xlat16_0.xy * vec2(vec2(_Front1TexDistotion, _Front1TexDistotion)) + u_xlat1.xz;
					    u_xlat16_4.xy = u_xlat16_0.xy * vec2(_Front2TexDistotion) + u_xlat1.yw;
					    u_xlat10_2.xyz = texture2D(_Front2Tex, u_xlat16_4.xy).xyz;
					    u_xlat16_2.xyz = u_xlat10_2.xyz * _Front2TexColor.xyz;
					    u_xlat10_5.xyz = texture2D(_Front1Tex, u_xlat16_18.xy).xyz;
					    ...
					    u_xlat10_6.xyz = texture2D(_Back1Tex, u_xlat16_18.xy).xyz;
					    ...
					    u_xlat16_7.xyz = u_xlat10_7.xyz * _Back2TexColor.xyz;
					    u_xlat10_8.xyz = texture2D(_MainTex, u_xlat16_18.xy).xyz;
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK1TEX_POLAR" "_FRONT1TEX_POLAR" "_DISTOTIONTEX_POLAR" "_BACK2TEX_ROTATE" "_FRONT2TEX_POLAR" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlat16_1 = u_xlat16_24 * 0.0208350997 + -0.0851330012;
					    u_xlat16_1 = u_xlat16_24 * u_xlat16_1 + 0.180141002;
					    u_xlat16_1 = u_xlat16_24 * u_xlat16_1 + -0.330299497;
					    u_xlat16_1 = u_xlat16_24 * u_xlat16_1 + 0.999866009;
					    u_xlat16_9.x = u_xlat16_16 * u_xlat16_1;
					    u_xlat9.x = u_xlat16_9.x * -2.0 + 1.57079637;
					    u_xlatb17 = abs(u_xlat16_0.y)<abs(u_xlat16_0.x);
					    u_xlat9.x = u_xlatb17 ? u_xlat9.x : float(0.0);
					    u_xlat1 = u_xlat16_16 * u_xlat16_1 + u_xlat9.x;
					    ...
					    u_xlat9.x = u_xlat16_24 * u_xlat16_9.x + u_xlat17;
					    ...
					    u_xlat16_8.x = u_xlat9.x * 0.159154937 + 0.75;
					    ...
					    u_xlat16_9.xy = u_xlat16_5.xy * vec2(0.0208350997, 0.0208350997) + vec2(-0.0851330012, -0.0851330012);
					    u_xlat16_9.xy = u_xlat16_5.xy * u_xlat16_9.xy + vec2(0.180141002, 0.180141002);
					    u_xlat16_9.xy = u_xlat16_5.xy * u_xlat16_9.xy + vec2(-0.330299497, -0.330299497);
					    u_xlat16_9.xy = u_xlat16_5.xy * u_xlat16_9.xy + vec2(0.999866009, 0.999866009);
					    u_xlat16_12.xy = u_xlat16_0.xw * u_xlat16_9.xy;
					    ...
					    u_xlat9.xy = u_xlat16_0.xw * u_xlat16_9.xy + u_xlat12.xy;
					    ...
					    u_xlati12.xy = op_and((ivec2(u_xlatb12.xy) * -1), (ivec2(u_xlatb6.xy) * -1));
					    {
					        ...
					        hlslcc_movcTemp.x = (u_xlati12.x != 0) ? (-u_xlat9.x) : u_xlat9.x;
					        hlslcc_movcTemp.y = (u_xlati12.y != 0) ? (-u_xlat9.y) : u_xlat9.y;
					        u_xlat9 = hlslcc_movcTemp;
					    }
					    u_xlat16_0.xw = u_xlat9.xy * vec2(0.159154937, 0.159154937) + vec2(0.75, 0.75);
					    u_xlat5.xy = vec2(_Front1TexAnimeSpeed2, _Front2TexAnimeSpeed2) * vec2(u_xlat1) + u_xlat16_0.xw;
					    u_xlat16_0.x = dot(u_xlat16_2.xy, u_xlat16_2.xy);
					    u_xlat16_0.w = dot(u_xlat16_2.zw, u_xlat16_2.zw);
					    u_xlat16_0.xw = sqrt(u_xlat16_0.xw);
					    u_xlat16_0.xw = (-u_xlat16_0.xw) + vec2(1.0, 1.0);
					    u_xlat5.w = _Front2TexAnimeSpeed * u_xlat1 + u_xlat16_0.w;
					    u_xlat16_7.xy = u_xlat16_8.xy * vec2(_Front2TexDistotion) + u_xlat5.yw;
					    u_xlat10_9.xyz = texture2D(_Front2Tex, u_xlat16_7.xy).xyz;
					    u_xlat16_9.xyz = u_xlat10_9.xyz * _Front2TexColor.xyz;
					    u_xlat5.z = _Front1TexAnimeSpeed * u_xlat1 + u_xlat16_0.x;
					    u_xlat16_0.xy = u_xlat16_8.xy * vec2(vec2(_Front1TexDistotion, _Front1TexDistotion)) + u_xlat5.xz;
					    u_xlat10_12.xyz = texture2D(_Front1Tex, u_xlat16_0.xy).xyz;
					    u_xlat16_12.xyz = u_xlat10_12.xyz * _Front1TexColor.xyz;
					    u_xlat16_0.xyz = u_xlat16_12.xyz * u_xlat10_4.xxx + u_xlat16_3.xyz;
					    u_xlat16_0.xyz = u_xlat16_9.xyz * u_xlat10_4.xxx + u_xlat16_0.xyz;
					    SV_Target0.xyz = u_xlat16_0.xyz * vs_COLOR0.xyz;
					    SV_Target0.w = vs_COLOR0.w;
					    return;
					}
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_FRONT1TEX_POLAR" "_BACK1TEX_ROTATE" "_DISTOTIONTEX_POLAR" "_BACK2TEX_ROTATE" "_FRONT2TEX_POLAR" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlat16_1 = u_xlat16_24 * u_xlat16_1 + -0.330299497;
					    u_xlat16_1 = u_xlat16_24 * u_xlat16_1 + 0.999866009;
					    u_xlat16_9.x = u_xlat16_16.x * u_xlat16_1;
					    u_xlat9.x = u_xlat16_9.x * -2.0 + 1.57079637;
					    u_xlatb17 = abs(u_xlat16_0.y)<abs(u_xlat16_0.x);
					    u_xlat9.x = u_xlatb17 ? u_xlat9.x : float(0.0);
					    u_xlat1 = u_xlat16_16.x * u_xlat16_1 + u_xlat9.x;
					    u_xlatb9 = u_xlat16_0.y<(-u_xlat16_0.y);
					    u_xlat9.x = u_xlatb9 ? -3.14159274 : float(0.0);
					    u_xlat1 = u_xlat9.x + u_xlat1;
					    ...
					    u_xlat16_16.xy = max(abs(u_xlat16_3.yw), abs(u_xlat16_3.xz));
					    u_xlat16_16.xy = vec2(1.0, 1.0) / u_xlat16_16.xy;
					    u_xlat16_5.xy = min(abs(u_xlat16_3.yw), abs(u_xlat16_3.xz));
					    u_xlat16_16.xy = u_xlat16_16.xy * u_xlat16_5.xy;
					    u_xlat16_5.xy = u_xlat16_16.xy * u_xlat16_16.xy;
					    u_xlat16_9.xy = u_xlat16_5.xy * vec2(0.0208350997, 0.0208350997) + vec2(-0.0851330012, -0.0851330012);
					    u_xlat16_9.xy = u_xlat16_5.xy * u_xlat16_9.xy + vec2(0.180141002, 0.180141002);
					    u_xlat16_9.xy = u_xlat16_5.xy * u_xlat16_9.xy + vec2(-0.330299497, -0.330299497);
					    u_xlat16_9.xy = u_xlat16_5.xy * u_xlat16_9.xy + vec2(0.999866009, 0.999866009);
					    u_xlat16_10.xy = u_xlat16_16.xy * u_xlat16_9.xy;
					    u_xlat10.xy = u_xlat16_10.xy * vec2(-2.0, -2.0) + vec2(1.57079637, 1.57079637);
					    u_xlatb6.xy = lessThan(abs(u_xlat16_3.ywyy), abs(u_xlat16_3.xzxx)).xy;
					    u_xlat10.xy = mix(vec2(0.0, 0.0), u_xlat10.xy, vec2(u_xlatb6.xy));
					    u_xlat9.xy = u_xlat16_16.xy * u_xlat16_9.xy + u_xlat10.xy;
					    u_xlatb10.xy = lessThan(u_xlat16_3.ywyy, (-u_xlat16_3.ywyy)).xy;
					    u_xlat10.xy = mix(vec2(0.0, 0.0), vec2(-3.14159274, -3.14159274), vec2(u_xlatb10.xy));
					    u_xlat9.xy = u_xlat9.xy + u_xlat10.xy;
					    u_xlat16_16.xy = min(u_xlat16_3.yw, u_xlat16_3.xz);
					    u_xlatb10.xy = lessThan(u_xlat16_16.xyxx, (-u_xlat16_16.xyxx)).xy;
					    u_xlat16_16.xy = max(u_xlat16_3.yw, u_xlat16_3.xz);
					    u_xlatb6.xy = greaterThanEqual(u_xlat16_16.xyxx, (-u_xlat16_16.xyxx)).xy;
					    u_xlati10.xy = op_and((ivec2(u_xlatb10.xy) * -1), (ivec2(u_xlatb6.xy) * -1));
					    {
					        vec2 hlslcc_movcTemp = u_xlat9;
					        hlslcc_movcTemp.x = (u_xlati10.x != 0) ? (-u_xlat9.x) : u_xlat9.x;
					        hlslcc_movcTemp.y = (u_xlati10.y != 0) ? (-u_xlat9.y) : u_xlat9.y;
					        u_xlat9 = hlslcc_movcTemp;
					    }
					    u_xlat16_16.xy = u_xlat9.xy * vec2(0.159154937, 0.159154937) + vec2(0.75, 0.75);
					    u_xlat5.xy = vec2(_Front1TexAnimeSpeed2, _Front2TexAnimeSpeed2) * vec2(u_xlat1) + u_xlat16_16.xy;
					    u_xlat16_16.x = dot(u_xlat16_3.xy, u_xlat16_3.xy);
					    u_xlat16_16.y = dot(u_xlat16_3.zw, u_xlat16_3.zw);
					    u_xlat16_16.xy = sqrt(u_xlat16_16.xy);
					    u_xlat16_16.xy = (-u_xlat16_16.xy) + vec2(1.0, 1.0);
					    u_xlat5.w = _Front2TexAnimeSpeed * u_xlat1 + u_xlat16_16.y;
					    u_xlat16_7.xy = u_xlat16_0.xy * vec2(_Front2TexDistotion) + u_xlat5.yw;
					    u_xlat10_9.xyz = texture2D(_Front2Tex, u_xlat16_7.xy).xyz;
					    u_xlat16_9.xyz = u_xlat10_9.xyz * _Front2TexColor.xyz;
					    u_xlat5.z = _Front1TexAnimeSpeed * u_xlat1 + u_xlat16_16.x;
					    u_xlat16_0.xy = u_xlat16_0.xy * vec2(vec2(_Front1TexDistotion, _Front1TexDistotion)) + u_xlat5.xz;
					    u_xlat10_10.xyz = texture2D(_Front1Tex, u_xlat16_0.xy).xyz;
					    u_xlat16_10.xyz = u_xlat10_10.xyz * _Front1TexColor.xyz;
					    u_xlat16_0.xyz = u_xlat16_10.xyz * u_xlat10_2.xxx + u_xlat16_4.xyz;
					    u_xlat16_0.xyz = u_xlat16_9.xyz * u_xlat10_2.xxx + u_xlat16_0.xyz;
					    SV_Target0.xyz = u_xlat16_0.xyz * vs_COLOR0.xyz;
					    SV_Target0.w = vs_COLOR0.w;
					    return;
					}
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_DISTOTIONTEX_SCROLL" "_BACK1TEX_ROTATE" "_FRONT1TEX_ROTATE" "_BACK2TEX_ROTATE" "_FRONT2TEX_POLAR" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlat10_1.xyz = texture2D(_MaskTex, vs_TEXCOORD0.xy).xyz;
					    u_xlat16_2.xy = u_xlat16_0.xy * u_xlat10_1.zz;
					    u_xlat16_14.xy = u_xlat16_2.xy * vec2(vec2(_Back1TexDistotion, _Back1TexDistotion)) + vs_TEXCOORD2.xy;
					    u_xlat10_0.xyz = texture2D(_Back1Tex, u_xlat16_14.xy).xyz;
					    u_xlat16_0.xyz = u_xlat10_0.xyz * _Back1TexColor.xyz;
					    u_xlat16_14.xy = u_xlat16_2.xy * vec2(vec2(_MainTexDistotion, _MainTexDistotion)) + vs_TEXCOORD0.xy;
					    u_xlat10_3.xyz = texture2D(_MainTex, u_xlat16_14.xy).xyz;
					    u_xlat16_4.xyz = u_xlat16_0.xyz * u_xlat10_1.yyy + u_xlat10_3.xyz;
					    u_xlat16_14.xy = u_xlat16_2.xy * vec2(vec2(_Back2TexDistotion, _Back2TexDistotion)) + vs_TEXCOORD2.zw;
					    u_xlat10_0.xyz = texture2D(_Back2Tex, u_xlat16_14.xy).xyz;
					    u_xlat16_0.xyz = u_xlat10_0.xyz * _Back2TexColor.xyz;
					    u_xlat16_4.xyz = u_xlat16_0.xyz * u_xlat10_1.yyy + u_xlat16_4.xyz;
					    u_xlat16_14.xy = u_xlat16_2.xy * vec2(vec2(_Front1TexDistotion, _Front1TexDistotion)) + vs_TEXCOORD1.xy;
					    u_xlat10_0.xyz = texture2D(_Front1Tex, u_xlat16_14.xy).xyz;
					    u_xlat16_0.xyz = u_xlat10_0.xyz * _Front1TexColor.xyz;
					    u_xlat16_4.xyz = u_xlat16_0.xyz * u_xlat10_1.xxx + u_xlat16_4.xyz;
					    u_xlat16_14.xy = vs_TEXCOORD1.wz * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
					    u_xlat16_22 = max(abs(u_xlat16_14.y), abs(u_xlat16_14.x));
					    u_xlat16_22 = float(1.0) / u_xlat16_22;
					    u_xlat16_5 = min(abs(u_xlat16_14.y), abs(u_xlat16_14.x));
					    u_xlat16_22 = u_xlat16_22 * u_xlat16_5;
					    u_xlat16_5 = u_xlat16_22 * u_xlat16_22;
					    u_xlat16_0.x = u_xlat16_5 * 0.0208350997 + -0.0851330012;
					    u_xlat16_0.x = u_xlat16_5 * u_xlat16_0.x + 0.180141002;
					    u_xlat16_0.x = u_xlat16_5 * u_xlat16_0.x + -0.330299497;
					    u_xlat16_0.x = u_xlat16_5 * u_xlat16_0.x + 0.999866009;
					    u_xlat16_6 = u_xlat16_0.x * u_xlat16_22;
					    u_xlat6 = u_xlat16_6 * -2.0 + 1.57079637;
					    u_xlatb12 = abs(u_xlat16_14.y)<abs(u_xlat16_14.x);
					    u_xlat6 = u_xlatb12 ? u_xlat6 : float(0.0);
					    u_xlat0 = u_xlat16_22 * u_xlat16_0.x + u_xlat6;
					    u_xlatb6 = u_xlat16_14.y<(-u_xlat16_14.y);
					    u_xlat6 = u_xlatb6 ? -3.14159274 : float(0.0);
					    u_xlat0 = u_xlat6 + u_xlat0;
					    u_xlat16_22 = min(u_xlat16_14.y, u_xlat16_14.x);
					    u_xlatb6 = u_xlat16_22<(-u_xlat16_22);
					    u_xlat16_22 = max(u_xlat16_14.y, u_xlat16_14.x);
					    u_xlat16_14.x = dot(u_xlat16_14.xy, u_xlat16_14.xy);
					    u_xlat16_14.x = sqrt(u_xlat16_14.x);
					    u_xlat16_14.x = (-u_xlat16_14.x) + 1.0;
					    u_xlatb12 = u_xlat16_22>=(-u_xlat16_22);
					    u_xlatb6 = u_xlatb12 && u_xlatb6;
					    u_xlat0 = (u_xlatb6) ? (-u_xlat0) : u_xlat0;
					    u_xlat16_20 = u_xlat0 * 0.159154937 + 0.75;
					    u_xlat0 = fract(_Time.x);
					    u_xlat3.x = _Front2TexAnimeSpeed2 * u_xlat0 + u_xlat16_20;
					    u_xlat3.y = _Front2TexAnimeSpeed * u_xlat0 + u_xlat16_14.x;
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_DISTOTIONTEX_SCROLL" "_FRONT1TEX_ROTATE" "_BACK1TEX_SCROLL" "_BACK2TEX_ROTATE" "_FRONT2TEX_POLAR" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_DISTOTIONTEX_POLAR" "_FRONT1TEX_ROTATE" "_BACK1TEX_SCROLL" "_BACK2TEX_ROTATE" "_FRONT2TEX_POLAR" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlat16_6 = u_xlat1 * 0.159154937 + 0.75;
					    u_xlat1 = fract(_Time.x);
					    u_xlat2.x = _DistotionTexAnimeSpeed2 * u_xlat1 + u_xlat16_6;
					    u_xlat2.y = _DistotionTexAnimeSpeed * u_xlat1 + u_xlat16_0.x;
					    u_xlat10_7.xy = texture2D(_DistotionTex, u_xlat2.xy).xy;
					    u_xlat16_7.xy = u_xlat10_7.xy + vec2(-0.5, -0.5);
					    u_xlat16_7.xy = u_xlat16_7.xy * vec2(vec2(_DistotionTexPower, _DistotionTexPower));
					    u_xlat10_2.xyz = texture2D(_MaskTex, vs_TEXCOORD0.xy).xyz;
					    u_xlat16_0.xy = u_xlat16_7.xy * u_xlat10_2.zz;
					    u_xlat16_12.xy = u_xlat16_0.xy * vec2(vec2(_Back1TexDistotion, _Back1TexDistotion)) + vs_TEXCOORD2.xy;
					    u_xlat10_7.xyz = texture2D(_Back1Tex, u_xlat16_12.xy).xyz;
					    u_xlat16_7.xyz = u_xlat10_7.xyz * _Back1TexColor.xyz;
					    u_xlat16_12.xy = u_xlat16_0.xy * vec2(vec2(_MainTexDistotion, _MainTexDistotion)) + vs_TEXCOORD0.xy;
					    u_xlat10_3.xyz = texture2D(_MainTex, u_xlat16_12.xy).xyz;
					    u_xlat16_4.xyz = u_xlat16_7.xyz * u_xlat10_2.yyy + u_xlat10_3.xyz;
					    u_xlat16_12.xy = u_xlat16_0.xy * vec2(vec2(_Back2TexDistotion, _Back2TexDistotion)) + vs_TEXCOORD2.zw;
					    u_xlat10_7.xyz = texture2D(_Back2Tex, u_xlat16_12.xy).xyz;
					    u_xlat16_7.xyz = u_xlat10_7.xyz * _Back2TexColor.xyz;
					    u_xlat16_4.xyz = u_xlat16_7.xyz * u_xlat10_2.yyy + u_xlat16_4.xyz;
					    u_xlat16_12.xy = u_xlat16_0.xy * vec2(vec2(_Front1TexDistotion, _Front1TexDistotion)) + vs_TEXCOORD1.xy;
					    u_xlat10_7.xyz = texture2D(_Front1Tex, u_xlat16_12.xy).xyz;
					    u_xlat16_7.xyz = u_xlat10_7.xyz * _Front1TexColor.xyz;
					    u_xlat16_4.xyz = u_xlat16_7.xyz * u_xlat10_2.xxx + u_xlat16_4.xyz;
					    u_xlat16_12.xy = vs_TEXCOORD1.wz * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
					    u_xlat16_22 = max(abs(u_xlat16_12.y), abs(u_xlat16_12.x));
					    u_xlat16_22 = float(1.0) / u_xlat16_22;
					    u_xlat16_5 = min(abs(u_xlat16_12.y), abs(u_xlat16_12.x));
					    u_xlat16_22 = u_xlat16_22 * u_xlat16_5;
					    ...
					    u_xlat16_12.x = sqrt(u_xlat16_12.x);
					    u_xlat16_12.x = (-u_xlat16_12.x) + 1.0;
					    u_xlat3.y = _Front2TexAnimeSpeed * u_xlat1 + u_xlat16_12.x;
					    u_xlatb19 = u_xlat16_22>=(-u_xlat16_22);
					    u_xlatb13 = u_xlatb19 && u_xlatb13;
					    u_xlat7 = (u_xlatb13) ? (-u_xlat7) : u_xlat7;
					    u_xlat16_12.x = u_xlat7 * 0.159154937 + 0.75;
					    u_xlat3.x = _Front2TexAnimeSpeed2 * u_xlat1 + u_xlat16_12.x;
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK1TEX_POLAR" "_DISTOTIONTEX_POLAR" "_FRONT1TEX_ROTATE" "_BACK2TEX_SCROLL" "_FRONT2TEX_POLAR" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlat16_7.xyz = u_xlat10_7.xyz * _Back2TexColor.xyz;
					    u_xlat16_3.xyz = u_xlat16_7.xyz * u_xlat10_4.yyy + u_xlat16_3.xyz;
					    u_xlat16_0.xw = u_xlat16_6.xy * vec2(vec2(_Front1TexDistotion, _Front1TexDistotion)) + vs_TEXCOORD1.xy;
					    u_xlat10_7.xyz = texture2D(_Front1Tex, u_xlat16_0.xw).xyz;
					    u_xlat16_7.xyz = u_xlat10_7.xyz * _Front1TexColor.xyz;
					    u_xlat16_3.xyz = u_xlat16_7.xyz * u_xlat10_4.xxx + u_xlat16_3.xyz;
					    u_xlat16_0.xw = vs_TEXCOORD1.wz * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
					    u_xlat16_21 = max(abs(u_xlat16_0.w), abs(u_xlat16_0.x));
					    u_xlat16_21 = float(1.0) / u_xlat16_21;
					    u_xlat16_5 = min(abs(u_xlat16_0.w), abs(u_xlat16_0.x));
					    ...
					    u_xlat16_0.x = u_xlat7 * 0.159154937 + 0.75;
					    u_xlat2.x = _Front2TexAnimeSpeed2 * u_xlat1 + u_xlat16_0.x;
					    u_xlat16_0.xy = u_xlat16_6.xy * vec2(_Front2TexDistotion) + u_xlat2.xy;
					    u_xlat10_1.xyz = texture2D(_Front2Tex, u_xlat16_0.xy).xyz;
					    u_xlat16_1.xyz = u_xlat10_1.xyz * _Front2TexColor.xyz;
					    u_xlat16_0.xyz = u_xlat16_1.xyz * u_xlat10_4.xxx + u_xlat16_3.xyz;
					    SV_Target0.xyz = u_xlat16_0.xyz * vs_COLOR0.xyz;
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK1TEX_POLAR" "_DISTOTIONTEX_POLAR" "_FRONT1TEX_SCROLL" "_BACK2TEX_SCROLL" "_FRONT2TEX_POLAR" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlat5 = fract(_Time.x);
					    u_xlat0.xy = vec2(_Front1TexAnimeSpeed, _Front1TexAnimeSpeed2) * vec2(u_xlat5) + u_xlat1.xy;
					    vs_TEXCOORD1 = u_xlat0;
					    u_xlat0.xy = in_TEXCOORD0.xy * _Back2Tex_ST.xy + _Back2Tex_ST.zw;
					    u_xlat0.zw = vec2(_Back2TexAnimeSpeed, _Back2TexAnimeSpeed2) * vec2(u_xlat5) + u_xlat0.xy;
					    u_xlat0.xy = in_TEXCOORD0.xy * _Back1Tex_ST.xy + _Back1Tex_ST.zw;
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK1TEX_ROTATE" "_DISTOTIONTEX_POLAR" "_FRONT1TEX_SCROLL" "_BACK2TEX_SCROLL" "_FRONT2TEX_POLAR" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_FRONT1TEX_POLAR" "_DISTOTIONTEX_POLAR" "_BACK1TEX_SCROLL" "_BACK2TEX_SCROLL" "_FRONT2TEX_POLAR" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles hw_tier02 " {		Keywords { "_BACK1TEX_POLAR" "_FRONT1TEX_ROTATE" "_BACK2TEX_ROTATE" "_DISTOTIONTEX_ROTATE" "_FRONT2TEX_POLAR" }
					"!!GLES
					#ifdef VERTEX
					#version 100
					...
					void main()
					{
					    ...
					    u_xlat10_7.xyz = texture2D(_Front1Tex, u_xlat16_12.xy).xyz;
					    u_xlat16_7.xyz = u_xlat10_7.xyz * _Front1TexColor.xyz;
					    u_xlat16_4.xyz = u_xlat16_7.xyz * u_xlat10_3.xxx + u_xlat16_4.xyz;
					    u_xlat16_12.xy = vs_TEXCOORD1.wz * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
					    u_xlat16_22 = max(abs(u_xlat16_12.y), abs(u_xlat16_12.x));
					    u_xlat16_22 = float(1.0) / u_xlat16_22;
					    u_xlat16_5 = min(abs(u_xlat16_12.y), abs(u_xlat16_12.x));
					    ...
					    u_xlat16_12.x = sqrt(u_xlat16_12.x);
					    u_xlat16_12.x = (-u_xlat16_12.x) + 1.0;
					    u_xlat2.y = _Front2TexAnimeSpeed * u_xlat1 + u_xlat16_12.x;
					    u_xlatb19 = u_xlat16_22>=(-u_xlat16_22);
					    u_xlatb13 = u_xlatb19 && u_xlatb13;
					    u_xlat7 = (u_xlatb13) ? (-u_xlat7) : u_xlat7;
					    u_xlat16_12.x = u_xlat7 * 0.159154937 + 0.75;
					    u_xlat2.x = _Front2TexAnimeSpeed2 * u_xlat1 + u_xlat16_12.x;
