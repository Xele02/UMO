...
*/
			...
			{
				float4 u_xlat0, u_xlat1, u_xlat2, u_xlat4, u_xlat5, u_xlat3, u_xlat10_1, u_xlat16_1, SV_Target0;
				float u_xlat14;
				...
				u_xlat2.x = (-u_xlat0.x);
				u_xlat4.xyz = (-i.texcoord1.xyz) + _WorldSpaceCameraPos.xyz;
				u_xlat5.x = dot(u_xlat4.xyz, u_xlat4.xyz);
				u_xlat5.x = rsqrt(u_xlat5.x);
				u_xlat4.xyz = u_xlat4.xyz * u_xlat5.xxx;
				u_xlat5.x = dot(i.texcoord2.xyz, i.texcoord2.xyz);
				u_xlat5.x = rsqrt(u_xlat5.x);
				u_xlat5.xyz = u_xlat5.xxx * i.texcoord2.xyz;
