	...
	SubShader {
		...
		Pass {
			...
			v2f vert(appdata v)
			{
				...
				normal.w = 0;
				o.texcoord1 = normalize((mul(unity_ObjectToWorld,normal)).xyz);
...
*/
			...
			{
				float4 SV_Target0, u_xlat0, u_xlat10_0, u_xlat16_0, u_xlat1;
				float u_xlat6;
				u_xlat0.xy = i.texcoord0.xy * _VAL_col_ST.xy + _VAL_col_ST.zw;
				u_xlat10_0.xyz = tex2D(_VAL_col, u_xlat0.xy).xyz;
				...
				u_xlat6 = dot(i.texcoord1.xyz, i.texcoord1.xyz);
				u_xlat6 = rsqrt(u_xlat6);
				u_xlat1.xyz = float3(u_xlat6, u_xlat6, u_xlat6) * i.texcoord1.xyz;
